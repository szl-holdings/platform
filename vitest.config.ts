...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: "@szl-holdings/auth-shared/server", replacement: resolve(__dirname, "packages/auth-shared/src/server/index.ts") },
      { find: "@szl-holdings/auth-shared/client", replacement: resolve(__dirname, "packages/auth-shared/src/client/index.ts") },
      { find: "@szl-holdings/auth-shared/mobile", replacement: resolve(__dirname, "packages/auth-shared/src/mobile/index.ts") },
      { find: "@szl-holdings/auth-shared/types", replacement: resolve(__dirname, "packages/auth-shared/src/types.ts") },
      { find: "@szl-holdings/auth-shared", replacement: resolve(__dirname, "packages/auth-shared/src/index.ts") },
      ...
      { find: "@workspace/ontology", replacement: resolve(__dirname, "packages/ontology/src/index.ts") },
      ...
      { find: "@workspace/eval-forge/types", replacement: resolve(__dirname, "packages/eval-forge/src/types.ts") },
      { find: "@workspace/eval-forge/metrics", replacement: resolve(__dirname, "packages/eval-forge/src/metrics.ts") },
      { find: "@workspace/eval-forge/graders", replacement: resolve(__dirname, "packages/eval-forge/src/graders.ts") },
      { find: "@workspace/eval-forge/runtime", replacement: resolve(__dirname, "packages/eval-forge/src/runtime.ts") },
      { find: "@workspace/eval-forge/nightly-runner", replacement: resolve(__dirname, "packages/eval-forge/src/nightly-runner.ts") },
      { find: "@workspace/eval-forge/cli", replacement: resolve(__dirname, "packages/eval-forge/src/cli.ts") },
      { find: "@workspace/eval-forge/suites", replacement: resolve(__dirname, "packages/eval-forge/src/suites/index.ts") },
      { find: "@workspace/eval-forge", replacement: resolve(__dirname, "packages/eval-forge/src/index.ts") },
      ...
      { find: "@workspace/tool-mesh/rate-limiter", replacement: resolve(__dirname, "packages/tool-mesh/src/rate-limiter.ts") },
      { find: "@workspace/tool-mesh/executor", replacement: resolve(__dirname, "packages/tool-mesh/src/executor.ts") },
      { find: "@workspace/tool-mesh/mcp-bridge", replacement: resolve(__dirname, "packages/tool-mesh/src/mcp-bridge.ts") },
