...
**Companion docs:** [DATA-RETENTION.md](DATA-RETENTION.md) · [TENANCY-MODEL.md](TENANCY-MODEL.md) · [AI_GOVERNANCE.md](AI_GOVERNANCE.md)
...
> Full third-party register: [docs/THIRD_PARTY_REGISTER.md](docs/THIRD_PARTY_REGISTER.md)
...
See [AI_GOVERNANCE.md](AI_GOVERNANCE.md) for the full AI governance posture.
...
1. Internal detection and containment per [INCIDENT_RESPONSE.md](INCIDENT_RESPONSE.md)
