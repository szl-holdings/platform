...
**Related:** [AI_EVALUATION_STRATEGY.md](AI_EVALUATION_STRATEGY.md) · [GUARDRAILS_MODEL.md](GUARDRAILS_MODEL.md) · [AGENT_GATEWAY_STRATEGY.md](AGENT_GATEWAY_STRATEGY.md) · [MCP_GATEWAY_STRATEGY.md](MCP_GATEWAY_STRATEGY.md) · [ANALYTICS-EVENTS.md](ANALYTICS-EVENTS.md) · [OPERATIONS-RUNBOOK.md](OPERATIONS-RUNBOOK.md)
...
Server-side structured log `guardrail.triggered` (emitted via the pino logger in `routes/ai-engine.ts`) carries the full context of any guardrail firing — see [GUARDRAILS_MODEL.md](GUARDRAILS_MODEL.md).
...
- [OPERATIONS-RUNBOOK.md § Health & Monitoring](OPERATIONS-RUNBOOK.md#5-health--monitoring) — Self-monitor thresholds
