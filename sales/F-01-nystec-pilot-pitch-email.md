...
| "We can't pilot a non-StateRAMP product" | "Understood. The disclosure is at A11OY-01. If StateRAMP is hard-required, we'll pause and revisit at StateRAMP Ready milestone (target Q1 2027). Would it help if I introduced you to a peer agency that doesn't have the StateRAMP requirement?" |
