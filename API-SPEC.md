...
|--------|-------------|--------|
| Route files | 315 | `artifacts/api-server/src/routes/` |
...
The API server exposes **5,040 REST operations** across **4,071 paths** in **315 route files**, all documented in the OpenAPI 3.1 spec at `lib/api-spec/openapi.yaml` and rendered into `API-CATALOGUE.md` (regenerated by `pnpm docs:generate`).
