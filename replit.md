...
## System Architecture
The platform is a pnpm monorepo, known as the Continuum Business Observability Fabric (formerly AEEP/Alloy Execution Fabric), built with TypeScript 5.9, React 19, Vite, and Node.js, employing a micro-frontend architecture.
...
- **Continuum ARGO — Field Intelligence Forge (`/a11oy/argo`, v0.2.0-seed):** Distillation surface that fuses external signals with defensive doctrines and public research for cybersecurity insights.
- **Continuum Aerial Twin (Site-Specific Wireless Digital-Twin Doctrine):** Doctrine hub distilling public NVIDIA Aerial Digital Twin overview into the SZL ecosystem with operational milestone surfaces.
- **Continuum Mythos Layer (Defensive Architecture Doctrine):** Static doctrine surface codifying the Continuum×Sentra orchestration architecture.
- **Continuum × Sentra Glasswing Command Layer (Risk-as-Reward):** Premium executive command surface synthesizing agent constellations and a "Risk-as-Reward" novelty thesis.
- **Continuum Command Fabric — Universal Intelligence Layer:** Cross-vertical command layer spanning all SZL verticals with interactive data views.
- **Continuum Observability AI Layer:** Seven new advanced ML-driven observability pages under the OBSERVABILITY AI nav group:
...
- **Continuum Trust & Policies:** Three new operational policy pages covering Constitution, Security & Compliance, and Right to Audit.
