...
- **Carlota Jo:** Warm ivory/brushed gold, light luxury, serif fonts. UHNW residential advisory platform for Rosa Lutar. Features: public marketing site with Services, Who We Serve (4 UHNW profiles), How We Work (5-stage engagement workflow), About Carlota Jo (founder narrative), 4-step booking flow (/booking → POST /api/booking/inquiries), and private Client Portal with document vault, message thread, invoices, and engagement timeline. Navigation: Services, Who We Serve, How We Work, About Carlota Jo + Request Consultation CTA.
