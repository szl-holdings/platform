...
- **SZL Holdings (`szl-holdings`, route: `/`):** Premium portfolio HQ. Corporate site (/corporate) uses dark graphite/stone base (#0e100f) with warm metallic gold accent (#c9a96e), Instrument Serif display font. Hero: "A portfolio built for modern systems, operations, and premium execution." Sections: Hero, Portfolio (grid), Leadership (principles), Contact (minimalist form), Footer. Spectrum analytics, Changelog, Roadmap pages also present.
