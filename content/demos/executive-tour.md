# Executive Tour — 5 Minutes with SZL Holdings

## What You'll See
A bird's-eye view of the platform's command surfaces, decision workflows, and trust posture.
...
### Step 2: Lyte Executive Command (1 min)
**Navigate to**: Lyte Command Center (/)
- See the executive command dashboard
- Note signal prioritization and metrics
...
### Step 5: Trust & Investor Surfaces (1 min)
**Navigate to**: Trust Center (/trust) or Investor Relations (/investors)
- See security, compliance, and architecture documentation
- Note the data room and trust posture
...
- Professional engineering discipline (47 CI/CD workflows, measured in `artifacts/SOURCE_OF_TRUTH.json`)
