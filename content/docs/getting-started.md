...
### 1. Sign In
Navigate to your product URL and sign in via the authentication provider. Your account will be associated with your organization and role.
...
#### View and Triage Signals (Lyte)
1. Open the signal queue
2. Review priority and context
...
4. Update status and assign

#### Manage Properties (Terra)
1. Open Dashboard
2. Browse portfolio or distress engine
3. Open property detail
4. Track deals and diligence

#### Monitor Fleet (Vessels)
1. Open Fleet Map
2. Select vessel for detail
3. Review alerts and exceptions
