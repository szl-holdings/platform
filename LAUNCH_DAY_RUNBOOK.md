...
**Related:** [ROLLBACK_PLAYBOOK.md](ROLLBACK_PLAYBOOK.md) · [ENVIRONMENT_VALIDATION.md](ENVIRONMENT_VALIDATION.md) · [RELEASE_INTELLIGENCE.md](RELEASE_INTELLIGENCE.md) · [LAUNCH_ANALYTICS_PLAN.md](LAUNCH_ANALYTICS_PLAN.md)
...
- [ ] All hard blockers in [LAUNCH_BLOCKERS.md](LAUNCH_BLOCKERS.md) resolved and signed off
- [ ] Production environment fully validated per [ENVIRONMENT_VALIDATION.md](ENVIRONMENT_VALIDATION.md) Stage 2
...
- [ ] Rollback procedure tested in staging ([ROLLBACK_PLAYBOOK.md](ROLLBACK_PLAYBOOK.md))
...
- [ ] Day 0 dashboard configured per [LAUNCH_ANALYTICS_PLAN.md](LAUNCH_ANALYTICS_PLAN.md)
...
**Rollback procedure:** [ROLLBACK_PLAYBOOK.md](ROLLBACK_PLAYBOOK.md)
...
See [LAUNCH_ANALYTICS_PLAN.md](LAUNCH_ANALYTICS_PLAN.md) for the full metrics framework.
