      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(1.25rem,5vw,2.5rem)" }}>
        <div className="grid lg:grid-cols-[420px,1fr] gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <p style={{ fontSize: "0.9375rem", lineHeight: "1.72", color: "hsl(210,5%,54%)", maxWidth: "26rem", marginBottom: "1.75rem" }}>
              Every SZL Holdings platform operates from a shared doctrine: observe reality, interpret signal, decide with clarity, execute with precision, and advise with trust. The platforms are different. The discipline is identical.
            </p>
            <div
              style={{
                display: "inline-flex",
            ...
            >
              <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "hsl(152,62%,46%)", display: "inline-block", boxShadow: "0 0 6px hsla(152,62%,46%,0.5)" }} />
            ...
            {doctrine.map((d, i) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: "12.5px", lineHeight: "1.6", color: "hsl(210,5%,52%)" }}>{d.desc}</p>
                </div>
              </m.div>
            ))}
          </div>
