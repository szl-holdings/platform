...
export default function InvestorScreen() {
  ...
  const handleDocRequest = useCallback(() => {
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        { text: "Email IR Team", onPress: () => Linking.openURL("mailto:hello@szlholdings.com?subject=Investor Document Request") },
      ]
    );
  }, []);
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>
            SZL Holdings is building command-layer infrastructure for organizations where unreliability is not a recoverable condition.
          </Text>
        </View>
        ...
        <View style={[styles.section, { borderTopColor: colors.borderSubtle }]}>
          ...
          <View style={[styles.capTable, { backgroundColor: colors.card, borderColor: colors.borderSubtle }]}>
            {CAP_TABLE_ITEMS.map((item, i) => (
              ...
              >
                ...
                <Text style={[styles.capEntity, { color: colors.cream }]}>
                  {item.entity}
                </Text>
                <Text style={[styles.capOwnership, { color: item.color }]}>
                  {item.ownership}
                </Text>
              </View>
            ))}
            ...
            {STRATEGIC_PRIORITIES.map((p) => (
              ...
              >
                ...
                <View style={styles.priorityContent}>
                  <Text style={[styles.priorityTitle, { color: colors.cream }]}>
                    {p.title}
                  </Text>
        ...
        >
          ...
          <Text style={[styles.contactBtnText, { color: colors.gold }]}>
