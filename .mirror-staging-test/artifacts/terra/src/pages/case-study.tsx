...
import { Building2, Clock, Users, DollarSign, CheckCircle, AlertTriangle, ArrowRight, BarChart3, Zap } from "lucide-react";
...
export default function CaseStudyPage() {
  return (
    <div style={{ padding: "1.5rem 1.5rem 4rem", maxWidth: "780px", fontFamily: "'Inter', system-ui, sans-serif" }}>
      <motion.div
      ...
      >
        ...
        <h1 style={{ fontSize: "1.625rem", fontWeight: "700", color: "hsl(38,12%,92%)", letterSpacing: "-0.018em", lineHeight: "1.2", marginBottom: "0.75rem" }}>
          {CASE_STUDY.title}
        </h1>
      ...
      {[
        {
          ...
          content: (
            <div>
              <p style={{ fontSize: "14px", fontWeight: "600", color: "hsl(38,12%,85%)", marginBottom: "0.5rem" }}>{CASE_STUDY.problem.headline}</p>
              <p style={{ fontSize: "12.5px", lineHeight: "1.65", color: "hsl(210,5%,54%)" }}>{CASE_STUDY.problem.body}</p>
            </div>
          ),
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              {[
                ...
                <div key={item.label}>
                  <p style={{ fontSize: "10px", fontWeight: "600", letterSpacing: "0.07em", textTransform: "uppercase", color: "hsl(210,5%,36%)", marginBottom: "0.25rem" }}>
                    {item.label}
                  </p>
        ...
        },
        {
          ...
          content: (
            <div>
              <p style={{ fontSize: "12.5px", color: "hsl(38,12%,78%)", marginBottom: "1rem", lineHeight: "1.6" }}>
                ...
                {CASE_STUDY.system.steps.map((step, idx) => (
                  <div key={idx} style={{ display: "flex", gap: "0.875rem" }}>
                    <div style={{
                      ...
                      background: `${TERRA_ACCENT}18`, border: `1px solid ${TERRA_ACCENT}30`,
        ...
        },
        {
          ...
          icon: ArrowRight,
          content: (
            <p style={{ fontSize: "12.5px", lineHeight: "1.7", color: "hsl(210,5%,54%)" }}>{CASE_STUDY.howItWorked}</p>
          ),
        },
        {
          i: 5,
          ...
          content: (
            <div>
              ...
              <div style={{ padding: "0.875rem", borderRadius: "0.5rem", background: `${TERRA_ACCENT}10`, border: `1px solid ${TERRA_ACCENT}25` }}>
                <p style={{ fontSize: "12px", lineHeight: "1.6", color: "hsl(38,12%,75%)" }}>{CASE_STUDY.outcome.keyMetric}</p>
              </div>
            </div>
          ),
        },
        ...
        },
        {
          ...
          icon: DollarSign,
          content: (
            <p style={{ fontSize: "13px", lineHeight: "1.7", color: "hsl(38,12%,76%)", fontWeight: "500" }}>{CASE_STUDY.whyItMatters}</p>
          ),
        },
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "0.625rem", marginBottom: "1rem" }}>
            <div style={{
              ...
              background: `${TERRA_ACCENT}15`, border: `1px solid ${TERRA_ACCENT}25`,
