...
export function MetricCard({ title, value, change, changeType = "neutral", icon: Icon, gradient = "from-terra-primary to-terra-accent", subtitle }: MetricCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <p className="text-xs text-terra-text-muted font-medium uppercase tracking-wider mb-1">{title}</p>
