...
const OWNER_DATA: OwnerRecord[] = [
  { name: "Unassigned", team: "Procurement", workflows: 1, approvals: 1, gaps: 1, value_at_risk: 320000, status: "gap" },
  { name: "Jordan Alvarez", team: "Revenue Operations", workflows: 1, approvals: 1, gaps: 0, value_at_risk: 840000, status: "overloaded" },
  { name: "Priya Mehta", team: "Finance", workflows: 1, approvals: 1, gaps: 0, value_at_risk: 450000, status: "normal" },
  { name: "Marcus Webb", team: "Customer Success", workflows: 1, approvals: 1, gaps: 0, value_at_risk: 480000, status: "overloaded" },
  { name: "Thomas Nguyen", team: "Legal", workflows: 1, approvals: 1, gaps: 0, value_at_risk: 2100000, status: "overloaded" },
  { name: "Elena Santos", team: "Product", workflows: 1, approvals: 0, gaps: 0, value_at_risk: 0, status: "normal" },
];
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="rounded-xl border" style={{ borderColor: "rgba(255,255,255,0.07)", background: "rgba(255,255,255,0.02)" }}>
        <div className="px-5 py-4 border-b" style={{ borderColor: "rgba(255,255,255,0.05)" }}>
          <span className="text-sm font-semibold text-white">Ownership Status — All Active Workflows</span>
        </div>
            ...
            <div key={owner.name} className="px-5 py-4 flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                {owner.status === "overloaded" && (
                  <button className="text-[10px] px-3 py-1.5 rounded-lg font-medium transition-all hover:opacity-80" style={{ color: "rgba(255,255,255,0.5)", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
                    Reassign
                  </button>
                )}
              </div>
