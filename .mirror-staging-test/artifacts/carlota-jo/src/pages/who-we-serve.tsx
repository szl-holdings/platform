...
const CLIENT_PROFILES = [
  {
    ...
    resolution: "Rosa becomes that single accountable person. She holds the operational picture across all properties, maintains consistent standards regardless of which residence you are in, and ensures that your family never experiences the gap between how things should be and how they are.",
    indicators: [
  ...
  },
  {
    ...
    resolution: "Rosa installs the systems and assumes the oversight role that estate environments require. She builds the vendor network, documents the standards, and maintains the operational infrastructure — so that the property performs to its full capability, consistently and without requiring the principal's time.",
    indicators: [
  ...
  },
  {
    ...
    resolution: "Rosa brings professional operational discipline to the residential environment — the same rigor that a well-run family office applies to investment governance. She reports clearly, documents thoroughly, and interfaces directly with family office advisors and legal counsel as required.",
    indicators: [
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p className="text-base font-light leading-relaxed mb-4" style={{ color: "var(--color-ink-600)" }}>
                Carlota Jo works with a deliberately limited client base. Every relationship begins with a genuine conversation about fit — and Rosa will decline engagements where she cannot deliver her full attention.
              </p>
              <p className="text-sm font-light leading-relaxed" style={{ color: "var(--color-ink-500)" }}>
                The clients who benefit most from Carlota Jo share a common characteristic: they require an exceptional standard and have reached the point where managing the operational layer of residential life themselves — or through an agency — is no longer tenable.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              {CLIENT_PROFILES.map((profile, i) => (
                ...
                >
                  <div className="lg:col-span-4">
                    ...
                    <p className="text-[12px] font-light leading-relaxed italic mb-5" style={{ color: "var(--color-gold)", opacity: 0.85 }}>
                      {profile.tagline}
                    </p>
                    <ul className="space-y-2.5">
                      {profile.indicators.map((ind) => (
                        <li key={ind} className="flex items-start gap-3">
                          ...
                          <span className="text-[12px] font-light" style={{ color: "var(--color-ink-600)" }}>{ind}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  <div className="lg:col-span-8 lg:pl-10">
                    <div className="mb-6">
                      <p className="text-[10px] font-medium tracking-[0.2em] uppercase mb-3" style={{ color: "var(--color-stone-400)" }}>
                        The challenge
                      </p>
                    ...
                    <div className="pl-5" style={{ borderLeft: "2px solid var(--color-gold)", borderLeftColor: "rgba(154,125,82,0.25)" }}>
                      <p className="text-[10px] font-medium tracking-[0.2em] uppercase mb-3" style={{ color: "var(--color-gold)", opacity: 0.75 }}>
                        How Carlota Jo responds
                      </p>
                      <p className="text-[13px] font-light leading-relaxed" style={{ color: "var(--color-ink-700)" }}>
                        {profile.resolution}
                      </p>
                    </div>
                  </div>
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p className="text-sm font-light leading-relaxed mb-4" style={{ color: "var(--color-ink-600)" }}>
                Carlota Jo does not advertise. The majority of new client relationships begin through introductions from existing clients, family offices, private wealth advisors, and estate attorneys who know Rosa's work firsthand.
              </p>
              <p className="text-sm font-light leading-relaxed mb-8" style={{ color: "var(--color-ink-500)" }}>
                If you believe a principal in your network would benefit from Rosa's services, she welcomes introductions. All conversations are handled with complete discretion.
              </p>
