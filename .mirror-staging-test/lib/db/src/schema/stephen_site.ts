...
export const insertStephenSiteContactSchema = createInsertSchema(stephenSiteContactsTable).omit({ id: true, createdAt: true });
...
export const insertStephenSiteTestimonialSchema = createInsertSchema(stephenSiteTestimonialsTable).omit({ id: true, createdAt: true });
...
export const insertStephenSiteCaseStudySchema = createInsertSchema(stephenSiteCaseStudiesTable).omit({ id: true, createdAt: true, updatedAt: true });
