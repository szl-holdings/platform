...
export function LanguageSwitcher({
  ...
  const styles = {
    light: {
      button: "text-[#6b6259] hover:text-[#1a1614] border border-[#d4ccc2] bg-transparent hover:border-[#9a9086]",
    ...
    dark: {
      button: "text-[rgba(245,240,232,0.5)] hover:text-[rgba(245,240,232,0.85)] border border-[rgba(245,240,232,0.1)] bg-transparent hover:border-[rgba(245,240,232,0.25)]",
    ...
    gold: {
      button: "text-[rgba(196,170,126,0.6)] hover:text-[rgba(196,170,126,0.9)] border border-[rgba(196,170,126,0.15)] bg-transparent hover:border-[rgba(196,170,126,0.35)]",
          ...
          {supportedLocales.map((locale) => (
            ...
            >
              ...
              {locale === currentLocale && (
                <span className="ms-auto text-[8px]">✓</span>
              )}
            </button>
          ))}
        </div>
