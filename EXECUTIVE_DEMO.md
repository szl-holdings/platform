...
**Companion docs:** [DEMO_STRATEGY.md](DEMO_STRATEGY.md) · [SALES_NARRATIVE.md](SALES_NARRATIVE.md) · [BUYER_PERSONAS.md](BUYER_PERSONAS.md)
...
| Is the data isolated? | Tenant data is scoped at the query layer through `org_id`. Bypass requires `super_admin` role with audit logging. See [TENANCY-MODEL.md](TENANCY-MODEL.md). |
...
| What does a deployment look like? | Pilot tier on production for the first 90 days, then convert to Standard or Enterprise. See [TENANT_TIERS.md](TENANT_TIERS.md). |
