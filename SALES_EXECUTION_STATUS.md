...
| **Researched ICP-fit targets** | **18** (see [TARGET_ACCOUNTS.md](TARGET_ACCOUNTS.md)) |
...
| Asset | Path | Status |
|---|---|---|
| Design partner program structure + pricing | [DESIGN_PARTNER_PROGRAM.md](DESIGN_PARTNER_PROGRAM.md) | Ready |
| Sales motion + qualification + handoff | [SALES_HANDOFF_GUIDE.md](SALES_HANDOFF_GUIDE.md) | Ready |
| Demo scripts (executive, operator, technical) | [DEMO_STRATEGY.md](DEMO_STRATEGY.md) and adjacent | Ready |
| Customer success playbook | [CUSTOMER_SUCCESS_PLAYBOOK.md](CUSTOMER_SUCCESS_PLAYBOOK.md) | Ready |
| ROI quantification | [ROI_MODEL.md](ROI_MODEL.md) | Ready |
| Researched target accounts (18 named) | [TARGET_ACCOUNTS.md](TARGET_ACCOUNTS.md) | Ready |
| Outreach sequences (4 verticals + follow-ups) | [OUTREACH_SEQUENCES.md](OUTREACH_SEQUENCES.md) | Ready |
| Design Partner Agreement template | [DESIGN_PARTNER_AGREEMENT.md](DESIGN_PARTNER_AGREEMENT.md) | Ready (legal review needed) |
| First-meeting kit (discovery → demo → DPA) | [FIRST_MEETING_KIT.md](FIRST_MEETING_KIT.md) | Ready |
...
| Tenant tiers, pricing, packaging | [TENANT_TIERS.md](TENANT_TIERS.md), [PRICING_PACKAGING.md](PRICING_PACKAGING.md) | Ready |
...
| Week | Founder action |
|---|---|
| Week 1 | Validate top 6 targets per vertical from [TARGET_ACCOUNTS.md](TARGET_ACCOUNTS.md). Confirm exec contacts. Identify warm intro paths. |
...
| Week 2 | Run first discovery calls. Use [FIRST_MEETING_KIT.md](FIRST_MEETING_KIT.md) verbatim. Honest no-fits at the end of the call. |
...
2. Update [DESIGN_PARTNER_PROGRAM.md](DESIGN_PARTNER_PROGRAM.md) Cohort 1 status table.
