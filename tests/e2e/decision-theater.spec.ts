...
async function openTheaterTab(page: Page) {
  const tab = page
    ...
    .first();
  await tab.click();
  await expect(page.locator('h2', { hasText: 'Decision Theater' }).first()).toBeVisible({
    timeout: 15000,
  });
}
...
async function clickStage(page: Page, label: string, expectedStep: number) {
  ...
  await expect(page.locator(`text=Step ${expectedStep} of 9`).first()).toBeVisible({
    timeout: 10000,
  });
}
...
test.describe('Decision Theater — Tab activation', () => {
  ...
  test('Decision Theater tab renders the canonical description subtitle', async ({ page }) => {
    ...
    await expect(page.locator('text=canonical governed decision loop').first()).toBeVisible({
      timeout: 10000,
    });
  });
  ...
  test('Decision Theater tab renders the scenario banner', async ({ page }) => {
    await goToTheater(page);
    await expect(page.locator('text=Cross-Domain Threat').first()).toBeVisible({ timeout: 10000 });
  });
...
test.describe('Decision Theater — Stage 1: Signal', () => {
  ...
  test('stage heading is Signal', async ({ page }) => {
    await expect(page.locator('h3', { hasText: 'Signal' }).first()).toBeVisible({ timeout: 10000 });
  });

  test('Prism Event Bus stat line is visible', async ({ page }) => {
    await expect(page.locator('text=Prism Event Bus').first()).toBeVisible({ timeout: 10000 });
  });
...
test.describe('Decision Theater — Stage 2: Context', () => {
  ...
  test('shows Step 2 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 2 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Cross-Domain Correlation panel is visible', async ({ page }) => {
    await expect(page.locator('text=Cross-Domain Correlation').first()).toBeVisible({
      timeout: 10000,
    });
  });

  test('Event Fabric stat line is visible', async ({ page }) => {
    await expect(page.locator('text=Event Fabric').first()).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe('Decision Theater — Stage 3: Recommendation', () => {
  ...
  test('shows Step 3 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 3 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Recommended Actions section is visible', async ({ page }) => {
    await expect(page.locator('text=Recommended Actions').first()).toBeVisible({ timeout: 10000 });
  });

  test('Source Attribution section is visible', async ({ page }) => {
    await expect(page.locator('text=Source Attribution').first()).toBeVisible({ timeout: 10000 });
  });

  test('Correlation ID is shown in the recommendation card', async ({ page }) => {
    await expect(page.locator('text=Correlation ID').first()).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe('Decision Theater — Stage 4: Simulation', () => {
  ...
  test('shows Step 4 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 4 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Monte Carlo iterations count is visible', async ({ page }) => {
    await expect(page.locator('text=iterations').first()).toBeVisible({ timeout: 10000 });
  });

  test('Output Distributions panel is visible', async ({ page }) => {
    await expect(page.locator('text=Output Distributions').first()).toBeVisible({ timeout: 10000 });
  });

  test('Input Sensitivity section is visible', async ({ page }) => {
    await expect(page.locator('text=Input Sensitivity').first()).toBeVisible({ timeout: 10000 });
  });
...
test.describe('Decision Theater — Stage 5: Policy', () => {
  ...
  test('shows Step 5 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 5 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Policy Evaluation panel is visible', async ({ page }) => {
    await expect(page.locator('text=Policy Evaluation').first()).toBeVisible({ timeout: 10000 });
  });
  ...
  test('ALLOW or DENY verdict badge is rendered', async ({ page }) => {
    ...
    const eitherVisible =
      (await allow.isVisible().catch(() => false)) || (await deny.isVisible().catch(() => false));
    expect(eitherVisible).toBe(true);
  });

  test('Simulation Trace section is visible', async ({ page }) => {
    await expect(page.locator('text=Simulation Trace').first()).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe('Decision Theater — Stage 6: Execution', () => {
  ...
  test('shows Step 6 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 6 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Execution Log heading is visible', async ({ page }) => {
    await expect(page.locator('text=Execution Log').first()).toBeVisible({ timeout: 10000 });
  });
...
test.describe('Decision Theater — Stage 7: Proof', () => {
  ...
  test('shows Step 7 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 7 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Proof Chain Record panel is visible', async ({ page }) => {
    await expect(page.locator('text=Proof Chain Record').first()).toBeVisible({ timeout: 10000 });
  });

  test('Audit Trail panel is visible', async ({ page }) => {
    await expect(page.locator('text=Audit Trail').first()).toBeVisible({ timeout: 10000 });
  });

  test('Chain ID field is displayed', async ({ page }) => {
    await expect(page.locator('text=Chain ID').first()).toBeVisible({ timeout: 10000 });
  });

  test('Input Sources section is shown', async ({ page }) => {
    await expect(page.locator('text=Input Sources').first()).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe('Decision Theater — Stage 8: Outcome', () => {
  ...
  test('shows Step 8 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 8 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Predicted vs Actual heading is visible', async ({ page }) => {
    await expect(page.locator('text=Predicted vs Actual').first()).toBeVisible({ timeout: 10000 });
  });

  test('Cost Variance metric is displayed', async ({ page }) => {
    await expect(page.locator('text=Cost Variance').first()).toBeVisible({ timeout: 10000 });
  });

  test('Resolution Variance metric is displayed', async ({ page }) => {
    await expect(page.locator('text=Resolution Variance').first()).toBeVisible({ timeout: 10000 });
  });

  test('Outcome ID field is shown', async ({ page }) => {
    await expect(page.locator('text=Outcome ID').first()).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe('Decision Theater — Stage 9: Learning', () => {
  ...
  test('shows Step 9 of 9 header', async ({ page }) => {
    await expect(page.locator('text=Step 9 of 9').first()).toBeVisible({ timeout: 10000 });
  });

  test('Confidence Calibration section is visible', async ({ page }) => {
    await expect(page.locator('text=Confidence Calibration').first()).toBeVisible({
      timeout: 10000,
    });
  });

  test('System Updates section is visible', async ({ page }) => {
    await expect(page.locator('text=System Updates').first()).toBeVisible({ timeout: 10000 });
  });

  test('Decision Memory Updated banner is visible', async ({ page }) => {
    await expect(page.locator('text=Decision Memory Updated').first()).toBeVisible({
      timeout: 10000,
    });
  });

  test('Detected Patterns section is visible', async ({ page }) => {
    await expect(page.locator('text=Detected Patterns').first()).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe('Decision Theater — Next/Prev boundaries', () => {
  ...
  test('nav-prev button is enabled and shows adjacent label from any non-first stage', async ({
    page,
  }) => {
    await goToTheater(page);
    await clickStage(page, 'Simulation', 4);
...
test.describe('Decision Theater — Progress bar stage jumping', () => {
  for (const { label, step } of STAGES) {
    test(`clicking "${label}" in the progress bar jumps to step ${step}`, async ({ page }) => {
      ...
      await expect(page.locator('h3', { hasText: label }).first()).toBeVisible({ timeout: 10000 });
    });
  }
...
test.describe('Decision Theater — Guided Demo controls', () => {
  ...
  test('clicking Guided Demo shows the auto-advancing indicator text', async ({ page }) => {
    await goToTheater(page);
    await page.locator("button[title='Start guided demo']").click();
    await expect(page.locator('text=Auto-advancing').first()).toBeVisible({ timeout: 10000 });
  });
  ...
  test('clicking Pause while in demo mode reverts button to Guided Demo', async ({ page }) => {
    ...
    await expect(page.locator("button[title='Start guided demo']").first()).toBeVisible({
      timeout: 10000,
    });
  });
  ...
  test('Reset during guided demo stops the demo and returns to stage 1', async ({ page }) => {
    ...
    await expect(page.locator("button[title='Pause guided demo']")).not.toBeVisible({
      timeout: 5000,
    });
  });
});
