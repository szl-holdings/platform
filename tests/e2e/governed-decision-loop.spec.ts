...
test.describe("Governed Decision Loop — Page shell", () => {
  ...
  test("page renders the Lyte · Governed Decision Loop label", async ({
    page,
  }) => {
    await goToLoop(page);
    const label = page.locator(
      "text=Lyte · Governed Decision Loop"
    );
    await expect(label).toBeVisible({ timeout: 15000 });
  });

  test("Demo Scenario bar is visible with Maritime Fleet Command label", async ({
    page,
  }) => {
    await goToLoop(page);
    ...
    await expect(
      page.locator("text=Maritime Fleet Command").first()
    ).toBeVisible({ timeout: 10000 });
  });
...
test.describe("Governed Decision Loop — Step 1: Signal", () => {
  ...
  test("step header shows 'Step 1: Signal'", async ({ page }) => {
    await expect(
      page.locator("text=Step 1: Signal").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("signal title mentions fleet ETA compliance", async ({ page }) => {
    await expect(
      page.locator("text=Fleet ETA compliance gap").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("affected vessels M/V Meridian, M/V Catalyst, M/V Horizon are listed", async ({
    page,
  }) => {
  ...
  test("AIS position deviation evidence is shown", async ({ page }) => {
    await expect(
      page.locator("text=AIS position deviation").first()
    ).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe("Governed Decision Loop — Step 2: Context", () => {
  ...
  test("step header shows 'Step 2: Context'", async ({ page }) => {
    await expect(
      page.locator("text=Step 2: Context").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Cross-Domain Intelligence section is visible", async ({ page }) => {
    await expect(
      page.locator("text=Cross-Domain Intelligence").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("Enrichment Sources section is visible", async ({ page }) => {
    await expect(
      page.locator("text=Enrichment Sources").first()
    ).toBeVisible({ timeout: 10000 });
  });
...
test.describe("Governed Decision Loop — Step 3: Recommendation", () => {
  ...
  test("step header shows 'Step 3: Recommendation'", async ({ page }) => {
    await expect(
      page.locator("text=Step 3: Recommendation").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("confidence score 82% is displayed within the recommendation card", async ({
    page,
  }) => {
  ...
  test("model attribution szl-ops-advisor-v3 is visible", async ({ page }) => {
    await expect(
      page.locator("text=szl-ops-advisor-v3").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("reroute recommendation text is displayed", async ({ page }) => {
    await expect(
      page.locator("text=Authorize fuel surcharge pass-through").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Reasoning Chain is visible", async ({ page }) => {
    await expect(
      page.locator("text=Reasoning Chain").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("SLA penalty reasoning is listed", async ({ page }) => {
    await expect(
      page.locator("text=2.1M SLA penalty").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Alternative Considered section is visible", async ({ page }) => {
    await expect(
      page.locator("text=Alternative Considered").first()
    ).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe("Governed Decision Loop — Step 5: Policy Gate", () => {
  ...
  test("step header shows 'Step 5: Policy Gate'", async ({ page }) => {
    await expect(
      page.locator("text=Step 5: Policy Gate").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Covenant Policy evaluations are listed", async ({ page }) => {
    await expect(
      page.locator("text=Covenant Policy").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("signal ingestion audit entry is shown", async ({ page }) => {
    await expect(
      page.locator("text=Signal SIG-4821 ingested").first()
    ).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe("Governed Decision Loop — Step 6: Approval", () => {
  ...
  test("step header shows 'Step 6: Approval'", async ({ page }) => {
    await expect(
      page.locator("text=Step 6: Approval").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Fleet Operations Lead approver Marcus Chen is shown", async ({
    page,
  }) => {
  ...
  test("Finance Controller approver Aisha Kamara is shown", async ({
    page,
  }) => {
  ...
  test("approval chain shows three approvers", async ({ page }) => {
    ...
    await expect(
      page.locator("text=Fleet Operations Lead").first()
    ).toBeVisible({ timeout: 10000 });
    await expect(
      page.locator("text=Finance Controller").first()
    ).toBeVisible({ timeout: 10000 });
    await expect(
      page.locator("text=CEO").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("approval comments are visible", async ({ page }) => {
    await expect(
      page.locator("text=Reroute is the right call").first()
    ).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe("Governed Decision Loop — Step 7: Execution", () => {
  ...
  test("step header shows 'Step 7: Execution'", async ({ page }) => {
    await expect(
      page.locator("text=Step 7: Execution").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Workflow Execution heading is visible", async ({ page }) => {
    await expect(
      page.locator("text=Workflow Execution").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("Authorization verified step is listed", async ({ page }) => {
    await expect(
      page.locator("text=Authorization verified").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Reroute order dispatched step is listed", async ({ page }) => {
    await expect(
      page.locator("text=Reroute order dispatched").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Client notification sent step is listed", async ({ page }) => {
    await expect(
      page.locator("text=Client notification sent").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Audit trail sealed step is listed", async ({ page }) => {
    await expect(
      page.locator("text=Audit trail sealed").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("total execution duration 4.2s is shown within the execution panel", async ({
    page,
  }) => {
  ...
  test("5/5 steps completion count is shown within the execution panel", async ({
    page,
  }) => {
    const execPanel = page
      .locator("div")
...
test.describe("Governed Decision Loop — Step 8: Proof Chain", () => {
  ...
  test("step header shows 'Step 8: Proof Chain'", async ({ page }) => {
    await expect(
      page.locator("text=Step 8: Proof Chain").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("model attribution szl-ops-advisor-v3 appears in proof chain", async ({
    page,
  }) => {
    await expect(
      page.locator("text=szl-ops-advisor-v3").first()
  ...
  test("Operational Recommendation content type is shown", async ({
    page,
  }) => {
    await expect(
      page.locator("text=Operational Recommendation").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("Monte Carlo Simulation Result content type is shown", async ({
    page,
  }) => {
    await expect(
      page.locator("text=Monte Carlo Simulation Result").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("AIS Position Feed input source is shown", async ({ page }) => {
    await expect(
      page.locator("text=AIS Position Feed").first()
    ).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe("Governed Decision Loop — Step 9: Outcome", () => {
  ...
  test("step header shows 'Step 9: Outcome'", async ({ page }) => {
    await expect(
      page.locator("text=Step 9: Outcome").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("outcome result ACHIEVED is displayed", async ({ page }) => {
    await expect(
      page.locator("text=ACHIEVED").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("$2.1M protected is shown in actual impact", async ({ page }) => {
    await expect(
      page.locator("text=$2.1M protected").first()
    ).toBeVisible({ timeout: 10000 });
  });
  ...
  test("operator feedback note is visible", async ({ page }) => {
    await expect(
      page.locator("text=Reroute executed cleanly").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("downstream impact (contract renewal) is shown", async ({ page }) => {
    await expect(
      page.locator("text=contract renewal").first()
    ).toBeVisible({ timeout: 10000 });
  });
});
...
test.describe("Governed Decision Loop — Navigation", () => {
  ...
  test("Previous is enabled after advancing to Recommendation", async ({
    page,
  }) => {
    await clickStep(page, "Recommendation");
    const prevBtn = page.locator("button", { hasText: /previous/i });
  ...
  test("clicking a step indicator dot jumps directly to that step", async ({
    page,
  }) => {
...
test.describe("Governed Decision Loop — Full nine-step regression", () => {
  test("walks through all nine steps via Next button", async ({ page }) => {
    ...
    // Step 1 — Signal
    await expect(
      page.locator("text=SIG-4821").first()
    ...
    await next.click();
    await expect(
      page.locator("text=REC-0421").first()
    ).toBeVisible({ timeout: 10000 });
    ...
    await next.click();
    await expect(
      page.locator("text=Marcus Chen").first()
    ).toBeVisible({ timeout: 10000 });
    ...
    await next.click();
    await expect(
      page.locator("text=PF-9041").first()
    ).toBeVisible({ timeout: 10000 });

    // Step 9 — Outcome
    await next.click();
    await expect(
      page.locator("text=OUT-2104").first()
    ).toBeVisible({ timeout: 10000 });
...
test.describe("Governed Decision Loop — Demo scenario bar", () => {
  ...
  test("clicking 5-min route reveals demo route beats", async ({ page }) => {
    ...
    await expect(
      page.locator("text=5-Minute Demo Route").first()
    ).toBeVisible({ timeout: 10000 });
  });

  test("5-min route shortcuts include Policy Gate and Outcome", async ({
    page,
  }) => {
    const toggleBtn = page.locator("button", { hasText: /5-min route/i });
    await toggleBtn.click();
    ...
    await expect(
      page.locator("text=Policy Gate").first()
    ).toBeVisible({ timeout: 10000 });
    await expect(
      page.locator("text=Outcome").first()
    ).toBeVisible({ timeout: 10000 });
  });
});
