...
const TARGETS: ArtifactTarget[] = [
  { slug: 'a11oy',      path: '/a11oy/',      brand: /A11oy|Enterprise Execution/i,            shotFile: '01-a11oy.jpg',      required: true  },
  { slug: 'sentra',     path: '/sentra/',     brand: /Sentra|Cyber Resilience/i,               shotFile: '02-sentra.jpg',     required: true  },
  { slug: 'terra',      path: '/terra/',      brand: /Terra|Real Estate|Property/i,            shotFile: '03-terra.jpg',      required: false },
  { slug: 'carlota-jo', path: '/carlota-jo/', brand: /Carlota Jo|Consulting/i,                 shotFile: '04-carlota-jo.jpg', required: false },
  { slug: 'counsel',    path: '/counsel/',    brand: /Counsel|Legal Matter|Legal Command/i,    shotFile: '05-counsel.jpg',    required: false },
  { slug: 'vessels',    path: '/vessels/',    brand: /Vessels|Maritime|Fleet/i,                shotFile: '06-vessels.jpg',    required: false },
];
