...
vi.mock('@szl-holdings/services', () => ({
  services: {
    ...
    jira: {
      ...
      sync: vi.fn(() =>
        Promise.resolve({ synced: 0, projects: 0, issues: 0, timestamp: new Date().toISOString() }),
      ),
    },
  },
}));
...
describe('Integration Routes', () => {
  ...
  beforeEach(async () => {
    vi.clearAllMocks();
    integrationsRouter = (await import('../../artifacts/api-server/src/routes/integrations'))
      .default;
  });
