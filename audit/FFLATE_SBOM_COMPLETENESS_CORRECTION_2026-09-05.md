...
- **test_results:**
  - `pnpm install --frozen-lockfile --ignore-scripts` — exit `0`; the frozen dependency graph installed and the corrected 0.9.12 tarball passed integrity verification.
