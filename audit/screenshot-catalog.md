...
## P0 Series-A product wiring UI evidence - 2026-08-11

These images were captured from the local production-build preview at
`http://127.0.0.1:4111`. They are Level 4 local browser evidence only: they do
not establish a deployment, hosted-source parity, certification, authenticated
operational data, or production operation. The in-app capture excludes browser
chrome, so the exact route is recorded in every catalog entry.

| Filename | Route | Surface | Capture date | Captured by | Workcell | Proof level | Status | Notes |
|----------|-------|---------|--------------|-------------|----------|-------------|--------|-------|
| `docs/assets/screenshots/current/a11oy-start-320px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/start` | Investor/developer product journey - 320 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Active-prototype and evidence boundaries are visible. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-start-390px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/start` | Investor/developer product journey - 390 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Active-prototype and evidence boundaries are visible. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-start-768px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/start` | Investor/developer product journey - 768 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Active-prototype and evidence boundaries are visible. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-start-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/start` | Investor/developer product journey - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Active-prototype and evidence boundaries are visible. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-start-1728px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/start` | Investor/developer product journey - 1728 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Active-prototype and evidence boundaries are visible. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcells-320px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/workcells` | Seeded Workcell registry - 320 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Repository records are explicitly labeled `DEMO`; workflow state is not presented as operational availability. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcells-390px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/workcells` | Seeded Workcell registry - 390 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Repository records are explicitly labeled `DEMO`; workflow state is not presented as operational availability. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcells-768px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/workcells` | Seeded Workcell registry - 768 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Repository records are explicitly labeled `DEMO`; workflow state is not presented as operational availability. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcells-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/workcells` | Seeded Workcell registry - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Repository records are explicitly labeled `DEMO`; workflow state is not presented as operational availability. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcells-1728px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/workcells` | Seeded Workcell registry - 1728 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Repository records are explicitly labeled `DEMO`; workflow state is not presented as operational availability. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcell-detail-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/workcells/wc-001` | Seeded Workcell detail - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture of a deterministic repository fixture explicitly labeled `DEMO`, not an authenticated execution. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcell-replay-detail-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/workcells/wc-001/replay` | Seeded Workcell replay detail - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture of deterministic replay demonstration data. It is not a live receipt or execution witness. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-workcell-replay-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/replay` | Seeded replay registry - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture of repository-seeded replay demonstrations. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-demo-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/demo` | Interactive seeded demonstration - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. The surface is a deterministic demonstration and is not authenticated operational evidence. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-pce-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/pce` | PCE demonstration registry - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture of modeled PCE entries; no production execution or policy decision is claimed. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-governance-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/governance` | Governance demonstration - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture of modeled controls and seeded demonstrations, not certification or production enforcement evidence. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-proof-ledger-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/proof` | Demonstration Proof Ledger - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture of repository demonstration receipts; cryptographic validity or operational provenance is not established. Route is recorded because browser chrome is not included. |
| `docs/assets/screenshots/current/a11oy-trust-center-1366px-2026-08-11.jpg` | `http://127.0.0.1:4111/a11oy/trust` | Prototype Trust Center - 1366 CSS px | 2026-08-11 | Codex | `P0-SERIES-A-PRODUCT-WIRING-20260811` | 4 | current | Live local built-preview capture. Prototype and evidence-state qualifiers remain visible; no certification or production claim is made. Route is recorded because browser chrome is not included. |
