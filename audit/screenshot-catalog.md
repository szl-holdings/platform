...
## P0 Series A successor UI evidence - 2026-08-11

| Filename | Route | Width | Capture date | Captured by | Workcell | Proof level | Status | Notes |
|----------|-------|------:|--------------|-------------|----------|-------------|--------|-------|
| `docs/assets/screenshots/current/a11oy-series-a-start-320-2026-08-11.png` | `http://127.0.0.1:4128/a11oy/start` | 320 | 2026-08-11 | Codex (local Playwright) | `P0-SERIES-A-PRODUCT-WIRING-20260811` | DEMONSTRATION/LOCAL_SOURCE | current source proof | Six views, truth states, 2x2 mobile nav, and system-font fallback visible; SHA-256 `3FEEF96D2ABC2CCADB8AE117A37DEC9FB785EC794BD08EF7442A3111009AB84E`. |
| `docs/assets/screenshots/current/a11oy-series-a-start-390-2026-08-11.png` | `http://127.0.0.1:4128/a11oy/start` | 390 | 2026-08-11 | Codex (local Playwright) | `P0-SERIES-A-PRODUCT-WIRING-20260811` | DEMONSTRATION/LOCAL_SOURCE | current source proof | Narrow mobile composition; SHA-256 `4822BAE2B2B3C118CF8527078CA0742C363C92D3D3BF7A17D7F50210FD5F64BD`. |
| `docs/assets/screenshots/current/a11oy-series-a-start-768-2026-08-11.png` | `http://127.0.0.1:4128/a11oy/start` | 768 | 2026-08-11 | Codex (local Playwright) | `P0-SERIES-A-PRODUCT-WIRING-20260811` | DEMONSTRATION/LOCAL_SOURCE | current source proof | Tablet composition; SHA-256 `EF5D1298D865F01BB4E8F64A932A323C97D66F4D978D4821A94D77D5E5826511`. |
| `docs/assets/screenshots/current/a11oy-series-a-start-1366-2026-08-11.png` | `http://127.0.0.1:4128/a11oy/start` | 1366 | 2026-08-11 | Codex (local Playwright) | `P0-SERIES-A-PRODUCT-WIRING-20260811` | DEMONSTRATION/LOCAL_SOURCE | current source proof | Laptop/desktop composition; SHA-256 `E2EBA6DCC1293ACFF47957AC68647DA1D18A66B15F07B49373F2D6D82DE14547`. |
| `docs/assets/screenshots/current/a11oy-series-a-start-1728-2026-08-11.png` | `http://127.0.0.1:4128/a11oy/start` | 1728 | 2026-08-11 | Codex (local Playwright) | `P0-SERIES-A-PRODUCT-WIRING-20260811` | DEMONSTRATION/LOCAL_SOURCE | current source proof | Wide-desktop composition; SHA-256 `C4B9C902FCBAFA30B4F0F887098056751EBA9D23622DB15799962518D628CD3B`. |
...
The immutable captures were copied without byte changes from the original audit location into the
required current-proof directory; the hashes above remain unchanged. They prove local layout and
claim presentation only; they do not prove merge, deployment, production operation, customer
data, or live service parity.
