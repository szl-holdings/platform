...
- **test_results:**
  ...
  - **post_change:** Recorded in [Post-change results](#post-change-results); scoped Markdown, changed-file, secret-pattern, and diff checks passed, while the documented repository-wide baseline failures were no worse.
...
- **recorded_at:** 2026-07-26T00:56:40.4377458-04:00
