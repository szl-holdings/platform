...
- **test_results:**
  ...
  - `pnpm audit --json --audit-level=moderate` — exit `0`; no Critical, High, Moderate, or Low advisory remains in the resolved graph.
...
- reviewed predecessor head: `574b7caa5de64fb814dfd43ba5a019b746726fbf`
