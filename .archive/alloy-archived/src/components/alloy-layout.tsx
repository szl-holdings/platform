...
const CREATIVE_NAV = [
  { href: "/creative", label: "Campaign Hub", icon: Film },
  { href: "/creative/brand-voice", label: "Brand Voice", icon: Mic },
  { href: "/creative/content-calendar", label: "Content Calendar", icon: Calendar },
  { href: "/creative/ai-studio", label: "AI Studio", icon: Wand2 },
];
