...
**Companion docs:** [SUPPORT_OPERATIONS.md](SUPPORT_OPERATIONS.md) · [INCIDENT_COMMAND_PLAYBOOK.md](INCIDENT_COMMAND_PLAYBOOK.md) · [CUSTOMER_ESCALATION_MATRIX.md](CUSTOMER_ESCALATION_MATRIX.md)
