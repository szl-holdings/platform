...
**Companion docs:** [CATEGORY_POSITIONING.md](CATEGORY_POSITIONING.md) · [BUYER_PERSONAS.md](BUYER_PERSONAS.md) · [OBJECTION_HANDLING.md](OBJECTION_HANDLING.md)
...
Lead with the **category claim** + **team proof** + **architectural proof** + **commercial proof**. Cover the design partner motion. Skip the loop unless asked. Close with the moat — see [MOAT_MAP.md](MOAT_MAP.md).

### To a partner (advisory firm, integrator)

Lead with the **category claim** + **domain proof**. Cover the partner motion in [GO_TO_MARKET_MOTION.md](GO_TO_MARKET_MOTION.md). Close with referral mechanics.
...
| Claim | Verifiable at |
|-------|--------------|
| "Six primitives" | [PLATFORM_PRIMITIVES.md](PLATFORM_PRIMITIVES.md) |
| "11-role RBAC" | [ACCESS-CONTROL-MATRIX.md](ACCESS-CONTROL-MATRIX.md) |
| "Tenant isolation enforced at query layer" | [TENANCY-MODEL.md](TENANCY-MODEL.md) |
| "Proof Chain immutable" | [PLATFORM_PRIMITIVES.md](PLATFORM_PRIMITIVES.md), live demo |
| "Five domain packs" | [DOMAIN_PACK_CATALOG.md](DOMAIN_PACK_CATALOG.md), public site |
| "Pricing published" | [PRICING_PACKAGING.md](PRICING_PACKAGING.md), `/pricing` page |
| "Known Gaps published" | [KNOWN-GAPS.md](KNOWN-GAPS.md) |
