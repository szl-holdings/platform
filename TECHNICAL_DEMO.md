...
**Companion docs:** [DEMO_STRATEGY.md](DEMO_STRATEGY.md) · [TECHNICAL_DILIGENCE_PACKET.md](TECHNICAL_DILIGENCE_PACKET.md) · [TRUST_CENTER_INDEX.md](TRUST_CENTER_INDEX.md)
...
| Known Gaps | [KNOWN-GAPS.md](KNOWN-GAPS.md) | Pinned |
| Diligence packet | [TECHNICAL_DILIGENCE_PACKET.md](TECHNICAL_DILIGENCE_PACKET.md) | Ready to send |
...
Walk [TENANCY-MODEL.md](TENANCY-MODEL.md).
...
Walk [ACCESS-CONTROL-MATRIX.md](ACCESS-CONTROL-MATRIX.md).
...
Walk [AI_GOVERNANCE.md](AI_GOVERNANCE.md). Cover:
...
Open [INCIDENT_RESPONSE.md](INCIDENT_RESPONSE.md). Walk the severity matrix and the response timeline.

Open [KNOWN-GAPS.md](KNOWN-GAPS.md). Walk the open P1 and P2 items.
...
- [TECHNICAL_DILIGENCE_PACKET.md](TECHNICAL_DILIGENCE_PACKET.md)
...
| How are secrets managed? | All secrets via environment variables. No secrets in source. Secret scanning is being added to CI as part of the open KG011/KG012 work. See [SECRETS_SETUP.md](SECRETS_SETUP.md). |
| What about the AI eval pipeline? | Trace capture lives in `lib/ai-engine/src/evals/trace-capture.ts`. Tenant-scoped retrieval; org-scoped dashboard. See [AI_GOVERNANCE.md](AI_GOVERNANCE.md). |
...
| What is your DR posture? | Nightly snapshots, cross-region copy at Pro and Enterprise. See [BACKUP-RESTORE.md](BACKUP-RESTORE.md). |
| What does production deployment look like? | See [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) for hosting topology by edition. Production slot for the first commercial tenants is being stood up; status is tracked honestly in the operations docs. |
...
- Do not hide known gaps — the [KNOWN-GAPS.md](KNOWN-GAPS.md) file is a deliverable, not a risk
- Do not over-claim certifications we don't hold
- Do not improvise on AI governance; walk [AI_GOVERNANCE.md](AI_GOVERNANCE.md)
