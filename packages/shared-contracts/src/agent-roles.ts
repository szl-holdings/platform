...
export const AGENT_ROLE_CONTRACTS: Record<AgentRoleId, AgentRoleContract> = {
  MissionPlanner: {
    ...
    description:
      'Decomposes high-level goals into executable task trees and coordinates sub-agent delegation.',
  ...
  MemoryCustodian: {
    ...
    description:
      'Manages working memory, episodic memory, and structured fact storage. Enforces freshness TTL.',
    defaultAutonomyMode: 'supervised',
    capabilities: [
      { toolId: 'memory.read', permitted: true },
  ...
  ToolOrchestrator: {
    ...
    description:
      'Selects, sequences, and validates tool calls. Handles retries, timeouts, and schema validation.',
    defaultAutonomyMode: 'supervised',
    capabilities: [
  ...
  PolicyGuardian: {
    ...
    description:
      'Evaluates planned actions against policy rules. Issues allow/require-approval/block verdicts.',
  ...
  ExecutionSupervisor: {
    ...
    description:
      'Monitors live runs, detects anomalies, and can halt or escalate runs that breach policy.',
    defaultAutonomyMode: 'supervised',
    capabilities: [
  ...
  EvidenceSynthesizer: {
    ...
    description:
      'Compiles retrieval results, tool outputs, and citations into structured evidence packages.',
    defaultAutonomyMode: 'full',
    capabilities: [
  ...
  Evaluator: {
    ...
    description:
      'Runs evaluation suites against agent outputs. Reports scores, regressions, and benchmarks.',
    defaultAutonomyMode: 'full',
    capabilities: [
