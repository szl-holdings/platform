...
const VesselsCharterNegotiationScenario: ScenarioDefinition = {
  ...
  domain: "vessels",
  description: "Agent evaluates competing charter party offers for a handymax vessel and recommends the optimal fixture. Tests commercial reasoning, rate benchmarking against Baltic indices, and clause risk assessment.",
      ...
      agentInputs: [
        {
          ...
          ownerConstraints: ["avoid_west_africa_rainy_season", "no_fertilizer_without_hold_cleaning_allowance"],
        },
      ],
      groundTruth: {
        ...
        rejectionReason: "CTR-B fertilizer cargo triggers hold-cleaning cost without allowance; deviation clause creates unquantified liability",
      ...
      agentInputs: [
        {
          ...
          recapText: "MV Atlantic Trader / CTR-A: 14200/day, 30 days, Amsterdam/Casablanca, laycan 15-17 Dec, demurrage USD 8,000/day, SHINC laytime, free pratique on arrival, WIBON WIPON WIFCON",
          focusAreas: ["laytime_calculation", "demurrage_exposure", "force_majeure", "off_hire_triggers"],
        },
      ],
      groundTruth: {
        layTimeBasis: "SHINC",
        ...
        redFlags: [],
        clauseRisks: ["WIBON: vessel cannot refuse a berth if weather turns; exposure if Amsterdam port closes"],
        overallRisk: "low",
        auditPassed: true,
...
const TerraPortfolioStressScenario: ScenarioDefinition = {
  ...
  domain: "terra",
  description: "Agent models the impact of a 200bps rate shock on a mixed-use real estate portfolio and recommends repositioning actions. Tests DCF sensitivity, LTV covenant breach detection, and disposition prioritization.",
  ...
  snapshots: [
      ...
      agentInputs: [
        {
          ...
          assets: [
            { id: "TERRA-ASSET-001", type: "office", city: "London", currentValue: 85000000, currentLTV: 58, loanMaturity: "2027-03" },
            { id: "TERRA-ASSET-002", type: "logistics", city: "Amsterdam", currentValue: 62000000, currentLTV: 55, loanMaturity: "2028-06" },
            { id: "TERRA-ASSET-003", type: "retail-park", city: "Manchester", currentValue: 44000000, currentLTV: 68, loanMaturity: "2026-09" },
            { id: "TERRA-ASSET-004", type: "multifamily", city: "Berlin", currentValue: 97000000, currentLTV: 61, loanMaturity: "2028-12" },
            { id: "TERRA-ASSET-005", type: "office", city: "Paris", currentValue: 71000000, currentLTV: 67, loanMaturity: "2026-11" },
          ],
          outputRequirements: ["covenant_breach_flags", "revised_ltv_table", "disposition_priority_rank"],
        },
      ],
      groundTruth: {
    ...
    },
    {
      ...
      agentInputs: [
        {
          ...
          options: [
            ...
            { action: "refinance_and_hold", newLTV: 60, additionalEquityRequired: 5800000, holdPeriodYears: 3 },
      ...
      groundTruth: {
        ...
        rationale: "WALE below 2.5 years makes refinance difficult; JV dilutes returns without resolving covenant; sale proceeds cover debt and preserves fund NAV",
    ...
    },
    {
      ...
      groundTruth: {
        reportGenerated: true,
        sectionsRequired: ["executive-summary", "stress-scenario-assumptions", "asset-heat-map", "covenant-breach-detail", "disposition-plan", "sensitivity-table"],
        audienceTone: "board",
...
const TerraAssetValuationScenario: ScenarioDefinition = {
  ...
  domain: "terra",
  description: "Agent reconciles a 12% discrepancy between internal model valuation and third-party appraisal for a Grade-A office asset. Tests valuation methodology reasoning, assumption sensitivity, and flagging of appraisal override risk.",
...
const PrismSARFilingScenario: ScenarioDefinition = {
  ...
  domain: "prism",
  description: "Agent identifies suspicious transaction patterns across two accounts and guides the compliance team through the SAR preparation, internal escalation, and FinCEN submission workflow. Tests AML reasoning, threshold analysis, and reporting accuracy.",
      ...
      agentInputs: [
        {
          ...
          flaggedAccounts: [
            ...
            },
            {
              ...
              transactions: [
                { date: "2025-11-05", amount: 250000, type: "wire_in", currency: "USD", originCountry: "NG" },
                { date: "2025-11-06", amount: 248000, type: "wire_out", currency: "USD", destinationCountry: "AE" },
              ],
      ...
      agentInputs: [
        {
          ...
          transactionSummary: "Four cash deposits totalling $38,650 over 12 days, each below $10,000 CTR threshold",
          suspicionBasis: ["transactions_structured_to_avoid_CTR", "no_apparent_business_purpose", "high_risk_profile"],
...
const PrismComplianceBreachScenario: ScenarioDefinition = {
  ...
  domain: "prism",
  description: "A regulatory data breach notification scenario where the agent identifies GDPR breach severity, calculates the 72-hour reporting window, drafts the supervisory authority notification, and tracks remediation obligations. Tests regulatory deadline reasoning, severity classification, and notification quality.",
  ...
  snapshots: [
    {
      ...
      agentInputs: [
        {
          ...
          breachDescription: "Unauthorised access to CRM database via compromised service account. Attacker exfiltrated records for approximately 2,400 clients including names, email addresses, portfolio values, and national identification numbers.",
      ...
      groundTruth: {
        ...
        immediateActions: ["reset_all_service_account_credentials", "isolate_crm_system", "preserve_forensic_evidence"],
        confidence: 0.96,
      },
      metadata: {
      ...
      agentInputs: [
        {
          ...
          knownFacts: {
            ...
            measuresTaken: ["service_account_reset", "crm_isolation", "forensic_investigation_initiated"],
          },
        },
      ],
      groundTruth: {
    ...
    },
    {
      ...
      groundTruth: {
        ...
        exceptionRejectionReason: "encryption_was_not_in_place_at_breach_time_so_technical_measure_exception_does_not_apply",
        notificationDeadline: "without_undue_delay",
        notificationChannels: ["email", "secure_portal_message"],
        notificationContentRequired: ["nature_of_breach", "contact_of_dpo", "likely_consequences", "protective_measures_advised"],
