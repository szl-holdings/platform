...
describe('auditEventSchema', () => {
  ...
  it('accepts null actorUserId', () => {
    expect(auditEventSchema.parse({ ...valid, actorUserId: null }).actorUserId).toBeNull();
  });
  ...
  it('accepts null payloadJson', () => {
    expect(auditEventSchema.parse({ ...valid, payloadJson: null }).payloadJson).toBeNull();
  });
});
...
describe('canonicalEntityTypeSchema', () => {
  it('accepts known entity types', () => {
    ...
    expect(canonicalEntityTypeSchema.parse('organization')).toBe('organization');
  });
