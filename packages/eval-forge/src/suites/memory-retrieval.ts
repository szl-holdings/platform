...
export const memoryRetrievalSuite: EvalSuiteDef = {
  ...
  description: "Evaluates episodic and semantic memory retrieval: recall accuracy, recency weighting, and cross-session continuity.",
  domain: "memory",
  ...
  cases: [
    ...
    },
    {
      ...
      input: {
        ...
        persistedMemory: [
          { key: "q2-budget", value: 450000, session: "session-001" },
        ],
      },
      groundTruth: {
        minItems: 1,
