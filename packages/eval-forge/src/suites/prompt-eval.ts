...
export const promptEvalSuite: EvalSuiteDef = {
  ...
  name: "Prompt Eval",
  description: "Evaluates prompt quality, coherence, relevance, and instruction-following accuracy.",
  domain: "prompt",
  ...
  cases: [
    {
      ...
      input: {
        instruction: "Summarise the following quarterly earnings in 3 bullet points for an executive audience.",
        content: "Revenue $12.4M (+18% YoY). EBITDA margin 22%. Key growth drivers: cloud contracts and APAC expansion.",
      },
      groundTruth: {
    ...
    },
    {
      ...
      graderType: "prompt-eval",
      input: {
        instruction: "Classify the sentiment of the following text as positive, neutral, or negative.",
