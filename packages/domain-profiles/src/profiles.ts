...
export const DOMAIN_PROFILES: Record<DomainProfileId, DomainProfile> = {
  lyte: {
    profileId: "lyte",
    displayName: "Lyte",
    description: "Decision intelligence platform. Focuses on signal detection, cross-domain synthesis, and executive brief generation.",
    version: "1.0.0",
  ...
  vessels: {
    profileId: "vessels",
    displayName: "Vessels",
    description: "Maritime intelligence platform. Port data, vessel movements, and operational digests.",
    version: "1.0.0",
  ...
  terra: {
    profileId: "terra",
    displayName: "Terra",
    description: "Real estate intelligence platform. Property records, market data, comps, and risk assessment.",
    version: "1.0.0",
  ...
  aegis: {
    profileId: "aegis",
    displayName: "Aegis",
    description: "Investor pitch and portfolio intelligence. Risk scoring, governance tracking, and portfolio narratives.",
    version: "1.0.0",
  ...
  prism: {
    profileId: "prism",
    displayName: "PRISM",
    description: "Legal matter management platform. Case timelines, document retrieval, and matter intelligence.",
    version: "1.0.0",
    ...
    agentRoles: ["MissionPlanner", "RetrievalStrategist", "EvidenceSynthesizer", "PolicyGuardian", "ExecutionSupervisor"],
  },

  carlota: {
    profileId: "carlota",
    displayName: "Carlota",
    description: "Consulting services platform. Client engagements, deliverable tracking, and advisory content.",
    version: "1.0.0",
