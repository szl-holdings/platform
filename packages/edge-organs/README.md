...
Edge-Organs: WASI-RIKUQ house-watcher — single-pane observability + chaos/resilience.
...
## Honesty note
Chaos experiments are 2-person Yuyay gated. Health number is a computed aggregate, labeled.

## Install (editable, from monorepo root)
```bash
pip install -e packages/edge-organs
```
