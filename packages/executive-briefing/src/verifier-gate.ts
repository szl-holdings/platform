import { verify, type VerifierDecision } from "@workspace/verifier";
...
export function gateBrief(brief: Omit<StructuredExecutiveBrief, "id" | "generatedAt" | "verifierStatus" | "verifierFeedback" | "sourceTraceIds" | "briefingId">): GateResult {
  ...
  const requiredFields = ["headline", "situation", "whatWeBelieve", "whyCitations", "whatWeRecommend", "autonomyTier", "confidence"];
