/**
 * Demo Narrative 5: DOMAINE — Real Estate / Distress Diligence Lens
 *
 * Scenario: Apex Capital Partners — A Brooklyn multifamily property carries
 * an active lis pendens AND a recently filed tax lien. DOMAINE detects the
  ...
  entities: {
    ...
    context: {
      ...
      signals: [
        {
          source: 'Title',
          signal: 'Lis pendens active 136 days — Kings County Supreme Court — no cure plan filed',
        },
        {
          source: 'Tax',
          signal: 'NYC DOF tax lien filed 2026-04-13 for $147,000 — secondary lien position',
        },
        {
          source: 'Ownership',
          signal: 'GreenHouse Realty LLC — 4 other NYC properties — 2 also in distress',
        },
        {
          source: 'Lender Posture',
          signal:
            'Originating lender (Atlantic Trust Bank) flagged file for OREO desk on 2026-04-08',
        },
        {
          source: 'Comps (90-day)',
          signal:
            '3 comparable Flatbush multifamily trades — median $245/sqft — supports $2.85M valuation',
        },
        {
          source: 'Rent Roll',
          signal: '9 of 12 units occupied; 3 below-market leases offer $44K/yr upside post-renewal',
        },
        {
          source: 'Climate',
          signal: 'Coastal flood band C — moderate. No FEMA flood claim history.',
        },
        ...
        { source: 'Permits', signal: 'No open DOB violations. Last C of O issued 2018.' },
        {
          ...
          signal: "Lender's 3 prior outreach attempts unanswered — owner appears disengaged",
        },
        {
          source: 'Auction Calendar',
          signal: 'Likely auction window: 2026-07 to 2026-09 if no cure',
        },
      ],
    },
    recommendation: {
    ...
    approval: {
      ...
      decision: 'approved',
      note: 'Approved. Open the file. Send our standing-offer letter through Cohen & Park escrow. I want a fresh title abstract pulled before any number is signed. Also flag the other two GreenHouse properties for watchlist.',
    ...
    proofChain: {
      ...
      entries: [
        ...
        },
        {
          ...
          event: 'Owner counter received and LOI signed',
          actor: 'System',
          source: 'Cohen & Park escrow',
        },
      ],
      exportable: true,
    },
