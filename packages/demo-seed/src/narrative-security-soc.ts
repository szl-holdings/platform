  ...
  entities: {
    ...
    context: {
      ...
      signals: [
        ...
        { source: "Business", signal: "Auth Service handles 340,000 active sessions — blast radius: critical" },
      ],
    },
    recommendation: {
      id: "demo-rec-sec-001",
      agent: "Sentinel",
      action: "Immediate IP block for 14 flagged addresses; rate limiting on Auth Service; rotate 3 elevated session tokens; patch Auth Service to v2.9.0 within 24 hours",
      rationale:
