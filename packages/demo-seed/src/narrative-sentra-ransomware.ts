...
export const SENTRA_RANSOMWARE_NARRATIVE = {
  ...
  entities: {
    scadaServer: { entityId: "asset-scada-01", entityType: "cyber_asset" as const, displayName: "SCADA Production Server", domain: "security" as const },
    hmiWorkstation: { entityId: "asset-hmi-04", entityType: "cyber_asset" as const, displayName: "HMI Workstation - Line 4", domain: "security" as const },
    plcController: { entityId: "asset-plc-12", entityType: "cyber_asset" as const, displayName: "PLC Controller - Zone B", domain: "security" as const },
    c2Beacon: { entityId: "threat-c2-99", entityType: "indicator" as const, displayName: "Anomalous C2 Beacon", domain: "security" as const },
  },
  ...
  buildSignals(): Signal[] {
    ...
    return [
      createSignal({
        ...
        confidence: 0.92,
        severity: "critical",
        entityRefs: [this.entities.scadaServer, this.entities.hmiWorkstation, this.entities.plcController],
        rawPayload: { eventType: "encrypted_payload_detected", detectionEngine: "Sentra-OT-Shield", payloadEntropy: 7.9, filePattern: "random_extension_enc" },
      ...
      createSignal({
        ...
        rawPayload: { eventType: "c2_beaconing", destinationIp: "185.220.101.42", protocol: "HTTPS/443", packetSize: "uniform", frequency: "60s" },
      ...
      createSignal({
        ...
        rawPayload: { eventType: "backup_staleness", lastSuccessfulBackup: new Date(now - 72 * 3600_000).toISOString(), status: "failed", criticalSla: "24h" },
      ...
      createSignal({
        ...
        severity: "medium",
        entityRefs: [],
        rawPayload: { eventType: "control_drift", family: "Respond", controlId: "RS.RP-1", currentStatus: "degraded", evidence: "Incident response plan not updated for OT segment" },
  ...
  buildEvidenceItems(signals: Signal[]): EvidenceItem[] {
    return [
      createEvidenceItem({
        ...
        entityRefs: [this.entities.scadaServer, this.entities.hmiWorkstation, this.entities.plcController],
        summary: "High-entropy encrypted payload detected across 3 critical OT assets — indicative of active ransomware",
        confidence: 0.92,
        freshness: 0.95,
        weight: 0.45,
  ...
  buildRecommendation(signals: Signal[], evidenceItems: EvidenceItem[]): Recommendation {
    return createRecommendation({
      ...
      confidence: 0.91,
      freshness: 0.96,
      projectedImpact: "Network isolation contains ransomware spread to 3 identified OT assets, preserving $2.8M cost-avoidance window and maintaining production continuity.",
      projectedRisk: "Without isolation, SCADA and HMI breach containment within 4 hours — $2.8M estimated downtime and potential multi-site OT shutdown.",
