...
export const CARLOTA_JO_ESTATE_NARRATIVE = {
  ...
  entities: {
    property: { entityId: "property-castellano", entityType: "property" as const, displayName: "Castellano Estate", domain: "real-estate" as const },
    guest: { entityId: "guest-marchetti", entityType: "contact" as const, displayName: "The Marchetti Family", domain: "real-estate" as const },
  },
    ...
    return [
      ...
      createSignal({
        ...
        rawPayload: {
          ...
          openChecklistItems: 4,
          openItems: ["Pool heating activation", "Wine cellar temperature", "Master suite linen change", "Security access codes reset"],
        },
  ...
  buildEvidenceItems(signals: Signal[]): EvidenceItem[] {
    return [
      createEvidenceItem({
        ...
        entityRefs: [this.entities.property],
        summary: "Pool heating system offline — T-18h before VIP arrival. Guest comfort critically at risk.",
        confidence: 0.98,
        freshness: 0.92,
        weight: 0.35,
      ...
      createEvidenceItem({
        ...
        entityRefs: [this.entities.property],
        summary: "Wine cellar at 16°C — 3°C above 13°C target. Rare wine collection quality at risk.",
        confidence: 0.99,
        freshness: 0.95,
        weight: 0.3,
      ...
      createEvidenceItem({
        ...
        summary: "VIP arrival confirmed T-18h. 4 open checklist items. Estate readiness score: 60%.",
        confidence: 0.99,
        freshness: 0.97,
        weight: 0.25,
  ...
  buildRecommendation(signals: Signal[], evidenceItems: EvidenceItem[]): Recommendation {
    return createRecommendation({
      ...
      actionPayload: {
        dispatchOrders: [
          { vendor: "Pool Systems UAE", service: "Pool heating repair", etaHours: 4, priority: "critical" },
          { vendor: "ColdChain HVAC", service: "Wine cellar temperature correction", etaHours: 2, priority: "critical" },
      ...
      confidence: 0.97,
      freshness: 0.95,
      projectedImpact: "Dispatch resolves all 4 open items before VIP arrival, restoring estate readiness to 100% and protecting $45K guest-satisfaction revenue.",
      projectedRisk: "Without action, estate readiness remains at 60% — pool offline, cellar breach unresolved, and access codes unrotated — putting $45K of revenue at risk within 18 hours.",
