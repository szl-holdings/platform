...
export const COUNSEL_DEADLINE_NARRATIVE = {
  ...
  entities: {
    matter: { entityId: "matter-meridian-compliance-v3", entityType: "matter" as const, displayName: "Meridian Compliance v.3", domain: "legal" as const },
    outsideCounsel: { entityId: "firm-morrison-vance", entityType: "counsel_firm" as const, displayName: "Morrison & Vance LLP", domain: "legal" as const },
    discoveryRequest: { entityId: "obl-discovery-001", entityType: "obligation" as const, displayName: "Discovery Request #001", domain: "legal" as const },
    filingDeadline: { entityId: "obl-filing-001", entityType: "obligation" as const, displayName: "Regulatory Filing Filing", domain: "legal" as const },
  },
  ...
  buildSignals(): Signal[] {
    ...
    return [
      createSignal({
        ...
        rawPayload: { eventType: "deadline_proximity", daysRemaining: 11, deadlineDate: new Date(now + 11 * 24 * 60 * 60_000).toISOString() },
      ...
      createSignal({
        ...
        rawPayload: { eventType: "unanswered_dependency", daysOverdue: 18, blockerFor: ["obl-filing-001", "obl-compliance-002"] },
      ...
      createSignal({
        ...
        rawPayload: { eventType: "counsel_performance_drift", overdueDeliverables: 3, averageResponseTimeHours: 72 },
      ...
      createSignal({
        ...
        rawPayload: { eventType: "exposure_assessment", estimatedPenaltyUsd: 4_100_000, riskType: "regulatory_non_compliance" },
  ...
  buildRecommendation(signals: Signal[], evidenceItems: EvidenceItem[]): Recommendation {
    return createRecommendation({
      ...
      confidence: 0.94,
      freshness: 0.92,
      projectedImpact: "Parallel filing track eliminates deadline breach risk and preserves $4.1M litigation position over the next 11 days.",
      projectedRisk: "Discovery blockage plus counsel performance lag leaves zero defense coverage in 11 days — $4.1M exposure crystallises on missed filing deadline.",
      ...
      entityRefs: [this.entities.matter as any, this.entities.outsideCounsel as any, this.entities.filingDeadline as any],
