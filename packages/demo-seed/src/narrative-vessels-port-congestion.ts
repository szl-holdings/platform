...
import type { Signal, EvidenceItem, Recommendation } from "@workspace/ontology";
...
export const VESSELS_PORT_CONGESTION_NARRATIVE = {
  ...
  entities: {
    soltana: { entityId: "vessel-soltana", entityType: "vessel" as const, displayName: "MV Soltana", domain: "maritime" as const, externalIds: { mmsi: "538009241", imo: "9812347" } },
    horizonStar: { entityId: "vessel-horizon-star", entityType: "vessel" as const, displayName: "MV Horizon Star", domain: "maritime" as const, externalIds: { mmsi: "477123456", imo: "9654321" } },
    atlanticCarrier: { entityId: "vessel-atlantic-carrier", entityType: "vessel" as const, displayName: "MV Atlantic Carrier", domain: "maritime" as const, externalIds: { mmsi: "636091234", imo: "9100234" } },
    portFujairah: { entityId: "port-fujairah", entityType: "port" as const, displayName: "Fujairah Port, UAE", domain: "maritime" as const },
  },
  ...
  buildSignals(): Signal[] {
    ...
    return [
      createSignal({
        ...
        rawPayload: { eventType: "ais_dark_period", durationMinutes: 134, lat: 25.6, lon: 57.2, corridor: "Strait of Hormuz proximity", cargoValue: 3_200_000 },
      ...
      createSignal({
        ...
        confidence: 0.88,
        severity: "high",
        entityRefs: [this.entities.portFujairah, this.entities.soltana, this.entities.horizonStar, this.entities.atlanticCarrier],
        rawPayload: { eventType: "port_congestion_alert", portName: "Fujairah, UAE", waitTimeHours: 28, queueLength: 12, financialImpactUsd: 185_000 },
      ...
      createSignal({
        ...
        severity: "medium",
        entityRefs: [],
        rawPayload: { eventType: "charter_rate_spike", route: "TD3C", currentRate: 38_200, previousRate: 31_500, changePercent: 21.3 },
      ...
      createSignal({
        ...
        severity: "critical",
        entityRefs: [this.entities.soltana],
        rawPayload: { eventType: "ofac_proximity_alert", screeningResult: "proximity_match", matchedList: "OFAC SDN", riskScore: 0.78 },
  ...
  buildEvidenceItems(signals: Signal[]): EvidenceItem[] {
    return [
      ...
      createEvidenceItem({
        ...
        entityRefs: [],
        summary: "TD3C charter rates spiked +21% ($31,500 → $38,200/day) — alternative route cost-effective",
        confidence: 0.92,
        freshness: 0.88,
        weight: 0.15,
  ...
  buildRecommendation(signals: Signal[], evidenceItems: EvidenceItem[]): Recommendation {
    return createRecommendation({
      ...
      confidence: 0.88,
      freshness: 0.9,
      projectedImpact: "Khor Fakkan bypass saves $185K/day in demurrage and clears the OFAC compliance gate, protecting $3.2M cargo value.",
      projectedRisk: "Without reroute, fleet faces continued port congestion ($185K/day exposure), OFAC screening failure, and potential vessel detention at Fujairah.",
