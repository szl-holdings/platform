...
export const MARITIME_NARRATIVE = {
  ...
  entities: {
    ...
    context: {
      ...
      summary: "Helmsman assembled 7 signals from AIS, OFAC, weather, port data, and commercial context.",
      signals: [
        {
          source: "AIS",
    ...
    recommendation: {
      id: "demo-rec-mar-001",
      agent: "Helmsman",
      action: "Hold port approach at Karachi anchorage pending OFAC clearance review. File voyage incident report. Notify P&I Club within 24 hours. Reroute if OFAC cannot clear within 6 hours.",
      rationale:
    ...
    auditTrail: {
      ...
      entries: [
        ...
        },
        {
          ...
          event: "All execution steps confirmed — master notified, P&I notified, charterer notified",
