...
export const LYTE_STALLED_APPROVAL_NARRATIVE: LyteStalledApprovalNarrative = {
  ...
  scenario: {
    ...
    daysStalled: 47,
    rootCause: "Approval ownership gap — VP BD departed 2026-02-28 without recording a handoff. Procurement approval chain broke at step 2.",
    resolution: "CFO approves emergency ownership reassignment; deal restarted within 6 hours; close probability recovers to 74%.",
    approvalChainSteps: [
      { step: 1, name: "BD Qualification Sign-off", owner: "Chris Wade (VP BD, departed)", status: "void", stalledDays: 47, note: "Owner departed 2026-02-28; no handoff recorded." },
      { step: 2, name: "Procurement Approval", owner: "Tyler Raines (Procurement Lead)", status: "stalled", stalledDays: 39, note: "Waiting on BD sign-off that never came. Escalation auto-blocked by policy." },
      { step: 3, name: "Legal Review", owner: "Ana Kovac (General Counsel)", status: "pending", note: "Blocked waiting on Procurement." },
      { step: 4, name: "CFO Final Authorization", owner: "Marcus Holt (CFO)", status: "pending", note: "Not yet reached." },
    ],
  },
  ...
  entities: {
    ...
    approvalChain: {
      ...
      status: "stalled",
      steps: [
        { step: 1, name: "BD Qualification Sign-off", owner: "Chris Wade (VP BD, departed)", status: "void", stalledDays: 47, note: "Owner departed 2026-02-28; no handoff." },
        { step: 2, name: "Procurement Approval", owner: "Tyler Raines (Procurement Lead)", status: "stalled", stalledDays: 39, note: "Waiting on void step 1." },
    ...
    recommendations: [
      {
        ...
        summary: "Invoke CFO override to void the stalled approval chain, reassign ownership to Sarah Kim (VP BD), and restart the Vantex acquisition process immediately.",
        ...
        projectedRisk: {
          ifIgnored: "Deal falls out of Q2. Full restart required in Q3 with 60% probability of permanent loss. Board will question Q2 miss.",
          probabilityOfLoss: 0.60,
      ...
      },
      {
        ...
        summary: "Run a platform-wide scan of approval chains that reference staff who departed in the last 90 days. Reassign or void all stalled steps.",
        reasoning: "The Vantex situation is a systemic failure pattern, not a one-off. 3 of 14 portfolio companies show similar approval gaps in the current quarter. A full audit prevents additional revenue risk crystallizing in Q2.",
        confidence: 0.84,
        urgency: "moderate",
        priority: 72,
        businessImpact: {
        ...
        projectedRisk: {
          ifIgnored: "Additional $7.2M at risk across 3 similar situations that will compound through Q2.",
  ...
  simulationScenarios: [
    {
      ...
      downstreamEffects: [
        { entity: "Approval Chain (Vantex)", effect: "Step 1 voided, Sarah Kim assigned, chain unblocked", magnitude: "high" },
        { entity: "Buyer Proposal v3", effect: "Unlocked for revision, delivery target: 48h", magnitude: "high" },
        { entity: "Legal Review Package", effect: "Procurement can now proceed, legal review within 72h", magnitude: "high" },
        { entity: "Q2 Pipeline ($18M target)", effect: "+$4.2M restored to closeable column", magnitude: "high" },
        { entity: "Buyer Relationship", effect: "CFO personal outreach resets engagement — high-signal to buyer", magnitude: "medium" },
      ],
    },
    {
      ...
      downstreamEffects: [
        { entity: "Approval Chain (Vantex)", effect: "Step 1 reassigned but not voided — policy review pending", magnitude: "medium" },
        { entity: "Buyer Proposal v3", effect: "Delayed 4–5 additional days for policy clearance", magnitude: "medium" },
        { entity: "Legal Review Package", effect: "Proceeds after procurement, 10+ days total delay", magnitude: "medium" },
        { entity: "Q2 Pipeline", effect: "Deal may slip to Q2 close date edge — marginal", magnitude: "low" },
    ...
    },
    {
      ...
      downstreamEffects: [
        ...
        { entity: "Q2 Revenue Target", effect: "$4.2M gap against $18M board target (23% shortfall)", magnitude: "high" },
        { entity: "Buyer Relationship", effect: "High churn probability — competitor likely to engage", magnitude: "high" },
        { entity: "Approval Chain (Vantex)", effect: "Remains frozen indefinitely — no self-resolution path", magnitude: "high" },
        { entity: "Portfolio Scan (3 similar gaps)", effect: "$7.2M additional exposure compounds", magnitude: "high" },
      ],
    },
  ],
};
