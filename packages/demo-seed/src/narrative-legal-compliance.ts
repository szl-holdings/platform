...
export const LEGAL_COMPLIANCE_NARRATIVE = {
  ...
  entities: {
    ...
    context: {
      ...
      summary: "PRISM assembled 9 signals across deadlines, insurer behavior, medical records, and regulatory context.",
      signals: [
        {
        ...
        },
        {
          ...
          signal: "Demand package scored 91% complete — police report, imaging, expert affidavit present",
        },
        {
        ...
        {
          source: "CMS MSPRP",
          signal: "Medicare lien query pending — conditional payment letter expected within 21 days",
        },
        {
    ...
    recommendation: {
      ...
      action: "Issue formal Regulation 68 violation notice to Continental General. Attach demand packet at 91% readiness. Request acknowledgement response within 7 days or formal complaint to NY DFS will be filed.",
      rationale:
      ...
      privilegeNote: "This recommendation is attorney work product — protected under NY CPLR 3101(c)",
    ...
    execution: {
      ...
      steps: [
        ...
        {
          step: 3,
          action: "Letter transmitted to Continental General (certified mail + email) — ref RIV-2026-0130",
        ...
        {
          step: 5,
          action: "7-day response deadline calendar event created — escalation if no response by 2026-02-06",
