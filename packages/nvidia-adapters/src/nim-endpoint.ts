...
class NimEndpointManager {
  ...
  list(
    filters: { gpuRequired?: boolean; tags?: string[]; enabledOnly?: boolean } = {},
  ): NimEndpointConfig[] {
...
export { NimEndpointManager, PREDEFINED_NIM_ENDPOINTS };
