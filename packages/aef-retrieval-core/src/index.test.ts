...
describe('reciprocalRankFusion', () => {
  const dense: DenseHit[] = [
    ...
    { chunkId: 'c2', sourceId: 's2', score: 0.8, metadata: {} },
    { chunkId: 'c3', sourceId: 's3', score: 0.7, metadata: {} },
  ];

  const keyword: KeywordHit[] = [
    { chunkId: 'c2', sourceId: 's2', score: 0.9, metadata: {} },
    { chunkId: 'c3', sourceId: 's3', score: 0.75, metadata: {} },
    { chunkId: 'c4', sourceId: 's4', score: 0.6, metadata: {} },
  ];
...
describe('applyExactMatchBoosts', () => {
  ...
  it('does not boost any hits when query has no recognized patterns', () => {
    const hits = [makeHit('c1', 0.5, { imo: 'IMO 9123456' }), makeHit('c2', 0.5, {})];
