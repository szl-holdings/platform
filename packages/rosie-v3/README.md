...
Rosie v3 companion: reasoning companion organ + flat single-file build.
...
## Honesty note
Reasoning is LLM-routed via a11oy.code; outputs carry honest provenance.

## Install (editable, from monorepo root)
```bash
pip install -e packages/rosie-v3
```
