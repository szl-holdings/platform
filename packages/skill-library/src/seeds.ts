...
export const builtinSkills: SkillDefinition[] = [
...

  {
    ...
    category: 'workflow',
    objective: 'Ensure high-impact actions receive explicit human approval before execution.',
...

  {
    ...
    category: 'reporting',
    objective: 'Generate a period KPI report with trend analysis ready for executive review.',
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        name: 'Draft Brief',
        description:
          'Generate a structured markdown brief with sections for context, risks, and actions.',
    ...
    expectedOutputs: ['Executive brief document', 'Top-N signal list', 'Recommended actions'],
    successCriteria: [
      {
