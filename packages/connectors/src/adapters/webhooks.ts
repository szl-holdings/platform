...
import type { WebhookConnector, ConnectorMetadata, ConnectorStatus } from "../interfaces.js";
...
export class WebhookDemoAdapter implements WebhookConnector {
  ...
  private _events: Array<{ eventId: string; source: string; payload: Record<string, unknown>; receivedAt: string }> = [];
  private _emitSignal?: (input: SignalInput) => Promise<Signal>;

  status(): ConnectorStatus { return this._status; }

  getReceivedEvents() { return this._events; }
