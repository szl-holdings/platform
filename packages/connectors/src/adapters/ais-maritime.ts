...
const DEMO_VESSELS = [
  { mmsi: "538009241", imo: "9812347", name: "MV Soltana", flag: "MH", cargo: "Refined Petroleum", lat: 25.2, lon: 56.8, speed: 12.4, heading: 95, status: "underway", cargoValue: 3_200_000 },
  { mmsi: "477123456", imo: "9654321", name: "MV Horizon Star", flag: "SG", cargo: "Container", lat: 22.4, lon: 60.1, speed: 14.2, heading: 215, status: "underway", cargoValue: 8_500_000 },
  { mmsi: "636091234", imo: "9100234", name: "MV Atlantic Carrier", flag: "LR", cargo: "Bulk Grain", lat: 24.8, lon: 58.3, speed: 0, heading: 180, status: "anchored", cargoValue: 2_100_000 },
  { mmsi: "209333000", imo: "9523456", name: "MV Nordic Pioneer", flag: "CY", cargo: "LNG", lat: 23.6, lon: 59.2, speed: 8.1, heading: 310, status: "underway", cargoValue: 12_000_000 },
  { mmsi: "311000234", imo: "9712345", name: "MV Gulf Express", flag: "BS", cargo: "Chemical Tanker", lat: 26.1, lon: 55.9, speed: 11.8, heading: 135, status: "underway", cargoValue: 4_700_000 },
];

const DARK_PERIOD_VESSELS = [
  { mmsi: "538009241", imo: "9812347", name: "MV Soltana", durationMinutes: 134, lat: 25.6, lon: 57.2 },
];
...
export class AISMaritimeDemoAdapter implements AISMaritimeConnector {
  ...
  async poll(): Promise<Signal[]> {
    ...
    const darkSignal = await this._emitSignal({
      ...
      confidence: 0.92,
      severity: "high",
      entityRefs: [{ entityId: "vessel-soltana", entityType: "vessel", displayName: "MV Soltana", domain: "maritime" }],
      rawPayload: {
  ...
  private async _emitInitialSignals(): Promise<void> {
    ...
    await this._emitSignal({
      ...
      confidence: 0.95,
      severity: "high",
      entityRefs: [{ entityId: "vessel-soltana", entityType: "vessel", displayName: "MV Soltana", domain: "maritime", externalIds: { mmsi: "538009241", imo: "9812347" } }],
      rawPayload: {
    ...
    await this._emitSignal({
      ...
      severity: "high",
      entityRefs: [
        { entityId: "port-fujairah", entityType: "port", displayName: "Fujairah Port", domain: "maritime" },
      ],
      rawPayload: {
  ...
  private async _emitPeriodicSignals(): Promise<void> {
    ...
    await this._emitSignal({
      ...
      confidence: 1.0,
      severity: "info",
      entityRefs: [{ entityId: `vessel-${vessel.mmsi}`, entityType: "vessel", displayName: vessel.name, domain: "maritime" }],
      rawPayload: {
