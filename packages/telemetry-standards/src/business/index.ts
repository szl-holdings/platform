...
export type BusinessAttrKey =
  (typeof BUSINESS_ATTRS)[keyof typeof BUSINESS_ATTRS];
...
export type ATLASEventClassValue =
  (typeof ATLAS_EVENT_CLASS)[keyof typeof ATLAS_EVENT_CLASS];
