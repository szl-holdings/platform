...
export const ENV_CONTRACT: EnvVarSpec[] = [
  ...
  },
  {
    ...
    classification: "required",
    description:
      "Privileged agent access token for M2M communication. Minimum 32 characters.",
    risksIfMissing: "Agent-to-agent calls fail; Alloy execution fabric is broken.",
  },
  {
  ...
  // Maps
  {
    ...
    risksIfMissing:
      "All Terra map views render blank. Demo-killer for Terra presentations.",
  },
  ...
  // Demo mode
  {
    ...
    classification: "optional",
    description:
      "If 'true', mocks external services and disables destructive operations.",
  ...
  },
  {
    ...
    classification: "optional",
    description:
      "If 'true', seeds demo data on startup. MUST NOT be set in production.",
    example: "true",
