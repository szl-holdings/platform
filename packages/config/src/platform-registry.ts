...
export const PLATFORM_PRODUCTS: Record<string, PlatformProduct> = {
  "szl-holdings": {
    ...
    seedDataModules: [
      ...
      "decision theater scenarios",
    ],
    knownBlockers: [
      "Autopilot header stats hardcoded",
      "Genome score hardcoded",
    ],
  },
  "carlota-jo": {
    id: "carlota-jo",
  ...
  terra: {
    ...
    knownBlockers: [
      "MAPBOX_TOKEN not set — maps blank",
      "No live MLS/CoStar integration",
    ],
  },
  vessels: {
    id: "vessels",
  ...
  "api-server": {
    ...
    knownBlockers: [
      "Zod validation: 21/170 routes only",
