...
export const APP_INTEGRATIONS: Record<string, { connectors: string[]; description: string; liveFeeds?: string[]; doctrineRole?: string }> = {
  ...
  dreamscape: {
    ...
    description: "Alloy predictive intelligence layer — scenario modeling, confidence scoring. Absorbed into Alloy.",
  ...
  aegis: {
    ...
    description: "Aegis control plane — risk register, remediation tracking, governance, and compliance using NIST CSF 2.0, FedRAMP, and CMMC frameworks.",
  ...
  rosie: {
    ...
    description: "Aegis Operations (slug: rosie/msp) — threat and anomaly visibility, evidence-backed incident command.",
  ...
  beacon: {
    ...
    description: "Terra (slug: beacon) — business telemetry, KPI movement, Census demographics, BLS employment, FEMA risk, SEC EDGAR REIT filings.",
  ...
  inca: {
    ...
    description: "AI research platform with live arXiv multi-category papers, Semantic Scholar citation graph, PapersWithCode ML benchmarks.",
  ...
  "carlota-jo": {
    ...
    description: "Luxury advisory booking uses World Bank live GDP indicators, BLS employment data, and Outlook Calendar integration.",
