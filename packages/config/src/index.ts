...
> = {
  ...
  alloy: {
    ...
    description:
      'FORGE — execution fabric, connectors, automations, DAGs, and predictive intelligence engine across the SZL platform.',
    liveFeeds: [
  ...
  dreamscape: {
    ...
    description:
      'FORGE predictive intelligence layer — scenario modeling, confidence scoring. Absorbed into Alloy.',
    liveFeeds: [
      'HuggingFace Hub — AI Creative Tools (live API)',
  ...
  beacon: {
    ...
    description:
      'DOMAINE (slug: beacon) — business telemetry, KPI movement, Census demographics, BLS employment, FEMA risk, SEC EDGAR REIT filings.',
    liveFeeds: [
