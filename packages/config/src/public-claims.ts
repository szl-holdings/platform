...
export const PUBLIC_CLAIMS: PublicClaim[] = [
  ...
  },
  {
    ...
    truthValue: 'aspirational',
    source: 'artifacts/aegis/src/pages/digital-twin.tsx, artifacts/szl-demo-video',
    displayLabel: '[Projected]',
...
export const BANNED_HARDCODED_STRINGS: BannedHardcodedString[] = [
  ...
  },
  {
    ...
    reason: "Use LYTE_FALSE_POSITIVE_RATE from the artifact's claims adapter.",
  },
  {
    value: '34 days pre-designation',
    claimId: 'vessels-dark-detection-lead',
    reason: "Use VESSELS_DARK_DETECTION_LEAD from the artifact's claims adapter.",
  },
  {
    value: '$4.2B+',
