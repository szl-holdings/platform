...
export const PolicyStateSchema = z.enum(['unchecked', 'allowed', 'requires_approval', 'blocked']);
export type PolicyState = z.infer<typeof PolicyStateSchema>;

export const ApprovalModeSchema = z.enum(['none', 'pending', 'approved', 'rejected', 'escalated']);
