...
export const advisoryFixtures: GoldenFixtureSet = {
  ...
  corpus: [
    ...
    { chunkId: "chunk-distractor-coffee", text: "Guide to single origin coffee tasting notes covering acidity, body, and finish across Ethiopian and Colombian beans." },
    { chunkId: "chunk-distractor-marketing", text: "Marketing campaign retrospective covering paid social spend and creative iteration cycle for a consumer brand launch." },
    { chunkId: "chunk-distractor-music", text: "History of orchestral string instruments from baroque viols through modern violin construction." },
    { chunkId: "chunk-distractor-travel", text: "Walking tour of Edinburgh's Old Town including the Royal Mile and surrounding closes and wynds." },
    { chunkId: "chunk-distractor-fitness", text: "Mobility routine for desk workers focused on shoulders, thoracic spine, and hip flexors performed daily." },
  ],
};
