...
export const complianceFixtures: GoldenFixtureSet = {
  ...
  corpus: [
    ...
    { chunkId: "chunk-distractor-recipe", text: "Recipe for slow-cooked pulled pork sandwiches with a tangy vinegar barbecue sauce." },
    { chunkId: "chunk-distractor-design", text: "Visual design system tokens for color, spacing, and typography used across the marketing website." },
    { chunkId: "chunk-distractor-jazz", text: "Liner notes for a jazz album recorded live at a Greenwich Village club in the 1960s." },
    { chunkId: "chunk-distractor-travel", text: "Backpacking itinerary across Patagonia covering Torres del Paine and El Chaltén highlights." },
    { chunkId: "chunk-distractor-fitness", text: "Strength program for masters athletes focusing on tendon health and joint mobility." },
  ],
};
