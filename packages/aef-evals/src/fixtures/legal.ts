...
export const legalFixtures: GoldenFixtureSet = {
  ...
  corpus: [
    ...
    { chunkId: "chunk-distractor-recipe", text: "A recipe for tomato basil soup involving fresh basil, ripe tomatoes, garlic, and a touch of cream." },
    { chunkId: "chunk-distractor-marketing", text: "Marketing brochure describing premium membership benefits, including priority customer support and exclusive events." },
    { chunkId: "chunk-distractor-engineering", text: "Engineering changelog for release v3.4.2: bug fixes for the data export pipeline and improved logging." },
    { chunkId: "chunk-distractor-travel", text: "Travel advisory for Southeast Asia covering visa requirements and recommended vaccinations for tourists." },
    { chunkId: "chunk-distractor-fitness", text: "Twelve-week strength training program emphasizing compound lifts and progressive overload for intermediate lifters." },
  ],
};
