...
export const realEstateFixtures: GoldenFixtureSet = {
  ...
  corpus: [
    ...
    },
    {
      ...
      text: 'Recipe for sourdough boule using a 75 percent hydration dough and a 24-hour cold retard.',
    },
    {
      chunkId: 'chunk-distractor-music',
      text: 'Concert review for a touring jazz quartet performing at a downtown venue last weekend.',
    },
    {
      chunkId: 'chunk-distractor-tax-form',
      text: 'Instructions for preparing personal income tax returns including standard deduction and credit eligibility.',
    },
    {
      chunkId: 'chunk-distractor-software',
      text: 'Release notes for a developer tooling package introducing a new CLI command and bug fixes.',
    },
    {
      chunkId: 'chunk-distractor-fitness',
      text: 'Half marathon training plan for novice runners building from a 5k base over twelve weeks.',
    },
  ],
};
