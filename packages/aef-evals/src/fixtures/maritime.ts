...
export const maritimeFixtures: GoldenFixtureSet = {
  ...
  corpus: [
    ...
    { chunkId: "chunk-distractor-galley-recipe", text: "Galley recipe book: instructions for preparing seafarer meals during long ocean transits, including provisioning quantities for crews of 20." },
    { chunkId: "chunk-distractor-marine-insurance", text: "Marine hull and machinery insurance policy boilerplate covering general average, salvage, and collision liability for commercial shipping." },
    { chunkId: "chunk-distractor-port-tariff", text: "Port tariff schedule listing pilotage, towage, and berth occupancy charges for container terminals in Northwest Europe." },
    { chunkId: "chunk-distractor-bunker-price", text: "Daily bunker price index for VLSFO and MGO across Singapore, Rotterdam, and Fujairah hubs published by independent energy reporting agency." },
    { chunkId: "chunk-distractor-crew-training", text: "STCW basic safety training schedule for deck and engine officers, covering personal survival, fire fighting, and first aid modules." },
  ],
};
