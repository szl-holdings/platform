...
export const CARLOTA_GOLDEN_QUERIES: GoldenQuery[] = [
  ...
  },
  {
    ...
    expectedRelevant: 0,
    exactMatchBoostTerms: [],
    metadata: { domain: "carlota", queryType: "adversarial", reason: "off-domain natural sciences" },
  },
  {
    ...
    expectedRelevant: 0,
    exactMatchBoostTerms: [],
    metadata: { domain: "carlota", queryType: "adversarial", reason: "invalid engagement identifier" },
  },
];

export const CARLOTA_MOCK_CORPUS = new Map<string, { text: string; boostTerms: string[] }>([
  ["carlota-chunk-001", { text: "Engagement ENG-2024-CJ-007 — Strategy Advisory. Principal: [REDACTED]. Status: Active. Advisory brief: Repositioning the operating entity from regional to national scope. Three pillars: market expansion, brand credibility, and operational consolidation.", boostTerms: ["engagement", "advisory brief", "principal", "confidentiality"] }],
  ["carlota-chunk-002", { text: "ENG-2024-CJ-007 strategy brief summary: analysis of six comparable market entries over prior 5 years. Recommendation: phased national expansion starting Q3 2024, anchored in two pilot markets. Confidence: HIGH.", boostTerms: ["engagement", "advisory brief", "strategy"] }],
  ...
  ["carlota-chunk-004", { text: "CJ-P-0042 brand positioning — principal feedback: framework approved. Visual identity brief forwarded to external design firm. Key message architecture approved for use in Q3 communications rollout.", boostTerms: ["client reference", "brand positioning", "deliverable", "principal"] }],
  ["carlota-chunk-005", { text: "Active retainer engagements Q3 2024: ENG-2024-CJ-007 (strategy), ENG-2024-CJ-009 (operations), ENG-2024-CJ-011 (brand). All three principals have confirmed Q3 continuity. ENG-2024-CJ-011 scheduled for scope review July 10.", boostTerms: ["retainer", "engagement", "scope"] }],
  ["carlota-chunk-006", { text: "Retainer client status — active engagements: 3 principals on monthly retainer, 2 on project retainer. All retainer agreements current. Next renewal review cycle: September 2024.", boostTerms: ["retainer", "engagement", "principal"] }],
  ...
  ["carlota-chunk-008", { text: "Strategy brief for Q3 board: presentation structure agreed with principal 2024-06-28. Opening: operating summary (5 slides). Middle: strategic priorities (8 slides). Close: capital ask and timeline (3 slides). Rehearsal scheduled July 14.", boostTerms: ["strategy", "advisory brief", "principal"] }],
  ["carlota-chunk-009", { text: "Outstanding invoices — operations advisory retainer: INV-2024-CJ-039 ($8,500, 45 days outstanding). INV-2024-CJ-044 ($8,500, 15 days outstanding). Both linked to ENG-2024-CJ-009 operations retainer.", boostTerms: ["invoice", "retainer", "engagement"] }],
  ["carlota-chunk-010", { text: "Operations advisory retainer billing summary: ENG-2024-CJ-009. Retainer rate: $8,500/month. Invoices issued: 6. Invoices paid: 4. Invoices outstanding: 2. Aging: INV-039 (45d), INV-044 (15d).", boostTerms: ["invoice", "retainer", "engagement"] }],
  ["carlota-chunk-011", { text: "Engagement ENG-2024-CJ-012 — Brand Advisory. Project milestones achieved: M1 Discovery complete (April 8), M2 Brand architecture approved (May 14), M3 Launch collateral delivered (June 3). M4 Rollout support in progress.", boostTerms: ["project milestone", "engagement", "scope"] }],
  ...
  ["carlota-chunk-013", { text: "Engagement runway by principal: 2 engagements concluding before September 2024 — ENG-2024-CJ-005 (concludes Aug 12, principal pending renewal decision), ENG-2024-CJ-008 (concludes Aug 30, principal opted out of renewal).", boostTerms: ["principal", "engagement"] }],
  ["carlota-chunk-014", { text: "Scope creep flag — ENG-2024-CJ-012 brand advisory: rollout support requests now include social channel management not in original SOW. Carlota recommended scope reset conversation; principal agreed to revisit at July 22 check-in.", boostTerms: ["scope", "engagement"] }],
  ["carlota-chunk-015", { text: "Capital allocation narrative draft — Q3 board: balanced thesis recommending 60% reinvestment into operating portfolio, 25% selective M&A, 15% return of capital. Carlota framing emphasises resilience-first messaging.", boostTerms: ["advisory brief", "strategy"] }],
  ["carlota-chunk-016", { text: "Engagement health composite — ENG-2024-CJ-009 operations retainer: invoice aging amber (INV-039 45d), deliverable past milestone date (M2 ops handbook +9 days), satisfaction green. Recommended action: principal touch-base.", boostTerms: ["invoice", "engagement", "project milestone"] }],
  ["carlota-chunk-017", { text: "Pilot market shortlist for national expansion strategy — top two recommendations: Atlanta GA and Denver CO. Selection rationale: market size adjacency, talent availability, regulatory environment, and modest competitive density.", boostTerms: ["strategy", "advisory brief"] }],
  ["carlota-chunk-018", { text: "September retainer renewal checklist: validate scope, confirm rate card, refresh confidentiality undertakings, align on quarterly KPIs, schedule annual principal off-site. Owner: Carlota. Target completion: 2024-09-15.", boostTerms: ["retainer"] }],
  ["carlota-chunk-019", { text: "Confidentiality posture for principal-facing engagements: all client identifiers redacted in shared drives. Strategy briefs labelled CJ-CONFIDENTIAL. Access limited to Carlota and named delivery leads. NDA in force on all retainers.", boostTerms: ["principal", "confidentiality"] }],
]);
