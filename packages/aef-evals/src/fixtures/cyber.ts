...
export const cyberFixtures: GoldenFixtureSet = {
  ...
  corpus: [
    ...
    {
      chunkId: 'chunk-distractor-tea-blog',
      text: 'A blog post about brewing the perfect cup of green tea at home, including water temperature and steep times.',
    },
    {
      chunkId: 'chunk-distractor-marketing-funnel',
      text: 'Marketing funnel optimization tips for B2B SaaS companies: improving lead qualification and demo conversion rates.',
    },
    {
      chunkId: 'chunk-distractor-music-review',
      text: 'Album review of an indie folk record exploring themes of memory and place across twelve acoustic tracks.',
    },
    {
      chunkId: 'chunk-distractor-travel-italy',
      text: 'Two-week travel itinerary through Italy covering Rome, Florence, and Venice with restaurant recommendations.',
    },
    {
      chunkId: 'chunk-distractor-fitness-yoga',
      text: 'Beginner yoga routine focused on hip mobility and breath control, suitable for office workers with tight hips.',
    },
  ],
};
