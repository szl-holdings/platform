...
export const TERRA_MOCK_CORPUS = new Map<string, { text: string; boostTerms: string[] }>([
  ...
  ["terra-chunk-002", { text: "Distress signal: BBL 3-09442-1001 — 4821 Church Ave Brooklyn — tax delinquency notice filed 2024-01-18. HPD violations: 7 open. Classified as high-distress asset.", boostTerms: ["parcel ID", "BBL", "distress", "HPD"] }],
  ...
  ["terra-chunk-005", { text: "Tax lien cluster alert: 12 Manhattan properties owned by entities linked to Harlem Capital Group showing simultaneous lien filings in Q1 2024. Portfolio distress indicator triggered.", boostTerms: ["tax lien", "distress", "lis pendens"] }],
  ["terra-chunk-006", { text: "Ownership chain — 548 West 46th Street, Manhattan (BBL 1-01075-0032): Owner of record: West Side Developments LLC. Beneficial controller: Marcus Webb (90% interest via holding entity MWP Holdings NJ).", boostTerms: ["property address", "owner of record", "BBL", "beneficial owner"] }],
  ["terra-chunk-007", { text: "548 W 46th Street ownership history: conveyed from Meridian NYC LLC to West Side Developments LLC on 2022-11-14. Transfer price: $4.2M. Mortgage: $3.1M (First Republic, now JPMorgan).", boostTerms: ["property address", "owner of record", "BBL"] }],
  ...
  ["terra-chunk-009", { text: "Deal D-2024-BX-07 — 2456 Grand Concourse, Bronx. Diligence stage. Estimated value: $6.8M. Distress score: 0.81. Tax arrears: $212,000. LOI signed: 2024-05-28.", boostTerms: ["BBL", "distress", "pro forma"] }],
  ["terra-chunk-010", { text: "Lis pendens filing — Owner: Hudson Valley Holdings LLC. Properties affected: 3 in Brooklyn, 1 in Queens. Filing date: 2024-04-03. Foreclosure action initiated by lender First National Community Bank.", boostTerms: ["lis pendens", "distress", "owner of record", "foreclosure"] }],
  ["terra-chunk-011", { text: "Hudson Valley Holdings — lis pendens cluster: BBLs 3-05812-0044, 3-06231-0017, 3-07809-0023, 4-11204-0088. All filed within 10-day window. Possible strategic default scenario.", boostTerms: ["lis pendens", "distress", "tax lien"] }],
  ["terra-chunk-012", { text: "Co-op board violations — Queens Q2 2024: Forest Hills Gardens Co-op (BBL 4-01823-0010): 4 open ECB violations. Kew Gardens Residence Corp (BBL 4-02107-0041): 2 open violations.", boostTerms: ["co-op", "distress", "BBL"] }],
  ...
  ["terra-chunk-014", { text: "HPD violation roll-up for 4821 Church Avenue: 7 open class-B violations (heat/hot water, vermin, peeling lead paint). Earliest open violation dates to 2022-09-11. No active vacate orders.", boostTerms: ["HPD", "distress"] }],
  ["terra-chunk-015", { text: "NYC tax delinquency notice trend Q1 2024 by neighborhood: East Harlem +38% YoY, Bushwick +31%, Mott Haven +27%, Hell's Kitchen +19%. Aggregate notices issued: 1,847.", boostTerms: ["tax lien", "distress"] }],
  ["terra-chunk-016", { text: "Beneficial owner portfolio map — Marcus Webb: controlling interest in 6 LLCs (West Side Developments, MWP Holdings NJ, Riverbend Equities, Hudson West Capital, 46 St Partners, Webb Family Trust II). Combined NYC asset value: $58M.", boostTerms: ["owner of record", "beneficial owner"] }],
  ["terra-chunk-017", { text: "Combined-distress parcel watchlist: 11 BBLs with both active tax lien and lis pendens filing as of 2024-06-15. Aggregate exposure: $9.4M in arrears, $24M in mortgage principal.", boostTerms: ["lis pendens", "tax lien", "distress"] }],
  ["terra-chunk-018", { text: "NYC foreclosure auction calendar Q3 2024: 142 scheduled auctions across the five boroughs. Brooklyn leads with 51, followed by Queens (37) and Bronx (28). Manhattan: 14, Staten Island: 12.", boostTerms: ["foreclosure", "distress"] }],
  ["terra-chunk-019", { text: "Featured Q3 foreclosure auction — 1147 Bedford Avenue, Brooklyn (BBL 3-01900-0023): scheduled 2024-08-14, opening bid $1.85M, mortgage debt $2.4M. Second mortgage holder: Bedford Capital Lending.", boostTerms: ["foreclosure", "BBL"] }],
  ["terra-chunk-020", { text: "Brooklyn multifamily cap rate analysis Q2 2024: trailing 90-day average 5.4%, compressed 40bps from Q1. Class B trades clearing at 5.1-5.6% range. Discount window narrowing relative to Manhattan.", boostTerms: ["cap rate"] }],
  ["terra-chunk-021", { text: "Bronx pipeline pro forma assumptions: 6.0% exit cap, 8.5% blended rent growth over 3-year hold, 65% LTV at 7.25% interest. Stabilised yield-on-cost target: 7.8%.", boostTerms: ["pro forma", "deal"] }],
]);
