...
describe("retrieval metrics — unit tests", () => {
  ...
  const none = [{ chunkId: "x", score: 1.0 }, { chunkId: "y", score: 0.9 }];
  ...
  it("recall@k is partial when only some relevant retrieved", () => {
    const partial = [{ chunkId: "a", score: 1.0 }, { chunkId: "x", score: 0.8 }];
  ...
  it("MRR = 0.5 when second result is first relevant", () => {
    const results = [{ chunkId: "x", score: 1.0 }, { chunkId: "a", score: 0.9 }];
  ...
  it("exactMatchRecoveryRate = 1 when all boost terms matched", () => {
    const retrieved = [
      { chunkId: "a", score: 1.0, boostTermsMatched: ["IMO", "sanctions"] },
    ];
