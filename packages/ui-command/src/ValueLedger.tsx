...
const TYPE_META = {
  ...
  protected: {
    ...
    color: '#22c55e',
    icon: Shield,
    bg: 'hsla(160,60%,14%,0.6)',
  },
  created: {
    label: 'Value Created',
    color: '#a78bfa',
    icon: TrendingUp,
    bg: 'hsla(265,60%,14%,0.6)',
  },
};
      ...
      >
        {groups.map(({ type, total }) => {
          ...
          return (
            ...
            >
              <Icon
                style={{ width: 14, height: 14, color: meta.color, margin: '0 auto 0.375rem' }}
              />
              <div
                style={{
                  fontSize: '1.25rem',
          ...
          return (
            <div
              ...
              style={{
                ...
                gap: '0.75rem',
                padding: '0.5rem 0',
                borderBottom: i < entries.length - 1 ? '1px solid hsla(0,0%,100%,0.04)' : 'none',
              }}
            >
              <div
                style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {entry.description && (
                  <div
                    style={{ fontSize: '9px', color: 'rgba(255,255,255,0.3)', marginTop: '1px' }}
                  >
                    {entry.description}
                  </div>
                )}
              ...
              {entry.domainColor && (
                <span
                  style={{
                    ...
                    padding: '1px 6px',
                    borderRadius: '3px',
                    background: `${entry.domainColor}20`,
              ...
              <span style={{ fontSize: '12px', fontWeight: 700, color: meta.color, flexShrink: 0 }}>
