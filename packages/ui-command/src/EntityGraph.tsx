...
export function EntityGraph({ nodes, edges, title = "Cross-Domain Impact Map", height = 320 }: EntityGraphProps) {
      ...
      <div style={{ width: "100%", overflowX: "auto" }}>
        ...
        >
          ...
          {edges.map((edge, i) => {
            ...
            const opacity = edge.strength === "strong" ? 0.4 : edge.strength === "medium" ? 0.25 : 0.15;
            ...
            return (
              <g key={i}>
                ...
                />
                {edge.label && (
                  <text x={mx} y={my - 4} textAnchor="middle" fill="rgba(255,255,255,0.2)" fontSize="8">
                    {edge.label}
                  </text>
                )}
              </g>
      ...
      <div style={{ display: "flex", gap: "1rem", marginTop: "0.75rem", flexWrap: "wrap" }}>
        {[
          ...
          <div key={type} style={{ display: "flex", alignItems: "center", gap: "0.375rem" }}>
            {type === "domain" ? (
              <div style={{ width: 10, height: 10, borderRadius: "2px", background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.4)" }} />
            ) : (
              <div style={{ width: type === "signal" ? 6 : 9, height: type === "signal" ? 6 : 9, borderRadius: "50%", background: "rgba(255,255,255,0.3)" }} />
            )}
