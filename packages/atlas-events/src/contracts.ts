...
export function createEventEnvelope<T>(
  ...
  payload: T,
  metadata: Omit<AtlasEventMetadata, "eventId" | "eventName" | "publishedAt" | "schemaVersion" | "eventVersion">,
...
export class AtlasUnknownEventError extends Error {
  constructor(eventName: string) {
    super(`Unknown ATLAS event: "${eventName}". Use a canonical AtlasEventName or createEventEnvelope() for custom events.`);
