...
<section id="szl-flagship-hero" data-szl-hero-v2="rosie" aria-label="rosie command hero">
  ...
  <div id="szl-hero-inner">
    ...
    <div class="szl-hero-cta"><a class="primary" href="#root">Open Rosie</a><a class="ghost" href="#root">Anatomy 3D</a></div>
    <div class="szl-hero-foot">FRONTIER: Breathing organ pulse — live anatomy heartbeat that maps reasoning to the body · governed loop GREEN · additive deploy · sign: Yachay</div>
  </div>
  <script>
  (function(){
