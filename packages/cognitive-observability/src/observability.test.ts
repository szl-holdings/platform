...
import { METRIC_DEFINITIONS, makeMetric, CognitiveMetricSchema } from "./metrics.js";
...
describe("METRIC_DEFINITIONS", () => {
  it("contains all 15 required metrics", () => {
    const required = [
      "latency_ms", "token_count", "tool_error_rate", "retrieval_quality_score",
      "memory_hit_rate", "hallucination_rate", "citation_coverage",
      "approval_bottleneck_ms", "override_rate", "rollback_count",
      "drift_score", "value_created_usd", "value_at_risk_usd",
      "agent_reliability_score", "cost_usd",
    ];
