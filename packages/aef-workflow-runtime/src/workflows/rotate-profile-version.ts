...
import { PolicyGuardActor, ApprovalGateActor } from "../actors.js";
...
export const rotateProfileVersionWorkflow: WorkflowDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      actor: "ApprovalGate",
      description: "Require human approval before activating the new profile version across tenants.",
    ...
    },
    {
      ...
      actor: "PolicyGuard",
      description: "Activate the new profile version in the registry and record the version transition.",
      async execute(ctx: WorkflowContext, _prior: WorkflowStepResult[]) {
        return {
          activated: true,
          profileId: ctx.profileId,
