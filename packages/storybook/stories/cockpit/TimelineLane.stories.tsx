...
import { TimelineLane, type CockpitTimelineEvent } from '@szl-holdings/design-system';
...
const events: CockpitTimelineEvent[] = [
  ...
  { id: 'e4', label: 'Policy escalation', timestamp: '2026-04-26T08:01:20Z', severity: 'warning' },
  {
    ...
    timestamp: '2026-04-26T08:01:28Z',
    severity: 'warning',
  },
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Chronological event lane for incident timelines, run histories, and audit sequences.',
      },
    },
  },
  tags: ['autodocs'],
