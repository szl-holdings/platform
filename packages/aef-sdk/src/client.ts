...
export class AefClient {
  ...
  async embed(
    request: WithDefaults<Omit<EmbedRequest, "requestId" | "tenantId">, "normalize" | "metadata"> & { requestId?: string },
  ...
  async rerank(
    request: WithDefaults<Omit<RerankRequest, "requestId" | "tenantId">, "topK" | "metadata"> & { requestId?: string },
  ...
  async hybridSearch(
    request: WithDefaults<
      ...
      "topK" | "candidatePool" | "denseWeight" | "keywordWeight" | "rerankEnabled" | "includeProvenance" | "metadata"
    > & { requestId?: string },
  ...
  async ingest(
    request: WithDefaults<Omit<IngestRequest, "requestId" | "tenantId">, "chunkSize" | "chunkOverlap" | "metadata"> & { requestId?: string },
