...
import { registerPrompt, promotePromptVersion } from "./registry.js";
...
const SEED_PROMPTS: Array<{
...
}> = [
  {
    id: "agents.perceive",
    name: "Perceive Phase",
    description: "System prompt for the perceive phase — parse raw signals into structured observations",
    domain: "agents-core",
  ...
  },
  {
    ...
    domain: "agents-core",
    routeClass: "cognitive-loop",
    systemPrompt: "You are a quality assurance expert. Verify outputs against the expected criteria.",
    template:
