...
describe("Query helpers", () => {
  ...
  beforeEach(() => {
    store = new InMemoryLedgerStore();
    store.append(makeEntry({ entryId: "e-1", requestId: "req-1", tenantId: "t-a", policyAllow: true }));
    store.append(makeEntry({ entryId: "e-2", requestId: "req-1", tenantId: "t-a", policyAllow: false }));
    store.append(makeEntry({ entryId: "e-3", requestId: "req-2", tenantId: "t-b", policyAllow: true }));
  });
