...
export const LEAN_REGISTRY: readonly LeanEntry[] = [
  ...
  { thesis: "T03", file: "Lutar/Lambda/SchurConcave.lean", theorem: "lambda_two_axis_schur_concave", leanStatus: "proven", runtimeAssert: "lambda_axis/lambdaOverAxes" }, // Schur-concave property: NOT Λ-uniqueness Conjecture
  { thesis: "T03", file: "Lutar/Lambda/SchurConcave.lean", theorem: "lambda_schur_concave_n_axis", leanStatus: "sorry", runtimeAssert: null }, // Schur-concave n-axis: NOT Λ-uniqueness Conjecture
