...
export const LEAN_REGISTRY: readonly LeanEntry[] = [
  ...
  { thesis: "T03", file: "Lutar/Lambda/SchurConcave.lean", theorem: "lambda_two_axis_schur_concave", leanStatus: "proven", lambdaNote: "Schur-concave — proven, NOT Λ-uniqueness Conjecture", runtimeAssert: "lambda_axis/lambdaOverAxes" },
  { thesis: "T03", file: "Lutar/Lambda/SchurConcave.lean", theorem: "lambda_schur_concave_n_axis", leanStatus: "sorry", lambdaNote: "Schur-concave — NOT Λ-uniqueness Conjecture", runtimeAssert: null },
