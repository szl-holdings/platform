...
Wire-D: live provenance wire (Wire D) — SSE stream of DSSE-signed BOE receipts.
...
## Honesty note
SLSA L1 honest; Wire D is the provenance transport, not a L2/L3 attestation by itself.
