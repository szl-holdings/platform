/**
 * Continuum Contract Bridge
 *
 * Maps Continuum OS runtime types (@workspace/forge) onto
...
/**
 * Map an Continuum `RunStatus` to the visual PolicyState displayed in a ProofEnvelope.
 *
...
/**
 * Convert Continuum LedgerEntries into EvidenceSource objects suitable for
...
/**
 * Convert Continuum LedgerEntries into TimelineEvent objects for TimelineLane.
...
/**
 * Map an Continuum policy tier string to the closest AutonomyMode displayed in the toggle.
 *
...
// Re-export Continuum types used above for convenience
