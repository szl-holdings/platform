...
export const BUILT_IN_GUARDRAILS: Policy[] = [
  {
    ...
    description: "Blocks autonomous execution of actions estimated to cost more than $10,000 USD without explicit approval.",
    scope: "action",
    priority: 9000,
    isActive: true,
    rules: [
    ...
    rules: [
      {
        ...
        conditions: [
          { field: "regulatoryExposure", operator: "eq", value: true },
        ],
        effect: "require_approval",
  ...
  },
  {
    ...
    description: "Requires approval for critical urgency actions with cross-domain blast radius ≥ 3 domains.",
    scope: "action",
    priority: 7500,
    isActive: true,
    rules: [
      {
        ...
        conditions: [
          { field: "urgency", operator: "eq", value: "critical" },
        ],
        effect: "require_approval",
