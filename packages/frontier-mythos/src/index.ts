/**
 * Frontier Intelligence Mythos Index — shared typed data package.
 *
 * This package is the single source of truth for the competitive capability
 * positioning model AND the broader Mythos knowledge graph used in A11oy\'s
...
// ─── Mythos Index — tracked actor archetypes ──────────────────────────────────
...
export const MYTHOS_ACTORS: MythosActor[] = [
  // Foundation labs
  {
...
export const MYTHOS_IDEAS: MythosIdea[] = [
  {
    id: 'idea-agentic-ai',
    label: 'Agentic AI',
    kind: 'concept',
...
// ─── Mythos Index — doctrine citations ────────────────────────────────────────

export type CitationKind = 'paper' | 'report' | 'standard' | 'post' | 'policy';

export interface MythosCitation {
  id: string;
  title: string;
  kind: CitationKind;
  year: number;
...
export const MYTHOS_CITATIONS: MythosCitation[] = [
  {
    id: 'mcit-01',
