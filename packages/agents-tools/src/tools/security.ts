...
export const threatScanTool = defineTool({
  ...
  handler: (input) => threatScanHandler(input, THREAT_SCAN_TOOL_MANIFEST) as Promise<z.infer<typeof GenericOutputSchema>>,
});
...
export const alertEscalationTool = defineTool({
  ...
  outputSchema: GenericOutputSchema,
  handler: (input) => alertEscalationHandler(input, ALERT_ESCALATION_TOOL_MANIFEST) as Promise<z.infer<typeof GenericOutputSchema>>,
});
...
export const complianceCheckTool = defineTool({
  ...
  outputSchema: GenericOutputSchema,
  handler: (input) => complianceCheckHandler(input, COMPLIANCE_CHECK_TOOL_MANIFEST) as Promise<z.infer<typeof GenericOutputSchema>>,
});
...
export const incidentContainmentTool = defineTool({
  ...
  outputSchema: GenericOutputSchema,
  handler: (input) =>
    incidentContainmentHandler(input, INCIDENT_CONTAINMENT_TOOL_MANIFEST) as Promise<z.infer<typeof GenericOutputSchema>>,
});
...
export const vulnerabilityReportTool = defineTool({
  ...
  outputSchema: GenericOutputSchema,
  handler: (input) =>
    vulnerabilityReportHandler(input, VULNERABILITY_REPORT_TOOL_MANIFEST) as Promise<z.infer<typeof GenericOutputSchema>>,
});
