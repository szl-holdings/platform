...
**Companion docs:** [EXECUTIVE_SCORECARD.md](EXECUTIVE_SCORECARD.md) · [REVENUE_MODEL.md](REVENUE_MODEL.md) · [DESIGN_PARTNER_SCORECARD.md](DESIGN_PARTNER_SCORECARD.md) · [SERIES_A_READINESS.md](SERIES_A_READINESS.md)
