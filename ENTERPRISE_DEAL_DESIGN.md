...
**Companion docs:** [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) · [PRICING_PACKAGING.md](PRICING_PACKAGING.md) · [PRODUCT_PACKAGING.md](PRODUCT_PACKAGING.md) · [TENANT_TIERS.md](TENANT_TIERS.md)
...
| Domain packs | Per pack | Per [PRICING_PACKAGING.md](PRICING_PACKAGING.md) |
...
| Service credits structure (per [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) SLA) | Sales lead |
...
| Termination | Notice period; data export per [DATA-RETENTION.md](DATA-RETENTION.md) |
