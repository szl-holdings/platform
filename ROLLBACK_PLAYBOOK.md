...
**Related:** [RELEASE_INTELLIGENCE.md](RELEASE_INTELLIGENCE.md) · [OPERATIONS-RUNBOOK.md](OPERATIONS-RUNBOOK.md) · [DEPLOYMENT-GUIDE.md](DEPLOYMENT-GUIDE.md) · [ENVIRONMENT_VALIDATION.md](ENVIRONMENT_VALIDATION.md)
...
3. **File SEV incident** — Open incident in [INCIDENT_RESPONSE.md](INCIDENT_RESPONSE.md)
