...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@workspace/config': resolve(__dirname, 'packages/config/src/index.ts'),
      ...
      '@szl-holdings/platform-registry': resolve(__dirname, 'packages/config/src/index.ts'),
      ...
      '@workspace/ontology': resolve(__dirname, 'packages/ontology/src/index.ts'),
      '@szl-holdings/ontology': resolve(__dirname, 'packages/ontology/src/index.ts'),
  ...
  test: {
    ...
    isolate: true,
    globalSetup: [
      resolve(__dirname, 'tests/utils/smoke-test-preflight.ts'),
      resolve(__dirname, 'tests/utils/warmup-shared-services.ts'),
    ],
    testTimeout: 30000,
    hookTimeout: 15000,
