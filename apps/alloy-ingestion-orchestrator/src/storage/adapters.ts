...
export class PgvectorChunkStoreStub implements ChunkStore {
  async put(_chunk: Chunk): Promise<void> {
    notImplemented('PgvectorChunkStore', 'put');
  }
  async get(_chunkId: string): Promise<Chunk | undefined> {
    notImplemented('PgvectorChunkStore', 'get');
  }
  async listBySource(_sourceId: string, _tenantId: string): Promise<Chunk[]> {
    notImplemented('PgvectorChunkStore', 'listBySource');
  }
  async listByTenant(_tenantId: string, _profileId?: string): Promise<Chunk[]> {
    notImplemented('PgvectorChunkStore', 'listByTenant');
  }
  async delete(_chunkId: string): Promise<boolean> {
    notImplemented('PgvectorChunkStore', 'delete');
  }
  async deleteBySource(_sourceId: string, _tenantId: string): Promise<number> {
    notImplemented('PgvectorChunkStore', 'deleteBySource');
  }
  async count(_tenantId: string, _profileId?: string): Promise<number> {
    notImplemented('PgvectorChunkStore', 'count');
  }
}
...
export class AzureAiSearchIndexStoreStub implements IndexStore {
  async getPointer(_tenantId: string, _profileId: string): Promise<IndexPointer | undefined> {
    notImplemented('AzureAiSearchIndexStore', 'getPointer');
  }
  async upsertPointer(_pointer: IndexPointer): Promise<void> {
    notImplemented('AzureAiSearchIndexStore', 'upsertPointer');
  }
  async swapPointer(
    _tenantId: string,
    _profileId: string,
    ...
    notImplemented('AzureAiSearchIndexStore', 'swapPointer');
  }
  async snapshot(_tenantId: string, _profileId: string): Promise<string> {
    notImplemented('AzureAiSearchIndexStore', 'snapshot');
  }
}
...
export class ObjectStorageRawDocumentStoreStub implements RawDocumentStore {
  async put(_doc: RawDocument): Promise<void> {
    notImplemented('ObjectStorageRawDocumentStore', 'put');
  }
  async get(_sourceId: string, _tenantId: string): Promise<RawDocument | undefined> {
    notImplemented('ObjectStorageRawDocumentStore', 'get');
  }
  async list(_tenantId: string, _profileId?: string): Promise<RawDocument[]> {
    notImplemented('ObjectStorageRawDocumentStore', 'list');
  }
  async delete(_sourceId: string, _tenantId: string): Promise<boolean> {
    notImplemented('ObjectStorageRawDocumentStore', 'delete');
  }
}
