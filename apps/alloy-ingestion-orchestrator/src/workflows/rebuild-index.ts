    ...
    steps: [
      ...
      },
      {
        ...
        input: {
          ...
          projectedImpact: "All retrieval requests will be served from the new index version after swap.",
          projectedRisk: "If the new index is corrupted, retrieval quality will degrade until rolled back.",
