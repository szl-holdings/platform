...
export function buildRotateProfileVersionWorkflow(
  input: RotateProfileVersionInput,
): WorkflowDefinition {
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        input: {
          ...
          projectedImpact:
            'All retrieval for this tenant will use the new profile after promotion.',
          projectedRisk:
            'If the new profile version has degraded retrieval quality, results will worsen until rollback.',
