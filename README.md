...
| Vertical | Domain |
|---|---|
| Sentra | Cyber resilience — exposure mapping, incident command, control drift |
| Counsel | Legal matter management — obligations, exposure, court filings |
| Vessels | Maritime fleet — AIS tracking, voyage P&L, freight |
| Terra | Real estate — distress pipeline, ownership graph, deal workflow |
