...
- A (a11oy FROM MAIN) = OUTSTANDING. a-11-oy.com 404: /v1/ayni, /research/prereg, /research/verify,
...
- B (killinchu FROM MAIN) = LIVE. killinchu.a-11-oy.com 200: /healthz, /v1/finance/fx,
  /elite/wiring/health?probe=true.
- C (szl-router PRIVATE live) = LIVE. a-11-oy.com 200: /v1/router/health, /v1/router/models
...
- F (harvest/metrics stable 200) = CONFIRMED. a-11-oy.com /v1/harvest/metrics 200 across 2 probes;
