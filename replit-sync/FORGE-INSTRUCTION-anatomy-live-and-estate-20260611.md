...
All 3 Spaces RUNNING + a11oy.net reachable as of 00:53 EDT. Policy: **restart ONLY to recover a broken Space (SLEEPING/RUNTIME_ERROR/BUILD_ERROR) — never a healthy one.** anatomy is static and auto-serves on commit (no restart needed). The hourly uptime cron auto-recovers broken Spaces.
