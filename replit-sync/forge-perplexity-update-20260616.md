...
- **Actionable items (16)** — handed to Forge agent (mode=`dispatch-cmd`, ok=`False`):
  ...
  - The static files are staged at platform/replit-sync/hf-a11oy-static/ (README.md with `sdk: static`, and index.html — a polished landing page linking into a-11-oy.com + key surfaces).
  ...
  - Honest: this Space is a front-door/mirror; the real live platform is a-11-oy.com. Don't claim the Space itself runs the backend.
- **Founder-gated, auto-skipped (1)** (Doctrine v11 — keys/secrets/major-bumps):
...
## Auto-loop pass — order `a13f4b97` — 2026-06-16T20:36:09Z
