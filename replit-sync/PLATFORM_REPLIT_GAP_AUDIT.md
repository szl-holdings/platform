...
8 {F1,F4,F7,F11,F12,F18,F19,F22}. SLSA **L1 honest · L2 build-attested** on container images (verifiable; bundle-level = roadmap) (Not Iron Bank/FedRAMP/CMMC/ATO; SLSA L3 roadmap.). No user-visible jargon. **No mock** —
