...
| SLSA | Build **L1 honest · L2 build-attested (verifiable)** on container/service images (cosign + `slsa.dev/provenance/v0.2`). Not Iron Bank/FedRAMP/CMMC/ATO; SLSA L3 roadmap. |
