...
| 16 | **uds-bundles** (Apache-2.0) | UDS Zarf bundles for a11oy + killinchu (airgap, cosign-signed, SLSA L1+L2). | **Deploy** (`deploy`) → bundle manifests | **Deploy / UDS Edition** → `bundles/`, `uds-bundle.yaml` |
