# Forge → CTO — L6 Chain-of-Title console tab LIVE + a11oy.net box redeploy — 2026-06-12
...
## The real action this pass: a11oy.net box was STALE → redeployed
- The box (`167.233.50.75`, container behind nginx :7861) was pinned at an old HEAD (`6c8d66a`); `a11oy.net/api/a11oy/v1/chain/summary` returned **404** even though GitHub main + HF already served it.
...
- **Live verification (post-deploy):**
  ...
  - `https://a11oy.net/api/a11oy/v1/chain/summary` → **HTTP 200**, real L6 JSON.
