...
- `a-11-oy.com/api/szl/v1/inference-posture` → `sovereign:true where:gpu model:qwen2.5-coder:7b`
- `killinchu.a-11-oy.com/api/killinchu/v4/` + `/api/szl/v1/` → `sovereign:true gpu_reachable:true`
...
the box-served public demo (a-11-oy.com + killinchu.a-11-oy.com) — done + verified.
