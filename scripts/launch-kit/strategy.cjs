  ...
  audiences: [
    {
      ...
      posts: [
        'Investor updates in public',
        'Portfolio deep-dives',
        'Term-sheet and fundraising essays',
      ],
    },
    {
      ...
      posts: [
        'Vertical deep-dives (Aegis, Vessels, Terra, Prism Counsel)',
        'Market structure essays',
        'Compliance and governance essays',
      ],
    },
    {
      name: 'AI builders',
      ...
      posts: [
        'AI platform engineering essays',
        'Eval / guardrail / agent-design posts',
...
const VISUAL_IDENTITY = {
  ...
  typography: {
    display:
      'Space Grotesk (weights 500/600/700) — used for headlines, section headers, pull quotes.',
...
const GROWTH_PLAN = {
  ...
  paidTierPricing: {
    ...
    foundingMember:
      '$500 / year (capped at 100 seats in year one). Everything above plus a 1:1 call with the founder per year and early previews of portfolio product roadmaps.',
...
const KPIS = {
  ...
  inboundLeads: {
    ...
    month12:
      '200 qualified conversations; at least 10% converted to paid engagements or investments.',
  },
  trackingSheetSpec: {
    columns: [
      'post_id',
...
const SUBSTACK_CHECKLIST = [
  {
    ...
    detail:
      "Create the Substack publication at szlcommand.substack.com (or the chosen handle). Set publication name to 'SZL Command'.",
  },
  {
    step: 2,
  ...
  },
  {
    ...
    detail:
      'Paste the About-page copy from the positioning section verbatim. Add a headshot or a branded monogram.',
  },
  {
    step: 5,
    task: 'Configure the welcome email',
    detail:
      'Use the welcome email copy from this document. Subject, preview text, body all provided.',
  },
  {
    step: 6,
  ...
  },
  {
    ...
    detail:
      'Point szlcommand.szlholdings.com (or similar) to Substack via CNAME. Do this before launch to avoid URL fragmentation later.',
  },
  {
    step: 8,
  ...
  },
  {
    ...
    detail:
      'Use the LinkedIn short-form and X thread templates from this kit for each of the first three posts.',
  },
  {
    step: 11,
  ...
  },
  {
    ...
    task: 'Cadence lock',
    detail:
      'Lock Tuesday 09:00 ET and Friday 09:00 ET publishing times in the calendar for the next 90 days.',
  },
  {
    step: 13,
