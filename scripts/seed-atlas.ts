...
import { db, atlasArtifactsTable, type AtlasTemplateType, type AtlasArtifactDomain } from "@szl-holdings/db";
    ...
    sections: [
      {
        ...
        content: "LockBit 3.0 ransomware variant detected across 3 systems. 2.4TB encrypted. Drift score: 0.82 (critical). Containment: partial.",
        type: "text",
        order: 0,
      },
      {
        ...
        content: "Branch A (Network Isolation): 72% P(success), 48h recovery, $180K cost. Branch B (Monitor-Contain): 61% P(lateral movement contained), 96h recovery, $380K cost.",
        type: "table",
        order: 1,
        data: {
          branches: [
      ...
      },
      {
        ...
        content: "T+0: Phishing email delivered. T+2h: Initial compromise (AD). T+4h: Lateral movement to ERP. T+6h: Ransomware payload deployed. T+8h: Detection triggered.",
        type: "list",
        order: 2,
      },
      {
        ...
        content: "T1566.001 (Spearphishing Attachment), T1078 (Valid Accounts), T1486 (Data Encrypted for Impact)",
        type: "list",
        order: 3,
      },
    ],
    ...
    sections: [
      {
        ...
        content: "MV Pacific Horizon (IMO-9876543) operating Strait of Hormuz → Rotterdam route. OFAC SDN flag: positive (Bandar Abbas port call). Cargo value: $14.2M. Drift score: 0.61.",
        type: "text",
        order: 0,
      },
      {
        ...
        content: "Original route: Strait of Hormuz → Suez → Rotterdam (18 days). Cape reroute: Cape Town → Rotterdam (26 days, +$180K fuel). Sanctions risk on original: OFAC enforcement exposure.",
        type: "table",
        order: 1,
        data: {
          routes: [
      ...
      },
      {
        id: "incidents",
        title: "Risk Flags",
        content: "1. OFAC SDN — Bandar Abbas port call detected. 2. Arabian Sea storm system — severity moderate, track intersecting original route days 6–8.",
        type: "list",
        order: 2,
      },
      {
        ...
        content: "Recommend Cape of Good Hope reroute. 88% P(clean transit). $180K additional fuel cost vs. $14.2M cargo exposure and OFAC enforcement risk on original route.",
        type: "text",
        order: 3,
      },
    ],
    ...
    sections: [
      {
        ...
        content: "842 Atlantic Ave, Brooklyn, NY 11238. Distress score: 87/100. Lis pendens: active. Tax arrears: $142K. Days on market: 214. ARV: $2.8M. Current ask: $1.95M.",
        type: "text",
        order: 0,
      },
      {
        ...
        content: "Crown Heights/Prospect Heights sub-market. Median PSF: $1,180. Subject property at significant discount to ARV due to distress. Comparable sales: 3 comps within 0.3mi at $2.6–$3.1M.",
        type: "text",
        order: 1,
      },
      {
        ...
        content: "Scenario A (Base, 66%): Acquire at $1.82M, settle arrears, reposition. IRR: 24%, net gain $930K. Scenario B (Soft market, 28%): Extended hold, IRR: 14%, gain $560K. Scenario C (Structural, 6%): Post-acq issue, breakeven.",
        type: "table",
        order: 2,
        data: {
          scenarios: [
      ...
      },
      {
        ...
        content: "Composite opportunity score: 84/100. Distress depth: high. Market timing: favorable. Structural risk: low-moderate. Comparable recovery: strong.",
        type: "kpi_grid",
        order: 3,
      },
    ],
    ...
    sections: [
      {
        ...
        content: "Holloway v. Meridian Capital Group. Commercial dispute. Total exposure: $8.4M. Key deadline: 34 days. Discovery: ongoing. Settlement offer on table: $3.2M. Client pressure score: 78/100.",
        type: "text",
        order: 0,
      },
      {
        ...
        content: "Outside counsel recommends modified settlement at $4.2M. Avoids extended discovery cost ($280K est.) and trial exposure ($8.4M). Net savings vs. trial: $2.8M.",
        type: "text",
        order: 1,
      },
      {
        ...
        content: "Path A (Settle at $4.2M, 71%): Total cost $4.2M, trial risk avoided. Path B (Trial, 29%): Full $8.4M exposure + $480K litigation cost.",
        type: "table",
        order: 2,
        data: {
          paths: [
            { label: "Accelerated settlement at $4.2M", probability: 0.71, totalCostUsd: 4200000, trialRiskAvoided: true },
            { label: "Trial proceeds", probability: 0.29, totalCostUsd: 8880000, trialRiskAvoided: false },
          ],
        },
      },
      {
        ...
        content: "1. Outside counsel recommendation (attached). 2. Partner review. 3. Client sign-off. All three gates required before settlement execution via Alloy.",
        type: "list",
        order: 3,
      },
    ],
