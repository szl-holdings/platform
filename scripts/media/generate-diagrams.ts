...
function generateEcosystemMapSVG(): string {
  ...
  <text x="450" y="152" text-anchor="middle" class="desc">KORA · Counsel · Domain Packs</text>
...
function generateSignalToActionSVG(): string {
  ...
  <text x="450" y="56" text-anchor="middle" font-size="10" fill="#64748b" letter-spacing="0.12em">SZL HOLDINGS PLATFORM · KORA + Counsel CORE</text>
  ...
  <text x="270" y="392" text-anchor="middle" font-size="9" fill="#475569">KORA + Counsel intelligence and execution spine.</text>
