...
function generateEcosystemMapSVG(): string {
  ...
  <text x="450" y="152" text-anchor="middle" class="desc">Lyte · Alloy · Domain Packs</text>
  ...
  <text x="450" y="248" text-anchor="middle" class="section-title" fill="#0ea5e9">ALLOY</text>
...
function generateSignalToActionSVG(): string {
  ...
  <text x="450" y="56" text-anchor="middle" font-size="10" fill="#64748b" letter-spacing="0.12em">SZL HOLDINGS PLATFORM · LYTE + ALLOY CORE</text>
  ...
  <text x="260" y="204" text-anchor="middle" class="step-desc">Alloy fabric</text>
  ...
  <text x="610" y="112" text-anchor="middle" class="step-label" fill="#0ea5e9">ALLOY</text>
  ...
  <text x="270" y="392" text-anchor="middle" font-size="9" fill="#475569">Lyte + Alloy intelligence and execution spine.</text>
