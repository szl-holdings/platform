...
const RECOMMENDED = [
  ...
  { key: "CONNECTOR_ENCRYPTION_KEY", desc: "Connector encryption key (≥32 chars)", blocker: "LB-005" },
...
results.summary = {
  ...
  overall: requiredFailed === 0 ? (recommendedMissing === 0 ? "PASS" : "PASS_WITH_WARNINGS") : "FAIL",
};
