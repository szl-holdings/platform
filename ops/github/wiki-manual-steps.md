...
1. Go to: `https://github.com/stephenlutar2-hash/szl-holdings-platform/wiki/Screenshots-and-Demos`
...
```
https://raw.githubusercontent.com/stephenlutar2-hash/szl-holdings-platform/master/docs/media/screenshots/lyte-overview.jpg
```
