...
`https://github.com/szl-holdings/platform/settings/branches`
...
```bash
gh api repos/szl-holdings/platform/branches/master/protection \
  --method PUT \
...
```bash
gh repo view szl-holdings/platform --json defaultBranchRef
```
