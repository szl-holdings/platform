...
**Companion docs:** [PRICING_PACKAGING.md](PRICING_PACKAGING.md) · [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) · [TENANT_TIERS.md](TENANT_TIERS.md) · [DOMAIN_PACK_CATALOG.md](DOMAIN_PACK_CATALOG.md) · [REVENUE_MODEL.md](REVENUE_MODEL.md)
...
See [PRICING_PACKAGING.md](PRICING_PACKAGING.md) for list prices.
...
See [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) for the long-form edition sheet.

---

## Domain Pack Composition

Each domain pack is itself a defined bundle. From [DOMAIN_PACK_CATALOG.md](DOMAIN_PACK_CATALOG.md):
