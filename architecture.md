...
> **Navigation:** [ontology.md](ontology.md) · [policy-model.md](policy-model.md) · [telemetry-model.md](telemetry-model.md) · [app-moats.md](app-moats.md) · [AGENTS.md](AGENTS.md) · [CODEX_HANDOFF.md](CODEX_HANDOFF.md)
...
All surfaces share six governance primitives: Outcome Graph, Proof Chain, Covenant Policy, Decision Simulation (Monte Carlo), Workflow Engine, and Event Fabric (Prism Bus). See [PLATFORM_PRIMITIVES.md](PLATFORM_PRIMITIVES.md) for the full definition.
...
*For the legacy doc index see [docs/CANONICAL_INDEX.md](docs/CANONICAL_INDEX.md). For drift history see [AUDIT_FINDINGS_REGISTER.md](AUDIT_FINDINGS_REGISTER.md).*
