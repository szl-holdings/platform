# `khipu-doctrine` — PR Governance Check

A first-party GitHub Action that runs the PR-time governance subset of the [Khipu Doctrine Open Spec](../../../docs/a11oy/spec/khipu-doctrine-spec/README.md).
...
|:------|:--------|:--------|
| `spec-version` | `0.1.0` | Khipu Doctrine Open Spec version this run targets. |
...
jobs:
  khipu-doctrine:
    ...
    steps:
      ...
      - uses: a11oy/khipu-doctrine@v0.1.0
        with:
          agent-id: op-cascade
