...
| GitHub release | https://github.com/szl-holdings/platform/releases/tag/v1.0-standby                                                                                  | 2026-04-18T12:30:25Z      |
...
- [x] GitHub release link points to the correct tag. Public Release "v1.0-standby — Wave 3 Launch Standby" published 2026-04-18T12:30:25Z against tag `v1.0-standby` on `szl-holdings/platform`; verified HTTP 200 unauthenticated on 2026-04-19 at https://github.com/szl-holdings/platform/releases/tag/v1.0-standby.
