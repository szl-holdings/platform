...
| Document | Purpose |
|----------|---------|
| [KNOWN-GAPS.md](../operations/known-gaps.md) | Full gap registry referenced by this roadmap |
| [TECHNICAL_DILIGENCE_PACKET.md](../investor/technical-diligence-packet.md) | Technical foundation this roadmap builds on |
| [DEPLOYMENT-GUIDE.md](../operations/deployment-guide.md) | Deployment procedures for M1 production deployment |
| [ops/frontier/launch-readiness-scorecard.md](../../ops/frontier/launch-readiness-scorecard.md) | Launch readiness tracking |
| [docs/investor/go-to-market.md](../investor/go-to-market.md) | GTM strategy that the design partner program executes |
