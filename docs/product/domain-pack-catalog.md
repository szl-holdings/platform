...
**Companion docs:** [PRODUCT_PACKAGING.md](packaging.md) · [PLATFORM_PRIMITIVES.md](../architecture/platform-primitives.md) · [CATEGORY_POSITIONING.md](../sales/category-positioning.md)

> **Product naming:** The canonical product name → artifact map is now in [app-moats.md](../architecture/app-moats.md). This document retains the domain pack anatomy, agent lists, action vocabulary, and scenario library. See [docs/CANONICAL_INDEX.md](../CANONICAL_INDEX.md).
...
See [PLATFORM_PRIMITIVES.md](../architecture/platform-primitives.md) for the primitives every pack inherits.
...
5. RBAC role mappings published in [ACCESS-CONTROL-MATRIX.md](../security/access-control-matrix.md)
...
Once approved, the pack is added to this document, [PRODUCT_PACKAGING.md](packaging.md), [PLATFORM_EDITIONS.md](platform-editions.md), and the public site.
