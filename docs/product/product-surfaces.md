...
> For the product surface-to-primitive mapping see [PRODUCT_SURFACE_MAP.md](product-surface-map.md). For the category narrative see [CATEGORY_POSITIONING.md](../sales/category-positioning.md).
...
All surfaces share six platform primitives — see [PLATFORM_PRIMITIVES.md](../architecture/platform-primitives.md) for the full specification.
...
**Related:** [architecture.md](../architecture/architecture.md) · [SYSTEM-OVERVIEW.md](../architecture/system-overview-executive.md) · [API-SPEC.md](../architecture/api-spec.md) · [ACCESS-CONTROL-MATRIX.md](../security/access-control-matrix.md)
