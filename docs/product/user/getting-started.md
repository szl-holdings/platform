...
| I want to... | Go to |
|---|---|
| Set up my organization | [ADMIN_SETUP_GUIDE.md](admin-setup-guide.md) |
| Understand all features | [FEATURE_OVERVIEW.md](../feature-overview.md) |
| Learn daily operator workflows | [OPERATOR_GUIDE.md](operator-guide.md) |
| Troubleshoot an issue | [TROUBLESHOOTING_GUIDE.md](troubleshooting-guide.md) |
