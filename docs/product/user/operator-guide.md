...
- [End User Guide](end-user-guide.md) — Daily interface reference
- [Admin Setup Guide](admin-setup-guide.md) — Organization configuration
- [Troubleshooting](troubleshooting-guide.md) — Common issues
- [Platform Primitives](../../architecture/platform-primitives.md) — Technical architecture
- [Demo Guide](../../sales/demo-guide.md) — Demo scripts for showing the platform to others
