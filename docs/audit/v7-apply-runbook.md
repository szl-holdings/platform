...
1. **Resolve PM decisions** — see `docs/audit/v7-pm-decisions.md`. Until
   ...
   **Status (2026-05-17): all three decisions are recorded.**
   ...
   With these decisions recorded, steps 2 → 7 may proceed in order with
   per-batch sign-off. No further PM gating is required for the V7
   apply pass.
