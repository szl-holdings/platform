...
> **Source of truth:** `generated/platform-metrics.json`  
> **Generated by:** `scripts/audit/generate-platform-metrics.ts`  
> **Regenerate:** `npx tsx scripts/audit/generate-platform-metrics.ts`  
> **Do not hand-edit this file.** All counts below are derived from the generated output.
...
| Database table definitions (Drizzle pgTable) | 1,047 |
| SQL migrations | 59 |
...
*Numbers sourced from `generated/platform-metrics.json` (generated 2026-04-27). CI workflow count reflects the generator's count at that timestamp. To refresh all counts: `npx tsx scripts/audit/generate-platform-metrics.ts`*
