...
# RESEARCH_KHIPU — A11oy Frontier Intelligence Doctrine
...
**A11oy implication:** AI2's benchmarks inform the Khipu Index as external evaluation ground truth. BigBench Hard tasks are cited in Capability Bet 12. Semantic Scholar feeds into A11oy's academic scanner pipeline.
...
**Target surfaces:** MirrorEval, Pillpintu Attestation, Covenant Layer
...
**A11oy position:** Constitution DSL + Pillpintu attestation is core differentiation.  
**Gap:** Third-party certification pathway not yet established.  
**Target surfaces:** Constitution DSL, Pillpintu Attestation, Covenant Layer
...
**Target surfaces:** RedTeam module, Pillpintu Attestation, Constitution Review Queue
...
**Target surfaces:** Sovereign Mode, FlexCache Runtime, Pillpintu Attestation (residency extension)
...
**Target surfaces:** Proof Ledger, Snapshot Provenance, Pillpintu Attestation
...
**Target Surface:** Proof Ledger, Covenant Layer, Pillpintu Attestation
...
**Success Signal:** Policy update round-trip (draft → approval → live) under 60 seconds; zero agent restart required; mutation events fully auditable in Pillpintu.
...
**Success Signal:** All cross-Workcell delegations carry a verifiable capability token; zero cross-agent impersonation in red-team exercises; token chain auditable end-to-end in Pillpintu.
...
**Target Surface:** Sovereign Mode, Pillpintu Attestation, FlexCache Runtime, Covenant Layer
...
**Proposed Capability:** Build a causal attribution layer on top of the Outcome Verifier that traces a failed outcome back to the specific reasoning step, model call, or policy constraint that caused it, presented as a ranked causal tree in the Pillpintu audit view.

**Target Surface:** Outcome Verifier, Proof Ledger, Pillpintu Attestation, Workcell Execution
...
**Target Surface:** Proof Ledger, Pillpintu Attestation, Covenant Layer, Agent Identity Registry
...
Three ideas added to the shared frontier-khipu package (`@szl-holdings/frontier-khipu`) to align the
Helios API enrichment keyspace with the KhipuIndex UI. These complete the taxonomy of nodes that carry
...
- `docs/a11oy/KHIPU_RESEARCH_SWEEP.md` — Behavioral audit, adversarial robustness, constitutional runtime sweep  
