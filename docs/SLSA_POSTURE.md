...
| Zarf packages and `szl-mesh` bundle | [`.github/workflows/szl-zarf-publish.yml`](../.github/workflows/szl-zarf-publish.yml) configures keyless signing, a custom SLSA provenance predicate, and in-workflow verification. | **MODELED / UNEVALUATED.** No current published package, bundle, or attestation was independently retrieved and verified. The predicate is labeled SLSA v0.2 in the workflow and has not been assessed against v1.2 Build Track requirements here. |
