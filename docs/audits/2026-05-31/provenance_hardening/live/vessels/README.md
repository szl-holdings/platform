...
> 🦅 **What's New — vessels has pivoted to the air domain.** The same UDS mesh, Λ-gate governance, and Khipu receipts now power **[Killinchu](https://huggingface.co/spaces/SZLHOLDINGS/killinchu)** — the SZL counter-UAS / drone-intelligence flagship. Maritime domain awareness → airborne unmanned domain awareness: real Remote-ID / ADS-B / MAVLink decoders, a 53-system drone database, multi-constellation GEOINT, per-drone digital twins with tamper tripwires, and a passive identify & track engine. *We sense, we evidence; we do not jack into third-party drones.* Live at [szlholdings-killinchu.hf.space](https://szlholdings-killinchu.hf.space) · machine-readable at `/api/vessels/v1/killinchu-redirect`.
...
---
© SZL Holdings · Stephen P. Lutar Jr. · Doctrine v10 — Proprietary runtime · BSL-1.1 platform · CC-BY-4.0 research · SLSA L1
