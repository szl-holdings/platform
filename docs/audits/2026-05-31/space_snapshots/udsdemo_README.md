...
pinned: true
license: apache-2.0
short_description: "UDS mesh: 7 organs, 12 MCP tools, Lean 456/14/6"
tags:
  - governance
  - agentic-ai
  - doctrine-v9
...
SZL Holdings builds a formally-verified governance gate for agentic AI. The Λ aggregator is proved in Lean 4 against 456 declarations / 14 unique axioms / 6 tracked sorries. Every gate decision emits a DSSE-signed receipt onto a hash-linked Khipu Merkle DAG with summation-checked integrity. The system packages as a UDS bundle and aligns with EU AI Act Article 12 and NIST AI RMF.
...
- the **Lean kernel stats** — 456 / 14 / 6 @ c7c0ba17
...
| 11 | `doctrine_gate` | Doctrine v9 | Checks an action and payload against Doctrine v9 gate rules via a11oy-core |
...
| Item | Value |
|------|-------|
| Lean 4 declarations | **456** |
| Raw axioms | 15 |
| Unique axioms | **14** |
| Tracked sorries | **6** (all with documented discharge routes) |
...
**Note on sorries:** 6 tracked sorries remain — each with a documented discharge route. The critical sorry is in TH10 (uniqueness theorem, CAUCHY_ND) — meaning the headline Λ uniqueness claim is axiomatized at this commit, not fully closed. PR #134 is open to align Zenodo metadata with the live 456/6 count.
...
**EU AI Act Article 13 (Transparency):** The open Zenodo thesis (DOI `10.5281/zenodo.20434276`) documents the Lean 4 formal proof, all 456 declarations, and the 6 sorry discharge routes. The `LIABILITY_AND_LIMITS.md` honest-disclosure artifact is a governance artifact bundled with every deployment.

**NIST AI RMF — GOVERN function:** The a11oy doctrine gate (tool #12) enforces Doctrine v9 at the policy substrate level, blocking 15 categories of destructive action (`branch_protection_edit`, `force_push`, `repo_delete`, `cron_*`, `spend`, `credential_write`, etc.) before they reach any execution surface.
...
---
© SZL Holdings · Founder: Stephen P. Lutar Jr. (ORCID 0009-0001-0110-4173 · stephen@szlholdings.com) · Doctrine v9
