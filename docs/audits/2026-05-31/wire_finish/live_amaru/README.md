...
**Canonical numbers (locked 2026-05-31):** Doctrine v10 · 15 axioms (14 unique) · 749 Lean 4 declarations · 163 sorries · 44 anchor formula gates · SLSA L1 (honest). These resolve to CI logs and the Mathlib-based Lean source (formula moat); browse them in the [UDS demo Space](https://huggingface.co/spaces/SZLHOLDINGS/uds-demo).
...
---
© SZL Holdings · Stephen P. Lutar Jr. · Doctrine v10 — no marketing language; every number resolves to a CI log or DOI.
