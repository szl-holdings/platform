...
| Revenue / insurance | exact `insurance` repository absent; one private revenue-adjacent repository exists | decide disclosure or another public revenue-adjacent substitute | **FOUNDER DECISION 3** | MODELED |
...
| 3 — revenue slot | authorize a specific private disclosure; choose another public revenue surface; defer slot | **NOT DECIDED** | **REQUIRED** |
...
- no publication of a private repository without a specific founder disclosure decision;
