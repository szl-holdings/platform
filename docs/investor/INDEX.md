...
| [atlas-spatial-runtime-moat.md](atlas-spatial-runtime-moat.md) | ATLAS spatial runtime moat analysis |
| [revenue-model.md](revenue-model.md) | Revenue model: platform fee, per-seat, domain pack pricing |
| [pricing-packaging.md](pricing-packaging.md) | Pricing and packaging details |
| [plan-matrix.md](plan-matrix.md) | Plan matrix: tier features and pricing |
| [go-to-market.md](go-to-market.md) | GTM strategy from investor perspective |
| [problem-opportunity.md](problem-opportunity.md) | Problem and market opportunity framing |
| [why-now.md](why-now.md) | Why now: market timing and tailwinds |
| [why-team.md](why-team.md) | Why this team: founder background and credibility |
| [platform-portfolio.md](platform-portfolio.md) | Platform portfolio: all domain packs and status |
