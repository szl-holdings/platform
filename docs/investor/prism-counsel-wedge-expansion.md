...
- **Titles:** General Counsel, Head of Litigation, Head of Compliance, Director of Legal Operations
- **Company size:** 500–5,000 employees with an in-house legal team of 5–25
- **Trigger events:** Recent missed deadline incident, regulatory action, or audit finding that required reconstructing a decision chain after the fact
- **Industries:** Financial services, insurance, healthcare, regulated industrial — environments where legal obligations carry statutory deadlines and the cost of a missed obligation is measurable
...
Land on deadline, obligation, and matter governance for a single in-house team. Prove the proof-chain story on a real audit pull. Drive expansion within the legal organization.

### Stage 2 — Privilege & Disclosure Controls

Add privilege-aware redaction, disclosure approval flow, and audit-grade access logs. Replace the spreadsheet-and-shared-drive privilege register that every legal ops team maintains today.
...
Open a constrained surface to outside counsel partners — privilege-scoped, audit-trailed, governed by the same Covenant Policy that governs internal access. This is the channel into outside-counsel software spend, which is structurally larger than in-house spend.

---

## Why the Expansion Path Defends Itself

Each stage is a capability the wedge buyer already wanted but did not have a single platform for. Each stage strengthens the proof-chain audit trail rather than diluting it. And each stage compounds the platform-level investment: the obligation graph, Proof Chain, and Covenant Policy primitives at the foundation are the same ones that power Aegis, Vessels, and Terra.

The competitive risk at each stage is a point-tool incumbent — but no point tool carries the proof-chain governance substrate, and that substrate is increasingly a procurement requirement, not a feature.
