...
**Companion docs:** [TENANCY-MODEL.md](../architecture/tenancy-model.md) · [ACCESS-CONTROL-MATRIX.md](access-control-matrix.md) · [DATA-RETENTION.md](data-retention.md)
...
- **Database hosting:** PostgreSQL deployment, automated backups (per [BACKUP-RESTORE.md](../operations/backup-restore.md)), encryption at rest, access controls.
...
- **Availability:** Best-effort uptime targeting 99.5% at GA. Incident response per [INCIDENT_RESPONSE.md](../operations/incident-response.md).
...
- **Backup integrity:** Regular automated backups with tested restore procedures per [BACKUP-RESTORE.md](../operations/backup-restore.md).
...
- **Incident response:** Responding to platform incidents per [INCIDENT_RESPONSE.md](../operations/incident-response.md) and [SEVERITY_MODEL.md](../operations/severity-model.md).
...
- Honest disclosure of platform gaps and limitations (see [KNOWN-GAPS.md](../operations/known-gaps.md)).
