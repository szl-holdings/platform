...
**Companion docs:** [SECURITY.md](../../SECURITY.md) · [ACCESS-CONTROL-MATRIX.md](access-control-matrix.md) · [TENANCY-MODEL.md](../architecture/tenancy-model.md) · [AI_GOVERNANCE.md](../architecture/ai-governance.md)
...
Yes. See [docs/DATA_CLASSIFICATION.md](../DATA_CLASSIFICATION.md) for data sensitivity tiers. [Current]
...
Yes. Known gaps are tracked in [KNOWN-GAPS.md](../operations/known-gaps.md) with severity, status, and remediation owners. All P0 items are resolved as of April 2026.
...
See [AI_GOVERNANCE.md](../architecture/ai-governance.md) for the complete AI governance posture.
...
A GDPR privacy framework is in place (see [PRIVACY_OVERVIEW.md](privacy-overview.md)). Full legal compliance review with external counsel is required before EU commercial launch. [Framework in place]
...
Yes. See [INCIDENT_RESPONSE.md](../operations/incident-response.md) and [SEVERITY_MODEL.md](../operations/severity-model.md).

**Q: What are the RTO and RPO targets?**  
RTO: 4 hours. RPO: 1 hour. See [BACKUP-RESTORE.md](../operations/backup-restore.md) for tier-specific targets.
...
Planned. See [STATUSPAGE_PLAN.md](../operations/statuspage.md). [Planned — pre-GA]
...
See [docs/THIRD_PARTY_REGISTER.md](../THIRD_PARTY_REGISTER.md) for the full register. Key providers: Azure (infrastructure), Stripe (payments), OpenAI/Anthropic/HuggingFace (AI inference).

**Q: Are third-party providers vetted?**  
Yes. Major providers are evaluated for their security posture, certifications, and data processing terms before integration. See [docs/DEPENDENCY_POLICY.md](../DEPENDENCY_POLICY.md).
