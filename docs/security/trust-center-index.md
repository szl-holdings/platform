...
| Compliance posture | GDPR/CCPA privacy frameworks in place. **SOC 2 Type II audit engagement signed with A-LIGN on 2026-04-19; observation period in progress (2026-05-01 → 2026-10-31).** Type I bridge report targeted 2026-07-31; Type II report targeted 2027-01-31. See [SOC2_AUDIT_ENGAGEMENT.md](soc2-audit.md). |
...
| [docs/trust/security-posture.md](../trust/security-posture.md) | Technical / CISO | Security architecture deep-dive: auth, encryption, network, monitoring |
| [KNOWN-GAPS.md](../operations/known-gaps.md) | Technical / Investors | Honest gap register with severity, status, and remediation owners |
...
| [docs/ACCESS_CONTROL.md](../ACCESS_CONTROL.md) | Access control policy — source document |
| [docs/SECRETS_POLICY.md](../SECRETS_POLICY.md) | How secrets are managed, stored, and rotated |
...
| Document | Summary |
|----------|---------|
| [PLATFORM_PRIMITIVES.md](../architecture/platform-primitives.md) | Six governance primitives — Proof Chain, Covenant Policy, Outcome Graph, Monte Carlo, Workflow Engine, Event Fabric |
| [PROOF_AND_POLICY_MODEL.md](../architecture/proof-and-policy-model.md) | How AI outputs are tagged, reviewed, and governed before export |
| [AI_EVALUATION_STRATEGY.md](../architecture/ai-evaluation-strategy.md) | INCA evaluation framework — confidence calibration, output scoring, drift detection |
| [AI_GOVERNANCE.md](../architecture/ai-governance.md) | Buyer-facing AI governance posture — advisory-only model, human-in-the-loop enforcement, override attribution |
...
| [docs/DATA_CLASSIFICATION.md](../DATA_CLASSIFICATION.md) | Data sensitivity tiers |
| [docs/THIRD_PARTY_REGISTER.md](../THIRD_PARTY_REGISTER.md) | All third-party services and their data access |
| [docs/trust/privacy-boundaries.md](../trust/privacy-boundaries.md) | Data privacy model and jurisdictional commitments |
| [docs/LOGGING_AND_RETENTION.md](../LOGGING_AND_RETENTION.md) | What is logged, for how long, and how it is protected |
| [docs/ENVIRONMENT_SEPARATION.md](../ENVIRONMENT_SEPARATION.md) | Dev/staging/production isolation |
| [docs/DEPENDENCY_POLICY.md](../DEPENDENCY_POLICY.md) | Package management and vetting policy |

### Shared Responsibility

See [SHARED_RESPONSIBILITY_MODEL.md](shared-responsibility.md) for the clear delineation of what SZL Holdings is responsible for versus what the customer organization is responsible for, covering infrastructure, identity, access control, data, AI governance, and compliance.
...
- See [PRIVACY_OVERVIEW.md](privacy-overview.md) for a full privacy overview covering data collection, rights requests, sub-processors, AI and privacy, and breach notification.
...
| Document | Summary |
|----------|---------|
| [SUPPORT_OPERATIONS.md](../sales/support-operations.md) | Support channels, tiers, triage workflow, SLAs, escalation path, and response templates |
| [INCIDENT_COMMAND_PLAYBOOK.md](../operations/incident-command.md) | Full incident command lifecycle: detection, declaration, response, communication, post-mortem |
| [SEVERITY_MODEL.md](../operations/severity-model.md) | P0–P3 severity definitions, response targets, escalation, and classification decision tree |
| [CUSTOMER_ESCALATION_MATRIX.md](../sales/customer-escalation.md) | Escalation paths by issue type: outage, breach, access issue, feature request, billing |
| [STATUSPAGE_PLAN.md](../operations/statuspage.md) | Status page implementation plan, component monitoring, incident update templates |
| [RUNBOOK_COMMON_FAILURES.md](../operations/common-failures.md) | Step-by-step runbooks for 10 common failure scenarios |
| [SUPPORT_HANDOFF_GUIDE.md](../sales/support-handoff.md) | Incident Commander transfer, support ticket handoff, end-of-day procedures |
| [INCIDENT_RESPONSE.md](../operations/incident-response.md) | Incident handling procedures (legacy reference) |
| [INCIDENT_SEVERITY_MATRIX.md](../operations/incident-severity.md) | Incident classification matrix (legacy reference; superseded by SEVERITY_MODEL.md) |
| [BACKUP-RESTORE.md](../operations/backup-restore.md) | Buyer-facing backup & restore commitments — RPO/RTO targets, restore drill cadence, data residency |
| [ops/infra/recovery-and-backup-model.md](../../ops/infra/recovery-and-backup-model.md) | Backup model detail |
| [OPERATIONS-RUNBOOK.md](../operations/operations-runbook.md) | Operational procedures and failure modes |
| [docs/trust/deployment-model.md](../trust/deployment-model.md) | Infrastructure and deployment approach |
...
For the engagement scope, observation window, evidence sources, and per-criterion readiness, see [SOC2_AUDIT_ENGAGEMENT.md](soc2-audit.md). Enterprise evaluators may request the engagement letter and current bridge letter under NDA at security@szlholdings.com.
...
| Document | Purpose |
|----------|---------|
| [TECHNICAL_DILIGENCE_PACKET.md](../investor/technical-diligence-packet.md) | Single-document technical diligence reference — architecture, tenancy, governance, AI, observability, known gaps |
| [SECURITY_QUESTIONNAIRE_PACK.md](security-questionnaire.md) | Pre-answered responses to common enterprise security questionnaire topics |
| [SHARED_RESPONSIBILITY_MODEL.md](shared-responsibility.md) | Platform vs customer responsibility across infrastructure, identity, data, AI, and compliance |
| [PRIVACY_OVERVIEW.md](privacy-overview.md) | Privacy framework: data collection, rights, sub-processors, AI handling, breach notification |
...
| [KNOWN-GAPS.md](../operations/known-gaps.md) | Transparent gap register with severity and remediation status |
| [architecture.md](../architecture/architecture.md) | System architecture — topology, stack, design principles |
...
| Document | Purpose |
|----------|---------|
| [INVESTOR_NARRATIVE.md](../investor/investor-narrative.md) | Governed decision infrastructure thesis — why now, why this architecture |
| [MOAT_MAP.md](../investor/moat-map.md) | Eight structural moats with codebase evidence |
| [PRODUCT_ROADMAP.md](../product/roadmap.md) | 30-day and 90-day priorities |
| [docs/investor/platform-thesis.md](../investor/platform-thesis.md) | Platform thesis in detail |
| [docs/investor/data-room-index.md](../investor/data-room-index.md) | Data room index |
