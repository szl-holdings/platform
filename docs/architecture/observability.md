...
> **⚠ Canonical replacement:** [telemetry-model.md](telemetry-model.md) (April 2026) supersedes this document as the source of truth for the telemetry model, observability surfaces, and correlation contract. This file is retained for historical reference. See [docs/CANONICAL_INDEX.md](../CANONICAL_INDEX.md).
