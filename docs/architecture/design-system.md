...
| Navigation strategy | [NAVIGATION_STRATEGY.md](../product/navigation-strategy.md) |
| Route inventory | [ROUTE_INVENTORY.md](route-inventory.md) |
| Platform primitives | [PLATFORM_PRIMITIVES.md](platform-primitives.md) |
| Product surface map | [PRODUCT_SURFACE_MAP.md](../product/product-surface-map.md) |
