...
*Supersedes: [OBSERVABILITY_ARCHITECTURE.md](observability.md). See also: [architecture.md](architecture.md) · [packages/telemetry-standards/](packages/telemetry-standards/) · [packages/observability-core/](packages/observability-core/)*
