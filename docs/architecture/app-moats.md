...
> **Navigation:** [architecture.md](architecture.md) · [ontology.md](ontology.md) · [policy-model.md](policy-model.md) · [MOAT_MAP.md](../investor/moat-map.md)
...
The following moats describe why the "Living Infrastructure / Adaptive Intelligence Mesh" is defensible. Each moat compounds with use. See [MOAT_MAP.md](../investor/moat-map.md) for the full analysis; this section summarizes the architecture-grounded properties that make the vision durable.
...
*Supersedes product-naming sections of: [MOAT_MAP.md](../investor/moat-map.md) · [DOMAIN_PACK_CATALOG.md](../product/domain-pack-catalog.md). For full moat analysis, see [MOAT_MAP.md](../investor/moat-map.md). For artifact runtime config, see [docs/PLATFORM_CANONICAL.md](../PLATFORM_CANONICAL.md).*
