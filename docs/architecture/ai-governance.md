...
**Companion docs:** [PLATFORM_PRIMITIVES.md](platform-primitives.md) · [PROOF_AND_POLICY_MODEL.md](proof-and-policy-model.md) · [SECURITY.md](../../SECURITY.md) · [TENANCY-MODEL.md](tenancy-model.md)
...
7. **We publish what we know and what we do not.** Known gaps in AI governance are listed in [KNOWN-GAPS.md](../operations/known-gaps.md).
...
See [PROOF_AND_POLICY_MODEL.md](proof-and-policy-model.md) for the full model.
...
See [ACCESS-CONTROL-MATRIX.md](../security/access-control-matrix.md) for role mappings per action class.
...
See [PLATFORM_PRIMITIVES.md](platform-primitives.md) Outcome Graph section.
...
From [KNOWN-GAPS.md](../operations/known-gaps.md):
...
| NIST AI RMF | Map → Measure → Manage → Govern: documented in this file + [SECURITY.md](../../SECURITY.md) + [INCIDENT_RESPONSE.md](../operations/incident-response.md) |
| ISO/IEC 42001 (AI management) | Aligned; certification not yet pursued |
| SOC 2 (AI controls) | Logical access (CC6) extended to AI: per [ACCESS-CONTROL-MATRIX.md](../security/access-control-matrix.md) |
...
| Proof and policy model | [PROOF_AND_POLICY_MODEL.md](proof-and-policy-model.md) |
...
| Executive demo — trust walkthrough | [EXECUTIVE_DEMO.md](../sales/executive-demo.md) |
| Operator demo — override flow | [OPERATOR_DEMO.md](../sales/operator-demo.md) |
| Product surfaces — trust-provenance route | [PRODUCT-SURFACES.md](../product/product-surfaces.md) |
...
- **`/trust-provenance` route** (Aegis, Terra, Vessels) — 4-tab surface
  ...
  See [PRODUCT-SURFACES.md](../product/product-surfaces.md#trust--provenance-surface).
