...
**Supersedes:** [INCIDENT_SEVERITY_MATRIX.md](incident-severity.md) (retained for reference)
**Companion docs:** [INCIDENT_COMMAND_PLAYBOOK.md](incident-command.md) · [SUPPORT_OPERATIONS.md](../sales/support-operations.md) · [STATUSPAGE_PLAN.md](statuspage.md)
...
Customer-reported support issues follow a parallel severity model in [SUPPORT_OPERATIONS.md](../sales/support-operations.md). When a support issue indicates a systemic platform problem, it is escalated to the platform incident model (P0–P3) and an Incident Commander is declared.
