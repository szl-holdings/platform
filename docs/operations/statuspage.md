...
**Companion docs:** [INCIDENT_COMMAND_PLAYBOOK.md](incident-command.md) · [SEVERITY_MODEL.md](severity-model.md) · [SUPPORT_OPERATIONS.md](../sales/support-operations.md)
...
2. **All customers:** Direct email per [INCIDENT_COMMAND_PLAYBOOK.md](incident-command.md) customer communication templates
