...
**Related:** [OPERATIONS-RUNBOOK.md](operations-runbook.md) · [SECURITY-CHECKLIST.md](../security/security-checklist.md) · [KNOWN-GAPS.md](known-gaps.md)
...
Before executing any production deployment for public or design-partner launch, verify all hard blockers from [LAUNCH_BLOCKERS.md](../launch/launch-blockers.md) are resolved. This is a mandatory pre-step, not optional:
...
For full blocker details, resolution guidance, and the formal sign-off table, see [LAUNCH_BLOCKERS.md](../launch/launch-blockers.md).
...
*See also: [OPERATIONS-RUNBOOK.md](operations-runbook.md) · [DEPLOYMENT-GUIDE.md](deployment-guide.md) · [docs/deployment.md](../deployment.md)*
---
