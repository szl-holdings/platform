...
**Related:** [RELEASE_INTELLIGENCE.md](release-intelligence.md) · [RELEASE_CHECKLIST.md](release-checklist.md) · [DEPLOYMENT-GUIDE.md](deployment-guide.md) · [Environment Matrix](../../ops/infra/environment-matrix.md)
...
Complete before deploying to Azure production. Also verify all hard blockers from [LAUNCH_BLOCKERS.md](../launch/launch-blockers.md) are resolved.
