...
**Last updated:** 2026-08-26 (rev 26 — Series A current-main successor)
...
Platform PR #656 and its clean current-main successor carry the truth-safe `/a11oy/start` source candidate. GitHub
...
- The clean current-main successor must receive fresh exact-head CI and
