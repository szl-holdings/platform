...
**Companion docs:** [SEVERITY_MODEL.md](severity-model.md) · [SUPPORT_OPERATIONS.md](../sales/support-operations.md) · [RUNBOOK_COMMON_FAILURES.md](common-failures.md) · [STATUSPAGE_PLAN.md](statuspage.md)
...
**IC responsibilities:**
- Declare the incident and assign initial severity per [SEVERITY_MODEL.md](severity-model.md)
...
**IC transfer:** IC responsibilities can be transferred. When transferred, log the handover time, incoming IC name, and current incident state in the incident record. See [SUPPORT_HANDOFF_GUIDE.md](../sales/support-handoff.md).
...
2. **Assign initial severity** per [SEVERITY_MODEL.md](severity-model.md). Use the decision tree. When in doubt, classify higher.
...
5. **For P0:** Post initial status page update immediately (see [STATUSPAGE_PLAN.md](statuspage.md)).
...
See [STATUSPAGE_PLAN.md](statuspage.md) for the status page workflow and templates.
