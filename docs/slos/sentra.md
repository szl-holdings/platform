...
> Source of truth: `https://szlholdings-sentra.hf.space/healthz`
...
- `/healthz` HTTP `200`, observed total latency ≈ **292 ms** (well within 500 ms p99 target).
...
`platform/scripts/rollback_flagship.sh sentra <previous-sha>`.
