...
> Source of truth: `https://szlholdings-amaru.hf.space/healthz`
...
- `/healthz` HTTP `200`, observed total latency ≈ **282 ms** (well within 500 ms p99 target).
...
`platform/scripts/rollback_flagship.sh amaru <previous-sha>`.
