...
> Source of truth: `https://szlholdings-killinchu.hf.space/healthz`
...
- `/healthz` HTTP `200`, observed total latency ≈ **280 ms** (well within 500 ms p99 target).
...
`platform/scripts/rollback_flagship.sh killinchu <previous-sha>`.
