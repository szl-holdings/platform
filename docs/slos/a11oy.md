...
> Source of truth: `https://szlholdings-a11oy.hf.space/healthz`
...
- `/healthz` HTTP `200`, observed total latency ≈ **290 ms** (well within 500 ms p99 target).
...
`platform/scripts/rollback_flagship.sh a11oy <previous-sha>`.
