...
> Source of truth: `https://szlholdings-hatun-mcp.hf.space/healthz`
...
- `/healthz` HTTP `200`, observed total latency ≈ **281 ms** (well within 500 ms p99 target).
...
`platform/scripts/rollback_flagship.sh hatun-mcp <previous-sha>`.
