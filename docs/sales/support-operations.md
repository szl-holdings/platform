...
**Supersedes:** [SUPPORT_OPERATIONS.md](support-operations.md)
**Companion docs:** [SEVERITY_MODEL.md](../operations/severity-model.md) · [INCIDENT_COMMAND_PLAYBOOK.md](../operations/incident-command.md) · [CUSTOMER_ESCALATION_MATRIX.md](customer-escalation.md)
...
**Escalation path:** See [CUSTOMER_ESCALATION_MATRIX.md](customer-escalation.md)
...
For platform incidents (not customer-specific issues), see [SEVERITY_MODEL.md](../operations/severity-model.md) and [INCIDENT_COMMAND_PLAYBOOK.md](../operations/incident-command.md).
...
4. For active incidents: see [SUPPORT_HANDOFF_GUIDE.md](support-handoff.md)
