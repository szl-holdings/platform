...
**Companion docs:** [DEMO_GUIDE.md](demo-guide.md) · [EXECUTIVE_DEMO.md](executive-demo.md) · [OPERATOR_DEMO.md](operator-demo.md) · [TECHNICAL_DEMO.md](technical-demo.md) · [DEMO_ENVIRONMENT_CHECKLIST.md](demo-environment-checklist.md)
...
The demo runs against the demo tenant on production infrastructure. See [TENANT_TIERS.md](../product/tenant-tiers.md). Key properties:
...
| [TECHNICAL_DILIGENCE_PACKET.md](../investor/technical-diligence-packet.md) | Technical |
| [TRUST_CENTER_INDEX.md](../security/trust-center-index.md) link | Technical |
| Custom proof-of-value scope ask | Operator + Executive |
| Pricing reference (if asked) | All |

See [PROOF_OF_VALUE_PLAYBOOK.md](proof-of-value.md) for what comes next if the demo lands.
...
| Document | Path |
|----------|------|
| Demo guide (operational) | [DEMO_GUIDE.md](demo-guide.md) |
| Executive demo script | [EXECUTIVE_DEMO.md](executive-demo.md) |
| Operator demo script | [OPERATOR_DEMO.md](operator-demo.md) |
| Technical demo script | [TECHNICAL_DEMO.md](technical-demo.md) |
