...
**Companion docs:** [SUPPORT_OPERATIONS.md](support-operations.md) · [SEVERITY_MODEL.md](../operations/severity-model.md) · [INCIDENT_COMMAND_PLAYBOOK.md](../operations/incident-command.md)
...
| 3 | Classify as P0/P1 per [SEVERITY_MODEL.md](../operations/severity-model.md) | First responder | < 15 min |
...
| 7 | Resolve per [INCIDENT_COMMAND_PLAYBOOK.md](../operations/incident-command.md) | IC + engineering | Per severity targets |
