...
See [PLATFORM_PRIMITIVES.md](../architecture/platform-primitives.md) for the full technical specification.
...
| Document | Path |
|----------|------|
| Market positioning | [MARKET_POSITIONING.md](market-positioning.md) |
| Platform primitives | [PLATFORM_PRIMITIVES.md](../architecture/platform-primitives.md) |
| System overview | [SYSTEM-OVERVIEW.md](../architecture/system-overview-executive.md) |
