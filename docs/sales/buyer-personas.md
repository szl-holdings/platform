...
**Companion docs:** [GO_TO_MARKET_MOTION.md](go-to-market.md) · [SALES_NARRATIVE.md](sales-narrative.md) · [OBJECTION_HANDLING.md](objection-handling.md)
...
- **Diligence packet** ([TECHNICAL_DILIGENCE_PACKET.md](../investor/technical-diligence-packet.md))
- **Trust Center** ([TRUST_CENTER_INDEX.md](../security/trust-center-index.md))
- **Known Gaps** document — yes, we send it
- **Architecture diagram + access control matrix** ([architecture.md](../architecture/architecture.md), [ACCESS-CONTROL-MATRIX.md](../security/access-control-matrix.md))
