...
**Companion docs:** [DESIGN_PARTNER_PROGRAM.md](design-partner-program.md) · [PILOT_PLAYBOOK.md](pilot-playbook.md) · [ROI_MODEL.md](roi-model.md)
...
|---------|------------|--------------|
| Success | Target met or exceeded; champion + sponsor want to convert | Conversion to standard commercial; pricing per [PRICING_PACKAGING.md](../investor/pricing-packaging.md) |
