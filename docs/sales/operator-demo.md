...
**Companion docs:** [DEMO_STRATEGY.md](demo-strategy.md) · [DOMAIN_PACK_CATALOG.md](../product/domain-pack-catalog.md) · [PROOF_OF_VALUE_PLAYBOOK.md](proof-of-value.md)
...
| What about access? | The 11-role hierarchy is documented at [ACCESS-CONTROL-MATRIX.md](../security/access-control-matrix.md). Your role decides what you can do. |
