...
**Companion docs:** [SALES_HANDOFF_GUIDE.md](sales-handoff-guide.md) · [DEMO_STRATEGY.md](demo-strategy.md) · [DESIGN_PARTNER_AGREEMENT.md](design-partner-agreement.md)
...
Use [DEMO_STRATEGY.md](demo-strategy.md) for the canonical script. Always show:
...
Send [DESIGN_PARTNER_AGREEMENT.md](design-partner-agreement.md) **48 hours before** the meeting, with these sections highlighted:
