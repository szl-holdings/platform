...
**Companion docs:** [PROOF_OF_VALUE_PLAYBOOK.md](proof-of-value.md) · [DESIGN_PARTNER_PROGRAM.md](design-partner-program.md) · [DESIGN_PARTNER_SCORECARD.md](../product/design-partner-scorecard.md)
...
Pilot health is updated weekly. See [DESIGN_PARTNER_SCORECARD.md](../product/design-partner-scorecard.md) for the full scorecard. Headline:
