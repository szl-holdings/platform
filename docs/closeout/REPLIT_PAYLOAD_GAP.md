...
2. **Trigger the push** — run `python3 REPLIT_SZL_SINGLE.py` to re-extract, then commit each file group to its target repo under Doctrine v11 LOCKED 749/14/163 with DCO sign-off.
...
*Doctrine v11 LOCKED 749/14/163 — no bandaids, no hype.*
