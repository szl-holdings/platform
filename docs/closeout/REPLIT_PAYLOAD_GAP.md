...
2. **Trigger the push** — run `python3 REPLIT_SZL_SINGLE.py` to re-extract, then commit each file group to its target repo under Doctrine v6 with DCO sign-off.
...
*Doctrine v6 clean — no bandaids, no hype.*
