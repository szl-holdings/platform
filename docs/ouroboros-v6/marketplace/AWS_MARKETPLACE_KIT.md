# cloud marketplace Kit — Ouroboros Guardrails
...
The selected configuration is an annual SaaS Contract as the base tier, with an optional SaaS Subscription overage dimension for receipts beyond the contracted volume. This hybrid is the standard approach for cloud marketplace AI governance SaaS products and is documented in the COMPLIANCE_PLAYBOOK.md.
...
| End-user license agreement (EULA) | Custom EULA uploaded to AMMP or reference to Standard Contract for cloud marketplace (SCMP) | **in-progress** |
...
|---|---|---|---|---|
| enterprise integrator Hamilton | Federal Systems Integrator (Defense / Civilian AI) | $120,000 [CONFIRM] | AI/ML Capability Lead, Strategic Innovation Group — identify via LinkedIn | Target identified; outreach not sent |
| regional bank partner Financial | Regional Bank (Southeastern US) | $48,000 [CONFIRM] | Chief AI Officer or Model Risk Officer — identify via LinkedIn / bank governance filings | Target identified; outreach not sent |
| health system partner Health | Health System (New York) | $48,000 [CONFIRM] | VP of Clinical Informatics or Chief AI Officer — identify via health system partner leadership page | Target identified; outreach not sent |

> Private offers are created at zero cost in the cloud marketplace Management Portal after seller registration. Each offer is scoped to the named AWS account ID of the buyer. Custom EULA and payment terms are set per offer. No public listing required to transact.
...
|---|---|---|---|
| M1: cloud marketplace Seller registration submitted | Week 1 | Stephen Lutar | Seller account ID confirmed; W-9 uploaded |
...
| M5: First private offer delivered to enterprise integrator Hamilton | Month 2 | Stephen Lutar | Private offer link sent to champion contact; 30-day acceptance window |
| M6: Public listing live | Month 3 | Stephen Lutar | Ouroboros appears in cloud marketplace search; ACE co-sell pipeline opened |
...
| M9: Private offers delivered to regional bank partner and health system partner | Month 4–5 | Stephen Lutar | Two additional private offer links; negotiations open |
| M10: GovCloud listing submitted | Month 5–6 | Stephen Lutar | us-gov-east-1 and us-gov-west-1 regions enabled in AMMP |
| M11: First closed SaaS Contract | Month 6 | Stephen Lutar | Executed contract; first cloud marketplace disbursement |
...
- [cloud marketplace Seller Registration Docs](https://docs.aws.amazon.com/marketplace/latest/userguide/seller-account-registering.html)
