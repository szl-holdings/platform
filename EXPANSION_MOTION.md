...
**Companion docs:** [LAND_AND_EXPAND.md](LAND_AND_EXPAND.md) · [PRODUCT_PACKAGING.md](PRODUCT_PACKAGING.md) · [REVENUE_MODEL.md](REVENUE_MODEL.md) · [DESIGN_PARTNER_SCORECARD.md](DESIGN_PARTNER_SCORECARD.md)
...
Per [PRICING_PACKAGING.md](PRICING_PACKAGING.md). Seat increments are sold in chunks of 25 (Starter) or 50 (Pro). Enterprise is unlimited; expansion at Enterprise is via edition mechanics, not seat add-ons.
...
Enterprise is built up modularly per [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) and [PRICING_PACKAGING.md](PRICING_PACKAGING.md). Founder approval required.
...
| Champion engagement | Score ≥ 4 on [DESIGN_PARTNER_SCORECARD.md](DESIGN_PARTNER_SCORECARD.md) (or equivalent for non-DP customers) |
...
See [REVENUE_MODEL.md](REVENUE_MODEL.md) for how this rolls into total revenue forecasting.
...
| Document | Path |
|----------|------|
| Land & expand (overview) | [LAND_AND_EXPAND.md](LAND_AND_EXPAND.md) |
| Product packaging | [PRODUCT_PACKAGING.md](PRODUCT_PACKAGING.md) |
| Editions | [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) |
