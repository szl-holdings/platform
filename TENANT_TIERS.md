...
**Companion docs:** [TENANCY-MODEL.md](TENANCY-MODEL.md) · [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md) · [PRODUCT_PACKAGING.md](PRODUCT_PACKAGING.md)

---

## Purpose

Define the tenancy posture, isolation guarantees, and operational treatment for each tier of customer. This complements [TENANCY-MODEL.md](TENANCY-MODEL.md), which describes the technical architecture; this document specifies the *commercial* and *operational* tiering applied on top.
...
- Seat caps per [PLATFORM_EDITIONS.md](PLATFORM_EDITIONS.md)
...
- All changes captured in the design partner playbook (see [DESIGN_PARTNER_PROGRAM.md](DESIGN_PARTNER_PROGRAM.md))
...
See [TENANCY-MODEL.md](TENANCY-MODEL.md) for the technical detail.
...
| Any → cancellation | Notice period per MSA | Data export window per [DATA-RETENTION.md](DATA-RETENTION.md), then deletion | 90-day export window |
...
See [INCIDENT_RESPONSE.md](INCIDENT_RESPONSE.md) for the response runbook.
...
| Document | Path |
|----------|------|
| Tenancy model (technical) | [TENANCY-MODEL.md](TENANCY-MODEL.md) |
