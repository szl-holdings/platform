...
See [INCIDENT_SEVERITY_MATRIX.md](INCIDENT_SEVERITY_MATRIX.md) for full definitions.
...
1. **Stop the bleeding** — Is rollback the fastest path to stability?
   - If yes: execute [RUNBOOK_ROLLBACK.md](infra/runbooks/RUNBOOK_ROLLBACK.md) immediately
...
4. **Follow** [docs/ACCESS_CONTROL.md](docs/ACCESS_CONTROL.md) and [docs/SECRETS_POLICY.md](docs/SECRETS_POLICY.md)
