...
- [Feature Overview](FEATURE_OVERVIEW.md) — Complete feature map
- [Platform Primitives](PLATFORM_PRIMITIVES.md) — Technical specification
- [Category Positioning](CATEGORY_POSITIONING.md) — Market positioning and differentiation
- [Technical Diligence Packet](TECHNICAL_DILIGENCE_PACKET.md) — Full technical reference
