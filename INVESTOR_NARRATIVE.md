...
See [MOAT_MAP.md](MOAT_MAP.md) for the complete moat analysis with codebase evidence.
...
See [docs/investor/go-to-market.md](docs/investor/go-to-market.md) for the full GTM strategy and sequencing.
...
See [TECHNICAL_DILIGENCE_PACKET.md](TECHNICAL_DILIGENCE_PACKET.md) for the full technical diligence reference.
...
| [TECHNICAL_DILIGENCE_PACKET.md](TECHNICAL_DILIGENCE_PACKET.md) | Full technical diligence reference |
| [CATEGORY_POSITIONING.md](CATEGORY_POSITIONING.md) | Category definition and competitive positioning |
...
| [KNOWN-GAPS.md](KNOWN-GAPS.md) | Honest assessment of gaps and remediation status |
...
| [docs/investor/product-readiness.md](docs/investor/product-readiness.md) | Product readiness assessment |
