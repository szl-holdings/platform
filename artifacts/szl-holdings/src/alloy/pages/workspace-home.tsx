  ...
  const { data: runsData } = useStandardQuery({
    ...
    queryFn: async () => {
      try {
        ...
        }>('/alloy/runs?state=running&limit=5');
        return r?.data ?? [];
      } catch {
        return [];
      }
  ...
  const { data: signals } = useStandardQuery({
    ...
    queryFn: async () => {
      try {
        ...
        }>('/alloy/signals?severity=critical&limit=5');
        return r?.data ?? [];
      } catch {
        return [];
      }
  ...
  const { data: decisions } = useStandardQuery({
    ...
    queryFn: async () => {
      try {
        ...
        }>('/alloy/decisions?status=approval_required&limit=5');
        return r?.data ?? [];
      } catch {
        return [];
      }
