    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: 'rgba(255,255,255,0.4)' }}>
          All integrations, data connectors, health status, and API credentials powering Alloy
          automation.
        </p>
      </div>
          ...
          >
            <div className="flex items-start justify-between gap-3 mb-3">
              ...
              <span
                ...
                style={{
                  color: HEALTH_COLORS[c.health],
                  background: `${HEALTH_COLORS[c.health]}12`,
                  border: `1px solid ${HEALTH_COLORS[c.health]}25`,
                }}
              >
                {c.health}
              </span>
            ...
            <div className="grid grid-cols-3 gap-2 text-center mb-3">
              <div>
                <div className="text-sm font-bold" style={{ color: '#4B8BDB' }}>
                  {c.requests_today.toLocaleString()}
                </div>
            ...
            {c.last_error && (
              <div
                className="rounded-md p-2 mb-3 text-[9px]"
                style={{
