...
> = {
  executive: {
    ...
    steps: [
      ...
      },
      {
        ...
        phase: 'agent',
        description:
          'Alloy routes to Finance agent (Lyte). Cross-references vendor history, contract terms, and similar invoices. Identifies: no corresponding PO, vendor flagged for duplicate billing in Q1.',
  ...
  buyer: {
    ...
    duration: '~4 min',
    tagline:
      'Manual workflow → Alloy automates → evidence retrieval → resolution → time savings shown',
    ...
    steps: [
      ...
      {
        id: 2,
        label: 'Alloy Activates Research Agent',
        phase: 'agent',
        description:
      ...
      },
      {
        ...
        phase: 'decision',
        description:
          'Apex Systems: $42M ARR (est), 22% YoY growth, 3 new enterprise wins this quarter. Product gap: no mobile-native workflow. Pricing: 15% above Alloy list.',
        icon: <FileText className="w-3.5 h-3.5" />,
        durationMs: 800,
    ...
    steps: [
      {
        ...
        durationMs: 400,
        evidence:
          'Query source: Alloy console · Agent routing: AI research agent + Lyte (analytics)',
      },
      {
        id: 2,
        ...
        phase: 'agent',
        description:
          'AI research agent queries Arxiv, HuggingFace, web sources, and internal knowledge. Lyte correlates with platform metrics. Responses synthesized by Alloy orchestrator.',
        icon: <Zap className="w-3.5 h-3.5" />,
        durationMs: 2400,
