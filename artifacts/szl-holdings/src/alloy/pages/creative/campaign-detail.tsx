...
import { CampaignBilling } from '@/alloy/components/creative/billing/campaign-billing';
import { CreativePreview } from '@/alloy/components/creative/preview/creative-preview';
...
import { AssetVault } from '@/alloy/components/creative/vault/asset-vault';
import { VoiceoverManager } from '@/alloy/components/creative/voice/voiceover-manager';
...
export function CampaignDetail() {
  const [, params] = useRoute('/alloy/creative/campaigns/:id');
