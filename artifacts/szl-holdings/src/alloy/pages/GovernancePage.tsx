...
export default function GovernancePage({ onNavigate }: NavProps) {
  return (
    <div className="min-h-screen text-white px-6 py-16 max-w-6xl mx-auto">
      {/* Header */}
      <div className="mb-12">
        <div className="text-xs font-medium uppercase tracking-widest mb-3" style={{ color: "#4B8BDB" }}>Governance</div>
      ...
      {/* Principle Statement */}
      <div className="mb-14 p-8 rounded-2xl border" style={{ borderColor: "rgba(75,139,219,0.15)", background: "linear-gradient(135deg, rgba(75,139,219,0.04), rgba(99,102,241,0.04))" }}>
      ...
      {/* Control Cards */}
      <div className="mb-14">
        <div className="text-xs font-medium uppercase tracking-widest mb-6" style={{ color: "#4B8BDB" }}>Governance Controls</div>
      ...
      <div className="mb-14">
        <div className="text-xs font-medium uppercase tracking-widest mb-6" style={{ color: "#4B8BDB" }}>Human-in-the-Loop Flow</div>
