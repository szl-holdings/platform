import { Brain, Radio, Search, Shield, Sparkles, Zap } from 'lucide-react';
...
> = {
  sense: {
    ...
    icon: Radio,
    color: 'text-sky-400',
    description: 'Signal Bus — unified event stream from all domain agents',
  },
  decide: {
    label: 'Decide',
    icon: Brain,
    color: 'text-violet-400',
    description: 'Decision Mesh — agent registry, decision journal, orchestration',
  },
  act: {
    label: 'Act',
    icon: Zap,
    color: 'text-amber-400',
    description: 'Pipeline Builder — visual workflow execution and monitoring',
  },
  govern: {
    label: 'Govern',
    icon: Shield,
    color: 'text-emerald-400',
    description: 'Governance Console — scope certificates, compliance posture, audit trail',
  },
  search: {
    label: 'Search',
    icon: Search,
    color: 'text-rose-400',
    description: 'Federated Search — query across all domain signals, decisions, and artifacts',
  },
  evolve: {
    label: 'Evolve',
    icon: Sparkles,
    color: 'text-fuchsia-400',
    description: 'Self-Evolution — agent performance metrics and optimization proposals',
  },
};
...
export const STAGE_LIBRARY: { type: string; label: string; color: string; description: string }[] =
  [
    ...
    },
    {
      ...
      description: 'Tag and categorise input',
    },
    {
      type: 'score',
      label: 'Score',
      color: 'bg-amber-500/20 text-amber-400 border-amber-500/30',
      description: 'Risk / relevance scoring',
    },
    {
      type: 'enrich',
      label: 'Enrich',
      color: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30',
      description: 'Add context from knowledge-base',
    },
    {
      type: 'recommend',
      label: 'Recommend',
      color: 'bg-fuchsia-500/20 text-fuchsia-400 border-fuchsia-500/30',
      description: 'Generate ranked recommendations',
    },
    {
      type: 'audit',
      label: 'Audit',
      color: 'bg-rose-500/20 text-rose-400 border-rose-500/30',
      description: 'Compliance & governance check',
    },
  ];
