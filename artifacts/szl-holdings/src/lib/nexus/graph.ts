...
export const NEXUS_ENTITIES: EntityRecord[] = [
  {
    ...
    domainData: {
      ...
      threat: { ofacMatchConfidence: 87, sanctionsPrograms: ["Iran", "Russia", "Global Terrorism"] },
  ...
  },
  {
    ...
    domainData: {
      threat: {
        ...
        ipOverlap: true,
        indicators: ["IP range overlap with Chen Capital external infrastructure", "3 /24 subnets matched"],
      },
    },
...
export const NEXUS_EDGES: EdgeRecord[] = [
  { id: "e001", sourceId: "viktor-sorokin", targetId: "sorokin-maritime", relationship: "controls", confidence: 98, strength: 0.95, inferred: false, evidenceSources: ["BVI registry", "vessel registration"], discoveredAt: "2024-01-15" },
  { id: "e002", sourceId: "sorokin-maritime", targetId: "mv-arctic-eagle", relationship: "operates", confidence: 95, strength: 0.90, inferred: false, evidenceSources: ["AIS operator record", "Lloyd's register"], discoveredAt: "2024-03-10" },
  { id: "e003", sourceId: "sorokin-maritime", targetId: "shell-delta", relationship: "subsidiary", confidence: 82, strength: 0.75, inferred: false, evidenceSources: ["BVI incorporation docs", "beneficial ownership filing"], discoveredAt: "2024-06-01" },
  { id: "e004", sourceId: "mv-arctic-eagle", targetId: "ofac-flag-sorokin", relationship: "flagged_by", confidence: 87, strength: 0.95, inferred: false, evidenceSources: ["OFAC SDN screening", "Helmsman route correlation"], discoveredAt: "2026-03-18" },
  { id: "e005", sourceId: "viktor-sorokin", targetId: "trade-finance-dispute", relationship: "litigates", confidence: 91, strength: 0.85, inferred: false, evidenceSources: ["PRISM case file", "court filing"], discoveredAt: "2024-02-14" },
  { id: "e006", sourceId: "viktor-sorokin", targetId: "northport-properties", relationship: "owns", confidence: 89, strength: 0.85, inferred: false, evidenceSources: ["NJ LLC registry", "title records"], discoveredAt: "2024-05-20" },
  { id: "e007", sourceId: "northport-properties", targetId: "bayview-plaza", relationship: "holds", confidence: 95, strength: 0.95, inferred: false, evidenceSources: ["Essex County title records"], discoveredAt: "2024-05-22" },
  { id: "e008", sourceId: "northport-properties", targetId: "ironside-lofts", relationship: "holds", confidence: 95, strength: 0.90, inferred: false, evidenceSources: ["Kings County title records"], discoveredAt: "2024-02-28" },
  { id: "e009", sourceId: "sorokin-maritime", targetId: "trade-asset", relationship: "invests", confidence: 76, strength: 0.70, inferred: false, evidenceSources: ["Trade finance agreement TF-2023-SML-001"], discoveredAt: "2023-11-01" },
  { id: "e010", sourceId: "shell-delta", targetId: "trade-asset", relationship: "finances", confidence: 71, strength: 0.65, inferred: true, evidenceSources: ["Wire transfer pattern", "NEXUS correlation"], discoveredAt: "2024-06-15" },
  { id: "e011", sourceId: "marcus-chen", targetId: "chen-capital", relationship: "controls", confidence: 99, strength: 0.99, inferred: false, evidenceSources: ["Delaware LLC filing", "SEC Form D"], discoveredAt: "2024-07-01" },
  { id: "e012", sourceId: "chen-capital", targetId: "ironside-lofts", relationship: "co_invests", confidence: 63, strength: 0.50, inferred: false, evidenceSources: ["Kings County title records — 40% interest"], discoveredAt: "2024-02-28" },
  { id: "e013", sourceId: "chen-capital", targetId: "apt23-indicator", relationship: "associated_with", confidence: 68, strength: 0.68, inferred: true, evidenceSources: ["Aegis IP correlation", "ASN routing overlap"], discoveredAt: "2026-04-10" },
  { id: "e014", sourceId: "marcus-chen", targetId: "construction-fraud", relationship: "litigates", confidence: 94, strength: 0.90, inferred: false, evidenceSources: ["PRISM case file PR-2024-1143", "arbitration filing"], discoveredAt: "2024-08-15" },
  { id: "e015", sourceId: "marcus-chen", targetId: "ironside-lofts", relationship: "invests", confidence: 77, strength: 0.65, inferred: true, evidenceSources: ["Inferred via Chen Capital controlling interest"], discoveredAt: "2024-02-28" },
  { id: "e016", sourceId: "viktor-sorokin", targetId: "marcus-chen", relationship: "associated_with", confidence: 55, strength: 0.40, inferred: true, evidenceSources: ["NEXUS co-investment discovery at Ironside Lofts"], discoveredAt: "2026-02-28" },
];
...
export function getConnectedEdges(entityId: string, graph: KnowledgeGraph = KNOWLEDGE_GRAPH): EdgeRecord[] {
  return graph.edges.filter(e => e.sourceId === entityId || e.targetId === entityId);
}

/** Get all direct neighbor entity IDs for a given entity. */
export function getNeighborIds(entityId: string, graph: KnowledgeGraph = KNOWLEDGE_GRAPH): string[] {
...
/** Get entity by ID. */
export function getEntity(id: string, graph: KnowledgeGraph = KNOWLEDGE_GRAPH): EntityRecord | undefined {
  return graph.entities.find(e => e.id === id);
}

/** Get entities by type. */
export function getEntitiesByType(type: EntityType, graph: KnowledgeGraph = KNOWLEDGE_GRAPH): EntityRecord[] {
  return graph.entities.filter(e => e.type === type);
}

/** Get entities by domain. */
export function getEntitiesByDomain(domain: Domain, graph: KnowledgeGraph = KNOWLEDGE_GRAPH): EntityRecord[] {
