...
const milestones = [
  ...
  },
  {
    ...
    description: "Lyte and Alloy platforms launched. Shared infrastructure layer connects all operating platforms.",
  },
];
    ...
    <section id="milestones" style={{
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(1.25rem,5vw,2.5rem)" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          }} className="hidden sm:block" aria-hidden="true" />
            ...
            {milestones.map((item, i) => (
              ...
              >
                ...
                <p style={{
                  ...
                  maxWidth: "36rem",
                  paddingLeft: "6rem",
                }} className="sm:pl-0">{item.description}</p>
              </m.div>
            ))}
          </div>
        </div>
