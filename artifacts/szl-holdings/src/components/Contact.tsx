        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20">
          ...
          >
            ...
            <p className="text-szl-text-secondary text-sm leading-relaxed font-light mb-10">
              Investor relations, strategic partnerships, and portfolio company discussions. All
          ...
          >
            {status === 'success' ? (
              <div className="flex flex-col items-start gap-4 py-16">
                ...
                <h3 className="font-[var(--font-display)] text-2xl text-szl-text">
                  Inquiry received.
                </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="grid sm:grid-cols-2 gap-10">
                  <div>
                    <label className="text-[10px] tracking-[0.2em] uppercase text-szl-text-muted mb-2 block">
                      Full Name *
                    </label>
                    <input
                      name="name"
                  ...
                  <div>
                    ...
                    />
                    {errors.email && (
                      <p className="text-red-400/70 text-xs mt-1.5">{errors.email}</p>
                    )}
                  </div>
                </div>
                <div className="grid sm:grid-cols-2 gap-10">
                  ...
                  <div>
                    ...
                    />
                    {errors.subject && (
                      <p className="text-red-400/70 text-xs mt-1.5">{errors.subject}</p>
                    )}
                  </div>
                </div>
                <div>
                  ...
                  />
                  {errors.message && (
                    <p className="text-red-400/70 text-xs mt-1.5">{errors.message}</p>
                  )}
                </div>
