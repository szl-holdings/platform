...
export function ContinuumKernelPanel() {
  const kernel = useMemo(() => getKernel('meeting-to-crm-update'), []);
  ...
  return (
    <div
      ...
      style={{ border: '1px solid rgba(200,168,75,0.2)', background: 'rgba(200,168,75,0.02)' }}
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          >
            <Brain className="w-4 h-4" style={{ color: '#c8a84b' }} />
          </div>
          <div>
      ...
      {showExample && example && (
        <div
          ...
          style={{ background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(200,168,75,0.1)' }}
        >
          <div
