...
import { AlertOctagon, CheckSquare, Clock } from 'lucide-react';
...
const TIERS = [
  ...
  },
  {
    tier: 'T3',
    label: 'Dual approval',
    gate: '2 approvers + rationale',
    color: 'hsl(25,90%,55%)',
    bg: 'hsla(25,90%,55%,0.10)',
  ...
  },
  {
    ...
    gate: 'Senior + full audit',
    color: 'hsl(358,75%,58%)',
    bg: 'hsla(358,75%,58%,0.10)',
    border: 'hsla(358,75%,58%,0.20)',
    width: '25%',
  },
];
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
        ...
        <div
          style={{
            ...
            borderRadius: '2px',
            background:
              'linear-gradient(to right, hsl(145,62%,46%), hsl(40,90%,54%), hsl(25,90%,55%), hsl(358,75%,58%))',
          }}
        />
        <span
          style={{
