...
export const LOOP_STAGES = [
  ...
  },
  {
    ...
    icon: Layers,
    color: '#8b5cf6',
    description: 'Correlate across domains',
  },
  {
    id: 'recommendation',
    ...
    icon: Brain,
    color: '#ec4899',
    description: 'AI-generated advisory with confidence',
  },
  {
    id: 'simulation',
    label: 'Simulation',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    color: '#10b981',
    description: 'Covenant governance check',
  },
  {
    id: 'execution',
    label: 'Execution',
    icon: Play,
    color: '#6366f1',
    description: 'Governed workflow trigger',
  },
  {
    id: 'proof',
    label: 'Proof',
    icon: FileCheck,
    color: '#14b8a6',
    description: 'Immutable attribution chain',
  },
  {
    id: 'outcome',
    label: 'Outcome',
    icon: Target,
    color: '#ef4444',
    description: 'Measured result vs prediction',
  },
  {
    id: 'learning',
    label: 'Learning',
    icon: BookOpen,
    color: '#f97316',
    description: 'Decision memory & calibration',
  },
] as const;
