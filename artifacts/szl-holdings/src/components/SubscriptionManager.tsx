    ...
    <div className={`space-y-4 ${className}`}>
      <div className="rounded-xl border border-border bg-card overflow-hidden">
        <div className="px-5 py-4 flex items-start justify-between gap-4">
          ...
          <span
            className={`text-[10px] font-semibold px-2.5 py-1 rounded-full border flex items-center gap-1.5 ${statusCfg.bg} ${statusCfg.color}`}
          >
          ...
          <div className="px-5 py-3 grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-foreground flex items-center gap-1.5">
                ...
                {subscription.cancelAtPeriodEnd ? 'Cancels' : 'Renews'} in {daysLeft} day
                {daysLeft !== 1 ? 's' : ''}
              </p>
            </div>
          </div>
          ...
          {subscription.cancelAtPeriodEnd && (
            <div className="px-5 py-3 bg-amber-500/5">
              <p className="text-xs text-amber-500 flex items-center gap-1.5">
                ...
                Your subscription will cancel on {formatDate(subscription.currentPeriodEnd)} and
                will not renew.
              </p>
            </div>
          )}
