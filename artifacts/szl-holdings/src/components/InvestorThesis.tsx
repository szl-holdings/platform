      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-[1fr,440px] gap-16 lg:gap-24 items-start mb-16">
          ...
          >
            ...
            <p style={{ fontSize: "0.9375rem", lineHeight: "1.72", color: "hsl(210,5%,56%)", maxWidth: "32rem" }}>
              SZL Holdings is a vertically-integrated command systems studio. We build precision platforms across high-stakes domains — and the compounding infrastructure that connects them. Investors gain exposure to an 8-platform portfolio sharing one architecture, one auth layer, and one operating doctrine.
            </p>
          </m.div>
          ...
          >
            <p style={{ fontSize: "10px", fontWeight: "600", letterSpacing: "0.1em", textTransform: "uppercase", color: "hsl(210,5%,40%)", marginBottom: "1.25rem", fontFamily: "'JetBrains Mono', 'Space Mono', monospace" }}>
              Portfolio Snapshot
            </p>
            <div className="space-y-3">
              {[
                { label: "Active Platforms", value: "8", sub: "All live and operational" },
                { label: "Shared Architecture", value: "1", sub: "Auth, observability, design system" },
                { label: "Domains Covered", value: "5+", sub: "Maritime, cyber, AI, ops, advisory" },
                ...
                >
                  <div>
                    <p style={{ fontSize: "12px", color: "hsl(210,5%,62%)", fontWeight: "500" }}>{item.label}</p>
                    <p style={{ fontSize: "10px", color: "hsl(210,5%,36%)", fontFamily: "'JetBrains Mono', 'Space Mono', monospace", marginTop: "2px" }}>{item.sub}</p>
                  </div>
                  <span style={{
                    fontSize: "1.125rem",
                    fontWeight: "700",
            ...
            <Link
              ...
              onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.color = "hsl(38,12%,90%)"; }}
          ...
          {investorPaths.map((path, i) => (
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: "13px", lineHeight: "1.6", color: "hsl(210,5%,60%)", marginBottom: "1.125rem" }}>
                  {path.desc}
                </p>
                <div style={{
                  display: "inline-flex",
