...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Workflow Engine', href: '/docs/workflow-engine', note: 'Governed agentic orchestration' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Counsel — Execution Fabric', href: '/continuum-fabric', note: 'The product implementation' },
    ],
  },
  {
    label: 'Company',
...
const NAV_LINKS_MOBILE = [
  ...
  { label: 'KORA · Decision Theater', href: '/lyte/decision-theater', primary: false },
  { label: 'KORA · Signal Fusion', href: '/lyte/signal-fusion', primary: false },
  { label: 'KORA · Decision Schemas', href: '/lyte/decision-schemas', primary: false },
  { label: 'KORA · Governance Posture', href: '/lyte/governance-posture', primary: false },
  { label: 'Counsel', href: '/continuum-fabric', primary: false },
  ...
  { label: 'Workflow Engine', href: '/docs/workflow-engine', primary: false },
