...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    highlight: false,
    children: [
      { label: "Product Readiness Matrix", href: "/product-readiness", note: "What ships today vs. roadmap" },
      { label: "Trust Center Status", href: "/trust-center/status", note: "Live posture & evidence" },
      { label: "Technical Proof", href: "/technical-proof", note: "Architecture & build evidence" },
      { label: "Changelog Highlights", href: "/changelog-highlights", note: "Recent shipped milestones" },
