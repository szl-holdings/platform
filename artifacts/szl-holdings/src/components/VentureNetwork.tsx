const ventures = [
  {
    ...
    description: "Execution fabric and predictive intelligence engine powering Lyte, Vessels, and the full SZL ecosystem. Scenario modeling, confidence scoring, and agent coordination at the platform layer.",
    synergies: ["Prediction engine drives Lyte workflows", "Confidence scores power Aegis decisions", "Generative models feed scenario planning"],
  },
  {
    name: "Lyte",
    ...
    roi: "+358%",
    status: "Outperforming",
    description: "Business observability and orchestration platform interpreting signals, routing decisions, and managing escalations across the ecosystem.",
    synergies: ["Alloy powers prediction layer", "Vessels feeds maritime signals", "Beacon provides KPI telemetry"],
  },
  {
    ...
    synergies: ["Alloy powers route prediction", "Lyte monitors infrastructure", "Beacon tracks voyage economics"],
  },
  {
    name: "Terra",
    ...
    roi: "+250%",
    status: "Performing",
    description: "NYC real estate intelligence platform for distress property tracking, deal pipeline management, ownership entity resolution, and borough-level market intelligence.",
  ...
  },
  {
    ...
    roi: "+233%",
    status: "Performing",
    description: "Continuous business observability platform detecting KPI drift, market anomalies, and value leakage. Turns Census Bureau, BLS, FEMA, and SEC EDGAR data into enterprise-grade telemetry.",
    synergies: ["Lyte surfaces Beacon signals to owners", "Alloy powers anomaly classification", "Vessels consumes voyage economics feed"],
  },
  {
    ...
    roi: "+233%",
    status: "Performing",
    description: "Principal advisory practice serving boards, leadership teams, and investors across regulated and high-growth sectors.",
