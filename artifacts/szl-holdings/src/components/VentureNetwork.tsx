const ventures = [
  ...
  },
  {
    ...
    synergies: ["Alloy powers prediction layer", "Vessels feeds maritime signals", "Terra provides property intelligence"],
  },
  {
  ...
  },
  {
    ...
    roi: "+620%",
    status: "Outperforming",
    description: "Unified defense and intelligence command — three workspaces (Command, Defense, Labs) operating from one shared intelligence layer with cross-module correlations.",
    synergies: ["Alloy powers incident routing", "Lyte surfaces operational signals", "Vessels provides maritime threat context"],
  },
  {
