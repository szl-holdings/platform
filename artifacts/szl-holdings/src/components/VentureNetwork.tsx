const ventures = [
  ...
  },
  {
    ...
    synergies: ["Powers AI across all subsidiaries", "Alloy uses INCA generative models", "Vessels uses prediction models"],
  },
  {
    name: "Alloy",
    ...
    synergies: ["Alloy prediction engine drives Lyte workflows", "Aegis uses Alloy confidence scores", "INCA generative models feed Alloy scenarios"],
  },
  {
    name: "Rosie",
