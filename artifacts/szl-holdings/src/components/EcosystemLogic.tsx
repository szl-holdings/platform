      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-[1fr,420px] gap-8 lg:gap-12 items-start">
          <div>
            ...
            >
              ...
              >
                ...
                <span
                  style={{ fontSize: '10px', color: 'hsl(210,5%,36%)', letterSpacing: '0.04em' }}
                >
                  ·
                </span>
                <span
          ...
          >
            ...
            >
              Together, they form one disciplined ecosystem built around visibility, action, and
              premium execution.
            </p>
            ...
            <div className="space-y-2.5">
              {[
                ...
                {
                  entity: 'Carlota Jo',
                  role: 'Private advisory. High-trust execution support.',
                  accent: 'hsl(38,55%,58%)',
