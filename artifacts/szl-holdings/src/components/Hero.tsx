...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-24 pb-16 md:pt-28 md:pb-20 lg:pt-32 lg:pb-24" style={{ background: "hsl(210,12%,5%)", minHeight: "min(88vh, 820px)" }}>
      <HeroMesh />
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true" style={{
        background: "radial-gradient(ellipse 70% 50% at 70% 30%, hsla(190,60%,25%,0.06) 0%, transparent 60%)",
      }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          <div className="lg:col-span-8">
            <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.1 }} className="flex items-center gap-2 mb-6">
              <div className="w-1.5 h-1.5 rounded-full" style={{ background: "hsl(190,90%,55%)", boxShadow: "0 0 8px hsla(190,90%,55%,0.6)" }} />
            ...
            <m.h1
              ...
              style={{ color: "hsl(38,12%,94%)", fontFamily: "'Space Grotesk', 'Inter', system-ui, sans-serif", maxWidth: "38rem" }}
            >
            ...
            >
              Lyte + Alloy helps teams surface critical business signals, route action fast, and verify follow-through across the workflows that usually break between systems.
            </m.p>

            <m.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="flex flex-col sm:flex-row items-start gap-3 mb-10">
              <Link
              ...
              >
                Request a design partner conversation <ArrowRight size={14} strokeWidth={2.5} className="group-hover:translate-x-0.5 transition-transform" />
              </Link>
              <Link
                href="/platform"
          ...
          >
            <div style={{
              ...
              padding: "1.5rem", boxShadow: "0 20px 60px hsla(0,0%,0%,0.5), inset 0 1px 0 hsla(0,0%,100%,0.05)",
              backdropFilter: "blur(16px)", borderRadius: "4px",
            }}>
              <p style={{ fontSize: "9.5px", fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "hsl(210,5%,40%)", marginBottom: "1.25rem", fontFamily: "'Space Grotesk', 'Inter', system-ui, sans-serif" }}>
              ...
              <div className="space-y-2">
                {[
                  ...
                  >
                    <span style={{ fontSize: "11px", color: "hsl(210,5%,68%)", fontFamily: "'Space Grotesk', 'Inter', system-ui, sans-serif" }}>{item.signal}</span>
                    <span style={{ fontSize: "9px", fontWeight: 600, letterSpacing: "0.06em", color: "hsl(190,90%,52%)", fontFamily: "'JetBrains Mono', monospace" }}>{item.source}</span>
                  </m.div>
                ))}
              </div>
            </div>
