    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-[1fr,380px] gap-16 lg:gap-24 items-start mb-14">
          ...
          >
            <p style={{ fontSize: "11px", fontWeight: "600", letterSpacing: "0.1em", textTransform: "uppercase", color: "hsl(210,5%,42%)", marginBottom: "0.875rem", fontFamily: "'JetBrains Mono', 'Space Mono', monospace" }}>
              Built by an Operator
            </p>
            <h2 style={{ fontSize: "clamp(1.9rem, 3.5vw, 2.75rem)", fontWeight: "700", letterSpacing: "-0.022em", color: "hsl(38,12%,94%)", lineHeight: "1.1", marginBottom: "1.25rem", fontFamily: "'Space Grotesk', 'Inter', system-ui, sans-serif" }}>
              Stephen Lutar builds systems that connect visibility, execution, and operating discipline.
            </h2>
            <p style={{ fontSize: "0.9375rem", lineHeight: "1.72", color: "hsl(210,5%,56%)", marginBottom: "1rem", maxWidth: "30rem" }}>
            ...
            <p style={{ fontSize: "0.875rem", lineHeight: "1.7", color: "hsl(210,5%,46%)", maxWidth: "30rem", marginBottom: "2rem" }}>
              Every platform in the SZL ecosystem is founder-built, founder-operated, and structured around the same core principle: precision first, clarity always.
            </p>
            <div style={{ display: "flex", flexDirection: "row", gap: "0.75rem", flexWrap: "wrap" }}>
              ...
              <a
                ...
                onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.color = "hsl(210,5%,52%)"; }}
              >
                Stephen's Site
                <ArrowRight size={13} strokeWidth={2.5} />
              </a>
          ...
          >
            <p style={{ fontSize: "10px", fontWeight: "600", letterSpacing: "0.1em", textTransform: "uppercase", color: "hsl(210,5%,38%)", marginBottom: "1rem", fontFamily: "'JetBrains Mono', 'Space Mono', monospace" }}>
            ...
            {[
              ...
              >
                ...
                <span style={{ fontSize: "12px", fontWeight: "600", color: "hsl(210,5%,70%)" }}>{p.name}</span>
                <span style={{ fontSize: "10px", marginLeft: "auto", color: "hsl(210,5%,38%)", fontFamily: "'JetBrains Mono', 'Space Mono', monospace" }}>{p.role}</span>
                <div style={{ width: "5px", height: "5px", borderRadius: "50%", background: p.color, boxShadow: `0 0 5px ${p.color}80`, flexShrink: 0 }} />
              </m.div>
            ))}
          </m.div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {highlights.map((h, i) => {
            ...
            return (
              ...
              >
                <Icon size={14} style={{ color: h.color, marginBottom: "0.75rem" }} strokeWidth={1.5} />
                <p style={{ fontSize: "12.5px", fontWeight: "600", color: "hsl(38,12%,82%)", marginBottom: "0.375rem", letterSpacing: "-0.005em", fontFamily: "'Space Grotesk', 'Inter', system-ui, sans-serif" }}>
                  {h.label}
                </p>
