...
import {
  Radio, Layers, Brain, BarChart3, ShieldCheck,
  Zap, FileCheck, Target, BookOpen,
} from "lucide-react";

const LOOP_STEPS = [
  {
    n: "01", label: "Signal", icon: Radio, color: "#0ea5e9",
  ...
  {
    n: "02", label: "Context", icon: Layers, color: "#8b5cf6",
    body: "Cross-domain enrichment via Event Fabric. A sanctions alert in Vessels triggers a legal flag in PRISM Counsel, a risk entry in Lyte — full context assembled before any recommendation.",
    primitives: ["event-fabric", "outcome-graph"],
  },
  {
    n: "03", label: "Recommendation", icon: Brain, color: "#ec4899",
  ...
  {
    n: "04", label: "Simulation", icon: BarChart3, color: "#f59e0b",
  ...
  {
    n: "05", label: "Policy", icon: ShieldCheck, color: "#10b981",
  ...
  {
    n: "06", label: "Execution", icon: Zap, color: "#6366f1",
    body: "Alloy orchestrates the approved action as a durable, multi-step process with checkpoint recovery and agent coordination. Failures are handled — not silently dropped.",
    primitives: ["workflow-engine"],
  },
  {
    n: "07", label: "Proof", icon: FileCheck, color: "#14b8a6",
  ...
  {
    n: "08", label: "Outcome", icon: Target, color: "#ef4444",
  ...
  {
    n: "09", label: "Learning", icon: BookOpen, color: "#f97316",
...
const PRIMITIVES: Record<string, { label: string; color: string }> = {
  "event-fabric":    { label: "Event Fabric",        color: "#0ea5e9" },
  ...
  return (
    <div style={{ width: "100%" }}>
            ...
            {LOOP_STEPS.map((s, i) => {
              ...
              return (
                <g
                  ...
                  onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); handleStep(i); } }}
                >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", paddingTop: "0.5rem" }}>
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.875rem", marginBottom: "1rem" }}>
                ...
                <div>
                  <p style={{
                    ...
                    marginBottom: "2px", fontFamily: "'JetBrains Mono', monospace",
                  }}>
                    Step {step.n}
                  </p>
                  <h3 style={{
                    fontSize: "18px", fontWeight: 700, color: "hsl(38,12%,94%)",
              ...
              {/* Description */}
              <p style={{
                fontSize: "0.9375rem", lineHeight: 1.7, color: "hsl(210,5%,60%)",
                marginBottom: "1.5rem",
              }}>
                {step.body}
              </p>
              ...
              <div>
                <p style={{
                  ...
                  textTransform: "uppercase", color: "hsl(210,5%,38%)",
                  ...
                  {step.primitives.map((pid) => {
                    ...
                    return (
                      <span key={pid} style={{
                        ...
                        color: p.color, letterSpacing: "0.01em",
                      }}>
                        <span style={{
          ...
          <div style={{ borderTop: "1px solid hsla(0,0%,100%,0.06)", paddingTop: "1.25rem" }}>
            <p style={{
              fontSize: "10px", fontWeight: 600, letterSpacing: "0.08em",
              textTransform: "uppercase", color: "hsl(210,5%,32%)", marginBottom: "0.75rem",
            }}>
              All steps
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "4px" }}>
              {LOOP_STEPS.map((s, i) => {
                ...
                return (
                  ...
                  >
                    <span style={{
                      fontSize: "9px", fontWeight: 700, color: isActive ? s.color : "hsl(210,5%,38%)",
      ...
      <div style={{
        ...
        <span style={{
          fontSize: "10px", fontWeight: 600, letterSpacing: "0.08em",
          textTransform: "uppercase", color: "hsl(210,5%,32%)", flexShrink: 0, marginRight: "0.25rem",
        }}>
          Primitives:
        </span>
        {Object.entries(PRIMITIVES).map(([id, p]) => {
          ...
          return (
            <span key={id} style={{
              ...
              fontSize: "11px", fontWeight: isHighlighted ? 600 : 400,
