...
const apps = [
  ...
  },
  {
    ...
    path: "/terra/",
    obsSlug: "terra",
    description: "NYC real estate intelligence platform surfacing distressed properties, tracking ownership structures, managing deal pipelines, and delivering market intelligence for brokers, investors, and portfolio teams.",
