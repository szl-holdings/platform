...
const apps = [
  {
    ...
    features: ["SOC Dashboard", "Threat Intel", "MITRE ATT&CK", "Compliance"],
    kpi: "$11.4M ARR",
    market: "$266B TAM",
  },
  {
    ...
    path: "/inca/",
    obsSlug: "inca",
    description: "AI/ML research platform with experiment tracking, model registry, and ensemble management for enterprise AI governance.",
  ...
  },
  {
    ...
    path: "/terra/",
    obsSlug: "terra",
    description: "Commercial real estate analytics platform with climate risk overlays, AI-powered valuations, and institutional portfolio intelligence.",
  ...
  },
  {
    ...
    path: "/dreamscape/",
    obsSlug: "dreamscape",
    description: "Enterprise creative production platform combining generative AI, automated asset pipelines, and brand intelligence for studios and agencies.",
  ...
  },
  {
    ...
    path: "/msp/",
    obsSlug: "msp",
    description: "Managed service provider platform for enterprise IT management, NOC operations, proactive monitoring, and client lifecycle management.",
