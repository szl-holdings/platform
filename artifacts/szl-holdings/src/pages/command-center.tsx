...
const apps = [
  ...
  },
  {
    ...
    path: "/dreamscape/",
    obsSlug: "dreamscape",
    description: "Prediction, scenario modeling, and confidence scoring platform — powering the UNDERSTAND layer with probabilistic outputs and model-backed decision intelligence.",
  ...
  },
  {
    ...
    path: "/msp/",
    obsSlug: "msp",
    description: "Evidence-backed incident command delivering threat detection, anomaly visibility, and MSP-grade operational intelligence with government contract intelligence.",
    features: ["Incident Command", "Threat Detection", "NOC", "FedRAMP Intelligence"],
    kpi: "Enterprise",
    market: "$23B TAM",
  },
  {
