...
const TRUST_PILLARS = [
  {
    ...
    desc: "Human approval is not a policy configuration in KORA + Counsel — it is a structural property of the platform. The signal-to-action pipeline cannot route from AI recommendation to execution without passing through a human decision gate. This is enforced at the architecture level, not the policy level.",
  },
  {
    icon: Lock,
...
export default function DocsTrustPage() {
  const __pageMeta = usePageMeta({
    ...
    description: "Technical trust documentation for KORA + Counsel: human-in-the-loop architecture, immutable audit trail, proof chain, role-scoped access, and domain-specific governance.",
          ...
          <section className="border-b border-white/10">
            <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8 lg:py-28">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/65">
                Trust in the KORA + Counsel platform is an architectural property, not a product feature.
