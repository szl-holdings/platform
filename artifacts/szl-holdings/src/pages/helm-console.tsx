...
const HANDOFF_CONTRACTS = [
  { from: "Lyte", to: "FORGE RUNTIME", trigger: "Priority signal ≥ high", action: "Governed execution workflow", color: "hsl(192,72%,48%)" },
  { from: "Aegis", to: "COVENANT", trigger: "Confirmed threat (MITRE)", action: "Policy-gated response", color: "hsl(0,72%,58%)" },
  { from: "Vessels", to: "FORGE RUNTIME", trigger: "Voyage anomaly detected", action: "Rerouting command workflow", color: "hsl(220,72%,58%)" },
