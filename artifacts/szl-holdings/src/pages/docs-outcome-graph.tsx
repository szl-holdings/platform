...
export default function DocsOutcomeGraphPage() {
  const __pageMeta = usePageMeta({
    ...
    description: "Outcome Graph documentation: the directed signal and state fabric that connects every input, inference, decision, and output in the KORA + Counsel platform.",
          ...
          <section className="border-b border-white/10">
            <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8 lg:py-28">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/65">
                The Outcome Graph is the directed signal and state fabric at the core of KORA + Counsel.
