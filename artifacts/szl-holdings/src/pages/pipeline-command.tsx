...
interface TargetAccount {
  account: string;
  vertical: Vertical;
  product: "PARAGON" | "SEXTANT" | "DOMAINE" | "Counsel";
  why: string;
  whoToFind: string;
  hook: string;
  fitScore: number;
...
const TARGETS: TargetAccount[] = [
  { account: "Recorded Future", vertical: "Security", product: "PARAGON", why: "Threat-intel platform sells recommendations to SOC teams; analysts already wrestle with 'why did we act on this?' attribution gaps when feeds disagree.", whoToFind: "VP Customer Success, VP Product Security", hook: "Their analysts produce recommendations that downstream SOCs act on — the proof chain between intel → action is exactly the gap PARAGON closes.", fitScore: 9 },
  { account: "Expel", vertical: "Security", product: "PARAGON", why: "MDR provider selling outcomes (not alerts); under SOC 2 Type II pressure from their own customers; needs governed escalation trail.", whoToFind: "Director of Detection Engineering, VP SOC Operations", hook: "Expel sells transparency as a feature. PARAGON lets them prove governance on every escalation, not just the post-mortems.", fitScore: 8 },
  { account: "Devo Technology", vertical: "Security", product: "PARAGON", why: "SIEM with autonomous-response ambitions; faces customer pushback on 'AI takes action' without audit trail.", whoToFind: "VP Engineering, Chief Product Officer", hook: "Devo's autonomous SOC story breaks at the governance question. PARAGON is the answer they currently don't have.", fitScore: 8 },
  { account: "Arctic Wolf", vertical: "Security", product: "PARAGON", why: "Concierge-security model; 4,000+ customers means 4,000 audit trails to defend; growing enterprise base demands governance.", whoToFind: "VP Concierge Operations, Director of Security Services", hook: "Their concierge analysts make hundreds of decisions daily — PARAGON is the proof layer they can show regulators and customers alike.", fitScore: 7 },
  { account: "Huntress", vertical: "Security", product: "PARAGON", why: "MSP-channel MDR; compliance-conscious SMB and mid-market base needing audit-grade response evidence.", whoToFind: "VP Product, Director of ThreatOps", hook: "Their MSP partners sell on trust. PARAGON-backed proof chain is a channel-enablement story.", fitScore: 7 },
  { account: "Maersk Tankers", vertical: "Maritime", product: "SEXTANT", why: "Operates ~150 product tankers; OFAC and EU sanctions screening is daily friction; pool-management decisions need defensible audit.", whoToFind: "Head of Compliance, VP Commercial Operations", hook: "SEXTANT turns the daily charter/sanctions decision into a governed, exportable trail — exactly what their compliance team needs at audit.", fitScore: 9 },
  { account: "Teekay Tankers", vertical: "Maritime", product: "SEXTANT", why: "Mid-cap tanker operator; SEC-listed (NYSE: TNK); board-level scrutiny of sanctions program; lean ops team.", whoToFind: "Chief Risk Officer, Head of Chartering", hook: "SEC disclosure pressure + lean ops = strong appetite for governed decision tooling that scales without headcount.", fitScore: 8 },
  { account: "d'Amico Tankers", vertical: "Maritime", product: "SEXTANT", why: "European-listed (Milan); EU sanctions complexity; family-led, fast decisions, good design-partner profile.", whoToFind: "Head of Operations, Compliance Officer", hook: "EU sanctions regime is more punitive than US; a governed decision trail is operational insurance.", fitScore: 8 },
  { account: "Pacific Basin Shipping", vertical: "Maritime", product: "SEXTANT", why: "Dry-bulk operator (~250 vessels); Asia-based; growing compliance overhead from Western charterers.", whoToFind: "Director of Chartering, Head of Risk", hook: "Western charterers increasingly demand sanctions evidence; SEXTANT gives operators a one-click defense.", fitScore: 7 },
  { account: "Hafnia Limited", vertical: "Maritime", product: "SEXTANT", why: "Singapore/Bermuda, NYSE-listed (HAFN); large product-tanker pool; pool partners increasingly demand decision transparency.", whoToFind: "VP Pool Operations, Compliance Director", hook: "Pool members are partners, not customers — SEXTANT' shared decision trail strengthens the pool itself.", fitScore: 8 },
  { account: "Tishman Speyer", vertical: "Real Estate", product: "DOMAINE", why: "Global owner/operator; LP-reporting and acquisitions IC decisions need defensible analytical trail; ESG disclosure pressure.", whoToFind: "Head of Investments, Chief Data Officer", hook: "LP scrutiny of how investment decisions get made is at all-time high. DOMAINE is the IC's defensible memory.", fitScore: 8 },
  { account: "Hines", vertical: "Real Estate", product: "DOMAINE", why: "Global private real estate; 1,000+ assets; technology-forward ('Hines Living' tech bets); receptive to platform partnerships.", whoToFind: "Chief Innovation Officer, Head of Investment Strategy", hook: "They've publicly committed to data-driven IC. DOMAINE is the missing governance layer.", fitScore: 8 },
  { account: "JLL Capital Markets", vertical: "Real Estate", product: "DOMAINE", why: "Brokerage/advisory at scale; analytical consistency across teams is a known internal pain; willing to pilot platforms.", whoToFind: "Head of Capital Markets Analytics, Director of Research", hook: "Cross-team analytical consistency is their stated 2026 priority — DOMAINE is the system of record.", fitScore: 7 },
  { account: "Greystar", vertical: "Real Estate", product: "DOMAINE", why: "Largest US apartment owner/operator; massive acquisition volume; operational decisions at scale need traceability.", whoToFind: "Head of Acquisitions, VP Investment Management", hook: "Volume of acquisitions makes manual decision attribution impossible. DOMAINE automates the trail.", fitScore: 7 },
  { account: "Stockbridge", vertical: "Real Estate", product: "DOMAINE", why: "Mid-sized institutional manager (~$32B AUM); LP-driven governance demands; nimble enough for design-partner cadence.", whoToFind: "Chief Investment Officer, Head of Portfolio Management", hook: "Mid-sized managers feel LP governance pressure earliest — design-partner sweet spot.", fitScore: 8 },
  { account: "Axiom Law", vertical: "Legal", product: "Counsel", why: "Alt-legal at scale; matter-management consistency across distributed lawyers is a known pain.", whoToFind: "Chief Legal Operations Officer, Head of Practice Technology", hook: "Distributed-lawyer model lives or dies by consistent matter governance. Counsel is the standard.", fitScore: 7 },
  { account: "UnitedLex", vertical: "Legal", product: "Counsel", why: "Legal-services-as-platform; analytics-driven; tech-forward GC clients pulling them toward governed AI.", whoToFind: "Chief Strategy Officer, VP Legal Operations", hook: "Their GC clients are asking for governed AI evidence. Counsel is the answer they can resell.", fitScore: 7 },
  { account: "Elevate Services", vertical: "Legal", product: "Counsel", why: "Law company; managed services for in-house teams; matter-flow governance is core to their value.", whoToFind: "Chief Operating Officer, VP Managed Services", hook: "Matter-flow governance is what they sell. Counsel makes it provable.", fitScore: 7 },
];
