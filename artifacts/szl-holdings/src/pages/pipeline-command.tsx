...
const TARGETS: TargetAccount[] = [
  ...
  { account: "Huntress", vertical: "Security", product: "PARAGON", why: "MSP-channel MDR; compliance-conscious SMB and mid-market base needing audit-grade response evidence.", whoToFind: "VP Product, Director of ThreatOps", hook: "Their MSP partners sell on trust. Aegis-backed proof chain is a channel-enablement story.", fitScore: 7 },
