...
import {
  ...
  Briefcase, Anchor, ShieldCheck, Home, Scale,
} from "lucide-react";
import { usePageMeta } from "@/hooks/usePageMeta";

const STORAGE_KEY = "szl.pipeline-command.v1";
...
// These are starting points for the founder/sales team to validate, enrich,
// and decide whether to actually pursue. Names are public companies that
// match the firmographic profile in SALES_HANDOFF_GUIDE.md.
const TARGETS: TargetAccount[] = [
  // Security
  {
    account: "Recorded Future",
    vertical: "Security",
    product: "Aegis",
    why: "Threat-intel platform sells recommendations to SOC teams; analysts already wrestle with 'why did we act on this?' attribution gaps when feeds disagree.",
    whoToFind: "VP Customer Success, VP Product Security",
    hook: "Their analysts produce recommendations that downstream SOCs act on — the proof chain between intel → action is exactly the gap Aegis closes.",
    fitScore: 9,
  },
  {
    account: "Expel",
    vertical: "Security",
    product: "Aegis",
    why: "MDR provider selling outcomes (not alerts); under SOC 2 Type II pressure from their own customers; needs governed escalation trail.",
    whoToFind: "Director of Detection Engineering, VP SOC Operations",
    hook: "Expel sells transparency as a feature. Aegis lets them prove governance on every escalation, not just the post-mortems.",
    fitScore: 8,
  },
  {
    account: "Devo Technology",
    vertical: "Security",
    product: "Aegis",
    why: "SIEM with autonomous-response ambitions; faces customer pushback on 'AI takes action' without audit trail.",
    whoToFind: "VP Engineering, Chief Product Officer",
    hook: "Devo's autonomous SOC story breaks at the governance question. Aegis is the answer they currently don't have.",
    fitScore: 8,
  },
  {
    account: "Arctic Wolf",
    vertical: "Security",
    product: "Aegis",
    why: "Concierge-security model; 4,000+ customers means 4,000 audit trails to defend; growing enterprise base demands governance.",
    whoToFind: "VP Concierge Operations, Director of Security Services",
    hook: "Their concierge analysts make hundreds of decisions daily — Aegis is the proof layer they can show regulators and customers alike.",
    fitScore: 7,
  },
  {
    account: "Huntress",
    vertical: "Security",
    product: "Aegis",
    why: "MSP-channel MDR; compliance-conscious SMB and mid-market base needing audit-grade response evidence.",
    whoToFind: "VP Product, Director of ThreatOps",
    hook: "Their MSP partners sell on trust. Aegis-backed proof chain is a channel-enablement story.",
    fitScore: 7,
  },

  // Maritime
  {
    account: "Maersk Tankers",
    vertical: "Maritime",
    product: "Vessels",
    why: "Operates ~150 product tankers; OFAC and EU sanctions screening is daily friction; pool-management decisions need defensible audit.",
    whoToFind: "Head of Compliance, VP Commercial Operations",
    hook: "Vessels turns the daily charter/sanctions decision into a governed, exportable trail — exactly what their compliance team needs at audit.",
    fitScore: 9,
  },
  {
    account: "Teekay Tankers",
    vertical: "Maritime",
    product: "Vessels",
    why: "Mid-cap tanker operator; SEC-listed (NYSE: TNK); board-level scrutiny of sanctions program; lean ops team.",
    whoToFind: "Chief Risk Officer, Head of Chartering",
    hook: "SEC disclosure pressure + lean ops = strong appetite for governed decision tooling that scales without headcount.",
    fitScore: 8,
  },
  {
    account: "d'Amico Tankers",
    vertical: "Maritime",
    product: "Vessels",
    why: "European-listed (Milan); EU sanctions complexity; family-led, fast decisions, good design-partner profile.",
    whoToFind: "Head of Operations, Compliance Officer",
    hook: "EU sanctions regime is more punitive than US; a governed decision trail is operational insurance.",
    fitScore: 8,
  },
  {
    account: "Pacific Basin Shipping",
    vertical: "Maritime",
    product: "Vessels",
    why: "Dry-bulk operator (~250 vessels); Asia-based; growing compliance overhead from Western charterers.",
    whoToFind: "Director of Chartering, Head of Risk",
    hook: "Western charterers increasingly demand sanctions evidence; Vessels gives operators a one-click defense.",
    fitScore: 7,
  },
  {
    account: "Hafnia Limited",
    vertical: "Maritime",
    product: "Vessels",
    why: "Singapore/Bermuda, NYSE-listed (HAFN); large product-tanker pool; pool partners increasingly demand decision transparency.",
    whoToFind: "VP Pool Operations, Compliance Director",
    hook: "Pool members are partners, not customers — Vessels' shared decision trail strengthens the pool itself.",
    fitScore: 8,
  },

  // Real Estate
  {
    account: "Tishman Speyer",
    vertical: "Real Estate",
    product: "Terra",
    why: "Global owner/operator; LP-reporting and acquisitions IC decisions need defensible analytical trail; ESG disclosure pressure.",
    whoToFind: "Head of Investments, Chief Data Officer",
    hook: "LP scrutiny of how investment decisions get made is at all-time high. Terra is the IC's defensible memory.",
    fitScore: 8,
  },
  {
    account: "Hines",
    vertical: "Real Estate",
    product: "Terra",
    why: "Global private real estate; 1,000+ assets; technology-forward ('Hines Living' tech bets); receptive to platform partnerships.",
    whoToFind: "Chief Innovation Officer, Head of Investment Strategy",
    hook: "They've publicly committed to data-driven IC. Terra is the missing governance layer.",
    fitScore: 8,
  },
  {
    account: "JLL Capital Markets",
    vertical: "Real Estate",
    product: "Terra",
    why: "Brokerage/advisory at scale; analytical consistency across teams is a known internal pain; willing to pilot platforms.",
    whoToFind: "Head of Capital Markets Analytics, Director of Research",
    hook: "Cross-team analytical consistency is their stated 2026 priority — Terra is the system of record.",
    fitScore: 7,
  },
  {
    account: "Greystar",
    vertical: "Real Estate",
    product: "Terra",
    why: "Largest US apartment owner/operator; massive acquisition volume; operational decisions at scale need traceability.",
    whoToFind: "Head of Acquisitions, VP Investment Management",
    hook: "Volume of acquisitions makes manual decision attribution impossible. Terra automates the trail.",
    fitScore: 7,
  },
  {
    account: "Stockbridge",
    vertical: "Real Estate",
    product: "Terra",
    why: "Mid-sized institutional manager (~$32B AUM); LP-driven governance demands; nimble enough for design-partner cadence.",
    whoToFind: "Chief Investment Officer, Head of Portfolio Management",
    hook: "Mid-sized managers feel LP governance pressure earliest — design-partner sweet spot.",
    fitScore: 8,
  },
  ...
  // Legal
  {
    ...
    why: "Alt-legal at scale; matter-management consistency across distributed lawyers is a known pain.",
    whoToFind: "Chief Legal Operations Officer, Head of Practice Technology",
    hook: "Distributed-lawyer model lives or dies by consistent matter governance. PRISM Counsel is the standard.",
    fitScore: 7,
  },
  {
    account: "UnitedLex",
    vertical: "Legal",
    product: "PRISM Counsel",
    why: "Legal-services-as-platform; analytics-driven; tech-forward GC clients pulling them toward governed AI.",
    whoToFind: "Chief Strategy Officer, VP Legal Operations",
    hook: "Their GC clients are asking for governed AI evidence. PRISM Counsel is the answer they can resell.",
    fitScore: 7,
  },
  {
    account: "Elevate Services",
    vertical: "Legal",
    product: "PRISM Counsel",
    why: "Law company; managed services for in-house teams; matter-flow governance is core to their value.",
    whoToFind: "Chief Operating Officer, VP Managed Services",
    hook: "Matter-flow governance is what they sell. PRISM Counsel makes it provable.",
    fitScore: 7,
  },
];
...
export default function PipelineCommandPage() {
  ...
  useEffect(() => { if (hydrated) saveDeals(deals); }, [deals, hydrated]);
  ...
  // Active pipeline = real engaged deals only. "Researched" (uncontacted)
  // and terminal stages (Signed, Lost) do NOT count toward active pipeline,
  // to preserve the scoreboard's "real deals only" governance intent.
      ...
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        <header style={{ marginBottom: 24 }}>
          ...
          <p style={{ marginTop: 8, color: COLORS.textMuted, fontSize: 13.5, maxWidth: 760, lineHeight: 1.55 }}>
            ...
            an honest pipeline, and the outreach, DPA, and kickoff kits to move a deal from cold to signed.
            Pipeline state is local to this browser — wire it to a real CRM (or the existing inbound applications endpoint) before scaling.
          </p>
        </header>
        ...
        {/* Pipeline */}
        <Section title="Live Pipeline" eyebrow="Real deals only">
          ...
          {showAdd && (
            <div style={{
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
                <button onClick={addDeal} disabled={!draft.account || !draft.vertical} style={{ ...primaryBtn, opacity: (!draft.account || !draft.vertical) ? 0.5 : 1 }}>Add deal</button>
