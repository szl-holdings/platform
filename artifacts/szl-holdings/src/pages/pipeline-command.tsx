...
const TARGETS: TargetAccount[] = [
  ...
  { account: "Maersk Tankers", vertical: "Maritime", product: "SEXTANT", why: "Operates ~150 product tankers; OFAC and EU sanctions screening is daily friction; pool-management decisions need defensible audit.", whoToFind: "Head of Compliance, VP Commercial Operations", hook: "Vessels turns the daily charter/sanctions decision into a governed, exportable trail — exactly what their compliance team needs at audit.", fitScore: 9 },
