...
const portfolio = [
  ...
  { name: "Lyte", sector: "AIOps · Powered by Alloy", stage: "Growth", ownership: 100, arr: "$3.1M", growth: "+28%", headcount: 21, color: "#8b5cf6", status: "Scaling" },
  { name: "Vessels", sector: "Maritime Intelligence · Powered by Alloy", stage: "Growth", ownership: 100, arr: "$1.8M", growth: "+51%", headcount: 12, color: "#06b6d4", status: "Scaling" },
  ...
  { name: "INCA", sector: "AI Research · MLOps", stage: "Early", ownership: 100, arr: "$0.4M", growth: "+93%", headcount: 6, color: "#a855f7", status: "Hypergrowth" },
