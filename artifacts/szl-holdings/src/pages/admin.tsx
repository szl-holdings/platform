          ...
          <nav className="space-y-0.5 sticky top-20">
            ...
            <div className="mt-3 pt-3 border-t border-border/40 space-y-0.5">
              <Link
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-medium transition-colors text-left text-emerald-500 hover:text-emerald-400 hover:bg-emerald-500/10"
              >
