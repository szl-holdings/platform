...
import {
  Settings, Shield, AlertCircle, Loader2,
  ArrowLeft, BarChart3, Mail, FileText, Globe, Layers,
  Lock, RefreshCw, Users, Map, BookOpen, Star, MessageSquare,
  HelpCircle, MousePointer, Navigation, Gauge,
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {[
                    ...
                    { icon: "⚡", label: "Operational KPIs Report", app: "Lyte", path: "/command/operations/powerbi", color: "#f59e0b", desc: "Decision intelligence KPIs including SLA performance and PRISM health scores." },
                  ].map(r => (
