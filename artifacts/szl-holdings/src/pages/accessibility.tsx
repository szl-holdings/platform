...
export default function AccessibilityPage() {
  return (
    <div style={{ background: "var(--color-szl-bg)", color: "var(--color-szl-text)", minHeight: "100vh" }}>
      <Navbar />
      <main id="main-content" role="main" style={{ paddingTop: "6rem", paddingBottom: "4rem" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 1.5rem" }}>
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            ...
            <p style={{ color: "var(--color-szl-text-secondary)", lineHeight: 1.7, fontSize: "1rem" }}>
          ...
          <Section title="Conformance Status">
            <p>
              ...
              at Level {CONFORMANCE_LEVEL} across all of our web properties. WCAG {WCAG_VERSION} defines
              requirements for designers and developers to improve accessibility for people with
              disabilities, covering visual, auditory, physical, speech, cognitive, language,
          ...
          <Section title="Technical Specifications">
            <p>
              Our platform is built using semantic HTML5, ARIA landmarks and labels, and
              Radix UI primitives — all of which are designed with accessibility as a
              foundational requirement. We rely on the following technologies for conformance:
            </p>
            <ul style={{ marginTop: "0.75rem", paddingLeft: "1.5rem", lineHeight: 1.8, color: "var(--color-szl-text-secondary)" }}>
          ...
          <Section title="Measures We Take">
            ...
            <ul style={{ marginTop: "0.75rem", paddingLeft: "1.5rem", lineHeight: 1.8, color: "var(--color-szl-text-secondary)" }}>
              <li>
                <strong style={{ color: "var(--color-szl-text)" }}>Color contrast:</strong>{" "}
                All text meets WCAG 2.1 AA contrast ratios — at least 4.5:1 for normal
                text and 3:1 for large text and UI components.
              </li>
              <li>
                <strong style={{ color: "var(--color-szl-text)" }}>Keyboard navigation:</strong>{" "}
              ...
              <li>
                <strong style={{ color: "var(--color-szl-text)" }}>Skip links:</strong>{" "}
                Every application includes a "Skip to main content" link that becomes visible
                on focus, allowing keyboard and screen reader users to bypass repetitive navigation.
              </li>
              <li>
              ...
              <li>
                <strong style={{ color: "var(--color-szl-text)" }}>Form accessibility:</strong>{" "}
                All form inputs have programmatically associated labels. Error messages are
                linked to their corresponding inputs via <code>aria-describedby</code>.
                Required fields are communicated to assistive technology.
              </li>
              <li>
                <strong style={{ color: "var(--color-szl-text)" }}>Reduced motion:</strong>{" "}
                Animations and transitions respect the operating system's
          ...
          <Section title="Known Limitations">
            ...
            <ul style={{ marginTop: "0.75rem", paddingLeft: "1.5rem", lineHeight: 1.8, color: "var(--color-szl-text-secondary)" }}>
              <li>
                Complex data visualizations (charts, heatmaps, network graphs) may not yet
                have equivalent text alternatives. We are actively adding textual summaries
              ...
              <li>
                Third-party embedded content (such as Power BI reports) may not fully conform
                to WCAG 2.1 AA; we work with vendors to improve this where possible.
              </li>
            </ul>
          </Section>
          ...
          <Section title="Feedback and Contact">
            <p>
              ...
              experience any barriers or difficulty accessing our products, please contact us so
              we can help.
            </p>
            <div style={{
              marginTop: "1.25rem",
          ...
          <Section title="Formal Complaints">
            <p>
              ...
              supervisory authority in your jurisdiction. In the UK, this is the{" "}
              <a
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section style={{ marginBottom: "2rem" }} aria-labelledby={`section-${title.toLowerCase().replace(/\s+/g, "-")}`}>
      <h2
      ...
      <div style={{ color: "var(--color-szl-text-secondary)", lineHeight: 1.75, fontSize: "0.9375rem" }}>
        {children}
      </div>
    </section>
  );
...
function StatusBadge({ level }: { level: string }) {
  return (
    ...
    >
      <span style={{ color: "#52a882", fontSize: "1rem" }} aria-hidden="true">✓</span>
      <span style={{ color: "#52a882", fontWeight: 600, fontSize: "0.875rem", fontFamily: "var(--font-mono)" }}>
