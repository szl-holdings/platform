...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      let msg = match?.[1] ?? raw;
      try {
        msg = JSON.parse(msg)?.error || JSON.parse(msg)?.message || msg;
      } catch {
        /* not JSON */
      }
    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'hsl(214,16%,4%)', color: 'hsl(38,8%,95%)' }}>
        ...
        <main id="main-content">
          <section
            style={{ paddingTop: 'var(--space-hero-pt)', paddingBottom: 'clamp(4rem,8vw,6rem)' }}
          >
            <div
              style={{ maxWidth: '480px', margin: '0 auto', padding: '0 var(--space-content-x)' }}
            >
              <m.div
                ...
                {state === 'success' ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <strong style={{ color: 'hsl(38,8%,88%)' }}>{email}</strong>, you'll receive
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                      <label
                        htmlFor="reset-email"
                        style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'hsl(38,8%,80%)' }}
                      >
                        Email address
                      </label>
                      <div style={{ position: 'relative' }}>
                        ...
                        <input
                          ...
                          onFocus={(e) => {
                            e.currentTarget.style.borderColor = 'hsl(192,72%,48%)';
                          }}
                          onBlur={(e) => {
                            e.currentTarget.style.borderColor = 'var(--color-szl-border-hover)';
                          }}
                        />
                      </div>
                    </div>
                    ...
                    {errorMsg && (
                      ...
                      >
                        <XCircle
                          size={15}
                          style={{ color: 'hsl(0,72%,55%)', flexShrink: 0, marginTop: '1px' }}
                        />
                        <p style={{ fontSize: '0.8125rem', color: 'hsl(38,8%,88%)', margin: 0 }}>
                          {errorMsg}
                        </p>
                      </div>
                    )}
