...
const ENTITIES: Entity[] = [
  {
    id: 'meridian-capital',
    label: 'Meridian Capital LLC',
    type: 'organization',
    subtitle: 'BVI holding company',
    risk: 'critical',
    riskScore: 91,
    domains: ['vessels', 'legal', 'property', 'financial'],
    identifiers: { lei: '5493001KJTIIGC8Y1R12', bvi: 'BVI-234567' },
    domainData: {
      litigation: 'SDNY Civil, $12M exposure',
      property: '345 Atlantic Ave Brooklyn — 18% decline',
      vessel: 'AURORA (IMO 9234567)',
    },
    relatedAlertIds: ['demo-f1', 'demo-f3'],
  },
  {
    id: 'aurora-vessel',
    label: 'AURORA (IMO 9234567)',
    type: 'vessel',
    subtitle: 'Bulk carrier, Marshall Islands flag',
    risk: 'high',
    riskScore: 78,
    domains: ['vessels', 'legal'],
    identifiers: { imo: '9234567', mmsi: '538007234' },
    domainData: { route: 'Strait of Malacca → Rotterdam', cargo: 'Bulk grain', fuelLevel: '38%' },
    relatedAlertIds: ['demo-f1', 'demo-f2'],
  },
  {
    id: 'brooklyn-property',
    label: '345 Atlantic Ave, Brooklyn',
    type: 'property',
    subtitle: 'Mixed-use commercial property',
    risk: 'high',
    riskScore: 74,
    domains: ['property', 'legal', 'financial'],
    identifiers: { parcel: 'BK-3014789', loan: 'LOC-2019-77X' },
    domainData: { valuation: '$8.4M (-18% YTD)', occupancy: '71%', dscr: '1.08x' },
    relatedAlertIds: ['demo-f1'],
  },
  {
    id: 'apt41-threat',
    label: 'APT41 / Volt Typhoon',
    type: 'threat',
    subtitle: 'Chinese state-sponsored threat actor',
    risk: 'critical',
    riskScore: 96,
    domains: ['threat', 'security', 'vessels'],
    identifiers: { mitre: 'G0096', cisa: 'AA23-108A' },
    domainData: {
      ttps: 'T1590, T1199, T1078',
      campaigns: 'Maritime infrastructure targeting',
      ioc_count: '847 active IOCs',
    },
    relatedAlertIds: ['demo-f2'],
  },
  {
    id: 'pacific-ventures',
    label: 'Pacific Ventures Holdings BVI',
    type: 'organization',
    subtitle: 'Shell company — BVI registry',
    risk: 'critical',
    riskScore: 89,
    domains: ['financial', 'legal'],
    identifiers: { bvi: 'BVI-890123', ofac: 'Under review' },
    domainData: {
      hops: '4-hop chain to SDN entity',
      sanctions: 'OFAC SDN potential',
      kyc: 'KYC refresh required',
    },
    relatedAlertIds: ['demo-f3'],
  },
  {
    id: 'starlight-maritime',
    label: 'Starlight Maritime Ltd',
    type: 'organization',
    subtitle: 'Marshall Islands registered',
    risk: 'high',
    riskScore: 71,
    domains: ['vessels', 'financial'],
    identifiers: { imo_registered: 'ML-44567', lei: '5493009MG4DE8IH8R125' },
    domainData: {},
    relatedAlertIds: ['demo-f3'],
  },
  {
    id: 'atlas-wind',
    label: 'ATLAS WIND (IMO 8901234)',
    type: 'vessel',
    subtitle: 'Container vessel — Panama flag',
    risk: 'high',
    riskScore: 68,
    domains: ['vessels', 'threat'],
    identifiers: { imo: '8901234', mmsi: '352001890' },
    domainData: {
      route: 'Strait of Malacca (active)',
      eta: 'Rotterdam +8 days',
      status: 'At risk — APT41 corridor',
    },
    relatedAlertIds: ['demo-f2'],
  },
  {
    id: 'meridian-star',
    label: 'MERIDIAN STAR (IMO 7812345)',
    type: 'vessel',
    subtitle: 'Tanker — Liberia flag',
    risk: 'medium',
    riskScore: 55,
    domains: ['vessels'],
    identifiers: { imo: '7812345', mmsi: '636019812' },
    domainData: { route: 'South China Sea (transit)', cargo: 'Crude petroleum' },
    relatedAlertIds: ['demo-f2'],
  },
  {
    id: 'sdn-entity',
    label: 'SDN Entity (Redacted)',
    type: 'organization',
    subtitle: 'OFAC Specially Designated National',
    risk: 'critical',
    riskScore: 100,
    domains: ['legal', 'financial'],
    identifiers: { ofac: 'OFAC-SDN-RU2041', program: 'Ukraine EO13661' },
    domainData: {},
    relatedAlertIds: ['demo-f3'],
  },
  {
    id: 'szl-portfolio',
    label: 'SZL Holdings Portfolio',
    type: 'asset',
    subtitle: 'Multi-vertical investment portfolio',
    risk: 'medium',
    riskScore: 52,
    domains: ['financial', 'vessels', 'property'],
    identifiers: { aum: '$180M', entities: '47 active' },
    domainData: {},
    relatedAlertIds: [],
  },
  {
    id: 'prism-matter-001',
    label: 'SDNY Civil Action #24-cv-8891',
    type: 'matter',
    subtitle: 'Active litigation — $12M exposure',
    risk: 'high',
    riskScore: 77,
    domains: ['legal'],
    identifiers: { docket: '1:24-cv-08891', court: 'S.D.N.Y.' },
    domainData: {
      plaintiff: 'State of New York',
      defendant: 'Meridian Capital LLC',
  ...
  },
  {
    ...
    type: 'organization',
    subtitle: 'PE fund — co-investor',
    risk: 'low',
    riskScore: 22,
    domains: ['financial'],
    identifiers: { lei: '5493006VWDW6MCDX2349' },
    domainData: {},
    relatedAlertIds: [],
  },
];
...
const EDGES: Edge[] = [
  {
    ...
    type: 'owns',
    strength: 'strong',
    label: 'Beneficial owner (BVI)',
  },
  {
    from: 'meridian-capital',
    to: 'brooklyn-property',
    type: 'owns',
    strength: 'strong',
    label: 'Tenant-in-common 60%',
  },
  {
    from: 'meridian-capital',
    to: 'prism-matter-001',
  ...
  {
    from: 'pacific-ventures',
    to: 'meridian-capital',
    type: 'owns',
    strength: 'moderate',
    label: '2-hop ownership chain',
  },
  {
    from: 'pacific-ventures',
    to: 'starlight-maritime',
    type: 'controls',
    strength: 'strong',
    label: 'Controlling entity',
  },
  {
    from: 'starlight-maritime',
    to: 'sdn-entity',
...
const ALERT_LABELS: Record<string, { title: string; href: string }> = {
  'demo-f1': {
    title: 'AURORA Owner Filed PRAXIS Litigation — DOMAINE Brooklyn Property −18%',
  ...
  'demo-f3': {
    title: 'Shell Company Structure — Multi-Hop Ownership to OFAC SDN',
    href: '/intelligence/fabric',
  },
};
...
const REL_LABELS: Record<RelType, string> = {
  ...
  sanctions_link: 'Sanctions link',
  co_invests: 'Co-invests',
};
...
const REL_COLORS: Record<RelType, string> = {
  ...
  invests: '#10b981',
  subsidiary: '#6b7280',
  associated_with: '#6b7280',
  finances: '#3b82f6',
  flagged_by: '#ef4444',
  sanctions_link: '#ef4444',
  co_invests: '#10b981',
};
...
function buildEntityProof(
  entity: Entity,
  kind: 'cross_domain' | 'fusion_alert',
  subjectId: string,
): ProofRecord {
  ...
  const exportSafety: ExportSafety =
    entity.risk === 'critical' ? 'restricted' : entity.risk === 'high' ? 'pending_review' : 'safe';
  ...
  return {
    ...
    signalType:
      kind === 'cross_domain' ? 'cross_domain_recommendation' : 'fusion_alert_recommendation',
    confidence: conf,
    ...
    policyChecks: [
      ...
      {
        label: `Risk threshold (${entity.risk}) within review SLA`,
        passed: entity.risk !== 'critical',
        note: entity.risk === 'critical' ? 'Critical risk requires SOC Lead sign-off' : undefined,
      },
      { label: 'Human-in-loop gate: required before pivot', passed: true },
      { label: 'Source provenance: graph traversal documented', passed: true },
      {
        label: 'Export safety: redact identifiers before sharing',
        passed: exportSafety === 'safe',
        note: exportSafety === 'safe' ? undefined : 'PII redaction pending review',
      },
    ],
    chainLinks: [
      {
        id: 'c1',
        event: `Entity ${entity.label} ingested into graph`,
        actor: 'System / Entity Resolver',
        timestamp: '16 Apr 2026 06:02:11',
        hash: `sha256:${entity.id.slice(0, 8)}1...`,
      },
      {
        id: 'c2',
        event: `Risk score computed: ${entity.riskScore}/100 (${entity.risk})`,
        actor: 'Risk engine',
        timestamp: '16 Apr 2026 07:45:32',
        hash: `sha256:${entity.id.slice(0, 8)}2...`,
      },
      {
        id: 'c3',
        event:
          kind === 'cross_domain'
            ? `Cross-domain path surfaced — ${subjectId}`
            : `Fusion alert linked — ${subjectId}`,
        actor: 'Recommendation engine',
        timestamp: '16 Apr 2026 08:12:48',
        hash: `sha256:${entity.id.slice(0, 8)}3...`,
      },
      {
        id: 'c4',
        event: 'Recorded in analyst proof chain',
        actor: 'System / Proof Chain',
        timestamp: '16 Apr 2026 08:12:49',
        hash: `sha256:${entity.id.slice(0, 8)}4...`,
      },
    ],
    metadata: {
      'Entity ID': entity.id,
...
function getCrossdomainPaths(
  entityId: string,
): Array<{ path: string[]; domains: string[]; risk: string }> {
  ...
  for (const neighbor of neighbors) {
    ...
    if (newDomains.length > 0) {
      const risk =
        neighbor.risk === 'critical' || neighbor.risk === 'high' ? 'elevated' : 'moderate';
      paths.push({
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 3 }}>
          <span
            style={{ fontSize: 11, color: riskColor, fontWeight: 700, textTransform: 'uppercase' }}
          >
            {entity.risk}
          </span>
...
function RelationshipGraph({
  ...
  const neighborIds = new Set(
    edges.flatMap((e) => [e.from, e.to]).filter((id) => id !== entity.id),
  );
    ...
    <svg width={W} height={H} style={{ display: 'block' }}>
      ...
      {points.map(({ entity: n, x, y }) => {
        const edge = edges.find(
          (e) => (e.from === entity.id && e.to === n.id) || (e.from === n.id && e.to === entity.id),
        );
        const color = edge
          ? (REL_COLORS[edge.type] ?? 'rgba(255,255,255,0.2)')
...
export default function AnalystWorkspacePage() {
  ...
  const [selectedEntityId, setSelectedEntityId] = useState<string>(() => {
    if (deepLinkEntity) {
      const resolved = ENTITIES.find(
        (e) =>
          e.id === deepLinkEntity || e.label.toLowerCase().includes(deepLinkEntity.toLowerCase()),
      );
  ...
  const [activeDetailTab, setActiveDetailTab] = useState<'connections' | 'graph' | 'cross-domain'>(
    'connections',
  );
  ...
  const { outgoing, incoming } = useMemo(
    () => (selectedEntity ? getEntityEdges(selectedEntity.id) : { outgoing: [], incoming: [] }),
    [selectedEntity],
  );
  const crossDomainPaths = useMemo(
    () => (selectedEntity ? getCrossdomainPaths(selectedEntity.id) : []),
    [selectedEntity],
  );
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ fontSize: 13.5, color: 'hsl(210,5%,55%)', margin: '5px 0 0' }}>
                Pull investigative threads across domains — click any entity to explore its
                cross-domain connections, evidence chains, and risk signals.
              </p>
            </div>
          ...
          {investigationTrail.length > 1 && (
            ...
            >
              ...
              <span style={{ fontSize: 11, color: 'hsl(210,5%,50%)', fontWeight: 600 }}>
                Trail:
              </span>
              ...
              <button
                onClick={() => setInvestigationTrail([selectedEntityId])}
                style={{
                  marginLeft: 6,
                  padding: '2px 7px',
                  borderRadius: 4,
                  ...
                  style={{
                    ...
                    background:
                      filterRisk === r
                        ? r === 'all'
                          ...
                          : `${RISK_COLORS[r as RiskLevel] ?? '#6b7280'}20`
                        : 'rgba(255,255,255,0.04)',
                    ...
                    color:
                      filterRisk === r
                        ? r === 'all'
                          ? '#60a5fa'
                          : (RISK_COLORS[r as RiskLevel] ?? '#6b7280')
                        : 'hsl(210,5%,50%)',
            ...
            {selectedEntity ? (
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        padding: 8,
                        background: `${TYPE_COLORS[selectedEntity.type]}15`,
                        borderRadius: 9,
                        flexShrink: 0,
                      }}
                    >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <p style={{ fontSize: 13, color: 'hsl(210,5%,55%)', margin: 0 }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      <div
                        style={{
                          ...
                          color: RISK_COLORS[selectedEntity.risk],
                          fontSize: 11,
                          fontWeight: 700,
                          textTransform: 'uppercase',
                  ...
                  {selectedEntity.domainData &&
                    Object.keys(selectedEntity.domainData).length > 0 && (
                      <div
                        style={{
                          marginTop: 10,
                          padding: '10px 12px',
                      ...
                      >
                        ...
                        >
                          {Object.entries(selectedEntity.domainData).map(([k, v]) => (
                            <div key={k}>
                              <span
                                style={{ fontSize: 10, color: 'hsl(210,5%,48%)', fontWeight: 600 }}
                              >
                                {k}:{' '}
                              </span>
                  ...
                  {(['connections', 'graph', 'cross-domain'] as const).map((tab) => (
                    <button
                      ...
                      style={{
                        ...
                        cursor: 'pointer',
                        background:
                          activeDetailTab === tab ? 'rgba(167,139,250,0.15)' : 'transparent',
                        border: `1px solid ${activeDetailTab === tab ? 'rgba(167,139,250,0.3)' : 'transparent'}`,
                        color: activeDetailTab === tab ? '#a78bfa' : 'hsl(210,5%,50%)',
                        textTransform: 'capitalize',
                      }}
                    >
                      {tab === 'cross-domain'
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                        <div>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                              ...
                              return (
                                <div
                                  ...
                                  style={{
                                    ...
                                    borderRadius: 9,
                                    background: 'rgba(255,255,255,0.02)',
                                    border: `1px solid ${REL_COLORS[edge.type] ?? '#6b7280'}22`,
                                    cursor: 'pointer',
                                  }}
                                >
                                  <div
                                  ...
                                  >
                                    <span
                                      style={{
                                        fontSize: 10,
                                        color: REL_COLORS[edge.type],
                                        fontWeight: 700,
                                        padding: '1px 5px',
                                        background: `${REL_COLORS[edge.type]}15`,
                                        borderRadius: 3,
                                      }}
                                    >
                                      {REL_LABELS[edge.type]}
                                    </span>
                                    <span style={{ fontSize: 10, color: 'hsl(210,5%,42%)' }}>
                                      {edge.strength}
                                    </span>
                                  </div>
                                  <div
                                  ...
                                  <div
                                    style={{ fontSize: 11, color: 'hsl(210,5%,50%)', marginTop: 2 }}
                                  >
                                    {edge.label}
                                  </div>
                                </div>
                            ...
                            {outgoing.length === 0 && (
                              <p style={{ fontSize: 12, color: 'hsl(210,5%,42%)' }}>
                        ...
                        >
                          {(
                            ...
                            >
                              ...
                              <span style={{ fontSize: 10, color: 'hsl(210,5%,50%)' }}>
                                {REL_LABELS[type]}
                              </span>
                            </div>
                          ))}
                    ...
                    >
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                          ...
                          crossDomainPaths.map((path, i) => (
                            <m.div
                              ...
                              style={{
                                ...
                                borderRadius: 10,
                                background: 'rgba(255,255,255,0.02)',
                                border: `1px solid ${path.risk === 'elevated' ? 'rgba(249,115,22,0.2)' : 'rgba(255,255,255,0.07)'}`,
                              }}
                            >
                              <div
                                style={{
                              ...
                              <div
                                style={{ marginTop: 10 }}
                                data-testid={`proof-drawer-xdp-${selectedEntity.id}-${i}`}
                              >
                                <ProofDrawer
                                  proof={buildEntityProof(
                                    selectedEntity,
                                    'cross_domain',
                                    `XDP-${i + 1}-${path.path[path.path.length - 1].slice(0, 16).replace(/\s+/g, '-')}`,
                                  )}
                                  compact={true}
                                  defaultOpen={false}
                                />
                        ...
                        >
                          ...
                          >
                            {selectedEntity.label} spans {selectedEntity.domains.length} domain
                            {selectedEntity.domains.length !== 1 ? 's' : ''} (
                            {selectedEntity.domains.join(', ')}), with{' '}
                            {outgoing.length + incoming.length} documented cross-domain connections.
                            Risk score of {selectedEntity.riskScore} reflects correlated exposure —
                            changes in any connected domain may propagate.
                          </p>
                        </div>
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div
                                      ...
                                      data-testid={`proof-drawer-alert-${selectedEntity.id}-${alertId}`}
                                    >
                                      <ProofDrawer
                                        proof={buildEntityProof(
                                          selectedEntity,
              ...
              >
                ...
                <p style={{ fontSize: 14, textAlign: 'center' }}>
                  Select an entity from the list to explore its cross-domain connections
                </p>
              </div>
            )}
          </div>
