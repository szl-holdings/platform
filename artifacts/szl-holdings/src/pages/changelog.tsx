...
export default function Changelog() {
  const __pageMeta = usePageMeta({
    ...
    description: "Latest updates, features, and improvements across the SZL Holdings platform portfolio. Track product releases from Aegis, Aegis Intelligence, Terra, Vessels, Lyte, Counsel, Aegis Operations, and Aegis.",
