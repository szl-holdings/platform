...
export default function Changelog() {
  const __pageMeta = usePageMeta({
    ...
    description: "Latest updates, features, and improvements across the SZL Holdings platform portfolio. Track product releases from PARAGON, PARAGON Intelligence, DOMAINE, SEXTANT, KORA, Counsel, PARAGON Operations, and PARAGON.",
