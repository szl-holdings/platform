...
const RELIEFS = [
  ...
  },
  {
    ...
    body: "Cross-app handoff contracts route signals across Lyte, Aegis, Vessels, Terra, and Carlota Jo automatically. A threat in Aegis triggers a COVENANT response. A priority in Lyte creates a Counsel workflow. Intelligence compounds instead of fragmenting.",
    color: "hsl(280,52%,62%)",
