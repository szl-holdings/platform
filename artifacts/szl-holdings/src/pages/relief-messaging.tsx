...
const RELIEFS = [
  {
    ...
    body: "Every workflow, approval queue, and ownership gap in your operation becomes legible before it turns into a crisis. KORA instruments your existing systems — not a new one — and surfaces what's stuck, who owns it, and what's at risk.",
    color: "hsl(192,72%,48%)",
    product: "Command",
  ...
  },
  {
    ...
    body: "PARAGON correlates threat signals across your attack surface and routes governed response actions through COVENANT — the policy enforcement layer that decides who can do what, under what conditions, with a full audit trail.",
    color: "hsl(0,72%,58%)",
    product: "PARAGON SOC",
    cta: "/solutions/aegis",
  },
  {
    ...
    body: "Counsel RUNTIME routes consequential actions through the minimum viable approval gate — configured for your org structure. Every action is traceable. Nothing slips through unrecorded. Nothing gets blocked for no reason.",
    color: "hsl(38,90%,52%)",
    product: "Counsel RUNTIME",
    cta: "/platform",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    body: "Cross-app handoff contracts route signals across KORA, PARAGON, SEXTANT, DOMAINE, and Carlota Jo automatically. A threat in PARAGON triggers a COVENANT response. A priority in KORA creates a Counsel workflow. Intelligence compounds instead of fragmenting.",
    color: "hsl(280,52%,62%)",
