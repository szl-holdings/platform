...
const MILESTONES = [
  ...
  { phase: "Next", label: "Counsel maturity", items: ["First paid pilot contract signed", "SEXTANT entering design-partner phase", "SOC 2 Type II audit preparation underway"] },
