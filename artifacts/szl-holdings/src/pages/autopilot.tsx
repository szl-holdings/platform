...
const APPS = [
  { id: "aegis", name: "Aegis", icon: Shield, accent: "#6366f1" },
  { id: "terra", name: "Terra", icon: Building, accent: "#4d7c0f" },
  { id: "vessels", name: "Vessels", icon: Ship, accent: "#3b82f6" },
  { id: "lyte", name: "Lyte", icon: Zap, accent: "#f59e0b" },
  { id: "carlota", name: "Carlota Jo", icon: Globe, accent: "#c2a55a" },
  { id: "prism", name: "PRISM", icon: Brain, accent: "#a855f7" },
];
...
const DRIFT_ALERTS = [
  ...
  { id: "d2", severity: "warning" as DriftSeverity, app: "Terra", metric: "API Latency", detail: "/api/terra/distress-engine P95 at 2.4s — 20% above 2s threshold.", recommendation: "Add a DB index on distress_score + borough. Current query does a full table scan.", timestamp: "11 min ago" },
  { id: "d3", severity: "warning" as DriftSeverity, app: "PRISM", metric: "Webhooks", detail: "Webhooks capability rated Stub — no production delivery confirmed in 7 days.", recommendation: "Implement PRISM outbound webhook dispatch using the existing webhook-engine lib.", timestamp: "2 hr ago" },
  { id: "d4", severity: "info" as DriftSeverity, app: "Aegis", metric: "Bundle Size", detail: "Main bundle grew 8.3% this week (1.24MB → 1.34MB). Approaching 10% threshold.", recommendation: "Code-split the MITRE ATT&CK matrix — it's 280KB and loaded eagerly on all routes.", timestamp: "6 hr ago" },
...
const FEATURE_USAGE = [
  { app: "Lyte", feature: "AI Signal Summarizer", uses: 1420, trend: "rising" as FeatureTrend, delta: "+34%" },
  { app: "Aegis", feature: "Threat Feed Dashboard", uses: 980, trend: "rising" as FeatureTrend, delta: "+18%" },
  { app: "Vessels", feature: "Voyage Economics", uses: 762, trend: "stable" as FeatureTrend, delta: "+2%" },
  { app: "Terra", feature: "Distress Engine", uses: 640, trend: "rising" as FeatureTrend, delta: "+21%" },
  { app: "Lyte", feature: "APM Trace Explorer", uses: 430, trend: "stable" as FeatureTrend, delta: "-1%" },
  { app: "Aegis", feature: "MITRE ATT&CK Map", uses: 290, trend: "declining" as FeatureTrend, delta: "-14%" },
  { app: "PRISM", feature: "Matter Timeline", uses: 210, trend: "stable" as FeatureTrend, delta: "+5%" },
  { app: "Terra", feature: "Ownership Graph", uses: 180, trend: "declining" as FeatureTrend, delta: "-22%" },
  { app: "Carlota Jo", feature: "Estate Report PDF", uses: 94, trend: "stable" as FeatureTrend, delta: "+3%" },
  { app: "Aegis", feature: "Adversary Emulation Wizard", uses: 28, trend: "dead" as FeatureTrend, delta: "-61%" },
  { app: "Lyte", feature: "SCIM Provisioning UI", uses: 12, trend: "dead" as FeatureTrend, delta: "-40%" },
  { app: "Vessels", feature: "Charter Rate Benchmarks", uses: 8, trend: "dead" as FeatureTrend, delta: "-73%" },
];
...
const PLAYBOOKS = [
  ...
  { id: "p2", domain: "Aegis", name: "Incident Response", steps: 12, completionRate: 91, avgDurationMin: 41, status: "complete" as PlaybookStatus, lastRun: "14 hr ago", bottleneck: "Step 7: Escalation approval (avg 11 min)" },
  { id: "p3", domain: "Vessels", name: "Vessel Inspection", steps: 6, completionRate: 77, avgDurationMin: 18, status: "in-progress" as PlaybookStatus, lastRun: "4 hr ago", bottleneck: "Step 5: Photo upload (avg 4 min)" },
  { id: "p4", domain: "Terra", name: "Property Due Diligence", steps: 10, completionRate: 68, avgDurationMin: 55, status: "in-progress" as PlaybookStatus, lastRun: "1 day ago", bottleneck: "Step 6: Ownership verification (avg 18 min)" },
  { id: "p5", domain: "PRISM", name: "Matter Intake", steps: 7, completionRate: 88, avgDurationMin: 14, status: "complete" as PlaybookStatus, lastRun: "6 hr ago", bottleneck: "Step 3: Conflict check (avg 3 min)" },
...
const FORGE_CLIENTS = [
  ...
  { name: "PRISM Counsel",  app: "prism",           nps: 77, csat: 93, responseRate: 88, trend: "up"   as const },
];
...
const FORGE_FEEDBACK = [
  ...
  { client: "PRISM Counsel",  app: "prism",           rating: 5, comment: "AI-assisted contract review cut our turnaround from 3 days to 4 hours.",        date: "2026-04-09" },
