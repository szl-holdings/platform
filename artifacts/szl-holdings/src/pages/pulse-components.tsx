...
export const PLATFORM_APPS = [
  {
    ...
    orbit: 1,
    angle: 0,
    desc: 'Governed operational intelligence platform',
  },
  {
    id: 'lyte',
    name: 'KORA',
    ...
    orbit: 2,
    angle: 0,
    desc: 'Decision intelligence engine',
  },
  {
    id: 'aegis',
    name: 'PARAGON',
    ...
    orbit: 2,
    angle: 72,
    desc: 'Unified defense & intelligence',
  },
  {
    id: 'vessels',
    name: 'SEXTANT',
    ...
    orbit: 2,
    angle: 144,
    desc: 'Fleet command intelligence',
  },
  {
    id: 'terra',
    name: 'DOMAINE',
    ...
    orbit: 2,
    angle: 216,
    desc: 'Real estate portfolio intel',
  },
  {
    id: 'carlota-jo',
    name: 'Carlota Jo',
    ...
    orbit: 2,
    angle: 288,
    desc: 'UHNW residential advisory',
  },
  {
    id: 'prism',
    name: 'Counsel',
    ...
    orbit: 3,
    angle: 0,
    desc: 'Legal matter observability',
  },
  {
    id: 'nexus',
    name: 'PRAXIS',
  ...
  },
  {
    ...
    orbit: 3,
    angle: 288,
    desc: 'Field intelligence mobile',
  },
  {
    id: 'api-server',
    name: 'API Server',
...
export const AGENT_TYPES = [
  ...
  { id: 'msp-autonomous', domain: 'msp', name: 'MSP Watchdog', color: 'var(--gi-text-muted)' },
...
export function generatePulseEvent(): PulseEvent {
  ...
  const severities: PulseEvent['severity'][] = [
    'info',
    'info',
    'info',
    'low',
  ...
  const messages: Record<string, string[]> = {
    correlation_found: [
      'Cross-domain signal correlated',
      'Multi-vector pattern matched',
      'Temporal correlation chain detected',
    ],
    insight_generated: [
      'Portfolio insight synthesized',
      'Market signal processed',
      'Trend anomaly flagged',
    ],
    threat_scan: [
      'Perimeter scan complete — 0 IOCs',
    ...
    route_analysis: [
      'Route deviation scored at 0.03σ',
      'ETA recalculated — 2h delta',
      'Port congestion index: low',
    ],
    deal_scored: [
      'Deal pipeline scored: 87/100',
      'Valuation model updated',
      '3 comparable deals analyzed',
    ],
    compliance_check: [
      'Regulatory checkpoint passed',
      'Filing deadline: 14d',
      'Contract clause flagged — review',
    ],
    model_inference: [
      'Qwen3-8B inference: 142ms',
      'Confidence calibration: +2.3%',
      'Agent budget: $0.004 spent',
    ],
    causal_chain: [
      '3-hop causal chain identified',
      'Root cause isolated: supply delay',
      'Counterfactual generated',
    ],
    proactive_activation: [
      'Proactive scan triggered',
      'Signal threshold met — activating',
      'Pre-emptive alert dispatched',
    ],
  };
  return {
...
export const ConstellationView = memo(function ConstellationView({
  onSelectApp,
}: {
  onSelectApp: (app: (typeof PLATFORM_APPS)[0] | null) => void;
}) {
          ...
          <g key={sig.id}>
            ...
            <circle r="2.5" fill={sig.color} filter="url(#glow2)">
              <animateMotion
                dur="1.2s"
                fill="freeze"
                path={`M${from.x - centerX},${from.y - centerY} Q${midX - centerX},${midY - centerY} ${to.x - centerX},${to.y - centerY}`}
              />
            </circle>
          </g>
        );
        ...
        return (
          ...
          >
            <circle
              ...
              cy={app.y}
              r={isHovered ? 18 : 14}
              fill={isHovered ? `${app.color}15` : 'rgba(255,255,255,0.02)'}
              stroke={app.color}
...
export const GitTicker = memo(function GitTicker() {
  const commits = [
    ...
    {
      hash: 'b33ba2a',
      msg: 'feat: dashboard UI redesign across all apps',
      author: 'agent-459',
      time: '14m ago',
      files: 18,
    },
    {
      hash: 'b1a0925',
      msg: 'feat: agent framework evolution — 4 agents',
      author: 'agent-457',
      time: '28m ago',
      files: 5,
    },
    {
      hash: 'b317e94',
      msg: 'fix: 190 TypeScript errors zeroed out',
      author: 'agent-468',
      time: '35m ago',
      files: 22,
    },
    {
      hash: '5545dd9',
      msg: 'feat: 8 frontier agentic AI capabilities',
      author: 'agent-470',
      time: '41m ago',
      files: 12,
    },
    {
      hash: '79cb07f',
      msg: 'chore: web app polish & investor cleanup',
      author: 'agent-453',
      time: '52m ago',
      files: 8,
    },
    {
      hash: 'dc164a8',
      msg: 'chore: dependency audit & cleanup',
      author: 'agent-452',
      time: '1h ago',
      files: 9,
    },
    {
      hash: '1315b2c',
      msg: 'feat: mobile redesign + federation + streaming',
      author: 'agent-471',
      time: '1h ago',
      files: 16,
    },
      ...
      <AnimatePresence mode="popLayout">
        {events.slice(0, 8).map((event) => (
          ...
          >
            <div className="mt-1.5 relative flex-shrink-0">
              ...
              {event.severity !== 'info' && (
                <div
                  ...
                  style={{ background: severityColor(event.severity), opacity: 0.4 }}
                />
              )}
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <span
                  ...
                  style={{
                    color:
                      severityColor(event.severity) === 'rgba(255,255,255,0.3)'
            ...
            <span
              className="text-[9px] flex-shrink-0 mt-1 tabular-nums"
...
export function DomainHealthGrid() {
  const domains = [
    ...
    { name: 'Counsel Fabric', load: 31, color: 'var(--gi-text-muted)' },
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
      {domains.map((domain, i) => (
        <m.div
          key={domain.name}
          className="rounded-md px-3 py-2.5 group cursor-default"
        ...
        >
          ...
          >
            <m.div
              ...
              style={{ background: `linear-gradient(90deg, ${domain.color}80, ${domain.color})` }}
...
export function CrossDomainIntelFlow() {
  const flows = [
    ...
    },
    {
      from: 'PRAXIS',
      to: 'All',
      type: 'Fusion Intelligence Broadcast',
      color: '#ec4899',
      intensity: 5,
    },
      ...
      {flows.map((flow, i) => (
        ...
        >
          <div className="w-14 text-right">
            <span className="text-[11px] font-semibold" style={{ color: flow.color }}>
              {flow.from}
            </span>
          </div>
          <div
          ...
          >
            {i === activeFlow && (
              <m.div
                ...
                style={{
                  background: `linear-gradient(90deg, transparent, ${flow.color})`,
                  width: '40%',
                }}
                animate={{ left: ['0%', '60%', '0%'] }}
          ...
          <ChevronRight
            className="w-3 h-3"
            style={{ color: i === activeFlow ? flow.color : 'rgba(255,255,255,0.08)' }}
          />
          <div className="w-14">
            <span
              className="text-[11px] font-semibold"
              style={{
                color: i === activeFlow ? 'rgba(255,255,255,0.65)' : 'rgba(255,255,255,0.25)',
              }}
            >
              {flow.to}
            </span>
          ...
          <span
            className="text-[9px] hidden sm:block flex-1 truncate"
          ...
          <div className="flex gap-0.5">
            {Array.from({ length: 5 }).map((_, j) => (
              <div
                ...
                style={{
                  background: j < flow.intensity ? flow.color : 'rgba(255,255,255,0.04)',
                  opacity: j < flow.intensity ? (i === activeFlow ? 0.8 : 0.3) : 1,
                }}
              />
            ))}
          </div>
...
export function AppDetailPanel({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="absolute top-3 right-3 text-[10px] px-2 py-1 rounded"
      ...
      <div className="grid grid-cols-3 gap-3 mt-4">
        ...
        >
          <div className="text-lg font-bold tabular-nums" style={{ color: app.color }}>
            99.9%
          </div>
...
export const ThroughputChart = memo(function ThroughputChart() {
  ...
  const points = dataPoints
    .map((v, i) => `${(i / (dataPoints.length - 1)) * w},${h - (v / max) * h}`)
    .join(' ');
