...
const capitalPaths = [
  ...
  },
  {
    ...
    body: "Use equity conversations to accelerate product proof, customer acquisition, and the commercial maturation of KORA + Counsel.",
...
export default function InvestorRelationsPage() {
  ...
  const __pageMeta = usePageMeta({
    ...
    description:
      "Capital and partner materials for SZL Holdings, centered on the KORA + Counsel raise story.",
          ...
          <section className="border-b border-white/10">
            <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8 lg:py-28">
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-white/72">
                SZL Holdings is running a focused capital story around KORA + Counsel. The objective is
                  ...
                  <div className="mt-6 rounded-2xl border border-[#d4a054]/20 bg-[#d4a054]/10 p-5">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm leading-7 text-white/80">
                        Keep the ask simple: KORA + Counsel now, expansion lanes later, proof and customer
