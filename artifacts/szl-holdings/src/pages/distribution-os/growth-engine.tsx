...
const SUBSCRIBER_DATA: Subscriber[] = [
  ...
  {
    id: 2,
    email: 'alex.chen@techintel.io',
    source: 'embed',
    segment: 'engaged',
    interests: ['enterprise-tech', 'ai'],
    joined: '2025-02-08',
    engagementScore: 82,
    referralCount: 2,
  },
  {
    id: 3,
    email: 'marina.k@logisticsco.com',
    source: 'x',
    segment: 'engaged',
    interests: ['maritime', 'supply-chain'],
    joined: '2025-03-01',
    engagementScore: 74,
    referralCount: 0,
  },
  {
    id: 4,
    email: 'david.r@venture.com',
    source: 'referral',
    segment: 'engaged',
    interests: ['capital', 'strategy'],
    joined: '2025-03-15',
    engagementScore: 68,
    referralCount: 1,
  },
  ...
  {
    id: 6,
    email: 'james.w@operator.co',
    source: 'magic-link',
    segment: 'new',
    interests: ['operations', 'leadership'],
    joined: '2025-04-12',
    engagementScore: 22,
    referralCount: 0,
  },
...
const CROSS_PROMO_PARTNERS = [
  ...
  },
  {
    ...
    desc: 'Tactical leadership for mid-market executives',
    subscribers: '4,200',
    match: 65,
  },
];
...
function SubscriberRow({ sub }: { sub: Subscriber }) {
  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.125rem', flexWrap: 'wrap' }}>
          <span
            style={{
              ...
              borderRadius: '3px',
              background: `${SOURCE_COLORS[sub.source] || '#4a4540'}15`,
              color: SOURCE_COLORS[sub.source] || '#4a4540',
            }}
          >
            {sub.source}
          </span>
          {sub.interests.map((i) => (
            <span key={i} style={{ fontSize: '0.6rem', color: '#4a4540' }}>
              #{i}
            </span>
          ))}
        </div>
      ...
      <div style={{ textAlign: 'center', minWidth: 60 }}>
        <div
          style={{
            ...
            fontWeight: 700,
            color:
              sub.engagementScore >= 80
                ? '#5a9c5a'
                : sub.engagementScore >= 50
                  ? '#d4a054'
                  : '#4a4540',
          }}
        >
        ...
        <div style={{ fontSize: '0.5625rem', color: '#4a4540', textTransform: 'uppercase' }}>
          Score
        </div>
      </div>
      <div style={{ textAlign: 'center', minWidth: 50 }}>
        <div
          style={{
            fontSize: '0.875rem',
            fontWeight: 700,
            color: sub.referralCount > 0 ? '#d4a054' : '#4a4540',
          }}
        >
          {sub.referralCount}
        </div>
      ...
      <span style={{ fontSize: '0.6875rem', color: '#4a4540', minWidth: 72 }}>
        {new Date(sub.joined).toLocaleDateString()}
      </span>
    </div>
  );
}
...
export default function GrowthEnginePage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'referrals' | 'subscribers' | 'magic-link' | 'cross-promo'
  >('referrals');
  ...
  const avgEngagement = Math.round(
    SUBSCRIBER_DATA.reduce((s, sub) => s + sub.engagementScore, 0) / SUBSCRIBER_DATA.length,
  );
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            >
              ...
              <p style={{ fontSize: '0.75rem', color: '#6b6560', marginTop: '0.625rem' }}>
                Each person who subscribes via your link is tracked. Share this in content, bio, or
            ...
            <div>
              ...
              >
                Reward Milestones (Beehiiv-style Boosts)
              </h2>
                ...
                {REFERRAL_TIERS.map((tier, i) => (
                  <div
                    ...
                    style={{
                      ...
                      background: i === 0 ? 'hsla(38,65%,58%,0.05)' : 'hsla(0,0%,100%,0.02)',
                      border: `1px solid ${i === 0 ? 'hsla(38,65%,58%,0.15)' : 'hsla(0,0%,100%,0.05)'}`,
                      borderRadius: '10px',
                    }}
                  >
                    <div
                      style={{
                        ...
                        height: 44,
                        borderRadius: '10px',
                        background: i === 0 ? 'hsla(38,65%,58%,0.12)' : 'hsla(0,0%,100%,0.04)',
                        display: 'flex',
                        alignItems: 'center',
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        {tier.milestone} referral{tier.milestone !== 1 ? 's' : ''}
                      </div>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontSize: '1.125rem', fontWeight: 700, color: '#5a9c5a' }}>
                        {tier.achievers}
                      </div>
                      <div
                        style={{
          ...
          <div>
            <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem', flexWrap: 'wrap' }}>
              ...
              >
                ...
                {Object.entries(SEGMENT_META).map(([k, v]) => (
              ...
              <span style={{ fontSize: '0.75rem', color: '#4a4540', alignSelf: 'center' }}>
                {filteredSubs.length} subscribers
              </span>
            </div>
        ...
        {activeTab === 'magic-link' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div
              style={{
                padding: '1.5rem',
                background: 'hsla(270,40%,50%,0.05)',
                border: '1px solid hsla(270,40%,50%,0.15)',
                borderRadius: '12px',
              }}
            >
              <div
              ...
              >
                ...
                <h2 style={{ fontSize: '0.9375rem', fontWeight: 700, color: '#e8e4de' }}>
                  Magic Link Email Capture
                </h2>
              </div>
              <p
                style={{
              ...
              >
                Readers enter their email and receive an instant magic link — no password, no
                friction. Works in embedded widgets, on any website, and directly in newsletters.
              </p>
              ...
              {magicLinkSent && (
                ...
                >
                  ...
                  <span style={{ fontSize: '0.8125rem', color: '#5a9c5a' }}>
                    Magic link sent to {emailInput}. No password needed.
                  </span>
                </m.div>
              )}
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.75rem' }}>
              {[
                { label: 'Magic Links Sent', value: '148', color: '#8b7ac8', sub: 'Last 30 days' },
                {
                  ...
                  value: '68%',
                  color: '#5a9c5a',
                  sub: 'Click-to-confirm',
                },
                {
                  label: 'Embed Installs',
                  value: '12',
                  color: '#d4a054',
                  sub: 'Active widget installs',
                },
              ].map((s) => (
                <div
                  key={s.label}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            >
              <div style={{ fontSize: '0.75rem', color: '#6b6560', lineHeight: 1.6 }}>
                Cross-promotion lets you opt in to recommend other newsletters at the bottom of your
                content, and have your newsletter recommended in theirs. Audience match score
                ensures relevance.
              </div>
            </div>
                ...
                {CROSS_PROMO_PARTNERS.map((partner) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div
                        style={{ fontSize: '0.6875rem', color: '#4a4540', marginTop: '0.125rem' }}
                      >
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <div
                        style={{
                          fontSize: '1.25rem',
                          fontWeight: 800,
                          color: partner.match >= 70 ? '#5a9c5a' : '#d4a054',
                        }}
                      >
                        {partner.match}%
                      </div>
            ...
            >
              ...
              >
                My Cross-Promo Slot (shown at bottom of all content)
              </div>
              <div
                style={{
                  padding: '1rem',
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    <div style={{ fontSize: '0.8125rem', color: '#e8e4de' }}>
                      <strong>Maritime Insider</strong> — Weekly fleet & freight intelligence for
                      operators
                    </div>
                    <button
                      style={{
