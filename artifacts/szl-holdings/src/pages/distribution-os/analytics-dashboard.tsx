...
function MetricCard({
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: '0.75rem', color: DS.text.secondary, marginTop: '0.25rem' }}>
        {label}
      </div>
      {subtitle && (
      ...
      >
        <div style={{ marginBottom: '1rem' }}>
          ...
          <p style={{ fontSize: '0.75rem', color: DS.text.tertiary, marginTop: '0.25rem' }}>
            Content performance and distribution metrics
          </p>
        </div>
          ...
          <RoleSelector
            ...
            roles={[
              { id: 'executive', label: 'Executive', description: 'Top-line performance and ROI' },
              {
                id: 'analyst',
                label: 'Analyst',
                description: 'Deep content and distribution metrics',
              },
              {
                id: 'operator',
                label: 'Operator',
                description: 'Pipeline health and action items',
              },
            ]}
          />
          <DataProvenance
        ...
        >
          <MetricCard
            ...
            color="#4a90b8"
            subtitle="Across all public pages"
          />
          <MetricCard
            icon={UserPlus}
            label="New Leads (7d)"
            ...
            color="#5a9c5a"
            subtitle="Newsletter + contact forms"
          />
          <MetricCard
            icon={FileText}
        ...
        >
          <div
            style={{ width: 3, height: 40, background: '#d4a054', borderRadius: 2, flexShrink: 0 }}
          />
          <div>
            <div
              style={{
          ...
          <div style={{ flex: 1, marginLeft: '0.5rem' }}>
            <div style={{ fontSize: '0.75rem', color: DS.text.secondary, marginBottom: '0.25rem' }}>
              visits → leads this week
            </div>
            <div
              style={{
                height: 6,
            ...
            >
              <div
                style={{
                  height: '100%',
                  width: `${Math.min(parseFloat(convRate) * 10, 100)}%`,
                  background: '#d4a054',
                  borderRadius: 3,
                }}
              />
                    ...
                    {pipelineTotal > 0 && (
                      ...
                      >
                        <div
                          style={{
                            height: '100%',
                            width: `${pipelineTotal > 0 ? Math.round((item.value / pipelineTotal) * 100) : 0}%`,
