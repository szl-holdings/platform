        ...
        {detail ? (
          ...
          <m.div key="list" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }}>
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "2rem", gap: "1rem", flexWrap: "wrap" }}>
              <div>
                <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#e8e4de" }}>Session Journeys</h1>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                ...
                <button onClick={load} style={{ display: "flex", alignItems: "center", gap: "0.375rem", padding: "0.375rem 0.75rem", borderRadius: "6px", fontSize: "0.75rem", background: "hsla(0,0%,100%,0.04)", border: "1px solid hsla(0,0%,100%,0.08)", color: "#8b8579", cursor: "pointer" }}>
