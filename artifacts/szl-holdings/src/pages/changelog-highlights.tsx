...
const COMMITS: CommitGroup[] = [
  ...
  },
  {
    ...
    body: "SEXTANT, DOMAINE, and Carlota Jo now display the current policy mode badge in their header. Operators can see at a glance whether AI decisions are advisory, enforced, or locked.",
    type: "feature",
  ...
  },
  {
    date: "2026-04-12",
    sha: "f46cf44",
    title: "PARAGON and Counsel marketing landing pages",
    body: "Public marketing pages launched for PARAGON (Cyber Resilience Command) and Counsel (Legal Matter Command). Both include live demo narrative flows and product positioning.",
    type: "feature",
    products: ["PARAGON", "Counsel"],
  },
  {
    date: "2026-04-11",
    sha: "ab00755",
    title: "PARAGON/Counsel demo narratives wired to live signal mesh",
    body: "PARAGON and Counsel demo flows now pull from the live signal mesh via WebSocket. Incident and matter timelines update in real time during demos.",
    type: "feature",
    products: ["PARAGON", "Counsel"],
    taskRef: "#1935",
  },
...
const PRODUCT_COLORS: Record<string, string> = {
  KORA: "#d4a054", Counsel: "#8b7ac8", Command: "#5b8dd4", SEXTANT: "#4a90b8",
  DOMAINE: "#c8953c", PARAGON: "#c45a4a", PARAGON: "#ef8c3a", Counsel: "#70b890",
