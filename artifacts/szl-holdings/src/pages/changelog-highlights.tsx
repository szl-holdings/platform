...
const COMMITS: CommitGroup[] = [
  {
    ...
    body: 'Operators can now approve or dismiss Counsel workflow items inline — no modal or page navigation required. Confirmation records to audit trail with actor attribution.',
    type: 'feature',
    products: ['Counsel', 'Command'],
    taskRef: '#1947',
  },
  {
    date: '2026-04-19',
  ...
  },
  {
    ...
    body: 'Lyte operators can now fork a pending decision, adjust parameters, and run causal simulation against the PRAXIS model before confirming. All simulation runs record to the decision ledger.',
    type: 'feature',
    products: ['Lyte'],
  },
  {
  ...
  },
  {
    ...
    body: 'Fixed a blocking issue where policy approval/rejection UI calls were silently failing. Approve and reject now correctly route to the Counsel workflow engine and record to audit trail.',
    type: 'fix',
    products: ['Lyte', 'Counsel'],
    taskRef: '#1944',
  },
  {
    date: '2026-04-15',
  ...
  },
  {
    ...
    body: 'PRAXIS dashboard, Command Inbox, and Watchdog surfaces in Lyte now pull from live API endpoints. BLS, GitHub Trending, and RSS feeds are active. Demo seed fallback retained for offline mode.',
    type: 'feature',
    products: ['Lyte'],
    taskRef: '#1893',
  },
...
const PRODUCT_COLORS: Record<string, string> = {
  ...
  'Carlota Jo': '#a0a0c0',
  'API Server': '#6aaa72',
  Infrastructure: '#808090',
  'Design System': '#7090a8',
  'SZL Holdings Mobile': '#7ecfc0',
  'All Products': '#d4a054',
};
...
export default function ChangelogHighlightsPage() {
  const __pageMeta = usePageMeta({
    ...
    description:
      'Real changelog derived from git history — material capabilities shipped across the SZL Holdings platform.',
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Derived from real git commit history — filtered to customer-visible capability
                  changes. Internal refactors, test coverage, and documentation commits are
                  excluded. SHA links trace to the actual commit.
                </p>
              </m.div>
            </div>
          </section>
            ...
            >
                  ...
                  .map(([month, commits]) => (
                    <div key={month}>
                      ...
                      >
                        ...
                        <div
                          style={{ flex: 1, height: '1px', background: 'hsla(0,0%,100%,0.06)' }}
                        />
                        <span style={{ fontSize: '11px', color: 'hsl(210,5%,38%)' }}>
                          {commits.length} changes
                        </span>
                      </div>
                      <div
                        style={{
                        ...
                        {commits.map((commit, i) => (
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <span style={{ fontSize: '11px', color: 'hsl(210,5%,36%)' }}>
                                  {commit.date}
                                </span>
                                <code
                                  style={{
              ...
              >
                ...
                <p style={{ fontSize: '12.5px', color: 'hsl(210,5%,44%)', lineHeight: 1.6 }}>
                  This changelog is derived from git log entries filtered to material
                  customer-visible changes — features, security improvements, significant fixes, and
                  infrastructure changes that affect operator experience. Internal refactors,
                  documentation updates, and test-only commits are excluded. SHA hashes trace to
                  commits in the platform repository.
                </p>
              </div>
            </div>
          </section>
