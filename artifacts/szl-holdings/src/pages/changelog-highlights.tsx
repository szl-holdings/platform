...
const COMMITS: CommitGroup[] = [
  {
    ...
    body: "Operators can now approve or dismiss FORGE workflow items inline — no modal or page navigation required. Confirmation records to audit trail with actor attribution.",
    type: "feature",
  ...
  },
  {
    ...
    body: "Fixed a blocking issue where policy approval/rejection UI calls were silently failing. Approve and reject now correctly route to the FORGE workflow engine and record to audit trail.",
    type: "fix",
    products: ["KORA", "FORGE"],
    taskRef: "#1944",
  },
