...
export default function DocsControlPlanePage() {
  const __pageMeta = usePageMeta({
    ...
    description: "Covenant Policy documentation for KORA + Counsel: the governance rules engine that defines what the platform can and cannot do on behalf of any principal.",
          ...
          <section className="border-b border-white/10">
            <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8 lg:py-28">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/65">
                Covenant Policy is the governance rules engine in KORA + Counsel. It defines — in explicit,
