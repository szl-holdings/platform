...
export default function NewsletterLandingPage() {
  usePageMeta({ title: "Newsletter — SZL Holdings", description: "Strategic intelligence briefings for technical founders and enterprise leaders. AI, cybersecurity, real estate, maritime." });
