  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '32px 24px' }}>
        ...
        >
          ...
          >
            {[
              ...
              >
                <p style={{ margin: 0, fontSize: 24, fontWeight: 700, color, lineHeight: 1.2 }}>
                  {value}
                </p>
                <p
                  style={{
        ...
        <div
          style={{ display: 'flex', gap: 0, borderBottom: '1px solid #ffffff12', marginBottom: 24 }}
        >
          {TABS.map(({ key, label, icon: Icon }) => {
            const isActive = activeTab === key;
            const badge =
              key === 'drafts' ? pendingCount : key === 'feed' ? (stats?.active ?? 0) : 0;
            return (
              <button
                key={key}
                ...
                style={{
                  ...
                  color: isActive ? ACCENT : '#ffffff60',
                  cursor: 'pointer',
                  fontSize: 13,
                  fontWeight: 600,
                ...
                {badge > 0 && (
                  <span
                    style={{
                      ...
                      padding: '1px 6px',
                      borderRadius: 8,
                      background: isActive ? `${ACCENT}30` : '#ffffff15',
                      color: isActive ? ACCENT : '#ffffff60',
                    }}
                  >
                    {badge}
          ...
          >
            ...
            {activeTab === 'graph' && (
              <div>
                ...
                >
                  Force-directed entity relationship graph showing cross-domain connections. Filter
                            ...
                            {Object.entries(briefing.domainScores).map(([domain, score]) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  />
                                  <span
                                    style={{ fontSize: 11, color: '#ffffff70', fontWeight: 600 }}
                                  >
                                    {domain}
                                  </span>
