...
const ALLOY_INHERITED = [
  {
    ...
    description: "Every material voyage decision — rerouting, cargo hold, port exception — requires explicit human approval through Alloy's HITL gate before execution.",
  },
  {
  ...
  },
  {
    ...
    description: "Vessels integrates with fleet management systems, port agent platforms, and regulatory databases through Alloy's connector layer — no disruption to existing tools.",
  },
  {
        ...
        <main id="main-content" role="main">
          ...
          <section style={{ borderBottom: "1px solid var(--color-szl-border)", padding: "var(--space-section-md) 0" }}>
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }}>
                <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.6875rem", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "hsl(206,72%,52%)", marginBottom: "1rem" }}>
                  What Vessels Inherits from Alloy
                </p>
                ...
                {[
                  {
                    ...
                    description: "Voyage Twin model, signal integration schema, Alloy connector design, and audit trail structure are defined and validated.",
                  },
                  {
