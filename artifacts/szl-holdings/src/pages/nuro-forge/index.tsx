...
const FORGE_SECTIONS = [
  {
    ...
    icon: Trophy,
    color: '#f59e0b',
    href: '/nuro-forge/arena',
    desc: 'Head-to-head model benchmarking with performance ranking',
    stat: '12 models',
    metric: '2,847 tests',
  },
  {
    ...
    icon: GitMerge,
    color: '#8b5cf6',
    href: '/nuro-forge/composition',
    desc: 'Autonomous pipeline construction & self-optimization',
    stat: '8 pipelines',
    metric: '94.2% quality',
  },
  {
    ...
    icon: Shield,
    color: '#3b82f6',
    href: '/nuro-forge/governance',
    desc: 'Bias detection, hallucination scoring, audit trails',
    stat: '100% audited',
    metric: '0 violations',
  },
  {
    id: 'fine-tuning',
    label: 'Federated Fine-Tuning',
    icon: Brain,
    color: '#ec4899',
    href: '/nuro-forge/fine-tuning',
    desc: 'Domain-isolated learning signals & model improvement',
    stat: '9 domains',
    metric: '+12.4% accuracy',
  },
  {
    id: 'cost',
    ...
    icon: DollarSign,
    color: '#10b981',
    href: '/nuro-forge/cost',
    desc: 'Per-request cost tracking & optimal routing',
    stat: '$0.003/req',
    metric: '-34% cost',
  },
  {
    id: 'multimodal',
    label: 'Multimodal Hub',
    icon: Image,
    color: '#06b6d4',
    href: '/nuro-forge/multimodal',
    desc: 'Unified text, vision, audio, code interface',
    stat: '5 modalities',
    metric: '142ms p50',
  },
  {
    ...
    icon: Wand2,
    color: '#d4a054',
    href: '/nuro-forge/prompts',
    desc: 'Version-controlled prompts with A/B testing',
    stat: '234 prompts',
    metric: '18 active tests',
  },
  {
    id: 'observatory',
    label: 'Performance Observatory',
    icon: BarChart3,
    color: '#f97316',
    href: '/nuro-forge/observatory',
    desc: 'Real-time model accuracy, latency, drift detection',
    stat: '99.8% SLA',
  ...
  },
  {
    ...
    icon: Package,
    color: '#a855f7',
    href: '/nuro-forge/blueprints',
    desc: 'Pre-built intelligence packages per vertical',
    stat: '9 blueprints',
    metric: '1-click deploy',
  },
  {
    id: 'self-healing',
    label: 'Self-Healing Infra',
    icon: HeartPulse,
    color: '#ef4444',
    href: '/nuro-forge/self-healing',
    desc: 'Auto-failover, canary deploys, zero-downtime swaps',
    stat: '99.99% up',
    metric: '0 incidents',
  },
];
  ...
  return (
    <div className="space-y-1.5">
      {models.map((m, i) => (
        ...
        >
          <span
            className="text-[11px] font-bold w-5 text-right tabular-nums"
            style={{ color: i === 0 ? '#f59e0b' : 'rgba(255,255,255,0.25)' }}
          >
            #{i + 1}
          </span>
          ...
          <span className="text-[12px] font-bold tabular-nums" style={{ color: m.color }}>
            {m.elo}
          </span>
          <span
            className="text-[9px] font-medium"
            style={{ color: m.trend.startsWith('+') ? '#10b981' : '#ef4444' }}
          >
            {m.trend}
          </span>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <m.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
          <div className="flex items-center gap-3 mb-1">
            ...
            <span
              className="ml-2 px-2 py-0.5 rounded text-[9px] font-semibold tracking-wider"
              style={{
                background: 'linear-gradient(135deg, rgba(212,160,84,0.2), rgba(212,160,84,0.08))',
                color: '#d4a054',
                border: '1px solid rgba(212,160,84,0.2)',
              }}
            >
