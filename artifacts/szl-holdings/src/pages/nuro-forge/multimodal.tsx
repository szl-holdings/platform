...
const MODALITIES = [
  {
    ...
    icon: FileText,
    color: '#8b5cf6',
    models: ['Claude 4 Sonnet', 'GPT-5.2', 'Qwen3-8B'],
    p50: '142ms',
    requests: 84200,
    desc: 'Natural language processing, summarization, analysis',
  },
  {
    id: 'vision',
    name: 'Vision',
    icon: Image,
    color: '#3b82f6',
    models: ['Gemini 2.5 Pro', 'GPT-5.2 Vision', 'Claude 4 Vision'],
    p50: '890ms',
    requests: 12400,
    desc: 'Image analysis, document OCR, visual inspection',
  },
  {
    id: 'audio',
    name: 'Audio',
    icon: Mic,
    color: '#06b6d4',
    models: ['Whisper V4', 'Gemini Audio', 'Assembly AI'],
    p50: '1.2s',
    requests: 3200,
    desc: 'Transcription, sentiment, speaker diarization',
  },
  {
    id: 'code',
    name: 'Code',
    icon: Code2,
    color: '#10b981',
    models: ['Claude 4 Sonnet', 'GPT-5.2', 'DeepSeek V3'],
    p50: '380ms',
    requests: 28600,
    desc: 'Security review, generation, refactoring, testing',
  },
  {
    id: 'structured',
    ...
    icon: Database,
    color: '#d4a054',
    models: ['Mistral Large', 'Qwen3-8B', 'Phi-4 Mini'],
    p50: '95ms',
    requests: 45800,
    desc: 'Schema analysis, SQL generation, data transformation',
  },
];

const RECENT_TASKS = [
  {
    input: 'Maritime contract PDF',
    modality: 'vision',
  ...
  {
    input: 'Board meeting audio',
    modality: 'audio',
    output: 'Transcript + action items',
    model: 'Whisper V4',
    latency: '4.8s',
    status: 'complete',
  },
  {
    input: 'Python exploit scanner',
    modality: 'code',
  ...
  {
    input: 'Property inspection photos',
    modality: 'vision',
        ...
        >
          ...
          <div>
            ...
            <p className="text-[11px]" style={{ color: 'rgba(255,255,255,0.3)' }}>
              Text · Vision · Audio · Code · Structured Data
            </p>
          </div>
        </m.div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-6">
          {MODALITIES.map((mod, i) => (
            <m.div
              ...
              style={{
                background:
                  selectedModality?.id === mod.id ? `${mod.color}08` : 'rgba(255,255,255,0.02)',
            ...
            >
              ...
              <div className="text-[10px] tabular-nums" style={{ color: mod.color }}>
                {mod.p50} p50
              </div>
              <div className="text-[9px]" style={{ color: 'rgba(255,255,255,0.2)' }}>
                {mod.requests.toLocaleString()} requests
              </div>
            </m.div>
          ))}
        </div>
        ...
        {selectedModality && (
          <m.div
            ...
            style={{
              ...
              border: `1px solid ${selectedModality.color}15`,
            }}
          >
            <h2 className="text-sm font-bold mb-2" style={{ color: 'rgba(255,255,255,0.85)' }}>
              {selectedModality.name} Intelligence
            </h2>
            <p className="text-[11px] mb-4" style={{ color: 'rgba(255,255,255,0.35)' }}>
              {selectedModality.desc}
            </p>
            <div className="flex flex-wrap gap-2">
              {selectedModality.models.map((m) => (
                <span
                  ...
                  style={{
                    background: `${selectedModality.color}10`,
                    color: selectedModality.color,
                    border: `1px solid ${selectedModality.color}20`,
                  }}
                >
                  {m}
                </span>
