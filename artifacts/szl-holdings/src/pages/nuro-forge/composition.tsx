...
const PIPELINES: Pipeline[] = [
  ...
  {
    id: 'maritime-intel',
    name: 'Maritime Intelligence Pipeline',
    steps: [
  ...
  {
    id: 'financial-brief',
    name: 'Executive Financial Brief',
    steps: [
  ...
  },
  {
    ...
    name: 'Multimodal Report Generator',
    steps: [
...
export default function ModelCompositionPage() {
  ...
  useEffect(() => {
    ...
    const t = setInterval(
      () => setActiveStep((p) => (p + 1) % selectedPipeline.steps.length),
      2000,
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        >
          ...
          <div>
            ...
            >
              Autonomous Model Composition
            </h1>
            <p className="text-[11px]" style={{ color: 'rgba(255,255,255,0.3)' }}>
              {PIPELINES.length} pipelines · Self-optimizing chains
            </p>
          </div>
        </m.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            {PIPELINES.map((p, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[9px] tabular-nums" style={{ color: '#10b981' }}>
                    {p.qualityScore}%
                  </span>
                  <span
                  ...
                  >
                    {p.executions.toLocaleString()} runs
                  </span>
                </div>
              </m.div>
            ))}
          ...
          <div className="lg:col-span-2">
            {selectedPipeline ? (
              ...
              >
                <h2 className="text-sm font-bold mb-4" style={{ color: 'rgba(255,255,255,0.85)' }}>
                ...
                <div className="space-y-3 mb-6">
                  {selectedPipeline.steps.map((step, i) => (
                    <m.div
                      ...
                      animate={{
                        background:
                          i === activeStep ? 'rgba(255,255,255,0.03)' : 'rgba(255,255,255,0.01)',
                        borderColor:
                          i === activeStep ? `${step.color}30` : 'rgba(255,255,255,0.03)',
                      }}
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-[10px]" style={{ color: step.color }}>
                          {step.model}
                        </div>
                      </div>
                      {i === activeStep && (
                ...
                <div className="grid grid-cols-4 gap-3">
                  {[
                    {
                      label: 'Quality',
                      value: `${selectedPipeline.qualityScore}%`,
                      color: '#10b981',
                    },
                    {
                      label: 'Latency',
                      value: `${selectedPipeline.avgLatency}ms`,
                      color: '#06b6d4',
                    },
                    {
                      label: 'Success Rate',
                      value: `${selectedPipeline.successRate}%`,
                      color: '#8b5cf6',
                    },
                    {
                      label: 'Executions',
                      value: selectedPipeline.executions.toLocaleString(),
                      color: '#f59e0b',
                    },
                  ].map((s) => (
                    <div
              ...
              >
                ...
                <p className="text-[12px]" style={{ color: 'rgba(255,255,255,0.3)' }}>
                  Select a pipeline to view composition details
                </p>
              </div>
            )}
          </div>
