      ...
      <main className="max-w-6xl mx-auto px-6 py-6 space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Real-time performance intelligence across the SZL Holdings platform portfolio.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <MetricCard
            ...
            value={obs?.portfolioScore ? String(obs.portfolioScore) : '—'}
            sub="Ecosystem health index"
            icon={Activity}
          />
          <MetricCard
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            <div className="mt-4 pt-4 border-t border-border">
              <p className="text-xs text-muted-foreground">
                <span className="font-semibold text-foreground">1.0%</span> inquiry rate from
                visitors ·<span className="font-semibold text-foreground ml-1">36.8%</span> lead
                qualification rate
              </p>
            </div>
          </div>
