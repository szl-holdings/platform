...
const USE_CASES = [
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "Counsel routes pre-arrival workflow revision to port agent with updated ETA, berth instructions, and customs clearance tasks" },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "Counsel routes to legal for secondary review with full sanctions context, recommended hold, and charter clause reference" },
