    ...
    <div style={{ minHeight: "100vh", background: "hsl(214,16%,4%)", color: "hsl(38,8%,95%)" }}>
      ...
      <main id="main-content" role="main">
        ...
        <section style={{ borderBottom: "1px solid var(--color-szl-border)", padding: "var(--space-section-md) 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
            <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }}>
              <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.6875rem", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--color-vessels)", marginBottom: "1rem" }}>Built on Lyte + Alloy</p>
              ...
              <p style={{ fontSize: "0.9375rem", lineHeight: 1.72, color: "hsl(214,7%,60%)", maxWidth: "56ch", marginBottom: "2.5rem" }}>
                Vessels shares its execution fabric, governance model, and audit infrastructure with every SZL vertical.
                Signal detection, human-in-the-loop approval, and proof chain verification — applied to maritime operations.
              </p>
            </m.div>
            <div className="szl-grid-3">
              {[
                ...
                { label: "All Solutions", desc: "Explore PRISM Counsel, Aegis, Terra, and the full SZL vertical portfolio.", href: "/solutions", color: "hsl(38,72%,58%)" },
              ].map((link, i) => (
          ...
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
            <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }} className="szl-card szl-grid-cta" style={{ borderRadius: "1rem", padding: "clamp(2.5rem,5vw,4rem)", gap: "2.5rem", alignItems: "center" }}>
              <div>
                ...
                <p style={{ fontSize: "0.9375rem", lineHeight: 1.70, color: "hsl(214,7%,62%)", maxWidth: "48ch" }}>Vessels is in design-partner stage with maritime operators managing complex, distributed fleets. Talk to us about your operating environment.</p>
              </div>
