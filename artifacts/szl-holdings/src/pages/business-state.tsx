        ...
        {toasts.map((t) => (
          ...
          >
            {t.type === 'success' ? (
              ...
              <Info style={{ width: 13, height: 13, color: ACCENT, flexShrink: 0 }} />
            )}
            <span
...
const EXEC_HEALTH = {
  ...
  topIssues: [
    { title: 'Lyte API P95 breaching 2.4s SLA', severity: 'high', domain: 'lyte' as DomainId },
    {
      ...
      severity: 'high',
      domain: 'carlota' as DomainId,
    },
    {
      title: '2 over-budget domains consuming $1.2M extra',
      severity: 'medium',
  ...
  blockedActions: [
    {
      title: 'LP Q1 Update Report',
      reason: 'Draft pending CFO sign-off',
    ...
    {
      title: 'Carlota Jo Feed Reconnect',
      reason: 'CRM credentials expired',
      exposure: 'Churn risk',
    },
  ],
  changesYesterday: [
...
const KPI_HEALTH_DATA = [
  {
    ...
    status: 'breach',
    trend: 'up' as const,
    causal: 'Full table scan on distress_score query; index missing',
  },
  {
    id: 'k2',
    domain: 'aegis' as DomainId,
    ...
    status: 'healthy',
    trend: 'down' as const,
    causal: 'Automated playbook firing 43% of incidents without analyst',
  },
  {
    id: 'k3',
    domain: 'vessels' as DomainId,
    ...
    status: 'healthy',
    trend: 'flat' as const,
    causal: 'No anomalous port events in trailing 7 days',
  },
  {
    id: 'k4',
    domain: 'terra' as DomainId,
    ...
    status: 'healthy',
    trend: 'down' as const,
    causal: 'AI pre-triage routing reducing analyst queue depth',
  },
  {
    id: 'k5',
    domain: 'lyte' as DomainId,
    ...
    status: 'breach',
    trend: 'down' as const,
    causal: 'Weather event clusters in DC corridor; 3 routes impacted',
  },
  {
    id: 'k6',
    ...
    status: 'healthy',
    trend: 'down' as const,
    causal: 'AI review assistant reducing first-read time by 18%',
  },
  {
    id: 'k7',
    domain: 'carlota' as DomainId,
    ...
    status: 'breach',
    trend: 'up' as const,
    causal: 'CRM sync credentials expired; pipeline disconnected',
  },
  {
    id: 'k8',
    domain: 'aegis' as DomainId,
    ...
    status: 'healthy',
    trend: 'flat' as const,
    causal: 'Weekly automated patch cycle running on schedule',
  },
];
...
const RISK_REGISTER = [
  {
    id: 'r1',
    title: 'Carlota Jo real-time data SLA breach',
    domain: 'carlota' as DomainId,
    probability: 0.9,
    impact: 'High',
    level: 'critical',
    owner: 'Ops Lead',
    mitigation: 'Reconnect CRM sync, add freshness watchdog',
    trend: 'up' as const,
  },
  {
    id: 'r2',
    ...
    level: 'high',
    owner: 'Eng Team',
    mitigation: 'Add index on distress_score + borough',
    trend: 'up' as const,
  },
  {
    id: 'r3',
    ...
    level: 'high',
    owner: 'Frontend Lead',
    mitigation: 'Code-split MITRE ATT&CK (280KB eager load)',
    trend: 'flat' as const,
  },
  {
    id: 'r4',
    ...
    level: 'medium',
    owner: 'Product Lead',
    mitigation: 'UX review, add AI-guided walkthrough',
    trend: 'down' as const,
  },
  {
    id: 'r5',
    title: 'LP Q1 Report deadline exposure',
    domain: 'terra' as DomainId,
    probability: 0.4,
    impact: 'High',
    level: 'medium',
...
const OPP_REGISTER = [
  {
    ...
    value: '$820K ARR',
    level: 'high',
    action: 'Expand capacity, add org-wide rollout incentive',
    owner: 'Growth Lead',
  },
  {
    id: 'o2',
    ...
    value: '$140K ARR',
    level: 'high',
    action: 'Low-effort implementation; prioritize this sprint',
    owner: 'Eng Team',
  },
  {
    id: 'o3',
    ...
    level: 'high',
    action: 'Implement using shared webhook-engine lib',
    owner: 'Backend Lead',
  },
  {
    id: 'o4',
    ...
    value: '$280K saved',
    level: 'medium',
    action: 'Charter rate benchmark feature re-activation',
    owner: 'Product Lead',
  },
];
...
const VALUE_LEDGER = [
  {
    ...
    label: 'Carlota Jo pipeline disconnection',
    amount: 380000,
    domain: 'carlota' as DomainId,
    note: 'Churn risk if feed stale > 24h',
  },
  {
    id: 'v2',
    type: 'at-risk' as const,
  ...
  },
  {
    ...
    label: 'Automated incident response savings',
    amount: 1200000,
    domain: 'aegis' as DomainId,
    note: '43% of incidents closed auto, saving ~8h analyst time/day',
  },
  {
    id: 'v5',
    type: 'protected' as const,
...
const WORKFLOW_PERF = [
  {
    id: 'w1',
    name: 'Carlota Jo Client Onboarding',
    domain: 'carlota' as DomainId,
    steps: 8,
    completion: 84,
    avgMin: 22,
    bottleneck: 'Step 4: Contract sign-off (avg 6m)',
    status: 'active',
  },
  {
    id: 'w2',
    ...
    completion: 91,
    avgMin: 41,
    bottleneck: 'Step 7: Escalation approval (avg 11m)',
    status: 'active',
  },
  {
    id: 'w3',
    ...
    completion: 77,
    avgMin: 18,
    bottleneck: 'Step 5: Photo upload (avg 4m)',
    status: 'active',
  },
  {
    id: 'w4',
    ...
    completion: 68,
    avgMin: 55,
    bottleneck: 'Step 6: Ownership verification (avg 18m)',
    status: 'active',
  },
  {
    id: 'w5',
    ...
    completion: 88,
    avgMin: 14,
    bottleneck: 'Step 3: Conflict check (avg 3m)',
    status: 'active',
  },
  {
    id: 'w6',
    name: 'SZL LP Quarterly Update',
    domain: 'lyte' as DomainId,
    steps: 9,
    completion: 55,
    avgMin: 90,
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.875rem' }}>
        ...
        >
          ...
          {(period === '24h' ? health.changesYesterday : health.changesLastWeek).map(
            (change, i) => (
              <div
                key={i}
                style={{
        ...
        >
          ...
          <div
            style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)', marginBottom: '0.875rem' }}
          >
          ...
          return (
            ...
            >
              <div>
                ...
                >
                  <span
                    style={{ fontSize: '12px', fontWeight: 600, color: 'rgba(255,255,255,0.8)' }}
                  >
                    {kpi.name}
                  </span>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                {kpi.trend === 'up' ? (
                  <TrendingUp
                    style={{ width: 12, height: 12, color: isBreach ? '#ef4444' : '#22c55e' }}
                  />
                ) : kpi.trend === 'down' ? (
                  <TrendingDown
                    style={{ width: 12, height: 12, color: isBreach ? '#22c55e' : '#ef4444' }}
                  />
                ) : (
              ...
              <div
                style={{
                  ...
                  padding: '3px 8px',
                  borderRadius: '4px',
                  background: isBreach ? 'hsla(0,70%,14%,0.6)' : 'hsla(160,60%,14%,0.6)',
                  color: isBreach ? '#ef4444' : '#22c55e',
                }}
              >
          ...
          >
            ...
            >
              ...
              <div style={{ marginLeft: 'auto', display: 'flex', gap: '1rem', fontSize: '10px' }}>
                ...
                <span style={{ fontWeight: 700, color: effColor }}>
...
function RiskRegisterModule() {
  ...
  useEffect(() => {
    ...
    fetch('/api/linear/teams', { credentials: 'include' })
      ...
      .catch((err) => {
        if (!cancelled) setTeamsErr((err as Error).message);
      });
    return () => {
      cancelled = true;
    };
      ...
      patch({
        riskActions: {
          [riskId]: {
            type: 'playbook',
            status: 'done',
            result: 'Credentials rotated. Pipeline reconnected at 14:38. Freshness restored.',
            at: new Date().toISOString(),
            actor: CURRENT_ACTOR,
          },
        },
  ...
  async function handleTicket(riskId: string, risk: (typeof RISK_REGISTER)[number]) {
    ...
    patch({
      riskActions: {
        [riskId]: { type: 'ticket', status: 'running', at: startedAt, actor: CURRENT_ACTOR },
      },
    });
    ...
    const teamKey =
      override.teamKey && override.teamKey.trim().length > 0 ? override.teamKey.trim() : undefined;
    ...
    try {
      ...
      show(
        `Linear ticket ${json.identifier} created — assigned to ${json.assignee?.name ?? risk.owner}.`,
        'success',
      );
      ...
      if (created.length > 0) {
        show(
          `Auto-created missing label${created.length > 1 ? 's' : ''}: ${created.join(', ')}`,
          'info',
          5000,
        );
      }
  ...
  return (
    <>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', flexWrap: 'wrap' }}>
          ...
          <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.55)' }}>
            ...
            <strong style={{ color: 'rgba(255,255,255,0.85)' }}>
              {defaultTeamLabel ??
                (teams[0]
                  ? `${teams[0].key} · ${teams[0].name} (workspace default)`
                  : teamsErr
                    ? '—'
                    : 'loading…')}
            </strong>
          ...
          <button
            ...
            style={{
              ...
              padding: '3px 9px',
              borderRadius: '4px',
              background: adminOpen ? `${ACCENT}25` : 'hsla(0,0%,100%,0.04)',
              border: `1px solid ${adminOpen ? `${ACCENT}50` : BORDER}`,
              color: adminOpen ? ACCENT : 'rgba(255,255,255,0.55)',
              cursor: 'pointer',
            }}
          >
        ...
        {adminOpen && (
          ...
          >
            ...
            <span style={{ fontSize: '10px', color: 'rgba(255,255,255,0.35)' }}>
              Each ticket is also tagged with{' '}
              <code
                style={{
                  fontSize: '10px',
                  padding: '0 4px',
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
        {risks.map((risk, i) => {
          const color =
            risk.level === 'critical' ? '#ef4444' : risk.level === 'high' ? '#f97316' : '#f59e0b';
          ...
          return (
            <div
              key={risk.id}
              style={{ borderBottom: i < risks.length - 1 ? `1px solid ${BORDER}` : 'none' }}
            >
              <div
                style={{
                  display: 'flex',
                    ...
                    >
                        ...
                        {isEditingThisOwner ? (
                          <div style={{ display: 'flex', gap: '0.375rem', alignItems: 'center' }}>
                            <input
                              ...
                              onKeyDown={(e) => {
                                if (e.key === 'Enter') handleSaveOwner(risk.id);
                                if (e.key === 'Escape') {
                                  setEditingOwner(null);
                                  setOwnerInput('');
                                }
                            ...
                            />
                            <button
                              onClick={() => handleSaveOwner(risk.id)}
                              style={{
                                fontSize: '9px',
                                fontWeight: 700,
                                padding: '2px 8px',
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                            ...
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                setEditingOwner(risk.id);
                                setOwnerInput(effectiveOwner);
                              }}
                              style={{
                                fontSize: '9px',
                                padding: '1px 6px',
                      ...
                      <div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '3px' }}>
                          {risk.trend === 'up' ? (
                            <TrendingUp style={{ width: 11, height: 11, color: '#ef4444' }} />
                          ) : risk.trend === 'down' ? (
                            <TrendingDown style={{ width: 11, height: 11, color: '#22c55e' }} />
                          ) : (
                            <div
                              style={{ width: 11, height: 1, background: 'rgba(255,255,255,0.2)' }}
                            />
                          )}
                          <span
                            style={{
                    ...
                    >
                      {risk.id === 'r1' &&
                        (riskAction?.type === 'playbook' && riskAction.status === 'running' ? (
                          ...
                          <button
                            onClick={() => handlePlaybook(risk.id, risk.title)}
                            style={{
                              display: 'flex',
                              alignItems: 'center',
                              gap: '5px',
                              ...
                              borderRadius: '6px',
                              background: '#c2a55a20',
                              border: '1px solid #c2a55a40',
                              color: '#c2a55a',
                              cursor: 'pointer',
                            }}
                          >
                            <RefreshCw style={{ width: 10, height: 10 }} /> Rotate Credentials &amp;
                            Reconnect
                          </button>
                        ) : null)}
                      {riskAction?.type === 'ticket' && riskAction.status === 'running' ? (
                        ...
                        >
                          ...
                          {riskAction.ticketUrl ? (
                            ...
                            <>
                              Ticket <strong>{riskAction.ticketId}</strong> created — index
                              migration queued.
                            </>
                          )}
                        </div>
                        ...
                        <button
                          onClick={() => handleTicket(risk.id, risk)}
                          style={{
                            display: 'flex',
                            alignItems: 'center',
                            gap: '5px',
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              padding: '5px 12px',
                              borderRadius: '6px',
                              background: hasOverride ? `${ACCENT}20` : 'hsla(0,0%,100%,0.04)',
                              border: `1px solid ${hasOverride ? `${ACCENT}50` : BORDER}`,
                              color: hasOverride ? ACCENT : 'rgba(255,255,255,0.55)',
                              cursor: 'pointer',
                            }}
                          >
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Linear overrides for this risk
                              </span>
                              <span style={{ fontSize: '10px', color: 'rgba(255,255,255,0.35)' }}>
                                · remembered for next ticket from this row
                              </span>
                            </div>
                            <div
                              style={{
                            ...
                            >
                              ...
                              >
                                <option value="">
                                  ...
                                  {defaultTeamLabel ?? (teams[0] ? `${teams[0].key}` : 'auto')}) —
                                </option>
                                {teams.map((t) => (
                                  <option key={t.id} value={t.key}>
                                    {t.key} · {t.name}
                              ...
                              >
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.25rem' }}>
                                  {(override.labels ?? []).map((label) => (
                                    ...
                                    >
                                      {label}
                                      <button
                                        onClick={() => removeLabel(risk.id, override, label)}
                                        style={{
                                          background: 'transparent',
                                          border: 'none',
                                          color: ACCENT,
                                  ...
                                  {(!override.labels || override.labels.length === 0) && (
                                    ...
                                    >
                                      None — domain & severity tags are still added automatically.
                                    </span>
                                  )}
                                </div>
                                <div
                                ...
                                >
                                  <input
                                    value={draft}
                                    onChange={(e) =>
                                      setLabelDraft((d) => ({ ...d, [risk.id]: e.target.value }))
                                    }
                                    onKeyDown={(e) => {
                                      if (e.key === 'Enter') {
                                        e.preventDefault();
                                        addLabel(risk.id, override);
                                      }
                                    }}
                                  ...
                                  />
                                  <button
                                    onClick={() => addLabel(risk.id, override)}
                                    disabled={!draft.trim()}
                                    style={{
                                      fontSize: '10px',
                                      fontWeight: 700,
                                      ...
                                      background: draft.trim()
                                        ? `${ACCENT}25`
                                        : 'hsla(0,0%,100%,0.04)',
                                      border: `1px solid ${draft.trim() ? `${ACCENT}50` : BORDER}`,
                                      color: draft.trim() ? ACCENT : 'rgba(255,255,255,0.3)',
                            ...
                            {(override.teamKey ||
                              ...
                              <div>
                                <button
                                  onClick={() => setOverride(risk.id, null)}
                                  style={{
                                    fontSize: '10px',
                                    padding: '3px 9px',
                                    borderRadius: '4px',
...
function OpportunityModule() {
  ...
  function handleAccept(oppId: string, title: string) {
    patch({
      oppDecisions: {
        [oppId]: { decision: 'accept', at: new Date().toISOString(), actor: CURRENT_ACTOR },
      },
    });
  ...
  function handleSnoozeSubmit(oppId: string, title: string) {
    ...
    show(
      `"${title}" snoozed for ${snoozeInput.duration}${snoozeInput.reason ? ` — ${snoozeInput.reason}` : ''}.`,
      'info',
    );
              ...
              >
                <div>
                  ...
                  >
                    ...
                    {DOMAINS[opp.domain as DomainId] && (
                      <DomainTag domain={opp.domain as DomainId} />
                    )}
                    {decision && (
                      <span
                        style={{
                  ...
                  <div
                    style={{
                      fontSize: '9px',
                      color: 'rgba(255,255,255,0.25)',
                      marginBottom: decision ? 0 : '0.625rem',
                    }}
                  >
                  ...
                  {!decision && !isSnoozing && !isRejecting && (
                    <div style={{ display: 'flex', gap: '0.375rem', flexWrap: 'wrap' }}>
                      <button
                        onClick={() => handleAccept(opp.id, opp.title)}
                        style={{
                          display: 'flex',
                          alignItems: 'center',
                          gap: '4px',
                    ...
                    >
                      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setSnoozeInput((p) => ({ ...p, reason: e.target.value }))
                          }
                        ...
                        />
                        <button
                          onClick={() => handleSnoozeSubmit(opp.id, opp.title)}
                          style={{
                            fontSize: '9px',
                            fontWeight: 700,
                            padding: '3px 10px',
                  ...
                  {isRejecting && (
                    ...
                    >
                      ...
                      />
                      <button
                        onClick={() => handleRejectSubmit(opp.id, opp.title)}
                ...
                <div style={{ textAlign: 'right' }}>
                  <div
                    style={{ fontSize: '14px', fontWeight: 800, color, letterSpacing: '-0.02em' }}
                  >
                    {opp.value}
                  </div>
                  <div
      ...
      >
        {(
          ...
          return (
            ...
            >
              <Icon
                style={{ width: 16, height: 16, color: cfg.color, margin: '0 auto 0.375rem' }}
              />
              <div
                style={{
                  fontSize: '1.5rem',
        ...
        return (
          <div
            ...
            style={{
              ...
              borderBottom: i < ledger.length - 1 ? `1px solid ${BORDER}` : 'none',
            }}
          >
            <div
              style={{
    ...
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
        {WORKFLOW_PERF.map((wf) => {
          const compColor =
            wf.completion >= 85 ? '#22c55e' : wf.completion >= 70 ? '#f59e0b' : '#ef4444';
          return (
            <div
              key={wf.id}
              style={{
            ...
            >
              ...
              >
                <AlertTriangle
                  style={{ width: 9, height: 9, color: '#f59e0b', flexShrink: 0, marginTop: 1 }}
                />
            ...
            >
              <div>
                ...
                >
                  ...
                  {DOMAINS[agent.domain as DomainId] && (
                    <DomainTag domain={agent.domain as DomainId} />
                  )}
                </div>
                <div style={{ fontSize: '9px', color: 'rgba(255,255,255,0.3)' }}>
                  {agent.actionsExecuted.toLocaleString()} actions · {agent.humanOverrides}{' '}
                  overrides
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontSize: '11px', fontWeight: 800, color: sc }}>
                  {agent.trustScore}
                </div>
    ...
    <div>
      ...
      {sorted.length === 0 ? (
        ...
        >
          ...
          />
          No decisions logged yet. Accept, reject, or snooze items in the Risk Register or
          Opportunities to see them here.
        </div>
      ) : (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          {sorted.map((e, i) => (
...
export default function BusinessStatePage() {
  ...
  const breachKPIs = liveData
    ? liveData.kpiHealth.filter((k) => k.status === 'breach').length
    : KPI_HEALTH_DATA.filter((k) => k.status === 'breach').length;
  const criticalRisks = liveData
    ? liveData.riskRegister.filter((r) => r.level === 'critical').length
    : RISK_REGISTER.filter((r) => r.level === 'critical').length;
          ...
          {executiveMode && (
            ...
            >
              ...
              <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.6)' }}>
                <strong style={{ color: ACCENT }}>Executive Mode:</strong> Showing high-signal
                summary view. Causal explanations and sub-details are elevated for boardroom
                clarity.
              </span>
              <button
            ...
            >
              ...
              >
                ...
                <div style={{ padding: '1.25rem 1.5rem' }}>
                  {activeModule === 'exec' && (
                    <ExecutiveOverviewModule executiveMode={executiveMode} />
                  )}
