...
const PACKS: Pack[] = [
  ...
  },
  {
    ...
    description: "Real estate operators and investors finally get a command layer. Property Twin tracks every asset signal. FORGE routes action through governed workflows.",
    icon: Building2,
  ...
  },
  {
    ...
    description: "Command-grade observability for maritime operations. Voyage and fleet twins surface risk before it becomes a commercial incident. FORGE routes action with full traceability.",
    icon: Ship,
    ...
    workflow: [
      ...
      { label: "Action & Export", detail: "Rerouting or escalation routed through FORGE with approval gate and audit record" },
    ],
  ...
  },
  {
    ...
    description: "SOC command built for environments where every decision has consequence. Threat Twin tracks your exposure surface. FORGE routes response through governed playbooks.",
    icon: ShieldCheck,
    ...
    workflow: [
      ...
      { label: "Response Action Queue", detail: "Remediation steps routed to the right analyst through FORGE with SLA tracking" },
  ...
  },
  {
    ...
    workflow: [
      ...
      { label: "Action Routing", detail: "High-priority items escalated into FORGE with context and recommended action" },
    ],
...
export default function DemoPage() {
  ...
  const __pageMeta = usePageMeta({
    ...
    description: "See how KORA and FORGE work across every vertical pack. Choose a product, explore the flagship workflow, and request controlled access.",
