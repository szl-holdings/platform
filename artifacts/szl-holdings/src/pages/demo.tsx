...
const PACKS: Pack[] = [
  ...
  },
  {
    ...
    workflow: [
      ...
      { label: "Action & Export", detail: "Rerouting or escalation routed through Counsel with approval gate and audit record" },
    ],
  ...
  },
  {
    ...
    workflow: [
      ...
      { label: "Response Action Queue", detail: "Remediation steps routed to the right analyst through Counsel with SLA tracking" },
  ...
  },
  {
    ...
    workflow: [
      ...
      { label: "Action Routing", detail: "High-priority items escalated into Counsel with context and recommended action" },
    ],
