      ...
      >
        ...
        <div style={{ textAlign: 'right' }}>
          <div
            style={{
              fontSize: '11px',
              color: stream.qoqChange >= 0 ? '#22c55e' : '#ef4444',
              fontWeight: 700,
              display: 'flex',
              alignItems: 'center',
              gap: '2px',
          ...
          >
            ...
            {stream.qoqChange >= 0 ? '+' : ''}
            {stream.qoqChange.toFixed(1)}% QoQ
          </div>
          <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.25)', marginTop: '1px' }}>
            {stream.yoyChange >= 0 ? '+' : ''}
            {stream.yoyChange.toFixed(1)}% YoY
          </div>
        </div>
      </div>
      <div style={{ fontSize: '20px', fontWeight: 800, color: stream.color }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)' }}>
              Unified P&L across all domains · Stripe, Portfolio, Real Estate, Maritime, Advisory
            </div>
          </div>
        </div>
      }
      ...
      >
          ...
          {[
            {
              ...
              sub: `+${totalQoQ.toFixed(1)}% QoQ avg`,
              color: '#22c55e',
            },
            {
              label: 'Portfolio NAV',
              value: formatCurrency(284200000),
              sub: '+3.1% QoQ',
              color: ACCENT,
            },
            {
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
              {streams.map((stream) => (
                <RevenueStreamCard
                  ...
                  onClick={() =>
                    setSelectedStream((prev) => (prev === stream.id ? null : stream.id))
                  }
                />
              ))}
            </div>
            ...
            {selected && (
              ...
              >
                ...
                >
                  ...
                  <div>
                    <div
                      style={{ fontSize: '14px', fontWeight: 700, color: 'rgba(255,255,255,0.9)' }}
                    >
                      {selected.label}
                    </div>
                    <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)' }}>
                  ...
                  {selected.breakdown.map((b) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ fontSize: '16px', fontWeight: 700, color: selected.color }}>
        ...
        {view === 'waterfall' && (
          ...
          >
            ...
            >
              Cash Flow Waterfall — Operating Revenue
            </div>
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          >
                            ...
                            <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                              <span
                                style={{ fontSize: '12px', fontWeight: 700, color: stream.color }}
                              >
                                {formatCurrency(stream.totalRevenue)}
                              </span>
                              <span
                          ...
                          >
                            {pct.toFixed(1)}% of operating revenue
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                .map((stream) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <div style={{ flex: 1, fontSize: '12px', color: 'rgba(255,255,255,0.65)' }}>
                        {stream.label}
                      </div>
                      <div style={{ fontSize: '12px', fontWeight: 700, color: stream.color }}>
                        {pct.toFixed(1)}%
                      </div>
                      <div
                        style={{
