...
const PIPELINE_STAGES = [
  ...
  },
  {
    ...
    sublabel: "Counsel proposes action",
    color: "var(--color-alloy-light)",
    colorMuted: "var(--color-alloy-muted)",
    colorBorder: "var(--color-alloy-border)",
    desc: "Counsel receives the interpreted signal and generates a structured action recommendation — specific action type, responsible actor, routing path, and SLA expectation. Not a generic alert.",
  ...
  },
  {
    id: "action",
    label: "Action",
    sublabel: "Counsel executes",
    color: "var(--color-alloy)",
    colorMuted: "var(--color-alloy-muted)",
    colorBorder: "var(--color-alloy-border)",
    desc: "With approval confirmed, Counsel executes the action through the appropriate connector — task assignment, notification, external API call, or system update. Execution is scoped to the approved action only.",
