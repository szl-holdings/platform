...
const CAPABILITIES = [
  ...
  { icon: AlertOctagon, title: "Incident Response Routing", body: "When a threat signal crosses threshold, FORGE routes the incident to the right analyst with full context, playbook reference, and approval chain ready." },
  ...
  { icon: Zap, title: "Managed Operations Layer", body: "For teams that need managed security operations support — PARAGON provides the operating model, FORGE provides the execution layer, with HITL gates throughout." },
];
...
const USE_CASES = [
  {
    ...
    steps: [
      ...
      { text: "FORGE routes incident to on-call incident commander with playbook reference and approval chain pre-staged" },
  ...
  },
  {
    ...
    steps: [
      ...
      { proof: true, text: "FORGE executes the approved patch workflow; Proof Chain records the full decision chain for post-incident review" },
    ],
  },
];
