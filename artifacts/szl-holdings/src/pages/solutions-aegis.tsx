...
const CAPABILITIES = [
  ...
  { icon: Zap, title: "Managed Operations Layer", body: "For teams that need managed security operations support — Aegis provides the operating model, Counsel provides the execution layer, with HITL gates throughout." },
];
            ...
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <p style={{ fontSize: "clamp(1rem,1.8vw,1.125rem)", lineHeight: 1.72, color: "hsl(214,7%,64%)", maxWidth: "52ch", marginBottom: "2.25rem" }}>
                  SOC command, XDR, and managed security operations — built on the Lyte + Counsel
