...
const CAPABILITIES = [
  ...
  { icon: AlertOctagon, title: "Incident Response Routing", body: "When a threat signal crosses threshold, Counsel routes the incident to the right analyst with full context, playbook reference, and approval chain ready." },
  ...
  { icon: Zap, title: "Managed Operations Layer", body: "For teams that need managed security operations support — PARAGON provides the operating model, Counsel provides the execution layer, with HITL gates throughout." },
];
...
const USE_CASES = [
  {
    ...
    steps: [
      ...
      { text: "Counsel routes incident to on-call incident commander with playbook reference and approval chain pre-staged" },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "Compliance officer opens PARAGON audit surface, applies role filter and date range" },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "PARAGON enriches with asset exposure map: 14 production systems at risk, two in regulated scope" },
      ...
      { proof: true, text: "Counsel executes the approved patch workflow; Proof Chain records the full decision chain for post-incident review" },
    ],
  },
];
...
export default function SolutionsAegisPage() {
  const __pageMeta = usePageMeta({
    title: "PARAGON — Security & Defense Intelligence · SZL Holdings",
    description: "SOC command, MITRE ATT&CK mapping, SOAR playbooks, policy-gated triage with human approval. PARAGON is the security & defense domain pack — built on the same governance infrastructure as every SZL product.",
            ...
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.75rem" }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "0.625rem" }}>
                      <h1 style={{ fontSize: "clamp(2rem,4.5vw,3.25rem)", fontWeight: 600, letterSpacing: "-0.028em", lineHeight: 1.08 }}>PARAGON</h1>
                ...
                <p style={{ fontSize: "clamp(1rem,1.8vw,1.125rem)", lineHeight: 1.72, color: "hsl(214,7%,64%)", maxWidth: "52ch", marginBottom: "2.25rem" }}>
                  SOC command, XDR, and managed security operations — built on the KORA + Counsel
            ...
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }} className="szl-card szl-grid-cta" style={{ borderRadius: "1rem", padding: "clamp(2.5rem,5vw,4rem)", gap: "2.5rem", alignItems: "center" }}>
                <div>
                  ...
                  <p style={{ fontSize: "0.9375rem", lineHeight: 1.70, color: "hsl(214,7%,62%)", maxWidth: "48ch" }}>PARAGON is currently in pilot with security teams in high-consequence operating environments. Talk to us about your environment.</p>
                </div>
