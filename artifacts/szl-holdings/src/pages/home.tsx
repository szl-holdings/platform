  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          Governed software.<br />
          <span style={{ color: "var(--color-szl-accent)" }}>Operational precision.</span>
          <br />Command-grade execution.
        </m.h1>
        ...
        >
          One parent company. One intelligence backbone. Four purpose-built platforms —
          Lyte for business observability, Vessels for maritime command, Carlota Jo for high-trust operations,
          and Alloy powering the entire ecosystem.
        </m.p>
