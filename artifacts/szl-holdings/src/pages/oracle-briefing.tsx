...
import {
  type BriefSeverity,
  generateOracleBrief,
  type OracleBriefSection,
} from '@/lib/nexus/oracle-pipeline';

function buildSectionProof(
  section: OracleBriefSection,
  briefId: string,
  graphVersion: string,
): ProofRecord {
  ...
  return {
    ...
    confidence: conf,
    model: 'ORACLE pipeline · PRAXIS graph synthesis',
    ...
    policyChecks: [
      ...
      { label: 'Source: deterministic PRAXIS graph traversal', passed: true },
      { label: 'Human-in-loop gate: required before broad distribution', passed: true },
      {
        ...
        note: 'ORACLE drafts must be reviewed before external sharing',
      },
    ...
    chainLinks: [
      {
        id: 'c1',
        event: `PRAXIS graph traversed (v${graphVersion}) — entities + edges`,
        actor: 'System / PRAXIS',
        timestamp: new Date().toUTCString().replace(' GMT', ''),
        hash: `sha256:${section.id.repeat(2).slice(0, 9)}...`,
      },
      {
        id: 'c2',
        event: `Section synthesized — ${section.findings.length} findings, ${section.recommendedActions.length} actions`,
        actor: 'ORACLE pipeline',
        timestamp: new Date().toUTCString().replace(' GMT', ''),
        hash: `sha256:${section.id.repeat(3).slice(0, 9)}...`,
      },
      {
        id: 'c3',
        event: `Severity classified ${section.severity} — confidence ${section.analystConfidence}%`,
        actor: 'ORACLE classifier',
        timestamp: new Date().toUTCString().replace(' GMT', ''),
        hash: `sha256:o${section.id.slice(0, 8)}...`,
      },
      {
        id: 'c4',
        event: 'Recorded in proof chain — read receipts pending',
        actor: 'System / Proof Chain',
        timestamp: new Date().toUTCString().replace(' GMT', ''),
        hash: `sha256:${briefId.slice(-9)}...`,
      },
    ],
    metadata: {
          ...
          >
            <div style={{ padding: '0 1.5rem 1.5rem' }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ paddingLeft: '0.5rem' }}>
                        ...
                        <div
                          style={{ fontSize: '10.5px', color: 'hsl(210,5%,48%)', lineHeight: 1.6 }}
                        >
                          {f.detail}
                        </div>
                      </div>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          padding: '0.625rem 0.75rem',
                          borderRadius: '8px',
                          background: `${pc.color}05`,
                          border: `1px solid ${pc.color}14`,
                          marginBottom: '0.5rem',
                        }}
                      >
                        <PIcon
                          size={11}
                          style={{ color: pc.color, marginTop: '1px', flexShrink: 0 }}
                        />
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div
                            style={{
                          ...
                          >
                            ...
                            <span style={{ fontSize: '9px', color: 'hsl(210,5%,38%)' }}>
                              · {a.owner}
                            </span>
                          </div>
                          <div
                            style={{ fontSize: '11px', color: 'hsl(210,10%,74%)', lineHeight: 1.5 }}
                          >
                            {a.action}
                          </div>
                        </div>
              ...
              >
                <Info
                  size={11}
                  style={{ color: 'hsl(210,5%,38%)', flexShrink: 0, marginTop: '1px' }}
                />
                <div>
                  <div
                    style={{
                  ...
                  >
                    Analyst Note · Confidence {section.analystConfidence}%
                  </div>
                  <div style={{ fontSize: '10.5px', color: 'hsl(210,5%,48%)', lineHeight: 1.65 }}>
                    {section.analystNote}
                  </div>
                </div>
              </div>
              ...
              <div style={{ marginTop: '1rem' }} data-testid={`proof-drawer-section-${section.id}`}>
                <ProofDrawer
                  proof={buildSectionProof(section, briefId, graphVersion)}
                  compact={true}
                  defaultOpen={false}
                />
              </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          This brief contains ORACLE-generated intelligence synthesized from live SZL Holdings
          cross-domain data. Access is restricted to authorized SZL executives. Your review will be
          timestamped and logged for compliance purposes.
        </p>
        <m.button
...
export default function OracleBriefingPage() {
  ...
  useEffect(() => {
    document.title = 'ORACLE Daily Brief — SZL Holdings Executive';
  }, []);
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        ...
        <div
          style={{
            ...
            height: '40vw',
            borderRadius: '50%',
            background: 'radial-gradient(ellipse, rgba(239,68,68,0.025) 0%, transparent 70%)',
          }}
        />
      </div>
        ...
        <div style={{ maxWidth: '880px', margin: '0 auto', padding: '0 1.5rem 6rem' }}>
          ...
          >
              ...
              {[
                {
                  ...
                  value: executiveSummary.criticalCount,
                  color: '#ef4444',
                },
                { label: 'High Sections', value: executiveSummary.highCount, color: '#f97316' },
                {
                  label: 'Immediate Actions',
                  value: executiveSummary.immediateActionCount,
                  color: '#a78bfa',
                },
                ...
                <m.div
                  ...
                  style={{
                    padding: '0.875rem',
                    borderRadius: '10px',
                    background: `${kpi.color}06`,
                    border: `1px solid ${kpi.color}18`,
                  }}
                >
                  <div
                    style={{ fontSize: '9px', color: 'hsl(210,5%,40%)', marginBottom: '0.375rem' }}
                  >
                    {kpi.label}
                  </div>
                  <div
                    style={{ fontSize: '28px', fontWeight: 900, color: kpi.color, lineHeight: 1 }}
                  >
                    {kpi.value}
                  </div>
                </m.div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
              {[
                {
                  label: 'Top Risk',
                  value: executiveSummary.topRisk,
                  Icon: AlertTriangle,
                  color: critColor,
                },
                {
                  label: 'Key Development',
                  value: executiveSummary.keyDevelopment,
                  Icon: Activity,
                  color: '#f97316',
                },
                {
                  label: 'Trend Assessment',
                  value: executiveSummary.trendShift,
                  Icon: FileText,
                  color: '#eab308',
                },
                {
                  label: 'ORACLE Assessment',
                  value: executiveSummary.oracleAssessment,
                  Icon: BookOpen,
                  color: '#a78bfa',
                },
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '12px', color: 'hsl(210,5%,62%)', lineHeight: 1.65 }}>
                      {value}
                    </div>
                  </div>
                </m.div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
                ...
                <span style={{ fontSize: '10.5px', fontWeight: 600, color: 'hsl(210,5%,60%)' }}>
                  PRAXIS pattern engine: {anomalyReport.totalCount} cross-domain anomalies detected
                </span>
              </div>
              <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
                {(Object.entries(anomalyReport.bySeverity) as Array<[BriefSeverity, number]>).map(
                  ([sev, count]) => {
              ...
              <Link href="/nexus/explorer">
                ...
                >
                  View in PRAXIS <ChevronRight size={10} />
                </span>
              </Link>
            </m.div>
          )}
          ...
          >
            ...
            >
              ...
              >
                About This Brief — ORACLE Pipeline Provenance
              </span>
            </div>
            <div
              style={{
            ...
            >
              {[
                ...
                { label: 'Entities Analyzed', value: `${KNOWLEDGE_GRAPH.entities.length}` },
                {
                  ...
                  value: `${KNOWLEDGE_GRAPH.edges.length} (${KNOWLEDGE_GRAPH.edges.filter((e) => e.inferred).length} inferred)`,
                },
            ...
            >
              This brief is generated by the ORACLE pipeline from the live PRAXIS knowledge graph.
              All findings are derived deterministically from cross-domain entity data and anomaly
              patterns — no hardcoded content. Inferred relationships are marked as such and carry
              lower confidence. Not a substitute for human intelligence review.
            </p>
          </m.div>
        </div>
      </main>
