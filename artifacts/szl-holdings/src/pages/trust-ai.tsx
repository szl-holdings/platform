...
export default function TrustAIPage() {
  const __pageMeta = usePageMeta({
    ...
    description: "AI usage model, source-grounding, governed inference layer, and generated-vs-source controls for KORA + Counsel.",
            ...
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <p style={{ fontSize: "clamp(1rem,1.8vw,1.0625rem)", lineHeight: 1.72, color: "hsl(214,7%,64%)", maxWidth: "52ch" }}>
                  Every AI capability in KORA + Counsel — from Copilot recommendations to signal classification
