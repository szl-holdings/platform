...
const CAPABILITIES: Record<string, string[]> = {
  ...
  lyte: [
    ...
    'Built on the PRAXIS framework — Pulse, Risk, Intelligence, Signals, Motion',
  ],
  vessels: [
              ...
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: '0.8125rem', color: 'hsl(214, 6%, 57%)' }}>
                      — {selected.sublabel}
                    </span>
        ...
        <div style={{ marginTop: '4rem' }}>
          ...
          >
            {PILLAR_ROWS.map((pillar, i) => {
              const products = NODES.filter((n) => pillar.products.includes(n.id));
              return (
                <m.div
                  key={pillar.role}
