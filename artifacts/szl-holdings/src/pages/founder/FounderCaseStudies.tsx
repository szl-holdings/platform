...
const CASE_STUDIES = [
  {
    ...
    summary:
      `A maritime operations team was spending 40+ analyst hours per week manually auditing vessel port calls for compliance and sanctions exposure. We instrumented their AIS data feed through ${productName("vessels")}, connected it to ${productName("alloy")}'s workflow engine, and automated the compliance signal generation — reducing manual audit time by 78% while increasing coverage to the full fleet.`,
    outcome: "78% reduction in manual audit hours. Full-fleet coverage. Audit-grade record for every compliance check.",
  ...
  },
  {
    ...
    outcome: "$4.8B in tracked deal pipeline. 340+ distressed properties surfaced. First deals under LOI within 60 days of deployment.",
    ...
    <FounderLayout>
      ...
      >
        ...
        >
          ...
          >
            Documented proof from real deployments. No mock data, no projected outcomes — these are the actual results from operators who instrumented real workflows through the SZL stack.
          </p>
        </m.div>
