...
const THESIS_POINTS = [
  ...
  },
  {
    ...
    body: "Counsel is the shared execution spine. Every improvement to the fabric benefits every vertical simultaneously. This is not an efficiency measure — it's a strategic property. The portfolio gets stronger with every product added, not weaker.",
  },
  {
    number: '04',
    ...
    <FounderLayout>
      ...
      >
        ...
        >
          ...
          >
            ...
            <footer style={{ fontSize: '0.8125rem', color: 'hsl(214, 6%, 57%)' }}>
      ...
      >
        ...
        >
          ...
          >
            The design partner program is structured around one real workflow, documented proof, and
            direct founder access. No hand-offs.
          </p>
