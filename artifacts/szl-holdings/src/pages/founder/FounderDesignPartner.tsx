...
import { CheckCircle2, AlertCircle, ArrowRight, Zap, BarChart3, Shield, MessageSquare } from "lucide-react";
    ...
    <FounderLayout>
      ...
      >
        ...
        >
          ...
          >
            A design partner engagement is not a trial. It's a structured proof exercise: we identify one workflow in your operating environment that has a measurable inefficiency, instrument it together, and produce documented evidence of improvement. Direct founder access throughout.
          </p>
        </m.div>
        ...
        >
          <div>
            ...
            <div style={{ marginTop: "3rem" }}>
              ...
              {[
                { period: "Week 1–2", label: "Workflow selection + baseline", detail: "Identify the friction point. Define success criteria. Set the baseline." },
                { period: "Week 3–4", label: "Integration setup", detail: "Configure connectors. Test signal ingestion. Validate data quality." },
                { period: "Month 2", label: "Governed workflow live", detail: "End-to-end instrumented. AI recommendations running on live data." },
                { period: "Month 3", label: "Measurement + review", detail: "Document outcomes vs. baseline. Define expansion scope if results land." },
              ].map((phase) => (
                <div
                  key={phase.period}
                  style={{
          ...
          >
            {formState === "success" ? (
              <div style={{ textAlign: "center", padding: "2rem 0" }}>
                ...
                >
                  I review every application personally. If there's a fit, you'll hear from me directly within 5 business days.
                </p>
              </div>
            ) : (
