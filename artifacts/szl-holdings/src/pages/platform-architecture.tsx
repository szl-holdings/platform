...
const LOOP_STEPS = [
  {
    ...
    platforms: ["Lyte", "Vessels", "Aegis", "Terra"],
    color: "hsl(190,90%,55%)",
    colorRgb: "14,188,212",
  },
  {
    ...
    step: "02",
    label: "Interpret",
    description: "Contextualize raw signals with domain intelligence. Score risk, rank priority, map ownership. Counsel normalizes signals across all platforms into a shared entity model.",
    platforms: ["Counsel", "Aegis", "Terra"],
    color: "hsl(214,80%,65%)",
    colorRgb: "92,155,228",
  },
  {
    ...
    platforms: ["Counsel", "Lyte", "Vessels"],
    color: "hsl(265,80%,60%)",
    colorRgb: "136,96,212",
  },
  {
    ...
    step: "04",
    label: "Execute",
    description: "Act through structured, auditable workflows. Counsel orchestrates multi-step execution with human approval gates, assignment logic, and traceable outputs.",
    platforms: ["Counsel", "Carlota Jo"],
    color: "hsl(38,55%,58%)",
    colorRgb: "191,152,82",
  },
  {
  ...
  },
  {
    ...
    platforms: ["Counsel", "Terra", "Vessels"],
    color: "hsl(0,72%,55%)",
    colorRgb: "220,64,64",
  },
];
            ...
            <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  { title: "Counsel Signal Bus", body: "Every significant event in the ecosystem flows through Counsel's signal ingestion layer, normalized and enriched before routing to downstream platforms and agents." },
