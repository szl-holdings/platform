...
const ALLOY_INHERITED = [
  ...
  },
  {
    ...
    description: "Terra integrates with deal platforms, LP portals, and regulatory databases through Counsel's connector layer — output goes where the deal team already works.",
  },
  {
        ...
        <main id="main-content" >
            ...
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              ...
              <div style={{ display: "grid", gap: "clamp(2.5rem,5vw,4rem)", alignItems: "start" }} className="lg:grid-cols-[1.2fr_0.8fr]">
                <m.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.05 }}>
                  ...
                  >
                    Terra gives real estate operators and investors a command layer above a data-rich but execution-poor industry. Property Twin tracks every asset signal. Counsel routes action through governed workflows with full audit trail.
                  </p>
                  <p
                    style={{
              ...
              <div style={{ display: "grid", gap: "clamp(3rem,6vw,5rem)", alignItems: "start" }} className="lg:grid-cols-2">
                <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }}>
                  ...
                  <p style={{ fontSize: "0.9375rem", lineHeight: 1.70, color: "hsl(214,7%,62%)", maxWidth: "46ch", marginBottom: "1.25rem" }}>
                    Real estate is a domain rich in public data and poor in execution structure. Operators work from spreadsheets and manual data pulls while critical signals — distress, liens, flood risk — sit in disconnected systems. Terra applies Counsel's operating loop to the deal lifecycle: turning public data into a structured Property Twin, routing diligence actions through governed workflows, and producing LP-ready output with full provenance.
                  </p>
          ...
          <section style={{ borderBottom: "1px solid var(--color-szl-border)", padding: "var(--space-section-md) 0" }}>
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }}>
                <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.6875rem", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "hsl(140,50%,48%)", marginBottom: "1rem" }}>
                  What Terra Inherits from Counsel
                </p>
                ...
                <p style={{ fontSize: "0.9375rem", lineHeight: 1.70, color: "hsl(214,7%,58%)", maxWidth: "52ch", marginBottom: "2.5rem" }}>
                  Terra does not rebuild what Counsel already provides. Every capability below comes from the shared platform — the same infrastructure governing Counsel, Vessels, Aegis, and Carlota Jo.
                </p>
              </m.div>
