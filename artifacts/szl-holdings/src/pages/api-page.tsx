...
export default function ApiPage() {
  const __pageMeta = usePageMeta({
    ...
    description: "KORA + FORGE API overview: health, auth, signals, workflows, recommendations, audit, reports, and integrations endpoint groups.",
            ...
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <p style={{ fontSize: "clamp(1rem,1.8vw,1.125rem)", lineHeight: 1.72, color: "hsl(214,7%,62%)", maxWidth: "54ch", marginBottom: "2rem" }}>
                  The KORA + FORGE platform exposes a REST API and a governance API for tenant
