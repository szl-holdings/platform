...
const CASE_STUDIES_LD = {
  ...
  "description": "Documented design partner scenarios from KORA, SEXTANT, Counsel, DOMAINE, and PARAGON. Each case follows the same structure: problem, context, constraints, system built, how it worked, outcome, and why it matters.",
...
export default function CaseStudiesPage() {
  const __pageMeta = usePageMeta({
    ...
    description: "Documented design partner scenarios from KORA, SEXTANT, Counsel, DOMAINE, and PARAGON — structured case studies with documented problems, constraints, systems built, and proof.",
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-white/45 mt-2 max-w-2xl leading-relaxed">
                    Documented design partner scenarios from KORA, SEXTANT, Counsel, and DOMAINE. Each case follows the same structure: problem, context, constraints, system built, how it worked, outcome, and why it matters.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3" role="list" aria-label="Filter by product">
                {[
                  ...
                  ...["KORA", "SEXTANT", "Counsel", "DOMAINE", "PARAGON", "Carlota Jo"].map(p => ({ label: p, count: caseStudies.filter(c => c.product === p).length })),
