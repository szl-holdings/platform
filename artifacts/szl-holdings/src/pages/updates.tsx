...
const updates = [
  ...
  },
  {
    ...
    summary: "The SZL Holdings platform now includes a portfolio intelligence dashboard for investor visibility — tracking venture milestones, ecosystem metrics, and strategic progress across the portfolio.",
  },
  {
    date: "January 2026",
    tag: "SZL Cortex",
  ...
  },
  {
    ...
    summary: "Carlota Jo's advisory platform expanded with AI-assisted brand analysis tooling and a structured engagement workflow system for managing multi-phase client engagements.",
  },
  {
    date: "December 2025",
    tag: "Aegis",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-32 pb-24">
        <div className="mb-14">
          <p className="text-[11px] font-semibold text-[hsl(215,45%,45%)] tracking-[0.15em] uppercase mb-3">Updates</p>
          ...
          <p className="text-neutral-500 text-[15px] leading-relaxed">
            Milestone updates, product launches, and ecosystem progress from across the SZL portfolio.
          </p>
        </div>
