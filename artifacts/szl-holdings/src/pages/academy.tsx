...
export default function AcademyPage() {
  const __pageMeta = usePageMeta({ title: "Academy — SZL Holdings", description: "Learn the SZL platform end-to-end. Structured learning paths, quick starts, and domain-specific primers." });
