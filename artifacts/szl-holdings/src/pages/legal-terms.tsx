...
const SECTIONS = [
  {
    ...
    lines: [
      `These Terms of Service ("Terms") govern your access to and use of the websites, platforms, APIs, and services operated by SZL Holdings Ltd ("SZL Holdings", "we", "us", or "our"), including KORA, Counsel, PARAGON, DOMAINE, SEXTANT, Counsel, and associated services (collectively, the "Services").`,
