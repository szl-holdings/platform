...
const PILLARS = [
  ...
  },
  {
    ...
    body: "Capital, time, and attention are scarce. The company maintains one commercial wedge (KORA + Counsel) while the remainder of the ecosystem is staged as expansion value — visible but not simultaneously chased.",
