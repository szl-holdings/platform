...
const SECTIONS = [
  {
    title: "Overview",
    body: "This Acceptable Use Policy (\"AUP\") governs the use of KORA, FORGE, and all associated products and services operated by SZL Holdings. By accessing or using our platforms, you agree to these terms. Violations may result in account suspension or termination.",
  },
  {
    title: "Permitted use",
...
export default function LegalAcceptableUsePage() {
  const __pageMeta = usePageMeta({
    ...
    description: "SZL Holdings acceptable use policy for KORA, FORGE, and all platform products and services.",
