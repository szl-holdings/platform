...
export default function TerraListingsPage() {
  const [filter, setFilter] = useState<'All' | 'Office' | 'Mixed-Use' | 'Retail' | 'Industrial'>(
    'All',
  );
  ...
  const filtered =
    filter === 'All' ? STATIC_LISTINGS : STATIC_LISTINGS.filter((l) => l.type === filter);
          ...
          <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
              ...
              {filtered.map((listing, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: '12px', color: 'hsl(210,5%,48%)' }}>
                      {listing.submarket}
                    </span>
                  </div>
            ...
            >
              ...
              <p style={{ fontSize: '12.5px', color: 'hsl(210,5%,50%)', marginBottom: '1.25rem' }}>
                Active listings, inquiry routing, agent performance, and distress engine — all in
                one platform.
              </p>
              <a
                href="/terra/"
