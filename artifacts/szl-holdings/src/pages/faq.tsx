    ...
    questions: [
      {
        ...
        a: "SZL Holdings is a holding company building the business observability category. The core platform — Lyte + Alloy — is a shared execution fabric deployed across multiple domain-specific products: PRISM Counsel (legal operations), Vessels (maritime), Aegis (security and defense), and Terra (real estate).",
      },
      {
