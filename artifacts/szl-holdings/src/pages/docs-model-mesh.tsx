...
export default function DocsModelMeshPage() {
  const __pageMeta = usePageMeta({
    ...
    description: "Governed inference documentation: AI model routing, versioning, cost tracking, quality signals, and governance integration in the KORA + Counsel platform.",
          ...
          <section className="border-b border-white/10">
            <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8 lg:py-28">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/65">
                Governed inference is the AI model management layer of the KORA + Counsel platform. It handles
