...
const quarters = [
  {
    ...
    items: [
      ...
      { app: "SZL APEX", icon: Brain, color: "#8b5cf6", title: "GPU Monitoring + LLM Evaluation Studio", status: "done" },
      { app: "DOMAINE", icon: Building2, color: "#4d7c0f", title: "Distress Engine + Property Intelligence", status: "done" },
      { app: "Counsel", icon: Palette, color: "#6366f1", title: "Predictive Intelligence Engine + Confidence Scoring", status: "done" },
  ...
  },
  {
    ...
    items: [
      ...
      { app: "SZL APEX", icon: Brain, color: "#8b5cf6", title: "Ensemble Pipeline Studio + Multi-Model Comparison", status: "planned" },
      ...
      { app: "Counsel", icon: Palette, color: "#6366f1", title: "Scenario Model Library + Collaborative Workspace", status: "planned" },
    ],
  },
  {
    quarter: "Q3 2026",
    ...
    items: [
      ...
      { app: "SZL APEX", icon: Brain, color: "#8b5cf6", title: "Model Governance + Audit Trail for Regulated AI", status: "planned" },
    ],
  },
  {
    quarter: "Q4 2026",
...
export default function Roadmap() {
  const __pageMeta = usePageMeta({
    ...
    description: "The SZL Holdings platform roadmap: upcoming features, quarterly milestones, and product priorities across Counsel, KORA, SEXTANT, PARAGON, DOMAINE, SZL APEX, and Carlota Jo.",
