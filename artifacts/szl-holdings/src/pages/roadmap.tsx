...
export default function Roadmap() {
  const __pageMeta = usePageMeta({
    ...
    description: "The SZL Holdings platform roadmap: upcoming features, quarterly milestones, and product priorities across Counsel, Lyte, Vessels, Aegis, Terra, SZL APEX, and Carlota Jo.",
