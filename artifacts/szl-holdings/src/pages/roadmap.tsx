...
const quarters = [
  {
    ...
    items: [
      ...
      { app: "APEX", icon: Brain, color: "#8b5cf6", title: "GPU Monitoring + LLM Evaluation Studio", status: "done" },
  ...
  },
  {
    ...
    items: [
      ...
      { app: "APEX", icon: Brain, color: "#8b5cf6", title: "Ensemble Pipeline Studio + Multi-Model Comparison", status: "planned" },
  ...
  },
  {
    ...
    items: [
      ...
      { app: "APEX", icon: Brain, color: "#8b5cf6", title: "Model Governance + Audit Trail for Regulated AI", status: "planned" },
    ],
  },
  {
    quarter: "Q4 2026",
...
export default function Roadmap() {
  const __pageMeta = usePageMeta({
    ...
    description: "The SZL Holdings platform roadmap: upcoming features, quarterly milestones, and product priorities across FORGE, KORA, SEXTANT, PARAGON, DOMAINE, APEX, and Carlota Jo.",
