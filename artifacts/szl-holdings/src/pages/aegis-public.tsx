...
const WORKFLOW_STEPS = [
  ...
  },
  {
    ...
    body: "Remediation steps and response actions routed to the right analyst through FORGE with SLA tracking, escalation path, and full context. No raw alert dumps. Structured, prioritized action queues.",
  },
  {
    step: "05",
    label: "Traceability",
...
const CAPABILITIES = [
  ...
  { icon: Zap, title: "Incident Response Routing", body: "When a threat signal crosses threshold, FORGE routes the incident to the right analyst with full context, playbook reference, and human-gated approval chain ready." },
...
const ALLOY_INHERITED = [
  {
    ...
    description: "Every remediation action — patching, isolation, privilege revocation — requires analyst approval through FORGE's HITL gate before execution. No autonomous remediation.",
  },
  {
  ...
  },
  {
    ...
    description: "PARAGON integrates with SIEM, EDR, SOAR, and identity platforms through FORGE's connector layer — execution happens in existing tools without disruption.",
  },
  {
        ...
        <main id="main-content" >
              ...
              <div style={{ display: "grid", gap: "clamp(2.5rem,5vw,4rem)", alignItems: "start" }} className="lg:grid-cols-[1.2fr_0.8fr]">
                <m.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.05 }}>
                  ...
                  <p style={{ fontSize: "clamp(1rem,1.8vw,1.125rem)", lineHeight: 1.72, color: "hsl(214,7%,64%)", maxWidth: "50ch", marginBottom: "0.875rem" }}>
                    PARAGON gives security teams a command layer above their threat exposure. Threat Twin maps every CVE and identity signal to your actual environment. FORGE routes response through governed analyst workflows — with human approval at every consequential action.
                  </p>
              ...
              <div style={{ display: "grid", gap: "clamp(3rem,6vw,5rem)", alignItems: "start" }} className="lg:grid-cols-2">
                <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }}>
                  ...
                  <p style={{ fontSize: "0.9375rem", lineHeight: 1.70, color: "hsl(214,7%,62%)", maxWidth: "46ch", marginBottom: "1.25rem" }}>
                    Security operations is a domain drowning in signal volume and starved for structured action. The typical SIEM gives analysts raw alerts. The typical SOAR automates without sufficient human judgment. PARAGON applies FORGE's governed operating loop to the security workflow — so analysts act on context, not noise, and every action has a traceable record.
                  </p>
                  <p style={{ fontSize: "0.9375rem", lineHeight: 1.70, color: "hsl(214,7%,54%)", maxWidth: "46ch" }}>
                    The architecture mirrors Counsel's operating model: a structured threat object (Threat Twin), signal enrichment from authoritative intelligence sources, governed response routing through FORGE, and a compliance-ready audit footprint for every security decision.
                  </p>
                </m.div>
          ...
          <section style={{ borderBottom: "1px solid var(--color-szl-border)", padding: "var(--space-section-md) 0" }}>
            <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 var(--space-content-x)" }}>
              <m.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }}>
                <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.6875rem", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "hsl(222,60%,62%)", marginBottom: "1rem" }}>
                  What PARAGON Inherits from FORGE
                </p>
                ...
                <p style={{ fontSize: "0.9375rem", lineHeight: 1.70, color: "hsl(214,7%,58%)", maxWidth: "52ch", marginBottom: "2.5rem" }}>
                  PARAGON does not rebuild what FORGE already provides. Every capability below is inherited from the shared platform — the same infrastructure governing Counsel, SEXTANT, DOMAINE, and Carlota Jo.
                </p>
              </m.div>
                ...
                {[
                  {
                    ...
                    description: "Threat Twin model, signal integration schema, FORGE connector design, and compliance audit trail structure are defined.",
                  },
                  {
