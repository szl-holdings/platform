...
const UI_PRINCIPLES = [
  ...
  { title: "Color means something", body: "Green: confirmed / secure. Amber: attention required. Red: risk or failure. Lyte teal: observability signal. Counsel purple: execution. Do not use colors decoratively." },
