...
const SCENARIOS = [
  {
    ...
    allocations: [
      ...
      { name: "NEXUS", value: 24, color: "#a855f7", rationale: "Strong matter volume growth" },
      ...
      { name: "Terra", value: 8, color: "#6b9c30", rationale: "NEXUS synergy pipeline" },
  ...
  },
  {
    ...
    allocations: [
      ...
      { name: "NEXUS", value: 20, color: "#a855f7", rationale: "Consistent growth trajectory" },
  ...
  },
  {
    ...
    allocations: [
      ...
      { name: "Terra", value: 20, color: "#6b9c30", rationale: "Counsel litigation data feed" },
      { name: "NEXUS", value: 16, color: "#a855f7", rationale: "Terra distress data consumer" },
