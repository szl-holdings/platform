...
const SCENARIOS = [
  {
    ...
    allocations: [
      { name: "KORA", value: 32, color: "#38bee0", rationale: "Highest NRR + burn efficiency" },
      { name: "PRAXIS", value: 24, color: "#a855f7", rationale: "Strong matter volume growth" },
      { name: "SEXTANT", value: 20, color: "#3aa4dc", rationale: "Regulatory tailwind + maritime demand" },
      { name: "PARAGON", value: 12, color: "#6366f1", rationale: "Managed SOC bundle scaling" },
      { name: "DOMAINE", value: 8, color: "#6b9c30", rationale: "PRAXIS synergy pipeline" },
  ...
  },
  {
    ...
    allocations: [
      { name: "KORA", value: 26, color: "#38bee0", rationale: "Top performer — maintain momentum" },
      { name: "SEXTANT", value: 22, color: "#3aa4dc", rationale: "Market position defense" },
      { name: "PRAXIS", value: 20, color: "#a855f7", rationale: "Consistent growth trajectory" },
      { name: "PARAGON", value: 16, color: "#6366f1", rationale: "CAC improvement investment" },
      { name: "DOMAINE", value: 12, color: "#6b9c30", rationale: "Channel partnership enablement" },
