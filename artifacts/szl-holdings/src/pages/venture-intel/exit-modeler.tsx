...
const COMPANIES = [
    ...
    scenarios: [
      {
        ...
        rationale: "Operational intelligence category is hot M&A territory. KORA's NRR >124% and proprietary agent layer command premium multiples from strategic acquirers who need the workflow coverage KORA owns.",
      ...
      },
      {
        ...
        rationale: "At current trajectory, KORA hits the scale inflection point where institutional growth investors get competitive around Series C. The operational observability category comps warrant 25–35× forward ARR.",
  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        rationale: "PE roll-up of maritime tech is an emerging category. SEXTANT as platform acquisition, then bolt-on AIS, port, and freight assets. Exit via strategic sale in 5–7 year horizon.",
      ...
      },
      {
        ...
        rationale: "Longer path to IPO given category maturity and public market precedent. MarineTraffic/Kpler trajectory shows the category can reach $500M+ revenue at scale. SEXTANT at $50M+ ARR would be IPO-eligible.",
  ...
  },
  {
    ...
    scenarios: [
      {
        ...
        rationale: "Managed SOC is consolidating rapidly. PARAGON' maritime cyber specialization is a premium vertical that large MSSPs lack. Combined with SEXTANT maritime book, creates a defensible vertical MSSP.",
    ...
    recommendation: "Prioritize CAC reduction through SEXTANT cross-sell. Reach $15M ARR before pursuing strategic acquirer conversations. The maritime cyber vertical differentiation is the core exit value driver.",
  },
  {
    id: "prism",
    name: "PRAXIS",
    ...
    scenarios: [
      {
        ...
        rationale: "CoStar has acquisition mandate for specialized data layers. DOMAINE's ACRIS-linked distress intelligence is not replicable at CoStar's scale — it's more defensible than it appears. PropTech consolidation creates natural buyer universe.",
