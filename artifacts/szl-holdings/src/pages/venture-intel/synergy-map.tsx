...
const SYNERGIES = [
  ...
  },
  {
    ...
    mechanism: "DOMAINE automated distress classifier publishes events to shared FORGE event bus. PRAXIS matter intake agent evaluates eligibility and creates pre-qualified matter shells. Attorneys receive pre-populated intake with full property intelligence.",
  ...
  },
  {
    ...
    pipeline: "22 KORA enterprise clients are PARAGON-eligible by sector profile",
