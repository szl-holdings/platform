...
const SYNERGIES = [
  ...
  },
  {
    ...
    description: "DOMAINE's ACRIS-linked distress signal detection feeds PRAXIS's matter intake pipeline. When DOMAINE identifies a property in financial distress (foreclosure filings, tax lien escalation, ownership transfer under duress), PRAXIS receives a referral alert for potential litigation matter.",
    mechanism: "DOMAINE automated distress classifier publishes events to shared Counsel event bus. PRAXIS matter intake agent evaluates eligibility and creates pre-qualified matter shells. Attorneys receive pre-populated intake with full property intelligence.",
  ...
  },
  {
    ...
    mechanism: "KORA signals normalized through Counsel event bus. PARAGON SIEM ingests as custom telemetry feed. Joint clients get correlated view: business anomaly + security context in single interface.",
  ...
  },
  {
    ...
    description: "PRAXIS clients in regulated sectors (financial, maritime, healthcare) face increasing cybersecurity regulatory mandates. PRAXIS identifies compliance obligations during matter intake; PARAGON delivers the technical compliance solution. Legal identifies the need; security fills it.",
    mechanism: "PRAXIS compliance assessment flags cyber regulatory exposure. PARAGON receives warm referral with regulatory context pre-populated. Joint proposal developed with legal + technical remediation bundled.",
