...
const SYNERGIES = [
  ...
  },
  {
    ...
    description: "Terra's ACRIS-linked distress signal detection feeds PRISM's matter intake pipeline. When Terra identifies a property in financial distress (foreclosure filings, tax lien escalation, ownership transfer under duress), PRISM receives a referral alert for potential litigation matter.",
    mechanism: "Terra automated distress classifier publishes events to shared Alloy event bus. PRISM matter intake agent evaluates eligibility and creates pre-qualified matter shells. Attorneys receive pre-populated intake with full property intelligence.",
  ...
  },
  {
    ...
    mechanism: "Lyte signals normalized through Alloy event bus. Aegis SIEM ingests as custom telemetry feed. Joint clients get correlated view: business anomaly + security context in single interface.",
  ...
  },
  {
    ...
    description: "PRISM clients in regulated sectors (financial, maritime, healthcare) face increasing cybersecurity regulatory mandates. PRISM identifies compliance obligations during matter intake; Aegis delivers the technical compliance solution. Legal identifies the need; security fills it.",
    mechanism: "PRISM compliance assessment flags cyber regulatory exposure. Aegis receives warm referral with regulatory context pre-populated. Joint proposal developed with legal + technical remediation bundled.",
