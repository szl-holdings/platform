...
const SIGNALS = [
  {
    ...
    icon: Globe,
    date: "Apr 12, 2026",
    summary: "IMO Carbon Intensity Indicator ratings become enforceable in Q3 2026. SEXTANT with CII rating below 'C' face operational restrictions. Creates immediate demand for SEXTANT' voyage optimization and emissions reporting.",
    recommendation: "Accelerate SEXTANT enterprise sales motion targeting bulk carriers and tanker operators. Bundle PARAGON cyber compliance as regulatory package. Expected 18-month tailwind worth $8–12M incremental ARR.",
    confidence: 91,
  ...
  },
  {
    ...
    recommendation: "PRAXIS should add 'AI governance legal advisory' as discrete service line — warm market of 4,200 SEC-registered companies needing compliance counsel. KORA operational audit trails directly support client disclosure requirements.",
    confidence: 88,
  ...
  },
  {
    ...
    recommendation: "DOMAINE should position now for transaction volume surge. Build institutional buyer workflow that pre-indexes distressed properties at current valuations. Carlota Jo should accelerate estate acquisition advisory services for principals looking to deploy liquidity.",
    confidence: 74,
  ...
  },
  {
    ...
    recommendation: "PARAGON should launch a 'SOC Continuity Guarantee' positioning. Differentiate on managed human-in-the-loop escalation (vs. fully automated CrowdStrike). Target mid-market with 45-day pilot → annual contract motion.",
    confidence: 82,
  ...
  },
  {
    ...
    recommendation: "SEXTANT' AIS + ownership tracking is the highest-value product in this environment. Immediate outreach to compliance teams at major trading houses, refiners, and commodity desks. PARAGON should flag this to maritime insurer clients.",
    confidence: 96,
  ...
  },
  {
    ...
    recommendation: "PRAXIS should accelerate deals with Harvey or Ironclad customers whose renewal dates fall in the next 12 months. Position as 'stability alternative' during integration uncertainty. Prepare a 'migration from Harvey' playbook.",
    confidence: 68,
    responseWindow: "60 days",
  },
  {
