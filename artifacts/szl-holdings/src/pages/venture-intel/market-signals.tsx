...
const SIGNALS = [
  ...
  },
  {
    ...
    recommendation: "PRISM should add 'AI governance legal advisory' as discrete service line — warm market of 4,200 SEC-registered companies needing compliance counsel. KORA operational audit trails directly support client disclosure requirements.",
    confidence: 88,
