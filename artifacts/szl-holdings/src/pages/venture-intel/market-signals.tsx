...
const SIGNALS = [
  {
    ...
    impact: "Positive",
    impactColor: "#6aaa72",
    affectedCompanies: ["Vessels", "Aegis"],
  ...
  },
  {
    ...
    recommendation: "PRAXIS should add 'AI governance legal advisory' as discrete service line — warm market of 4,200 SEC-registered companies needing compliance counsel. Lyte operational audit trails directly support client disclosure requirements.",
    confidence: 88,
  ...
  },
  {
    ...
    impact: "Positive",
    impactColor: "#6aaa72",
    affectedCompanies: ["Terra", "Carlota Jo"],
