...
const brands = [
  ...
  {
    name: "Firestorm",
    role: "Cyber Defense Command",
    description: "Unified XDR, identity threat detection, adversary emulation, and SOC automation. The security command layer for high-stakes operational environments.",
    accent: "hsl(0,80%,55%)",
    status: "Live",
    href: "/firestorm/",
  },
  {
    name: "INCA",
    role: "Agentic Intelligence Cortex",
    description: "Structured visibility, explainable AI triage, and auditable decision workflows. The AI research and intelligence platform for teams that need to trust their models.",
  ...
  {
    name: "Terra",
    role: "Real Estate Intelligence Platform",
    description: "The full broker command surface for commercial real estate. Listings intelligence, inquiry routing, agent coordination, distress signals, and brokerage-level visibility — all unified.",
    accent: "hsl(30,55%,52%)",
    status: "Live",
    href: "/terra/",
  },
  {
    name: "Rosie",
    role: "Managed Services / Incident Command",
    description: "MSP operations command: SLA prediction, client health scoring, technician dispatch, and incident triage — built for managed service providers who operate at scale.",
...
const internal = [
  ...
  {
    name: "Alloy — Scenario Intelligence",
    role: "Internal / Alloy Capability",
    description: "Predictive scenario modeling and multi-horizon forecasting is an embedded capability within Alloy. Accessible through the Alloy platform interface.",
    accent: "hsl(214,80%,65%)",
  },
];
