          ...
          <section style={{ padding: "2rem 0 3rem" }}>
            <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
              <SectionHeader
                ...
                description="KORA is the flagship governed command surface — signal stream, situation board, governed action panel. Counsel is the execution fabric underneath every domain pack. SEXTANT is the first commercial domain pack, shown here alongside the core platform."
              />
