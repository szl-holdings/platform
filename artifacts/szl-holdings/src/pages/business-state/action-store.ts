...
import { POLL_INTERVAL_MS, STORE_KEY, STORE_URL, STREAM_URL } from './constants';
import type { ActionStore, ActionStorePatch } from './types';

export function emptyStore(): ActionStore {
  return {
    riskOwners: {},
    riskActions: {},
    oppDecisions: {},
