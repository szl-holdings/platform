...
const ATTRIBUTION = [
  ...
  { company: "PRISM Counsel", contribution: 4.8, type: "IRR Attribution (pp)" },
...
export default function BenchmarkingPage() {
  usePageMeta({ title: "Fund Benchmarking — SZL Fund Intelligence", description: "Cambridge Associates, PitchBook, and peer cohort comparison with PME calculations." });
          ...
          {tab === "attribution" && (
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-[#c8953c]/20 bg-[#c8953c]/[0.04] p-4">
                ...
                <p className="text-xs text-white/60">Lyte accounts for 32.4% of fund IRR contribution, driven by its Series B valuation mark at $148M. PRISM Counsel is the second-highest contributor despite being the newest investment — the RegulaAI strategic synergy is generating early outsized returns. Carlota Jo drag has been contained at 1.3pp through proactive intervention, compared to peer fund write-off average of 4.2pp at this stage.</p>
              </div>
            </div>
          )}
