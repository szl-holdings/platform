...
export default function CoInvestPage() {
  usePageMeta({ title: "Co-Investment & SPV Management — SZL Fund Intelligence", description: "SPV entity tracking, co-investor coordination, and automated documentation." });
