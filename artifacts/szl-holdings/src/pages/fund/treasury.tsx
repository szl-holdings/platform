...
const DISTRIBUTIONS = [
  { id: "d2", date: "Feb 28, 2026", amount: "$3.8M", type: "Realized proceeds — SZL APEX partial exit", status: "distributed" },
...
export default function TreasuryPage() {
  const __pageMeta = usePageMeta({ title: "Treasury & Cash Management — SZL Fund Intelligence", description: "Capital call optimization, distribution planning, and cash flow forecasting." });
