...
export default function LpCrmPage() {
  usePageMeta({ title: "LP Communication Intelligence — SZL Fund Intelligence", description: "Investor CRM with sentiment analysis, re-up scoring, and automated meeting prep." });
