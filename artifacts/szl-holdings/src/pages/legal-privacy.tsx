...
const SECTIONS = [
  {
    ...
    lines: [
      `SZL Holdings Ltd ("SZL Holdings", "we", "us", or "our") is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our websites, use our platforms (including Lyte, Alloy, Aegis, Terra, Vessels, and Counsel), or communicate with us.`,
