...
export type CapTableSummary = {
  ...
  shareClasses: Array<{
    ...
    liquidationPreferencePct: string | null;
    liquidationMultiple: string | null;
...
export type LpCapitalAccount = {
  ...
  managementFeesPaidCents: number;
  carriedInterestPaidCents: number;
  vintage: string | null;
  notes: string | null;
};
