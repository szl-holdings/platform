...
export const ALLOY_AGENTS: AgentDefinition[] = [
  {
    ...
    systemsConnected: ['Lyte', 'Vessels', 'Carlota Jo', 'External APIs'],
    status: 'active',
    icon: '📥',
    category: 'Processing',
  ...
  },
  {
    ...
    escalationMode: 'threshold',
    approvalRequired: false,
    systemsConnected: ['Lyte', 'Vessels', 'API Server'],
    status: 'active',
    icon: '📡',
  ...
  },
  {
    ...
    escalationMode: 'auto',
    approvalRequired: false,
    systemsConnected: ['Lyte', 'Carlota Jo', 'Admin Panel'],
    status: 'active',
    icon: '🔀',
  ...
  },
  {
    ...
    approvalRequired: false,
    systemsConnected: ['Lyte', 'Vessels', 'SZL APEX', 'Carlota Jo'],
    status: 'active',
    icon: '📋',
    category: 'Output',
  },
  {
    ...
    systemsConnected: ['Carlota Jo', 'Vessels', 'Lyte'],
    status: 'active',
    icon: '📄',
    category: 'Output',
  ...
  },
  {
    ...
    approvalRequired: true,
    systemsConnected: ['Lyte', 'Vessels', 'Aegis', 'Admin Panel'],
    status: 'active',
    icon: '⚠️',
    category: 'Control',
  },
  {
    ...
    escalationMode: 'threshold',
    approvalRequired: false,
    systemsConnected: ['Lyte', 'Vessels', 'Carlota Jo'],
    status: 'active',
    icon: '✅',
    category: 'Assessment',
  ...
  },
  {
    ...
    escalationMode: 'never',
    approvalRequired: false,
    systemsConnected: ['SZL APEX', 'Counsel KB', 'External APIs'],
    status: 'active',
    icon: '🔍',
