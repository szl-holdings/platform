...
export default function ContinuumMarketingLanding({ onSignIn }: { onSignIn?: () => void }) {
  return (
    <div
      style={{
        minHeight: '100vh',
    ...
    >
      ...
      >
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
          <div
            ...
            className="continuum-stats-grid"
          >
            {[
      ...
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.05)', padding: '3rem 1.5rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div
            ...
            className="continuum-footer-grid"
          >
            <div>
              <div
      ...
      <style>{`
        @media (min-width: 768px) {
          .continuum-nav-links { display: flex !important; }
        }
        @media (max-width: 768px) {
          .continuum-grid, .powers-grid, .outputs-grid, .gov-grid { grid-template-columns: 1fr !important; gap: 2rem !important; }
          .pipeline-grid { grid-template-columns: 1fr 1fr !important; }
          .continuum-stats-grid { grid-template-columns: 1fr 1fr !important; }
          .integrations-grid { grid-template-columns: 1fr !important; }
          .continuum-footer-grid { grid-template-columns: 1fr 1fr !important; gap: 2rem !important; }
        }
        @media (max-width: 480px) {
          .pipeline-grid { grid-template-columns: 1fr !important; }
          .continuum-stats-grid { grid-template-columns: 1fr 1fr !important; }
          .continuum-footer-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </div>
  );
