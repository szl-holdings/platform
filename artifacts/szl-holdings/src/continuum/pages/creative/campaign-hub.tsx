...
import { useCampaigns, useCreateCampaign } from '@/continuum/hooks/use-campaigns';
      ...
      >
        {campaigns?.map((campaign) => (
          <motion.div key={campaign.id} variants={item}>
            <Link href={`/continuum/creative/campaigns/${campaign.id}`} className="block group">
        ...
        >
          <div className="p-5 border border-white/8 bg-[#0d1117] rounded-xl">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/continuum/creative/content-calendar">
