...
const PRODUCT_INTEGRATIONS = [
  {
    ...
    accent: '#f59e0b',
    description:
      'Command feeds service health streams, alert data, and operational metrics into Continuum. Counsel returns structured insights, prioritised incidents, and recommended actions.',
  ...
  },
  {
    ...
    accent: '#f472b6',
    description:
      'Carlota Jo passes client requests, engagement data, and document requirements to Continuum. Counsel generates documents, manages approval flows, and routes operational tasks.',
