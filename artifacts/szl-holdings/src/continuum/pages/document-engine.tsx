...
export default function ContinuumDocumentEngine() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        {activeTab === 'documents' && (
          <DocumentEnginePanel appSource="continuum" accentColor="#06b6d4" className="h-full" />
        )}
        {activeTab === 'signing' && (
          <SigningDashboard appSource="continuum" accentColor="#06b6d4" className="h-full" />
        )}
        {activeTab === 'pdf-batch' && (
          <BatchPdfPanel appSource="continuum" accentColor="#06b6d4" className="h-full" />
        )}
      </div>
    </div>
  );
