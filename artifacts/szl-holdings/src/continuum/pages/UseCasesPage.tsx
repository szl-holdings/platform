...
export default function UseCasesPage() {
  ...
  const filtered =
    filter === 'All' ? ALLOY_USE_CASES : ALLOY_USE_CASES.filter((u) => u.category === filter);
    ...
    <div className="min-h-screen text-white px-6 py-16 max-w-6xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-white/50 max-w-2xl leading-relaxed">
          These are the specific operational problems Counsel solves across the SZL ecosystem —
          concrete use cases with defined inputs, Counsel's role, and measurable business impact.
        </p>
      </div>
