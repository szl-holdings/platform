  ...
  return (
    <div className="min-h-screen text-white px-6 py-16 max-w-6xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-4">What Counsel produces</h1>
        <p className="text-white/50 max-w-2xl leading-relaxed">
          Counsel outputs are structured, contextualised, and traceable. Every output type has a
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
        {[
          ...
          {
            label: 'With Approval Flow',
            value: ALLOY_OUTPUTS.filter((o) => o.approvalRequired).length.toString(),
          },
          ...
          >
            <div className="text-2xl font-bold mb-1" style={{ color: '#4B8BDB' }}>
              {stat.value}
            </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {output.approvalRequired ? (
                          <span className="text-[10px] px-1.5 py-0.5 rounded font-medium text-amber-400 bg-amber-400/10">
                            Approval required
                          </span>
                        ) : (
                          <span className="text-[10px] px-1.5 py-0.5 rounded font-medium text-emerald-400 bg-emerald-400/10">
                            No approval needed
                          </span>
                        )}
                      </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {output.connectedProducts.map((p) => (
                        <span key={p} className="text-[11px] px-2 py-0.5 rounded text-white/40">
                          {p}
                        </span>
                      ))}
                    </div>
