...
import { useAtlasApprovalsBadge } from '@/continuum/hooks/use-atlas-approvals-badge';
...
const SZL_ONBOARDING_CONFIG: OnboardingConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: 'Factory Floor',
      description:
        'Monitor all active automation runs in real time. See execution status, throughput metrics, and drill into any workflow for full trace visibility.',
      targetSelector: "a[href='/continuum']",
      placement: 'right',
    ...
    },
    {
      ...
      title: 'Signal Feed',
      description:
        'Every external event enters here — webhooks, API triggers, scheduled crons. Signals are routed through the governed decision loop before execution.',
      targetSelector: "a[href='/continuum/signals']",
      placement: 'right',
      icon: Radio,
    },
    {
      ...
      description:
        'Manage integrations with 60+ platforms. Each connector is health-monitored and governed by the same policy layer as your workflows.',
      targetSelector: "a[href='/continuum/connectors']",
      placement: 'right',
      icon: Network,
    },
    {
      ...
      description:
        'Every action leaves a proof chain. Review approval workflows, audit trails, and compliance attestations across all automation runs.',
      targetSelector: "a[href='/continuum/governance']",
      placement: 'right',
      icon: Shield,
    },
    {
  ...
  checklist: [
    {
      id: 'explore-factory',
      label: 'Open the Automation Console',
      description: 'View active automation runs and throughput',
    },
    {
      id: 'review-connectors',
      label: 'Review Connector Mesh',
      description: 'Check integration health and available connectors',
    },
    {
      id: 'browse-signals',
      label: 'Browse Signal Feed',
      description: 'See how external events trigger workflows',
    },
    {
      id: 'check-governance',
      label: 'Check Governance & Audit',
      description: 'Review the proof chain and approval logs',
    },
    {
      id: 'visit-domain',
...
const NAV = [
  { href: '/continuum/home', label: 'Workspace Home', icon: Home, badge: 'New' },
  { href: '/continuum', label: 'Automation Console', icon: LayoutDashboard, exact: true },
  { href: '/continuum/runs', label: 'Execution History', icon: Activity },
  { href: '/continuum/signals', label: 'Signal Feed', icon: Radio },
  { href: '/continuum/workflows', label: 'Workflow Orchestration', icon: GitBranch },
  { href: '/continuum/connectors', label: 'Connector Mesh', icon: Network },
  { href: '/continuum/governance', label: 'Governance & Audit', icon: Shield },
  { href: '/continuum/enterprise-governance', label: 'Enterprise Governance', icon: Lock },
  { href: '/continuum/analytics', label: 'Automation Analytics', icon: BarChart2 },
];

const ATLAS_NAV = [
  { href: '/continuum/operator-approvals', label: 'Operator Approvals', icon: Shield, badge: 'Live' },
  { href: '/continuum/atlas-approvals', label: 'ATLAS Approvals', icon: GitBranch, badge: 'New' },
];

const COMMAND_NAV = [
  { href: '/continuum/decisions', label: 'Decision Objects', icon: Brain, badge: 'New' },
  { href: '/continuum/skills', label: 'Capability Library', icon: Layers, badge: 'New' },
  { href: '/continuum/operator', label: 'Agent Control', icon: Shield, badge: 'New' },
];

const CREATIVE_NAV = [
  { href: '/continuum/creative', label: 'Campaign Hub', icon: Film },
  { href: '/continuum/creative/brand-voice', label: 'Brand Voice', icon: Mic },
  { href: '/continuum/creative/content-calendar', label: 'Content Calendar', icon: Calendar },
  { href: '/continuum/creative/ai-studio', label: 'AI Studio', icon: Wand2 },
];

const DOCS_NAV = [{ href: '/continuum/documents', label: 'Document Engine', icon: FileText }];

const INTELLIGENCE_NAV = [
  { href: '/continuum/research', label: 'Research Mode', icon: BookOpen },
  { href: '/continuum/artifacts', label: 'Artifact Studio', icon: Layers },
  { href: '/continuum/browser', label: 'Web Automation', icon: Globe },
];

const PRAXIS_EXCHANGE_NAV = [
  { href: '/continuum/intelligence-exchange', label: 'Intelligence Exchange', icon: BarChart3, badge: 'New' },
];

const ENTERPRISE_NAV = [
  { href: '/continuum/policies', label: 'Policy Manager', icon: Lock, badge: 'New' },
  { href: '/continuum/admin-analytics', label: 'Admin Analytics', icon: BarChart2, badge: 'New' },
  { href: '/continuum/usage', label: 'Usage Metering', icon: DollarSign, badge: 'New' },
  { href: '/continuum/demos', label: 'Reference Demos', icon: Play, badge: 'New' },
  { href: '/continuum/pilot', label: 'Pilot Onboarding', icon: Star, badge: 'New' },
];
...
const MCP_NAV = [
  { href: '/continuum/mcp-store', label: 'MCP Marketplace', icon: Store, badge: 'New' },
  { href: '/continuum/mcp-tools', label: 'Custom Tool Creator', icon: Code2, badge: 'New' },
];
...
function NavItem({
  ...
  return (
    <Link
      ...
      style={{
        background: isActive ? 'rgba(75,139,219,0.08)' : undefined,
        color: isActive ? '#4B8BDB' : undefined,
      }}
    >
      {isActive && (
        <div
      ...
      <Icon
        ...
        style={isActive ? { color: '#4B8BDB' } : undefined}
      />
      ...
      {showCount && (
        <span
          ...
          style={{
            color: '#fff',
            background: '#f59e0b',
            boxShadow: pulse ? '0 0 0 0 rgba(245,158,11,0.6)' : undefined,
          }}
...
const ALLOY_SLASH_COMMANDS: CommandItem[] = [
  {
    id: 'slash-workflow',
    label: '/workflow',
    description: 'Open Workflow Orchestration',
    icon: '⬡',
  ...
  },
  {
    ...
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['approve', 'governance', 'review'],
    action: () => {},
  },
  {
    id: 'slash-signals',
    label: '/signals',
    description: 'Open Signal Feed',
    icon: '◇',
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['signals', 'feed', 'events'],
    action: () => {},
  },
  {
    id: 'slash-runs',
    ...
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['runs', 'history', 'execution'],
    action: () => {},
  },
  {
    id: 'slash-analytics',
    label: '/analytics',
    description: 'Open Automation Analytics',
    icon: '▤',
    group: 'Slash Commands',
    isSlashCommand: true,
  ...
  },
  {
    id: 'slash-decisions',
    label: '/decisions',
    description: 'Open Decision Objects',
    icon: '◎',
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['decisions', 'ai', 'intelligence'],
    action: () => {},
  },
  {
    id: 'slash-skills',
    label: '/skills',
    description: 'Open Capability Library',
    icon: '◈',
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['skills', 'registry', 'capabilities'],
    action: () => {},
  },
  {
    id: 'slash-operators',
    label: '/operators',
    description: 'Open Agent Control Center',
    icon: '□',
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['operator', 'agents', 'control'],
    action: () => {},
  },
  {
    id: 'slash-connectors',
    label: '/connectors',
    description: 'Open Connector Mesh',
    icon: '⊕',
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['connectors', 'integrations', 'mesh'],
    action: () => {},
  },
  {
    id: 'slash-docs',
    label: '/docs',
    description: 'Open Document Engine',
    icon: '▭',
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['docs', 'documents', 'files'],
    action: () => {},
  },
  {
    id: 'slash-home',
    label: '/home',
    description: 'Workspace Home & Priority Dashboard',
    icon: '◉',
    group: 'Slash Commands',
    isSlashCommand: true,
    keywords: ['home', 'workspace', 'priority'],
    action: () => {},
  },
];

const SLASH_TO_NAV: Record<string, string> = {
  'slash-workflow': '/continuum/workflows',
  'slash-approve': '/continuum/governance',
  'slash-signals': '/continuum/signals',
  'slash-runs': '/continuum/runs',
  'slash-analytics': '/continuum/analytics',
  'slash-decisions': '/continuum/decisions',
  'slash-skills': '/continuum/skills',
  'slash-operators': '/continuum/operator',
  'slash-connectors': '/continuum/connectors',
  'slash-docs': '/continuum/documents',
  'slash-home': '/continuum/home',
};

function buildContinuumCommands(navigate: (path: string) => void): CommandItem[] {
  const cmds: CommandItem[] = [];
  for (const { items, group } of ALL_NAV_SECTIONS) {
    for (const item of items) {
      cmds.push({
        id: `continuum-nav-${item.href}`,
        label: item.label,
        icon: undefined,
        group,
        keywords: ['continuum', item.label.toLowerCase()],
  ...
  cmds.push(...getEcosystemSwitchCommands('continuum'));
  return cmds;
}

export function ContinuumLayout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    async function loadWorkflows() {
      try {
        const res = await fetch('/api/continuum/workflows?limit=20');
        if (!res.ok) return;
        const json = await res.json();
        const list: Array<{ id: number; name: string; status: string }> = Array.isArray(json)
          ? json
          : (json?.data ?? []);
        if (!cancelled) {
          setWorkflowCmds(
  ...
  const alloyNavCmds = buildContinuumCommands(navigate);
    ...
    <div className="flex h-full overflow-hidden">
      ...
      >
        <div className="border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <Link
            href="/"
            className="flex items-center gap-1.5 px-4 py-1.5 text-[10px] hover:bg-white/5 transition-colors"
          ...
          <div className="h-10 flex items-center px-4">
            <div className="flex items-center gap-2.5">
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, #4B8BDB, #0090cc)',
                  boxShadow: '0 0 12px rgba(75,139,219,0.3)',
                }}
              >
            ...
            {COMMAND_LOOP.map((p, i) => (
              <div key={p.phase} className="flex items-center gap-1">
                {p.link ? (
                  <a
                    href={p.link}
                    className="text-[8px] font-bold uppercase tracking-widest px-1.5 py-0.5 rounded transition-all hover:opacity-80"
                    style={{
        ...
        <div className="flex-1 min-h-0 flex flex-col">
          <nav className="flex-1 min-h-0 px-2 py-3 flex flex-col gap-0.5 overflow-y-auto">
            <div
              className="text-[9px] uppercase tracking-widest px-3 mb-1 font-medium"
            ...
            <div
              ...
              style={{ color: 'rgba(139,122,200,0.7)' }}
            >
              ATLAS Spatial
            </div>
            {ATLAS_NAV.map((item) => {
              const isAtlasApprovals = item.href === '/continuum/atlas-approvals';
              return (
                <NavItem
                  key={item.href}
                  {...item}
          ...
          <div
            className="mt-auto shrink-0 px-3 py-3 mx-2 mb-2 rounded-lg"
            style={{
          ...
          >
            <div
              ...
              style={{ color: 'rgba(75,139,219,0.4)' }}
            >
              Runtime Health
            </div>
            <div className="space-y-1.5">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-[9px] font-mono" style={{ color: '#4B8BDB' }}>
                  14 running
                </span>
              </div>
              <div className="flex items-center justify-between">
            ...
            >
              <div
                ...
                style={{ width: '72%', background: 'linear-gradient(90deg, #4B8BDB, #10b981)' }}
              />
            </div>
        ...
        <div className="p-3 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <div className="flex gap-1 flex-wrap">
            <a
              href="/terra/"
              className="text-[9px] px-1.5 py-0.5 rounded font-medium hover:opacity-80"
              style={{
                color: '#4d7c0f',
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          <div className="flex items-center gap-3 text-xs font-mono">
            ...
            <span
              className="w-1.5 h-1.5 rounded-full animate-pulse hidden sm:block"
              style={{ background: '#4B8BDB' }}
            />
            <span className="hidden sm:block" style={{ color: '#4B8BDB' }}>
              14 Active Runs
            </span>
            <span className="hidden sm:block" style={{ color: 'rgba(255,255,255,0.15)' }}>
              ·
            </span>
            ...
            <span className="hidden sm:block" style={{ color: '#ef4444' }}>
              2 Failed
            </span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <div className="text-right">
                ...
                <div className="text-[10px]" style={{ color: 'rgba(75,139,219,0.7)' }}>
                  SZL Holdings
                </div>
              </div>
              <div
