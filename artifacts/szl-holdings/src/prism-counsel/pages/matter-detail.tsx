...
import {
  ...
  Scale, ChevronRight, ExternalLink
} from "lucide-react";
...
export default function MatterDetailPage({ id }: { id: number }) {
  ...
  const matter = DEMO_MATTERS.find(m => m.id === id);
    ...
    <div className="p-6 max-w-[1400px] mx-auto space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="col-span-2">
          ...
          {activeTab === "communications" && <CommsTab matter={matter} />}
...
function SummaryTab({ matter }: { matter: typeof DEMO_MATTERS[0] }) {
  return (
    <div className="space-y-3">
...
function TimelineTab({ matter }: { matter: typeof DEMO_MATTERS[0] }) {
  const events = [
...
function DamagesTab({ matter }: { matter: typeof DEMO_MATTERS[0] }) {
...
function MedicalTab({ matter }: { matter: typeof DEMO_MATTERS[0] }) {
...
function ForecastTab({ matter }: { matter: typeof DEMO_MATTERS[0] }) {
  return (
    <div className="space-y-3">
      <div className="rounded-lg border border-white/[0.06] p-4" style={{ background: "#0c1220" }}>
...
function CommsTab({ matter }: { matter: typeof DEMO_MATTERS[0] }) {
  return (
    <div className="rounded-lg border border-white/[0.06] p-4" style={{ background: "#0c1220" }}>
...
function ApprovalsTab({ matter }: { matter: typeof DEMO_MATTERS[0] }) {
  return (
    <div className="rounded-lg border border-white/[0.06] p-4" style={{ background: "#0c1220" }}>
