...
export const ventures: Venture[] = [
  ...
  },
  {
    ...
    milestones: [
      ...
      {
        date: 'Q3 2024',
        event: 'Predictive intelligence unified into Alloy — full engine convergence',
      },
    ],
    caseStudies: [
      {
        ...
        solution:
          "Alloy's predictive engine modeled each scenario with confidence bounds, assumption tracking, and automated sensitivity analysis.",
