...
export const ventures: Venture[] = [
  ...
  },
  {
    id: "dreamscape",
    name: "Nimbus",
    tagline: "Predictive Intelligence — UNDERSTAND Layer",
    oneLiner: "Prediction, scenario modeling, and confidence scoring powering the UNDERSTAND layer of the SZL intelligence doctrine.",
    audience: "Enterprise strategists, data science teams, and decision-makers requiring probabilistic intelligence at scale.",
    category: "Predictive Intelligence",
    status: "Live",
    accentColor: "#a855f7",
    description:
      "Nimbus is the UNDERSTAND layer of the SZL intelligence doctrine — converting raw signals from OBSERVE into probabilistic predictions, scenario models, and confidence scores. It powers cross-ecosystem decision intelligence with model-backed outputs.",
    painSolved:
      "Decision-makers get data but not answers. Nimbus closes the gap between observation and decision by providing confidence-scored predictions and scenario models that survive contact with real uncertainty.",
    metrics: [
      ...
      { label: "Avg Prediction Latency", value: "< 200ms", trend: "up" },
    ],
    milestones: [
      { date: "Q4 2022", event: "Prediction studio launched" },
      { date: "Q2 2023", event: "Confidence scoring module released" },
      { date: "Q1 2024", event: "85+ enterprise clients milestone" },
      { date: "Q3 2024", event: "Scenario modeling v2 shipped" },
    ],
    caseStudies: [
      {
        ...
        solution: "Nimbus modeled each scenario with confidence bounds, assumption tracking, and automated sensitivity analysis.",
    ...
    useCases: [
      ...
      "AI-backed decision briefing generation",
      "Cross-ecosystem signal synthesis",
      "Performance analytics and model attribution",
    ],
    capabilities: [
      "Generative prediction suite: scenario, forecast, sensitivity",
      "Confidence scoring with uncertainty quantification",
      "Automated assumption extraction and tracking",
      "Real-time collaboration workspace",
      "Performance attribution per model variant",
      "Integration with INCA, Beacon, and Aegis",
    ],
    nextMilestone: "Scenario Model Library public launch (Q2 2026)",
