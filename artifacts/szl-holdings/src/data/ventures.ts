...
export const ventures: Venture[] = [
  {
    ...
    oneLiner: "Business observability command center that converts operational signals into prioritized, explainable decisions.",
  ...
  },
  {
    ...
    oneLiner: "Commercial real estate analytics with climate risk overlays, AI valuations, and portfolio performance intelligence.",
    audience: "Institutional fund managers, CRE operators, and investment teams managing multi-asset portfolios.",
    category: "Real Estate Tech",
    status: "Live",
    accentColor: "#10b981",
    description:
      "Terra gives CRE investment teams and operators the intelligence layer they're missing. It combines AI-powered property valuations, climate risk scoring, market trend signals, and portfolio performance analytics into one platform — replacing fragmented data sources with a single point of truth.",
    painSolved:
      "CRE investment teams are making billion-dollar decisions on fragmented data. Terra consolidates market signals, climate exposure, and portfolio metrics so investment committees have complete context — not a patchwork of reports.",
    metrics: [
      { label: "Enterprise CRE Clients", value: "34", trend: "up" },
      { label: "ARR", value: "$3.1M", trend: "up" },
      { label: "Portfolio Assets Under Analysis", value: "$4.2B+", trend: "up" },
      { label: "Addressable Market", value: "$12.4B", trend: "up" },
    ],
    milestones: [
      { date: "Q3 2022", event: "Property intelligence engine launched" },
      { date: "Q2 2023", event: "Climate risk overlay released" },
      { date: "Q1 2024", event: "AI valuation suite launched" },
      { date: "Q4 2024", event: "Institutional fund manager partnership program launched" },
    ],
    caseStudies: [
      {
        title: "Portfolio Climate Exposure Audit",
        problem: "An institutional manager needed to assess climate risk across a 140-asset CRE portfolio for a regulatory disclosure.",
        solution: "Terra ran a full climate overlay across the portfolio in 48 hours — flood, heat, and transition risk scored per asset.",
    ...
    capabilities: [
      "AI valuation engine trained on 40M+ property data points",
    ...
    nextMilestone: "Platform license deals with institutional fund managers (Q2 2026)",
    path: "/ventures/terra",
    externalPath: "/terra/",
  },
  {
    id: "dreamscape",
    name: "Dreamscape",
    tagline: "AI Creative Production Engine",
    oneLiner: "Enterprise creative production platform combining generative AI, real-time collaboration, and automated asset pipelines.",
    audience: "Studios, agencies, brands, and media teams producing content at enterprise scale.",
    category: "Creative Tech",
    status: "Live",
    accentColor: "#a855f7",
    description:
      "Dreamscape is the production infrastructure for creative teams that need to scale output without scaling headcount. It combines generative AI, brand intelligence, and automated pipeline management into a single platform — enabling broadcast-quality creative production at 10x traditional velocity.",
    painSolved:
      "Creative production is the last enterprise vertical that still runs on disconnected tools, email, and manual handoffs. Dreamscape gives teams a unified production layer: from brief to delivery, with AI assist at every step.",
    metrics: [
      { label: "Projects Delivered", value: "12,400+", trend: "up" },
      { label: "Enterprise Clients", value: "85+", trend: "up" },
      { label: "ARR", value: "$5.1M", trend: "up" },
      { label: "Avg Production Velocity", value: "10x vs. traditional", trend: "up" },
    ],
    milestones: [
      { date: "Q4 2022", event: "AI studio production layer launched" },
      { date: "Q2 2023", event: "Brand intelligence module released" },
      { date: "Q1 2024", event: "85+ enterprise clients milestone" },
      { date: "Q3 2024", event: "Automated asset pipeline v2 shipped" },
    ],
    caseStudies: [
      {
        title: "Campaign Production at 10x Velocity",
        problem: "A media company producing 200+ assets per campaign was bottlenecking at the creative review and versioning stage.",
        solution: "Dreamscape automated versioning, AI-assisted review routing, and brand compliance checks into a single workflow.",
        result: "Campaign production time dropped from 3 weeks to 4 days. Client satisfaction score: 96%.",
      },
    ],
    useCases: [
      "Campaign production and asset management",
      "AI studio: generative image, video, and copy",
      "Brand intelligence and compliance automation",
      "Content calendar and approval workflow",
      "Cross-team real-time collaboration",
      "Performance analytics and creative attribution",
    ],
    capabilities: [
      "Generative AI suite: image, video, copy, voice",
      "Brand intelligence layer with style enforcement",
      "Automated asset pipeline with version management",
      "Real-time collaboration workspace",
      "Performance attribution per creative variant",
      "Integration with Adobe, Figma, and major DAM platforms",
    ],
    nextMilestone: "Media and entertainment enterprise expansion (Q2 2026)",
    path: "/ventures/dreamscape",
    externalPath: "/dreamscape/",
  },
  {
    id: "msp",
    name: "Evolve MSP",
    tagline: "Managed IT Services at Enterprise Depth",
    oneLiner: "Full-stack managed service provider platform for multi-client IT management, NOC operations, and service delivery.",
    audience: "MSPs, mid-market enterprises, and IT operators managing multi-tenant service environments.",
    category: "Managed Services",
    status: "Live",
    accentColor: "#06b6d4",
    description:
      "Evolve MSP gives managed service providers and enterprise IT teams the full operational stack: client management, NOC, service desk, billing, and performance analytics — integrated into a single command center instead of fragmented across 8 tools.",
    painSolved:
      "MSPs are operating on stacks of disconnected tools: RMM, PSA, ticketing, billing, and reporting all live separately. Evolve MSP consolidates the core operational layer so MSPs can scale clients without scaling headcount.",
    metrics: [
    ...
    caseStudies: [
      {
        title: "MSP Client Scaling Without Headcount Growth",
        ...
        solution: "Evolve MSP consolidated 6 tools into one, with AI-assisted triage reducing L1 ticket volume by 34%.",
