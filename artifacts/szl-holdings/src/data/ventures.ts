...
export const ventures: Venture[] = [
  {
    ...
    metrics: [
      {
        ...
        value: metricDisplay(LYTE_SIGNAL_DETECTION_TIME),
        trend: 'up',
      },
    ...
    milestones: [
      {
        date: 'Q1 2024',
        event: 'Core signal engine launched',
        outcome: 'Detection latency under 4 minutes',
      },
      {
        date: 'Q3 2024',
        event: 'Explainability framework deployed',
        outcome: 'Human-readable root cause context',
      },
      {
        date: 'Q1 2025',
        event: 'Autonomous playbook library shipped',
        outcome: '120+ pre-built resolution paths',
      },
      {
        date: 'Q4 2025',
        event: 'Executive command view launched',
        outcome: 'Role-based live ops intelligence',
      },
    ],
    caseStudies: [
      {
  ...
  },
  {
    ...
    audience:
      'Commodity traders, shipping operators, port authorities, financial institutions with maritime exposure.',
    ...
    metrics: [
      ...
      { label: 'Shipping Lanes', value: '340+', trend: 'neutral' },
      {
        ...
        value: metricDisplay(VESSELS_DARK_DETECTION_LEAD),
        trend: 'up',
      },
    ...
    milestones: [
      {
        date: 'Q2 2023',
        event: 'AIS ingestion layer live',
        outcome: '52K vessel baseline tracking',
      },
      { date: 'Q4 2023', event: 'Sanctions reconciliation engine deployed' },
      {
        date: 'Q2 2024',
        event: 'Dark vessel behavioral model shipped',
        outcome: '34-day avg pre-designation detection',
      },
      {
        date: 'Q1 2025',
        event: 'Voyage economics layer launched',
        outcome: 'Draft-based cargo inference at scale',
      },
    ],
    caseStudies: [
      {
  ...
  },
  {
    ...
    oneLiner:
      'Discreet, high-trust lifestyle management and estate support for principals who expect the exceptional.',
    audience:
      'Ultra-high-net-worth individuals, family offices, and principals requiring end-to-end lifestyle infrastructure.',
    category: 'Consulting',
    status: 'Pilot Ready',
    accentColor: '#d97706',
    description:
    ...
    milestones: [
      {
        date: 'Q3 2024',
        event: 'Service architecture defined',
        outcome: '12-domain framework built',
      },
    ...
    caseStudies: [
      {
        ...
        problem:
          'A principal relocating between three residences across two continents had no unified coordination layer.',
        solution:
          'Carlota Jo built a full estate activation plan, coordinating 14 vendors, 6 household staff, and cross-border logistics.',
        result:
          "Principal described the transition as 'invisible.' Zero coordination gaps across 90-day relocation.",
      },
    ],
    useCases: [
  ...
  },
  {
    ...
    audience:
      'Enterprise CISOs, defense contractors, government agencies, and compliance-driven security teams.',
    ...
    milestones: [
      ...
      {
        date: 'Q3 2023',
        event: 'Adaptive campaign generator deployed',
        outcome: 'RL-based attack path adaptation',
      },
  ...
  },
  {
    ...
    audience:
      'AI/ML teams, enterprise AI governance officers, and research organizations deploying models at scale.',
    category: 'AI / ML',
    status: 'Live',
    accentColor: '#8b5cf6',
    description:
  ...
  },
  {
    ...
    audience:
      'Enterprise architects, platform teams, and operators deploying automated workflows at scale.',
    category: 'Command Systems',
    status: 'Live',
    accentColor: '#6366f1',
    description:
      'Counsel is the execution fabric of the SZL platform — orchestrating connectors, DAGs, automations, and the predictive intelligence layer into a unified engine. It is not a product sold standalone; it is the platform backbone that KORA, SEXTANT, and every SZL subsidiary runs on.',
    painSolved:
  ...
  },
  {
    ...
    audience:
      'MSPs, enterprise IT operators, and security teams managing multi-tenant threat environments.',
