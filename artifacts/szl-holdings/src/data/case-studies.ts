...
export const caseStudies: CaseStudy[] = [
  {
    ...
    sections: {
      ...
      systemBuilt:
        "KORA was configured to ingest approval events across procurement (Coupa), legal (Matter), and finance (NetSuite) using FORGE connectors. The signal normalization layer identified ownership gaps — approvals sitting with no acknowledged owner for >24 hours. KORA's action routing engine escalated the stalled contract renewals to the VP Finance and flagged it in the Command Inbox with a revenue impact estimate.",
      howItWorked: [
        'FORGE connectors pulled approval state from Coupa and Matter every 15 minutes',
  ...
  },
  {
    ...
    subtitle:
      'How FORGE eliminated coordination overhead across procurement, legal, and operations',
    sections: {
      problem:
