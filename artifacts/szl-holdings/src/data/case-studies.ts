...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    subtitle: "How Lyte eliminated the coordination overhead that turns containable incidents into enterprise crises",
    sections: {
      problem: "A design partner scenario: a mid-market financial services firm experiences a suspected data exfiltration event at 3 AM. The IR process requires notifying legal, triggering the CISO escalation chain, engaging an external forensics vendor, and filing a preliminary incident report — all before a single remediation action is authorized. The coordination overhead routinely added 4–6 hours to time-to-containment. By then, the damage was done.",
      context: "Security incident response is not primarily a technical problem — it is a coordination and accountability problem. The detection tooling usually identifies the event quickly. What breaks down is: who has decision authority, what the notification sequence is, which vendor to engage, and who documents the chain of custody for the eventual regulatory filing. Each of those steps involves people who don't work from the same toolchain and don't have the same access to the incident timeline.",
      constraints: [
  ...
  },
  {
    ...
    sections: {
      ...
      outcome: "Zero detention. The deficiency was identified and corrected 11 days before inspection. Estimated detention avoided: $110,000 per day (charter rate + port fees). The same autonomous scan identified 3 additional pre-risk items across the other 13 vessels in the fleet — all resolved before their respective inspection windows. Fleet PSC detention rate for the year: 0%.",
      visualProof: [
  ...
  },
  {
    ...
    sections: {
      ...
      systemBuilt: "Terra was configured with a distress signal model that combined: property tax delinquency (county records integration), utility disconnection notices (state utility registry), insurance policy lapse indicators (commercial property database), maintenance permit inactivity (building department records), and rental market price deviation (listed rent vs. market comp). The multi-signal distress score for the target property crossed the 85/100 threshold 22 days before the foreclosure filing was recorded — Terra issued a high-priority acquisition opportunity alert to the investment committee.",
      howItWorked: [
      ...
      outcome: "LOI signed 8 days after foreclosure filing — but the negotiating position was established 12 days before the filing, when the GP was still open to a private sale. Final acquisition at 18% discount to estimated market value. The investment committee later calculated that acquiring through the public foreclosure process would have cost $3.2M more and taken 4–6 months longer to close.",
      visualProof: [
