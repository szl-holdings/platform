...
export const caseStudies: CaseStudy[] = [
  {
    ...
    sections: {
      ...
      systemBuilt:
        "Lyte was configured to ingest approval events across procurement (Coupa), legal (Matter), and finance (NetSuite) using Counsel connectors. The signal normalization layer identified ownership gaps — approvals sitting with no acknowledged owner for >24 hours. Lyte's action routing engine escalated the stalled contract renewals to the VP Finance and flagged it in the Command Inbox with a revenue impact estimate.",
      howItWorked: [
