...
export const DECISION_CASES: DecisionCase[] = [
  {
    ...
    recommendation: {
      ...
      body:
        "Sever northbound traffic from the partner port-edge bastion, raise berth-clearance hold on tanker IMO-9837442 until AIS reconciliation completes, and escalate to SOC Lead for human-in-loop approval.",
      confidence: 0.94,
    ...
    proof: {
      ...
      policyChecks: [
        ...
        { label: "Review state: must be human_reviewed before export", passed: false, note: "Awaiting reviewer sign-off" },
        { label: "Export safety: no PII in output", passed: true },
      ],
      chainLinks: [
        { id: "c1", event: "Signal ingested from Aegis threat feed", actor: "System / Prism Bus", timestamp: "19 Apr 2026 08:14:22", hash: "sha256:a3f7b2c1d…" },
        { id: "c2", event: "Cross-domain correlation with Vessels AIS", actor: "System / Signal Fusion", timestamp: "19 Apr 2026 08:14:24", hash: "sha256:9e1d4f2a8…" },
        { id: "c3", event: "AI recommendation generated", actor: "Model: gpt-4o-mini", timestamp: "19 Apr 2026 08:14:27", hash: "sha256:b4e8f3c6d…" },
        { id: "c4", event: "Policy gate evaluated — approval required", actor: "System / Covenant Policy", timestamp: "19 Apr 2026 08:14:29", hash: "sha256:c2a9d1f7e…" },
      ],
      metadata: {
  ...
  },
  {
    ...
    recommendation: {
      ...
      body:
        "Place a tier-2 bid at ZAR 15.5M conditional on a 72-hour legal title review through PRISM Counsel. Reserve secondary capital line for top-up if title is clean.",
      confidence: 0.81,
    ...
    proof: {
      ...
      policyChecks: [
        ...
        { label: "PRISM Counsel matter: not yet opened", passed: false, note: "Will be opened on approval" },
        { label: "CFO sign-off: not required at this size", passed: true },
      ],
      chainLinks: [
        { id: "c1", event: "Distress signal ingested", actor: "System / Terra Beacon", timestamp: "18 Apr 2026 11:02:18", hash: "sha256:7c1a9d…" },
        { id: "c2", event: "Comp band correlation", actor: "System / Capital Engine", timestamp: "18 Apr 2026 11:02:21", hash: "sha256:5e9b3f…" },
        { id: "c3", event: "Recommendation generated", actor: "Model: gpt-4o", timestamp: "18 Apr 2026 11:02:25", hash: "sha256:1f4a6c…" },
      ],
      metadata: {
  ...
  },
  {
    ...
    recommendation: {
      ...
      body:
        "Open a regulatory matter with 72-hour clock, draft data subject notice template, and freeze vendor contract amendments until breach scope is confirmed.",
      confidence: 0.88,
    ...
    proof: {
      ...
      chainLinks: [
        { id: "c1", event: "Vendor breach notice ingested", actor: "System / Intake Channel", timestamp: "17 Apr 2026 14:48:02", hash: "sha256:2b7e9a…" },
        { id: "c2", event: "Recommendation generated", actor: "Model: claude-sonnet-4", timestamp: "17 Apr 2026 14:48:09", hash: "sha256:4d8c1f…" },
        { id: "c3", event: "Counsel Lead approved", actor: "L. Nkosi", timestamp: "17 Apr 2026 15:12:44", hash: "sha256:9a3e7b…" },
        { id: "c4", event: "Workflow dispatched", actor: "System / Workflow Mesh", timestamp: "17 Apr 2026 15:13:01", hash: "sha256:6f1d2c…" },
      ],
      metadata: {
        "Vendor": "Northwind Data Services",
