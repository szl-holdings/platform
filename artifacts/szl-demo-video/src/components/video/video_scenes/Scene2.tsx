...
export function Scene2() {
  ...
  const surfaces = [
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden flex flex-col">
          <div className="h-[2vh] w-full bg-[var(--color-border)] flex items-center px-[1vw]">
            <span className="font-mono text-[0.5vw] tracking-widest text-[var(--color-warning)]">
              CONFIDENTIAL // PRINCIPAL EYES ONLY
            </span>
          </div>
          <div className="p-[2vw] flex flex-col gap-[2vh]">
            ...
            <h2 className="font-display text-[1.8vw] text-[var(--color-text-primary)] leading-tight">
              Sanctioned crude tanker enters Persian Gulf shadow corridor; counterparty exposure
              spans 3 portfolio entities.
            </h2>
            <div className="flex gap-[0.5vw]">
              <span className="font-mono text-[0.6vw] px-[0.8vw] py-[0.4vh] rounded-full border border-[var(--color-critical)] text-[var(--color-critical)] bg-[var(--color-critical)]/10">
                HIGH 0.87
              </span>
              <span className="font-mono text-[0.6vw] px-[0.8vw] py-[0.4vh] rounded-full border border-[var(--color-warning)] text-[var(--color-warning)] bg-[var(--color-warning)]/10">
                MODERATE 0.62
              </span>
            </div>
            <div className="font-mono text-[0.6vw] text-[var(--color-text-muted)] mt-[2vh]">
              trc_9X2M4K8L1P0R5T
            </div>
          </div>
        </div>
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="flex justify-between items-start border-b border-[var(--color-border)] pb-[1.5vh] mb-[1.5vh]">
            <div>
              <div className="font-mono text-[0.8vw] text-[var(--color-vessels)] mb-[0.5vh]">
                IMO 9821045
              </div>
              <div className="font-display text-[2vw] text-[var(--color-text-primary)]">
                PACIFIC MERIDIAN
              </div>
              <div className="font-mono text-[0.7vw] text-[var(--color-text-muted)] mt-[0.5vh]">
                VLCC · 300,000 DWT · Flag: Unknown
              </div>
            </div>
            <div className="text-right">
              <div className="font-mono text-[0.7vw] text-[var(--color-critical)]">
                SUSPICION SCORE
              </div>
              <div className="font-mono text-[3vw] text-[var(--color-critical)] leading-none">
                94
              </div>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-[1vw]">
            <div className="bg-[var(--color-bg-base)] p-[1vw] rounded border border-[var(--color-border)]">
              ...
              <div className="font-mono text-[0.6vw] text-[var(--color-warning)] mt-[0.5vh]">
                26.1°N 55.8°E — Persian Gulf
              </div>
            </div>
            <div className="bg-[var(--color-bg-base)] p-[1vw] rounded border border-[var(--color-border)]">
              ...
              <div className="font-mono text-[0.6vw] text-[var(--color-critical)] mt-[0.5vh]">
                Total Potential Fine: $2.98M
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="font-mono text-[0.7vw] text-[var(--color-terra)] tracking-wider mb-[1vh]">
            AUM: $4.2B+
          </div>
          <div className="font-display text-[2vw] text-[var(--color-text-primary)] border-b border-[var(--color-border)] pb-[1.5vh] mb-[1.5vh]">
            Meridian Tower
          </div>
          <div className="font-mono text-[0.8vw] text-[var(--color-text-muted)] mb-[2vh]">
            1200 Meridian Ave, Miami, FL
          </div>
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="flex justify-between items-center mb-[2vh] border-b border-[var(--color-border)] pb-[1.5vh]">
            <div className="font-mono text-[0.8vw] text-[var(--color-aegis)]">
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-carlota)]/30 rounded-lg overflow-hidden p-[2vw]">
          ...
          <div className="grid grid-cols-2 gap-[1.5vw]">
            <div className="font-mono text-[0.8vw] text-[var(--color-text-primary)]">
    ...
    },
    {
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="font-mono text-[0.8vw] text-[var(--color-critical)] mb-[1vh]">
            CYBER POSTURE
          </div>
          <div className="font-display text-[2vw] text-[var(--color-text-primary)] border-b border-[var(--color-border)] pb-[1.5vh] mb-[1.5vh]">
          ...
          <div className="flex justify-between items-center bg-[var(--color-bg-base)] border border-[var(--color-critical)]/30 p-[1vw] rounded mb-[2vh]">
            <div className="font-mono text-[0.8vw] text-[var(--color-critical)]">
              ELEVATED · 3 ACTIVE INCIDENTS
            </div>
    ...
    },
    {
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="font-mono text-[0.8vw] text-[var(--color-lyte-cyan)] mb-[1vh]">
          ...
          <div className="flex justify-between items-end mb-[2vh]">
            <div>
              ...
              <div className="font-mono text-[2vw] text-[var(--color-lyte-cyan)] leading-none">
                92 CONFIDENCE
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="font-mono text-[0.8vw] mb-[1vh]" style={{ color: 'hsl(263,52%,55%)' }}>
            LEGAL COMMAND
          </div>
          <div className="font-display text-[2vw] text-[var(--color-text-primary)] border-b border-[var(--color-border)] pb-[1.5vh] mb-[1.5vh]">
    ...
    },
    {
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="font-mono text-[0.8vw] mb-[1vh]" style={{ color: 'hsl(246,48%,60%)' }}>
            LEGAL MATTERS
          </div>
          <div className="font-display text-[2vw] text-[var(--color-text-primary)] border-b border-[var(--color-border)] pb-[1.5vh] mb-[1.5vh]">
          ...
          <div className="flex justify-between items-center mb-[2vh] bg-[var(--color-bg-base)] border border-[var(--color-warning)]/30 p-[1vw] rounded">
            <div className="font-mono text-[0.8vw] text-[var(--color-warning)]">
              URGENT · 12h DEADLINE
            </div>
          </div>
    ...
    },
    {
      ...
      mock: (
        <div className="w-[40vw] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg overflow-hidden p-[2vw]">
          <div className="font-mono text-[0.8vw] text-[var(--color-lyte-cyan)] mb-[2vh]">
          ...
          <div className="grid grid-cols-2 gap-[1vw]">
            ...
            <div className="bg-[var(--color-bg-base)] border border-[var(--color-text-primary)]/30 p-[1vw] rounded">
              ...
              <div className="font-mono text-[1.2vw] text-[var(--color-text-primary)]">
                79{' '}
                <span className="text-[0.6vw] text-[var(--color-text-muted)]">($3.2B / 18.4%)</span>
              </div>
            </div>
