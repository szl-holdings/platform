...
export function Scene6() {
  return (
    ...
    >
      ...
      <div className="relative w-[85vw] h-[65vh] flex flex-col gap-6">
        <motion.div
        ...
        >
          <motion.img
            src={`${import.meta.env.BASE_URL}screens/09-pipeline.jpg`}
            alt="Pipeline"
            className="w-full h-full object-cover object-top"
            initial={{ scale: 1.1, y: '0%' }}
            animate={{ scale: 1.0, y: '-2%' }}
        ...
        >
          <motion.img
            src={`${import.meta.env.BASE_URL}screens/11-model-router.jpg`}
            alt="Model Router"
            className="w-full h-full object-cover object-top"
