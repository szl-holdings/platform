...
const COMMAND_NAV_ROUTES: Array<{ href: string; label: string; group: string }> = [
  ...
  { href: '/operations/alloy/canvas', label: 'FORGE Workflow Canvas', group: 'FORGE' },
  { href: '/operations/alloy/actions', label: 'FORGE Action Console', group: 'FORGE' },
  { href: '/operations/alloy/templates', label: 'FORGE Templates', group: 'FORGE' },
  { href: '/operations/alloy/intelligence', label: 'FORGE Intelligence', group: 'FORGE' },
  { href: '/operations/alloy/governance', label: 'FORGE Governance', group: 'FORGE' },
  { href: '/operations/alloy/agents', label: 'FORGE Agent Monitor', group: 'FORGE' },
  { href: '/operations/alloy/traces', label: 'FORGE Execution Traces', group: 'FORGE' },
  { href: '/operations/alloy/replay', label: 'FORGE Replay Timeline', group: 'FORGE' },
  { href: '/operations/alloy/simulate', label: 'FORGE Policy Sim', group: 'FORGE' },
  { href: '/operations/alloy/handoffs', label: 'FORGE Agent Handoffs', group: 'FORGE' },
  { href: '/operations/alloy/receipts', label: 'FORGE Trust Receipts', group: 'FORGE' },
  { href: '/operations/alloy/integrations', label: 'FORGE Integration Health', group: 'FORGE' },
  { href: '/operations/alloy/compiler', label: 'FORGE Graph Compiler', group: 'FORGE' },
  { href: '/operations/alloy/policy-compiler', label: 'FORGE Policy Compiler', group: 'FORGE' },
  { href: '/operations/alloy/proof', label: 'FORGE Proof', group: 'FORGE' },
