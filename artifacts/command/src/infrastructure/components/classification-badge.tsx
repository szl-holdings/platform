...
import { Lock, Shield, Globe, AlertTriangle } from "lucide-react";
import type { Classification } from "@imp/lib/imperium-data";
import { cn } from "@imp/lib/utils";

const CONFIG: Record<Classification, { label: string; icon: React.ElementType; className: string }> = {
  ...
  return (
    <div
      className={cn(
        ...
        textSize, padding, cfg.className
      )}
    >
