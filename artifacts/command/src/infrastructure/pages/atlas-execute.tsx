      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-[11px] mt-0.5" style={{ color: 'rgba(255,255,255,0.35)' }}>
            Ingest infrastructure signals, run governed remediation workflows, review execution
            evidence, and approve sovereign actions.
          </p>
        </div>
          ...
          <div className="flex-1">
            ...
            <div className="text-[11px] text-white mb-1">
              {pendingApproval.reason ??
                'This infrastructure action requires governor approval before execution continues.'}
            </div>
          ...
          >
            ...
            {loading ? (
              ...
              >
                ...
                <span className="text-[11px]">Loading signals…</span>
              </div>
            ) : signals.length === 0 ? (
              <div
                className="flex items-center gap-2 py-4"
              ...
              >
                ...
                <span className="text-[11px]">
                  No signals yet. Ingest an infrastructure event to begin.
                </span>
              </div>
            ) : (
              <div className="space-y-1.5 max-h-64 overflow-y-auto">
                {signals.map((sig) => (
                  <label
                    ...
                    style={{
                      background: selectedSignalIds.includes(sig.id)
                        ? `${ACCENT}15`
                  ...
                  >
                    <input
                      type="checkbox"
                      checked={selectedSignalIds.includes(sig.id)}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        <span
                          ...
                          style={{
                            background: `${SEV_COLOR[sig.severity]}20`,
                      ...
                      <div
                        ...
                        style={{ color: 'rgba(255,255,255,0.3)' }}
                      >
                        Confidence: {Math.round(sig.confidence * 100)}% · {sig.source}
                      </div>
                    </div>
                  </label>
                ))}
            ...
            >
              <span className="text-[10px] font-mono" style={{ color: 'rgba(255,255,255,0.3)' }}>
                {selectedSignalIds.length > 0
                  ...
                  : 'Select signals to include in workflow'}
              </span>
              <button
          ...
          >
            ...
            {runs.length === 0 ? (
              ...
              >
                <Info className="w-3.5 h-3.5" />
                <span className="text-[11px]">
                  No runs yet. Execute a workflow to see the timeline.
                </span>
              </div>
            ) : (
              <div className="space-y-2 max-h-72 overflow-y-auto">
                {runs.map((run) => (
                  ...
                  >
                    <button
                      onClick={() => {
                        setExpandedRun((e) => (e === run.runId ? null : run.runId));
                        setSelectedRun(run);
                      }}
                    ...
                    {expandedRun === run.runId && run.steps && run.steps.length > 0 && (
                      <div
                        className="px-3 pb-3 space-y-1 border-t"
                        style={{ borderColor: 'rgba(255,255,255,0.06)' }}
                      >
                        {run.steps.map((step) => (
                ...
                {outcomes.map((oc) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className="text-[10px] px-1.5 py-0.5 rounded ml-auto font-mono"
                        style={{ background: `${ACCENT}20`, color: ACCENT }}
                      >
                        {oc.status}
                      </span>
