import type { CommandAction, DomainData, IntelligenceCard, TimelineEvent } from '../types';
...
export const baseDomainData: DomainData[] = [
  {
    ...
    sparkline: [
      58, 61, 63, 60, 58, 62, 65, 63, 61, 64, 62, 60, 61, 63, 60, 58, 61, 63, 65, 62, 60, 61, 62,
      61,
    ],
    link: '/aegis/',
  },
  {
    ...
    sparkline: [
      80, 82, 81, 83, 82, 84, 83, 82, 81, 82, 83, 84, 82, 81, 80, 82, 83, 82, 81, 82, 83, 82, 81,
      82,
    ],
    link: '/vessels/',
  },
  {
    ...
    sparkline: [
      77, 78, 79, 78, 80, 79, 78, 79, 80, 79, 78, 79, 80, 79, 78, 79, 80, 79, 78, 79, 80, 79, 78,
      79,
    ],
    link: '/',
  },
  {
    ...
    sparkline: [
      87, 88, 89, 88, 87, 88, 89, 90, 89, 88, 87, 88, 89, 88, 87, 88, 89, 88, 87, 88, 89, 88, 87,
      88,
    ],
  ...
  },
  {
    ...
    sparkline: [
      71, 70, 69, 68, 69, 70, 68, 67, 69, 70, 69, 68, 69, 70, 68, 67, 69, 70, 69, 68, 69, 70, 69,
      69,
    ],
    link: '/terra/',
  },
  {
    ...
    alerts: { count: 2, severity: 'medium' },
    sparkline: [
      86, 87, 88, 89, 88, 87, 88, 89, 90, 88, 87, 88, 89, 88, 87, 88, 89, 88, 87, 88, 89, 88, 87,
      88,
    ],
    link: '/carlota-jo/',
  },
  {
    ...
    sparkline: [
      74, 75, 76, 75, 77, 76, 75, 76, 77, 76, 75, 76, 77, 76, 75, 76, 77, 76, 75, 76, 77, 76, 75,
      76,
    ],
    link: '/founder',
  },
...
export const baseTimelineEvents: TimelineEvent[] = [
  {
    ...
    domain: 'aegis',
    severity: 'critical',
    title: 'APT-29 lateral movement',
    detail:
      'Threat actor pivoting from phishing compromise on CORP-WS-447 toward Active Directory controllers — isolation recommended.',
  },
  {
    id: 2,
    time: '8m ago',
  ...
  },
  {
    ...
    domain: 'vessels',
    severity: 'high',
    title: 'MV Kestrel Meridian delayed 18hrs',
    detail: 'Port of Singapore congestion affecting Q2 cargo schedule; Horizon Logistics notified.',
  },
  {
    id: 4,
    time: '24m ago',
    domain: 'aegis',
    severity: 'high',
    title: '3 endpoints quarantined',
    detail:
      'Containment action executed on CORP-WS-447, CORP-LT-219, CORP-SRV-08; forensic imaging in progress.',
  },
  {
    id: 5,
    time: '31m ago',
    domain: 'terra',
    severity: 'medium',
    title: 'Phoenix MSA comp decline 3.2%',
    detail:
      'Comparable sales pressure in Phoenix metropolitan area impacts Sunset Ridge Portfolio valuation.',
  },
  {
    id: 6,
    time: '45m ago',
    domain: 'lyte',
    severity: 'info',
    title: 'Auto-scaling triggered: +5 nodes',
    detail: 'Kubernetes cluster expanded from 12 to 17 nodes; CPU load normalized to 34%.',
  },
  {
    id: 7,
    time: '52m ago',
  ...
  },
  {
    ...
    detail:
      '847 emails blocked across SZL domain — credential-harvesting lure targeting finance team.',
  },
  {
    id: 10,
    time: '1h 28m ago',
    domain: 'vessels',
    severity: 'medium',
    title: 'Cargo inspection: Port Houston',
    detail: 'MV Albatross Star cleared customs — 2hr delay adds to transit time estimate.',
  },
  {
    id: 11,
    time: '2h ago',
  ...
  },
  {
    ...
    domain: 'terra',
    severity: 'medium',
    title: 'Distress opportunity flagged',
    detail:
      '3 off-market Phoenix multifamily assets identified at 15-20% discount to recent comps.',
  },
  {
    id: 13,
    time: '3h ago',
  ...
  },
  {
    ...
    detail: 'Scheduled PostgreSQL vacuum and index rebuild completed — zero downtime.',
  },
  {
    id: 15,
    time: '4h ago',
    domain: 'vessels',
    severity: 'info',
    title: 'MV Nordic Arrow departed Rotterdam',
    detail: 'On-schedule departure with $124M cargo bound for Houston; ETA April 22.',
  },
  {
    id: 16,
    time: '5h ago',
    domain: 'aegis',
    severity: 'low',
    title: 'Vulnerability patch applied',
    detail: 'CVE-2025-1734 patched across 4,821 endpoints — zero exploitation detected.',
  },
];
...
export const baseCommandActions: CommandAction[] = [
  {
    ...
    domain: 'aegis',
    priority: 'critical',
    text: 'Acknowledge 7 unacknowledged critical alerts from APT-29 campaign',
  ...
  },
  {
    ...
    domain: 'vessels',
    priority: 'high',
    text: 'Escalate MV Kestrel Meridian delay to port authority and Horizon Logistics',
    buttonText: 'Escalate',
  },
  {
    id: 'act-4',
  ...
  },
  {
    ...
    domain: 'terra',
    priority: 'medium',
    text: 'Sign off on Phoenix market comp report before board meeting',
    buttonText: 'Acknowledge',
  },
];
