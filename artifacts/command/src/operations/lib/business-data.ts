...
export const signals: BusinessSignal[] = [
  {
    ...
    summary:
      'Eight enterprise deals ($4.2M combined ARR) have been pending legal/finance approval for 10–18 business days. Historical average is 3.2 days.',
    whyItMatters:
      'At current close probability decay rate, 3 of these deals are projected to slip from Q1 to Q2. Forecast impact estimated at $2.1M.',
    affectedFunction: 'Enterprise Sales',
    owner: 'Marcus Webb',
    ownerTeam: 'Revenue Operations',
    recommendedAction:
      'Escalate to CFO approval track; flag deals >10 days for executive sponsor outreach. Remove blockers in legal review queue.',
    valueAtRisk: 2100000,
    detectedAt: minsAgo(18),
    status: 'active',
    relatedSignals: ['SIG-004', 'SIG-009'],
    anomaly:
      'Approval latency increased 21% over the past 10 business days. Highest outlier: Veritas Corp deal at 18 days with no owner activity in 7 days.',
  ...
  },
  {
    ...
    summary:
      'Post-sale implementation queue has 14 projects stalled at the delivery handoff stage. No CSM or implementation engineer assigned. Mean days stalled: 11.4.',
    whyItMatters:
      'Customer onboarding SLA is 5 business days to first contact. All 14 are in breach. Churn risk on 4 accounts exceeds $890K ARR.',
    affectedFunction: 'Customer Success',
    owner: 'Diana Reyes',
    ownerTeam: 'Delivery Operations',
    recommendedAction:
      'Assign capacity from bench pool immediately. Escalate top 4 accounts to VP CS. Activate overflow staffing protocol.',
    valueAtRisk: 890000,
  ...
  },
  {
    ...
    severity: 'critical',
    title:
      'Q1 forecast dropped $3.8M in 10 days — commit probability collapsing across mid-market segment',
    summary:
      "Mid-market segment commit has fallen from $12.4M to $8.6M over 10 business days. 22 deals reclassified from 'commit' to 'best case'.",
    whyItMatters:
      'Q1 board commitment is $11.2M. Current trajectory implies a $2.6M miss. No corrective actions have been filed by segment leadership.',
    affectedFunction: 'Revenue',
    owner: 'Priya Nair',
    ownerTeam: 'Mid-Market Sales',
    recommendedAction:
      'Convene forecast review with VP Sales. Identify 5–7 deals for acceleration. Assess whether pipeline coverage compensates.',
    valueAtRisk: 3800000,
    detectedAt: minsAgo(8),
    status: 'active',
    relatedSignals: ['SIG-001', 'SIG-011'],
    anomaly:
      'Steepest 10-day forecast decline in 6 quarters. Rate of reclassification (22 deals) is 3.1x historical norm.',
  ...
  },
  {
    ...
    summary:
      'Seven enterprise accounts with combined ARR of $2.3M are approaching renewal with no assigned account executive or CSM in the system.',
    whyItMatters:
      'Unowned renewals churn at 4.2x the rate of owned accounts. At 60 days, win rate drops precipitously without early outreach.',
    affectedFunction: 'Account Management',
    owner: 'Unassigned',
    ownerTeam: 'Enterprise Sales',
    recommendedAction:
      'Assign AE/CSM pairs within 24 hours. Initiate health checks on all 7 accounts. Prioritize by ARR and health score.',
    valueAtRisk: 2300000,
    detectedAt: minsAgo(52),
    status: 'active',
    relatedSignals: ['SIG-001'],
    anomaly:
      'Ownership gap is 2.1x larger than same period last quarter. Root cause: 2 AEs departed without territory reassignment.',
  ...
  },
  {
    ...
    summary:
      'SE team is receiving pre-sales technical requests 9 days after initial qualification. Standard SLA is 2 days. Queue has grown 47% in 3 weeks.',
    whyItMatters:
      'Late SE engagement correlates with 28% lower win rate. 6 deals in queue are >$500K TCV with discovery calls scheduled.',
    affectedFunction: 'Pre-Sales',
    owner: 'James Okafor',
    ownerTeam: 'Solutions Engineering',
    recommendedAction:
      'Triage queue by deal size. Fast-track >$300K TCV. Evaluate capacity expansion or priority matrix revision.',
    valueAtRisk: 1400000,
    detectedAt: minsAgo(74),
    status: 'acknowledged',
    relatedSignals: ['SIG-009'],
    anomaly:
      'Queue growth rate outpaced hiring plan. SE capacity model was last updated 4 months ago.',
  ...
  },
  {
    ...
    summary:
      'Of 284 active pipeline opportunities, 116 show no logged activity (call, email, meeting) in the past 14 days and no next step date.',
    whyItMatters:
      'Stale pipeline corrupts forecast accuracy and wastes capacity. These 116 deals represent $8.4M in reported pipeline but have minimal actual probability.',
    affectedFunction: 'Sales Operations',
    owner: 'Rosa Kim',
    ownerTeam: 'Revenue Operations',
    recommendedAction:
      'Mandatory pipeline review by reps this week. Auto-age to lower stage after 21 days no activity. Manager review of >$200K stale deals.',
    valueAtRisk: 840000,
    detectedAt: minsAgo(110),
    status: 'active',
    anomaly:
      'Stale deal percentage increased from 28% to 41% over the past 3 weeks. Correlates with new sales methodology rollout.',
  ...
  },
  {
    ...
    summary:
      '12 professional services statements of work have been sent to clients and are awaiting signature. Average days outstanding is 19; oldest is 34 days.',
    whyItMatters:
      'Revenue cannot be recognized until SOW is signed. $1.1M in delivery revenue is blocked. Project start dates are slipping.',
    affectedFunction: 'Professional Services',
    owner: 'Anika Mehta',
    ownerTeam: 'Delivery',
    recommendedAction:
      'Client outreach on all 12. Engage executive sponsors for deals >34 days. Review client-side blockers and offer e-signature acceleration.',
    valueAtRisk: 1100000,
    detectedAt: minsAgo(130),
    status: 'active',
    relatedSignals: ['SIG-002'],
    anomaly:
      'Signing latency up 38% vs Q4. Client-side legal review is primary bottleneck per rep notes.',
  ...
  },
  {
    ...
    summary:
      'Usage telemetry shows 23 accounts consuming beyond contracted tier limits for 2+ billing cycles without upgrade or overage charge applied.',
    whyItMatters:
      'Under-billing represents direct revenue leakage. Also creates adoption risk — uncapped usage patterns may reset when billing is corrected.',
    affectedFunction: 'Finance / Billing',
    owner: 'Tom Farrell',
    ownerTeam: 'Finance Operations',
    recommendedAction:
      'Finance audit of billing rules against usage data. CSM outreach to affected accounts before corrective billing. Consider expansion offer framing.',
    valueAtRisk: 340000,
    detectedAt: minsAgo(195),
    status: 'acknowledged',
    anomaly:
      'New usage-based pricing tier launched 6 weeks ago. Billing system rule propagation appears to have failed for accounts migrated before cutover.',
  ...
  },
  {
    ...
    summary:
      'Non-standard discount requests (>25%) require VP and CFO sign-off. 11 active requests averaging 5.8 business days to approval. Standard is 2 days.',
    whyItMatters:
      '3 deals with customer-committed close dates in the next 7 days are blocked on discount approval. Combined TCV: $870K.',
    affectedFunction: 'Deal Desk',
    owner: 'Kenji Watanabe',
    ownerTeam: 'Deal Desk',
    recommendedAction:
      'Escalate 3 expiring deals to CFO today. Review approval chain for bottlenecks. Consider pre-approved discount bands to reduce approval load.',
    valueAtRisk: 870000,
  ...
  },
  {
    ...
    summary:
      "Eighteen deals have been in 'Proposal Sent' stage for 30+ days without a follow-up logged. Proposal acceptance rate at this stage drops 60% after 3 weeks.",
    whyItMatters:
      'Pipeline stage accuracy is distorted. These 18 deals inflate pipeline by $2.1M but have negligible realistic probability.',
    affectedFunction: 'Sales',
    owner: 'Various',
    ownerTeam: 'Mid-Market Sales',
    recommendedAction:
      'Rep outreach required this week. If no client engagement by day 35, auto-move to Nurture stage and remove from commit forecast.',
    valueAtRisk: 420000,
    detectedAt: minsAgo(280),
    status: 'active',
    anomaly:
      'Proposal acceptance rate declined from 52% to 31% over the past quarter. Pricing competitiveness review may be warranted.',
  ...
  },
  {
    ...
    summary:
      'Enterprise pipeline coverage against Q1 commit has dropped to 0.94x. Historical target is 1.3x at this stage in the quarter.',
    whyItMatters:
      'Coverage below 1.0x means there is not enough pipeline to cover the committed number even at 100% close rate. Requires either pull-forward deals or expectation management.',
    affectedFunction: 'Revenue',
    owner: 'Sarah Donovan',
    ownerTeam: 'Enterprise Sales',
    recommendedAction:
      'Source 3–5 accelerated deals from late-stage partners. Review if any Q2 pipeline can be pulled forward. Revise Q1 commit expectation with board.',
    valueAtRisk: 1800000,
    detectedAt: minsAgo(340),
    status: 'active',
    relatedSignals: ['SIG-003'],
    anomaly:
      'Coverage ratio declining at 0.04x per week. At this rate, will reach 0.80x before quarter-end.',
  ...
  },
  {
    ...
    severity: 'low',
    title:
      'Customer success QBR completion rate at 61% — 39% of enterprise accounts unreviewed this quarter',
    summary:
      'Of 74 enterprise accounts due for quarterly business reviews, 29 have not had a QBR completed or scheduled. Quarter ends in 22 business days.',
    whyItMatters:
      'Accounts without QBRs have 2.3x higher churn rate at renewal. 29 unreviewed accounts represent $4.1M ARR at elevated risk.',
    affectedFunction: 'Customer Success',
    owner: 'Maria Vasquez',
    ownerTeam: 'Enterprise Customer Success',
    recommendedAction:
      'CSM outreach this week to all 29 accounts. Prioritize by health score and ARR. Compress QBR format to 30-min virtual if needed.',
    valueAtRisk: 820000,
    detectedAt: minsAgo(390),
    status: 'acknowledged',
    anomaly:
      'QBR completion rate lowest in 3 years. Correlation with CS team expansion — new CSMs not yet at full book capacity.',
...
export const narrativeInsights: NarrativeInsight[] = [
  ...
  },
  {
    id: 'INS-002',
    title:
      'Q1 mid-market forecast has lost $3.8M in credibility over 10 days — board commit at risk',
  ...
  },
  {
    id: 'INS-003',
    title:
      'Delivery handoff failures are compressing customer onboarding performance — churn signal emerging',
...
export const ownershipMap: OwnershipRecord[] = [
  ...
  {
    id: 'OWN-004',
    area: 'Mid-Market Forecast Recovery',
  ...
  {
    id: 'OWN-005',
    area: 'Enterprise QBR Completion',
    team: 'Enterprise CS',
    owner: 'Maria Vasquez',
    status: 'ambiguous',
    openItems: 29,
  ...
  {
    id: 'OWN-007',
    area: 'Revenue Billing Reconciliation',
...
export const valueAtRiskBreakdown: ValueAtRiskRecord[] = [
  {
    ...
    amount: 5600000,
    trend: 18.4,
    signalType: 'forecast_drift',
    workflows: ['Q1 Mid-Market', 'Enterprise Coverage'],
  },
  {
    ...
    workflows: ['Enterprise Approval', 'Discount Approval'],
  },
  {
    ...
    workflows: ['Renewals', 'Onboarding'],
  },
  {
    category: 'Stalled Workflows',
    amount: 1990000,
    trend: 38.0,
    signalType: 'stalled_workflow',
    workflows: ['Implementation', 'SOW Signing'],
  },
  {
    category: 'Handoff Failures',
    amount: 2290000,
    trend: 12.5,
    signalType: 'handoff_failure',
    workflows: ['SE Queue', 'QBR Cycle'],
  },
  {
    category: 'Pipeline Hygiene',
    amount: 1260000,
    trend: -5.2,
    signalType: 'pipeline_hygiene',
    workflows: ['Stale Opportunities'],
  },
  {
    category: 'Revenue Leakage',
    amount: 340000,
    trend: 0,
    signalType: 'revenue_leakage',
    workflows: ['Usage Billing'],
  },
];
