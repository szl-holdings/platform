...
export default function DemoDashboard() {
  const [activeRole, setActiveRole] = useState<'executive' | 'operator' | 'manager' | 'compliance'>(
    'executive',
  );
  const summary = demoRoleSummaries[activeRole];
  const criticalSignals = demoSignals.filter(
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] mt-0.5" style={{ color: TEXT.secondary }}>
            Live operational signals — seeded demo data
          </p>
        </div>
        <div
          ...
          {ROLES.map((r) => (
            <button
              ...
              style={{
                ...
                border:
                  activeRole === r.key ? '1px solid rgba(212,160,84,0.2)' : '1px solid transparent',
              }}
            >
              {r.label}
            </button>
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] mt-0.5 leading-relaxed" style={{ color: TEXT.secondary }}>
              {summary.headline}
            </p>
          </div>
        </div>
          ...
          return (
            <Panel key={i}>
              <div className="px-3 py-3">
                ...
                <div className="text-xl font-bold font-mono mb-1" style={{ color: c.text }}>
                  {kpi.value}
                </div>
                <div className="flex items-center gap-1">
                  {isDown && kpi.severity !== 'stable' ? (
                    <TrendingDown className="w-2.5 h-2.5" style={{ color: '#c45a4a' }} />
                  ) : (
                    <TrendingUp className="w-2.5 h-2.5" style={{ color: '#6b8f71' }} />
                  )}
        ...
        <div className="col-span-2 space-y-3">
          <Panel>
            <PanelHead
              ...
              right={
                ...
                >
                  All signals <ChevronRight className="w-2.5 h-2.5" />
                </Link>
              }
            />
          ...
          <Panel>
            <PanelHead
              ...
              right={
                <Link
                  href="/operations/priorities"
                  className="flex items-center gap-0.5 text-[9px] font-mono"
                  style={{ color: TEXT.tertiary }}
                >
                  All priorities <ChevronRight className="w-2.5 h-2.5" />
                </Link>
              }
            />
            <div className="divide-y" style={{ borderColor: BORDER.subtle }}>
              {topPriorities.map((pri) => {
                ...
                return (
                  <div key={pri.id} className="px-3 py-2.5 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <span
                          ...
                          style={{
                            color: urgColors[pri.urgency],
                            background: `${urgColors[pri.urgency]}14`,
                            border: `1px solid ${urgColors[pri.urgency]}25`,
                          }}
                        >
                    ...
                    <div className="text-[9px] font-mono shrink-0" style={{ color: '#6b8f71' }}>
                      {fmt(pri.valueProtected)}
                    </div>
                    <div className="w-12 flex-shrink-0">
                      <div
                        className="text-[7px] text-right mb-0.5 font-mono"
                        style={{ color: TEXT.muted }}
                      >
                        Score
                      </div>
                      ...
                      >
                        <div
                          ...
                          style={{
                            width: `${pri.totalScore}%`,
                            background: 'linear-gradient(90deg, #c8953c, #d4a054)',
                          }}
                        />
                      </div>
                      <div
                        className="text-[7px] text-right mt-0.5 font-mono"
                        style={{ color: TEXT.tertiary }}
                      >
                        {pri.totalScore}
                      </div>
        ...
        <div className="space-y-3">
          <Panel>
            ...
            <div className="px-2 py-2">
              <div className="text-xl font-bold font-mono" style={{ color: '#c45a4a' }}>
                $17.6M
              </div>
              <div className="text-[9px] mb-2" style={{ color: TEXT.muted }}>
                Total value at risk — all active signals
              </div>
            ...
            <div className="divide-y" style={{ borderColor: BORDER.subtle }}>
              {stalledWorkflows.map((wf) => (
                <div key={wf.id} className="px-3 py-2.5">
                  <div
                    className="text-[10px] font-medium mb-0.5 leading-snug"
                    style={{ color: TEXT.primary }}
                  >
                    {wf.name}
                  </div>
                  <div className="text-[9px] leading-snug mb-1" style={{ color: TEXT.muted }}>
                    {wf.stallReason?.slice(0, 80)}...
                  </div>
                  <div className="flex items-center gap-2">
                    <span
                    ...
                    <span className="text-[9px] font-mono" style={{ color: '#c45a4a' }}>
                      {fmt(wf.valueAtRisk)}
                    </span>
                  </div>
                </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <Panel>
          <PanelHead
            ...
            right={
              <Link
                href="/operations/recommendations"
                className="flex items-center gap-0.5 text-[9px] font-mono"
                style={{ color: TEXT.tertiary }}
              >
          ...
          <div className="px-3 py-2.5">
            <div
              className="text-[10px] font-semibold leading-snug mb-1.5"
              style={{ color: TEXT.primary }}
            >
              Implement parallel legal review for deals &gt;$1M TCV
            </div>
            <div className="text-[9px] leading-relaxed mb-2" style={{ color: TEXT.secondary }}>
              Reduce approval latency from 14.2 days to 3.2 days. Estimated $1.8M Q1 impact
              protection.
            </div>
            <div className="flex items-center gap-2">
              <div
              ...
              >
                <div
                  className="h-full rounded-full"
                  style={{ width: '91%', background: '#8b7ac8' }}
                />
              </div>
              <span className="text-[8px] font-mono shrink-0" style={{ color: '#8b7ac8' }}>
                91% confidence
              </span>
            </div>
          </div>
          ...
          <div className="px-3 py-2.5 grid grid-cols-5 gap-1">
            {[
              ...
              <div key={p.key} className="flex flex-col items-center gap-1">
                ...
                <div className="text-[9px] font-mono" style={{ color: p.color }}>
                  {p.score}
                </div>
