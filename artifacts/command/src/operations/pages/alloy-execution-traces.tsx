...
import { AlertTriangle, ChevronDown, ChevronRight, GitBranch, Search } from 'lucide-react';
    ...
    steps: [
      {
        ...
        status: 'ok',
        duration: '28ms',
        output: '263 signals normalized from 8 sources',
      },
      {
        step: '02',
        ...
        status: 'ok',
        duration: '112ms',
        output: 'Workspace state assembled — 14 owners, 31 active workflows',
      },
      {
        step: '03',
        label: 'Risk Scoring',
        status: 'ok',
        duration: '344ms',
        output: '5 high-risk signals identified, 2 critical ownership gaps',
      },
      {
        step: '04',
        ...
        status: 'ok',
        duration: '788ms',
        output: '3,840 tokens — 1 finding generated with evidence chain',
      },
      {
        step: '05',
        ...
        status: 'ok',
        duration: '86ms',
        output: '1 action routed to Command Inbox — awaiting approval',
      },
      {
        step: '06',
        ...
        status: 'ok',
        duration: '54ms',
        output: 'Trace archived to Proof Chain — immutable record created',
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        status: 'ok',
        duration: '8ms',
        output: '47 events ingested from 3 sources',
      },
      {
        step: '02',
        ...
        status: 'ok',
        duration: '214ms',
        output: '12 correlation rules applied',
      },
      {
        step: '03',
        ...
        status: 'ok',
        duration: '388ms',
        output: '3 correlated clusters identified',
      },
      {
        step: '04',
        label: 'Severity Assignment',
        status: 'ok',
        duration: '72ms',
        output: '1 critical, 1 high, 1 medium cluster',
      },
      {
        step: '05',
        ...
        status: 'ok',
        duration: '130ms',
        output: '3 correlated signals published to event fabric',
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        status: 'ok',
        duration: '42ms',
        output: 'Action type: notify — approved by governance policy',
      },
      {
        step: '02',
        label: 'Connector Resolution',
        status: 'ok',
        duration: '28ms',
        output: 'Slack connector selected — workspace: @acme',
      },
      {
        step: '03',
        ...
        status: 'ok',
        duration: '764ms',
        output: '1,280 tokens — message rendered with context',
      },
      {
        step: '04',
        label: 'Delivery Attempt 1',
        status: 'warn',
        duration: '504ms',
        output: 'Timeout (500ms) — connector unreachable',
      },
      {
        step: '05',
        label: 'Delivery Attempt 2',
        status: 'warn',
        duration: '504ms',
        output: 'Timeout (500ms) — connector unreachable',
      },
      {
        ...
        status: 'ok',
        duration: '0ms',
        output: 'Fallback queued — email delivery pending',
      },
      {
        step: '07',
        label: 'Audit Recording',
        status: 'ok',
        duration: '0ms',
        output: 'Failure recorded — alert surfaced to Agent Monitor',
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        status: 'ok',
        duration: '188ms',
        output: '94 resources scanned — 12 unassigned',
      },
      {
        step: '02',
        label: 'Gap Analysis',
        status: 'ok',
        duration: '412ms',
        output: '7 ownership gaps exceeding 7-day threshold',
      },
      {
        step: '03',
        label: 'Attribution Inference',
        status: 'ok',
        duration: '1,204ms',
        output: '2,100 tokens — attribution suggested for 5 gaps',
      },
      {
        step: '04',
        ...
        status: 'ok',
        duration: '244ms',
        output: '7 findings queued — prioritised by impact',
      },
      {
        step: '05',
        label: 'Routing',
        status: 'ok',
        duration: '56ms',
        output: '2 actions routed to Command Inbox',
      },
    ],
  },
];
    ...
    >
      <div className="flex items-center justify-between gap-4">
        <div className="min-w-0">
          <p className="text-[11px] font-mono mb-0.5" style={{ color: ACCENT }}>
            {trace.traceId}
          </p>
    ...
    <div className="h-full overflow-y-auto" style={{ background: BG.surface }}>
      <div className="px-5 py-4" style={{ borderBottom: `1px solid ${BORDER.subtle}` }}>
        <div className="flex items-start justify-between gap-3 mb-3">
          <div>
            <p className="text-[11px] font-mono mb-1" style={{ color: ACCENT }}>
              {trace.traceId}
            </p>
        ...
        <div className="grid grid-cols-4 gap-3">
          {summaryMetrics.map((m) => (
            <div key={m.label} className="rounded px-3 py-2" style={{ background: BG.elevated }}>
              <p className="text-[10px] mb-0.5" style={{ color: TEXT.muted }}>
                {m.label}
              </p>
              <p className="text-[12px] font-mono" style={{ color: TEXT.secondary }}>
                {m.value}
              </p>
            </div>
          ))}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      ...
                      style={{ background: STEP_STATUS_COLOR[step.status] }}
                    />
        ...
        <div className="overflow-y-auto" style={{ borderRight: `1px solid ${BORDER.subtle}` }}>
          ...
          >
            <p className="text-[10px]" style={{ color: TEXT.muted }}>
              {filtered.length} traces · last 15 min
            </p>
          </div>
          {filtered.map((trace) => (
            <TraceRow
