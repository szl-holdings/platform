...
const DIGESTS: Digest[] = [
  {
    ...
    highlights: [
      ...
      'PARAGON: Security audit completed — 94% score, 0 critical findings',
  ...
  },
  {
    ...
    status: 'ready',
    summary:
      'Moderate portfolio health across Q1 close period. Vessels completed 4 successful port calls. PRISM Q1 reporting cycle closed. Terra completed 3 asset reviews. PARAGON initiated security vendor onboarding process.',
    highlights: [
