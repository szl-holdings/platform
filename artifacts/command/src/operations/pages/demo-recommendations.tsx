    ...
    >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 flex-wrap mb-2">
              ...
              <span
                className="text-[8px] px-1.5 py-px rounded"
                style={{
                  color: rec.status === 'in_progress' ? '#d4a054' : TEXT.muted,
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 flex-1">
                <div
                  className="flex-1 h-1 rounded-full overflow-hidden max-w-[80px]"
                  style={{ background: 'rgba(255,255,255,0.06)' }}
                >
                  <div
                    className="h-full rounded-full"
                    style={{ width: `${rec.confidenceScore}%`, background: confColor }}
                  />
                </div>
                <span className="text-[8px] font-mono shrink-0" style={{ color: confColor }}>
              ...
              <span
                ...
                style={{ color: '#6b8f71' }}
              >
                {fmt(rec.valueEstimate)} est. value
              </span>
              <span className="text-[9px] shrink-0" style={{ color: TEXT.muted }}>
                Owner: {rec.owner}
              </span>
            </div>
          </div>
      ...
      {open && (
        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-1">
              {rec.evidence.map((e, i) => (
                ...
                >
                  <span className="shrink-0 mt-0.5" style={{ color: cat.color }}>
                    ·
                  </span>
                  {e}
                </li>
          ...
          >
            <div className="text-[8px] uppercase tracking-wider mb-1" style={{ color: cat.color }}>
              Suggested Action
            </div>
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-[11px] mt-0.5" style={{ color: TEXT.secondary }}>
            Action recommendations with confidence scores, reasoning, and explainability context
          </p>
        </div>
        <div className="flex items-center gap-1.5">
          <div
            className="flex items-center gap-1 text-[9px] px-2.5 py-1 rounded-full"
            style={{
              color: '#8b7ac8',
