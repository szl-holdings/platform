    ...
    <div className="max-w-[1100px] space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">
          Value at risk from workflow failures, ownership gaps, and execution delays
        </p>
      </div>

      <div className="grid grid-cols-3 gap-4">
        <div className="col-span-3 md:col-span-1 rounded-xl p-5 border border-[#c45a4a]/30 bg-[#c45a4a]/5">
          <div className="text-[11px] text-[#c45a4a] font-mono uppercase tracking-wide mb-2">
            Total Value at Risk
          </div>
          <div className="font-display font-bold text-4xl text-[#c45a4a] mb-1">
            {formatCurrency(totalValueAtRisk)}
          </div>
          <div className="text-[11px] text-slate-400 mb-4">
            Across {activeSignals.length} active signals
          </div>
          <div className="h-24">
        ...
        <div className="col-span-3 md:col-span-2 rounded-xl p-5 border border-white/5 bg-white/[0.02]">
          <div className="text-[11px] text-slate-500 uppercase tracking-wide mb-4">
            Risk by Category
          </div>
          <div className="h-52">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={valueAtRiskBreakdown}
                layout="vertical"
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={cn(
                        ...
                        r.trend > 0 ? 'text-[#c45a4a]' : 'text-[#6b8f71]',
                      )}
                    >
                      {r.trend > 0 ? (
                ...
                <div key={sig.id} className={cn('p-3 rounded-lg border', c.border, c.bg)}>
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-[11px] font-medium text-white/90 leading-tight mb-1 line-clamp-2">
                        {sig.title}
                      </div>
                      ...
                      <div className="mt-1.5 h-1 bg-white/5 rounded-full overflow-hidden">
                        <div
                          className={cn('h-full rounded-full', c.dot.split(' ')[0])}
