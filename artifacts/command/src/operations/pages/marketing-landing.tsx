      ...
      <section className="relative pt-36 sm:pt-44 pb-28 sm:pb-36 max-w-[1140px] mx-auto px-6">
        ...
        <Reveal delay={400}>
          <div className="flex flex-wrap gap-3 mb-24">
            ...
            <button onClick={() => { window.location.href = "/command/operations/?view=app"; }} className="text-[13px] font-medium border rounded-lg px-7 py-3 transition-all hover:border-[rgba(212,160,84,0.3)] hover:text-[rgba(212,160,84,0.8)]" style={{ color: "rgba(255,255,255,0.5)", borderColor: "rgba(255,255,255,0.12)" }}>
              Try Live Demo →
            </button>
          </div>
        </Reveal>
