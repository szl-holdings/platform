...
import { ArrowRight, Building2, CheckCircle, Shield, X, Zap } from 'lucide-react';
...
const tiers = [
  ...
  },
  {
    ...
    notIncluded: ['SSO / SAML (add-on)', 'Dedicated CSM'],
  },
  {
    name: 'Enterprise',
    monthly: null,
  ...
  return (
    <div className="min-h-screen" style={{ background: BG, color: 'rgba(255,255,255,0.88)' }}>
      <ContactModal
        ...
        subtitle="Tell us about your team and use case."
      />
      ...
      <div className="border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          >
            ...
            <Link href="/pricing" style={{ color: 'rgba(255,255,255,0.88)' }}>
              Pricing
            </Link>
          </nav>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p
          ...
          style={{ color: 'rgba(255,255,255,0.5)' }}
        >
          From small ops teams to enterprise command centers. Every plan includes a full-featured
          trial.
        </p>
              ...
              <div
                ...
                style={{
                  background: tier.highlight
                    ? `linear-gradient(135deg, rgba(212,160,84,0.12), rgba(212,160,84,0.06))`
          ...
          {[
            {
              ...
              desc: 'No credit card required. Full access to all features.',
            },
            { label: 'No lock-in', desc: 'Cancel any time. Data export included in all plans.' },
            {
              label: 'SOC 2 compliant',
              desc: 'Enterprise-grade security baked in, not bolted on.',
            },
          ].map((item) => (
            <div key={item.label}>
