        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-[11px]" style={{ color: TEXT.secondary }}>
              Watch Command detect a live signal, classify it, run the Counsel workflow engine through
                  ...
                  state.recommendation?.approvalState === 'done' && (
                    ...
                    >
                      ...
                      <p className="text-[10px]" style={{ color: TEXT.secondary }}>
                        Command detected the signal, classified it, ran the Counsel workflow engine
