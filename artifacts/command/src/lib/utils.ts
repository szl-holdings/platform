...
export function getDomainColor(domainId: string) {
  switch (domainId.toLowerCase()) {
    case 'aegis':
      return 'var(--color-aegis)';
    case 'vessels':
      return 'var(--color-vessels)';
    case 'szl':
      return 'var(--color-szl)';
    case 'lyte':
      return 'var(--color-lyte)';
    case 'prism':
      return 'var(--color-prism)';
    case 'terra':
      return 'var(--color-terra)';
    case 'carlota':
      return 'var(--color-carlota)';
    case 'stephen':
      return 'var(--color-stephen)';
    default:
      return 'var(--color-fg-muted)';
  }
}
