...
export function AgentsPage() {
  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <select
            ...
            style={{
              ...
              borderRadius: 6,
              padding: '6px 10px',
              color: RISK_COLOR[globalAutonomy],
              fontSize: 12,
              cursor: 'pointer',
            }}
          >
            {Object.entries(AUTONOMY_LEVELS).map(([k, v]) => (
              <option key={k} value={k} style={{ color: RISK_COLOR[k] }}>
                {v.label}
              </option>
            ))}
          </select>
      ...
      <div
        style={{
          background: `${RISK_COLOR[globalAutonomy]}12`,
          borderBottom: `1px solid ${RISK_COLOR[globalAutonomy]}22`,
          padding: '10px 32px',
          display: 'flex',
          alignItems: 'center',
          gap: 8,
      ...
      >
        ...
        <span style={{ fontSize: 12, color: RISK_COLOR[globalAutonomy] }}>
          {AUTONOMY_LEVELS[globalAutonomy].label}
        </span>
        <span style={{ fontSize: 12, color: '#64748b' }}>—</span>
        <span style={{ fontSize: 12, color: '#94a3b8' }}>
          {AUTONOMY_LEVELS[globalAutonomy].description}
        </span>
      </div>
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: 24 }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
            {OPERATORS.map((op) => {
              ...
              const exceeds =
                Object.keys(AUTONOMY_LEVELS).indexOf(op.maxAutonomyLevel) >
                Object.keys(AUTONOMY_LEVELS).indexOf(globalAutonomy);
                ...
                >
                  ...
                  <div style={{ marginBottom: 10 }}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 10, color: '#8b7ac8', fontWeight: 600 }}>
                        {op.trustScore.overall}%
                      </span>
                    </div>
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                      ...
                      <span
                        style={{
                          fontSize: 10,
                          color: RISK_COLOR[op.maxAutonomyLevel],
                          fontWeight: 600,
                          marginLeft: 4,
                        }}
                      >
            ...
            >
              ...
              {[
                ...
                { label: 'Low Hallucination', value: selectedOp.trustScore.lowHallucinationScore },
                {
                  ...
                  value: selectedOp.trustScore.successfulVerification,
                },
                ...
                <div key={d.label} style={{ marginBottom: 8 }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: 11,
                        color: d.value >= 90 ? '#22c55e' : d.value >= 80 ? '#d4a054' : '#ef4444',
                      }}
                    >
                      {d.value}
                    </span>
                  ...
                  <div style={{ height: 3, background: '#1e293b', borderRadius: 2 }}>
                    <div
                      style={{
                        ...
                        width: `${d.value}%`,
                        background:
                          d.value >= 90 ? '#22c55e' : d.value >= 80 ? '#d4a054' : '#ef4444',
                        borderRadius: 2,
                      }}
                    />
                  </div>
