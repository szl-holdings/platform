    ...
    <div style={{ background: '#080c14', minHeight: '100vh', color: '#e2e8f0', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ borderBottom: '1px solid #1e293b', padding: '20px 32px', display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: '#64748b' }}>10-dimension evaluation across {evalRows.length} Action Briefs</div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', height: 'calc(100vh - 186px)' }}>
              ...
              return (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                    <div>
                      <div style={{ fontSize: 12, fontWeight: 600, color: '#e2e8f0' }}>{row.title}</div>
                      <div style={{ fontSize: 10, color: '#64748b', marginTop: 2 }}>{row.domain}</div>
                    </div>
                    ...
                    {DIM_LABELS.map((d) => {
                      ...
                      return (
                        <div key={d.key} title={`${d.label}: ${Math.round(val * 100)}%`} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
                          <div style={{ width: '100%', height: 24, background: '#1e293b', borderRadius: 2, position: 'relative', overflow: 'hidden' }}>
        ...
        {selected && (
          <div style={{ width: 360, borderLeft: '1px solid #1e293b', overflow: 'auto', padding: 20, background: '#080c14' }}>
            ...
            <div style={{ marginTop: 16, background: '#0f172a', borderRadius: 8, border: '1px solid #1e293b', padding: 12 }}>
