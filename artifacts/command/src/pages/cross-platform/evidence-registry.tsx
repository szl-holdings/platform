...
import { ArrowLeft, Database, ExternalLink, Search, X } from 'lucide-react';
...
export function EvidenceRegistryPage() {
  ...
  function handleSearch(v: string) {
    setSearch(v);
    clearTimeout(
      (window as unknown as { _evidenceDebounce?: ReturnType<typeof setTimeout> })
        ._evidenceDebounce,
    );
    (window as unknown as { _evidenceDebounce?: ReturnType<typeof setTimeout> })._evidenceDebounce =
  ...
  return (
    ...
    >
      ...
      <div
        className="px-6 py-3 border-b flex flex-col gap-3"
      ...
      <div className="flex-1 overflow-auto px-6 py-4">
        ...
        {!isLoading && !error && nodes.length === 0 && (
          <div className="text-center py-12 text-sm" style={{ color: 'rgba(255,255,255,0.3)' }}>
            No evidence nodes match your query
          </div>
        )}
              ...
              >
                ...
                <div className="shrink-0 text-right">
                  ...
                  <div
                    ...
                    style={{ color: 'rgba(255,255,255,0.2)' }}
                  >
                    {new Date(node.capturedAt).toLocaleDateString()}
                  </div>
                  {node.traceId && (
                    <a
                      href={node.drillUrl}
