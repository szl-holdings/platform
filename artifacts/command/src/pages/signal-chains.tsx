      ...
      <main className="flex-1 p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto w-full flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm" style={{ color: "var(--color-fg-muted)" }}>
            Cross-domain trigger→action workflows that fire automatically when signal thresholds are crossed.
            Each execution is logged with full explainability for audit compliance.
          </p>
        </div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span style={{ color: "var(--color-fg-muted)" }}>All chain executions are logged to the immutable audit trail with step-level explainability</span>
          </div>
        </div>
