...
const SEEDED_RECORDS: MemoryRecord[] = [
  ...
  },
  {
    ...
    value:
      'Cyclone Halia bearing 240° at 18 knots. Agent recommended 3-day delay via Port Colombo. Operator approved.',
    confidence: 0.99,
    freshness: 0.82,
  ...
  },
  {
    ...
    value:
      'Cap rate: 5.2% (±0.3). Comparable set: 12 assets. Model: DCF + residual value. IRR baseline: 8.4%.',
    confidence: 0.87,
    freshness: 0.71,
  ...
  },
  {
    ...
    value:
      'Step 1: DPA notification within 72h. Step 2: Data subject notice within 30d. Step 3: Remediation log filed. Step 4: Board briefing.',
    confidence: 0.96,
    freshness: 0.6,
  ...
  },
  {
    ...
    value:
      'VLCC TD3C TCE: $38,200/day. 3-month forward: $41,500/day. Premium vs spot: +8.6%. Source: Baltic Exchange Apr 16.',
    confidence: 0.91,
    freshness: 0.55,
  ...
  },
  {
    ...
    value:
      'APT29 phishing campaign neutralised. 3 accounts compromised; credentials rotated. No exfiltration confirmed. MTTR: 2h 18m.',
    confidence: 0.99,
    freshness: 0.28,
  ...
  },
  {
    ...
    value:
      'Series B — $12M ask at $60M pre-money. Revenue: $4.2M ARR. Rule of 40: 62. Key risk: customer concentration (top 3 = 58% ARR).',
    confidence: 0.88,
    freshness: 0.95,
  ...
  },
  {
    ...
    value:
      'Hull plating thickness, propeller blade condition, shaft alignment, electrical isolation test, BWTS sampling. Estimated 18-day window.',
    confidence: 0.93,
    freshness: 0.22,
  ...
  },
  {
    ...
    value:
      'CII A: ≤0.82 attained. CII B: 0.82–0.91. CII C: 0.91–1.00. CII D/E trigger corrective action plan. Source: IMO MEPC.82/21.',
    confidence: 0.99,
    freshness: 0.12,
...
function ConfidenceBar({ value, color }: { value: number; color: string }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
      ...
      <span style={{ fontSize: 10, color, fontWeight: 600, width: 32, textAlign: 'right' }}>
        {(value * 100).toFixed(0)}%
      </span>
    </div>
  );
...
export default function MemoryExplorer() {
  ...
  const stats = useMemo(
    () => ({
      ...
      avgConfidence: records.length
        ...
        : 0,
      avgFreshness: records.length
        ? records.reduce((s, r) => s + r.freshness, 0) / records.length
        : 0,
    }),
    [records],
  );
  ...
  return (
    <CognitiveLayout
      ...
      subtitle="Browse and search across all agent memory types. Inspect freshness, confidence, and provenance for every record."
    >
      <div
        style={{
          display: 'grid',
      ...
      >
        {[
          ...
          {
            label: 'Avg Freshness',
            value: `${(stats.avgFreshness * 100).toFixed(1)}%`,
            color: '#f59e0b',
          },
        ].map((m) => (
          <div
            ...
            {filtered.map((rec) => (
              ...
              >
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                      <span
                        style={{
                          ...
                          background: `${TYPE_COLORS[rec.type]}18`,
                          padding: '2px 7px',
                          borderRadius: 4,
                          textTransform: 'uppercase',
                          letterSpacing: 0.5,
                      ...
                      <span
                        style={{
                          fontSize: 10,
                          fontWeight: 700,
                          color: TIER_COLORS[rec.tier],
                          background: `${TIER_COLORS[rec.tier]}18`,
                          padding: '2px 7px',
                          borderRadius: 4,
                          textTransform: 'uppercase',
                          letterSpacing: 0.5,
                      ...
                      <span
                        style={{
                          fontSize: 10,
                          color: DOMAIN_COLORS[rec.domain] ?? DOMAIN_COLORS.default,
                          background: `${DOMAIN_COLORS[rec.domain] ?? DOMAIN_COLORS.default}15`,
                          padding: '2px 7px',
                          borderRadius: 4,
                        }}
                      >
                  ...
                  <div
                    style={{ fontSize: 10, color: '#475569', textAlign: 'right', flexShrink: 0 }}
                  >
                    <div>
