...
export default function EnterpriseStatePage() {
  ...
  const pending = liveData
    ? liveData.actions.filter((a) => a.status === 'pending').length
          ...
          >
            ...
            <div>
              <span className="text-sm font-bold" style={{ color: ACCENT }}>
                Enterprise State Board
              </span>
              <span className="text-xs ml-2" style={{ color: 'var(--color-fg-muted)' }}>
                Unified business health, causal intelligence, and action command surface across all
                domains
              </span>
            </div>
            <div
              className="flex items-center gap-4 ml-auto text-xs"
            ...
            {activeTab === 'impact' && (
              <div className="p-5">
                <div
                  ...
                  style={{ color: 'var(--color-fg-muted)' }}
                >
                  Cross-Domain Impact Map — Dependencies, risk flows, and value chains between
                  domains
                </div>
