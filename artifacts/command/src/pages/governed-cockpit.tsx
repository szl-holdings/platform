...
const PORTFOLIO_EVIDENCE: EvidenceSource[] = [
  {
    ...
    timestamp: FRESH_2M,
    excerpt:
      'PARAGON: 3 critical threat signals. SEXTANT: 6 fleet alerts. DOMAINE: 2 covenant triggers. Pulse: 1 executive dissent. Correlation matrix: 0.71 between PARAGON/Vessels threat clusters.',
  },
  {
    id: 'ev-cmd2',
