    ...
    <footer className="bg-black py-20 border-t border-white/10 text-white/60 text-sm">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-2">
          <Link href="/marketing" className="text-xl font-bold text-white tracking-tight mb-4 inline-block">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="/marketing/apps/aegis" className="hover:text-white transition-colors">Aegis</Link></li>
            <li><Link href="/marketing/apps/vessels" className="hover:text-white transition-colors">Vessels</Link></li>
            <li><Link href="/marketing/apps/terra" className="hover:text-white transition-colors">Terra</Link></li>
            <li><Link href="/marketing/apps/lyte" className="hover:text-white transition-colors">Lyte</Link></li>
            <li><Link href="/marketing/apps/prism" className="hover:text-white transition-colors">PRISM Counsel</Link></li>
          </ul>
        </div>
