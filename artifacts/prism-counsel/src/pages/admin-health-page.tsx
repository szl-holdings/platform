...
export default function AdminHealthPage() {
  ...
  const { data: metricsData } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiRequest<any>("GET", "/api/prism-counsel/admin/service-metrics");
      return res;
    },
  });
  ...
  const { data: incidentsData } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiRequest<any>("GET", "/api/prism-counsel/admin/incidents");
      return res;
    },
  ...
  const { data: onboardingData } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiRequest<any>("GET", "/api/prism-counsel/admin/onboarding");
      return res;
    },
