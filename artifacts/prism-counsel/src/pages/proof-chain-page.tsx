...
export default function ProofChainPage() {
  ...
  const { data: proofData, isLoading: pcLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiRequest<any>("GET", `/api/prism-counsel/matters/${matterId}/proof-chain`);
      return res;
    },
  ...
  const { data: contradictionData, isLoading: cdLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiRequest<any>("GET", `/api/prism-counsel/matters/${matterId}/contradictions`);
      return res;
    },
  ...
  const { data: auditData } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiRequest<any>("GET", `/api/prism-counsel/matters/${matterId}/audit-packets`);
      return res;
    },
