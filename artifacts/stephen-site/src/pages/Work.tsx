...
const projects = [
  ...
  { slug: "inca", year: "2024–present", title: "INCA Agentic Intelligence Platform", role: "Founder & Architect", description: "AI research and intelligence platform with explainable outputs, traceable decision workflows, and enterprise-grade multi-tenant architecture. Covers model management, signal intelligence, and full audit trail.", tags: ["AI Platform", "Research Infrastructure", "Enterprise"] },
  { slug: "szl-holdings", year: "2023–present", title: "SZL Holdings", role: "Founder & CEO", description: "Strategic technology portfolio spanning enterprise software, maritime intelligence, AI research, and consulting. Built to develop and scale a portfolio of domain-specific platforms.", tags: ["Portfolio Company", "Strategic Holding", "Enterprise Technology"] },
