        ...
        <div className="grid md:grid-cols-12 gap-14">
          <div className="md:col-span-5">
            ...
            <p className="text-muted-foreground text-[14px] leading-relaxed mb-8">
              I'm open to conversations about enterprise software architecture, AI infrastructure, advisory roles, and strategic partnerships within the SZL portfolio.
            </p>
            <div className="space-y-4 mb-10">
              {[
                "Advisory or consulting inquiries",
          ...
          <div className="md:col-span-7">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label className="block text-[11px] font-medium tracking-[0.12em] uppercase text-muted-foreground/50 mb-1.5">Type of inquiry</label>
                  <select
                    value={form.type}
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-lg text-[13px] font-semibold bg-primary hover:bg-primary/90 text-primary-foreground transition-colors"
                >
                  Send message
                </button>
              </form>
