...
const projectDeepDives = [
  ...
  { name: "Aegis Defense & Intelligence", tech: ["SOC Dashboard", "MITRE ATT&CK", "Threat Intel", "MSP Ops"], impact: "Unified defense command with SOC, XDR, and managed operations", status: "Live" },
  { name: "INCA AI Research Platform", tech: ["Neural Networks", "Model Benchmarking", "GPU Clusters", "Agentic Cortex"], impact: "Training, evaluating, and deploying custom AI models", status: "Live" },
