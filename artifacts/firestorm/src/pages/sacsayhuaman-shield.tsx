...
const SEED_DECISIONS: PolicyDecision[] = [
  ...
  { id: "pd7", timestamp: new Date(Date.now() - 130000), agent: "Alloy Predictor", domain: "Alloy Predict", action: "Access Beacon signals for scenario model update", actionType: "data_access", decision: "permitted", policyRule: "CROSS-DOMAIN-READ-ALLOY-001", riskScore: 18, details: "Alloy Predictor has read access to Beacon telemetry for model inputs." },
...
function generateDecision(): PolicyDecision {
  ...
  const domains = ["Vessels", "Rosie", "Beacon", "Alloy Predict", "SZL Holdings", "Stephen", "Carlota Jo"];
  const actions = [
