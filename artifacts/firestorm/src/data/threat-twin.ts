...
export interface ExposureTwin {
  id: string;
  name: string;
  type: "vulnerability_cluster" | "misconfiguration" | "identity_gap" | "third_party_risk" | "compliance_gap";
  severity: ThreatSeverity;
  exposureLevel: ExposureLevel;
  affectedAssetCount: number;
  affectedAssets: string[];
...
export const threatTwins: ThreatTwin[] = [
  {
    ...
    sourceIndicators: ["Anomalous RPC call chain", "Credential enumeration attempt", "Process injection artifact"],
    ...
    approvals: [
      {
        ...
        description: "SOC Lead requesting authorization to isolate compromised cluster. Estimated service disruption: 15-30 mins.",
        status: "pending",
        priority: "critical",
        requestedBy: "SOC Lead",
        requestedAt: hoursAgo(2),
        comments: [
          { author: "CISO", body: "Approved in principle. Confirm blast radius before executing.", at: hoursAgo(1), internal: true },
        ],
      },
    ],
    auditTrail: [
      { id: "taud-001", threatId: "threat-001", action: "threat_detected", actor: "siem.correlation", actorRole: "system", at: hoursAgo(4) },
      { id: "taud-002", threatId: "threat-001", action: "assigned_to_analyst", actor: "SOC Manager", actorRole: "manager", at: hoursAgo(3.5) },
      { id: "taud-003", threatId: "threat-001", action: "containment_requested", actor: "SOC Lead", actorRole: "analyst", at: hoursAgo(2) },
    ],
    externalDataConnectors: [
  ...
  },
  {
    ...
    sourceIndicators: ["Impossible travel detected", "MFA fatigue pattern", "Conditional access policy circumvention"],
    ...
    approvals: [],
    auditTrail: [
      { id: "taud-010", threatId: "threat-002", action: "threat_detected", actor: "identity.monitor", actorRole: "system", at: hoursAgo(18) },
      { id: "taud-011", threatId: "threat-002", action: "triage_started", actor: "Identity Security Analyst", actorRole: "analyst", at: hoursAgo(16) },
    ],
    externalDataConnectors: [
      { name: "VirusTotal", type: "threat_intel", status: "not_connected" },
...
export const exposureTwins: ExposureTwin[] = [
  {
    ...
    description: "Two critical CVEs unpatched on production API cluster. Remote code execution risk. Patch window needed.",
  ...
  },
  {
    ...
    affectedAssets: ["asset-002"],
    description: "18% of privileged accounts lack enforced MFA. Policy exists but enforcement gaps in legacy SSO.",
    remediationStatus: "in_progress",
    dueDate: daysAgo(-7),
    owner: "IT Security",
  ...
  },
  {
    ...
    description: "2 S3 buckets found with public read access enabled. Contents appear to be non-sensitive (static assets). Risk accepted pending review.",
...
export const incidentReadiness: IncidentReadiness[] = [
  ...
  },
  {
    ...
    issues: ["IR playbook last updated 6 months ago", "Containment authorization flow needs approval"],
    pendingActions: 2,
  },
  {
    id: "read-003",
  ...
  },
  {
    ...
    issues: ["3 governance reviews overdue", "Board reporting cadence lapsed", "Policy exceptions not formally approved"],
    pendingActions: 5,
  },
];
...
export const aegisWhatChanged: AegisWhatChangedEvent[] = [
  {
    ...
    detail: "Anomalous RPC chain and credential enumeration detected. Confidence 87%. SOC Lead assigned. Containment action pending approval.",
    severity: "critical",
  ...
  },
  {
    ...
    detail: "SOC Lead requested network isolation of prod-api-cluster-01. CISO acknowledged. Awaiting final authorization.",
    severity: "critical",
    source: "Approvals",
  ...
  },
  {
    ...
    detail: "Impossible travel + MFA fatigue pattern detected. Identity Security Analyst assigned. Triage in progress.",
    severity: "warning",
  ...
  },
  {
    ...
    detail: "Two critical CVEs are 2 days past remediation deadline. Risk score: 94. Platform Engineering team alerted.",
    severity: "critical",
...
export const actionQueue: ActionQueueItem[] = [
  ...
  },
  {
    ...
    description: "Prepare and deliver overdue board security briefing. Include threat landscape and posture summary.",
    type: "governance",
    priority: "medium",
    status: "open",
    assignedTo: "CISO",
