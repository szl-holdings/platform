...
function EcosystemTab() {
  const apps = [
    ...
    { name: 'KORA — Decision Intelligence', path: '/lyte/', category: 'Intelligence', desc: 'AI-powered decision intelligence and analytics hub' },
    { name: 'Pulse — Executive Briefing', path: '/pulse/', category: 'Intelligence', desc: 'Automated executive briefing and signal aggregation' },
    { name: 'SEXTANT — Maritime Intelligence', path: '/vessels/', category: 'Domain', desc: 'Real-time maritime fleet tracking and weather risk' },
    { name: 'Sentra — Cyber Resilience', path: '/sentra/', category: 'Domain', desc: 'Security operations and threat detection' },
    { name: 'DOMAINE — Real Estate Intelligence', path: '/terra/', category: 'Domain', desc: 'Real estate market intelligence and investment analytics' },
