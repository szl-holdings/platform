...
const SLIDES = [
  {
    ...
    title: "Stephen Lutar",
    subtitle:
      "Investor, founder, and independent thinker. Explore essays, venture perspectives, and reflections on building at the frontier.",
    accent: "#6366F1",
  },
  {
    ...
    subtitle:
      "Deep essays on technology, capital allocation, and the future of enterprise software. Updated regularly with original analysis.",
    accent: "#8B5CF6",
  },
  {
    icon: "zap" as const,
    ...
    subtitle:
      "A curated view of early-stage companies and theses. See where conviction meets capital.",
    accent: "#06B6D4",
  },
];
    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom + 24 }]}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.nextButton} onPress={handleNext}>
          ...
          <Feather name={isLast ? "check" : "arrow-right"} size={18} color="#0a0a0a" />
        </TouchableOpacity>
      </View>
    </View>
  );
