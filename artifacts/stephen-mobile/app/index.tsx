...
export default function Home() {
  ...
  // Build thesis content: CMS if available, otherwise static fallback
  const thesisItems =
                  ...
                  {CONTACT_PURPOSE_OPTIONS.map((p, idx) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        {
                          borderColor:
                            activePurposeIdx === idx ? colors.silver : colors.border,
                          backgroundColor:
                            activePurposeIdx === idx ? colors.silverDim : colors.card,
                        },
                      ]}
                    >
                      <Text
                        style={[
                          ...
                          {
                            color:
                              activePurposeIdx === idx ? colors.silver : colors.mutedForeground,
                          },
                        ]}
                      >
                        {p.label}
...
function HeroPulseRings({ colors }: { colors: ReturnType<typeof useColors> }) {
  ...
  return (
    <View style={styles.pulseContainer} pointerEvents="none">
      <Animated.View
        style={[styles.pulseRing, styles.pulseRing1, { borderColor: colors.silver }, ring1Style]}
      />
      <Animated.View
        style={[styles.pulseRing, styles.pulseRing2, { borderColor: colors.silver }, ring2Style]}
      />
    </View>
  );
}
...
function VentureCard({
  ...
  return (
    <TouchableOpacity
      ...
      style={[
        styles.ventureCard,
        { backgroundColor: colors.card, borderColor: colors.border, width: VENTURE_CARD_WIDTH },
      ]}
    >
      {/* Screenshot mockup */}
      ...
      <View style={styles.ventureCardInner}>
        ...
        <Text style={[styles.ventureDesc, { color: colors.mutedForeground }]}>
          {venture.description}
        </Text>
        ...
        <View style={styles.ventureActions}>
          ...
          <TouchableOpacity
            style={styles.viewLiveIconBtn}
            onPress={() => onViewLive(venture.url)}
          >
...
function CaseStudyCard({
  ...
  return (
    <TouchableOpacity
      ...
      style={[
        styles.contentCard,
        { backgroundColor: colors.card, borderColor: colors.border, width: CONTENT_CARD_WIDTH },
      ]}
    >
      ...
      <Text style={[styles.csTitle, { color: colors.foreground }]} numberOfLines={2}>
        {study.title}
      </Text>
      {study.summary ? (
        <Text style={[styles.csSummary, { color: colors.mutedForeground }]} numberOfLines={4}>
          {study.summary}
        </Text>
      ) : null}
      {study.outcome ? (
        <View style={[styles.outcomeRow, { borderTopColor: colors.border }]}>
          ...
          <Text style={[styles.outcomeText, { color: colors.mutedForeground }]} numberOfLines={2}>
            {study.outcome}
          </Text>
        </View>
      ) : null}
    ...
    >
      <View style={styles.articleContent}>
        ...
        {(article.excerpt ?? article.summary) ? (
          <Text
            style={[styles.articleExcerpt, { color: colors.mutedForeground }]}
            numberOfLines={2}
          >
            {article.excerpt ?? article.summary}
          </Text>
        ...
        {article.readingTime ? (
          <Text style={[styles.articleMetaText, { color: colors.mutedForeground }]}>
...
function ThesisCard({
  ...
  return (
    <View
      style={[
        styles.thesisCard,
        { backgroundColor: colors.card, borderColor: colors.border, width: THESIS_CARD_WIDTH },
      ]}
    >
      ...
      <Text style={[styles.thesisContent, { color: colors.mutedForeground }]}>
        {point.content}
      </Text>
    </View>
  );
    ...
    <Animated.View entering={FadeInDown.delay(index * 80).springify()} style={styles.milestoneRow}>
      ...
      <View style={styles.milestoneContent}>
        ...
        <View style={styles.milestoneCompanyRow}>
          ...
          >
            <Text style={[styles.companyLogoText, { color: milestone.logoColor }]}>
              {milestone.logoInitials}
            </Text>
          </View>
          <Text style={[styles.milestoneCompany, { color: colors.silverSubtle }]}>
            {milestone.company}
          </Text>
        </View>
        <Text style={[styles.milestoneEvent, { color: colors.foreground }]}>
          {milestone.event}
        </Text>
        <Text style={[styles.milestoneDetail, { color: colors.mutedForeground }]}>
          {milestone.detail}
        </Text>
        <View
          style={[
            styles.achievementBadge,
            { backgroundColor: colors.silverDim, borderColor: colors.silverBorder },
          ]}
        >
...
function SectionHeader({
  ...
  return (
    <View style={styles.sectionHeader}>
      <Text style={[styles.sectionLabel, { color: colors.silverSubtle }]}>
        {label.toUpperCase()}
      </Text>
...
const styles = StyleSheet.create({
  ...
  companyLogoText: { fontSize: 9, fontFamily: "Inter_600SemiBold", letterSpacing: 0.5 },
  achievementBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  resetBtn: { borderWidth: 1, borderRadius: 6, paddingVertical: 8, paddingHorizontal: 16 },
  ...
  purposeRow: { flexDirection: "row", gap: 8, marginBottom: 4 },
  purposeChip: {
    borderWidth: 1,
    borderRadius: 6,
    paddingHorizontal: 14,
  ...
  shareText: { fontSize: 12, fontFamily: "Inter_400Regular" },

  // Venture screenshot mockup
  screenshotFrame: {
    borderWidth: 1,
    borderRadius: 8,
    overflow: "hidden",
  ...
  screenshotUrl: { fontSize: 8, fontFamily: "Inter_400Regular" },
  screenshotContent: { flexDirection: "row", padding: 8, height: 80 },
  screenshotSidebar: { width: 28, gap: 6 },
  screenshotSidebarItem: { height: 8, borderRadius: 2, flex: 0 },
  screenshotRow: { borderRadius: 2, marginBottom: 6 },
  screenshotStatRow: { flexDirection: "row", gap: 4, marginTop: 4 },
  screenshotStat: { flex: 1, borderWidth: 1, borderRadius: 4, padding: 4, alignItems: "center" },
  screenshotStatVal: { fontSize: 10, fontFamily: "Inter_600SemiBold" },
  screenshotStatLabel: { fontSize: 7, fontFamily: "Inter_400Regular", textAlign: "center" },
});
