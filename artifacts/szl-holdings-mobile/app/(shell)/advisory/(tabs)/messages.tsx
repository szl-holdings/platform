...
function ReadReceipt({ status }: { status?: 'sent' | 'delivered' | 'read' }) {
  ...
  return (
    ...
    >
      ...
      {isRead && (
        <Text
          style={{ fontSize: 8, fontFamily: 'Inter_300Light', color: colors.gold, marginLeft: 2 }}
        >
          Read
        </Text>
      )}
  ...
  return (
    <View style={[styles.bubbleRow, isClient && styles.bubbleRowRight]}>
      ...
      <View style={[styles.bubbleWrap, isClient && styles.bubbleWrapRight]}>
        {msg.date && (
          <Text style={[styles.dateLabel, { color: colors.mutedForeground }]}>{msg.date}</Text>
        )}
        <View
          style={[
            styles.bubble,
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { paddingTop: topPad + 12 }]}>
        <View>
          <Text style={[styles.eyebrow, { color: colors.goldSubtle }]}>DIRECT LINE</Text>
        ...
        {sending && (
          <View style={[styles.typingRow, { paddingLeft: 20 }]}>
            ...
            <View
              style={[
                styles.typingBubble,
                { backgroundColor: colors.surfaceElevated, borderColor: colors.creamFaint },
              ]}
            >
