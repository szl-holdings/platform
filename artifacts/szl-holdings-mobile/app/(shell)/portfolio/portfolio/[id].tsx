...
> = {
  ...
  alloy: {
    ...
    description:
      'Alloy is the execution fabric that powers every automation, prediction, and approval workflow across the SZL platform. Sub-200ms latency, 12,400+ scenario models, and a human-in-the-loop approval layer trusted by enterprise operators.',
