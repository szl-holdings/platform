  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={fetching} onRefresh={onRefresh} tintColor={colors.gold} />
        }
      >
        <View style={styles.header}>
          <Text style={[styles.eyebrow, { color: colors.goldSubtle }]}>TRUST CENTER</Text>
          <Text style={[styles.title, { color: colors.cream }]}>Security &{'\n'}Compliance</Text>
          <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>
            SZL Holdings maintains enterprise-grade compliance across all platforms. Last audit: Q1
            2026.
          </Text>
        </View>
        ...
        <View style={styles.metricsRow}>
          {[
            {
              label: 'Frameworks',
              value: `${certifiedCount}/${COMPLIANCE_FRAMEWORKS.length}`,
              color: '#10b981',
            },
        ...
        <View style={[styles.section, { borderTopColor: colors.borderSubtle }]}>
          <Text style={[styles.sectionLabel, { color: colors.goldSubtle }]}>SECURITY POLICIES</Text>
          <View style={[styles.policyList, { borderColor: colors.borderSubtle }]}>
            {POLICIES.map((policy, i) => (
              <Pressable key={policy.title} onPress={() => handlePolicyRequest(policy.title)}>
                <View
                  style={[
                    styles.policyRow,
                    {
                ...
                >
                  ...
                  <Text style={[styles.policyTitle, { color: colors.cream }]}>{policy.title}</Text>
        ...
        >
          ...
          <Pressable onPress={() => Linking.openURL('mailto:security@szlholdings.com')}>
            <Feather name="chevron-right" size={16} color={colors.goldSubtle} />
          </Pressable>
        </View>

        <View style={[styles.section, { borderTopColor: colors.borderSubtle }]}>
          <Text style={[styles.sectionLabel, { color: colors.goldSubtle }]}>PROFILE</Text>
          <View
            style={[
              styles.userCard,
              { backgroundColor: colors.card, borderColor: colors.borderSubtle },
