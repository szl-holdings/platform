...
const portfolioCommands: SpotlightCommand[] = [
  {
    id: 'nav-command',
    label: 'Command',
    description: 'Executive command overview',
    icon: '◆',
    group: 'Navigate',
    action: () => router.push('/(shell)/portfolio/(tabs)'),
  },
  {
    id: 'nav-portfolio',
    label: 'Portfolio',
    description: 'Holdings & venture performance',
    icon: '💼',
    group: 'Navigate',
    action: () => router.push('/(shell)/portfolio/(tabs)/portfolio'),
  },
  {
    id: 'nav-investors',
    label: 'Investors',
    description: 'Investor relations & reports',
    icon: '📈',
    group: 'Navigate',
    action: () => router.push('/(shell)/portfolio/(tabs)/investor'),
  },
  {
    id: 'nav-analytics',
    label: 'Analytics',
    description: 'MRR, ARR, churn & funnel metrics',
    icon: '📊',
    group: 'Navigate',
    action: () => router.push('/(shell)/portfolio/(tabs)/analytics'),
  },
  {
    id: 'nav-ai',
    label: 'Navigator AI',
    description: 'Executive intelligence assistant',
    icon: '🤖',
    group: 'Navigate',
    action: () => router.push('/(shell)/portfolio/(tabs)/agent-chat'),
  },
  {
    id: 'nav-map',
    label: 'Portfolio Map',
    description: 'View portfolio properties on satellite map',
    icon: '🗺️',
    group: 'Navigate',
    action: () => router.push('/(shell)/portfolio/(tabs)/map'),
  },
];
