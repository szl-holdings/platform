  ...
  return (
    <View style={styles.agentRow}>
      <View
        style={[
          styles.agentIcon,
          { backgroundColor: `${agent.color}15`, borderColor: `${agent.color}25` },
        ]}
      >
            ...
            {AGENT_DEFS.map((a, i) => {
              ...
              return (
                <View key={a.id} style={styles.healthRow}>
                  <View
                    style={[styles.healthDot, { backgroundColor: isHealthy ? GREEN : AMBER }]}
                  />
                  <Text style={styles.healthName}>{a.name}</Text>
                  <View style={styles.healthRight}>
                    <Text style={[styles.healthScore, { color: isHealthy ? GREEN : AMBER }]}>
                      {score}/100
                    </Text>
