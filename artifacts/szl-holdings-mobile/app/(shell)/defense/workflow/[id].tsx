...
export default function WorkflowDetailScreen() {
  ...
  const decideApproval = useOptimisticMutation<
    unknown,
    Error,
    { approvalId: number; decision: 'approved' | 'rejected'; note?: string }
  >({
    queryKey: runQueryKey,
          ...
          <>
            ...
            {pendingApprovals.map((approval) => (
              <SwipeableApproval
                ...
                colors={colors}
                deciding={
                  decideApproval.isPending && decideApproval.variables?.approvalId === approval.id
                }
                ...
                return (
                  ...
                  >
                    ...
                    <View style={styles.stepContent}>
                      ...
                      {step.outputSummary && (
                        <Text
                          style={[styles.stepOutput, { color: colors.mutedForeground }]}
                          numberOfLines={2}
                        >
                          {step.outputSummary}
                        </Text>
      ...
      <View
        style={[
          styles.approvalCard,
          {
            ...
            borderColor: deciding ? 'rgba(139,92,246,0.5)' : 'rgba(139,92,246,0.2)',
          },
        ]}
      >
        ...
        <View style={styles.approvalQuickActions}>
          ...
          <Pressable
            ...
            onPress={() => {
              ...
              Alert.alert(
                'Escalate',
                'This approval will be rejected and flagged for senior review.',
                [
                  { text: 'Cancel', style: 'cancel' },
                  {
                    text: 'Escalate',
                    onPress: () => onDecide(approval.id, 'rejected', 'escalated_to_senior'),
                  },
                ],
              );
            }}
