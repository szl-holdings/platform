...
const TACTICS = [
  {
    ...
    name: 'Initial Access',
    short: 'Init',
    techniques: ['T1566.001', 'T1190', 'T1133', 'T1078'],
  },
  {
    id: 'TA0002',
    name: 'Execution',
    short: 'Exec',
    techniques: ['T1059.001', 'T1059.003', 'T1204', 'T1053'],
  },
  {
    id: 'TA0003',
    name: 'Persistence',
    short: 'Persist',
    techniques: ['T1547', 'T1136', 'T1505.003', 'T1078'],
  },
  {
    id: 'TA0004',
    name: 'Privilege Esc.',
    short: 'PrivEsc',
    techniques: ['T1548', 'T1134', 'T1055', 'T1611'],
  },
  {
    id: 'TA0005',
    name: 'Defense Evasion',
    short: 'Evasion',
    techniques: ['T1070', 'T1036', 'T1027', 'T1562'],
  },
  {
    id: 'TA0006',
    name: 'Credential Access',
    short: 'Creds',
    techniques: ['T1003.001', 'T1110.001', 'T1555'],
  },
  {
    id: 'TA0007',
    name: 'Discovery',
    short: 'Discov',
    techniques: ['T1087', 'T1082', 'T1046', 'T1083'],
  },
  {
    id: 'TA0008',
    name: 'Lateral Movement',
    short: 'Lateral',
    techniques: ['T1021.002', 'T1550', 'T1570'],
  },
  {
    id: 'TA0010',
    name: 'Exfiltration',
    short: 'Exfil',
    techniques: ['T1041', 'T1048.001', 'T1567.002'],
  },
  {
    id: 'TA0040',
    name: 'Impact',
    short: 'Impact',
    techniques: ['T1486', 'T1485', 'T1490', 'T1489'],
  },
];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          <Text style={[styles.coverageText, { color: colors.emerald }]}>
            ...
            {[
              ...
              >
                <Text
                  style={[
                    styles.statValue,
                    { color: stat.color, fontFamily: 'SpaceGrotesk_700Bold' },
                  ]}
                >
                  {stat.value}
                </Text>
              ...
              {TACTICS.map((tactic) => (
                <View key={tactic.id} style={{ width: 70 }}>
                  <Text
                    style={[
                      styles.tacticLabel,
                      { color: colors.red, fontFamily: 'Inter_500Medium' },
                    ]}
                    numberOfLines={1}
                  >
                    {tactic.short}
                  ...
                  {tactic.techniques.map((techId) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Text
                          style={[styles.heatCount, { color: tc, opacity: count === 0 ? 0.3 : 1 }]}
                        >
                          {count}
                        </Text>
                      </TouchableOpacity>
          ...
          >
              ...
              <View style={[styles.modalStat, { backgroundColor: colors.redDim }]}>
                <Text
                  style={[
                    ...
                    { color: colors.red, fontFamily: 'SpaceGrotesk_700Bold' },
                  ]}
                >
              ...
              <View style={[styles.modalStat, { backgroundColor: colors.blueDim }]}>
                <Text
                  style={[
                    ...
                    {
                      color:
                        selectedTech?.detection?.coverageStatus === 'detected'
                          ? colors.emerald
                          : colors.red,
                ...
                >
                  {selectedTech?.detection?.coverageStatus === 'detected'
                    ? 'Full'
                    : selectedTech?.detection?.coverageStatus === 'partial'
                      ? 'Part'
                      : 'None'}
                </Text>
                <Text style={[styles.modalStatLabel, { color: colors.mutedForeground }]}>
            ...
            {!selectedTech?.detection && (
              ...
              >
                ...
                <Text style={[styles.gapText, { color: colors.red }]}>
                  No active detection — coverage gap identified
                </Text>
              </View>
            )}
            ...
            {relatedIncidents.slice(0, 5).map((inc) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.relatedRow,
                    { backgroundColor: colors.navySurface, borderColor: colors.border },
                  ]}
                  onPress={() => {
