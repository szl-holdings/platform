          ...
          return (
            <TouchableOpacity
              ...
              style={[
                styles.filterChip,
                {
                  backgroundColor: active ? `${stColor}18` : colors.navyLight,
                  borderColor: active ? `${stColor}40` : colors.border,
                },
              ]}
            ...
            >
              <Text
                style={[
                  styles.filterText,
                  {
                    color: active ? stColor : colors.mutedForeground,
                    fontFamily: 'Inter_500Medium',
                  },
                ]}
              >
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.findingCard,
                  {
                    ...
                    borderColor: isCrit ? colors.redBorder : colors.border,
                  },
                ]}
                onPress={() => {
