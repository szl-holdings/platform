...
const AGENTS = [
  ...
  { id: 'alloy', name: 'Counsel', role: 'Orchestration', icon: 'git-merge', color: giProductAccent.holdings },
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      agentName: 'Helmsman',
      content:
        "Helmsman online. AIS feeds active. I monitor your fleet, assess route risk, and track maritime threats. What's your query?",
  ...
  const sendMessage = useCallback(async () => {
    ...
    try {
      ...
      const fallbacks: Record<string, string> = {
        helmsman:
          'Fleet status: 12 vessels active, 2 in port. No collision risks detected. Weather window clear for Atlantic routes.',
    ...
    >
      <View style={styles.header}>
        ...
        <View style={styles.livePill}>
          ...
          <Text style={styles.liveText}>AIS LIVE</Text>
        </View>
      </View>
      {showPicker && (
      ...
      >
        ...
        {isLoading && (
          <View style={styles.typing}>
            ...
            <Text style={styles.typingText}>{selectedAgent.name} scanning…</Text>
          </View>
        )}
      </ScrollView>
      <View style={[styles.inputBar, { paddingBottom: insets.bottom + 8 }]}>
        <TextInput
          ...
          placeholder="Ask Helmsman…"
          placeholderTextColor={TEXT_DIM}
          multiline
          maxLength={2000}
        />
        <TouchableOpacity
          style={[styles.sendBtn, (!input.trim() || isLoading) && styles.sendOff]}
          onPress={sendMessage}
