                ...
                <View style={styles.cardBody}>
                  ...
                  <View style={styles.metricsRow}>
                    {v.metrics.map((m) => (
                      <View
                        key={m.label}
                        style={[styles.metricChip, { borderColor: v.color + "30", backgroundColor: v.color + "0a" }]}
                      >
                  ...
                  <View style={styles.cardActions}>
                    ...
                    <TouchableOpacity
                      style={[styles.btn, styles.btnPrimary, { backgroundColor: v.color + "18", borderColor: v.color + "40" }]}
...
const styles = StyleSheet.create({
  ...
  metricLabel: { fontSize: 9, color: TEXT_DIM, marginTop: 1, textTransform: "uppercase", letterSpacing: 0.5 },
