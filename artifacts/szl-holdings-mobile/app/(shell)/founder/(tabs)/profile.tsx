      ...
      >
        <View style={styles.heroSection}>
          ...
          <Text style={styles.bio}>
            Builder of domain-specific enterprise platforms across maritime intelligence, cybersecurity, real estate, and AI operations. Infrastructure-first, operator-minded.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          {SOCIAL_LINKS.map((link) => (
            ...
            >
              ...
              <Feather name="external-link" size={12} color={TEXT_DIM} style={{ marginLeft: "auto" }} />
            </TouchableOpacity>
          ))}
        </View>
