  ...
  const sendMessage = useCallback(async () => {
    ...
    try {
      ...
      const fallbacks: Record<string, string> = {
        beacon:
          'Signal analysis complete. SLO burn rate normal. Error budget: 98.3% remaining. No anomalies in last 4h.',
    ...
    >
      <View style={styles.header}>
        ...
        <View style={styles.pill}>
          ...
          <Text style={styles.pillText}>AIOPS</Text>
        </View>
      </View>
      {showPicker && (
      ...
      >
        ...
        {isLoading && (
          <View style={styles.typing}>
            ...
            <Text style={styles.typingText}>{selectedAgent.name} analyzing…</Text>
          </View>
        )}
      </ScrollView>
      <View style={[styles.bar, { paddingBottom: insets.bottom + 8 }]}>
        <TextInput
          ...
          placeholder="Query your AIOps agents…"
