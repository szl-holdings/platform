                ...
                >
                  <Text
                    style={[
                      ...
                      { color: hour === h ? ACCENT : colors.mutedForeground },
                    ]}
                  >
            ...
            {MINUTES.map((m) => (
              ...
              >
                <Text
                  style={[
                    styles.pickerItemText,
                    { color: minute === m ? ACCENT : colors.mutedForeground },
                  ]}
                >
          ...
          {prefs.alerts_quiet_hours_enabled && (
            <View style={{ gap: 8 }}>
              ...
              <Text style={[styles.helperText, { color: colors.mutedForeground }]}>
                Quiet window: {format12h(prefs.alerts_quiet_hours_start)} →{' '}
                {format12h(prefs.alerts_quiet_hours_end)} in your local time. Set your time zone in
                Settings → Time Zone so server alerts honor this window. Critical approvals always
                break through.
              </Text>
            </View>
          )}
