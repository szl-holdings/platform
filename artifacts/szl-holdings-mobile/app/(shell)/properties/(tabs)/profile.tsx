    ...
    <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
      ...
      {NYC_BOROUGHS.map((b, i) => (
        ...
        >
          ...
          <Text style={[styles.boroughUnits, { color: colors.mutedForeground }]}>
            {b.units} units
          </Text>
          <Text style={[styles.boroughPrice, { color: colors.gold }]}>{b.avgPrice}</Text>
          <Text
            style={[styles.boroughChange, { color: b.positive ? colors.emerald : colors.rose }]}
          >
            {b.change}
          </Text>
        </View>
    ...
    >
      ...
      <View style={{ paddingHorizontal: 20 }}>
        <Pressable
          ...
          style={[
            styles.signOutBtn,
            { backgroundColor: 'rgba(192,80,58,0.08)', borderColor: 'rgba(192,80,58,0.2)' },
          ]}
        >
