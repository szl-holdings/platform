...
const propertiesCommands: SpotlightCommand[] = [
  { id: "nav-map", label: "Property Map", description: "Interactive real estate map", icon: "🗺", group: "Navigate", action: () => router.push("/(shell)/properties/(tabs)") },
...
function NativeTabLayout() {
  ...
  useEffect(() => { setActiveWorkspace("properties"); }, [setActiveWorkspace]);
  return (
    <NativeTabs>
    ...
    <Tabs screenOptions={tabBarScreenOptions}>
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Properties",
          tabBarIcon: ({ color }) =>
            isIOS ? <SymbolView name="building.2.fill" tintColor={color} size={22} /> : <Feather name="home" size={20} color={color} />,
        }}
      />
      <Tabs.Screen
        name="pipeline"
