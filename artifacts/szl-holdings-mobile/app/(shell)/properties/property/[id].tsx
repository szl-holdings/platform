  ...
  if (!property) {
    return (
      ...
      >
        ...
        >
          <Text style={{ color: colors.cream, fontFamily: 'Inter_500Medium', fontSize: 13 }}>
            Go back
          </Text>
        </Pressable>
      </View>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.topBar, { paddingTop: topPad + 12 }]}>
        ...
        <Pressable
          ...
          style={[
            styles.backBtn,
            {
              backgroundColor: watchlisted ? colors.goldDim : 'rgba(255,255,255,0.06)',
              borderColor: watchlisted ? colors.goldBorder : colors.border,
            },
          ]}
        >
          <Feather
            name="bookmark"
            size={16}
            color={watchlisted ? colors.gold : colors.mutedForeground}
          />
        </Pressable>
      </View>
      ...
      >
        <View style={styles.heroSection}>
          ...
          <Text style={[styles.borough, { color: colors.mutedForeground }]}>
            {property.borough}
          </Text>
          ...
          <View style={styles.heroStats}>
            ...
            >
              ...
              <Text style={[styles.heroStatValue, { color: scoreColor }]}>
            ...
            >
              ...
              <Text style={[styles.heroStatValue, { color: colors.cream }]}>
                {property.daysInDistress}
              </Text>
            </View>
          </View>
        </View>
          ...
          <View style={[styles.section, { borderColor: colors.border }]}>
            ...
            <View style={styles.finRow}>
              ...
              >
                ...
                <Text style={[styles.finValue, { color: colors.rose }]}>
                  {formatCurrency(property.debt)}
                </Text>
              </View>
              <View
                style={[
              ...
              >
                ...
                <Text style={[styles.finValue, { color: colors.emerald }]}>
                  {formatCurrency(property.equity ?? 0)}
                </Text>
              </View>
              <View
                style={[
              ...
              >
                ...
                <Text style={[styles.finValue, { color: colors.cream }]}>
                  {Math.round(((property.debt ?? 0) / property.estimatedValue) * 100)}%
                </Text>
              </View>
            </View>
          </View>
          ...
          {(property.comparables ?? []).length === 0 ? (
            ...
            <>
              {(property.comparables ?? []).map((comp, i) => (
                ...
                >
                  <View style={{ flex: 1 }}>
                    <Text style={[styles.compAddress, { color: colors.cream }]}>
                      {comp.address}
                    </Text>
                    <Text style={[styles.compMeta, { color: colors.mutedForeground }]}>
                      {comp.distance} · {comp.sqft} sf · {comp.date}
                    </Text>
                  </View>
                  <View style={{ alignItems: 'flex-end' }}>
                    <Text style={[styles.compPrice, { color: colors.gold }]}>{comp.sold}</Text>
                    <Text style={[styles.compPpsf, { color: colors.mutedForeground }]}>
                      {comp.ppsf}
                    </Text>
                  </View>
                </View>
              ...
              {property.squareFeet && (
                ...
                >
                  ...
                  <Text style={[styles.marketNoteText, { color: colors.emerald }]}>
                    Subject: ${Math.round(property.estimatedValue / property.squareFeet)}/sf
                  </Text>
                </View>
              )}
            </>
        ...
        <View style={styles.actionGrid}>
          <Pressable
            ...
            style={[
              ...
              {
                borderColor: watchlisted ? colors.goldBorder : colors.border,
                backgroundColor: watchlisted ? colors.goldDim : 'rgba(255,255,255,0.02)',
              },
            ]}
          >
            <Feather
          ...
          <Pressable
            ...
            style={[
              styles.actionGridBtn,
              {
                borderColor: 'rgba(192,80,58,0.3)',
                backgroundColor: 'rgba(192,80,58,0.08)',
                opacity: createLeadMutation.isPending ? 0.6 : 1,
              },
            ]}
          >
            <Feather name="user-plus" size={16} color={colors.rose} />
            <Text style={[styles.actionGridText, { color: colors.rose }]}>
              {createLeadMutation.isSuccess ? 'Lead Created' : 'Create Lead'}
            </Text>
          </Pressable>
          <Pressable
            onPress={() => {
          ...
          >
            ...
            <Text style={[styles.actionGridText, { color: colors.mutedForeground }]}>
              Share Report
            </Text>
          </Pressable>
        </View>
        ...
        >
          ...
          <Text style={[styles.downloadBtnText, { color: colors.gold }]}>
            Add to Pipeline &amp; Download PDF Report
          </Text>
        </Pressable>
      </ScrollView>
    </View>
