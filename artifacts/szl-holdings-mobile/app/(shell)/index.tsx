  ...
  const brief = briefingData ?? {
    ...
    signals: [
      ...
      },
      {
        ...
        summary: '12 DOMAINE properties and 8 PRISM contracts flagged via signal chain.',
        count: 2,
      },
      {
        domain: 'szl-holdings',
        ...
        summary: 'Portfolio rebalance signal chain triggered across DOMAINE, SEXTANT, and fund ops.',
        count: 5,
      },
    ],
  };
