    ...
    <View style={[styles.container, { backgroundColor: colors.background ?? "#0a0a0a" }]}>
      <View style={[styles.header, { paddingTop: insets.top + 12, borderBottomColor: ACCENT + "30" }]}>
        <View style={styles.headerLeft}>
          ...
          <View>
            <Text style={[styles.screenTitle, { color: ACCENT }]}>Portfolio Intel</Text>
            <Text style={styles.screenSubtitle}>Cross-domain signal aggregation · SZL Holdings</Text>
          </View>
        </View>
      </View>
      <IntelligenceFeed
