...
const VENTURES: Record<string, {
  ...
  aegis: {
    ...
    description: "Aegis is a unified defense and intelligence command platform purpose-built for organizations where a single breach can be existential. Real-time threat intelligence, AI-simulated adversary campaigns, and NATO-aligned targeting workflows in a single operator interface.",
  ...
  vessels: {
    ...
    description: "Vessels delivers maritime intelligence for commodity traders, compliance teams, and defense logistics. Dark vessel detection, port congestion forecasting, and AIS prediction with a 34-day lead time advantage over competitors.",
  ...
  terra: {
    ...
    description: "Terra delivers real estate intelligence for institutional investors and operators in NYC and beyond. Distress property tracking, portfolio risk analysis, and hyperlocal pricing signals with two-percentage-point accuracy.",
  ...
  lyte: {
    ...
    description: "Lyte is the SZL execution nervous system — business observability that detects signals in under 4 minutes across commerce, infrastructure, and human behavior. AI-native anomaly forecasting identifies what will fail before it does.",
  ...
  alloy: {
    ...
    description: "Alloy is the execution fabric that powers every automation, prediction, and approval workflow across the SZL platform. Sub-200ms latency, 12,400+ scenario models, and a human-in-the-loop approval layer trusted by enterprise operators.",
  ...
  "carlota-jo": {
    ...
    description: "Carlota Jo is a private advisory and lifestyle management platform for ultra-high-net-worth principals. AI-powered with human expert oversight — zero-latency tasks meet impeccable judgment and discretion.",
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        <View style={[styles.notFound, { paddingTop: topPad + 20 }]}>
          <Text style={[styles.notFoundText, { color: colors.cream }]}>
            Venture not found
          </Text>
      ...
      >
          ...
          <View style={styles.nameRow}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    venture.status === "live" ? "#10b981" : "#f59e0b",
                },
              ]}
            />
        ...
        <View style={styles.heroStats}>
          {[
            ...
            { label: "Status", value: venture.status.toUpperCase(), color: venture.status === "live" ? "#10b981" : "#f59e0b" },
          ].map((s) => (
            <View
              key={s.label}
              style={[
