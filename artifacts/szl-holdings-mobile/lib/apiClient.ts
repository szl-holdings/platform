    ...
    interventions: [
      {
        ...
        summary: "Port of Rotterdam dwell time is up 22h on a 3-day trend. MSC Horizon is 36h from arrival; rerouting via Suez avoids a projected 5-day delay and force-majeure exposure on the charter.",
        urgency: "critical",
        confidence: 0.91,
        valueAtRisk: 680000,
        sourceSignalCount: 6,
        ...
        plannerAssessment: { riskLevel: "high", requiredApproval: true, approvalReason: "Reroute changes counterparty obligations" },
      },
      {
        id: "INT002",
        domain: "aegis",
        title: "Force credential rotation for 3 executive accounts targeted by spray campaign",
        summary: "Aegis SOC blocked a credential spray from a Romanian Google Cloud ASN against three exec accounts. MFA held, but reuse risk on related SaaS tenants warrants immediate rotation.",
        urgency: "urgent",
        confidence: 0.94,
        valueAtRisk: 540000,
        sourceSignalCount: 9,
      ...
      },
      {
        ...
        summary: "Terra surfaced a Midtown asset with a hard 90-day maturity and 42% LTV distress. Comparable trades suggest a $7.2M acquisition window before the lender forces sale.",
        urgency: "moderate",
        confidence: 0.78,
        valueAtRisk: 720000,
        sourceSignalCount: 4,
        ...
        plannerAssessment: { riskLevel: "medium", requiredApproval: true, approvalReason: "Capital allocation > $5M threshold" },
      },
      {
        id: "INT004",
        domain: "lyte",
        title: "Hedge crude exposure with 30-day forward — covers maritime delay scenario",
        summary: "Lyte models a 0.62 correlation between Rotterdam dwell and crude futures. A $2.1M 30-day forward closes the hedging gap surfaced by the cross-domain risk fusion.",
        urgency: "moderate",
        confidence: 0.82,
        valueAtRisk: 480000,
        sourceSignalCount: 5,
      ...
      },
      {
        ...
        summary: "PRISM detected charter language permitting force majeure notification at 48h dwell. Pre-drafting the notice preserves optionality without committing — saves 6h if invoked.",
        urgency: "low",
        confidence: 0.88,
        valueAtRisk: 420000,
        sourceSignalCount: 3,
