...
const DOMAIN_RESPONSES: Record<VoiceLanguage, Record<WorkspaceDomain, { response: string; cards: VoiceResultCard[] }>> = {
  en: {
    ...
    fleet: { response: 'Fleet operational. 12 vessels active, 1 delayed at Port of Rotterdam due to weather.', cards: [{ id: '1', label: 'Active Vessels', value: '12', trend: 'neutral' }, { id: '2', label: 'On Schedule', value: '11/12', trend: 'up' }, { id: '3', label: 'Cargo Value', value: '$84.2M', trend: 'up' }] },
    ...
    operations: { response: 'Systems healthy. API latency up 12% — Lyte agent investigating root cause.', cards: [{ id: '1', label: 'System Health', value: '94%', trend: 'down' }, { id: '2', label: 'API Latency', value: '238ms', change: '+12%', trend: 'up', severity: 'medium' }, { id: '3', label: 'Active Signals', value: '5', trend: 'neutral' }] },
  ...
  es: {
    ...
    operations: { response: 'Sistemas saludables. Latencia de API aumentó 12% — agente Lyte investigando causa raíz.', cards: [{ id: '1', label: 'Salud del Sistema', value: '94%', trend: 'down' }, { id: '2', label: 'Latencia API', value: '238ms', change: '+12%', trend: 'up', severity: 'medium' }, { id: '3', label: 'Señales Activas', value: '5', trend: 'neutral' }] },
  ...
  zh: {
    ...
    operations: { response: '系统健康。API延迟上升12%——Lyte代理正在调查根本原因。', cards: [{ id: '1', label: '系统健康', value: '94%', trend: 'down' }, { id: '2', label: 'API延迟', value: '238ms', change: '+12%', trend: 'up', severity: 'medium' }, { id: '3', label: '活跃信号', value: '5', trend: 'neutral' }] },
