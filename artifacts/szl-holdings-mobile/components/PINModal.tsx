      ...
      <View style={styles.overlay}>
        <View style={[styles.container, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <View style={styles.topRow}>
            ...
            <View style={[styles.lockCircle, { backgroundColor: `${ACCENT}10`, borderColor: `${ACCENT}30` }]}>
            ...
            {KEYS.map((key, i) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.key,
                    { backgroundColor: isDelete ? "transparent" : colors.muted },
                  ]}
                  onPress={() => handleKey(key)}
                  activeOpacity={0.7}
                >
                  <Text style={[styles.keyText, { color: isDelete ? colors.mutedForeground : colors.foreground }]}>
                    {key}
                  </Text>
                </TouchableOpacity>
              );
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 18, fontFamily: "Inter_600SemiBold", letterSpacing: -0.3, textAlign: "center" },
