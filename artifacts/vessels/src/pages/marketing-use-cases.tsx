...
import { ChevronRight, TrendingUp, Radio, DollarSign } from "lucide-react";
...
const useCases = [
  {
    ...
    description: "Fleet executives need portfolio-level visibility without wading through operational noise. Vessels gives you fleet utilization, TCE trends, margin exposure, and exception severity — at a glance, updated in real time.",
    points: [
  ...
  },
  {
    ...
    description: "Operations teams deal with a high volume of signals. Vessels filters to the exceptions that have real business impact — and surfaces them with the context needed to make a decision, not just a notification.",
    points: [
  ...
  },
  {
    ...
    description: "Commercial teams need to understand charter performance, voyage margins, and delay exposure — not just where vessels are on a map. Vessels surfaces the financial context behind every voyage.",
    points: [
  ...
  return (
    <div className="min-h-screen bg-[#060e1a] text-sky-50">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-28 pb-20">
        <div className="mb-14">
          <p className="text-[11px] font-semibold text-sky-400/60 tracking-[0.15em] uppercase mb-3">Use Cases</p>
          <h1 className="text-3xl md:text-4xl font-bold text-sky-50 mb-4">Who Vessels is built for</h1>
          <p className="text-sky-300/40 text-[15px] leading-relaxed max-w-xl">
            Three distinct operational personas. One platform that serves them all without compromising on depth.
          </p>
        </div>
          ...
          {useCases.map((uc) => (
            <div key={uc.role} className="border border-sky-500/10 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[11px] font-semibold text-sky-400/60 uppercase tracking-[0.12em]">{uc.role}</span>
              </div>
