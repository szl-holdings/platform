      ...
      <div>
        ...
        <div className="space-y-2">
          {activeExceptions.map((exc) => {
            ...
            const impact = (exc as { estimatedImpactUSD?: number; estimatedImpact?: number; valueAtRiskUsd?: string }).estimatedImpactUSD ?? (((exc as unknown) as { valueAtRiskUsd?: string }).valueAtRiskUsd ? parseFloat(((exc as unknown) as { valueAtRiskUsd: string }).valueAtRiskUsd) : ((exc as { estimatedImpact?: number }).estimatedImpact ?? 0));
            return (
