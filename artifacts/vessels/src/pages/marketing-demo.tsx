import { AlertCircle, ChevronRight, Ship } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-14">
          <div>
            ...
            <p className="text-sky-300/40 text-[14px] leading-relaxed mb-8">
              ...
              case. We don't run generic product tours.
            </p>
          ...
          <div className="bg-[#0a1628]/80 border border-sky-500/10 rounded-2xl p-7">
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-sky-300/40 text-[13px]">
                  We'll be in touch within one business day to schedule your private demo.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <h3 className="text-[15px] font-semibold text-sky-100 mb-1">
                ...
                {[
                  { label: 'Name', key: 'name', type: 'text', placeholder: 'Your full name' },
                  {
                    ...
                    key: 'company',
                    type: 'text',
                    placeholder: 'Fleet operator or organisation',
                  },
                  {
                    label: 'Work email',
                    key: 'email',
