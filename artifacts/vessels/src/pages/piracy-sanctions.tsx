...
const RISK_CORRIDORS = [
  {
    ...
    level: 'critical',
    threat: 'Houthi missile & drone attacks',
    vessels: 8,
    incidents30d: 7,
  ...
  },
  {
    ...
    name: 'Gulf of Guinea',
    level: 'critical',
    threat: 'Armed robbery / crew kidnapping',
    vessels: 3,
    incidents30d: 4,
    avoidanceActive: true,
    lat: 4.0,
  ...
  },
  {
    ...
    level: 'medium',
    threat: 'Petty theft / boarding attempts',
    vessels: 11,
    incidents30d: 2,
    avoidanceActive: false,
    lat: 2.5,
  ...
  {
    id: 'RC-005',
    name: 'Indian Ocean (East Africa)',
    level: 'medium',
    threat: 'Piracy resurgence',
    vessels: 4,
    incidents30d: 1,
    avoidanceActive: false,
    lat: -5.0,
  ...
  },
  {
    ...
    name: 'Black Sea',
    level: 'high',
    threat: 'Conflict zone / mine risk',
    vessels: 0,
    incidents30d: 12,
    avoidanceActive: true,
    lat: 43.0,
...
const SANCTIONS_HITS = [
  {
    entity: 'Evergreen Meridian Shipping LLC',
    list: 'OFAC SDN',
    match: 0.96,
  ...
  {
    entity: 'Black Sea Cargo Partners',
  ...
  {
    entity: 'Aurora Petroleum Trading',
  ...
  {
    entity: 'Pacific Star Marine Inc',
    list: 'UK OFSI',
    match: 0.65,
...
export default function PiracySanctionsPage() {
  ...
  const filteredHits = SANCTIONS_HITS.filter(
    (h) =>
      !searchQuery ||
      h.entity.toLowerCase().includes(searchQuery.toLowerCase()) ||
      h.vessel.toLowerCase().includes(searchQuery.toLowerCase()),
  );
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <Badge
              variant="outline"
              className="text-[9px] text-red-400 border-red-500/30 bg-red-500/5"
            >
              LIVE INTEL
            </Badge>
          </div>
