...
import { type FleetWhatChangedEvent, fleetWhatChanged } from '@/data/fleet-twin';
...
export default function FleetWhatChanged() {
  ...
  const filtered = fleetWhatChanged.filter(
    (e) => filter === 'all' || e.severity === filter || e.eventType === filter,
  );
