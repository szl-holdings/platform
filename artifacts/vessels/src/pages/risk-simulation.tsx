      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <header className="flex items-center gap-3">
          <div
            ...
            style={{ background: `${VESSELS_ACCENT}15`, border: `1px solid ${VESSELS_ACCENT}30` }}
          >
          ...
          <div>
            ...
            <p className="text-[12px]" style={{ color: 'rgba(255,255,255,0.5)' }}>
              Monte Carlo modeling of total voyage cost under uncertain fuel, weather, port, and
              risk premium conditions.
            </p>
          </div>
        </header>
