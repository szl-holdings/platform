...
export default function CommandWorkflowsPage() {
  ...
  const createWorkflow = useStandardMutation({
    ...
    onSuccess: (_data, vars) => {
      toast.success(`Workflow "${WORKFLOW_TYPE_LABELS[vars.workflowType]}" created via Counsel`);
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">
            Exception queue, owner assignment, route interventions — powered by Counsel
          </p>
        </div>
        <Button
          variant="outline"
                    ...
                    <Button
                      ...
                      onClick={() =>
                        createWorkflow.mutate({
                          ...
                          assignedTo: 'Counsel Workflow Engine',
                        })
                      }
