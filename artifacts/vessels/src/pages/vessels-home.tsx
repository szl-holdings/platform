  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-3 left-3 right-3 flex items-start justify-between gap-2 pointer-events-none">
        ...
        <div className="bg-[#060e1a]/90 border border-sky-500/15 rounded px-3 py-2 backdrop-blur-sm">
          <div className="text-[9px] font-mono text-[#c9b787]/50 mb-0.5">AIS FEED · LIVE</div>
          <div className="text-[10px] font-semibold text-[#d4c598]">
          ...
          >
            <div>
              ...
              <div className="space-y-4">
                {[
                  'Live AIS position tracking with historical trail and replay',
