    ...
    <div className="flex items-center gap-1">
      {levels.map((l, i) => (
        <div
          ...
          style={{
            background:
              i <= idx ? RISK_STYLE[l as keyof typeof RISK_STYLE]?.color : 'rgba(255,255,255,0.06)',
          }}
        />
      ))}
    </div>
...
const CONTEXT_PANELS = [
  {
    ...
    icon: Wind,
    description:
      'Live weather routing data — swell height, wind speed, tropical storm tracking, piracy advisories.',
  ...
  },
  {
    ...
    icon: Anchor,
    description:
      'Port AIS congestion, ETA advisories, berth availability, and terminal congestion indexes.',
  ...
  },
  {
    ...
    icon: Shield,
    description:
      'OFAC, EU, UN sanctions screening. Geopolitical risk zones, transit restrictions, embargo status.',
    ...
    <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          {voyageTwins.map((v) => (
            <button
              ...
              style={{
                background:
                  selected === v.id ? 'hsl(205 70% 38% / 0.15)' : 'rgba(255,255,255,0.04)',
      ...
      {voyage && vessel && (
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="flex-1">
                ...
                <div className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>
                  {voyage.vesselName} · {voyage.originPort} → {voyage.destinationPort} ·{' '}
                  {voyage.cargo}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-5">
              ...
              >
                ...
                <div
                  ...
                  style={{ color: RISK_STYLE[voyage.routeRisk].color }}
                >
              ...
              >
                ...
                <div
                  className="text-sm font-semibold mt-2 capitalize"
                  style={{ color: WEATHER_STYLE[voyage.weatherRisk] }}
                >
              ...
              >
                ...
                <div
                  className="text-sm font-semibold mt-2 capitalize"
                  style={{
                    color: RISK_STYLE[voyage.portCongestionRisk]?.color ?? 'rgba(255,255,255,0.5)',
                  }}
                >
          ...
          <div>
            <div className="text-sm font-semibold mb-4" style={{ color: 'rgba(255,255,255,0.6)' }}>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                {
                  label: 'Voyage Revenue',
                  value: `$${(voyage.economics.voyageRevenue / 1000).toFixed(0)}K`,
                },
                {
                  label: 'Total Costs',
                  value: `$${(voyage.economics.voyageCosts / 1000).toFixed(0)}K`,
                },
                {
                  label: 'Bunker Cost',
                  value: `$${(voyage.economics.bunkerCost / 1000).toFixed(0)}K`,
                },
                {
                  label: 'Port Disbursements',
                  value: `$${(voyage.economics.portDisbursements / 1000).toFixed(0)}K`,
                },
                {
                  label: 'TC Equivalent',
                  value: `$${voyage.economics.tcEquivalent.toLocaleString()}/d`,
                },
                {
                  label: 'Profit Margin',
                  value: `${voyage.economics.profitMarginPct.toFixed(1)}%`,
                  color: voyage.economics.profitMarginPct > 20 ? '#40856a' : '#c08a2c',
                },
              ].map((m) => (
                <div
                  key={m.label}
