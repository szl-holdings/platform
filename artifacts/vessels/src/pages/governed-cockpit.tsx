...
const ROUTING_EVIDENCE: EvidenceSource[] = [
  {
    id: 'ev-v1',
    label: 'NOAA Weather Routing Model — Leg 3',
    type: 'api',
    timestamp: FRESH_3M,
    excerpt:
      'Cyclone Aiko (Cat 2) projected track updated 3m ago. 95% probability of interference with nominal route SIN→HAM on Day 4.',
  },
  {
    id: 'ev-v2',
    label: 'Port State Control Risk Index — Hamburg',
    type: 'document',
    timestamp: FRESH_10M,
    excerpt:
      'HAM PSC inspection rate elevated to 38% (vs 22% baseline). Flag state NIL deficiency record provides partial offset.',
  },
  {
    id: 'ev-v3',
    label: 'Historical Voyage Archive — 18 mo',
    type: 'model',
    timestamp: AGING_30M,
    excerpt:
      'Northern route via Rotterdam adds +1.3 days average but reduces weather-related delay probability by 67%.',
  },
  {
    id: 'ev-v4',
    label: 'Charter Party Clause CP-14b',
    type: 'document',
    timestamp: AGING_30M,
    excerpt:
      'Owner entitled to deviate up to 2 degrees lat/lon from agreed route to avoid peril. No charterer consent required.',
  },
];
...
const SANCTIONS_EVIDENCE: EvidenceSource[] = [
  {
    id: 'ev-s1',
    label: 'OFAC SDN List — Automated Screening',
    type: 'api',
    timestamp: FRESH_3M,
    excerpt:
      "Counterparty 'Starline Maritime SA' matches OFAC SDN entry with 94% name-match confidence. Registered Panama.",
  },
  {
    id: 'ev-s2',
    label: 'Dow Jones Risk & Compliance DB',
    type: 'document',
    timestamp: FRESH_10M,
    excerpt:
      "Parent entity 'Starline Group' subject to EU restrictive measures since March 2024. Ultimate beneficial owner identified.",
  },
  {
    id: 'ev-s3',
    label: 'AIS Position History — 90 days',
    type: 'signal',
    timestamp: AGING_30M,
    excerpt:
      '3 port calls to sanctioned jurisdiction (BND) in prior 90 days. AIS transmitter disabled for 14h during two transits.',
  },
];
...
const MAINTENANCE_EVIDENCE: EvidenceSource[] = [
  {
    id: 'ev-m1',
    label: 'Main Engine Telemetry — MV Horizon Star',
    type: 'signal',
    timestamp: FRESH_3M,
    excerpt:
      'Cylinder 4 exhaust temp deviation: +42°C above baseline for 6h. Vibration signature consistent with liner wear.',
  },
  {
    id: 'ev-m2',
    label: 'Class Maintenance Record',
    type: 'document',
    timestamp: AGING_30M,
    excerpt:
      'Last scheduled overhaul: 14 months ago. Class requires attention at 18 months or 8,000 running hours (current: 7,840h).',
  },
  {
    id: 'ev-m3',
    label: 'Predictive Maintenance Model v3.1',
    type: 'model',
    timestamp: FRESH_10M,
    excerpt:
      'P(failure before next port call) = 0.31 based on telemetry trend. Proactive intervention reduces downtime cost by avg $340K.',
  },
];
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span
            ...
            style={{ color: '#4a6070' }}
          >
            Fleet Intelligence · Deterministic Fallback (FORGE integration active)
          </span>
        </div>
        ...
        >
          <div className="space-y-2">
            <p className="text-sm" style={{ color: '#c8d8e8' }}>
              ...
              intervention reduces expected downtime cost by ~$340K.
            </p>
            <div
              className="mt-3 rounded-lg p-3"
              style={{ background: '#060b12', border: '1px solid #243040' }}
