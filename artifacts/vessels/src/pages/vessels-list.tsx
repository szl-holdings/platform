...
const statusConfig: Record<string, { label: string; color: string; dotColor: string }> = {
  ...
  in_port: {
    label: 'In Port',
    color: 'text-[var(--gi-accent-blue)] bg-[rgba(77,143,204,0.10)] border-[rgba(77,143,204,0.20)]',
    dotColor: 'bg-[var(--gi-accent-blue)]',
  },
  anchored: {
    label: 'Anchored',
  ...
  inactive: {
    label: 'Inactive',
    color: 'text-[var(--gi-accent-blue)/40] bg-[rgba(77,143,204,0.05)] border-[rgba(77,143,204,0.10)]',
      ...
      <div className="bg-[#0a1628]/80 border border-[rgba(77,143,204,0.10)] rounded-xl px-4 py-3 hover:border-[rgba(77,143,204,0.20)] hover:bg-[rgba(77,143,204,0.05)] cursor-pointer transition-all">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {v.activeExceptions > 0 && (
                <Badge
                  variant="outline"
                  className="text-[9px] text-red-400 bg-red-500/10 border-red-500/20 shrink-0"
                >
            ...
            <p className="text-[10px] text-[var(--gi-accent-blue)]/40 mt-0.5">
          ...
          <div className="hidden md:flex items-center gap-6 shrink-0 text-right">
            {v.destination && (
              <div>
                <p className="text-[9px] text-[var(--gi-accent-blue)]/30 flex items-center gap-1 justify-end">
            ...
            {lat !== null && lon !== null && (
              <div>
                ...
                {v.speed && (
                  <p className="text-[9px] text-[var(--gi-accent-blue)]/40 mt-0.5">
            ...
            {tce !== null && tce > 0 && (
              <div>
                ...
                {v.charterType && (
                  <p className="text-[9px] text-[var(--gi-accent-blue)]/40 mt-0.5 capitalize">
          ...
          <ChevronRight className="w-4 h-4 text-[var(--gi-accent-blue)]/20 shrink-0" />
        </div>
      </div>
    </Link>
  );
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-[var(--gi-accent-blue)]/50 mt-0.5">
            ...
            {!isLive && !isLoading && <span className="ml-2 text-[var(--gi-accent-blue)]/40">· loading</span>}
          </p>
        </div>
        <button
          onClick={() => refetch()}
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[var(--gi-accent-blue)]/40" />
          <input
            value={search}
        ...
        <div className="ml-auto flex items-center gap-1">
          <span className="text-[10px] text-[var(--gi-accent-blue)]/40 mr-1">Sort:</span>
          {[
            { id: 'name', label: 'Name' },
            { id: 'type', label: 'Type' },
            { id: 'flag', label: 'Flag' },
