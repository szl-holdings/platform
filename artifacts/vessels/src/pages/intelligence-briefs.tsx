...
const BRIEFS = [
  ...
  },
  {
    ...
    situation: "PACIFIC MERIDIAN (IMO 9821045, VLCC, 300k DWT) completed a 14h 22m AIS blackout near 26.1°N 55.8°E in the Persian Gulf. Satellite imagery analysis suggests ship-to-ship transfer with KAZAN SPIRIT (sanctioned entity, OFAC SDN list). Estimated 285,000 MT crude oil transferred, cargo value ~$151M. Both vessels now showing false flag of convenience.",
