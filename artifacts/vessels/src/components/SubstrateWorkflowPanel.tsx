        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div>
              ...
              <p className="text-[10px] text-blue-400/50 mt-0.5 font-mono">
                Substrate · vessels-voyage-anomaly · Phase 2
              </p>
            </div>
          ...
          <p className="text-[10px] text-slate-400 mt-1.5 leading-relaxed">
            Reviews AIS event streams for dark periods, STS transfers, and sanctions proximity.
            Operator approval required before case creation.
          </p>
        ...
        <div className="border-t border-blue-500/10 pt-3 space-y-3">
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={m.label} className="rounded border border-slate-800 bg-slate-900/60 p-2">
                ...
                <p
                  className={`text-sm font-mono font-bold truncate ${STATUS_COLOR[String(m.value)] ?? 'text-blue-300'}`}
                >
                  {m.value}
                </p>
              </div>
          ...
          <div className="flex items-center justify-between">
            <span className="text-[9px] font-mono text-slate-600">
              mode:{result.mode} · inbox:vessels-voyage-anomaly
            </span>
          ...
          {mode === 'dry-run' && (
            <div className="rounded border border-sky-500/15 bg-sky-500/5 p-2">
              <p className="text-[9px] font-mono text-sky-400">
                DRY-RUN — case creation and notifications suppressed.
              </p>
            </div>
          )}
          {status === 'pending-approval' && (
