...
export type ComplianceStatus = "compliant" | "minor_deficiency" | "major_deficiency" | "non_compliant";
...
export interface VesselTwin {
  ...
  certExpiries: Array<{ cert: string; expiresAt: string; status: "valid" | "expiring_soon" | "expired" }>;
...
export interface VoyageApproval {
  ...
  voyageNumber: string;
  vesselName: string;
  actionClass: "route_deviation" | "port_clearance" | "cargo_override" | "exception_escalation" | "export_packet";
  title: string;
  description: string;
...
export const vesselTwins: VesselTwin[] = [
  ...
  },
  {
    ...
    maintenanceDue: false,
    certExpiries: [
      { cert: "SOLAS Safety", expiresAt: daysAgo(-200), status: "valid" },
    ],
    complianceStatus: "compliant",
...
export const voyageTwins: VoyageTwin[] = [
  {
    ...
    approvals: [
      {
        ...
        description: "Speed reduction due to 3m swell. Requesting ETA extension acknowledgment from charterer.",
        status: "pending",
        priority: "medium",
    ...
    auditTrail: [
      { id: "vaud-001", voyageId: "voyage-001", action: "voyage_created", actor: "ops.system", actorRole: "system", at: daysAgo(12) },
      { id: "vaud-002", voyageId: "voyage-001", action: "deviation_detected", actor: "system", actorRole: "automation", at: hoursAgo(36) },
    ],
    externalDataConnectors: [
    ...
    deviations: [
      {
        ...
        description: "Vessel diverted to Fujairah for emergency maintenance inspection. Voyage status: Exception.",
        resolved: false,
      },
    ],
    approvals: [
      {
        ...
        description: "MT Zenith Carrier diverted to Fujairah for emergency inspection. Charterer notification required. Delay 3-5 days estimated.",
        status: "pending",
        priority: "critical",
        requestedBy: "Fleet Ops Lead",
        requestedAt: hoursAgo(10),
        comments: [{ author: "Ops Controller", body: "Technical superintendent notified. Surveyor en route.", at: hoursAgo(8) }],
      },
    ],
    auditTrail: [
      { id: "vaud-010", voyageId: "voyage-002", action: "voyage_created", actor: "ops.system", actorRole: "system", at: daysAgo(8) },
      { id: "vaud-011", voyageId: "voyage-002", action: "exception_raised", actor: "system", actorRole: "automation", at: hoursAgo(12), details: { type: "unplanned_port_call" } },
    ],
    externalDataConnectors: [
      { name: "StormGeo Weather", type: "weather_api", status: "not_connected" },
...
export const fleetWhatChanged: FleetWhatChangedEvent[] = [
  {
    ...
    detail: "MT Zenith Carrier diverted to Fujairah for emergency maintenance. Voyage status set to Exception. Approval request pending.",
    severity: "critical",
    source: "Fleet Ops",
  ...
  },
  {
    ...
    detail: "Maintenance overdue + 2 PSC deficiencies + ISPS cert expiring. Score dropped 14 points.",
    severity: "warning",
  ...
  },
  {
    ...
    detail: "International Ship and Port Facility Security — Shipboard Security Alert System cert expiring. Action required.",
    severity: "warning",
  ...
  },
  {
    ...
    detail: "Port of Shanghai PSC inspection completed with zero deficiencies. Vessel cleared for departure.",
    severity: "info",
    source: "PSC Records",
