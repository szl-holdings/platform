...
export default function CustomBrief() {
  ...
  const handleSubmit = () => {
    ...
    const domainsForRequest: DomainKey[] =
      selectedDomains.length > 0 ? selectedDomains : ['executive'];
    requestBrief.mutate(
      {
        topic: topic.trim(),
    ...
    <div style={{ padding: '28px 28px 40px' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--pulse-text-muted)' }}>
          Request a focused intelligence briefing on any entity, topic, or scenario. Alloy agents
        ...
        <div className="section-card" style={{ padding: 24 }}>
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ marginTop: 8 }}>
              <span style={{ fontSize: '0.68rem', color: 'var(--pulse-text-muted)' }}>
                Examples:{' '}
              </span>
                ...
                >
                  <span
                    style={{
                      ...
                      borderRadius: 4,
                      background:
                        req.status === 'complete' ? 'rgba(78,202,139,0.1)' : 'rgba(200,168,75,0.1)',
