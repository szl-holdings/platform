...
export type DomainKey = "maritime" | "security" | "real_estate" | "legal" | "financial" | "platform" | "executive";
...
export const AGENTS: Record<string, Agent> = {
  helmsman: { id: "helmsman", name: "Helmsman", domain: "maritime", color: "#5090e8", borderColor: "rgba(80,144,232,0.4)", bgColor: "rgba(80,144,232,0.1)" },
  sentinel: { id: "sentinel", name: "Sentinel", domain: "security", color: "#e05050", borderColor: "rgba(224,80,80,0.4)", bgColor: "rgba(224,80,80,0.1)" },
...
export function getConfidenceClass(label: ConfidenceLevel): string {
  switch (label) {
    ...
    case "MODERATE": return "conf-moderate";
    case "LOW": return "conf-low";
    case "INSUFFICIENT": return "conf-low";
  }
}
