...
import { usePushNotifications as useSharedPushNotifications } from "@szl-holdings/mobile-ai";
import type { NotificationConfig } from "@szl-holdings/mobile-ai";
...
export function usePushNotifications(accentColor: string, apiBase?: string, appId?: string, authToken?: string | null) {
