...
const DECISIONS: BoardItem[] = [
  {
    ...
    pack: "Vessels",
    packColor: "#38bdf8",
    detail: "Three vessels awaiting fuel surcharge approval. SLA breach window is 4 hours. Finance VP sign-off required — calendar conflict must be escalated to CFO.",
  },
  {
    id: "D-2",
    ...
    pack: "PRISM",
    packColor: "#d4a054",
    detail: "Pricing revision in executive queue 31h. Board deadline 17h away. Market window closes at midnight if unsigned.",
  },
  {
    id: "D-3",
    ...
    pack: "PRISM",
    packColor: "#d4a054",
    detail: "Single COO assignment decision unlocks $650K in payment processing. Two teams are contested — one choice needed.",
  },
];
...
const RISKS: BoardItem[] = [
  {
    ...
    pack: "Vessels",
    packColor: "#38bdf8",
    detail: "M/V Meridian, Pacific Star, and Coral Wind operating outside SLA windows. Penalty clauses activate at 26h mark.",
  },
  {
    id: "R-2",
    ...
    pack: "PRISM",
    packColor: "#d4a054",
    detail: "Pricing revision must be signed before market conditions shift at midnight. No second chance on this window.",
  },
  {
    id: "R-3",
    ...
    pack: "Terra",
    packColor: "#a07848",
    detail: "Missing exhibit B. Tenant can void renewal in 3 days. Property manager unresponsive for 48h.",
  },
];
...
const ASKS: BoardItem[] = [
  {
    ...
    pack: "Vessels",
    packColor: "#38bdf8",
    detail: "Finance VP is in calendar conflict. Who is the designated backup approver for fleet surcharge decisions? Answer needed in 2h.",
  },
  {
    id: "A-2",
    ...
    pack: "PRISM",
    packColor: "#d4a054",
    detail: "A single COO assignment will immediately unblock $650K in payment processing. No other action needed from leadership.",
  },
  {
    id: "A-3",
    ...
    pack: "Terra",
    packColor: "#a07848",
    detail: "Authorization needed to escalate directly to property management firm director and, if needed, engage legal.",
  },
];
...
function BoardItemCard({
  ...
  const typeColor = type === "decisions" ? LYTE_COLORS.medium : type === "risks" ? LYTE_COLORS.critical : "#8b7ac8";
      ...
      <View style={[styles.itemCard, { borderColor: expanded ? `${typeColor}30` : colors.border }]}>
        <View style={styles.itemHeader}>
          <View style={styles.itemLeft}>
            ...
            <Text style={styles.itemTitle} numberOfLines={expanded ? undefined : 2}>{item.title}</Text>
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={LYTE_COLORS.medium} />
        }
      >
        <View style={styles.header}>
          ...
          <View style={[styles.atRisk, { backgroundColor: "rgba(196,90,74,0.10)", borderColor: "rgba(196,90,74,0.25)" }]}>
