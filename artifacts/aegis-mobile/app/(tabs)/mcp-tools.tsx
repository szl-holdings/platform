...
function ToolRow({ tool, selected, onPress }: { tool: McpTool; selected: boolean; onPress: () => void }) {
  return (
    <TouchableOpacity
      onPress={onPress}
      style={[styles.toolRow, selected && { backgroundColor: `${ACCENT}10`, borderColor: `${ACCENT}30` }]}
      activeOpacity={0.7}
    >
...
const styles = StyleSheet.create({
  ...
  toolDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: "rgba(255,255,255,0.2)", flexShrink: 0 },
