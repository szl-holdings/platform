...
export async function seedConstellationExtended() {
  ...
  const nodeTypeDefs = [
    {
      domain: 'terra',
      typeKey: 'property',
      displayName: 'Distress Property',
      description: 'Real estate asset in distress pipeline',
    },
    {
      domain: 'terra',
      typeKey: 'lead',
      displayName: 'Acquisition Lead',
      description: 'Active lead on a distress opportunity',
    },
    {
      domain: 'vessels',
      typeKey: 'vessel',
      displayName: 'Vessel',
      description: 'Maritime vessel under AIS monitoring',
    },
    {
      domain: 'vessels',
      typeKey: 'fleet',
      displayName: 'Fleet Grouping',
      description: 'Logical grouping of vessels',
    },
    {
      domain: 'aegis',
      typeKey: 'finding',
      displayName: 'Security Finding',
    ...
    },
    {
      ...
      description: 'Active or historical security incident',
    },
    {
      domain: 'aegis',
      typeKey: 'asset',
      displayName: 'IT/OT Asset',
      description: 'Technology or operational asset',
    },
    {
      domain: 'lyte',
      typeKey: 'signal',
      displayName: 'Business Signal',
      description: 'Revenue or operational anomaly signal',
    },
    {
      domain: 'lyte',
      typeKey: 'entity',
      displayName: 'Portfolio Entity',
      description: 'Monitored portfolio company',
    },
    {
      domain: 'platform',
      typeKey: 'organization',
      displayName: 'Organization',
      description: 'SZL Holdings entity',
    },
    {
      domain: 'platform',
      typeKey: 'agent',
      displayName: 'AI Agent',
      description: 'Active AI agent in the system',
    },
    {
      domain: 'carlota-jo',
      typeKey: 'client',
      displayName: 'Client Engagement',
      description: 'Carlota Jo advisory client',
    },
    {
      domain: 'carlota-jo',
      typeKey: 'engagement',
      displayName: 'Service Engagement',
      description: 'Active service engagement',
    },
  ];
  ...
  const nodes: (typeof cstNodes.$inferInsert)[] = [
    // Terra
    {
      ...
      description:
        'Multifamily property in Harlem. 283 days distress. Auction April 10, 2026. Opportunity score 92/100.',
      provenanceSourceId: 'dp-seed-002',
      provenanceSourceType: 'terra_distress_properties',
      provenanceSourceLabel: 'Terra Distress Pipeline',
      freshness: daysAgo(1),
      confidence: 0.92,
    ...
    },
    {
      ...
      description:
        'Brooklyn multifamily pre-foreclosure. 136 days distress. Opportunity score 87/100.',
      provenanceSourceId: 'dp-seed-001',
      provenanceSourceType: 'terra_distress_properties',
      provenanceSourceLabel: 'Terra Distress Pipeline',
      freshness: daysAgo(2),
      confidence: 0.87,
      ...
      extensions: {
        ...
        estimatedValueUsd: 2_850_000,
      },
    },
    {
      id: IDS.property_flushing,
      canonicalId: randomUUID(),
      domain: 'terra',
      entityType: 'property',
      ...
      description:
        'Commercial property, Flushing corridor. Tax lien $287K. Opportunity score 79/100.',
      provenanceSourceId: 'dp-seed-006',
      provenanceSourceType: 'terra_distress_properties',
      provenanceSourceLabel: 'Terra Distress Pipeline',
      freshness: daysAgo(3),
      confidence: 0.82,
    ...
    },
    {
      ...
      provenanceSourceId: 'dp-seed-010',
      provenanceSourceType: 'terra_distress_properties',
      provenanceSourceLabel: 'Terra Distress Pipeline',
      freshness: daysAgo(4),
      confidence: 0.78,
    ...
    },
    {
      ...
      description:
        'Mixed-use Fulton corridor. Foreclosure notice. 130 days distress. Opportunity score 80/100.',
      provenanceSourceId: 'dp-seed-011',
      provenanceSourceType: 'terra_distress_properties',
      provenanceSourceLabel: 'Terra Distress Pipeline',
      freshness: daysAgo(2),
      confidence: 0.83,
    ...
    {
      id: IDS.vessel_pacific_meridian,
      canonicalId: randomUUID(),
      domain: 'vessels',
      entityType: 'vessel',
      ...
      description:
        'IMO 9876543. Container vessel. 18-hour AIS dark period resolved. OFAC cleared. Route: NYC → Rotterdam.',
      provenanceSourceId: '9876543',
      provenanceSourceType: 'vessels_ais',
      provenanceSourceLabel: 'AIS Monitoring Feed',
      freshness: daysAgo(5),
      confidence: 0.93,
      sensitivityTier: 'confidential',
      extensions: {
        ...
        ofacStatus: 'cleared',
        trackingContext: 'ais_dark_period',
      },
    },
    {
      id: IDS.vessel_atlantic_voyager,
      canonicalId: randomUUID(),
      domain: 'vessels',
      entityType: 'vessel',
      ...
      description:
        'IMO 9876543. Red Sea re-routing active. Cost impact $800K/30 days. Alternate route: Suez bypassed via Cape of Good Hope.',
      provenanceSourceId: '9876543',
      provenanceSourceType: 'vessels_ais',
      provenanceSourceLabel: 'AIS Monitoring Feed',
      freshness: daysAgo(1),
      ...
      extensions: {
        ...
        flag: 'Panama',
        rerouteActive: true,
        rerouteCostImpact: 800_000,
        trackingContext: 'route_deviation',
      },
    },
    {
      id: IDS.fleet_szl_managed,
      canonicalId: randomUUID(),
      domain: 'vessels',
      entityType: 'fleet',
      ...
      provenanceSourceId: 'fleet-szl-001',
      provenanceSourceType: 'vessels_fleet_registry',
      provenanceSourceLabel: 'Fleet Registry',
      freshness: daysAgo(0),
      confidence: 0.99,
      sensitivityTier: 'internal',
      extensions: {
    ...
    // Findings reference the seeded Firestorm ASSET records (stable names, not auto-generated finding IDs)
    {
      ...
      description:
        'Insecure Direct Object Reference in payment API. Active exploitation probes. Emergency patch pre-staged.',
      provenanceSourceId: 'payment-api-v3',
      provenanceSourceType: 'firestorm_assets',
      provenanceSourceLabel: 'Aegis Asset Registry',
      freshness: daysAgo(0),
      confidence: 0.99,
    ...
    },
    {
      ...
      description:
        '4 admin accounts without MFA. Conditional access policy gap. Remediation in progress.',
      provenanceSourceId: 'azure-ad-tenant',
      provenanceSourceType: 'firestorm_assets',
      provenanceSourceLabel: 'Aegis Asset Registry',
      freshness: daysAgo(3),
      confidence: 0.95,
    ...
    },
    {
      ...
      description:
        'MITRE T1059 + T1486 pattern detected at 67% confidence. Playbook triggered. Contained. Case CASE-2026-002.',
      provenanceSourceId: 'CASE-2026-002',
      provenanceSourceType: 'firestorm_cases',
      provenanceSourceLabel: 'Aegis Incident Response',
      freshness: daysAgo(2),
      confidence: 0.81,
      sensitivityTier: 'confidential',
      extensions: {
        mitreIds: ['T1059', 'T1486'],
        confidence: 0.67,
        status: 'contained',
    ...
    },
    {
      ...
      name: 'payment-api-v3',
      description:
        'Production payment API. $2.4M daily volume. 4 critical, 9 high findings open. Risk score 9.5.',
      provenanceSourceId: 'asset-payment-api-v3',
      provenanceSourceType: 'firestorm_assets',
      provenanceSourceLabel: 'Asset Registry',
      freshness: daysAgo(0),
      confidence: 1.0,
      sensitivityTier: 'restricted',
      extensions: {
        ...
        dailyTransactionVolume: 2_400_000,
      },
    },
    // Lyte
    {
      id: IDS.signal_vessels_arr,
      canonicalId: randomUUID(),
      domain: 'lyte',
      entityType: 'signal',
      ...
      provenanceSourceId: 'lyte-signal-vessels-arr-q2',
      provenanceSourceType: 'lyte_signals',
      provenanceSourceLabel: 'Lyte Revenue Intelligence',
      freshness: daysAgo(1),
      confidence: 0.91,
      sensitivityTier: 'confidential',
    ...
    },
    {
      ...
      description:
        'P95 latency 340% above baseline on PRISM pipeline. Resolved via DB replica routing.',
      provenanceSourceId: 'lyte-signal-prism-latency-001',
      provenanceSourceType: 'lyte_signals',
      provenanceSourceLabel: 'Lyte AIOps',
      freshness: daysAgo(2),
      confidence: 0.88,
      sensitivityTier: 'internal',
    ...
    // Platform
    {
      ...
      provenanceSourceId: 'org-1',
      provenanceSourceType: 'organizations',
      provenanceSourceLabel: 'Platform Organization Registry',
      freshness: daysAgo(0),
      confidence: 1.0,
      sensitivityTier: 'internal',
    ...
    },
    {
      ...
      description:
        'AI agent for distress property scoring, opportunity analysis, and market intelligence.',
      provenanceSourceId: 'agent-terra-intel-v2',
      provenanceSourceType: 'agent_registry',
      provenanceSourceLabel: 'Agent OS',
      freshness: daysAgo(0),
      confidence: 0.99,
      sensitivityTier: 'internal',
      extensions: {
        agentId: 'terra-intelligence-agent',
        version: '2.1',
        runsToday: 12,
        status: 'healthy',
      },
    },
    {
      ...
      provenanceSourceId: 'agent-aegis-soar-v3',
      provenanceSourceType: 'agent_registry',
      provenanceSourceLabel: 'Agent OS',
      freshness: daysAgo(0),
      confidence: 0.99,
    ...
    },
    {
      ...
      description:
        'Maritime compliance agent for OFAC sanctions screening and AIS anomaly analysis.',
      provenanceSourceId: 'agent-vessels-compliance-v2',
      provenanceSourceType: 'agent_registry',
      provenanceSourceLabel: 'Agent OS',
      freshness: daysAgo(0),
      confidence: 0.99,
    ...
    // Carlota Jo
    {
      ...
      description:
        'Incoming advisory inquiry from Fortune 500 CHRO. High fit — Executive Strategy Intensive. Discovery call scheduled.',
      provenanceSourceId: 'inquiry-cj-2026-018',
      provenanceSourceType: 'carlota_inquiries',
      provenanceSourceLabel: 'Carlota Jo CRM',
      freshness: daysAgo(1),
      confidence: 0.85,
      sensitivityTier: 'confidential',
    ...
    },
    {
      ...
      description:
        '4 executives cleared for board placement after completing Board Readiness Program.',
      provenanceSourceId: 'engagement-board-readiness-q2-2026',
      provenanceSourceType: 'carlota_reservations',
      provenanceSourceLabel: 'Carlota Jo Engagement Registry',
      freshness: daysAgo(2),
      confidence: 0.92,
      sensitivityTier: 'confidential',
  ...
  const edges: (typeof cstEdges.$inferInsert)[] = [
    // Aegis: finding → asset
    {
      fromNodeId: IDS.finding_payment_idor,
      toNodeId: IDS.asset_payment_api,
      relationshipType: 'affects',
      confidence: 0.99,
      sourceId: 'seed-aegis',
      sourceType: 'seed',
      sourceLabel: 'Seed: Aegis domain',
      active: true,
      extensions: { cvss: 9.3 },
    },
    {
      fromNodeId: IDS.incident_ransomware,
      toNodeId: IDS.asset_payment_api,
    ...
    {
      fromNodeId: IDS.vessel_pacific_meridian,
      toNodeId: IDS.fleet_szl_managed,
      relationshipType: 'member_of',
      confidence: 1.0,
      sourceId: 'seed-vessels',
      sourceType: 'seed',
      sourceLabel: 'Seed: Vessels domain',
      active: true,
      extensions: {},
    },
    {
      fromNodeId: IDS.vessel_atlantic_voyager,
      toNodeId: IDS.fleet_szl_managed,
      relationshipType: 'member_of',
      confidence: 1.0,
      sourceId: 'seed-vessels',
    ...
    {
      fromNodeId: IDS.fleet_szl_managed,
      toNodeId: IDS.signal_vessels_arr,
      relationshipType: 'generates',
      confidence: 0.87,
      sourceId: 'seed-cross',
      sourceType: 'seed',
      sourceLabel: 'Seed: Cross-domain',
      active: true,
      extensions: { signalType: 'revenue' },
    },
    {
      fromNodeId: IDS.entity_vessels,
      toNodeId: IDS.signal_vessels_arr,
      relationshipType: 'tracks',
      confidence: 0.91,
      sourceId: 'seed-lyte',
      sourceType: 'seed',
      sourceLabel: 'Seed: Lyte domain',
      active: true,
      extensions: {},
    },
    // Lyte signal → PRISM portfolio (operational impact)
    {
      fromNodeId: IDS.signal_prism_latency,
      toNodeId: IDS.entity_prism,
      ...
      sourceLabel: 'Seed: Lyte domain',
      active: true,
      extensions: { slaImpact: 'at_risk' },
    },
    // Platform org → portfolio entities
    {
      fromNodeId: IDS.org_szl,
      toNodeId: IDS.entity_vessels,
      relationshipType: 'owns',
      confidence: 1.0,
      sourceId: 'seed-platform',
      sourceType: 'seed',
      sourceLabel: 'Seed: Platform',
      active: true,
      extensions: {},
    },
    {
    ...
    {
      fromNodeId: IDS.org_szl,
      toNodeId: IDS.property_145th,
      relationshipType: 'tracks',
      confidence: 0.92,
      sourceId: 'seed-terra',
      sourceType: 'seed',
      sourceLabel: 'Seed: Terra domain',
      active: true,
      extensions: {},
    },
    {
      fromNodeId: IDS.org_szl,
      toNodeId: IDS.property_flatbush,
      relationshipType: 'tracks',
      confidence: 0.87,
      sourceId: 'seed-terra',
      sourceType: 'seed',
    ...
    {
      fromNodeId: IDS.agent_terra,
      toNodeId: IDS.property_145th,
      relationshipType: 'analyzed',
      confidence: 0.89,
      sourceId: 'seed-agent',
      sourceType: 'seed',
      sourceLabel: 'Seed: Agent runs',
      active: true,
      extensions: { runId: 'run-wf-terra-outreach-002-1' },
    },
    {
      fromNodeId: IDS.agent_terra,
      toNodeId: IDS.property_flatbush,
    ...
    {
      fromNodeId: IDS.agent_aegis,
      toNodeId: IDS.incident_ransomware,
      relationshipType: 'responded_to',
      confidence: 0.81,
      sourceId: 'seed-agent',
      sourceType: 'seed',
      sourceLabel: 'Seed: Agent runs',
      active: true,
      extensions: { playbook: 'ransomware-containment-v3' },
    },
    {
      fromNodeId: IDS.agent_aegis,
      toNodeId: IDS.finding_payment_idor,
      relationshipType: 'escalated',
      confidence: 0.99,
      sourceId: 'seed-agent',
      sourceType: 'seed',
      sourceLabel: 'Seed: Agent runs',
    ...
    {
      fromNodeId: IDS.agent_vessels,
      toNodeId: IDS.vessel_pacific_meridian,
      relationshipType: 'screened',
      confidence: 0.93,
      sourceId: 'seed-agent',
      sourceType: 'seed',
      sourceLabel: 'Seed: Agent runs',
      active: true,
      extensions: { ofacResult: 'no_match' },
    },
    // Carlota Jo
    {
      fromNodeId: IDS.org_szl,
      toNodeId: IDS.engagement_board,
      relationshipType: 'manages',
      confidence: 0.95,
      sourceId: 'seed-carlota',
      sourceType: 'seed',
      sourceLabel: 'Seed: Carlota Jo',
      active: true,
      extensions: {},
    },
    {
      fromNodeId: IDS.client_chro,
      toNodeId: IDS.engagement_board,
      relationshipType: 'candidate_for',
      confidence: 0.72,
      sourceId: 'seed-carlota',
      sourceType: 'seed',
      sourceLabel: 'Seed: Carlota Jo',
    ...
    // Cross-domain: fleet billing → payment API (shared infrastructure risk)
    {
      ...
      sourceLabel: 'Seed: Cross-domain',
      active: true,
      extensions: { riskType: 'shared_infrastructure' },
    },
  ];
