...
async function seedMarketingOS() {
    ...
    await db.insert(dosEditorialPillarsTable).values([
      {
        ...
        slug: 'maritime-supply-chain',
        description:
          'Operational risk, vessel intelligence, port dynamics, and global supply chain resilience.',
        color: '#4a90b8',
        isFavorite: true,
        sortOrder: 1,
      },
      {
        ...
        description: 'Decision-making frameworks, operator mindset, and leadership at scale.',
        color: '#d4a054',
        isFavorite: true,
        sortOrder: 2,
      },
      {
        name: 'Enterprise Technology Adoption',
        slug: 'enterprise-tech',
        description:
          'How enterprises evaluate, adopt, and get ROI from complex technology investments.',
        color: '#9c5adc',
        isFavorite: true,
        sortOrder: 3,
      },
      {
        ...
        slug: 'ai-intelligent-ops',
        description: 'Practical AI use cases for operations, risk, and decision intelligence.',
        color: '#5a9c5a',
        isFavorite: false,
        sortOrder: 4,
      },
      {
        name: 'Capital Readiness & Investor Relations',
        slug: 'capital-readiness',
        description:
          'How operators and founders prepare for capital raises, due diligence, and investor communication.',
        color: '#c45a4a',
        isFavorite: false,
        sortOrder: 5,
      },
  ...
  if (existingCarousels.length === 0) {
    await db.insert(dosCarouselProjectsTable).values([
      ...
      },
      {
        ...
        status: 'idea',
        visualDirectionNotes:
          'Template: Operator Checklist. Clean numbered layout, checkmark icons.',
      },
      {
        ...
        status: 'idea',
        visualDirectionNotes:
          'Template: Educational Explainer. Maritime imagery, data visualization references.',
      },
      {
      ...
      },
      {
        ...
        status: 'idea',
        visualDirectionNotes:
          'Template: Educational Explainer. Clean data-forward design, ROI callouts.',
      },
      {
        ...
        status: 'draft',
        visualDirectionNotes:
          'Template: Myth vs. Reality. Two-column contrast layout, fact-based callouts.',
      },
      {
        ...
        status: 'idea',
        visualDirectionNotes:
          'Template: Educational Explainer. Report layout references, annotated screenshots.',
      },
      {
        ...
        status: 'idea',
        visualDirectionNotes:
          'Template: Enterprise Readiness Checklist. Structured, authoritative layout.',
      },
      {
  ...
  if (existingCalendar.length === 0) {
    ...
    await db.insert(dosContentCalendarItemsTable).values([
      {
        title: '5 Supply Chain Risk Signals — Carousel',
        contentType: 'carousel',
        pillarId: pillarMap['maritime-supply-chain'],
        channel: 'linkedin',
        status: 'planned',
        scheduledDate: nextWeek,
        notes: 'Hero carousel for Q2 maritime intelligence push.',
      },
      {
        title: "The Contrarian's Guide to Enterprise AI — Carousel",
        contentType: 'carousel',
        pillarId: pillarMap['enterprise-tech'],
        channel: 'linkedin',
        status: 'in-progress',
        scheduledDate: twoWeeks,
        notes: 'Pair with the AI Readiness article.',
      },
      {
        title: 'Weekly Intelligence Briefing #14',
