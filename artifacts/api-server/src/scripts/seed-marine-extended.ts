...
export async function seedMarineExtended() {
  ...
  const existing = await db
    .select({ id: marineInsuranceQuotesTable.id })
    ...
    .values([
      {
        ...
        riskFactors: [
          {
            factor: 'vessel_age',
            description: '7-year-old vessel — moderate age risk',
            weight: 0.2,
          },
          {
            factor: 'route_chokepoints',
            description: 'Gibraltar — standard Atlantic route',
            weight: 0.1,
          },
      ...
      },
      {
        ...
        riskFactors: [
          {
            factor: 'hormuz_chokepoint',
            description: 'Strait of Hormuz — geopolitical risk',
            weight: 0.35,
          },
          { factor: 'cargo_hazard', description: 'Class 3 flammable cargo', weight: 0.25 },
          {
            factor: 'high_value_hull',
            description: 'VLCC hull — significant exposure',
            weight: 0.2,
          },
        ],
      ...
      },
      {
        ...
        riskFactors: [
          {
            factor: 'vessel_age',
            description: '9-year-old bulk carrier — above-average wear risk',
            weight: 0.25,
          },
          {
            factor: 'iron_ore_density',
            description: 'Dense bulk cargo — stability considerations',
            weight: 0.15,
          },
        ],
  ...
  await db.insert(marineInsuranceClaimsTable).values([
    {
      ...
      incidentDescription:
        'Water ingress into hold #3 during Pacific storm. Iron ore cargo contaminated — 1,200 MT affected. Loss assessed at $185,000.',
      ...
      status: 'negotiation',
      supportingDocuments: [
        { type: 'surveyor_report', ref: 'SURV-NOR-2026-001' },
        { type: 'cargo_manifest', ref: 'CM-NS-2026-0041' },
      ],
      adjustorNotes:
        'Weather conditions verified via meteorological report. Partial contamination — claim adjusted for recoverable cargo.',
  ...
  const instruments = await db
    ...
    .values([
      {
        symbol: 'BDI-C5TC',
        name: 'Baltic Dry Index — Capesize 5TC Route Average',
        ...
        volume: 42,
        openInterest: 218,
        description: 'Capesize vessel time charter average — 5 route basket',
        routeCode: 'C5TC',
        isActive: true,
      },
      {
        symbol: 'BDI-P1A',
        name: 'Baltic Dry Index — Panamax 1A',
        instrumentType: 'dry_bulk',
        exchange: 'Baltic Exchange',
        currency: 'USD',
        unit: '$/day',
        ...
        volume: 67,
        openInterest: 341,
        description: 'Panamax vessel 1 route — North Pacific grain route',
        routeCode: 'P1A',
        isActive: true,
      },
      {
        symbol: 'BCI-380-SING',
        name: 'Bunker — IFO 380 Singapore',
        instrumentType: 'bunker_fuel',
        exchange: 'Singapore MPA',
        currency: 'USD',
        unit: '$/MT',
        lotSize: '100',
        tickSize: '0.25',
        currentPrice: '472.50',
        previousClose: '468.00',
        dayHigh: '476.00',
        dayLow: '465.50',
        volume: 1240,
        openInterest: 0,
        description: 'IFO 380 bunker fuel — Singapore stem',
        isActive: true,
      },
      {
        symbol: 'BCI-VLSFO-ROT',
        name: 'Bunker — VLSFO Rotterdam',
        instrumentType: 'bunker_fuel',
        exchange: 'Rotterdam Port Authority',
        currency: 'USD',
        unit: '$/MT',
        lotSize: '100',
        tickSize: '0.25',
        currentPrice: '618.00',
        previousClose: '614.75',
        dayHigh: '621.50',
        dayLow: '612.00',
        volume: 890,
        openInterest: 0,
        description: 'Very Low Sulphur Fuel Oil — Rotterdam stem',
        isActive: true,
      },
      {
        symbol: 'FFA-CAPE-Q2',
        name: 'FFA — Capesize Q2 2026',
        instrumentType: 'freight_futures',
        exchange: 'Baltic Exchange / CME',
        currency: 'USD',
        unit: '$/day',
        lotSize: '1',
        tickSize: '1.00',
        ...
        volume: 28,
        openInterest: 156,
        description: 'Capesize forward freight agreement Q2 2026 settlement',
        isActive: true,
      },
      {
        symbol: 'IRON-62-CFR',
        ...
        exchange: 'Singapore Mercantile Exchange',
        currency: 'USD',
        unit: '$/MT',
        lotSize: '1000',
        tickSize: '0.05',
        ...
        volume: 3400,
        openInterest: 12800,
        description: 'Iron ore 62% Fe fine CFR Qingdao',
        isActive: true,
      },
    ])
    .onConflictDoNothing()
    ...
    .values([
      {
        ...
        filledQty: '10',
        remainingQty: '0',
        notionalValue: '183200',
        commission: '185.00',
        submittedAt: daysAgo(3),
        filledAt: daysAgo(3),
        notes: 'Hedge for Q2 Atlantic capesize exposure',
      },
      {
        instrumentId: instruments[1].id,
        orderRef: 'ORD-2026-0082',
        orderType: 'limit',
        side: 'sell',
        status: 'open',
        quantity: '15',
        ...
        filledQty: '0',
        remainingQty: '15',
        notionalValue: '187500',
        commission: '0',
        submittedAt: daysAgo(1),
        expiresAt: daysAhead(5),
        notes: 'Take profit on Panamax long position',
      },
      {
        instrumentId: instruments[2].id,
        orderRef: 'ORD-2026-0083',
        orderType: 'market',
        side: 'buy',
        status: 'filled',
        quantity: '500',
        ...
        filledQty: '500',
        remainingQty: '0',
        notionalValue: '235500',
        commission: '420.00',
        submittedAt: daysAgo(7),
        filledAt: daysAgo(7),
        notes: 'Singapore bunker purchase for Pacific Guardian voyage',
      },
      {
        ...
        filledAt: daysAgo(5),
        notes: 'Q2 FFA position — anticipating summer demand recovery',
      },
      {
        ...
        filledQty: '2000',
        remainingQty: '0',
        notionalValue: '214400',
        commission: '215.00',
        submittedAt: daysAgo(2),
        filledAt: daysAgo(2),
        notes: 'Close iron ore swap on China demand concern',
      },
      {
        ...
        filledQty: '0',
        remainingQty: '300',
        notionalValue: '185400',
        commission: '0',
        submittedAt: new Date(),
        notes: 'Rotterdam bunker stem for Coral Breeze turnaround',
      },
    ])
    .onConflictDoNothing()
    .returning();
  ...
  await db.insert(commodityTradingPositionsTable).values([
    ...
    },
    {
      ...
      side: 'buy',
      quantity: '500',
      avgEntryPrice: '471.00',
      currentPrice: '472.50',
      unrealizedPnl: '750',
      realizedPnl: '0',
      totalPnl: '750',
      notionalValue: '236250',
      marginUsed: '23625',
    },
  ]);
  ...
  await db.insert(fleetExceptionsTable).values([
    {
      ...
      description:
        'MV Atlantic Voyager has deviated 42nm north of planned route. AIS tracking shows altered heading since 14:30 UTC.',
      whyItMatters:
        'Route deviation may signal weather avoidance, mechanical issue, or unauthorized cargo stop. Increases transit time and fuel cost.',
      recommendedResponse:
        'Contact vessel master immediately. Request deviation explanation and ETA update.',
      businessConsequence:
        'Estimated 8-hour delay to Rotterdam arrival — potential demurrage $18,400.',
    ...
    },
    {
      ...
      description:
        'NWS track shows Category 2 typhoon developing in South China Sea. SS Pacific Guardian route passes through projected track in 72 hours.',
      whyItMatters:
        'Typhoon path intercept risk — vessel may require route diversion adding 4–6 days to transit.',
      recommendedResponse:
        'Pre-position vessel deviation route. Coordinate with charter counterparty on schedule flexibility.',
      businessConsequence:
        'Potential 5-day delay to LA arrival — $42,000 fuel cost for diversion route.',
    ...
    },
    {
      ...
      description:
        'Port of Los Angeles reporting 4.2-day average anchor wait. MV Coral Breeze will arrive in 72 hours — congestion likely.',
      whyItMatters: 'Port congestion adds waiting time and potential demurrage exposure.',
      recommendedResponse:
        'Notify cargo receivers of expected delay. Consider slow steaming to optimize arrival window.',
    ...
    },
    {
      ...
      description:
        'Remote monitoring system detecting elevated exhaust temperatures on cylinder units 3 and 4 of main engine. Early stage of potential failure.',
      whyItMatters:
        'Unaddressed engine anomaly can escalate to engine failure at sea — requiring towage and cargo transshipment.',
      recommendedResponse:
        'Divert to Fujairah for inspection within 24 hours. Engage class surveyor.',
    ...
    },
    {
      ...
      description:
        'Daily fuel consumption reports show Northern Star consuming 52MT/day vs. 45MT/day voyage plan — 15.6% over budget.',
      whyItMatters:
        'Excess fuel consumption at current bunker prices (~$472/MT) adds $3,300/day to voyage cost.',
      recommendedResponse:
        'Review speed and trim optimization. Investigate potential hull fouling.',
  ...
  await db.insert(vesselMaintenanceTable).values([
    {
      ...
      description: 'Turbocharger inspection and bearing replacement per manufacturer schedule.',
      status: 'due_soon',
      priority: 'high',
      dueDate: daysAhead(14),
      estimatedCost: '28000',
      riskOfServiceIssue: '0.42',
      impactsVoyageAvailability: true,
      assetHealth: '0.72',
      technician: 'Chief Engineer Rodriguez',
    },
    {
      vesselId: 1,
      component: 'Hull — Anti-Fouling Coating',
      maintenanceType: 'scheduled',
      description: 'Dry dock hull cleaning and anti-fouling paint renewal. Class due.',
      status: 'scheduled',
      priority: 'medium',
      dueDate: daysAhead(65),
      estimatedCost: '185000',
      riskOfServiceIssue: '0.18',
      impactsVoyageAvailability: true,
      assetHealth: '0.81',
      technician: 'Drydock Team — Port Newark',
    },
    {
      vesselId: 2,
      ...
      description:
        'Cargo pump #2 seal failure detected during last voyage. Repair required before next loading.',
      status: 'in_progress',
      priority: 'critical',
      dueDate: daysAgo(1),
      estimatedCost: '42000',
      riskOfServiceIssue: '0.88',
      impactsVoyageAvailability: true,
      assetHealth: '0.55',
      technician: 'Chief Engineer Kim',
      notes: 'Parts on order — ETA 2 days.',
    },
    {
      vesselId: 3,
      component: 'Hold Hatch Seals — All Holds',
      maintenanceType: 'corrective',
      description:
        'Water ingress via hold #3 hatch seals during Pacific storm. All seals require inspection and replacement.',
      status: 'in_progress',
      priority: 'high',
      dueDate: new Date(),
      estimatedCost: '18500',
      riskOfServiceIssue: '0.65',
      impactsVoyageAvailability: true,
      assetHealth: '0.68',
      technician: 'Port Maintenance Team — Qingdao',
    },
    {
      vesselId: 4,
      component: 'Main Engine — Cylinders 3-4',
      maintenanceType: 'predictive',
      description:
        'Elevated exhaust temperatures on cylinders 3-4. Predictive failure signature detected by remote monitoring.',
      status: 'due_soon',
      priority: 'critical',
      dueDate: daysAhead(1),
      estimatedCost: '85000',
      riskOfServiceIssue: '0.91',
      impactsVoyageAvailability: true,
      assetHealth: '0.48',
      technician: 'MAN Energy Solutions — Service',
    },
    {
      vesselId: 5,
      component: 'Propeller — Pitch Control',
      maintenanceType: 'preventive',
      description:
        'Controllable pitch propeller — annual pitch control system lubrication and inspection.',
      status: 'scheduled',
      priority: 'low',
      dueDate: daysAhead(45),
      estimatedCost: '8500',
      riskOfServiceIssue: '0.12',
      impactsVoyageAvailability: false,
      assetHealth: '0.92',
      technician: 'Wartsila Service Team',
    },
  ]);
  ...
  await db.insert(vesselSanctionsScreeningTable).values([
    {
      ...
      flagRegistryValid: true,
      pscResult: 'no_inspection',
    },
    {
      vesselId: 2,
      screeningDate: daysAgo(2),
      ofacStatus: 'clear',
      euStatus: 'clear',
      unStatus: 'clear',
      ukStatus: 'clear',
