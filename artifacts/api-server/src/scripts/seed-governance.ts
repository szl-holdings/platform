...
export async function seedGovernance() {
    ...
    .values([
      {
        ...
        description:
          'Requires human approval for any AI-generated content, recommendation, or action that will be surfaced externally or used in a binding decision.',
      ...
      },
      {
        ...
        description:
          'Enforces maximum AI inference cost per agent run in the production environment. Blocks execution if per-call cost exceeds $0.50.',
        policyType: 'cost_ceiling',
        scope: 'global',
        rules: [
          { maxCostPerCall: 0.5, action: 'block_and_alert', environment: 'production' },
          { maxCostPerCall: 2.0, action: 'alert_only', environment: 'staging' },
        ],
        isActive: true,
        priority: 20,
      ...
      },
      {
        ...
        description:
          'Controls which agent roles and users can access PII, financial records, and attorney-client privileged data. Enforces access logging.',
        policyType: 'data_access',
        scope: 'tenant',
        rules: [
          { resource: 'pii', requiredRole: 'operator', logAccess: true },
          {
            resource: 'privileged_documents',
      ...
      },
      {
        ...
        description:
          'Controls which agents are permitted to send external communications (email, Slack messages, webhooks) on behalf of the organization.',
        policyType: 'agent_permission',
        scope: 'global',
        rules: [
          {
            action: 'send_email',
            allowedAgents: ['communication-agent', 'notification-agent'],
            requireApproval: true,
          },
      ...
      },
      {
        ...
        description:
          'Automated compliance template mapping platform controls to SOC 2 Trust Service Criteria.',
        policyType: 'compliance_template',
        scope: 'global',
        rules: [
          {
            criteria: 'CC6.1',
            control: 'Access control — role-based permissions enforced',
            status: 'compliant',
          },
          {
            criteria: 'CC7.2',
            control: 'System monitoring — health checks every 5 minutes',
            status: 'compliant',
          },
          {
            criteria: 'CC8.1',
            control: 'Change management — all deployments require PR review',
            status: 'compliant',
          },
          {
            criteria: 'CC9.2',
            control: 'Vendor risk — quarterly vendor security assessments',
            status: 'in_progress',
          },
        ],
        isActive: true,
  ...
  await db
    ...
    .values([
      {
        orgId: ORG_ID,
        name: 'Primary Production Router — Claude Sonnet',
        modelProvider: 'anthropic',
        modelId: 'claude-sonnet-4-5',
        taskCategories: ['reasoning', 'analysis', 'writing', 'summarization'],
        maxCostPerCall: '0.15',
        isAllowed: true,
        isDefault: true,
        priority: 10,
      ...
      {
        orgId: ORG_ID,
        name: 'Fast Classification — GPT-4o Mini',
        modelProvider: 'openai',
        modelId: 'gpt-4o-mini',
        taskCategories: ['classification', 'extraction', 'routing', 'tagging'],
        maxCostPerCall: '0.02',
        isAllowed: true,
        isDefault: false,
        priority: 20,
      ...
      },
      {
        ...
        taskCategories: ['embedding', 'similarity', 'search'],
      ...
      {
        orgId: ORG_ID,
        name: 'High-Stakes Legal — Claude Opus',
        modelProvider: 'anthropic',
        modelId: 'claude-opus-4-5',
        taskCategories: ['legal_analysis', 'privilege_review', 'contract_analysis'],
        maxCostPerCall: '0.75',
        isAllowed: true,
        isDefault: false,
        priority: 5,
      ...
      {
        orgId: ORG_ID,
        name: 'Staging Router — GPT-4o',
        modelProvider: 'openai',
        modelId: 'gpt-4o',
        taskCategories: ['reasoning', 'analysis', 'writing'],
        maxCostPerCall: '0.10',
        isAllowed: true,
        isDefault: true,
        priority: 10,
  ...
  const budgets = await db
    ...
    .values([
      {
        orgId: ORG_ID,
        name: 'Platform AI — Monthly Budget',
        budgetType: 'monthly',
        limitAmount: '2000.00',
        currentSpend: '847.32',
        warnThreshold: '0.80',
      ...
      {
        orgId: ORG_ID,
        name: 'Aegis Threat Intelligence — Daily Budget',
        budgetType: 'daily',
        limitAmount: '150.00',
        currentSpend: '42.18',
        warnThreshold: '0.80',
    ...
    .values([
      {
        ...
        eventType: 'agent_run',
        resourceId: 'lyte-signal-agent',
        resourceName: 'Lyte Signal Detection Agent',
        modelProvider: 'anthropic',
        modelId: 'claude-sonnet-4-5',
        tokensIn: 2400,
        tokensOut: 850,
      ...
      },
      {
        ...
        resourceId: 'vessels-route-analyzer',
        resourceName: 'Vessels Route Analysis Skill',
        modelProvider: 'openai',
        modelId: 'gpt-4o-mini',
        tokensIn: 1200,
        tokensOut: 400,
      ...
      },
      {
        ...
        resourceId: 'terra-distress-scorer',
        resourceName: 'Terra Distress Scoring',
        modelProvider: 'openai',
        modelId: 'gpt-4o-mini',
        tokensIn: 800,
        tokensOut: 200,
      ...
      },
      {
        ...
        eventType: 'agent_run',
        resourceId: 'prism-forecast-agent',
        resourceName: 'PRISM Settlement Forecast Agent',
        modelProvider: 'anthropic',
        modelId: 'claude-opus-4-5',
        tokensIn: 8200,
        tokensOut: 2100,
      ...
      },
      {
        ...
        budgetId: budgets[1].id,
        eventType: 'skill_invocation',
        resourceId: 'prism-demand-readiness',
        resourceName: 'PRISM Demand Readiness Scorer',
        modelProvider: 'anthropic',
        modelId: 'claude-sonnet-4-5',
        tokensIn: 4100,
        tokensOut: 1200,
      ...
      },
      {
        ...
        eventType: 'agent_run',
        resourceId: 'aegis-threat-intel',
        resourceName: 'Aegis Threat Intelligence Agent',
        modelProvider: 'anthropic',
        modelId: 'claude-sonnet-4-5',
        tokensIn: 5600,
        tokensOut: 1800,
    ...
    .values([
      {
        ...
        description:
          'PRISM legal analysis agent consumed $428 in a single day during bulk matter processing, exceeding the $150 daily alert threshold.',
        agentId: 'prism-legal-analysis-agent',
        resourceType: 'agent_run',
        resolution:
          'Daily cost cap enforcement added to agent configuration. Bulk processing now limited to off-peak windows.',
      ...
      },
      {
        ...
        description:
          'Communication agent sent external email to law firm client without human review approval. Email was informational and not harmful, but violated the external output approval gate.',
        agentId: 'communication-agent',
        resourceType: 'email',
        resolution:
          'Communication agent deployment pipeline updated to enforce approval gate before any external transmission.',
      ...
      },
      {
        ...
        description:
          'Attorney manually overrode PRISM AI-generated settlement demand amount ($290K → $350K) without logging rationale in system.',
      ...
      },
      {
        ...
        description:
          'Route analysis agent timed out during Pacific fleet computation. Non-critical — fallback cache data served.',
        agentId: 'vessels-route-analyzer',
        resourceType: 'workflow_run',
        resolution:
          'Timeout threshold increased from 15s to 45s. Pacific routing computation optimized.',
        resolvedBy: 'stephen@szlholdings.com',
    ...
    .values([
      {
        ...
        recommendationSummary:
          'Recommend transition from standard advisory to discretionary managed account for equity portfolio.',
        rationaleText:
          "Client's 10+ year investment horizon, high risk tolerance, and illiquidity tolerance support discretionary management structure.",
        clientProfile: {
          age: 52,
          netWorth: '25M+',
          incomeLevel: 'high',
      ...
      },
      {
        ...
        recommendationSummary:
          'Recommend adding 15% allocation to private credit through Series B+ company credit facilities.',
        rationaleText:
          "Client's moderate-to-aggressive risk profile and 7-year horizon accommodate illiquid credit positions. Expected yield premium 4–6% over public fixed income.",
        clientProfile: {
          age: 38,
          netWorth: '4M+',
          incomeLevel: 'high',
        ...
        conflicts: [
          {
            type: 'advisory_fee',
            description: 'Advisor receives performance fee on private credit allocation',
          },
        ],
    ...
    .values([
      {
        ...
        participants: [
          { id: 'advisor-szl-001', name: 'Stephen L.', role: 'advisor' },
          { id: 'client-holloway-001', name: 'Vanessa Holloway', role: 'client' },
        ],
      ...
      },
      {
        ...
        participants: [
          { id: 'advisor-szl-001', name: 'Stephen L.', role: 'advisor' },
          { id: 'client-chakrabarti-002', name: 'Priya Chakrabarti', role: 'client' },
        ],
      ...
      },
      {
        ...
        contentSummary:
          'Trade confirmation for $450K private credit allocation in Meridian Credit Fund III.',
        retentionPolicy: 'rule_17a4_3year',
        retentionExpiresAt: daysAhead(365 * 3),
        isImmutable: true,
      },
    ...
    .values([
      {
        ...
        description:
          'Pending review of private credit recommendation with identified conflict of interest. Requires independent suitability sign-off.',
        assignedToId: 'reviewer-001',
        assignedToName: 'Jordan Chen',
        submittedById: 'advisor-szl-001',
        submittedByName: 'Stephen L.',
        relatedEntities: [
          { type: 'client', id: 'client-chakrabarti-002', name: 'Priya Chakrabarti' },
        ],
        escalationLevel: 0,
        riskScore: '62.00',
        dueAt: daysAhead(5),
        auditTrail: [
          { action: 'created', by: 'system', at: daysAgo(2).toISOString() },
          { action: 'assigned', by: 'admin', at: daysAgo(1).toISOString() },
        ],
      },
      {
        orgId: ORG_ID,
        ...
        description:
          'Routine monthly spot check of archived communications for completeness and retention compliance.',
        assignedToId: 'reviewer-001',
        assignedToName: 'Jordan Chen',
      ...
      },
      {
        ...
        description:
          'Review flagged: performance fee arrangement on Holloway private credit allocation may require enhanced conflict disclosure under Reg BI. Legal review requested.',
        ...
        dueAt: daysAhead(3),
        auditTrail: [
          { action: 'auto_created', by: 'system', at: daysAgo(3).toISOString() },
          { action: 'escalated', by: 'reviewer-001', at: daysAgo(1).toISOString() },
        ],
      },
    ])
    .onConflictDoNothing();
    ...
    .values([
      {
        ...
        description:
          'Comprehensive annual review of all compliance policies, procedures, and controls. Required annually under our compliance program.',
      ...
      },
      {
        ...
        description:
          'Quarterly Regulation Best Interest audit covering suitability documentation, conflict disclosure, and care obligation assessments.',
      ...
      },
      {
        ...
        description:
          'Review and validation of communication archival completeness against Rule 17a-4 retention requirements.',
      ...
      },
      {
        ...
        description:
          'Annual review of data access and privacy policies for GDPR and CCPA compliance.',
