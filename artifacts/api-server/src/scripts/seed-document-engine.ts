        ...
        blocks: [
          {
            id: '1',
            type: 'heading1',
            children: [{ text: 'Incident Response Plan — {{incident_id}}' }],
          },
          { id: '2', type: 'paragraph', children: [{ text: 'Severity: {{severity}}' }] },
          {
            id: '3',
            type: 'paragraph',
            children: [{ text: 'Affected System: {{affected_system}}' }],
          },
      ...
      contentJson: {
        ...
        blocks: [
          { id: '1', type: 'heading1', children: [{ text: 'Consulting Agreement' }] },
          {
            ...
            children: [
              {
                text: 'This agreement is entered into by Carlota Jo Consulting and {{client_name}}.',
              },
            ],
          },
          ...
          { id: '5', type: 'heading2', children: [{ text: 'Compensation' }] },
          {
            ...
            type: 'paragraph',
            children: [
              { text: 'Monthly retainer: {{retainer_amount}}, commencing {{engagement_start}}.' },
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            id: '1',
            type: 'heading1',
            children: [{ text: 'Voyage Charter Party — {{vessel_name}}' }],
          },
          { id: '2', type: 'paragraph', children: [{ text: 'Voyage No: {{voyage_number}}' }] },
          {
            id: '3',
            type: 'paragraph',
            children: [{ text: 'From: {{port_of_departure}} To: {{port_of_arrival}}' }],
          },
      ...
      contentJson: {
        ...
        blocks: [
          ...
          { id: '3', type: 'paragraph', children: [{ text: 'Requested by: {{requester}}' }] },
          {
            id: '4',
            type: 'paragraph',
            children: [{ text: 'Target system: {{integration_target}}' }],
          },
          {
            id: '5',
            type: 'paragraph',
            children: [{ text: 'Approval required by: {{approval_deadline}}' }],
          },
        ],
      },
      isActive: true,
      ...
      contentJson: {
        ...
        blocks: [
          { id: 'cl1', type: 'horizontal_rule', children: [{ text: '' }] },
          {
            ...
            children: [
              {
                text: 'CONFIDENTIAL: This document contains confidential information intended solely for the named recipient. Any unauthorized disclosure, copying, or distribution is strictly prohibited.',
              },
            ],
          },
        ],
      ...
      contentJson: {
        ...
        blocks: [
          { id: 'sb1', type: 'horizontal_rule', children: [{ text: '' }] },
          {
            id: 'sb2',
            type: 'paragraph',
            children: [{ text: 'Signed: _________________________ Date: _________________' }],
          },
          { id: 'sb3', type: 'paragraph', children: [{ text: 'Name: {{client_name}}' }] },
          {
            ...
            type: 'paragraph',
            children: [
              { text: 'Title: _________________________ Organization: _________________' },
            ],
          },
        ],
      },
      ...
      contentJson: {
        ...
        blocks: [
          { id: 'rf1', type: 'heading2', children: [{ text: 'Risk Factors' }] },
          {
            id: 'rf2',
            type: 'bullet_list',
            children: [{ text: 'Market risk: adverse movements in interest rates or cap rates' }],
          },
          {
            id: 'rf3',
            type: 'bullet_list',
            children: [
              { text: 'Environmental risk: undisclosed contamination or compliance issues' },
            ],
          },
          {
            id: 'rf4',
            type: 'bullet_list',
            children: [
              { text: 'Tenant risk: vacancy, non-renewal, or creditworthiness of key tenants' },
            ],
          },
          {
            id: 'rf5',
            ...
            children: [
              {
                text: 'Execution risk: permitting delays, construction overruns, or financing gaps',
              },
            ],
          },
        ],
      ...
      contentJson: {
        ...
        blocks: [
          { id: 'lt1', type: 'heading2', children: [{ text: 'Laytime & Demurrage' }] },
          {
            ...
            children: [
              {
                text: 'Laytime for loading and discharging shall be 72 running hours, Saturdays, Sundays, and holidays included (SHINC). Demurrage, if incurred, shall be at the rate of USD [●] per day pro rata.',
              },
            ],
          },
          {
            ...
            children: [
              {
                text: 'Time shall commence 6 hours after Notice of Readiness (NOR) is tendered, whether in berth or not (WIBON), whether in port or not (WIPON).',
              },
            ],
          },
        ],
