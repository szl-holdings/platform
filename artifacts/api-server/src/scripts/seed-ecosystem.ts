...
async function seedDistressProperties() {
  ...
  const properties: InsertTerraDistressProperty[] = [
      ...
      timeline: [
        {
          date: '2025-04-01',
          type: 'Payment Default',
          description: 'First missed payment recorded',
        },
        {
          date: '2025-06-20',
          type: 'Lis Pendens Filed',
    ...
    },
    {
      ...
      confidenceLevel: 'high',
      scoreRationale:
        'Foreclosure notice filed, 18% equity cushion, South Bronx renovation corridor',
      latitude: '40.8104',
      longitude: '-73.9051',
      sqft: 3400,
      yearBuilt: 1938,
    ...
    },
    {
      ...
      confidenceLevel: 'medium',
      scoreRationale:
        'Early-stage pre-foreclosure, mixed-use building near ferry terminal, conversion potential',
      latitude: '40.6365',
      longitude: '-74.1242',
      sqft: 2800,
      yearBuilt: 1955,
    ...
    },
    {
      ...
      confidenceLevel: 'high',
      scoreRationale:
        'Major Flushing corridor, growing Asian-American commercial district, lien exceeds 9% of value',
      latitude: '40.7580',
      longitude: '-73.8318',
      sqft: 7800,
      yearBuilt: 1968,
    ...
    },
    {
      ...
      confidenceLevel: 'high',
      scoreRationale:
        'Foreclosure judgment entered, Prospect Heights premium location, forced sale approaching',
      latitude: '40.6697',
      longitude: '-73.9585',
      sqft: 12600,
      yearBuilt: 1924,
    ...
    },
    {
      ...
      confidenceLevel: 'high',
      scoreRationale:
        '125th St corridor premier retail, auction May 2nd — below market acquisition opportunity, zero cure activity',
      latitude: '40.8086',
      longitude: '-73.9510',
      sqft: 8400,
      yearBuilt: 1985,
    ...
    },
    {
      ...
      confidenceLevel: 'medium',
      scoreRationale:
        'JFK-adjacent industrial, pre-foreclosure stage, potential rezoning to logistics/last-mile',
      latitude: '40.7010',
      longitude: '-73.8058',
      sqft: 11200,
      yearBuilt: 1962,
    ...
    },
    {
      ...
      confidenceLevel: 'high',
      scoreRationale:
        'Grand Concourse Art Deco landmark, architectural district, lien 8.8% of value — motivated trust owners',
      latitude: '40.8530',
      longitude: '-73.9161',
      sqft: 16400,
      yearBuilt: 1931,
    ...
    },
    {
      ...
      confidenceLevel: 'high',
      scoreRationale:
        'Downtown Brooklyn Fulton corridor, mixed-use asset, 15% equity, foreclosure notice — strong buyer demand',
      latitude: '40.6917',
      longitude: '-73.9881',
      sqft: 14200,
      yearBuilt: 1972,
    ...
    },
    {
      ...
      confidenceLevel: 'medium',
      scoreRationale:
        'East Bronx commercial strip, early pre-foreclosure, 24% equity cushion — outreach window open',
      latitude: '40.8401',
      longitude: '-73.8527',
      sqft: 3600,
      yearBuilt: 1958,
...
async function seedFirestormData() {
  ...
  const [assessment1] = await db
    ...
    .values({
      ...
      description:
        'Quarterly red team exercise covering API surface, auth flows, and data pipeline security',
      ...
      executiveSummary:
        '7 critical findings, 12 high, 23 medium identified across the platform surface. Authentication bypass and injection vectors prioritized.',
    })
    .returning();
  ...
  const [assessment2] = await db
    ...
    .values({
      ...
      executiveSummary:
        'Rate limiting bypass identified on 3 endpoints. CORS misconfiguration on legacy routes. All critical findings remediated.',
    })
    .returning();
    ...
    const findings = [
      {
        ...
        recommendation:
          'Parameterize all query inputs, add WAF rule, validate enum values server-side',
        cvssScore: '9.1',
      },
      {
        assessmentId: assessment1.id,
        ...
        description:
          'Existing JWT sessions remain valid after password change, allowing session hijack persistence',
        ...
        recommendation:
          'Implement token blacklist or version-based invalidation on credential changes',
        cvssScore: '7.8',
      },
      {
        assessmentId: assessment1.id,
        ...
        description:
          'Production error responses expose internal stack traces and file paths in non-prod mode',
        ...
        recommendation:
          'Enforce NODE_ENV=production check, strip all stack traces from API responses',
        cvssScore: '5.3',
      },
      {
        assessmentId: assessment1.id,
        ...
        description:
          'POST /api/core/recommendations lacks per-IP rate limiting, enabling AI inference abuse',
        severity: 'high' as const,
        status: 'open' as const,
        ...
        recommendation:
          'Apply writeLimiter middleware, add auth requirement, implement cost-per-user tracking',
        cvssScore: '7.2',
      },
      {
        ...
        description:
          'Legacy /api/gov/* routes allow wildcard CORS origin, exposing data to any cross-origin request',
        severity: 'high' as const,
        ...
        recommendation:
          'Explicitly enumerate allowed origins, remove wildcard from non-public routes',
        cvssScore: '6.5',
      },
      {
        assessmentId: assessment2.id,
        ...
        description:
          'Admin panel access not tracked in audit_logs — no forensic trail for admin operations',
        severity: 'medium' as const,
        status: 'open' as const,
  ...
  const runs = [
    ...
    },
    {
      ...
      result: {
        ...
        findings_new: 4,
        findings_resolved: 2,
        warnings: ['CVE-2025-1234 unpatched on 2 nodes'],
      },
...
async function seedAuditLogs() {
  ...
  const events = [
    {
      actionType: 'distress_property.ingested',
      entityType: 'distress_property',
      entityId: 'dp-seed-001',
      payloadJson: { source: 'NYC ACRIS', score: 87 },
    },
    {
      actionType: 'distress_property.ingested',
      entityType: 'distress_property',
      entityId: 'dp-seed-002',
      payloadJson: { source: 'NYC Auction Registry', score: 92 },
    },
    {
      actionType: 'alloy.recommendation.generated',
      entityType: 'recommendation',
      entityId: 'rec-batch-001',
      payloadJson: { entity_type: 'distress_property', count: 12 },
    },
    {
      actionType: 'firestorm.finding.created',
      entityType: 'vulnerability',
      entityId: 'finding-sql-001',
      payloadJson: { severity: 'critical', cvss: '9.1' },
    },
    {
      actionType: 'alloy.workflow.started',
      entityType: 'workflow',
      entityId: 'wf-normalize-001',
      payloadJson: { domain: 'alloy', type: 'signal.normalize' },
    },
    {
      actionType: 'user.login',
      entityType: 'session',
      entityId: 'admin',
      payloadJson: { method: 'replit-oidc', ip: '10.0.0.1' },
    },
    {
      actionType: 'holdings.inquiry.submitted',
      entityType: 'inquiry',
      entityId: 'inq-001',
      payloadJson: { type: 'investment', interest: '$5M+' },
    },
    {
      actionType: 'vessels.anomaly.detected',
      entityType: 'vessel',
      entityId: 'vessel-mmsi-123456789',
      payloadJson: { type: 'dark_period', duration_hours: 18 },
    },
    {
      actionType: 'lyte.incident.escalated',
      entityType: 'incident',
      entityId: 'inc-7821',
      payloadJson: { severity: 'high', playbook: 'P3-network-intrusion' },
    },
    {
      actionType: 'terra.lead.created',
      entityType: 'lead',
      entityId: 'lead-001',
      payloadJson: { source: 'distress_alert', property: 'dp-seed-007' },
    },
  ];
  ...
  const recs = [
    {
      ...
      reasoning:
        'Opportunity score 92/100 — 283 days in distress, distress type: auction (est. $4,200,000). Auction scheduled April 10. Owner is highly motivated — advanced distress stage.',
      recommendedAction:
        'Acquire or note-purchase 234 W 145th St in Manhattan. High-priority — act within 72 hours.',
      timeframe: '72 hours',
      context: {
    ...
    },
    {
      ...
      reasoning:
        'Opportunity score 87/100 — 136 days in distress, distress type: pre-foreclosure (est. $2,850,000). Opportunity score, days in distress, debt to value all factored. Early/mid-stage — window available for outreach.',
      recommendedAction:
        'Acquire or note-purchase 1847 Flatbush Ave in Brooklyn. High-priority — act within 72 hours.',
      timeframe: '72 hours',
    ...
    },
    {
      ...
      reasoning:
        'CVSS score 9.1/10 on /api/terra/distress/search?borough=. Exploitability and asset criticality indicate critical business risk. Immediate remediation prevents potential breach escalation.',
      recommendedAction:
        'Remediate within 24 hours — patch /api/terra/distress/search?borough=, verify remediation, update security posture in Firestorm.',
      timeframe: '24 hours',
      context: {
        cvss_score: 9.1,
        affected_asset: '/api/terra/distress/search',
        title: 'SQL Injection Vector in Distress Property Search',
      },
    },
    {
      ...
      reasoning:
        'Incident severity is critical. Containment status and blast radius indicate immediate escalation required. Cross-domain correlation with known threat patterns.',
      recommendedAction:
        'Escalate and contain immediately in Aegis Operations — assign incident commander, activate playbook, notify stakeholders within 15 minutes.',
      timeframe: '15 minutes',
      context: {
        severity: 'critical',
        title: 'Lyte Playbook Execution Timeout',
    ...
    },
    {
      ...
      reasoning:
        'Analyzed anomaly score, sanctions risk, route deviation for entity of type vessel. Score of 72 reflects elevated priority across vessels domain.',
      recommendedAction:
        'Flag for review this vessel within 48 hours — review in vessels dashboard.',
      timeframe: '48 hours',
