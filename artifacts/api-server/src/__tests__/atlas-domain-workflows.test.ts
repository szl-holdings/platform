...
const DOMAIN_CASES = [
  ...
  },
  {
    ...
    signalType: "filing-deadline",
    severity: "high" as const,
    title: "Appellate brief due in 5 days — Matter #CR-2024-0192",
    description: "Court deadline approaching; co-counsel has not submitted draft",
