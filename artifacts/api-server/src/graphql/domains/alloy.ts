  ...
  Subscription: {
    alloyWorkflowRunUpdated: {
      subscribe: withFilter(
        (_: unknown, __: unknown, context: SubscriptionWsContext) => {
          ...
          return pubsub.asyncIterableIterator(ALLOY_EVENTS.WORKFLOW_RUN_UPDATED);
        },
        (
    ...
    alloyApprovalRequired: {
      subscribe: withFilter(
        (_: unknown, __: unknown, context: SubscriptionWsContext) => {
          ...
          return pubsub.asyncIterableIterator(ALLOY_EVENTS.APPROVAL_REQUIRED);
        },
        (
    ...
    alloyWorkflowStatusChanged: {
      subscribe: (_: unknown, __: unknown, context: SubscriptionWsContext) => {
        requireOperatorWsUser(context);
        return pubsub.asyncIterableIterator(ALLOY_EVENTS.WORKFLOW_STATUS_CHANGED);
      },
    },
  },
};
