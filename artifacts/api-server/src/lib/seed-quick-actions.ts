...
const DEMO_APPROVALS = [
  {
    ...
    description:
      'CFO-initiated $2.4M wire to Cascade Partners LP closing account. Requires exec sign-off per treasury policy T-12.',
  ...
  },
  {
    ...
    description:
      'Port Kavkaz congestion requires rerouting via Bosporus. 18hr delay projected. Cargo SLA at risk.',
    ...
    payload: {
      ...
      cargo: 'Class B Petroleum',
      delay: '18hr',
      alternateRoute: 'Bosporus Strait',
    },
  ...
  },
  {
    ...
    description:
      'CVSS 9.1 authentication bypass affecting API gateway cluster. Zero-day exploit detected in the wild. Immediate patching required.',
    actionClass: 'authorize',
    priority: 'critical' as const,
    ...
    payload: {
      cve: 'CVE-2025-8847',
      cvss: '9.1',
      affectedSystems: ['api-gateway', 'auth-svc'],
      deployWindow: '2h',
    },
  ...
  },
  {
    ...
    description:
      'Letter of Intent for 450 Park Ave South — 22,000 sqft office at $112/sqft NNN. Offer expires in 48 hours.',
  ...
  },
  {
    ...
    description:
      'New family office seeking advisory mandate. KYC/AML clearance received. Engagement letter and fee schedule require partner sign-off before services commence.',
    actionClass: 'authorize',
    ...
    payload: {
      ...
      aum: '$2.1B',
      engagementType: 'Family Office Advisory',
      kycStatus: 'cleared',
    },
  ...
  },
  {
    ...
    description:
      'API gateway P99 response time has exceeded SLO threshold for 18 consecutive minutes. Auto-remediation paused pending operator acknowledgment. Rollback or scale-out approval needed.',
    actionClass: 'acknowledge',
    priority: 'critical' as const,
...
export async function seedQuickActions(
  ...
  for (const approval of DEMO_APPROVALS) {
    try {
      ...
      logger.warn(
        { err, correlationId: approval.correlationId },
        '[seed-quick-actions] Failed to insert approval',
      );
    }
  }
