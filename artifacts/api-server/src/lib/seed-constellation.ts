  ...
  try {
    ...
    const [prop1, prop2, vessel1, lender1, owner1, matter1, incident1, tenant1] = await Promise.all([
      upsertNode({
        ...
        provenance: { sourceId: "terra-seed", sourceType: "seed", sourceLabel: "Constellation Demo Seed" },
        freshness: now,
        confidence: 0.95,
      ...
      upsertNode({
        ...
        provenance: { sourceId: "vessels-seed", sourceType: "seed", sourceLabel: "Constellation Demo Seed" },
        freshness: now,
        confidence: 0.98,
        sensitivityTier: "internal",
      ...
      upsertNode({
        ...
        provenance: { sourceId: "prism-seed", sourceType: "seed", sourceLabel: "Constellation Demo Seed" },
        freshness: now,
        confidence: 0.88,
        sensitivityTier: "confidential",
      ...
      upsertNode({
        ...
        provenance: { sourceId: "aegis-seed", sourceType: "seed", sourceLabel: "Constellation Demo Seed" },
        freshness: now,
        confidence: 0.97,
      ...
      upsertNode({
        ...
        provenance: { sourceId: "imperium-seed", sourceType: "seed", sourceLabel: "Constellation Demo Seed" },
        freshness: now,
        confidence: 1.0,
        sensitivityTier: "confidential",
