...
export async function seedPlatformData(): Promise<void> {
  ...
  await db.insert(productsTable).values([
    ...
    { key: "lyte", name: "Lyte Command Center", description: "Business telemetry and ops signal management for MSPs", category: "platform" as const, isActive: true },
    ...
    { key: "terra", name: "Terra", description: "Predictive intelligence and business analytics", category: "analytics" as const, isActive: true },
  ...
  await db.insert(platformSignalsTable).values([
    {
      ...
      valueAtRisk: "450000",
      metadata: { category: "performance", tags: ["api", "latency", "sla", "production"], whatHappened: "Production API latency spiked to P99 > 8000ms across all endpoints", nextAction: "Escalate to on-call engineering, initiate incident runbook" },
    ...
    },
    {
      ...
      valueAtRisk: "352800",
      metadata: { category: "revenue", tags: ["payments", "stripe", "webhooks"], whatHappened: "Payment webhook failure rate 14x normal — 147 transactions impacted" },
      receivedAt: hourAgo,
    },
    {
      orgId: seedOrgId,
      ...
      valueAtRisk: "2000000",
      metadata: { category: "security", tags: ["security", "login", "threat"], whatHappened: "Credential stuffing attempt detected — 47 attempts targeting 12 admin accounts" },
  ...
  await db.insert(platformSignalsTable).values([
    {
      ...
      valueAtRisk: "150000",
      metadata: { category: "incident", tags: ["customer", "sla", "incident", "acme"], whatHappened: "Acme Corp prod environment unresponsive — 3 core services down" },
