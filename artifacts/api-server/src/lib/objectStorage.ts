...
export class ObjectStorageService {
   ...
   * @param subPath - Relative path within PRIVATE_OBJECT_DIR (e.g. "pdfs/my-doc.pdf")
   * @param contentType - MIME type
   * @returns Normalized object path (e.g. "/objects/pdfs/my-doc.pdf")
   */
  async uploadBuffer(buffer: Buffer, subPath: string, contentType: string): Promise<string> {
    const privateObjectDir = this.getPrivateObjectDir();
