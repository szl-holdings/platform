...
const WRITE_ROLES = new Set([
  "founder_admin", "super_admin", "admin", "org_admin",
  "attorney", "paralegal", "operator", "ops",
]);
...
export function enforcePrivilegeFilter() {
  return (req: Request, _res: Response, next: NextFunction) => {
    const userRoles = getUserRoles(req);
    const canSeePrivileged = hasAnyRole(userRoles, new Set(["founder_admin", "super_admin", "admin", "org_admin", "attorney"]));
...
export function getPrismCapabilities(userRoles: string[]) {
  return {
    ...
    canViewPrivileged: hasAnyRole(userRoles, new Set(["founder_admin", "super_admin", "admin", "org_admin", "attorney"])),
