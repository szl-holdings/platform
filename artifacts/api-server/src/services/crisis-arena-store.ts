...
export async function seedCrisisArenaData(): Promise<void> {
  ...
  await insertEngagement({
    ...
    scopedDomains: ['Sentra', 'Counsel', 'DOMAINE'],
  ...
  await insertSubmission({
    ...
    impactEstimate: { revenueAtRiskUsd: 14_000_000, rtoBreach: 4320, rpoBreach: 2880, regulatoryExposureUsd: 2_500_000, blastRadiusDomains: ['Sentra', 'Counsel', 'DOMAINE'] },
  ...
  await insertSubmission({
    ...
    impactEstimate: { revenueAtRiskUsd: 8_400_000, rtoBreach: 5760, rpoBreach: 2880, regulatoryExposureUsd: 1_800_000, blastRadiusDomains: ['Sentra', 'SEXTANT'] },
