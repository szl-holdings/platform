...
vi.mock("../metering", () => ({ default: stubRouter() }));
...
// data-services group
vi.mock("../documents", () => ({ default: stubRouter() }));
...
// security group
vi.mock("../firestorm", () => ({ default: stubRouter() }));
...
vi.mock("../intelligence", () => ({ default: stubRouter() }));
...
vi.mock("../rmm", () => ({ default: stubRouter() }));
...
vi.mock("../distribution-os", () => ({ default: stubRouter() }));
...
vi.mock("../control-tower", () => ({ default: stubRouter() }));
