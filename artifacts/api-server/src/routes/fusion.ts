...
router.post("/fusion/alerts/:id/acknowledge", authMiddleware(), validateBody(bodyShape({})), async (req, res) => {
  const ok = fusionCortex.acknowledgeAlert(req.params.id as string);
  if (!ok) return sendError(res, "Alert not found", 404);
  res.json({ success: true, message: "Alert acknowledged" });
});

router.post("/fusion/alerts/:id/resolve", authMiddleware(), validateBody(bodyShape({})), async (req, res) => {
  const ok = fusionCortex.resolveAlert(req.params.id as string);
  if (!ok) return sendError(res, "Alert not found", 404);
  res.json({ success: true, message: "Alert resolved" });
});

router.post("/fusion/alerts/inject", authMiddleware(), validateBody(bodyShape({
...
router.post("/fusion/demo/seed", validateBody(bodyShape({})), authMiddleware(), async (_req, res) => {
...
router.post("/fusion/start-continuous", validateQuery(anyQuerySchema), authMiddleware(), validateBody(bodyShape({})), async (req, res) => {
...
router.post("/fusion/stop-continuous", validateBody(bodyShape({})), authMiddleware(), async (_req, res) => {
...
router.post("/fusion/patterns/:id/feedback", authMiddleware(), validateBody(bodyShape({
...
router.post("/fusion/alerts/:alertId/feedback", authMiddleware(), validateBody(bodyShape({
      "notes": z.unknown().optional(),
...
router.post("/fusion/patterns/custom", authMiddleware(), validateBody(bodyShape({
      "category": z.unknown().optional(),
...
router.post("/fusion/predictive/project", authMiddleware(), validateBody(bodyShape({
...
router.post("/fusion/predictive/generate", authMiddleware(), validateBody(bodyShape({
      "confidence": z.unknown().optional(),
      "horizon": z.unknown().optional(),
      "tags": z.unknown().optional(),
      "title": z.unknown().optional(),
...
router.post("/fusion/predictive/alerts/:id/resolve", authMiddleware(), validateBody(bodyShape({})), async (req, res) => {
