        ...
        try {
          ...
          try {
            ...
            logger.error(
              ...
              'alloy-voice: transcription failed — marking as failed, no fallback',
            );
            await pool.query(
          ...
          logger.info(
            ...
            'alloy-voice: transcription completed',
          );
        } catch (asyncErr) {
