...
router.post(
  '/continuum/research/spaces/:id/run',
  authMiddleware({ required: false }),
  validateBody(
    bodyShape({
...
Return ONLY valid JSON.`;
        ...
        const researchResult = await callModel({
          provider: 'openai', model: 'gpt-5.2', surface: 'continuum-research',
          fn: async () => {
...
router.post(
  '/continuum/browser/tasks/:id/execute',
  authMiddleware({ required: false }),
  validateBody(bodyShape({})),
  async (req: Request, res: Response) => {
    try {
...
router.post(
  '/continuum/browser/tasks/:id/pause',
  authMiddleware({ required: false }),
  validateBody(bodyShape({})),
  async (req: Request, res: Response) => {
    try {
...
router.post(
  '/continuum/browser/tasks/:id/resume',
  authMiddleware({ required: false }),
  validateBody(bodyShape({})),
  async (req: Request, res: Response) => {
    try {
...
router.delete(
  '/continuum/browser/allowlist/:id',
  validateBody(bodyShape({})),
  authMiddleware({ required: false }),
  async (req: Request, res: Response) => {
    try {
