...
export { CONTROL_TOWER_AGENT_REGISTRY, AGENT_MANIFEST_VERSION, AGENT_MANIFEST_DATE };
...
export const DOMAIN_NAMESPACES = ["firestorm", "vessels", "terra", "lyte", "prism", "alloy"] as const;
