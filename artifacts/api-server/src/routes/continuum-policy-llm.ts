...
const SYSTEM_PROMPT = `You are the Continuum Policy Compiler's structured-parse assistant. Your job is to convert one ambiguous sentence of governance policy into a structured JSON object that downstream systems can enforce.
...
/**
 * POST /continuum/policies/llm-assist
 *
