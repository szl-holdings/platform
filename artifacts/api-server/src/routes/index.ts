...
import readinessLiveRouter from "./readiness-live";
import firestormLiveRouter from "./firestorm-live";
import incaLiveRouter from "./inca-live";
...
router.use(readinessLiveRouter);
router.use("/firestorm", readLimiter);
router.use(firestormLiveRouter);
router.use("/inca", readLimiter);
router.use(incaLiveRouter);
router.use("/vessels", readLimiter);
