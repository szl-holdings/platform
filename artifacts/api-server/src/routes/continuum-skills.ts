...
// Defense-in-depth: this router is mounted under /continuum in
// routes/groups/continuum.ts which already applies tenantScope({ required: true }),
...
router.use('/continuum/skills', tenantScope({ required: true }));
...
router.get('/continuum/skills', authMiddleware(), validateQuery(listQuerySchema), async (req, res) => {
  try {
...
router.get('/continuum/skills/:skillId', authMiddleware(), async (req, res) => {
  try {
...
router.get('/continuum/skills/chains/list', authMiddleware(), async (_req, res) => {
  try {
...
router.post(
  '/continuum/skills/chains/compose',
  authMiddleware(),
...
router.get('/continuum/skills/chains/prebuilt/:scenario', authMiddleware(), async (req, res) => {
  try {
...
router.post(
  '/continuum/skills/chains/:chainId/plan',
  authMiddleware(),
  validateBody(alloyResourceBodySchema),
  async (req, res) => {
    try {
...
router.delete(
  '/continuum/skills/chains/:chainId',
  validateBody(alloySkillDeleteSchema),
  authMiddleware(),
  requireRole('admin'),
  async (req, res) => {
...
router.post(
  '/continuum/decisions/:decisionId/outcome',
  authMiddleware(),
  validateBody(alloyResourceBodySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/agents/:agentId/performance',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/agents/:agentId/accuracy',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/agents/:agentId/calibration',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/agents/:agentId/trend',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/agents/:agentId/skill-effectiveness',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.post(
  '/continuum/agents/:agentId/performance/snapshot',
  authMiddleware(),
  requireRole('admin'),
  validateBody(alloyResourceBodySchema),
  async (req, res) => {
...
router.get(
  '/continuum/agents/:agentId/performance/history',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/agents/:agentId/self-reflection',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/agents/:agentId/reflections',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
...
router.post(
  '/continuum/performance/alerts/evaluate',
  authMiddleware(),
  requireRole('admin'),
  validateBody(alloyResourceBodySchema),
  async (req, res) => {
...
router.patch(
  '/continuum/performance/alerts/:alertId/resolve',
  authMiddleware(),
  validateBody(alloyResourceBodySchema),
  async (req, res) => {
    try {
...
router.get(
  '/continuum/self-improvement/config',
  authMiddleware(),
  validateQuery(listQuerySchema),
  async (req, res) => {
    try {
