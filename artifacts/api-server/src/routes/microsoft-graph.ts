  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      sendSuccess(res, {
        ...
        integrations: {
          sharePoint:
            'Read/write SharePoint document libraries — deal docs, compliance evidence, workflow attachments',
      ...
      handleRouteError(res, err, 'Failed to get Microsoft Graph status');
    }
  },
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      handleRouteError(res, err, 'Failed to list SharePoint files');
    }
  },
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      handleRouteError(res, err, 'Failed to list OneDrive files');
    }
  },
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      handleRouteError(res, err, 'Failed to list Outlook contacts');
    }
  },
);
...
router.get(
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      handleRouteError(res, err, 'Failed to list SharePoint sites');
    }
  },
);
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const adapter = services.microsoftGraph;
      const result = await adapter.sendTeamsNotification({
        text,
        title,
        color,
        channelId,
      ...
      handleRouteError(res, err, 'Failed to send Teams notification');
    }
  },
);
...
router.get(
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      handleRouteError(res, err, 'Failed to sync Microsoft Graph data');
    }
  },
);
