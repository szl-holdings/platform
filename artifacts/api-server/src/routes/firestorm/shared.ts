...
export const updateComplianceControlSchema = z
  .object({
    status: z.string().min(1).max(50).optional(),
...
export const updateWorkflowActionSchema = z
  .object({
    status: z.string().min(1).max(50).optional(),
    notes: z.string().max(5000).trim().optional(),
...
export const updateHardeningControlSchema = z
  .object({
    status: z.string().min(1).max(50).optional(),
    owner: z.string().max(200).trim().optional(),
    recommendedAction: z.string().max(5000).trim().optional(),
...
export const ingestWebhookSchema = z
  .object({
...
export const ingestSyslogSchema = z
  .object({
...
export const updateCaseMemorySchema = z
  .object({
...
export const tradecraftDecisionInputSchema = z
  .object({
...
export const evidenceIndexQuerySchema = z
  .object({
...
export const tradecraftDecisionActionSchema = z
  .object({
