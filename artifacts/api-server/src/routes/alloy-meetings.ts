        ...
        try {
          ...
          for (const item of extracted.actionItems) {
            ...
            try {
              ...
              logger.warn(
                { err: sigErr },
                'alloy-meetings: failed to create alloy signal for action item',
              );
            }
          ...
          logger.info(
            ...
            'alloy-meetings: capture completed',
          );
        } catch (asyncErr) {
...
router.patch(
  '/alloy/meetings/:id/action-items/:itemId',
  authMiddleware(),
  validateBody(
    bodyShape({
...
router.get(
  '/alloy/meetings/action-items/open',
  authMiddleware(),
