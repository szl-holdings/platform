    ...
    return [
      {
        ...
        lineage: [
          ...
          {
            label: 'Comparable selection algorithm run',
            sourceClass: 'system_computed',
            at: now(18000000),
          },
          {
            label: 'Valuation narrative generated',
            sourceClass: 'llm_generated',
            at: now(14400000),
          },
        ],
      },
      {
        ...
        inputSources: [
          { type: 'public_record', id: 'lien-889', label: 'Lien record — $127K outstanding' },
          {
            ...
            id: 'pay-hist-1124',
            label: 'Payment delinquency pattern (6 months)',
          },
    ...
    return [
      {
        ...
        reviewNote:
          'Confirmed AIS manipulation pattern. Recommend freezing trade activity pending OFAC verification.',
        generatedAt: now(3600000),
        serviceAttribution: 'Vessels Sanctions Engine v3',
        actorAttribution: 'APEX-Maritime Sentinel',
        inputSources: [
          ...
          {
            type: 'ownership_graph',
            id: 'ihs-ownership-01',
            label: 'IHS Ownership Graph — MV Poseidon',
          },
          {
            type: 'port_call_history',
            id: 'portcall-poseidon',
            label: 'Port Call History — 18 months',
          },
        ],
        lineage: [
          { label: 'AIS dark event detected', sourceClass: 'sensor_data', at: now(48 * 3600000) },
          {
            label: 'Ownership chain analyzed',
            sourceClass: 'system_computed',
            at: now(24 * 3600000),
          },
          {
            label: 'Sanctions proximity scored',
            sourceClass: 'system_computed',
            at: now(6 * 3600000),
          },
  ...
  return [
    {
      ...
      serviceAttribution: 'APEX-Sentinel v2.1',
    ...
    },
    {
      ...
      serviceAttribution: 'APEX-IR v1.8',
      inputSources: [
    ...
    return [
      {
        ...
        actor: 'Terra AI Engine',
        actorType: 'ai_model',
        domain: 'Terra',
        action: 'Property valuation generated — 47 Maple St ($3.95M ± 3.2%)',
        confidence: 0.82,
        modelUsed: 'gpt-4o',
        proofId: 2001,
        riskLevel: 'medium',
        immutableHash: 'a1b2c3d4e5f6a7b8',
      },
      {
        id: 't-002',
        ...
        actorType: 'human',
        domain: 'Terra',
        action: 'Valuation approved — 47 Maple St',
        approvedBy: 'Dana P. — Senior Analyst',
        outcome: 'Export safety state: Safe · Available for client distribution',
        riskLevel: 'low',
        immutableHash: 'b2c3d4e5f6a7b8c9',
      },
      {
        id: 't-003',
        ...
        actorType: 'agent',
        domain: 'Terra',
        action: 'High-distress property flagged — 89 River Rd (distress score 91/100)',
        confidence: 0.91,
        outcome: 'Added to acquisition target list',
        riskLevel: 'high',
        immutableHash: 'c3d4e5f6a7b8c9d0',
      },
      {
        id: 't-004',
        ...
        actorType: 'system',
        domain: 'Terra',
        action: 'Transaction approval policy evaluated — $4.8M deal',
        policyId: 'high_value_transaction',
        outcome: 'Escalated to Deal Manager',
        riskLevel: 'medium',
        immutableHash: 'd4e5f6a7b8c9d0e1',
      },
      {
        id: 't-005',
        ...
        actorType: 'human',
        domain: 'Terra',
        action: 'Investment memo exported to investor deck — 2245 Harbor Blvd',
        proofId: 2003,
        outcome: 'Awaiting proof review before export',
        riskLevel: 'high',
        immutableHash: 'e5f6a7b8c9d0e1f2',
      },
    ];
  }
    ...
    return [
      {
        ...
        actorType: 'ai_model',
        domain: 'Vessels',
        action: 'AIS dark vessel detected — MV Poseidon (42h gap)',
        confidence: 0.89,
        modelUsed: 'gpt-4o',
        proofId: 3001,
        riskLevel: 'critical',
        immutableHash: 'a1f2e3d4c5b6a7b8',
      },
      {
        id: 'v-002',
        ...
        actorType: 'system',
        domain: 'Vessels',
        action: 'Trade freeze escalated to Compliance Officer — sanctions proximity score 0.89',
        policyId: 'vessel_sanctions_response',
        outcome: 'Compliance review queued',
        riskLevel: 'critical',
        immutableHash: 'b2f3e4d5c6b7a8c9',
      },
      {
        id: 'v-003',
        timestamp: Date.now() - 3600000,
        actionType: 'recommendation',
        actor: 'Vessels AI Agent',
        actorType: 'agent',
        domain: 'Vessels',
        action: 'Voyage re-routing recommended — avoid high-risk corridor (Gulf of Aden)',
        confidence: 0.78,
        outcome: 'Alternative route proposed: +1.4 days, -$42K risk cost',
        riskLevel: 'high',
        immutableHash: 'c3f4e5d6c7b8a9d0',
      },
      {
        id: 'v-004',
        timestamp: Date.now() - 7200000,
        ...
        actorType: 'human',
        domain: 'Vessels',
        action: 'Voyage P&L approved for VES-2026-044 — Rotterdam to Singapore',
        approvedBy: 'Marcus O. — Commercial Director',
        outcome: 'Voyage executed · Estimated profit $218K',
        riskLevel: 'low',
        immutableHash: 'd4f5e6d7c8b9a0e1',
      },
      {
        id: 'v-005',
        timestamp: Date.now() - 14400000,
        actionType: 'proof_review',
        actor: 'Chen L.',
        actorType: 'human',
        domain: 'Vessels',
        action: 'Voyage P&L proof reviewed and cleared for export',
        proofId: 3002,
        outcome: 'Export safety: Safe',
        riskLevel: 'info',
        immutableHash: 'e5f6e7d8c9b0a1f2',
      },
    ];
  }
  ...
  return [
    {
      ...
      actorType: 'ai_model',
      domain: 'Aegis',
      action: 'Threat assessment generated for APT-class activity',
      entityType: 'threat',
      confidence: 0.87,
      modelUsed: 'gpt-4o',
      proofId: 1001,
      outcome: 'High-severity alert raised · Human review queued',
      riskLevel: 'high',
    ...
    },
    {
      ...
      actorType: 'human',
      domain: 'Aegis',
      action: 'Approved threat assessment and escalated to incident response',
      entityType: 'threat',
      approvedBy: 'Sarah K. — SOC Lead',
      outcome: 'IR-2026-044 opened',
      riskLevel: 'high',
      immutableHash: 'b7e4f1a9c3d25e08',
      chainLink: 'aud-001',
    },
    {
      id: 'aud-003',
      ...
      actorType: 'system',
      domain: 'Aegis',
      action: 'External notification policy evaluated — ESCALATE',
      policyId: 'security_incident_response',
      outcome: 'Escalation to Security Manager initiated',
      riskLevel: 'medium',
      immutableHash: 'c2a8f3b1d74e96f0',
    },
    {
      id: 'aud-004',
      timestamp: Date.now() - 3600000,
      ...
      actorType: 'agent',
      domain: 'Multi-Domain',
      action: 'Cross-domain correlation: Aegis threat linked to Vessels AIS anomaly',
      confidence: 0.74,
      outcome: 'Correlation published to PRISM Bus',
      riskLevel: 'high',
    ...
    },
    {
      id: 'aud-005',
      timestamp: Date.now() - 7200000,
      actionType: 'human_denial',
      actor: 'James M.',
      actorType: 'human',
      domain: 'Aegis',
      action: 'Denied automated IP blocking rule — insufficient evidence',
      overrideReason:
        'Correlation score below threshold for automated action. Requires manual investigation first.',
      outcome: 'Agent action blocked · Manual review assigned',
      riskLevel: 'medium',
    ...
    },
    {
      ...
      actorType: 'human',
      domain: 'Aegis',
      action: 'Proof chain reviewed and approved for Q2 vulnerability assessment',
      proofId: 1003,
      outcome: "Export safety state updated to 'safe'",
      riskLevel: 'low',
    ...
    },
    {
      ...
      actorType: 'human',
      domain: 'Aegis',
      action: 'Vulnerability assessment exported to board risk report',
      entityType: 'document',
      proofId: 1003,
      outcome: 'Export completed · 3 recipients',
      riskLevel: 'low',
    ...
    },
    {
      ...
      actorType: 'system',
      domain: 'Aegis',
      action: 'Threat intelligence feed rotation — CISA feeds updated',
      outcome: '4 feeds rotated · Coverage gap: none',
      riskLevel: 'info',
  ...
  if (domain === 'terra') {
    return [
      ...
      },
      {
        ...
        reason:
          'Transaction value $4.8M exceeds analyst approval threshold ($2M) — requires senior approval',
        ...
        approvalHistory: [
          {
            approver: 'Dana P. — Analyst',
            decision: 'approved',
            at: now(1200000),
            note: 'Strong deal fundamentals — recommending approval',
          },
    ...
    return [
      {
        ...
        reason:
          'Sanctions proximity alert on MV Poseidon — trade freeze requires compliance officer approval',
  ...
  return [
    {
      ...
      approvalHistory: [
        {
          approver: 'Sarah K. — SOC Lead',
          decision: 'approved',
          at: now(900000),
          note: 'Escalating per IR policy',
        },
...
function simulationResults(domain: Domain) {
  if (domain === 'terra') {
    return {
      ...
      predictedVsActual: [
        {
          label: 'Harbor Point Portfolio — 2025 acquisition',
          predicted: 480000,
          actual: 520000,
          format: 'currency',
          unit: '$',
        ...
        {
          label: 'Riverside Deal — 2024 acquisition',
          predicted: 310000,
          actual: 260000,
          format: 'currency',
          unit: '$',
      ...
      scenarios: [
        {
          ...
          sensitivityDrivers: [
            ...
            {
              id: 'renovation_overrun',
              label: 'Renovation Overrun',
              impact: -0.18,
              direction: 'negative',
            },
          ],
          costOfWaiting: {
            perDay: 1200,
            description: 'Daily opportunity cost vs current best-offer',
          },
          recommendation:
            'Strong return profile. Proceed if due diligence confirms occupancy assumptions.',
        ...
        },
        {
          ...
          recommendation:
            'Acceptable return at base case. Sensitivity to financing rate is the primary risk.',
          recommendationStrength: 'moderate',
        },
        {
          id: 'stressed',
          ...
          recommendation:
            'Negative outcome possible under severe stress scenario. Require interest rate cap before proceeding.',
  ...
  if (domain === 'vessels') {
    return {
      ...
      predictedVsActual: [
        {
          label: 'VES-2026-038 — Rotterdam → Shanghai',
          predicted: 180000,
          actual: 204000,
          format: 'currency',
          unit: '$',
        ...
        {
          label: 'VES-2026-021 — Antwerp → Singapore',
          predicted: 250000,
          actual: 195000,
          format: 'currency',
          unit: '$',
      ...
      scenarios: [
        {
          ...
          costOfWaiting: {
            perDay: 8500,
            description: 'Daily demurrage + opportunity cost vs next available fixture',
          },
          recommendation:
            'Optimal under current freight rates. Proceed if sanctions clearance confirmed within 48h.',
          recommendationStrength: 'strong',
        },
        {
          id: 'cape-route',
          ...
          recommendation:
            'Valid if Suez risk is assessed as high. Bunker cost is the primary sensitivity driver.',
          recommendationStrength: 'moderate',
        },
        {
          id: 'wait-for-market',
          ...
          recommendation:
            'High variance. Only viable if BDI is trending up. Requires 7-day hold cost coverage.',
  ...
  return {
    ...
    description:
      'APT-class threat — IR-2026-044 · Simulation based on 10,000 Monte Carlo iterations',
    ...
    predictedVsActual: [
      {
        label: 'IR-2026-038 — Ransomware containment',
        predicted: 6,
        actual: 5,
        format: 'days',
        unit: 'days',
      ...
      {
        label: 'IR-2026-021 — Supply chain compromise',
        predicted: 12,
        actual: 18,
        format: 'days',
        unit: 'days',
    ...
    scenarios: [
      {
        ...
        costOfWaiting: {
          perDay: 38000,
          perWeek: 210000,
          description: 'Each day of delay increases blast radius and recovery cost',
        },
        recommendation:
          'Initiate containment protocol immediately. Isolate affected segments before threat actor achieves persistence.',
        recommendationStrength: 'strong',
      },
      {
        id: 'monitor-assess',
        ...
        sensitivityDrivers: [
          {
            id: 'threat_actor_speed',
            label: 'Threat Actor Speed',
            impact: 0.65,
            direction: 'negative',
          },
          {
            id: 'intelligence_gain',
            label: 'Intelligence Gained',
            impact: -0.18,
            direction: 'positive',
          },
        ],
        costOfWaiting: {
          perDay: 52000,
          description: 'Higher daily cost vs rapid contain due to ongoing exposure window',
        },
        recommendation:
          'Only viable if threat actor is early-stage and intelligence value outweighs exposure risk.',
        recommendationStrength: 'weak',
      },
      {
        id: 'baseline',
        ...
        recommendation:
          'Not recommended. Without action, threat actor likely achieves full persistence.',
        recommendationStrength: 'strong',
      },
    ],
  };
