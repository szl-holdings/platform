...
interface SeedMatter {
  ...
  auditTrail: SeedAudit[];
  proofChain: SeedProof[];
}
...
const SEED_MATTERS: SeedMatter[] = [
  {
    ...
    wall: {
      enabled: true,
      reason:
        'Client-requested confidentiality wall — Meridian board members may have conflicting interests',
    ...
    obligations: [
      {
        ...
        description: 'Submit Hart-Scott-Rodino notification to FTC and DOJ',
        dueDate: d(3),
        status: 'in-progress',
        assignee: 'M. Farooq',
        dependencies: [],
      ...
      },
      {
        ...
        description: 'Meridian board meeting and shareholder vote approval documentation',
        dueDate: d(5),
        status: 'complete',
        assignee: 'R. Chen',
        dependencies: ['o1'],
      ...
      },
      {
        id: 'o3',
        matterId: 'M-2024-001',
        title: 'Merger Agreement Execution',
        description: 'Final execution of definitive merger agreement',
        dueDate: d(8),
        status: 'pending',
        assignee: 'M. Farooq',
        dependencies: ['o1', 'o2'],
      ...
      },
      {
        id: 'o4',
        matterId: 'M-2024-001',
        title: 'Employee Notification (WARN Act)',
        description: '60-day advance notice to affected employees if required',
        dueDate: d(12),
        status: 'pending',
        assignee: 'J. Whitmore',
        dependencies: ['o3'],
        privilegeLevel: 'confidential',
        filingRequired: false,
        consequence: 'WARN Act violation: $500/employee/day + benefits',
      },
    ],
    auditTrail: [
      {
        ...
        user: 'm.farooq',
        role: 'Partner',
        action: 'accessed-wall',
        detail: 'Created matter wall: Meridian board conflict screen',
        ip: '10.1.2.3',
      },
      {
        id: 'a2',
        ...
        role: 'Associate',
        action: 'edited',
        detail: 'Updated HSR filing timeline',
        ip: '10.1.2.4',
      },
      {
        id: 'a3',
        ...
        role: 'Partner',
        action: 'viewed',
        detail: 'Reviewed merger agreement draft v4',
        ip: '10.1.2.3',
      },
      {
        id: 'a4',
        ...
        detail: 'Closing date extended by 5 days per FTC request',
        ip: '10.1.2.5',
      },
    ],
    proofChain: [
      {
        ...
        summary:
          'Engagement letter signed between Apex Capital and firm. Scope: M&A advisory, regulatory, employment.',
        privilegeLevel: 'confidential',
        author: 'M. Farooq',
        parties: ['Apex Capital Partners LP'],
        hash: 'sha256:a3f1e2b4c5d6...',
      },
      {
        id: 'pc2',
        matterId: 'M-2024-001',
        timestamp: t(-30),
        eventType: 'discovery',
        title: 'Due Diligence Data Room Access',
        summary: 'Access granted to Meridian VDR. 14,200 documents reviewed.',
        privilegeLevel: 'restricted',
        author: 'R. Chen',
        parties: ['Meridian Software Group'],
        hash: 'sha256:b8f2c3a1d4e5...',
      },
      {
        id: 'pc3',
        matterId: 'M-2024-001',
        timestamp: t(-10),
        eventType: 'filing',
        title: 'HSR Pre-Notification Filing Draft',
        summary: 'Draft HSR notification prepared. Awaiting financial data from Goldman Sachs.',
        privilegeLevel: 'confidential',
        author: 'M. Farooq',
        parties: ['FTC', 'DOJ'],
        hash: 'sha256:c9d4e5f6a1b2...',
      },
    ],
  },
  {
    ...
    parties: [
      ...
      {
        id: 'p2',
        name: 'Prometheus AI Inc.',
        role: 'opposing-counsel',
        counsel: 'Quinn Emanuel Urquhart',
      },
    ...
    obligations: [
      {
        ...
        description:
          'Disclose expert witnesses and provide CV/report summaries to opposing counsel',
        dueDate: d(7),
        status: 'at-risk',
        assignee: 'S. Okafor',
        dependencies: [],
        privilegeLevel: 'privileged',
        filingRequired: true,
        courtId: '5:24-cv-03817-MC',
        consequence: 'Preclusion of expert testimony at trial',
      },
      {
        id: 'o2',
        matterId: 'M-2024-002',
        title: 'Expert Report — Technical Infringement',
        description: 'Dr. Voss final technical infringement opinion report',
        dueDate: d(14),
        status: 'in-progress',
        assignee: 'T. Park',
        dependencies: ['o1'],
      ...
      },
      {
        ...
        description: 'Joint pretrial conference with Judge Chen',
        dueDate: d(28),
        status: 'pending',
        assignee: 'S. Okafor',
        dependencies: ['o2'],
      ...
      },
      {
        id: 'o4',
        matterId: 'M-2024-002',
        title: 'Trial Brief Filing',
        description: 'File trial brief outlining legal theories, witness list, exhibit list',
        dueDate: d(35),
        status: 'pending',
        assignee: 'S. Okafor',
        dependencies: ['o3'],
    ...
    auditTrail: [
      {
        ...
        role: 'Partner',
        action: 'edited',
        detail: 'Matter opened. Complaint filed N.D. Cal.',
        ip: '10.1.3.1',
      },
      {
        id: 'a2',
        ...
        role: 'Associate',
        action: 'edited',
        detail: 'Claim construction brief filed',
        ip: '10.1.3.2',
      },
      {
        id: 'a3',
        ...
        role: 'Partner',
        action: 'deadline-updated',
        detail: 'Expert disclosure flagged at-risk — Dr. Voss report delayed',
        ip: '10.1.3.1',
      },
    ],
    proofChain: [
      {
        ...
        timestamp: t(-120),
        eventType: 'filing',
        title: 'Complaint Filed — N.D. Cal.',
        summary:
          'Patent infringement complaint filed. Patents-in-suit: US 11,234,567; US 11,345,678; US 11,456,789; US 11,567,890.',
        privilegeLevel: 'public',
        author: 'S. Okafor',
        parties: ['NeuralTech Corporation', 'Prometheus AI Inc.'],
        documentRef: 'ECF No. 1',
      ...
      },
      {
        ...
        timestamp: t(-90),
        eventType: 'order',
        title: 'Scheduling Order Issued',
        summary: 'Trial date set for 45 days out. Expert disclosure: 7 days. Pretrial: 28 days.',
        privilegeLevel: 'public',
        author: 'Hon. M. Chen',
        parties: ['NeuralTech Corporation', 'Prometheus AI Inc.'],
        documentRef: 'ECF No. 47',
      ...
      },
      {
        ...
        matterId: 'M-2024-002',
        timestamp: t(-14),
        eventType: 'expert-report',
        title: 'Dr. Voss Preliminary Infringement Opinion',
        summary:
          'Preliminary technical opinion: high probability of literal infringement on claims 1, 4, 7. Doctrine of equivalents analysis pending.',
        privilegeLevel: 'privileged',
        author: 'Dr. Alan Voss',
        parties: ['NeuralTech Corporation'],
  ...
  },
  {
    ...
    wall: {
      enabled: true,
      reason:
        'Firewall: Citadel trading desk vs. compliance function — privilege segregation required',
    ...
    parties: [
      {
        id: 'p1',
        name: 'Citadel Financial Holdings',
        role: 'client',
        counsel: 'P. Rodriguez, K. Morrison',
      },
    ...
    obligations: [
      {
        ...
        description:
          'Produce 45,000 documents in response to SEC subpoena. Privilege log required.',
        dueDate: d(2),
        status: 'at-risk',
        assignee: 'P. Rodriguez',
        dependencies: [],
        privilegeLevel: 'restricted',
        filingRequired: true,
        consequence: 'Contempt of subpoena — criminal exposure',
      },
      {
        id: 'o2',
        matterId: 'M-2024-003',
        title: 'Privilege Log Compilation',
        description: 'Prepare attorney-client privilege log for 3,200 withheld documents',
        dueDate: d(2),
        status: 'in-progress',
        assignee: 'K. Morrison',
        dependencies: [],
        privilegeLevel: 'restricted',
        filingRequired: true,
        consequence: 'Waiver of privilege if log not timely provided',
      },
      {
        id: 'o3',
        matterId: 'M-2024-003',
        title: 'Wells Submission',
        description: 'Respond to SEC Wells Notice with factual and legal defenses',
        dueDate: d(21),
        status: 'pending',
        assignee: 'P. Rodriguez',
        dependencies: ['o1', 'o2'],
      ...
      },
      {
        id: 'o4',
        matterId: 'M-2024-003',
        title: 'Board Audit Committee Briefing',
        description: 'Privileged briefing to Citadel board audit committee on exposure assessment',
        dueDate: d(14),
        status: 'pending',
        assignee: 'P. Rodriguez',
        dependencies: ['o2'],
    ...
    auditTrail: [
      {
        ...
        role: 'Partner',
        action: 'accessed-wall',
        detail: 'Firewall established per ethics counsel review',
        ip: '10.1.4.1',
      },
      {
        id: 'a2',
        ...
        role: 'Partner',
        action: 'edited',
        detail: 'Document hold notice issued to Citadel trading desk',
        ip: '10.1.4.2',
      },
      {
        id: 'a3',
        ...
        role: 'Partner',
        action: 'escalated',
        detail: 'Matter escalated: DOJ parallel investigation confirmed',
        ip: '10.1.4.3',
      },
      {
        id: 'a4',
        ...
        user: 'p.rodriguez',
        role: 'Partner',
        action: 'privilege-changed',
        detail:
          'Production set reclassified — 847 documents downgraded from restricted to confidential',
        ip: '10.1.4.1',
      },
    ],
    proofChain: [
      {
        ...
        timestamp: t(-90),
        eventType: 'communication',
        title: 'SEC Formal Order of Investigation',
        summary:
          'Formal Order received. Scope: dark pool order routing, best execution obligations, 2022-2024.',
        privilegeLevel: 'confidential',
        author: 'SEC Enforcement',
        parties: ['Citadel Financial Holdings'],
      ...
      },
      {
        ...
        timestamp: t(-60),
        eventType: 'discovery',
        title: 'Document Hold Notice Issued',
        summary: 'Legal hold notice issued to 340 Citadel employees. Trading systems preserved.',
        privilegeLevel: 'restricted',
        author: 'K. Morrison',
        parties: ['Citadel Financial Holdings'],
      ...
      },
      {
        ...
        timestamp: t(-15),
        eventType: 'communication',
        title: 'DOJ Parallel Investigation Confirmed',
        summary: '[REDACTED — Restricted]',
        privilegeLevel: 'restricted',
        author: 'P. Rodriguez',
        parties: ['DOJ Criminal Division'],
  ...
  },
  {
    ...
    parties: [
      ...
      {
        id: 'p2',
        name: 'Rosario et al. (Class Plaintiffs)',
        role: 'opposing-counsel',
        counsel: 'Outten & Golden LLP',
      },
    ...
    obligations: [
      {
        id: 'o1',
        matterId: 'M-2024-004',
        title: 'Class Certification Opposition Brief',
        description: "File opposition to plaintiffs' motion for class certification",
        dueDate: d(18),
        status: 'in-progress',
        assignee: 'L. Tanaka',
        dependencies: [],
        privilegeLevel: 'privileged',
        filingRequired: true,
        courtId: '2:24-cv-07234-RY',
      },
      {
        id: 'o2',
        matterId: 'M-2024-004',
        title: 'Expert Declaration (Compensation)',
        description: 'Dr. Goldman declaration opposing numerosity and commonality arguments',
        dueDate: d(15),
        status: 'at-risk',
        assignee: 'B. Osei',
        dependencies: [],
      ...
      },
      {
        id: 'o3',
        matterId: 'M-2024-004',
        title: 'Deposition: 30(b)(6) HR Witness',
        description: 'Defend corporate designee deposition on compensation practices',
        dueDate: d(30),
        status: 'pending',
        assignee: 'L. Tanaka',
        dependencies: ['o1'],
    ...
    auditTrail: [
      {
        ...
        role: 'Partner',
        action: 'edited',
        detail: 'Matter opened. Class action complaint filed.',
        ip: '10.1.5.1',
      },
      {
        id: 'a2',
        ...
        role: 'Associate',
        action: 'edited',
        detail: 'Internal pay equity audit report marked privileged',
        ip: '10.1.5.2',
      },
    ],
    proofChain: [
      {
        ...
        timestamp: t(-200),
        eventType: 'filing',
        title: 'Class Action Complaint Filed',
        summary:
          'Complaint alleges Title VII and EPA violations. Putative class: 2,400 female engineers. Damages: $45M+.',
        privilegeLevel: 'public',
        author: 'Outten & Golden LLP',
        parties: ['Rosario et al.', 'TechGiant Inc.'],
        documentRef: 'ECF No. 1',
      ...
      },
      {
        ...
        timestamp: t(-60),
        eventType: 'expert-report',
        title: 'Privileged Pay Equity Audit (Internal)',
        summary:
          'Pay equity regression analysis. Unexplained gender gap: 4.7% after controls. Scope: 2,400 employees, 2020-2023.',
        privilegeLevel: 'privileged',
        author: 'Dr. E. Goldman',
        parties: ['TechGiant Inc.'],
      ...
      },
      {
        ...
        timestamp: t(-15),
        eventType: 'hearing',
        title: 'Class Cert Motion Filed by Plaintiffs',
        summary: 'Plaintiffs moved for class certification. 28-day opposition window opened.',
        privilegeLevel: 'public',
        author: 'Outten & Golden LLP',
        parties: ['Rosario et al.'],
        documentRef: 'ECF No. 89',
    ...
    obligations: [
      {
        id: 'o1',
        matterId: 'M-2024-005',
        title: 'Arbitration Demand Filing',
        description: 'File AAA commercial arbitration demand with statement of claim',
        dueDate: d(25),
        status: 'pending',
        assignee: 'A. Patel',
        dependencies: [],
        privilegeLevel: 'confidential',
        filingRequired: true,
        consequence: 'Statute of limitations may bar claims after 90 days',
      },
      {
        id: 'o2',
        matterId: 'M-2024-005',
        title: 'Arbitrator Selection (3-Panel)',
        description: 'Submit ranked arbitrator preferences to AAA for 3-person panel',
        dueDate: d(35),
        status: 'pending',
        assignee: 'A. Patel',
        dependencies: ['o1'],
    ...
    auditTrail: [
      {
        ...
        role: 'Partner',
        action: 'edited',
        detail: 'Matter opened. Contract termination notice received.',
        ip: '10.1.6.1',
      },
    ],
    proofChain: [
      {
        ...
        timestamp: t(-45),
        eventType: 'communication',
        title: 'Termination Notice from Nordic Cold Chain',
        summary:
          'Nordic served 30-day termination notice citing Orion material breach — disputed. Contract value $18.5M.',
        privilegeLevel: 'confidential',
        author: 'Nordic Cold Chain AS',
        parties: ['Orion Logistics Group'],
      ...
      },
      {
        ...
        timestamp: t(-30),
        eventType: 'communication',
        title: 'Orion Dispute Letter',
        summary:
          'Orion disputes breach characterization. Demands reinstatement or damages. Invokes arbitration clause (AAA Commercial Rules).',
        privilegeLevel: 'confidential',
        author: 'A. Patel',
        parties: ['Nordic Cold Chain AS'],
  ...
  },
  {
    ...
    parties: [
      ...
      {
        id: 'p2',
        name: '300 West Partners LP (Landlord)',
        role: 'opposing-counsel',
        counsel: 'Fried Frank Harris',
      },
    ...
    obligations: [
      {
        ...
        description: 'Review title commitment and schedule of exceptions. Clear title objections.',
        dueDate: d(10),
        status: 'in-progress',
        assignee: 'D. Williams',
        dependencies: [],
      ...
      },
      {
        id: 'o2',
        matterId: 'M-2024-006',
        title: 'Lease Agreement Final Execution',
        description: 'Execution of 15-year commercial lease with all amendments',
        dueDate: d(25),
        status: 'pending',
        assignee: 'D. Williams',
        dependencies: ['o1'],
      ...
      },
      {
        id: 'o3',
        matterId: 'M-2024-006',
        title: 'TI Allowance Escrow Setup',
        description: 'Establish $45M tenant improvement escrow per lease terms',
        dueDate: d(30),
        status: 'pending',
        assignee: 'D. Williams',
        dependencies: ['o2'],
    ...
    auditTrail: [
      {
        ...
        role: 'Partner',
        action: 'edited',
        detail: 'Matter opened. LOI executed. Formal lease negotiation commenced.',
        ip: '10.1.7.1',
      },
      {
        id: 'a2',
        ...
        role: 'Partner',
        action: 'edited',
        detail: 'TI allowance increased to $45M following negotiation',
        ip: '10.1.7.1',
      },
    ],
    proofChain: [
      {
        ...
        summary:
          'LOI for 125,000 SF, 15-year term, $85/SF base rent, $45M TI allowance. Non-binding except exclusivity period.',
        privilegeLevel: 'confidential',
        author: 'D. Williams',
        parties: ['Harborview Development LLC', '300 West Partners LP'],
      ...
      },
      {
        ...
        summary:
          'Commitment from First Republic Title. Schedule B exceptions: 3 restrictive covenants, 1 utility easement under review.',
        privilegeLevel: 'confidential',
        author: 'First Republic Title Co.',
        parties: ['Harborview Development LLC'],
        hash: 'sha256:d0e1f2a3b4c5...',
      },
    ],
  },
];
