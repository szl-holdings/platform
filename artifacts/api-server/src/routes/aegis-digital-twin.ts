...
import { aegisDigitalTwinScenarioRunSchema, aegisDigitalTwinSyncSchema, aegisScenarioExportSchema, validateBody } from "../lib/validation";
  ...
  "supply-chain-compromise": {
    ...
    phases: [
      ...
      },
      {
        ...
        description: "Backdoor establishes encrypted C2 channel, masquerading as legitimate traffic.",
...
const VALID_SCENARIO_TYPES = ["tabletop", "incident_response", "threat_simulation", "red_team", "breach_rehearsal"];
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      if (
        body.classificationLevel &&
        !VALID_CLASSIFICATIONS.includes(body.classificationLevel)
      ) {
        sendBadRequest(
          res,
      ...
      const scenario: SecurityScenario = {
        ...
        threatActors: Array.isArray(body.threatActors) ? (body.threatActors as ThreatActor[]) : undefined,
        ...
        postureScoreBefore: typeof body.postureScoreBefore === "number" ? body.postureScoreBefore : undefined,
        postureScoreAfter: typeof body.postureScoreAfter === "number" ? body.postureScoreAfter : undefined,
        mttdEstimateMinutes: typeof body.mttdEstimateMinutes === "number" ? body.mttdEstimateMinutes : undefined,
        mttrEstimateMinutes: typeof body.mttrEstimateMinutes === "number" ? body.mttrEstimateMinutes : undefined,
        blastRadiusPct: typeof body.blastRadiusPct === "number" ? body.blastRadiusPct : undefined,
        classificationLevel: (body.classificationLevel as SecurityScenario["classificationLevel"]) ?? "unclassified",
