...
export function register(router: IRouter): void {
  ...
  router.use(lazyMatch("/terra", () => import("../terra-portfolio-intel"), "terra-portfolio-intel"));
  // Why This Property Now — public, demo-friendly, no auth required.
  router.use(lazyMatch("/terra", () => import("../terra-why-this-property"), "terra-why-this-property"));
