...
export function register(router: IRouter): void {
  ...
  router.use(lazyMatch("/analytics-engine", () => import("../analytics-engine"), "analytics-engine"));
  ...
  router.use(lazyMatch("/revenue-intelligence", () => import("../revenue-intelligence"), "revenue-intelligence"));
}
