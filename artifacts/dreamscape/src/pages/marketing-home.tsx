      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <m.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }} className="text-base sm:text-lg text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Nimbus combines predictive ML models, scenario planning, and decision intelligence to give leadership teams foresight — not hindsight.
          </m.p>
      ...
      <section id="intelligence" className="py-16 sm:py-24 border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-[14px] max-w-xl mx-auto">Nimbus continuously generates predictions, surfaces opportunities, and flags risks across your business data.</p>
          </div>
