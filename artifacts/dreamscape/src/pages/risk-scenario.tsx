    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs font-medium uppercase tracking-widest" style={{ color: "#8b5cf6" }}>Nimbus · Risk Scenario Planning</span>
        </div>
        <h1 className="text-2xl font-bold text-white">Risk Scenario Planning</h1>
        <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.4)" }}>Multi-variable risk models with mitigation strategies and Nimbus confidence scores.</p>
      </div>
