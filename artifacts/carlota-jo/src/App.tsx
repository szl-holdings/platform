...
const {
  ...
  ClientPortalOverview: lazy(() =>
    import('@/pages/ClientPortal').then((m) => ({ default: m.ClientPortalOverview })),
  ),
  ClientPortalDocuments: lazy(() =>
    import('@/pages/ClientPortal').then((m) => ({ default: m.ClientPortalDocuments })),
  ),
  ClientPortalUpdates: lazy(() =>
    import('@/pages/ClientPortal').then((m) => ({ default: m.ClientPortalUpdates })),
  ),
  ClientPortalMessages: lazy(() =>
    import('@/pages/ClientPortal').then((m) => ({ default: m.ClientPortalMessages })),
  ),
  ClientPortalSettings: lazy(() =>
    import('@/pages/ClientPortal').then((m) => ({ default: m.ClientPortalSettings })),
  ),
};
      ...
      >
        <div
          style={{
            ...
            height: 48,
            borderRadius: '50%',
            background: `${CARLOTA_ACCENT}20`,
            border: `1px solid ${CARLOTA_ACCENT}40`,
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
          }}
        ...
        <div>
          ...
          <p style={{ fontSize: 14, color: '#666', margin: 0, maxWidth: 340 }}>
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/client-portal/updates">
          {() => (
            <PortalAuthGuard>
              <ClientPortalUpdates />
            </PortalAuthGuard>
...
const carlotaCommands: CommandItem[] = [
  ...
  {
    id: 'nav-diagnostic',
    label: 'Strategic Diagnostic Engine',
    icon: '🧠',
    group: 'AI Platform',
  ...
  {
    id: 'nav-radar',
    label: 'Competitive Intelligence Radar',
    icon: '📡',
    group: 'AI Platform',
  ...
  {
    id: 'nav-simulator',
    label: 'Strategy Scenario Simulator',
    icon: '⚗️',
    group: 'AI Platform',
  ...
  {
    id: 'nav-knowledge',
    label: 'Knowledge Graph & IP Library',
    icon: '🕸️',
    group: 'AI Platform',
  ...
  {
    id: 'nav-revenue',
    label: 'Revenue Intelligence & Pipeline',
    icon: '💹',
    group: 'AI Platform',
  ...
  {
    id: 'nav-workshop',
    label: 'Workshop & Training Platform',
    icon: '🎓',
    group: 'AI Platform',
  ...
  {
    id: 'nav-experts',
    label: 'Expert Network & Team Assembly',
    icon: '👥',
    group: 'AI Platform',
  ...
  {
    id: 'nav-time',
    label: 'Time Tracking & Smart Billing',
    icon: '⏱️',
    group: 'AI Platform',
  ...
  {
    id: 'nav-vault',
    label: 'Knowledge Vault & Methodology Library',
    icon: '📚',
    group: 'AI Platform',
  ...
  {
    id: 'nav-deliverables',
    label: 'Deliverable Approval Workflow',
    icon: '✅',
    group: 'AI Platform',
  ...
  {
    id: 'nav-profitability',
    label: 'Engagement Profitability Analytics',
    icon: '💰',
    group: 'AI Platform',
  ...
  },
  {
    ...
    action: () => {
      window.location.href = '/admin/platform-settings';
    },
  },
  {
