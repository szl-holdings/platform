...
import { ArrowRight, Briefcase, Building, Compass, Home, Settings, Users } from 'lucide-react';
...
export default function Services() {
  ...
  return (
    <section
      ...
      style={{ background: 'var(--color-cream-warm)', borderColor: 'var(--color-stone-200)' }}
    >
          ...
          {servicesData.map((service, idx) => {
            ...
            return (
              <motion.div
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.background = 'var(--color-stone-100)';
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.background = 'var(--color-stone-50)';
                }}
              >
                <div
                ...
                <h3
                  ...
                  style={{ color: 'var(--color-ink-900)', fontWeight: 400 }}
                >
                  {service.title}
                </h3>
                <p
                ...
                <ul className="space-y-2 mb-6">
                  {service.capabilities.map((cap) => (
                    <li
                      key={cap}
                      className="text-xs flex items-start gap-2 font-light"
                ...
                <Link
                  ...
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.color = 'rgba(154,125,82,0.7)';
                  }}
                >
                  {t('services.inquire')}
                  <ArrowRight
