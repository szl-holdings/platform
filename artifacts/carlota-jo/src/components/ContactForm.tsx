...
export default function ContactForm() {
  ...
  const featuredTestimonial = (
    testimonialsData as Array<{ quote: string; name: string; title: string; company: string }>
  )[0];
      ...
      <section id="contact" className="py-24 lg:py-40 bg-taupe-50 border-t border-stone-200">
        <div className="max-w-2xl mx-auto px-6 lg:px-16 text-center">
          ...
          <p className="text-sm text-ink-500 leading-relaxed max-w-md mx-auto font-light">
            Thank you for your interest. A senior member of the advisory team will review your
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <p className="text-sm text-ink-600 font-light leading-relaxed mb-12 max-w-sm">
                Tell us about your household environment. All inquiries are handled with absolute
                discretion and responded to within 24 hours.
              </p>
            </motion.div>
            ...
            {featuredTestimonial && (
              ...
              >
                ...
                <div>
                  <p className="text-xs font-medium text-ink-900 tracking-wide">
            ...
            >
              {[
                ...
                <div key={item.label} className="bg-taupe-50 p-5">
                  <p className="font-serif text-2xl font-light text-warm-gold mb-1">
                    {item.metric}
                  </p>
                  <p className="text-[10px] tracking-wider uppercase text-stone-400 font-light">
                    {item.label}
                  </p>
                </div>
              ))}
