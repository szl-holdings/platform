...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{ background: '#1a1714', minHeight: 'min(92vh, 820px)' }}
    >
      <GoldDust />
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              'linear-gradient(to right, transparent, rgba(196,170,126,0.15), transparent)',
          }}
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 70% 60% at 75% 30%, rgba(196,170,126,0.04) 0%, transparent 70%)',
          }}
        />
        <div
          className="absolute bottom-0 inset-inline-0 h-32"
          style={{ background: 'linear-gradient(to top, #1a1714, transparent)' }}
        />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              <Link
                ...
                style={{
                  ...
                  border: '1px solid rgba(196,170,126,0.15)',
                }}
                onMouseEnter={(e) => {
          ...
          >
            <div
              className="border"
              style={{
                borderColor: 'rgba(196,170,126,0.1)',
            ...
            >
              <div
                ...
                style={{ background: 'rgba(196,170,126,0.08)' }}
              >
                {stats.map((stat) => (
                  <div
                    key={stat.label}
                  ...
                  >
                    <p
                      className="font-serif text-xl sm:text-2xl font-light mb-1"
                      style={{ color: '#f5f0e8' }}
                    >
                      {stat.value}
                    </p>
            ...
            <div className="mt-4 flex items-center justify-between px-1">
              <span
                ...
                style={{ color: 'rgba(196,170,126,0.25)' }}
              >
                {t('hero.location')}
              </span>
              <span className="text-[10px]" style={{ color: 'rgba(196,170,126,0.25)' }}>
                {t('hero.email')}
              </span>
            </div>
          </motion.div>
