      ...
      <div className="pt-24">
        ...
        >
          <div className="max-w-3xl mx-auto px-6 lg:px-12">
            ...
            >
              <p
                className="text-[14.5px] font-light leading-loose"
                style={{ color: 'var(--color-ink-600)' }}
              >
                Carlota Jo was founded for principals who need one trusted operator to manage the
                operational layer of their residential life — not an agency, not rotating staff, but
                someone who understands their standard and holds it consistently.
              </p>
              <p
                className="text-[14.5px] font-light leading-loose"
                style={{ color: 'var(--color-ink-600)' }}
              >
                A small practice by design. Every client receives Rosa's direct attention. This
                limits how many clients she can serve — and that is precisely the point.
              </p>
            </motion.div>
            ...
            >
              <h3
                className="font-serif text-[18px] font-light mb-3"
                style={{ color: 'var(--color-ink-900)' }}
              >
                Begin a conversation
              </h3>
              <p
                className="text-[13px] font-light mb-5 leading-relaxed"
                style={{ color: 'var(--color-ink-500)' }}
              >
                Rosa responds to enquiries from principals, family offices, and trusted referrals
