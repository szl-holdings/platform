...
const STAGES = [
  {
    ...
    description:
      'A confidential conversation to understand your household, properties, priorities, and the kind of support you are looking for. There is no obligation after this call — it is purely an opportunity for mutual understanding.',
    whatHappens: [
    ...
    whatYouReceive:
      "A written summary of the conversation and Rosa's initial thoughts on the scope of support that would be most relevant.",
  },
  {
    number: '02',
    ...
    description:
      'Before advising on anything, Rosa visits the property. She meets the household team, reviews vendor relationships and contracts, walks every system in the residence, and forms her own view of the operational situation — independent of what she has been told.',
    whatHappens: [
    ...
    whatYouReceive:
      "A written operational assessment covering the household's current state, the gaps she has identified, and her recommendations for the engagement scope.",
  },
  {
    number: '03',
    title: 'Service Plan',
    duration: '1–2 weeks',
    description:
      'Based on the assessment, Rosa prepares a tailored service plan that defines the exact scope of her involvement, the communication protocols, the reporting cadence, and the decision thresholds that will govern the engagement.',
    whatHappens: [
    ...
    whatYouReceive:
      'A signed service plan and engagement agreement, a confirmed onboarding schedule, and clarity on exactly what Rosa will own from day one.',
  },
  {
    number: '04',
    title: 'Onboarding',
    duration: '2–4 weeks',
    description:
      'Rosa assumes operational oversight of the engagement scope. She meets every vendor, confirms all service arrangements, documents the standards, and ensures that the household team understands the new protocols before active management begins.',
    whatHappens: [
    ...
    whatYouReceive:
      'A fully documented household, confirmed vendor relationships, and a smooth transition to active management without operational disruption.',
  },
  {
    number: '05',
    ...
    duration: 'Ongoing',
    description:
      'The steady state of the engagement. Rosa manages the operational layer of your residential life on an ongoing basis — proactively, quietly, and to the standard you have defined. Monthly summaries keep you informed. Quarterly reviews keep the engagement calibrated.',
    whatHappens: [
    ...
    whatYouReceive:
      'The experience of a flawlessly run household — without the management burden. Complete operational accountability from one trusted person.',
  },
];
        ...
        >
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              ...
              >
                Carlota Jo does not begin active management until Rosa understands your household
                thoroughly. The engagement process is designed to ensure that when she starts, she
                starts correctly — with full knowledge, confirmed relationships, and documented
                standards.
              </p>
              <p
              ...
              >
                Each stage has a defined purpose and a clear deliverable. You will never be left
                ...
                return (
                  <div key={stage.number} className="flex items-center">
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          border: isCurrent
                            ? 'none'
                            : isComplete
                              ? '1px solid rgba(154,125,82,0.25)'
                      ...
                      {isCurrent ? (
                        <span
                          className="text-[8px] tracking-[0.18em] uppercase font-medium text-center px-1.5 py-0.5"
                          style={{
                    ...
                    {i < STAGES.length - 1 && (
                      <div
                        ...
                        style={{
                          background:
                            i < CURRENT_STAGE ? 'rgba(154,125,82,0.25)' : 'var(--color-stone-300)',
                        }}
                      />
                    )}
                  </div>
                    ...
                    >
                      <div className="md:col-span-1">
                        {isComplete ? (
                          <CheckCircle2
                            size={20}
                            style={{ color: 'rgba(154,125,82,0.45)', marginTop: '0.25rem' }}
                          />
                        ) : (
                          <span
                            className="font-serif text-2xl font-light"
                            style={{
                              color: isCurrent ? 'var(--color-gold)' : 'var(--color-stone-300)',
                      ...
                      <div className="md:col-span-9">
                        <div className="flex flex-col gap-1">
                          <div className="flex items-center gap-3">
                            ...
                            {isCurrent && (
                              <span
                                className="text-[9px] font-medium tracking-[0.2em] uppercase px-2 py-0.5"
                                style={{
                                  color: 'var(--color-cream)',
                                  background: 'var(--color-gold)',
                                }}
                            ...
                            {isComplete && (
                              <span
                                ...
                                style={{ color: 'rgba(154,125,82,0.5)' }}
                              >
                                Complete
                              </span>
                            )}
              ...
              {[
                {
                  ...
                  sub: 'No obligation. No sales process.',
                },
                {
                  label: 'Typical start',
                  value: '4–6 weeks',
                  sub: 'From first conversation to active management.',
                },
                {
                  label: 'Commitment',
                  value: '3-month minimum',
                  sub: 'After which, rolling monthly engagement.',
                },
              ].map((item) => (
                <div key={item.label}>
                  <p
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p
                ...
                style={{ color: 'var(--color-ink-500)' }}
              >
                The discovery call is free, confidential, and carries no obligation. Rosa responds
                to substantive enquiries personally within two business days.
              </p>
