...
const QUALITIES = [
  {
    title: 'Warmth before structure',
    desc: 'Rosa builds genuine relationships with principals, household teams, and vendors alike — trust is the foundation of everything.',
  },
  {
    title: 'Operational precision',
    desc: 'Every process is documented, every task is owned, every gap is closed before it becomes a problem.',
  },
  {
    title: 'Discretion above all',
    desc: 'Confidentiality is not a service feature. It is the non-negotiable standard from which everything else follows.',
  },
  {
    title: 'Single point of contact',
    desc: 'One number. One person. Complete accountability — no handoffs, no delegation chains, no excuses.',
  },
  {
    title: 'Anticipatory by nature',
    desc: 'Rosa identifies what needs attention before you notice it. She resolves quietly, escalates precisely, and never creates noise.',
  },
];
...
const EXPERIENCE = [
  {
    ...
    detail:
      'Full lifecycle management across primary and secondary residences in the UK, Europe, and the United States. Rosa has opened, commissioned, and managed properties ranging from London townhouses to Mediterranean estates.',
  },
  {
    area: 'Household Systems',
    detail:
      'Design and implementation of operating systems for complex household environments: staff scheduling, service protocols, access management, and coverage planning that runs independently of any single person.',
  },
  {
    area: 'Vendor Management',
    detail:
      'Principal-facing vendor networks across 40+ service categories, from specialist contractors and private security to fine art handlers and discreet medical liaisons. Every relationship is managed to a consistent standard.',
  },
  {
    area: 'Estate Transitions',
    detail:
      'Complex property activations, cross-border relocations, and renovation oversight for families managing multiple simultaneous priorities. Rosa has coordinated international moves and full estate commissions under compressed timelines.',
  },
  {
    area: 'Lifestyle & Admin',
    detail:
      'Confidential administrative support for principals with demanding schedules — travel logistics, personal correspondence, family coordination, and liaison with private wealth advisors and family office teams.',
  },
];
      ...
      <div className="pt-24">
            ...
            >
              <div className="lg:col-span-7">
                <div className="flex items-start gap-5 mb-8">
                  ...
                  <div>
                    <p
                      className="text-[11px] font-medium tracking-[0.35em] uppercase mb-1"
                      style={{ color: 'var(--color-gold)' }}
                    >
                      Carlota Jo
                    </p>
                    <p className="text-[13px] font-light" style={{ color: 'var(--color-ink-500)' }}>
                      Private Practice · By Introduction Only
                    </p>
                  </div>
                </div>
                <h1
                ...
                >
                  Rosa founded Carlota Jo after a decade working in the operational core of UHNW
                  household environments — managing residences, coordinating vendors, building
                  systems, and earning the trust of principals who need one person they can rely on
                  absolutely.
                </p>
                <p
                ...
                >
                  The firm carries her grandmother's name — a deliberate choice that reflects Rosa's
                  approach to client relationships: warm, long-term, and deeply personal. Carlota Jo
                  is not a service company. It is a private practice, built around a small number of
                  client families who deserve an exceptional standard.
                </p>
                <p
                  className="text-sm font-light leading-relaxed mb-10"
                  style={{ color: 'var(--color-ink-500)' }}
                >
                  Rosa works with a deliberately limited number of principals. She takes on new
                  clients by introduction only, and only when she is confident she can deliver her
                  full attention. Every engagement begins with a genuine conversation about fit —
                  and if the fit isn't there, she will say so.
                </p>
                <Link
                  href="/contact"
        ...
        >
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              <p
                className="text-[11px] font-medium tracking-[0.35em] uppercase mb-10"
                style={{ color: 'var(--color-gold)' }}
              >
                Her philosophy
              </p>
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12 text-center">
            ...
            >
              <p
                ...
                style={{ color: 'var(--color-ink-800)', fontStyle: 'italic' }}
              >
                "The standard is not what's expected. It's what's deserved."
              </p>
              <p
                className="text-xs tracking-wide mb-8 mt-4"
                style={{ color: 'var(--color-stone-400)' }}
              >
                Carlota Jo accepts a limited number of new clients each year. All enquiries handled
