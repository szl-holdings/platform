...
const OS_MODULES = [
  {
    ...
    description:
      'Upload an RFP or describe prospect needs. AI generates complete proposals with scope, methodology, pricing, case studies, and team bios — optimised from win/loss data.',
  ...
  },
  {
    ...
    description:
      'Every engagement, deliverable, framework, and insight lives in a living knowledge graph. Query naturally: "What frameworks have we used for digital transformation in healthcare?"',
  ...
  },
  {
    ...
    description:
      'AI agents continuously monitor competitor activities, pricing changes, and public wins. Battlecards auto-update. Win/loss analysis identifies positioning gaps.',
  ...
  },
  {
    ...
    description:
      'Automated milestone tracking, deliverable versioning, AI-generated weekly status updates, burn-rate monitoring, and real-time scope-creep detection with auto-alerts.',
    href: '/engagements',
  ...
  },
  {
    ...
    description:
      'Real-time relationship health scoring across all clients. Sentiment analysis, satisfaction surveys, delivery metrics — with churn risk prediction and automated retention plays.',
    href: '/client-health',
  ...
  },
  {
    ...
    description:
      'Full pipeline management with AI close probability, optimal follow-up timing, and deal velocity. Revenue forecasting with scenario modelling and utilisation optimisation.',
  ...
  },
  {
    ...
    description:
      'AI transforms engagement insights into publishable content — blog posts, whitepapers, LinkedIn articles — while protecting client confidentiality. SEO-optimised with content calendar.',
  ...
  },
  {
    ...
    description:
      'Skills-based team matching for every engagement. Subcontractor network with availability, rates, and performance scoring. AI recommends optimal team composition.',
    href: '/expert-network',
  ...
  },
  {
    ...
    description:
      'Self-service client workspace with real-time project visibility, document sharing, approval workflows, and a communication hub. Clients always know exactly where things stand.',
    href: '/client-portal',
  ...
  },
  {
    ...
    description:
      'Granular time entry by engagement, phase, and deliverable. AI suggests entries from calendar activity. Automated invoice generation, rate card management, and billing milestone tracking.',
    href: '/time-tracking',
  ...
  },
  {
    ...
    description:
      'Visual team allocation heatmap showing utilisation rates, bench time, skill-gap analysis, and forward-looking capacity across all engagements. The #1 feature top consulting firms need.',
  ...
  },
  {
    ...
    description:
      'Every framework, playbook, template, and case study — searchable, version-controlled, and growing with every engagement. Governed engagement retrieval.',
  ...
  },
  {
    ...
    description:
      'Reference-quality industry benchmarks for consulting performance metrics auto-populated into client deliverables. 16 metrics across financial, delivery, talent, and client dimensions.',
  ...
  },
  {
    ...
    description:
      'Staged review pipeline with internal and client approval workflows, threaded comment resolution, full version history, and change tracking. Every deliverable, perfect every time.',
  ...
  },
  {
    ...
    description:
      'Real-time P&L per engagement with rate realization tracking, scope creep detection, write-off monitoring, and margin trend analysis. Know the true profitability of every client relationship.',
...
const RECENT_ACTIVITY = [
  {
    type: 'proposal',
    icon: FileText,
    text: 'Proposal generated for Luminary Brands expansion — 47 pages',
    time: '2 hours ago',
    color: '#B8960C',
  },
  {
    type: 'alert',
    icon: AlertCircle,
    text: 'Scope-creep alert: Oasis Wellness engagement at 94% budget utilisation',
    time: '4 hours ago',
    color: '#DC2626',
  },
  {
    type: 'intel',
    icon: Radar,
    text: 'Competitor update: McKinsey launched new pricing advisory service',
    time: '6 hours ago',
    color: '#7C3AED',
  },
  {
    type: 'content',
    icon: Lightbulb,
    text: 'Thought leadership draft ready: "The Future of Brand in AI Markets"',
    time: 'Yesterday',
    color: '#D97706',
  },
  {
    type: 'health',
    icon: Heart,
    text: 'Meridian Capital health score improved to 88 — relationship strengthening',
    time: 'Yesterday',
    color: '#E11D48',
  },
  {
    type: 'knowledge',
    icon: Network,
    text: '3 new frameworks indexed from Q1 Luminary Brands engagement',
    time: '2 days ago',
    color: '#059669',
  },
];
...
export default function ConsultingOS() {
  usePageMeta({
    ...
    description:
      'The AI-native operating system for boutique consulting — proposals, knowledge graphs, engagement delivery, and revenue intelligence in one platform.',
    ...
    <div style={{ minHeight: '100vh', background: '#FAFAF8', paddingTop: 64 }}>
      ...
      >
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          ...
          >
            ...
            >
              Ten governed intelligence modules that replace a team of ops specialists — so Carlota
              Jo can deliver Fortune 500 quality with boutique precision.
            </p>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          ...
          >
            {AI_INSIGHTS.map((insight, i) => {
              const insightEvidence = [
                {
                  id: `cjo-${i}-1`,
                  label: 'Alloy Pattern Engine — Engagement Similarity',
                  type: 'model' as const,
                  excerpt: insight.body,
                },
                {
                  id: `cjo-${i}-2`,
                  label: 'CRM Signal Aggregation',
                  type: 'api' as const,
                  excerpt:
                    'Client health, engagement momentum, and pipeline probability derived from live CRM data.',
                },
              ];
              return (
                <motion.div
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 13, color: '#6B5E47', lineHeight: 1.6, marginBottom: 12 }}
                    >
                      {insight.body}
                    </div>
                    ...
                    <a style={{ textDecoration: 'none', display: 'block' }}>
                      ...
                      >
                        <div
                          style={{
                            ...
                            background: isHovered
                              ? `linear-gradient(90deg, ${mod.color}, transparent)`
                              : 'transparent',
                            transition: 'all 0.2s',
                          }}
                        />
                        ...
                        <div style={{ marginBottom: 8 }}>
                          ...
                          <div style={{ fontSize: 12, color: mod.color, fontWeight: 500 }}>
                            {mod.subtitle}
                          </div>
                        </div>
                        ...
                        >
                          <span style={{ fontSize: 12, color: '#A89878' }}>
                            {liveModuleMetrics[mod.id] ?? mod.metric}
                          </span>
                          <ArrowUpRight
                            size={14}
                            color={mod.color}
                            style={{ opacity: isHovered ? 1 : 0.4, transition: 'opacity 0.2s' }}
                          />
                        </div>
                      </div>
                    </a>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    gap: 16,
                    padding: '16px 24px',
                    borderBottom: i < RECENT_ACTIVITY.length - 1 ? '1px solid #F0EBE0' : 'none',
                  }}
                >
                  <div
                    style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: 13, color: '#1A1A14', lineHeight: 1.5 }}>
                      {item.text}
                    </div>
        ...
        <div style={{ paddingBottom: 80 }}>
          <div
            style={{
              background: 'linear-gradient(135deg, #0F0F0D, #1A1A14)',
              borderRadius: 24,
              padding: '48px',
              display: 'grid',
          ...
          >
            <div>
              ...
              >
                The AI consulting market hits
                <br />
                <em style={{ color: GOLD }}>$91B by 2035</em>
              </h3>
              <p style={{ fontSize: 14, color: '#A89878', lineHeight: 1.7, marginBottom: 24 }}>
                89% of organisations expect AI in the consulting services they buy. 67% will leave
                firms that don't adopt AI. Carlota Jo is ahead of the curve — delivering
                institutional-quality intelligence through a boutique practice.
              </p>
              ...
              {[
                {
                  icon: Shield,
                  label: 'IP Protected',
                  desc: 'Client data never leaves your control',
                },
                ...
                { icon: Globe, label: 'Scalable', desc: 'Grow without headcount' },
                {
                  ...
                  desc: 'Every recommendation backed by data',
                },
              ].map((feat) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 13, fontWeight: 600, color: '#F5F0E8', marginBottom: 4 }}
                    >
                      {feat.label}
                    </div>
