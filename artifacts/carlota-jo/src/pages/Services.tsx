...
export default function ServicesPage() {
  const [services, setServices] = useState<ServiceItem[]>(
    servicesData.map((s) => normalizeService(s as unknown as Record<string, unknown>)),
  );
                ...
                return (
                  ...
                  >
                    <div className="md:col-span-5">
                      ...
                      {service.summary && (
                        <p
                          className="text-[12px] font-light leading-relaxed italic mb-4"
                          ...
                          <ul className="space-y-3 mb-6">
                            {(service.capabilities ?? []).map((cap) => (
                              <li key={cap} className="flex items-start gap-3">
                                <span style={{ color: 'var(--color-gold)', marginTop: '0.1rem' }}>
                                  —
                                </span>
                                <span
