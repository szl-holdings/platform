...
import { Activity, ArrowRight, FileText, Layers, Lock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <div className="lg:col-span-4">
            ...
            <p
              className="text-sm font-light leading-relaxed mb-1"
...
function TrustPillars() {
  ...
  const pillars = [
    ...
    {
      name: t('trust.pillars.professionalism.name'),
      desc: t('trust.pillars.professionalism.desc'),
    },
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2
            className="font-serif text-3xl lg:text-4xl font-light leading-tight"
            style={{ color: 'var(--color-ink-900)' }}
          >
            {t('trust.headline')}
            <br />
...
function ProcessStrip() {
  ...
  const processSteps = [
    {
      step: t('process.steps.discovery.step'),
      label: t('process.steps.discovery.label'),
      desc: t('process.steps.discovery.desc'),
    },
    {
      step: t('process.steps.assessment.step'),
      label: t('process.steps.assessment.label'),
      desc: t('process.steps.assessment.desc'),
    },
    {
      step: t('process.steps.plan.step'),
      label: t('process.steps.plan.label'),
      desc: t('process.steps.plan.desc'),
    },
    {
      step: t('process.steps.onboarding.step'),
      label: t('process.steps.onboarding.label'),
      desc: t('process.steps.onboarding.desc'),
    },
    {
      step: t('process.steps.management.step'),
      label: t('process.steps.management.label'),
      desc: t('process.steps.management.desc'),
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <div>
            ...
            <h2
              className="font-serif text-3xl lg:text-4xl font-light"
              style={{ color: 'var(--color-ink-900)' }}
            >
              {t('process.headline')}
              <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          {processSteps.map((step, idx) => (
            ...
            >
              ...
              <h3
                className="font-serif text-base font-light mb-3"
                style={{ color: 'var(--color-ink-900)' }}
              >
                {step.label}
              </h3>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="max-w-3xl">
          ...
          >
            ...
            <p
              className="text-[14px] font-light leading-relaxed mb-8 max-w-xl"
              style={{ color: 'var(--color-ink-500)' }}
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {contactDetails.map((item) => (
                  <div key={item.label}>
                    ...
                    <p className="text-[13px] font-light" style={{ color: 'var(--color-ink-600)' }}>
                      {item.value}
                    </p>
                  </div>
                ))}
...
function ServiceLanes() {
  const lanes = [
    {
      ...
      signals: [
        ...
        'Positioning thesis development',
      ],
    },
    {
      num: '02',
  ...
  return (
    <section
      className="py-20 lg:py-28"
      style={{ borderTop: '1px solid var(--color-stone-200)', background: 'var(--color-stone-50)' }}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <motion.div
          initial={{ opacity: 0, y: 12 }}
        ...
        >
          {lanes.map((lane, i) => (
            ...
            >
              <span
                className="text-[9px] tracking-[0.28em] uppercase font-medium block mb-5"
                style={{ color: 'var(--color-gold)' }}
              >
                {lane.num}
              </span>
              <h3
                className="font-serif text-xl font-light mb-4"
                style={{ color: 'var(--color-ink-900)' }}
              >
                {lane.name}
              </h3>
              <p
                className="text-[13px] font-light leading-relaxed mb-6"
                style={{ color: 'var(--color-ink-500)' }}
              >
                {lane.desc}
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            <p
              ...
              style={{ color: 'var(--color-ink-500)' }}
            >
              Rosa does not operate on instinct alone. Every engagement is structured, documented,
              and traceable. You should be able to understand exactly why a recommendation was made
            ...
            <p
              ...
              style={{ color: 'var(--color-ink-400)' }}
            >
              This means briefings that arrive with context. Recommendations that show their logic.
              And a relationship that builds compounding knowledge of your environment over time.
            </p>
          </motion.div>
            ...
            >
              ...
              >
                ...
                <span className="text-[11px] font-light" style={{ color: 'var(--color-ink-400)' }}>
                  Part of the{' '}
                  <span style={{ color: 'var(--color-gold)', fontWeight: 500 }}>SZL Holdings</span>{' '}
                  ecosystem — an advisory practice with a technology spine
                </span>
              </div>
            </div>
          </div>
...
function PrivatePortalTeaser() {
  return (
    <section
      ...
      style={{ background: '#1a1714', borderTop: '1px solid rgba(200,169,106,0.08)' }}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              ...
              >
                Client Portal — Private Access
              </span>
            </div>
            <h2
              className="font-serif text-3xl lg:text-4xl font-light leading-tight mb-5"
              style={{ color: '#f5f0e8' }}
            >
              Your engagement,
              <br />
            ...
            >
              Active clients access a private portal with their full engagement record — every
              briefing, recommendation, decision log, and action item in one place.
            </p>
            <p
              className="text-[13px] font-light leading-relaxed"
              style={{ color: 'rgba(245,240,232,0.3)' }}
            >
              Portal access is provisioned on engagement. No self-serve signups. Contact us to
              begin.
            </p>
          </motion.div>
            ...
            >
              {[
                ...
                <div
                  ...
                  style={{ borderTop: i > 0 ? '1px solid rgba(200,169,106,0.06)' : 'none' }}
                >
                  <div
                    className="w-1 h-1 rounded-full shrink-0"
                    style={{ background: 'var(--color-gold)', opacity: 0.35 }}
                  />
                  <span
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="max-w-xl">
          ...
          <h2
            ...
            style={{ color: 'var(--color-ink-900)', lineHeight: 1.35 }}
          >
          ...
          <p
            ...
            style={{ color: 'var(--color-ink-600)' }}
          >
            Essays on governed decision infrastructure, AI strategy, and operational design — from
            the founding team at SZL Holdings.
          </p>
          {status === 'success' ? (
