...
const PHASES = [
  {
    ...
    duration: 'Week 1–2',
    description:
      "A structured intake process that maps your principal's life architecture — residences, staff, recurring obligations, vendors, preferences, and the friction points that cost time and attention.",
  ...
  },
  {
    ...
    duration: 'Week 2–3',
    description:
      "The operating design for your principal's life. Vendor relationships, communication protocols, approval flows, and emergency escalation procedures — documented to the level of operational precision.",
  ...
  },
  {
    ...
    duration: 'Ongoing',
    description:
      "The continuous management layer. Every request handled with the same standard of care. Every vendor coordinated. Every deadline tracked. The principal's attention protected from operational complexity.",
  ...
  },
  {
    ...
    duration: 'Quarterly',
    description:
      'Lives change. Residences are acquired or sold. Families grow. Priorities shift. The engagement calibrates continuously — the operating infrastructure evolves in step with the principal.',
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--color-cream-warm)' }}>
      ...
      <div className="pt-24">
        ...
        >
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              ...
              >
                The Carlota Jo engagement model is built on a foundational premise: a principal's
                life operates at a level of complexity that requires structured operational
                management, not just an attentive assistant.
              </p>
              <p
                className="text-sm font-light leading-relaxed"
                style={{ color: 'var(--color-ink-500)' }}
              >
                What follows is not a description of service categories. It is the actual operating
                methodology applied in every engagement — from the initial discovery through years
        ...
        >
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <h2
                className="font-serif text-2xl lg:text-3xl font-light"
                  ...
                  <div className="lg:col-span-3">
                    <ul className="space-y-2">
                      {phase.details.map((d) => (
                        <li
                          key={d}
                          className="flex items-start gap-2 text-[11px] font-light leading-relaxed"
                          style={{ color: 'var(--color-ink-500)' }}
                        >
                          <Check
                            size={10}
        ...
        <section
          className="py-16 lg:py-24"
          style={{ borderTop: '1px solid var(--color-stone-200)', background: '#1a1714' }}
        >
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            <motion.div
              initial={{ opacity: 0, y: 14 }}
            ...
            >
              <p
                ...
                style={{ color: 'rgba(196,170,126,0.7)' }}
              >
                Begin
              </p>
              <h2
                className="font-serif text-2xl lg:text-3xl font-light mb-6"
                style={{ color: '#f5f0e8' }}
              >
                Engagements are limited.
                <br />
                <span style={{ fontStyle: 'italic', color: 'rgba(196,170,126,0.85)' }}>
              ...
              >
                We accept a small number of new principals each year. The initial consultation is
                private, obligation-free, and designed to assess whether the engagement would be
                mutually well-suited.
              </p>
              <Link
                href="/contact"
                ...
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.background = 'rgba(196,170,126,0.9)';
                }}
              >
