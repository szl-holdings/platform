    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 13, fontWeight: 500, color: INK, marginBottom: 3 }}>
            {log.subject}
          </div>
        ...
        {expanded && (
          ...
          >
            <div style={{ padding: '0 20px 20px', borderTop: `1px solid ${BORDER}` }}>
              <div
                style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginTop: 16 }}
              >
                {/* Summary */}
                <div>
                  <div
                  ...
                  {log.redacted && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 11, color: RED }}>
                        Content redacted per standing client instruction. Access restricted.
                      </span>
                    </div>
                  )}
                  <div
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 14, color: MUTED, margin: '0 0 12px' }}>
            Every client touchpoint — privacy-first, access-scoped, with redaction and full audit
            trail.
          </p>
          ...
          >
            ...
            <span style={{ fontSize: 11, color: MUTED }}>
              All correspondence is Tier 4 — Restricted. Access is scoped per record. Redaction is
              irreversible. All reads are audit-logged.
            </span>
          </div>
        ...
        >
          <div style={{ display: 'flex', gap: 6 }}>
            {(
              ...
              ] as { key: typeof filterDirection; label: string }[]
            ).map((f) => (
              <button
                key={f.key}
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            {(
              ...
              ] as { key: typeof filterRedacted; label: string }[]
            ).map((f) => (
              <button
                key={f.key}
