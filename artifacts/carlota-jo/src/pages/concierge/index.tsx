...
import {
  Crown, AlertTriangle, Clock, ChevronRight, Star,
  Users, BookOpen, MessageSquare, TrendingUp, Bell,
  ArrowUpRight, Shield, CheckCircle2,
} from "lucide-react";
import {
  CLIENT_DOSSIERS, SERVICE_REQUESTS, COMMUNICATION_LOGS,
  getSLALabel, getTierBadgeColor, getRequestPriorityLabel,
  getStatusLabel, getCategoryLabel, DEMO_NOTE,
  type SLAStatus, type ClientTier,
...
const activeRequests = SERVICE_REQUESTS.filter(r => r.status !== "resolved" && r.status !== "deferred");
const vipExceptions = activeRequests.filter(r => r.priority === "vip-exception");
const atRisk = activeRequests.filter(r => r.slaStatus === "at-risk" || r.slaStatus === "breached");
  ...
  return (
    <div style={{ minHeight: "100vh", background: CREAM, fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <div style={{
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", paddingBottom: 28 }}>
            <div>
              <div style={{
                fontSize: 10,
            ...
            <div style={{ display: "flex", gap: 10, paddingTop: 4 }}>
              <Link href="/concierge/requests" style={{
                display: "flex",
                alignItems: "center",
                gap: 8,
                padding: "10px 20px",
            ...
            >
              ...
              >
                <div
                  ...
                  onMouseEnter={e => (e.currentTarget.style.boxShadow = "0 4px 20px rgba(154,125,82,0.1)")}
                ...
                >
                  ...
                  <div style={{ fontSize: 32, fontWeight: 600, color: INK, lineHeight: 1, marginBottom: 6 }}>
                    {card.value}
                  </div>
                  <div style={{ fontSize: 13, color: INK, fontWeight: 500, marginBottom: 3 }}>{card.label}</div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
              <div>
                ...
                <p style={{ fontSize: 12, color: MUTED, margin: 0 }}>Active requests across all households</p>
              </div>
              <Link href="/concierge/requests" style={{
                display: "flex",
                alignItems: "center",
                ...
                >
                  <Link href={`/concierge/requests`} style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        background: "#fff",
                        border: req.priority === "vip-exception"
                          ? `1px solid ${AMBER}50`
                          : `1px solid ${BORDER}`,
                        borderRadius: 12,
                        padding: "16px 18px",
                        ...
                        borderLeft: req.priority === "vip-exception"
                          ? `3px solid ${AMBER}`
                          : `3px solid ${BORDER}`,
                      }}
                      onMouseEnter={e => (e.currentTarget.style.boxShadow = "0 2px 12px rgba(154,125,82,0.09)")}
                      onMouseLeave={e => (e.currentTarget.style.boxShadow = "none")}
                    >
                      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: 14, color: INK, fontWeight: 500, marginBottom: 4 }}>{req.title}</div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8, flexShrink: 0 }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                            ...
                            <span style={{ fontSize: 11, color: slaColor(req.slaStatus), fontWeight: 500 }}>
                          ...
                          <span style={{ fontSize: 10, color: MUTED }}>{req.progressPct}% complete</span>
                        </div>
                      </div>
                    </div>
                  </Link>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            >
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                  ...
                  <Link href="/concierge/clients" style={{
                    fontSize: 11,
                    color: GOLD,
                    textDecoration: "none",
                    display: "flex",
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {CLIENT_DOSSIERS.map(client => (
                    <Link key={client.id} href="/concierge/clients" style={{ textDecoration: "none" }}>
                      <div style={{
                        display: "flex",
                        alignItems: "center",
                        ...
                        onMouseEnter={e => (e.currentTarget.style.background = "rgba(154,125,82,0.06)")}
                      ...
                      >
                        <div>
                          ...
                          <span style={{ fontSize: 13, color: INK, fontWeight: 500, verticalAlign: "middle" }}>
            ...
            >
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                  ...
                  <Link href="/concierge/communications" style={{
                    fontSize: 11,
                    color: GOLD,
                    textDecoration: "none",
                    display: "flex",
                  ...
                  {recentComms.map(comm => (
                    <div key={comm.id} style={{
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                        <span style={{ fontSize: 10, color: MUTED, textTransform: "uppercase", letterSpacing: "0.12em" }}>
                          {comm.direction === "inbound" ? "↓ Received" : "↑ Sent"}
                        </span>
                        {comm.redacted && (
                          <span style={{ fontSize: 9, background: "rgba(192,57,43,0.1)", color: RED, border: `1px solid ${RED}30`, padding: "1px 6px", borderRadius: 3, letterSpacing: "0.1em", textTransform: "uppercase" }}>
                            Redacted
                          </span>
                        )}
                      </div>
                      <div style={{ fontSize: 12, color: INK, fontWeight: 500, marginBottom: 2 }}>{comm.subject}</div>
            ...
            >
              <div style={{
                ...
                <div style={{ fontSize: 10, letterSpacing: "0.18em", textTransform: "uppercase", color: GOLD, fontWeight: 600, marginBottom: 14 }}>
                  Quick Access
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {[
                    { label: "Service Choreographies", href: "/concierge/playbooks", icon: <Star size={13} color={GOLD} /> },
                    { label: "Client Dossiers", href: "/concierge/clients", icon: <Users size={13} color={GOLD} /> },
                    { label: "Priority Routing", href: "/concierge/requests", icon: <TrendingUp size={13} color={GOLD} /> },
                    { label: "Discreet Correspondence", href: "/concierge/communications", icon: <Shield size={13} color={GOLD} /> },
                  ].map(action => (
                    <Link key={action.href} href={action.href} style={{
                      ...
                      onMouseEnter={e => (e.currentTarget.style.background = "rgba(154,125,82,0.08)")}
