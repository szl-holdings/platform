          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p className="text-base font-light leading-relaxed mb-3" style={{ color: "var(--color-ink-600)" }}>
                All enquiries are handled personally by Rosa. Every conversation is conducted under strict confidentiality — nothing is shared, nothing is logged beyond what is necessary to respond.
              </p>
              <p className="text-sm font-light leading-relaxed" style={{ color: "var(--color-ink-500)" }}>
                Rosa responds to substantive enquiries within two business days. If your situation is time-sensitive, please indicate so in your message.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            {!submitted ? (
              <>
                ...
                >
                  ...
                  <p className="text-sm font-light" style={{ color: "var(--color-ink-500)" }}>
                    Select the path that most closely matches — this helps Rosa prepare for the conversation.
                  </p>
                </motion.div>
                  ...
                  {CONVERSATION_PATHS.map((path, i) => (
                    <motion.button
                      ...
                      style={{
                        ...
                        background: selectedPath === path.id ? "rgba(154,125,82,0.04)" : "var(--color-cream-warm)",
                      }}
                    >
                      <div className="flex items-start gap-4">
                        <div
                          ...
                          style={{
                            borderColor: selectedPath === path.id ? "var(--color-gold)" : "var(--color-stone-300)",
                            background: selectedPath === path.id ? "var(--color-gold)" : "transparent",
                          }}
                        >
                        ...
                        <div>
                          <p className="text-[14px] font-medium mb-1" style={{ color: "var(--color-ink-900)" }}>
                            {path.title}
                          </p>
                          ...
                          {!path.form && path.note && selectedPath === path.id && (
                            <p className="text-[11px] mt-3 italic" style={{ color: "var(--color-gold)" }}>{path.note}</p>
                          )}
                        </div>
                      </div>
                    </motion.button>
                ...
                {activePath?.form && (
                  ...
                  >
                    <form onSubmit={handleSubmit} className="max-w-xl space-y-6">
                      <div>
                        <label className="block text-[11px] font-medium tracking-[0.2em] uppercase mb-2" style={{ color: "var(--color-stone-400)" }}>
                          Your name
                        </label>
                        <input
                          type="text"
              ...
              <motion.div
                ...
                className="max-w-xl"
              >
                <div className="p-10" style={{ border: "1px solid var(--color-stone-200)", background: "var(--color-stone-50)" }}>
                  <p className="text-[11px] font-medium tracking-[0.35em] uppercase mb-5" style={{ color: "var(--color-gold)" }}>
                    Enquiry received
                  </p>
                  ...
                  <p className="text-sm font-light leading-relaxed mb-4" style={{ color: "var(--color-ink-600)" }}>
                    Rosa has received your enquiry and will respond personally within two business days. Your message is handled with complete confidentiality.
                  </p>
                  <p className="text-xs font-light" style={{ color: "var(--color-stone-400)" }}>
                    If you have an urgent situation, please mention it in the subject line when Rosa replies.
                  </p>
                </div>
              </motion.div>
            )}
        ...
        <section className="py-12 lg:py-16" style={{ background: "var(--color-stone-50)" }}>
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <p className="text-[10px] font-medium tracking-[0.25em] uppercase mb-3" style={{ color: "var(--color-stone-400)" }}>Response time</p>
                <p className="text-sm font-light" style={{ color: "var(--color-ink-600)" }}>Within two business days for all substantive enquiries</p>
              </div>
              <div>
                <p className="text-[10px] font-medium tracking-[0.25em] uppercase mb-3" style={{ color: "var(--color-stone-400)" }}>Confidentiality</p>
                <p className="text-sm font-light" style={{ color: "var(--color-ink-600)" }}>All enquiries are handled personally by Rosa under strict confidentiality</p>
              </div>
              <div>
                <p className="text-[10px] font-medium tracking-[0.25em] uppercase mb-3" style={{ color: "var(--color-stone-400)" }}>Location</p>
                <p className="text-sm font-light" style={{ color: "var(--color-ink-600)" }}>London · New York · Available internationally by arrangement</p>
              </div>
            </div>
          </div>
        </section>
