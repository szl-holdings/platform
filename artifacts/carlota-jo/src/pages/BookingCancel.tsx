    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center pt-20">
        <div className="max-w-lg mx-auto px-6 text-center">
          ...
          <h1 className="font-serif text-3xl text-cream-50 mb-4">Payment Cancelled</h1>
          <p className="text-sm text-cream-300/50 mb-8 leading-relaxed">
            Your payment was not processed. If you experienced any difficulties or have questions
            about our engagement models, please don't hesitate to contact our team directly.
          </p>
