      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-[11px] mt-0.5" style={{ color: 'rgba(255,255,255,0.35)' }}>
            Ingest client and vendor signals, trigger governed service workflows, and approve
            high-value vendor commitments.
          </p>
        </div>
          ...
          <label
            ...
            style={
              isDryRun
                ...
                : { color: 'rgba(0,0,0,0.5)', borderColor: 'rgba(0,0,0,0.12)' }
            }
          >
            <input
              type="checkbox"
          ...
          <div className="flex-1">
            ...
            <div className="text-[11px] text-black mb-1">
              {pendingApproval.reason ??
                'This vendor commitment requires principal approval before the service workflow continues.'}
            </div>
            {pendingApproval.role && (
              <div className="text-[10px] mb-2" style={{ color: 'rgba(0,0,0,0.5)' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            >
              ...
              <span className="ml-auto text-[9px] font-mono" style={{ color: 'rgba(0,0,0,0.4)' }}>
            ...
            {showIngestForm ? (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <select
                    className="text-[10px] bg-white border rounded-lg px-2 py-1.5 text-black focus:outline-none"
                    style={{ borderColor: 'rgba(0,0,0,0.15)' }}
            ...
            <div className="divide-y divide-black/[0.06] max-h-80 overflow-y-auto">
              {loading && (
                <div className="p-4 text-center text-[11px]" style={{ color: 'rgba(0,0,0,0.4)' }}>
                  Loading…
                </div>
              )}
              ...
              {signals.map((sig) => {
                ...
                return (
                  <div
                    key={sig.id}
                    className="p-3 cursor-pointer hover:bg-black/3 transition-colors"
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[9px] mt-0.5" style={{ color: 'rgba(0,0,0,0.35)' }}>
        ...
        >
          ...
          <div className="divide-y divide-black/[0.06] max-h-[440px] overflow-y-auto">
            {runs.length === 0 && (
              <div className="p-6 text-center text-[11px]" style={{ color: 'rgba(0,0,0,0.4)' }}>
                No runs yet.
              </div>
            )}
            {runs.map((run) => (
              <div key={run.runId}>
                <div
                  className="p-3.5 cursor-pointer hover:bg-black/3 transition-colors"
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    >
                      {expandedRun === run.runId ? (
                        <ChevronUp className="w-3 h-3" style={{ color: 'rgba(0,0,0,0.3)' }} />
                      ) : (
                  ...
                  {run.startedAt && (
                    <div className="text-[9px] mt-0.5" style={{ color: 'rgba(0,0,0,0.3)' }}>
        ...
        <div className="flex flex-col gap-3">
                ...
                <div key={ev.id} className="p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-[9px] mt-0.5" style={{ color: 'rgba(0,0,0,0.55)' }}>
                        {ev.value}
                      </div>
                      <div className="text-[9px] mt-0.5" style={{ color: 'rgba(0,0,0,0.3)' }}>
                ...
                return (
                  <div key={oc.id} className="p-3">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <span className="text-[9px] font-mono" style={{ color: 'rgba(0,0,0,0.3)' }}>
          ...
          >
            ...
            <div className="text-[9px] leading-relaxed" style={{ color: 'rgba(0,0,0,0.5)' }}>
              Select service signals, then{' '}
              <strong className="text-black">Run Service Workflow</strong> to trigger the client
              triage, vendor sourcing, and delivery workflow. Vendor commitments ≥ $25K require
              principal approval.
            </div>
          </div>
        </div>
