        ...
        recommended: [
          {
            ...
            rationale:
              '10 years consumer goods brand repositioning with direct DTC expertise matching engagement needs.',
            days: 18,
          },
          {
            expertId: 'e4',
            role: 'Org & Culture Advisor',
            rationale:
              'Internal adoption and culture alignment is critical for brand repositioning — Kai brings proven methodology.',
            days: 8,
          },
          {
            expertId: 'e7',
            ...
            rationale:
              'Consumer insights and competitive data analysis to underpin strategic recommendations.',
            days: 12,
          },
        ],
        teamRationale:
          'This three-person team provides full coverage across strategy, implementation readiness, and analytical depth. James leads with commercial credibility, Kai ensures internal adoption, and Amara provides the quantitative foundation. Together they represent a £58K-£75K resourcing envelope, appropriate for this scope.',
    ...
    <div style={{ minHeight: '100vh', background: '#FAFAF8', paddingTop: 64 }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            >
              Right Team.
              <br />
              <em style={{ color: '#5EEAD4' }}>Every Engagement.</em>
            </h1>
            <p
              style={{
                fontSize: 15,
            ...
            >
              AI matches skills to engagement needs — instantly. Availability tracking, rate
              management, and performance scoring in one place.
            </p>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ padding: '40px 0 0', marginBottom: 32 }}>
          <div
            style={{
              background: 'linear-gradient(135deg, #0F0F1A, #1A1428)',
              borderRadius: 20,
              padding: 32,
            }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              ...
              <h2 style={{ fontSize: 14, fontWeight: 600, color: '#F5F0E8' }}>
              ...
              {assembly && (
                ...
                >
                      ...
                      {assembly.recommended.map((rec) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <span
                                style={{ fontSize: 14, fontWeight: 600, color: tierMeta.color }}
                              >
                                {expert.name
                                  .split(' ')
                                  .map((n) => n[0])
                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              >
                                <div>
                                  <span style={{ fontSize: 14, fontWeight: 600, color: '#F5F0E8' }}>
                                    {expert.name}
                                  </span>
                                  <span
                                    style={{ fontSize: 12, color: tierMeta.color, marginLeft: 8 }}
                                  >
                                    — {rec.role}
                                  </span>
                                </div>
                                <span style={{ fontSize: 12, color: '#A89878' }}>
                                  {rec.days} days · £{(rec.days * expert.dayRate).toLocaleString()}
                                </span>
                              </div>
                              <div style={{ fontSize: 12, color: '#9B8DB8', marginTop: 4 }}>
                                {rec.rationale}
                              </div>
                            </div>
                          </div>
                  ...
                  >
                    ...
                    >
                      <div
                        style={{ fontSize: 11, fontWeight: 600, color: '#A89878', marginBottom: 6 }}
                      >
                        TEAM RATIONALE
                      </div>
                      <div style={{ fontSize: 13, color: '#D4C5A0', lineHeight: 1.7 }}>
                    ...
                    >
                      <div style={{ fontSize: 11, color: '#A89878', marginBottom: 4 }}>
                        ESTIMATED COST
                      </div>
            ...
            {['all', 'available', 'limited'].map((v) => (
              <button
                ...
                style={{
                  ...
                  padding: '6px 12px',
                  borderRadius: 100,
                  border: `1px solid ${filterAvail === v ? '#0F766E' : '#E8E2D6'}`,
                  background: filterAvail === v ? '#0F766E12' : 'transparent',
                  color: filterAvail === v ? '#0F766E' : '#6B5E47',
                  cursor: 'pointer',
                  fontWeight: filterAvail === v ? 600 : 400,
            ...
            {['all', 'principal', 'senior', 'specialist', 'associate'].map((tier) => (
              <button
                ...
                style={{
                  ...
                  padding: '6px 12px',
                  borderRadius: 100,
                  border: `1px solid ${filterTier === tier ? GOLD : '#E8E2D6'}`,
                  background: filterTier === tier ? '#FFF8E8' : 'transparent',
                  color: filterTier === tier ? '#6B5E47' : '#A89878',
                  cursor: 'pointer',
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    >
                      <span style={{ fontSize: 16, fontWeight: 600, color: tierMeta.color }}>
                        {expert.name
                          .split(' ')
                          .map((n) => n[0])
                          .join('')}
                    ...
                    <div>
                      <div style={{ fontSize: 14, fontWeight: 600, color: '#1A1A14' }}>
                        {expert.name}
                      </div>
                      <div style={{ fontSize: 11, color: tierMeta.color, fontWeight: 500 }}>
                        {tierMeta.label}
                      </div>
                    </div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    ...
                    />
                    <span style={{ fontSize: 10, color: availMeta.color, fontWeight: 500 }}>
                      {availMeta.label}
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    <Briefcase size={11} /> {expert.engagements} engagements
                  </span>
                  <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    <Star size={11} color="#D97706" fill="#D97706" /> {expert.rating}
                  </span>
                </div>
                ...
                >
                  <span style={{ fontSize: 13, fontWeight: 600, color: '#1A1A14' }}>
                    £{expert.dayRate.toLocaleString()}/day
                  </span>
                  ...
                  <>
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                        ...
                        >
                          <span style={{ fontSize: 20, fontWeight: 600, color: tierMeta.color }}>
                            {expert.name
                              .split(' ')
                              .map((n) => n[0])
                              .join('')}
                        ...
                        <div>
                          <div style={{ fontSize: 20, fontWeight: 600, color: '#1A1A14' }}>
                            {expert.name}
                          </div>
                          <div style={{ fontSize: 13, color: '#6B5E47' }}>{expert.title}</div>
                          <span style={{ fontSize: 11, color: tierMeta.color, fontWeight: 600 }}>
                            {tierMeta.label}
                          </span>
                        </div>
                      </div>
                    ...
                    >
                      {[
                        ...
                        <div
                          key={stat.label}
                          style={{ background: '#FAFAF8', borderRadius: 8, padding: '10px 12px' }}
                        >
                          <div
                            style={{
                              fontSize: 16,
                    ...
                    <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 20 }}>
                      <div>
                        ...
                        <div style={{ fontSize: 13, color: '#1A1A14' }}>
                    ...
                    <button
                      style={{
                        width: '100%',
                        padding: '13px 0',
                        background: expert.availability === 'booked' ? '#F5F0E8' : '#0F766E',
                        border: 'none',
                        borderRadius: 12,
                        color: expert.availability === 'booked' ? '#A89878' : '#fff',
                        fontSize: 14,
                        fontWeight: 600,
                        cursor: expert.availability === 'booked' ? 'not-allowed' : 'pointer',
                      }}
                    >
                      {expert.availability === 'booked'
                        ? 'Currently Unavailable'
                        : expert.availability === 'on-engagement'
