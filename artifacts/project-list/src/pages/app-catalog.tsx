...
const apps = [
  ...
  },
  {
    ...
    postureScore: 90,
    postureLabel: "Business Health Score",
    topSignal: "KPI drift detected — 3 metrics outside expected range",
    velocityUp: true,
  ...
  },
  {
    ...
    icon: Activity,
    color: "text-red-400 bg-red-400/10",
    description: "Evidence-backed incident command delivering threat detection, anomaly visibility, and MSP-grade operational intelligence with FedRAMP readiness",
    features: ["Incident Command", "Threat Detection", "NOC Health", "SLA Tracking"],
    postureScore: 86,
  ...
  },
  {
    ...
    description: "Enterprise control plane for risk register management, compliance scoring, and governance automation across NIST CSF, FedRAMP, and CMMC",
    features: ["Risk Register", "Compliance Score", "Drift Forecast", "Gap Closure"],
    postureScore: 79,
    postureLabel: "Compliance Posture Score",
