...
const apps = [
  ...
  },
  {
    ...
    accent: "#6366f1",
    path: "/alloy/",
    description: "Execution fabric and predictive intelligence engine powering Lyte, Vessels, and every SZL platform. Agent coordination, scenario modeling, confidence scoring, streaming chat, and Model Arena.",
    features: ["10 Domain Agents", "Scenario Modeling", "Confidence Scoring", "Model Arena"],
  },
  {
    id: "msp",
    name: "Rosie",
