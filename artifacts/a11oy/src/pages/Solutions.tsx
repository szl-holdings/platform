...
import {
  generateVerticalPDF,
  generatePlatformBriefPDF,
  VERTICAL_SPECS,
  type VerticalSpec,
} from '../lib/vertical-marketing-pdf';
...
function DownloadButton({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLButtonElement).style.background = toAlpha([201, 183, 135], 0.18);
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLButtonElement).style.background = toAlpha([201, 183, 135], 0.1);
      }}
    >
    ...
    >
      <div
        style={{
          ...
          borderRadius: 6,
          background: toAlpha([201, 183, 135], 0.06),
          border: `1px solid ${T.border}`,
          fontSize: '0.625rem',
          fontFamily: T.mono,
          fontWeight: 700,
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.875rem', color: T.textDim, margin: 0, lineHeight: 1.5 }}>
              {spec.tagline}
            </p>
          </div>
        </div>
          ...
          {tab === 'architecture' && (
            ...
            >
              ...
              >
                ...
                >
                  Signal Mesh → Causal Core → Action Rail → Covenant Layer → Workcell → Proof Ledger
                  → Outcome Graph
                </div>
              </div>
            </motion.div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
          {[
            ...
            <a
              ...
              style={{
                fontSize: '0.8125rem',
                color: link.label === 'Solutions' ? T.accent : T.textDim,
                textDecoration: 'none',
      ...
      <div style={{ paddingTop: 60 }}>
        ...
        >
          <div aria-hidden="true" style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
            ...
            >
              <defs>
                ...
                <mask id="sol-mask">
                  <rect width="100%" height="100%" fill="url(#sol-fade)" />
                </mask>
              </defs>
          ...
          <div style={{ maxWidth: 1320, margin: '0 auto', position: 'relative' }}>
            ...
            >
              ...
              >
                SZL Holdings · Platform Solutions
              </span>
            </motion.div>
            ...
            >
              Seven verticals. <span style={{ color: T.accent }}>One governed</span> execution
              fabric.
            </motion.h1>
            ...
            >
              SZL Holdings builds a governed portfolio of enterprise intelligence platforms. Each
              vertical commands its domain. All seven share the A11oy execution fabric — compounding
              intelligence, proof, and governance across the entire ecosystem.
            </motion.p>
          ...
          <div style={{ maxWidth: 1320, margin: '0 auto' }}>
            <FadeIn style={{ marginBottom: '2.5rem' }}>
              ...
              <p style={{ fontSize: '0.875rem', color: T.textDim, margin: 0 }}>
                Click any vertical to expand its philosophy, architecture, and capabilities — with a
                downloadable marketing brief.
              </p>
            </FadeIn>
        ...
        >
          <div style={{ maxWidth: 1320, margin: '0 auto' }}>
            <FadeIn style={{ marginBottom: '3rem' }}>
              ...
              >
                Beyond aggregation. Into governance.
              </h2>
              <p
                style={{
                  fontSize: '0.9375rem',
              ...
              >
                Competitors aggregate tools and call it a platform. A11oy builds a governed
                execution fabric with structural proof at every layer — the difference is
                architectural integrity, not feature count.
              </p>
            </FadeIn>
              ...
              {[
                ...
                <FadeIn key={item.num} delay={i * 0.07}>
                  ...
                  >
                    ...
                    <p
                      style={{ fontSize: '0.875rem', lineHeight: 1.7, color: T.textDim, margin: 0 }}
                    >
                      {item.desc}
                    </p>
                  </div>
            ...
            <FadeIn>
              ...
              >
                <div>
                  ...
                  >
                    All seven verticals. One ecosystem brief.
                  </h2>
                  ...
                  return (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
                        ...
                        <div>
                          <div style={{ fontSize: '0.875rem', fontWeight: 600, color: T.text }}>
                            {spec.name}
                          </div>
                          <div
                            style={{
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <span style={{ fontSize: '0.875rem', fontWeight: 600, color: T.textDim }}>
              a11oy · SZL Holdings
            </span>
          </div>
