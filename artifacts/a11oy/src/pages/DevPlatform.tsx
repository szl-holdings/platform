...
const SDK_PRIMITIVES = [
  ...
  { name: 'ComplianceCompass', desc: 'Real-time compliance posture across EU AI Act, NIST AI RMF, ISO 42001, and CSA Agentic Profile. Heat map visualization, drill-down to individual controls, one-click audit package export signed via Proof Ledger.', status: 'stable', lang: 'py + ts' },
  { name: 'AgentBOM', desc: 'Per-agent AI Bill of Materials — CycloneDX ML-BOM v1.7 JSON export. Model fingerprints, tool manifest hashes, constitution version, prompt hashes, eval history, dependency graph, welfare posture. Continuously updated.', status: 'stable', lang: 'py + ts' },
  { name: 'DelegationChainGov', desc: 'Multi-agent delegation governance — correlation IDs, scope narrowing at each hop, privilege boundary enforcement, full chain replay. Addresses the NIST gap: no concept of delegation boundary.', status: 'stable', lang: 'py + ts' },
  { name: 'TrustExchange', desc: 'Federated compliance attestation exchange across organizational boundaries. Posture brackets (exceptional/strong/moderate/developing) without exposing proprietary internals. Extends A2A v1.0 Agent Card.', status: 'stable', lang: 'py + ts' },
  { name: 'CAREEngine', desc: 'Continuous Audit Readiness Engine — evidence freshness monitoring, 6-month log retention verification per EU AI Act Article 12, FRIA template generator pre-populated from System Cards and Risk Reports.', status: 'stable', lang: 'py + ts' },
