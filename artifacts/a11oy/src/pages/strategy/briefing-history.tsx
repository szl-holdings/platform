...
export default function BriefingHistoryPage() {
  const [todayBriefing, setTodayBriefing] = useState<(typeof DEMO_BRIEFING_HISTORY)[0] | null>(
    null,
  );
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '6px' }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '8px',
                border: `1px solid ${ACCENT}40`,
                background: generating ? `${ACCENT}20` : `${ACCENT}15`,
                color: generating ? 'rgba(255,255,255,0.4)' : ACCENT,
                fontSize: '12px',
                fontWeight: 600,
