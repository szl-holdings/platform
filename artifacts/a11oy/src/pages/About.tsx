...
const FABRIC_LAYERS = [
  ...
  { n: 8, name: 'Doctrine Layer (Khipu)', desc: 'Frontier-grade alignment governance — constitutions, behavioral audit, reward-hacking watchdog, red-team probes, agent welfare telemetry, per-agent system cards, and Pillpintu transparency. Open Spec published under CC-BY-4.0.' },
...
const PRINCIPLES = [
  ...
  { title: 'Pillpintu Transparency', body: 'The Pillpintu distinction layer makes governance verifiable from the outside. Public trust portal, CAVD coordinated agent-vulnerability disclosure, 90-day transparency reports, adversarial robustness wall, and constitution-as-code DSL — all published under the Khipu Doctrine Open Spec (CC-BY-4.0). Every claim backed by an artifact.' },
];
