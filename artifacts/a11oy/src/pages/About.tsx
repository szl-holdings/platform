...
const FABRIC_LAYERS = [
  ...
  { n: 8, name: 'Doctrine Layer (Hatun)', desc: 'Frontier-grade alignment governance — constitutions, behavioral audit, reward-hacking watchdog, red-team probes, agent welfare telemetry, per-agent system cards, and Glasswing transparency. Open Spec published under CC-BY-4.0.' },
