...
const TWINS_DATA: TwinsData = {
  ...
  twins: [
    { id: 'vessel-twin-001', name: 'VLCC Everest', type: 'vessel', tenant: 'SZL Holdings / Vessels', domain: 'Maritime', fidelity: 94, driftScore: 74, riskLevel: 'critical', owner: 'Operations Controller, Vessels', lastSync: '2026-04-26T14:28:00Z', signals: 3, activeWorkcells: 1, proofCoverage: 96, recommendedAction: 'Reroute to Port Antwerp — VP Operations approval required', state: { vessel_id: 'VLCC-EVEREST-001', current_port: 'Singapore', destination: 'Rotterdam', eta_deviation_hours: 31, standby_cost_per_day: '$2.4M', cargo_type: 'Crude Oil', flag_state: 'Marshall Islands', compliance_status: 'COMPLIANT' } },
    ...
    { id: 'asset-twin-007', name: '45 Park Ave Portfolio', type: 'asset', tenant: 'Terra Real Estate', domain: 'Real Estate', fidelity: 88, driftScore: 22, riskLevel: 'low', owner: 'Portfolio Director, Terra', lastSync: '2026-04-26T11:00:00Z', signals: 1, activeWorkcells: 0, proofCoverage: 84, recommendedAction: 'Continue lease-up strategy — two LOIs in negotiation', state: { asset_class: 'Class A Office', total_sqft: 284000, occupancy_rate: '89%', covenant_threshold: '85%', lender: 'JPMorgan Real Estate', noi_ytd: '$8.2M', cap_rate: '5.4%', lease_expiry_risk: 'LOW' } },
