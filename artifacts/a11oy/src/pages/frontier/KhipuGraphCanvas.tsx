...
export interface KhipuGraphNode {
  id: string;
  kind: NodeKind;
  label: string;
...
export interface KhipuGraphEdge {
  source: string;
  target: string;
  relation: string;
}

interface SimNode extends d3.SimulationNodeDatum, KhipuGraphNode {}
interface SimLink extends d3.SimulationLinkDatum<SimNode> {
  relation: string;
}

interface Props {
  nodes: KhipuGraphNode[];
  edges: KhipuGraphEdge[];
