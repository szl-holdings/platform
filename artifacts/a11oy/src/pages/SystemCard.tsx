...
export function SystemCard() {
  ...
  const adherenceData = cst.adherenceTrend.map((v, i) => ({ i, v }));
  ...
  return (
    <Layout>
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-6">
        <Card>
          <SectionTitle>Constitution {cst.id}</SectionTitle>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <InfoRow label="Refusal rate" value={fmtPct(welfare.refusalRate)} />
