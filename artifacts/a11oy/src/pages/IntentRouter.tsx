...
const DEMO_INTENTS = [
  ...
  { id: 'i05', text: 'Plano industrial cap rates moved 18bps. Recommend portfolio rebalancing actions.', domain: 'real-estate', confidence: 0.89, priority: 'medium', entities: ['market:Plano', 'signal:cap_rate', 'delta:+18bps'], routed: ['Terra Analyst'] },
  ...
  { id: 'i13', text: 'Austin multifamily deals — cap rate compression accelerating. Flag for portfolio review.', domain: 'real-estate', confidence: 0.87, priority: 'medium', entities: ['market:Austin', 'asset:multifamily', 'signal:cap_compression'], routed: ['Terra Analyst'] },
