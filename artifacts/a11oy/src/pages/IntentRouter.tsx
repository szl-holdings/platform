...
const DEMO_INTENTS = [
  ...
  { id: 'i06', text: 'SIGINT pattern matches prior GROM adversary signature. Assess threat to contractor assets.', domain: 'defense', confidence: 0.97, priority: 'critical', entities: ['signal:sigint', 'adversary:GROM', 'asset:contractor'], routed: ['PARAGON Sentinel', 'Guardian'] },
  ...
  { id: 'i14', text: 'Lateral movement detected from compromised contractor account in defense subnet.', domain: 'defense', confidence: 0.98, priority: 'critical', entities: ['technique:lateral_movement', 'account:contractor', 'subnet:defense'], routed: ['PARAGON Sentinel', 'Guardian'] },
