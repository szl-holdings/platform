...
const RESEARCH_DOMAINS = [
  ...
  { name: 'Regulatory & Compliance', desc: 'Cross-jurisdictional regulatory analysis. GDPR, SOX, HIPAA, FedRAMP, ITAR — track requirements, monitor changes, assess impact on your operations.', queries: '1,200+' },
...
const ENTERPRISE_FEATURES = [
  ...
  { name: 'Compliance Certifications', desc: 'SOC 2 Type II, ISO 27001, HIPAA BAA, FedRAMP (in progress). Every certification backed by continuous monitoring, not annual snapshots.' },
