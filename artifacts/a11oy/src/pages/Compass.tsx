              ...
              {(() => {
                ...
                const buildFRIA = () => ({
                  ...
                  assessmentAreas: [
                    ...
                    { right: 'Human dignity', impact: 'Low', mitigation: 'Agent Welfare Assessment active. No claims of sentience. Welfare telemetry is governance signal only.', evidenceRef: 'WelfareAssessment probe results, Hatun Doctrine system cards' },
