...
} from '../../components/operations/governed-decision/monte-carlo-panel';
import { OutcomePanel, type OutcomeRecord } from '../../components/operations/governed-decision/outcome-panel';
import {
  type AuditEntry,
  type ApprovalStep as PolicyApprovalStep,
  type PolicyEvaluation,
  PolicyGatePanel,
} from '../../components/operations/governed-decision/policy-gate-panel';
import {
  type ProofEntry,
  ProofProvenancePanel,
} from '../../components/operations/governed-decision/proof-provenance-panel';
...
const LOOP_STEPS: LoopStep[] = [
  {
    ...
    icon: Radio,
    color: '#c45a4a',
    description: 'Inbound event detected across domain pack telemetry',
  },
  {
    id: 'context',
    label: 'Context',
    icon: Brain,
    color: '#ec4899',
    description: 'Signal enriched with cross-domain intelligence and historical patterns',
  },
  {
    id: 'recommendation',
    ...
    icon: Zap,
    color: '#8b7ac8',
    description: 'AI-generated action recommendation with confidence scoring',
  },
  {
    id: 'simulation',
    label: 'Simulation',
  ...
  },
  {
    ...
    icon: Scale,
    color: ACCENT,
    description: 'Covenant Policy evaluation — automated compliance and risk assessment',
  },
  {
    id: 'approval',
    label: 'Approval',
    icon: CheckSquare,
    color: '#22c55e',
    description: 'Human-in-the-loop approval chain with role-based gates',
  },
  {
    id: 'execution',
    label: 'Execution',
    icon: Play,
    color: '#6366f1',
    description: 'Governed action execution via workflow engine',
  },
  {
    id: 'proof',
    label: 'Proof Chain',
    icon: Shield,
    color: '#d4a054',
    description: 'Immutable provenance record — source, model, confidence, lineage',
  },
  {
    id: 'outcome',
    label: 'Outcome',
    icon: Target,
    color: '#6b8f71',
    description: 'Result captured, prediction accuracy measured, feedback loop closed',
  },
];
...
const VESSELS_DATA: ScenarioPanelData = {
  ...
  policy: {
    evaluations: [
      {
        policyId: 'cov-001',
        policyName: 'High-severity actions → Human approval required',
        outcome: 'approved',
        reason: 'Severity = CRITICAL, routed to human approval gate',
        evaluatedAt: '09:12:04',
        durationMs: 3,
      },
      {
        policyId: 'cov-002',
        policyName: 'Financial actions > $50K → Finance review',
        outcome: 'approved',
        reason:
          'Fuel surcharge $45K within threshold; reroute cost accepted under operational mandate',
        evaluatedAt: '09:12:04',
        durationMs: 2,
      },
      {
        policyId: 'cov-003',
        policyName: 'Compliance events → Immutable audit log',
        outcome: 'approved',
        reason: 'SLA-related action logged to immutable audit trail',
        evaluatedAt: '09:12:04',
        durationMs: 1,
      },
      {
    ...
    approvalChain: [
      {
        ...
        status: 'approved',
        timestamp: '09:18',
        comment: 'Confirmed weather window. Reroute is the right call.',
      },
      {
        role: 'Finance Controller',
        approver: 'Aisha Kamara',
        status: 'approved',
        timestamp: '09:25',
        comment: 'Fuel surcharge within Q2 contingency budget.',
      },
      {
        role: 'CEO',
        approver: 'Stephen Lutar',
        status: 'approved',
        timestamp: '09:45',
        comment: 'Approved. Protect the SLA — client relationship is strategic.',
      },
    ],
    auditTrail: [
      ...
      {
        timestamp: '09:12:01',
        action: 'Context enrichment completed (4 sources)',
        actor: 'System',
      },
      {
        timestamp: '09:12:03',
        action: 'Recommendation REC-0421 generated (82% confidence)',
        actor: 'szl-ops-advisor-v3',
      },
      {
        timestamp: '09:12:04',
        action: 'Covenant Policy evaluation — 4 policies checked, all passed',
        actor: 'Covenant Engine',
      },
      {
        timestamp: '09:12:06',
        action: 'Monte Carlo simulation completed (10,000 iterations)',
        actor: 'System',
      },
      {
        timestamp: '09:12:10',
        action: 'Approval request created — routed to 3-step chain',
        actor: 'System',
      },
      ...
      {
        timestamp: '09:45:02',
        action: 'Execution initiated — reroute order dispatched to vessel',
        actor: 'Workflow Engine',
      },
      {
        timestamp: '09:45:05',
        action: 'Proof chain record created — immutable receipt generated',
        actor: 'Proof Chain',
      },
      {
        timestamp: 'Apr 17, 14:30',
        action: 'Outcome recorded — SLA breach avoided, $2.1M protected',
        actor: 'System',
      },
    ],
  },
  execution: {
    steps: [
      {
        step: 'Authorization verified',
        status: 'complete',
        time: '09:45:01',
        detail: '3/3 approvals confirmed',
      },
      {
        step: 'Reroute order dispatched',
        status: 'complete',
        time: '09:45:02',
        detail: 'M/V Meridian — Captain notified via VSAT',
      },
      {
        step: 'Fuel surcharge entry created',
        status: 'complete',
        time: '09:45:03',
        detail: '$45K logged against contingency budget',
      },
      {
        step: 'Client notification sent',
        status: 'complete',
        time: '09:45:04',
        detail: 'Revised ETA communicated — Contract T-2241',
      },
      {
        step: 'Audit trail sealed',
        status: 'complete',
        time: '09:45:05',
        detail: 'Immutable proof chain record generated',
      },
    ],
    durationLabel: '4.2s',
    stepsCompleted: '5/5',
  ...
  outcome: {
    ...
    actualImpact:
      '$2.1M protected — SLA compliance restored, vessel arrived 6hr ahead of revised ETA',
    accuracy: 97,
    feedbackNote:
      'Reroute executed cleanly. Weather window was correctly predicted. Recommend pre-authorizing surcharge for similar patterns going forward.',
    laterImpact:
      'Client relationship strengthened — contract renewal probability increased from 72% to 89%',
...
const AEGIS_DATA: ScenarioPanelData = {
  ...
  signal: {
    ...
    evidence: [
      ...
      {
        type: 'historical',
        label: 'Pattern matches 2024 Lazarus-attributed credential-stuffing campaign',
      },
    ],
    riskEstimate: '$2.4M',
  },
  ...
  recommendation: {
    ...
    alternativeAction:
      'Enable step-up MFA only and monitor — preserves session continuity at higher risk',
    confidence: 94,
  ...
  simulation: {
    scenarios: [
      {
        id: 'contain',
        label: 'Contain & Rotate (Recommended)',
        color: '#6b8f71',
        outputMetric: 'Loss Avoided',
        outputUnit: '$',
        p5: 1400000,
        p25: 1900000,
        p50: 2400000,
    ...
    evaluations: [
      {
        ...
        policyName: 'High-severity actions → Human approval required',
        outcome: 'approved',
        reason: 'Severity = CRITICAL, routed to security approval gate',
        evaluatedAt: '02:14:08',
        durationMs: 2,
      },
      {
        policyId: 'cov-004',
        policyName: 'Credential rotation → CISO sign-off',
        outcome: 'approved',
        reason: 'Credential incident — CISO approval required and obtained',
        evaluatedAt: '02:14:09',
        durationMs: 3,
      },
      {
        policyId: 'cov-003',
        policyName: 'Compliance events → Immutable audit log',
        outcome: 'approved',
        reason: 'Security incident logged for SOC 2 evidence',
        evaluatedAt: '02:14:09',
        durationMs: 1,
      },
      {
        policyId: 'cov-007',
        policyName: 'Production credential changes → Two-person rule',
        outcome: 'approved',
        reason: 'Two-person approval satisfied (Sec Lead + CISO)',
        evaluatedAt: '02:14:10',
        durationMs: 2,
      },
    ],
    approvalChain: [
      {
        ...
        status: 'approved',
        timestamp: '02:16',
        comment: 'Telemetry confirms credential stuffing. Contain immediately.',
      },
      {
        role: 'CISO',
        approver: 'David Okafor',
        status: 'approved',
        timestamp: '02:19',
        comment: 'Approved containment + global MFA enforcement.',
      },
      {
        role: 'CEO',
        approver: 'Stephen Lutar',
        status: 'approved',
        timestamp: '02:22',
        comment: 'Approved. Notify board after containment confirmed.',
      },
    ],
    auditTrail: [
      ...
      {
        timestamp: '02:14:07',
        action: 'Recommendation REC-AEG-1184 generated (94% confidence)',
        actor: 'szl-aegis-responder-v2',
      },
      {
        timestamp: '02:14:10',
        action: 'Covenant Policy evaluation — 4 policies checked, all passed',
      ...
      {
        timestamp: '02:22:00',
        action: 'CEO approved — containment authorized',
        actor: 'Stephen Lutar',
      },
      {
        timestamp: '02:22:04',
        action: 'Execution initiated — accounts suspended, IP block applied',
        actor: 'Workflow Engine',
      },
      {
        timestamp: '02:22:09',
      ...
      {
        timestamp: 'Apr 16, 09:00',
        action: 'Outcome recorded — no breach, $2.4M exposure avoided',
        actor: 'System',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        status: 'complete',
        time: '02:22:01',
        detail: '3/3 approvals confirmed (Sec Lead, CISO, CEO)',
      },
      {
        step: 'Admin accounts suspended',
        status: 'complete',
        time: '02:22:03',
        detail: '3 accounts force-logged out, sessions revoked',
      },
      {
        step: 'Credentials & API keys rotated',
        status: 'complete',
        time: '02:22:05',
        detail: '47 secrets rotated, dependent services notified',
      },
      {
        step: 'Perimeter IP block applied',
        status: 'complete',
        time: '02:22:07',
        detail: '3 IP ranges blacklisted at edge',
      },
      {
        step: 'Audit trail sealed',
        status: 'complete',
        time: '02:22:09',
        detail: 'SOC 2 evidence chain generated',
      },
    ],
    durationLabel: '8.1s',
    stepsCompleted: '5/5',
  ...
  proof: [
    {
      id: 'PF-AEG-3301',
      sourceClass: 'llm_generated',
      contentType: 'Security Containment Recommendation',
      modelId: 'szl-aegis-responder-v2',
      modelProvider: 'SZL Internal',
      confidenceScore: 0.94,
      reviewState: 'approved',
      exportSafety: 'safe',
      generatedAt: 'Apr 16, 02:14:07',
    ...
    },
    {
      id: 'PF-AEG-3302',
      sourceClass: 'system_computed',
      contentType: 'Loss-Avoidance Simulation Result',
      confidenceScore: 0.88,
      reviewState: 'approved',
      exportSafety: 'safe',
      generatedAt: 'Apr 16, 02:14:12',
      reviewedBy: 'David Okafor',
      reviewedAt: 'Apr 16, 02:19',
      inputSources: [
        { type: 'model', label: 'Breach Loss Model v1.4' },
        { type: 'market', label: 'IBM Cost-of-Breach Index' },
        { type: 'historical', label: 'Industry IR benchmarks' },
      ],
      parentProofId: 'PF-AEG-3301',
    },
  ],
  outcome: {
    id: 'OUT-AEG-0117',
    result: 'achieved',
    executedAction:
      'Admin accounts suspended; credentials rotated; IP perimeter block applied; global MFA enforced',
    ...
    actualImpact:
      '$2.4M protected — no data exfiltration detected, attacker confirmed locked out, MFA gap closed',
    accuracy: 96,
    feedbackNote:
      'Containment fully effective. Recommend automating MFA enforcement across all admin tiers as standing policy.',
...
const TERRA_DATA: ScenarioPanelData = {
  ...
  simulation: {
    scenarios: [
      {
        id: 'loi-395',
        label: 'LOI at $3.95M (Recommended)',
        color: '#6b8f71',
        outputMetric: '3-Yr Equity Gain',
        outputUnit: '$',
        p5: 600000,
        p25: 950000,
        p50: 1250000,
    ...
    evaluations: [
      {
        ...
        policyName: 'Financial actions > $50K → Finance review',
        outcome: 'approved',
        reason: 'Acquisition $3.95M — finance review completed',
        evaluatedAt: '08:01:14',
        durationMs: 3,
      },
      {
        policyId: 'cov-008',
        policyName: 'Real estate acquisitions → Investment Committee approval',
        outcome: 'approved',
        reason: 'IC convened and approved within 60 minutes',
        evaluatedAt: '08:01:15',
        durationMs: 4,
      },
      {
        policyId: 'cov-003',
        policyName: 'Compliance events → Immutable audit log',
        outcome: 'approved',
        reason: 'LOI authorization logged for audit',
        evaluatedAt: '08:01:15',
        durationMs: 1,
      },
      {
        policyId: 'cov-009',
        policyName: 'Capital deployment > $1M → Treasury sign-off',
        outcome: 'approved',
        reason: 'Treasury confirmed capital availability and reserved $4.5M envelope',
        evaluatedAt: '08:01:16',
        durationMs: 2,
      },
    ],
    approvalChain: [
      {
        ...
        approver: 'Lena Vasquez',
        status: 'approved',
        timestamp: '08:18',
        comment: 'Comp analysis confirms 22% discount. LOI at $3.95M is the right anchor.',
      },
      {
        role: 'CFO / Treasury',
        approver: 'Aisha Kamara',
        status: 'approved',
        timestamp: '08:34',
        comment: 'Capital available. Reserve $450K CapEx as recommended.',
      },
      {
        role: 'CEO',
        approver: 'Stephen Lutar',
        status: 'approved',
        timestamp: '08:51',
        comment: 'Approved. Move fast — exclusivity window is the entire edge.',
      },
    ],
    auditTrail: [
      ...
      {
        timestamp: '07:34:18',
        action: 'Recommendation REC-TER-0903 generated (89% confidence)',
        actor: 'szl-terra-acquirer-v2',
      },
      {
        timestamp: '08:01:16',
        action: 'Covenant Policy evaluation — 4 policies checked, all passed',
      ...
      {
        timestamp: '08:51:09',
        action: 'Execution initiated — LOI dispatched to broker',
        actor: 'Workflow Engine',
      },
      {
        timestamp: '08:51:14',
      ...
      {
        timestamp: 'Apr 28, 16:00',
        action: 'Outcome recorded — LOI accepted, exclusivity locked',
        actor: 'System',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        status: 'complete',
        time: '08:51:01',
        detail: '3/3 approvals confirmed (Acquisitions, CFO, CEO)',
      },
      {
      ...
      },
      {
        ...
        status: 'complete',
        time: '08:51:07',
        detail: 'Sent to James Holt at Meridian Brokerage',
      },
      {
        step: 'Capital reservation booked',
        status: 'complete',
        time: '08:51:09',
        detail: '$4.5M reserved against Q2 acquisitions envelope',
      },
      {
        step: 'Audit trail sealed',
        status: 'complete',
  ...
  proof: [
    {
      id: 'PF-TER-5511',
      sourceClass: 'llm_generated',
      contentType: 'Acquisition Recommendation',
      modelId: 'szl-terra-acquirer-v2',
      modelProvider: 'SZL Internal',
      confidenceScore: 0.89,
      reviewState: 'approved',
      exportSafety: 'safe',
      generatedAt: 'Apr 16, 07:34:18',
      reviewedBy: 'Lena Vasquez',
      reviewedAt: 'Apr 16, 08:18',
      reviewNote: 'Comp analysis verified independently — recommendation stands',
      inputSources: [
        { type: 'database', label: 'Comp Sales DB (Q1 2026)' },
        { type: 'model', label: 'Cap Rate Model v3.0' },
        { type: 'database', label: 'Tenant Roll & Lease Schedule' },
        { type: 'historical', label: '7 prior distressed acquisitions' },
      ],
    },
    {
      id: 'PF-TER-5512',
      sourceClass: 'system_computed',
      contentType: 'Equity-Gain Simulation Result',
      confidenceScore: 0.81,
      reviewState: 'approved',
      exportSafety: 'safe',
      generatedAt: 'Apr 16, 08:02:04',
      reviewedBy: 'Aisha Kamara',
      reviewedAt: 'Apr 16, 08:34',
      inputSources: [
        { type: 'model', label: 'Acquisition IRR Model v2.2' },
        { type: 'market', label: 'Local Submarket Rent Index' },
        { type: 'historical', label: 'Lease-up absorption curves' },
      ],
      parentProofId: 'PF-TER-5511',
    },
  ],
  outcome: {
    id: 'OUT-TER-0822',
    ...
    actualImpact:
      'LOI accepted at $3.95M — exclusivity locked, due diligence on track, projected IRR 18.4% confirmed',
    accuracy: 92,
    feedbackNote:
      'Speed-to-LOI was decisive. Recommend pre-authorizing acquisitions under $5M with IC standing approval.',
    laterImpact:
      'Pipeline strengthened — broker brought 2 additional off-market opportunities citing execution speed',
          ...
          <div key={step.id} className="flex items-center shrink-0">
              ...
              >
                {isPast ? (
                  ...
                  <Icon
                    ...
                    style={{ color: isActive ? step.color : TEXT.muted }}
                  />
                )}
              </div>
              <span
            ...
            {i < steps.length - 1 && (
              <ArrowRight
                ...
                style={{ color: isPast ? 'rgba(107,143,113,0.4)' : TEXT.muted }}
              />
            )}
          </div>
        );
...
function SignalStep({ data }: { data: ScenarioPanelData }) {
  ...
  const sevColor =
    sig.severity === 'critical' ? '#c45a4a' : sig.severity === 'high' ? '#c8953c' : '#8b7ac8';
  return (
      ...
      >
        <div className="flex items-start gap-4 mb-4">
          <div
            ...
            style={{ background: `${sevColor}1a`, border: `2px solid ${sevColor}4d` }}
          >
          ...
          <div className="flex-1">
            ...
            <div className="text-base font-bold mb-1" style={{ color: TEXT.primary }}>
              {sig.title}
            </div>
            <div className="flex items-center gap-3 text-[10px]" style={{ color: TEXT.tertiary }}>
              <span
                ...
                style={{
                  background: `${sig.packColor}12`,
                  border: `1px solid ${sig.packColor}30`,
                  color: sig.packColor,
                }}
              >
                {sig.pack}
        ...
        <div className="grid grid-cols-3 gap-2">
          {sig.entities.map((e) => (
            <div
              ...
              style={{ background: `${sig.packColor}0d`, border: `1px solid ${sig.packColor}1f` }}
            >
              <div className="text-[10px] font-semibold" style={{ color: sig.packColor }}>
                {e}
              </div>
              <div
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div
          ...
          style={{ background: BG.surface, border: `1px solid ${BORDER.muted}` }}
        >
          <div className="text-2xl font-bold font-mono" style={{ color: '#ec4899' }}>
            {ctx.historicalMatches}
          </div>
          <div className="text-[9px] uppercase tracking-wider mt-1" style={{ color: TEXT.muted }}>
            Historical Matches
          </div>
        </div>
        <div
...
function RecommendationStep({ data }: { data: ScenarioPanelData }) {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex items-start gap-4 mb-4">
          <div
            ...
            style={{
              ...
              border: '2px solid rgba(139,122,200,0.3)',
            }}
          >
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  <div
                    ...
                    style={{ width: `${rec.confidence}%`, background: '#8b7ac8' }}
                  />
                </div>
          ...
          {rec.reasoning.map((r, i) => (
            <div
              ...
              style={{
                ...
                border: `1px solid rgba(139,122,200,0.08)`,
              }}
            >
              <span
                className="text-[9px] font-bold font-mono shrink-0 mt-0.5"
                style={{ color: '#8b7ac8' }}
              >
                {i + 1}.
              </span>
      ...
      <div
        className="rounded-xl p-4"
        style={{ background: 'rgba(200,149,60,0.03)', border: '1px solid rgba(200,149,60,0.1)' }}
      >
        <div
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-[9px] font-mono mt-0.5" style={{ color: TEXT.muted }}>
            Governed execution log — every step authorized, timed, and recorded
          </div>
        </div>
        ...
        >
          <div className="flex items-center gap-3">
            <div>
              ...
              <span className="text-sm font-bold font-mono" style={{ color: '#6366f1' }}>
                {ex.durationLabel}
              </span>
            </div>
            <div>
    ...
    >
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-mono" style={{ color: 'rgba(212,160,84,0.55)' }}>
            ·
          </span>
          <span
            className="text-[9px] font-mono"
            style={{ color: 'rgba(212,160,84,0.7)' }}
            data-testid="governed-loop-active-domain"
          >
            {data.domainLabel}
          </span>
        </div>
            ...
            {DEMO_ROUTE_STEPS_5MIN.map((r, i) => (
              <div key={r.step} className="flex items-center gap-1.5">
                <button
                  ...
                  style={{
                    background:
                      activeStep === r.step - 1 ? 'rgba(212,160,84,0.15)' : 'rgba(212,160,84,0.05)',
                ...
                >
                  <span className="font-mono text-[8px]" style={{ color: 'rgba(212,160,84,0.45)' }}>
                    {r.time}
                  </span>
                  {r.label}
                </button>
                {i < DEMO_ROUTE_STEPS_5MIN.length - 1 && (
                  <ArrowRight
                    ...
                    style={{ color: 'rgba(212,160,84,0.2)' }}
                  />
                )}
              </div>
            ))}
...
export default function GovernedDecisionLoop() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-5">
      {showSwitcher && <ScenarioSwitcher current={scenarioKey} onSelect={selectScenario} />}
      ...
      <div>
        ...
        <p className="text-sm mt-1 max-w-2xl" style={{ color: TEXT.tertiary }}>
          The canonical loop that makes every decision explainable. Signal enters, context is
          enriched, AI recommends, simulation quantifies risk, policy gates enforce compliance,
          humans approve, the system executes, proof is sealed, and outcomes close the feedback
          loop.
        </p>
      </div>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-bold" style={{ color: currentStep.color }}>
        ...
        <div className="flex items-center gap-1">
          {LOOP_STEPS.map((step, i) => (
            <button
              ...
              style={{
                background:
                  i === activeStep ? LOOP_STEPS[i].color : i < activeStep ? '#6b8f71' : TEXT.muted,
              }}
