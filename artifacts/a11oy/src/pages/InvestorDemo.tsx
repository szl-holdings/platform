...
const STAGES = [
  ...
  {
    step: 12,
    title: 'Khipu Doctrine — Frontier Alignment Governance',
    category: 'GOVERNANCE',
    body: 'Layer 8 of the A11oy fabric. Every agent carries a versioned constitution, behavioral audit trail, reward-hacking watchdog, and per-agent system card. Red-team probes run continuously. The Pillpintu distinction layer adds coordinated agent-vulnerability disclosure (CAVD), 90-day public transparency reports, an adversarial robustness wall, a constitution-as-code DSL with a Petri-net simulator, welfare intervention playbooks, and a defender credit pool. The Khipu Doctrine Open Spec (CC-BY-4.0) publishes the format so anyone can verify.',
    metrics: [
