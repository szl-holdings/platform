...
const AGENTS = [
  ...
  { id: 'ag-terra', name: 'DOMAINE Analyst', role: 'Domain Specialist', vertical: 'Real Estate', model: 'gpt-4o', status: 'active', trust: 88, handoffs: 6, tools: ['cap_rate', 'portfolio_analysis', 'valuation_model', 'market_comp'], instructions: 'Track portfolio metrics, run valuations, detect market signals. Escalate large transactions.', guardrails: ['valuation_bounds', 'transaction_limit'] },
...
const HANDOFF_FLOWS = [
  ...
  { from: 'DOMAINE Analyst', to: 'Pipeline Oracle', trigger: 'Portfolio transaction > $5M', count: 5, avgMs: 210 },
