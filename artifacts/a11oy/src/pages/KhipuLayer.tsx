...
import {
  KHIPU_LAYER_VERSION, KHIPU_LAYER_TAGLINE,
  ORCHESTRATION_STEPS, SCANNERS, RL_PIPELINE, GUARDRAILS, ROADMAP, MODEL_REFERENCES, KHIPU_LAYER_CITATIONS,
  type LoopActor, type ScannerSurface, type RoadmapPhase,
} from '../data/khipuLayer';
  ...
  return (
    <Layout>
      <PageHeader
        ...
        title="Khipu Layer"
        subtitle={`${KHIPU_LAYER_TAGLINE} · v${KHIPU_LAYER_VERSION}`}
        status="GATED"
      />
      ...
      <Card className="mb-6">
        ...
        <p className="text-xs mb-2" style={{ color: SUB, lineHeight: 1.7 }}>
          The Khipu Layer codifies how A11oy and Sentra compose into a defensive AI layer when frontier models become a force multiplier
