...
import type { PillpintuPartnerStage } from '../data/khipuDoctrine';
import { usePartners, useCavdRecords, DoctrineLoader } from '../hooks/useDoctrine';

const STAGES: PillpintuPartnerStage[] = ['apply', 'verify', 'vet', 'onboard', 'active', 'suspended', 'revoked'];

const STAGE_COLOR: Record<PillpintuPartnerStage, string> = {
...
export function PillpintuPartners() {
  ...
  return (
    <Layout>
      ...
      <PageHeader
        label="DOCTRINE · PILLPINTU PARTNERS"
        title="Pillpintu Partner Lifecycle"
          ...
          {filtered.map((p: any) => (
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="px-1.5 py-0.5 rounded text-xs font-mono uppercase" style={{ backgroundColor: `${STAGE_COLOR[p.stage as PillpintuPartnerStage]}22`, color: STAGE_COLOR[p.stage as PillpintuPartnerStage] }}>{p.stage}</span>
              </div>
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="px-1.5 py-0.5 rounded text-xs font-mono uppercase" style={{ backgroundColor: `${STAGE_COLOR[partner.stage as PillpintuPartnerStage]}22`, color: STAGE_COLOR[partner.stage as PillpintuPartnerStage] }}>
                {partner.stage}
              </span>
            </div>
