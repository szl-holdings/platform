        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 20, marginBottom: 20 }}>
          <div>
            ...
            >
              ...
              <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
                <a
                  href={`${import.meta.env.BASE_URL?.replace(/\/$/, '') || '/a11oy'}/omnia/narrative`}
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: 5,
                ...
                <a
                  href={`${import.meta.env.BASE_URL?.replace(/\/$/, '') || '/a11oy'}/omnia/world-model`}
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: 5,
          ...
          <div>
            ...
            >
              ...
              <div>
                {[
                  { href: `${import.meta.env.BASE_URL?.replace(/\/$/, '') || '/a11oy'}/omnia/world-model`, label: 'World Model Graph', icon: Layers, desc: 'Entity graph with ripple' },
                  { href: `${import.meta.env.BASE_URL?.replace(/\/$/, '') || '/a11oy'}/omnia/narrative`, label: 'Synthesis Narrative', icon: BookOpen, desc: 'Live portfolio story' },
                  { href: `${import.meta.env.BASE_URL?.replace(/\/$/, '') || '/a11oy'}/omnia/ripple`, label: 'Ripple / Impact', icon: Activity, desc: 'Downstream effect tracing' },
                  { href: `${import.meta.env.BASE_URL?.replace(/\/$/, '') || '/a11oy'}/omnia/story`, label: 'Public Story Mode', icon: Globe, desc: 'Investor-grade view' },
                ].map((surface) => {
