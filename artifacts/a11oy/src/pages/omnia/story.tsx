...
export default function OmniaStoryPage() {
  ...
  const FALLBACK: StoryData = {
    ...
    paragraphs: [
      { id: 'p-001', text: 'Sentra has elevated the APT-41 threat cluster to HIGH confidence following corroborated indicators across 14 unique signals. Precautionary reviews are underway for three downstream DOMAINE assets, with TER-8821 already restored to compliance.', domain: 'aegis', confidence: 0.92, deepLink: '/sentra' },
