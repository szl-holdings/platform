  ...
  return (
    <Layout>
      <PageHeader
        ...
        subtitle="A11oy operates across 7 enterprise verticals. Each vertical has dedicated agent operators, signal schemas, governance policies, proof coverage, Khipu Doctrine alignment governance, Pillpintu transparency, and Compliance Fabric mapping to EU AI Act, NIST AI RMF, ISO 42001, and CSA Agentic Profile — including per-agent CAVD disclosure, adversarial robustness scoring, Agent-BOM, and constitution-as-code enforcement."
        status="LIVE"
      />
