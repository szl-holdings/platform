...
const OPERATORS = [
  ...
  { id: 'op-terra', name: 'DOMAINE Analyst', vertical: 'terra-real-estate', type: 'domain-specialist', status: 'active', trustScore: 88, model: 'gpt-4o', tasksToday: 9, pendingTasks: 0, avgLatencyMs: 760, costPerCallUSD: 0.011, skills: ['Cap Rate Tracking', 'Portfolio Analysis', 'Valuation Modeling'], lastAction: 'Cap rate compression signal processed' },
