    ...
    <div style={{ minHeight: '100vh', background: NAVY, color: TEXT, fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ margin: '1rem 0 0', padding: '1rem 1.25rem', borderRadius: 12, display: 'flex', alignItems: 'center', gap: '1rem', background: 'rgba(107,141,227,0.04)', border: '1px solid rgba(107,141,227,0.15)' }}>
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 14, fontWeight: 600, color: '#e2e0d8', marginBottom: 2 }}>Khipu Index — Evolution Lineage</div>
          <div style={{ fontSize: 11, color: 'rgba(226,224,216,0.5)' }}>Karpathy evolution milestones feed the Khipu Index — the canonical record of capability emergence, model lineage, and frontier-lab benchmarks across all SZL agents.</div>
        </div>
