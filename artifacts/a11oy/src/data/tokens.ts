...
export const tokens: Token[] = [
  { id: 't-1', name: 'color-primary', category: 'color', value: '#3b82f6', description: 'Primary brand action color', version: '2.1.0', lastChanged: '2026-03-15', changedBy: 'S. Lutar', driftSurfaces: ['Terra'], history: [{version: '2.1.0', date: '2026-03-15', value: '#3b82f6', author: 'S. Lutar'}, {version: '2.0.0', date: '2025-11-10', value: '#2563eb', author: 'A. Chen'}] },
