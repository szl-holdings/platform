...
export const tokens: Token[] = [
  { id: 't-1', name: 'color-primary', category: 'color', value: '#c9b787', description: 'Primary brand action color', version: '2.1.0', lastChanged: '2026-03-15', changedBy: 'S. Lutar', driftSurfaces: ['Terra'], history: [{version: '2.1.0', date: '2026-03-15', value: '#c9b787', author: 'S. Lutar'}, {version: '2.0.0', date: '2025-11-10', value: '#2563eb', author: 'A. Chen'}] },
  { id: 't-2', name: 'color-surface', category: 'color', value: '#0a0a0a', description: 'Main application background', version: '1.4.2', lastChanged: '2026-01-20', changedBy: 'J. Doe', driftSurfaces: [], history: [{version: '1.4.2', date: '2026-01-20', value: '#0a0a0a', author: 'J. Doe'}] },
  { id: 't-3', name: 'color-text', category: 'color', value: '#f5f5f5', description: 'Primary body text', version: '1.1.0', lastChanged: '2025-08-05', changedBy: 'System', driftSurfaces: ['Counsel', 'Aegis'], history: [{version: '1.1.0', date: '2025-08-05', value: '#f5f5f5', author: 'System'}] },
  ...
  { id: 't-8', name: 'shadow-md', category: 'elevation', value: '0 4px 6px -1px rgb(0 0 0 / 0.1)', description: 'Standard dropdown shadow', version: '1.2.0', lastChanged: '2025-09-15', changedBy: 'J. Doe', driftSurfaces: ['Terra'], history: [{version: '1.2.0', date: '2025-09-15', value: '0 4px 6px -1px rgb(0 0 0 / 0.1)', author: 'J. Doe'}] },
