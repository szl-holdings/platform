...
export const brandsData: Record<string, Brand[]> = {
  szl: [
    { id: 'sentra', name: 'Sentra', tagline: 'Sentra — Cyber Resilience Command', color: '#8a8a8a', healthScore: 87, lastAudit: '2026-04-20', drift: 'none', owner: 'Brand Ops', surfaces: 4, detail: { tokenConformance: 92, voiceConformance: 85, a11yScore: 84, recentActivity: mockActivity } },
    ...
    { id: 'pulse', name: 'Pulse', tagline: 'Pulse — AI Executive Briefing', color: '#c9b787', healthScore: 91, lastAudit: '2026-04-22', drift: 'none', owner: 'Executive', surfaces: 2, detail: { tokenConformance: 95, voiceConformance: 90, a11yScore: 88, recentActivity: mockActivity } },
    { id: 'terra', name: 'Terra', tagline: 'Terra — Real Estate Intelligence', color: '#8a8a8a', healthScore: 68, lastAudit: '2026-04-10', drift: 'voice', owner: 'Property', surfaces: 5, detail: { tokenConformance: 75, voiceConformance: 60, a11yScore: 69, recentActivity: mockActivity } },
    { id: 'vessels', name: 'Vessels', tagline: 'Vessels — Maritime Intelligence', color: '#c9b787', healthScore: 82, lastAudit: '2026-04-18', drift: 'none', owner: 'Maritime', surfaces: 3, detail: { tokenConformance: 85, voiceConformance: 82, a11yScore: 79, recentActivity: mockActivity } },
    { id: 'aegis', name: 'Aegis', tagline: 'Aegis — Defense & Intelligence', color: '#8a8a8a', healthScore: 79, lastAudit: '2026-04-12', drift: 'token', owner: 'Defense', surfaces: 6, detail: { tokenConformance: 72, voiceConformance: 85, a11yScore: 80, recentActivity: mockActivity } },
