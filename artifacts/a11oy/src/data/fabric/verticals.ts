...
export const VERTICALS: readonly VerticalProfile[] = [
  {
    ...
    connectedA11oyLayers: ['Signal Mesh', 'Chainlight', 'Proof Chain', 'TENAX', 'Argo'],
  ...
  },
  {
    ...
    connectedA11oyLayers: ['Signal Mesh', 'Proof Chain', 'TENAX', 'Verity', 'Hermes'],
    maturityStage: 'operational',
    priorityLevel: 'high',
    route: '/counsel',
    colorToken: '#c9b787',
  ...
  },
  {
    ...
    connectedA11oyLayers: ['Signal Mesh', 'TENAX', 'Proof Chain', 'Argo'],
    maturityStage: 'seed',
  ...
  },
  {
    ...
    connectedA11oyLayers: ['Signal Mesh', 'Chainlight', 'Proof Chain', 'TENAX', 'Pallas'],
  ...
  },
  {
    ...
    operatingModel: 'Cross-vertical governance enforcement — every high-impact action across every vertical passes through TENAX for approval, policy check, and audit trail.',
    ...
    innovationSeed: {
      ...
      description: 'Detects conflicting policies across verticals — e.g., Terra vendor onboarding policy allows 48h turnaround while TENAX requires 5-day compliance review, creating an unresolvable conflict.',
