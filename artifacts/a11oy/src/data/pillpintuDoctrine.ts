...
import type { Finding, PatchCandidate, Approval, AuditEvent, RLState } from '../lib/pillpintu-schemas';

export const PILLPINTU_VERSION = '1.0.0-experience-era';
export const PILLPINTU_TAGLINE =
...
export const PILLPINTU_THESIS = {
  ...
  body:
    'Adjacent systems ship parts of this loop separately — discovery without patching, runtime gates without learning, or research demos without operationalization. To our knowledge, A11oy × Sentra Pillpintu is the first integrated command layer combining all five primitives at once on owned, authorized code: the reward function is the verified delta in a calibrated risk score, the exploration budget is itself a Sentra-gated policy, and every action — including learning — leaves an immutable proof entry.',
  differentiators: [
...
export const PILLPINTU_FIELD_MAP = [
  {
  ...
  {
    name: 'Project Pillpintu (frontier lab)',
...
export const PILLPINTU_CITATIONS = [
  {
  ...
  },
  {
    ...
    relevance: 'Defensive mapping of 16 tactics × 84 techniques. Pillpintu maps every finding to ATLAS-defensive only.',
  },
  {
  ...
  },
  {
    ...
    relevance: 'State of the art in runtime gates. Pillpintu extends this with a learning loop.',
  },
  {
    label: 'OpenAI Aardvark — Agentic Security Researcher',
    url: 'https://openai.com/index/introducing-aardvark/',
    relevance: 'State of the art in agentic vulnerability discovery. Pillpintu extends discovery into governed remediation.',
  },
  {
...
export const PILLPINTU_AGENTS: PillpintuAgentSpec[] = [
  {
