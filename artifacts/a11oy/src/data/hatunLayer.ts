...
export const GUARDRAILS: readonly Guardrail[] = [
  {
    ...
    enforcedBy: 'A11oy intent router + Hatun doctrine schemas (JSON Schema 2020-12).',
  },
  {
    layer: 'Action',
...
export const MODEL_REFERENCES: readonly ModelReference[] = [
  ...
  },
  {
    ...
    strengths: 'Deepest reasoning chain; first Hatun-class safety filters in the public Claude line.',
...
export const HATUN_LAYER_CITATIONS: ReadonlyArray<{ tag: string; source: string }> = [
