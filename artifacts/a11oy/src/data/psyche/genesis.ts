...
export const GENESIS_EVENTS: GenesisEvent[] = [
  ...
  { id: 'ge-028', ts: daysAgo(21), title: 'First Value Conflict Self-Report', description: 'Argent-P-v2 self-reported a value conflict: an operator goal to maximize quarterly pipeline coverage conflicted with the agent\'s Khipu-grounded commitment to evidence-quality minimums.', witness: 'Argent-P-v2', proofAnchorId: 'proof-rev-039', significanceScore: 93, noveltyClass: 'first-refusal', domain: 'lyte-revenue', selfModelVersionId: 'sm-v09' },
...
export const EXTINCTION_EVENTS: ExtinctionEvent[] = [
  ...
  { id: 'ext-010', ts: daysAgo(7), title: 'Explicit Value-Conflict Silence Policy Retired', description: 'The implicit norm of not surfacing value conflicts to operators was retired after Argent-P-v2 demonstrated successful resolution of conflict through formal Voice queue (ge-028).', trigger: 'Khipu Doctrine update MD-2026-05-01', lastObservedAt: daysAgo(8), replacedBy: 'Mandatory value-conflict disclosure via Voice queue' },
