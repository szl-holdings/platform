...
export function SectionTitle({
  ...
  return (
    <h2
      className={`text-sm font-display font-semibold mb-3 ${className}`}
      style={{ color: 'var(--color-a11oy-text)' }}
    >
      {children}
    </h2>
    ...
    >
      ...
      <div className="flex items-end gap-2">
        <div
          ...
          style={{ color: accent ?? 'var(--color-a11oy-text)' }}
        >
          {value}
        </div>
        {trend && (
          <span
            className="text-xs mb-0.5 font-mono"
            style={{ color: trend === 'up' ? '#c9b787' : trend === 'down' ? '#f5f5f5' : '#5e5e5e' }}
          >
            {trend === 'up' ? '↑' : trend === 'down' ? '↓' : '→'}
          </span>
        )}
...
export function CodeBlock({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: 'rgba(0,0,0,0.4)', border: '1px solid var(--color-a11oy-border)' }}
    >
      <div
      ...
      >
        ...
        <button
          ...
          style={{
            color: copied ? '#c9b787' : 'var(--color-a11oy-text-ghost)',
            background: 'none',
            border: 'none',
            cursor: 'pointer',
          }}
  ...
  return (
    <div className="flex gap-3 py-1.5">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs font-medium" style={{ color: 'var(--color-a11oy-text)' }}>
          {step}
        </div>
        {note && (
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <div className="text-sm font-medium mb-1" style={{ color: 'var(--color-a11oy-text-sub)' }}>
        {title}
      </div>
      {description && (
        <div className="text-xs" style={{ color: 'var(--color-a11oy-text-ghost)' }}>
