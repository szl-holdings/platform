...
**Run:** `2026-05-18_12-03-40`  
**Generated:** 2026-05-18T12:04:08.101Z  
**Total duration:** 27.8s  
...
| P0 | Typecheck | ❌ fail | 27.8s | [`typecheck/`](../evidence/2026-05-18_12-03-40/typecheck/) |
...
### ❌ Typecheck
```
 ERROR  @workspace/ouroboros-anchor#typecheck: command (/home/runner/workspace/packages/ouroboros-anchor) /nix/store/61lr9izijvg30pcribjdxgjxvh3bysp4-pnpm-10.26.1/bin/pnpm run typecheck exited (2)
...
All step output is captured under `artifacts/audit/evidence/2026-05-18_12-03-40/`.  
