...
**Run:** `2026-05-18_12-06-52`  
**Generated:** 2026-05-18T12:07:30.992Z  
**Total duration:** 38.0s  
...
| P0 | Typecheck | ❌ fail | 38.0s | [`typecheck/`](../evidence/2026-05-18_12-06-52/typecheck/) |
...
### ❌ Typecheck
```
 ERROR  @szl-holdings/agent-gateway#typecheck: command (/home/runner/workspace/platform/agent-gateway) /nix/store/61lr9izijvg30pcribjdxgjxvh3bysp4-pnpm-10.26.1/bin/pnpm run typecheck exited (2)
...
All step output is captured under `artifacts/audit/evidence/2026-05-18_12-06-52/`.  
