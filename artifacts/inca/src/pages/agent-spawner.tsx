...
const DOMAIN_TEMPLATES = [
  ...
  },
  {
    ...
    domain: "MSP", systemType: "mama-quilla" as const,
  ...
  {
    id: "creative-dir", name: "Creative Director", icon: Zap, color: "text-violet-400", bg: "bg-violet-400/10",
    description: "Suggests content strategies, optimizes campaigns, and generates creative briefs.",
    defaultInstruction: "Analyze campaign performance, identify content gaps, and generate strategy recommendations based on audience signals.",
    domain: "Dreamscape", systemType: "inti" as const,
    capabilities: ["Campaign optimization", "Content strategy", "Audience analysis", "Creative brief generation"],
  },
  {
...
const LIVE_AGENTS = [
  ...
  { name: "IT Sentinel", domain: "MSP", status: "active", uptime: "7d 2h", actions: 3847, lastAction: "30s ago" },
  { name: "Deal Scout", domain: "Terra", status: "active", uptime: "21d 0h", actions: 892, lastAction: "5m ago" },
  { name: "Creative Director", domain: "Dreamscape", status: "active", uptime: "3d 18h", actions: 445, lastAction: "8m ago" },
