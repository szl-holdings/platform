  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Head-to-head model evaluation on industry-standard benchmarks — accuracy, latency, and throughput profiling</p>
      </div>
