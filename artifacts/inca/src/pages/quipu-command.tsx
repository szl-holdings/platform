...
const ECOSYSTEM_APPS = [
  ...
  { id: "msp", name: "MSP", role: "IT Operations", agent: "IT Sentinel", icon: Cpu, color: "text-blue-400", bg: "bg-blue-400/10", borderColor: "border-blue-400/20" },
  { id: "terra", name: "Terra", role: "Real Estate Intel", agent: "Deal Scout", icon: TrendingUp, color: "text-emerald-400", bg: "bg-emerald-400/10", borderColor: "border-emerald-400/20" },
  { id: "dreamscape", name: "Dreamscape", role: "Creative Engine", agent: "Creative Director", icon: Zap, color: "text-violet-400", bg: "bg-violet-400/10", borderColor: "border-violet-400/20" },
