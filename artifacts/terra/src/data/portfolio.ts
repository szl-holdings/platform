...
export const properties: Property[] = [
  ...
  },
  {
    ...
    sqft: 210000,
    occupancy: 97.2,
    monthlyRevenue: 495000,
    annualNOI: 4120000,
    capRate: 4.9,
    value: 84100000,
    purchasePrice: 71000000,
...
export const tenants: Tenant[] = [
  ...
  },
  {
    id: 't-010',
    propertyId: 'prop-006',
    name: 'Individual Residents',
    unit: '175 Units',
    leaseStart: '2021-04-22',
    leaseEnd: '2026-04-21',
    monthlyRent: 487500,
    status: 'active',
  },
...
export const deals: Deal[] = [
  {
    id: 'deal-001',
    name: 'Sunrise Village Apartments',
    type: 'acquisition',
    stage: 'due-diligence',
    value: 45200000,
    capRate: 5.9,
  ...
  {
    id: 'deal-007',
    name: 'Industrial Portfolio (3 assets)',
    type: 'disposition',
    stage: 'sourcing',
    value: 28700000,
    capRate: 6.5,
...
export const alerts: Alert[] = [
  {
    ...
    type: 'vacancy',
    severity: 'high',
    message: 'Occupancy dropped to 68.4% — 30 units vacant. Immediate leasing strategy needed.',
  ...
  },
  {
    ...
    type: 'vacancy',
    severity: 'high',
    message: 'Retail occupancy at 78.1%. 7 units vacant — consider tenant incentive program.',
  ...
  },
  {
    id: 'a-003',
    propertyId: 'prop-002',
    propertyName: 'Pacific Heights Plaza',
    type: 'lease-expiry',
    severity: 'medium',
    message: 'NovaBio Sciences lease (Floors 8-9) expires Feb 2026. $142K/mo at risk.',
  ...
  },
  {
    ...
    type: 'maintenance',
    severity: 'medium',
    message: 'HVAC system in Building B requires scheduled maintenance — overdue by 15 days.',
  ...
  },
  {
    ...
    type: 'payment',
    severity: 'high',
    message: 'Sterling Design Studio (Unit 4C) — 45 days past due. $6,400 outstanding.',
  ...
  },
  {
    ...
    type: 'lease-expiry',
    severity: 'low',
    message: 'Horizon Tech Labs lease expires May 2026. Early renewal discussions recommended.',
  ...
  },
  {
    ...
    severity: 'low',
    message:
      'Austin multifamily vacancy rates trending up +0.8% QoQ. Monitor competitive positioning.',
  ...
  },
  {
    ...
    type: 'maintenance',
    severity: 'medium',
    message: 'Elevator modernization project — Phase 2 scheduled to begin April 15.',
