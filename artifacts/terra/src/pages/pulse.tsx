...
const EVENT_TYPES = [
  {
    type: 'deal_scored',
    messages: [
      'Industrial portfolio: 87/100 score',
      'Mixed-use opportunity flagged',
      'Cap rate 7.2% — above threshold',
    ],
  },
  {
    type: 'distress_signal',
    messages: [
      'Foreclosure filing: 42 Oak Ave',
      'Tax lien detected: Block 3, Lot 12',
      'Loan maturity approaching: Q3 2026',
    ],
  },
  {
    type: 'market_update',
    messages: [
      'Median price: +3.2% YoY in Sector 7',
      "Inventory down 12% — seller's market",
      'New construction permits: +8% MoM',
    ],
  },
  {
    type: 'comp_analysis',
    messages: [
      '3 comparable sales identified',
      'Price/sqft: $285 — 15% below market',
  ...
  },
  {
    ...
    messages: [
      ...
      'Offer accepted: 123 Main St',
      'Closing scheduled: April 28, 2026',
    ],
  },
];
      ...
      {stages.map((stage) => (
        <div key={stage.name} className="flex items-center gap-3">
          ...
          >
            ...
            />
            <span
              className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] font-bold tabular-nums"
...
export default function TerraPulse() {
  ...
  useEffect(() => {
    const t = setInterval(() => setDealVolume((p) => p + Math.floor(Math.random() * 2)), 5000);
  ...
  return (
    <div className="min-h-screen relative" style={{ background: '#070a10' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <PulseHeader
          title="DOMAINE Market Intelligence"
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] tabular-nums font-medium" style={{ color: '#10b981' }}>
              {dealVolume} deals / mo
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
          ...
          >
            ...
            >
              <TrendingUp className="w-4 h-4" style={{ color: '#10b981' }} /> Deal Pipeline
            </h2>
            <DealPipeline />
          </m.div>
          <m.div
          ...
          >
            <h2
              ...
              style={{ color: 'rgba(255,255,255,0.65)' }}
            >
              <Eye className="w-4 h-4" style={{ color: '#10b981' }} /> Market Intelligence Stream
            </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
          ...
          >
            <h2
              ...
              style={{ color: 'rgba(255,255,255,0.65)' }}
            >
              <Home className="w-4 h-4" style={{ color: '#10b981' }} /> Market Data Flow
            </h2>
            <PulseFlowDiagram
              flows={[
                {
          ...
          >
            <h2
              ...
              style={{ color: 'rgba(255,255,255,0.65)' }}
            >
              <Activity className="w-4 h-4" style={{ color: '#10b981' }} /> Market Health
            </h2>
            <PulseHealthGrid
              items={[
        ...
        <div className="text-center py-4 mt-4">
          ...
          >
            DOMAINE — Real Estate Intelligence — Market Intelligence
          </p>
        </div>
      </div>
    </div>
