...
const PROJECTS: Project[] = [
  {
    ...
    milestones: [
      {
        id: 'm1',
        label: 'Site Demolition & Preparation',
        target: '2024-08-01',
        actual: '2024-07-28',
        status: 'complete',
        pctComplete: 100,
      ...
      {
        id: 'm2',
        label: 'Foundation & Structural Steel (L1–L8)',
        target: '2025-01-15',
        actual: '2025-01-20',
        status: 'complete',
        pctComplete: 100,
        notes: '5-day delay due to weather; recovered through extended shifts',
      },
      {
        id: 'm3',
        label: 'Concrete Deck (L9–L22)',
        target: '2025-06-01',
        actual: '2025-07-14',
        status: 'complete',
        pctComplete: 100,
        notes: 'Concrete supplier change added 43 days; cost impact $480K',
      },
      {
        id: 'm4',
        label: 'MEP Rough-In & Envelope Enclosure',
        target: '2025-10-01',
        status: 'in-progress',
        pctComplete: 78,
        notes: 'HVAC ductwork on L18–L22 awaiting delivery',
      },
      {
        id: 'm5',
        label: 'Interior Framing & Drywall',
        target: '2026-02-01',
        status: 'in-progress',
        pctComplete: 22,
      },
    ...
    budgetLines: [
      {
        category: 'Hard Costs — Structural',
        budget: 14_200_000,
        spent: 14_700_000,
        variance: -500_000,
      },
      ...
      {
        category: 'Hard Costs — Envelope',
        budget: 6_400_000,
        spent: 5_100_000,
        variance: 1_300_000,
      },
      {
        category: 'Hard Costs — Interior',
        budget: 8_200_000,
        spent: 2_100_000,
        variance: 6_100_000,
      },
    ...
    photos: [
      {
        date: '2026-04-08',
        caption: 'MEP rough-in progress on floors 18–22; HVAC main trunk installation 80% complete',
        area: 'Floors 18–22',
        author: 'Site Superintendent R. Castillo',
      },
      {
        date: '2026-03-22',
        caption: 'Interior framing complete on floors 4–12; drywall hanging underway',
        area: 'Floors 4–12',
        author: 'QC Inspector T. Nakamura',
      },
      {
        date: '2026-02-14',
        caption: 'Curtainwall glass installation complete floors 1–18; Level 19+ ongoing',
        area: 'Building Exterior',
        author: 'Project Manager A. Singh',
      },
    ],
  },
  {
    ...
    milestones: [
      {
        id: 'm1',
        label: 'Structural Assessment & Remediation',
        target: '2025-09-01',
        actual: '2025-08-28',
        status: 'complete',
        pctComplete: 100,
      ...
      {
        id: 'm2',
        label: 'Kitchen & Bath Renovation (Units 1–12)',
        target: '2025-12-01',
        actual: '2025-11-30',
        status: 'complete',
        pctComplete: 100,
      ...
      {
        id: 'm4',
        label: 'Rooftop Deck & Amenity Install',
        target: '2026-05-01',
        status: 'in-progress',
        pctComplete: 65,
      },
    ...
    photos: [
      {
        date: '2026-04-05',
        caption: 'Rooftop deck framing 65% complete; steel pergola structure installed',
        area: 'Rooftop Level',
        author: 'Project Manager D. Chen',
      },
      {
        date: '2026-03-10',
        caption: 'Lobby renovation complete — new concierge desk, lighting, flooring',
        area: 'Lobby / Ground Floor',
        author: 'Interior Designer K. Walsh',
      },
    ],
  },
];
...
export default function ConstructionMonitorPage() {
  ...
  const seedMutation = useStandardMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['terra-construction-projects'] });
    },
  });
    ...
    <div className="space-y-4 max-w-[1400px]">
      <div>
        ...
        <p className="text-[10px] font-mono" style={{ color: DS.text.muted }}>
          Milestone timelines · budget vs. actual · photo documentation · portfolio dashboard
          integration
        </p>
      </div>
        ...
        {projects.map((p) => (
          ...
          >
            <div className="flex items-center justify-between mb-1">
              <p className="text-[11px] font-semibold" style={{ color: DS.text.primary }}>
                {p.name}
              </p>
              <span
                ...
                style={{
                  ...
                  background: `${STATUS_CONFIG[p.status].color}12`,
                }}
              >
            ...
            <p className="text-[9px]" style={{ color: DS.text.muted }}>
              {p.overallPct}% complete · {fmt(p.totalBudget)} budget
            </p>
          </button>
        ))}
      </div>
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          ...
          { label: 'Spent to Date', value: fmt(proj.totalSpent), color: DS.accent.gold },
          {
            ...
            color: budgetVariance >= 0 ? DS.accent.green : DS.accent.red,
          },
          {
            label: 'Milestones',
            value: `${completeMilestones}/${proj.milestones.length}`,
            color: DS.accent.blue,
          },
        ].map((m) => (
          <div
          ...
          >
            ...
            {proj.revisedCompletion && (
              <div
                ...
                style={{ color: DS.accent.red }}
              >
                <AlertTriangle className="w-3 h-3" />
                Revised to{' '}
                {new Date(proj.revisedCompletion).toLocaleDateString('en-US', {
                  month: 'short',
                  day: 'numeric',
                  year: 'numeric',
                })}
                ...
                <div key={m.id} className="flex items-start gap-3">
                  <div className="flex flex-col items-center shrink-0 mt-0.5">
                    <div
                      ...
                      style={{
                        borderColor: color,
                        background: m.status === 'complete' ? color : 'transparent',
                      }}
                    >
                      {m.status === 'complete' && (
                    ...
                    {i < proj.milestones.length - 1 && (
                      <div
                        className="w-px flex-1 mt-1"
                        style={{ height: 20, background: DS.border }}
                      />
                    )}
                  </div>
                  <div className="flex-1 min-w-0 pb-2">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[8px] font-bold shrink-0" style={{ color }}>
                        {m.status.replace('-', ' ')}
                      </span>
                    </div>
                    <div className="flex items-center gap-3 mt-0.5">
                      <span className="text-[9px]" style={{ color: DS.text.muted }}>
                        Target:{' '}
                        {new Date(m.target).toLocaleDateString('en-US', {
                          month: 'short',
                          day: 'numeric',
                        })}
                      </span>
                      {m.actual && (
                        <span className="text-[9px]" style={{ color: DS.text.muted }}>
                          Actual:{' '}
                          {new Date(m.actual).toLocaleDateString('en-US', {
                            month: 'short',
                            day: 'numeric',
                          })}
                        </span>
                      ...
                      {m.pctComplete > 0 && m.pctComplete < 100 && (
                        <div className="flex items-center gap-1">
                          <div className="w-16 h-1 rounded-full" style={{ background: DS.border }}>
                            <div
                              className="h-1 rounded-full"
                              style={{ width: `${m.pctComplete}%`, background: color }}
                            />
                          </div>
            ...
            <div className="divide-y" style={{ borderColor: DS.border }}>
              {proj.photos.map((photo, i) => (
                <button
                  ...
                  className="w-full text-left px-4 py-3 hover:bg-white/[0.015] transition-colors"
                >
        ...
        {photoModal && (
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: DS.text.muted }}>
                    {new Date(photoModal.date).toLocaleDateString()} · {photoModal.author}
                  </p>
                </div>
              ...
              <div
                className="rounded-xl h-48 flex items-center justify-center mb-4"
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-xs" style={{ color: DS.text.muted }}>
                    Photo documentation
                  </p>
                  <p className="text-[9px] mt-0.5" style={{ color: DS.text.muted }}>
                    Attach via site upload portal
                  </p>
                </div>
              </div>
              <p className="text-xs leading-relaxed" style={{ color: DS.text.secondary }}>
                {photoModal.caption}
              </p>
            </motion.div>
          </motion.div>
