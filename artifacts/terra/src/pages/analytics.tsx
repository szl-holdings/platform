...
const valueByType = (() => {
  ...
  properties.forEach((p) => {
    vals[p.type] = (vals[p.type] || 0) + p.value;
  });
...
const kpiCards = [
  {
    ...
    value: formatCurrency(portfolioSummary.totalMonthlyRevenue * 12),
    change: '+8.4%',
    up: true,
    icon: DollarSign,
    accent: '#3b82f6',
  ...
  {
    label: 'Annual NOI',
    value: formatCurrency(portfolioSummary.totalAnnualNOI),
    change: '+6.1%',
    up: true,
    icon: TrendingUp,
    accent: '#10b981',
  ...
  {
    label: 'Total Sq Ft',
    value: `${(portfolioSummary.totalSqft / 1e6).toFixed(2)}M`,
    change: '+0%',
    up: true,
    icon: Building2,
    accent: '#f59e0b',
  ...
  {
    label: 'Total Units',
    value: portfolioSummary.totalUnits.toString(),
    change: '+0%',
    up: true,
    icon: Users,
    accent: '#8b5cf6',
    ...
    <div className="p-6 space-y-6 overflow-auto">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-sm text-terra-text-secondary mt-1">
          Deep-dive time-series analysis of portfolio performance metrics
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {kpiCards.map((item, i) => (
          <motion.div
            ...
            style={{
              background: `radial-gradient(ellipse at top left, ${item.accent}10 0%, rgba(255,255,255,0.015) 60%)`,
          ...
          >
            <div
              style={{
                ...
                right: 0,
                height: '2px',
                background: `linear-gradient(90deg, ${item.accent}70, transparent)`,
              }}
            />
            <div className="flex items-center justify-between mb-3">
              ...
              <span
                className={cn(
                  ...
                  item.up ? 'text-terra-emerald' : 'text-terra-rose',
                )}
              >
                {item.up ? (
            ...
            <p className="text-xl font-display font-bold" style={{ color: item.accent }}>
              {item.value}
            </p>
          </motion.div>
        ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <motion.div
          ...
          className="rounded-xl border border-terra-border bg-terra-surface/50 p-5 relative overflow-hidden"
        >
          <div
            style={{
              position: 'absolute',
              ...
              right: 0,
              height: '2px',
              background: 'linear-gradient(90deg, #3b82f660, transparent)',
            }}
          />
      ...
      >
        <div
          style={{
            ...
            right: 0,
            height: '2px',
            background: 'linear-gradient(90deg, #8b5cf660, #3b82f640, transparent)',
          }}
        />
