import { fetchRiskRunEvidence, type SavedRiskRun } from '@szl-holdings/shared-ui/risk-evidence';
...
import { portfolioSummary, properties, revenueHistory } from '@/data/portfolio';
...
const LP_INVESTORS = [
  {
    name: 'Sovereign Capital Partners',
    commitment: 45000000,
    deployed: 38000000,
    distributions: 12400000,
    netIRR: 19.2,
    moic: 1.68,
    tier: 'Anchor LP',
    status: 'current',
  ...
  {
    name: 'Pacific Pension Trust',
    commitment: 30000000,
    deployed: 26000000,
    distributions: 7800000,
    netIRR: 17.4,
    moic: 1.52,
    tier: 'Major LP',
    status: 'current',
...
const LENDERS = [
  ...
  },
  {
    ...
    property: 'Pacific Heights Plaza',
    balance: 63800000,
    maturity: '2027-03-20',
    ltv: '59%',
    dscr: '1.22x',
  ...
  },
  {
    ...
    property: 'Summit Industrial Park',
    balance: 22500000,
    maturity: '2027-09-05',
    ltv: '55%',
    dscr: '1.74x',
...
const COVENANT_STATUS = [
  {
    name: 'DSCR Minimum (1.20x)',
    status: 'watch',
    detail: 'Skyline Lofts at 0.94x — below threshold',
    property: 'prop-007',
  },
  {
    name: 'LTV Maximum (75%)',
    status: 'watch',
    detail: 'Skyline Lofts at 78% LTV — above threshold',
    property: 'prop-007',
  },
  {
    name: 'Occupancy Floor (85%)',
    status: 'breach',
    detail: 'Skyline Lofts at 68.4% — material breach',
    property: 'prop-007',
  },
  { name: 'Debt Service Reserve (3 mo)', status: 'current', detail: 'All properties compliant' },
  {
    ...
    status: 'current',
    detail: 'All properties compliant — renewed Q1 2026',
  },
  {
    name: 'Reporting Covenants (quarterly)',
    status: 'current',
    detail: 'Q4 2025 report delivered Jan 15, 2026',
  },
];
...
async function collectTerraCitedRuns(): Promise<SavedRiskRun[]> {
  const lists = await Promise.all(
    TERRA_EVIDENCE_DOMAINS.map((d) => fetchRiskRunEvidence(d).catch(() => [])),
  );
...
export default function LenderReportPage() {
  ...
  return (
    <div className="space-y-4 overflow-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          },
          {
            ...
            value: formatCurrency(DISTRIBUTIONS[0].amount),
            sub: 'Q1 2026',
            color: '#f59e0b',
          },
        ].map((m, i) => (
      ...
      <div
        className="flex gap-1 border-b flex-wrap"
      ...
      {activeTab === 'executive' && (
        ...
        >
          ...
          >
            ...
            <div
              className="prose-style space-y-3 text-sm leading-relaxed"
              style={{ color: 'rgba(255,255,255,0.6)' }}
            >
              <p>
                The SZL Holdings real estate portfolio closed Q1 2026 with{' '}
                <strong className="text-white/80">$454.1M in total asset value</strong> across 8
                properties spanning multifamily, office, industrial, retail, and mixed-use asset
                classes. Portfolio-wide occupancy averaged{' '}
                <strong className="text-white/80">88.0%</strong>, with 6 of 8 assets classified as
                "Performing" and two flagged for active monitoring.
              </p>
              <p>
                <strong className="text-white/80">Portfolio NOI for the trailing 12 months</strong>{' '}
                totaled approximately <strong className="text-white/80">$25.8M</strong>, with the
                top-performing asset, Harborview Residences (Boston), generating a 97.2% occupancy
                rate and 4.9% cap rate yield. The portfolio's weighted average cap rate is{' '}
                <strong className="text-white/80">5.93%</strong>, in line with institutional
                benchmarks for the current rate environment.
              </p>
              <div
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="font-semibold" style={{ color: '#f59e0b' }}>
                      Watch Item: Skyline Lofts (Chicago, IL)
                    </p>
                    <p className="text-[11px] mt-1" style={{ color: 'rgba(255,255,255,0.5)' }}>
                      Occupancy at 68.4%, DSCR at 0.94x (below 1.0x covenant floor), and a loan
                      maturity of September 14, 2026 represent the most material risk exposure in
                      the portfolio. Capital markets is actively engaged on refinance and/or
                      maturity extension. Leasing incentive program initiated April 2026.
                    </p>
                  </div>
                </div>
              </div>
              <p>
                Distributions of <strong className="text-white/80">$3.2M</strong> were made on March
                15, 2026 ($0.58/unit), consistent with the prior three quarters. Total LP capital
                distributions since fund inception stand at{' '}
                <strong className="text-white/80">{formatCurrency(totalDistributed)}</strong> across
                all investor accounts. No material covenant breaches have been reported for the
                performing portfolio; Skyline Lofts occupancy covenant is under cure protocol.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            >
              <h4 className="text-sm font-bold text-white mb-4">
                Portfolio NOI — Trailing 12 Months
              </h4>
              <div className="h-52">
            ...
            >
              <h4 className="text-sm font-bold text-white mb-4">
                Capital Allocation by Asset Type
              </h4>
              <div className="h-52">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {[
                {
                  severity: 'critical',
                  title: 'Loan Maturity Concentration',
                  desc: 'Skyline Lofts loan matures Sept 2026. DSCR sub-1.0 constrains refi options. Extension in negotiation.',
                },
                {
                  severity: 'high',
                  title: 'Vacancy — Two Assets',
                  desc: 'Skyline Lofts (68.4%) and The Atrium (78.1%) are below occupancy thresholds. Combined revenue impact: ~$220K/mo.',
                },
                {
                  severity: 'medium',
                  title: 'Office Market Softness',
                  desc: 'Pacific Heights Plaza and Greenfield Office Campus face lease renewal pressure as hybrid work trends persist. NovaBio lease expires Feb 2026.',
                },
              ].map((r, i) => {
                const c =
                  r.severity === 'critical'
      ...
      {activeTab === 'portfolio' && (
        ...
        >
              ...
              <table className="w-full text-xs">
                  ...
                  {properties.map((p) => {
                    ...
                    return (
                      <tr key={p.id} className="hover:bg-white/[0.01] transition-colors">
                        <td className="px-4 py-3">
                          <div>
                            ...
                            <p className="text-[10px]" style={{ color: 'rgba(255,255,255,0.3)' }}>
                              {p.units} units · {(p.sqft / 1000).toFixed(0)}K sqft
                            </p>
                          </div>
                        </td>
                        <td
                        ...
                        <td className="px-4 py-3 font-semibold" style={{ color: '#c8a060' }}>
                          {formatCurrency(p.value)}
                        </td>
                        <td className="px-4 py-3 font-semibold text-white/70">
                          {formatCurrency(p.annualNOI)}
                        </td>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              <div
                                ...
                                style={{ width: `${p.occupancy}%`, background: statusColor }}
                              />
                            </div>
                            <span
                ...
                <tfoot>
                  <tr style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                    <td className="px-4 py-3 font-bold text-white/80" colSpan={3}>
                      Portfolio Total
                    </td>
                    <td className="px-4 py-3 font-bold" style={{ color: '#c8a060' }}>
                      {formatCurrency(portfolioSummary.totalValue)}
                    </td>
                    <td className="px-4 py-3 font-bold text-white/70">
                      {formatCurrency(portfolioSummary.totalAnnualNOI)}
                    </td>
                    <td className="px-4 py-3 font-bold text-white/70">
                      {portfolioSummary.avgCapRate.toFixed(1)}%
                    </td>
                    <td className="px-4 py-3 font-bold text-white/70">
                      {portfolioSummary.avgOccupancy.toFixed(1)}%
                    </td>
                    <td className="px-4 py-3" />
                  </tr>
                </tfoot>
          ...
          >
            <h4 className="text-sm font-bold text-white mb-4">
              Revenue vs NOI — Trailing 12 Months
            </h4>
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y" style={{ borderColor: 'rgba(255,255,255,0.03)' }}>
                  {LENDERS.map((l, i) => {
                    ...
                    const monthsToMaturity =
                      (maturityDate.getTime() - new Date('2026-04-02').getTime()) /
                      (1000 * 60 * 60 * 24 * 30);
                      ...
                      <tr key={i} className="hover:bg-white/[0.01] transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={cn(
                              'font-semibold',
                              maturityUrgent ? 'text-rose-400' : 'text-white/60',
                            )}
                          >
                            {new Date(l.maturity).toLocaleDateString('en-US', {
                              month: 'short',
                              day: 'numeric',
                              year: 'numeric',
                            })}
                            {maturityUrgent && (
                              <span className="ml-1 text-[9px] font-bold bg-rose-500/15 text-rose-400 px-1 py-0.5 rounded">
                                URGENT
                              </span>
                            )}
                          </span>
                ...
                <tfoot>
                  <tr style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                    <td className="px-4 py-3 font-bold text-white/80" colSpan={2}>
                      Total Portfolio Debt
                    </td>
                    <td className="px-4 py-3 font-bold font-mono" style={{ color: '#c8a060' }}>
              ...
              <table className="w-full text-xs">
                ...
                <tfoot>
                  <tr style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                    ...
                    <td className="px-4 py-3 font-mono font-bold text-white/60">
                      {formatCurrency(LP_INVESTORS.reduce((s, i) => s + i.deployed, 0))}
                    </td>
                    <td className="px-4 py-3 font-mono font-bold" style={{ color: '#10b981' }}>
                      {formatCurrency(totalDistributed)}
                    </td>
                    <td className="px-4 py-3 font-mono font-bold" style={{ color: '#40856a' }}>
                      {(
                        LP_INVESTORS.reduce((s, i) => s + i.netIRR, 0) / LP_INVESTORS.length
                      ).toFixed(1)}
                      %
                    </td>
                    <td className="px-4 py-3 font-mono font-bold" style={{ color: '#40856a' }}>
                      {(LP_INVESTORS.reduce((s, i) => s + i.moic, 0) / LP_INVESTORS.length).toFixed(
                        2,
                      )}
                      x
                    </td>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-white text-sm">
                  Covenant Compliance — {reportPeriod}
                </h3>
              </div>
              <div
