    ...
    <div className="p-6 space-y-6 overflow-auto">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-2xl font-display font-bold text-terra-text">Nimbus Intelligence</h1>
        </div>
      ...
      <div className="flex items-center gap-2 px-4 py-3 rounded-xl border border-violet-500/30 bg-violet-500/10">
        ...
        <p className="text-xs text-violet-300">
          <span className="font-semibold">Nimbus Explainability Standard:</span> Every AI output below includes probability, confidence score, rationale, assumptions, risk factors, and a specific recommended next action with owner and due date.
        </p>
      </div>
