            ...
            <div className="flex items-start justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <div className="flex gap-1.5">
                  ...
                  <a href="/alloy/" className="text-[9px] px-2 py-1 rounded font-medium hover:opacity-80 transition-opacity" style={{ color: "#00d4ff", background: "rgba(0,212,255,0.1)", border: "1px solid rgba(0,212,255,0.2)" }}>Run in AlloyScape</a>
                </div>
              </div>
            </div>
