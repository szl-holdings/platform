...
const ESTIMATES: CostEstimate[] = [
  {
    ...
    breakdown: [
      {
        ...
        description: 'Structural concrete, rebar, formwork',
        costPerSqft: 62,
        total: 11470000,
        pctOfHard: 16.1,
      },
      {
        division: '05 — Steel',
        description: 'Structural steel, misc metals, connections',
        costPerSqft: 48,
        total: 8880000,
        pctOfHard: 12.5,
      },
      {
        ...
        description: 'Waterproofing, insulation, roofing',
        costPerSqft: 22,
        total: 4070000,
        pctOfHard: 5.7,
      },
      {
        ...
        description: 'Curtain wall, windows, storefronts, doors',
        costPerSqft: 38,
        total: 7030000,
        pctOfHard: 9.9,
      },
      {
        ...
        description: 'Drywall, flooring, paint, ceilings',
        costPerSqft: 45,
        total: 8325000,
        pctOfHard: 11.7,
      },
      {
        ...
        description: 'Elevators (4 passenger + 1 freight)',
        costPerSqft: 18,
        total: 3330000,
        pctOfHard: 4.7,
      },
      ...
      },
      {
        ...
        description: 'Excavation, shoring, dewatering',
        costPerSqft: 15,
        total: 2775000,
        pctOfHard: 3.9,
      },
      {
        ...
        description: 'Landscaping, hardscape, site utilities',
        costPerSqft: 12,
        total: 2220000,
        pctOfHard: 3.1,
      },
      {
        division: 'Other',
        description: 'General conditions, insurance, permits, fees',
        costPerSqft: 30,
        total: 5550000,
        pctOfHard: 7.8,
      },
    ...
    materialTrends: [
      {
        material: 'Structural Steel (W-shapes)',
        currentPrice: '$1,420/ton',
        yoyChange: -8.2,
        trend: 'down',
        supplyStatus: 'normal',
      },
      ...
      {
        material: 'Rebar (#4-#11)',
        currentPrice: '$0.78/lb',
        yoyChange: -3.1,
        trend: 'down',
        supplyStatus: 'normal',
      },
      {
        material: 'Copper Wire (THHN)',
        currentPrice: '$4.85/lb',
        yoyChange: 12.3,
        trend: 'up',
        supplyStatus: 'tight',
      },
      {
        material: 'Lumber (2x4 SPF)',
        currentPrice: '$428/MBF',
        yoyChange: -15.6,
        trend: 'down',
        supplyStatus: 'normal',
      },
      ...
      {
        material: 'PVC Pipe (4")',
        currentPrice: '$8.50/ft',
        yoyChange: -1.2,
        trend: 'flat',
        supplyStatus: 'normal',
      },
      {
        material: 'Transformer (750kVA)',
        currentPrice: '$42,000/ea',
        yoyChange: 28.5,
        trend: 'up',
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-2xl font-semibold tracking-tight text-white">
            Cost Estimation & Material Trends
          </h1>
          <p className="mt-1 text-sm text-white/40">
            Real-time construction cost estimation, material price tracking, and Monte Carlo
            timeline simulation.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 mb-8">
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <div className="text-xs text-white/40 mt-1">
                {est.location} · {est.buildingType} · {est.grossSqft.toLocaleString()} SF ·{' '}
                {est.stories} stories
              </div>
            </div>
            <span
              ...
              style={{
                background: `${FINISH_COLORS[est.finishLevel]}15`,
                color: FINISH_COLORS[est.finishLevel],
              }}
            >
              {est.finishLevel}
            </span>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              {
                label: 'Hard Costs',
                value: fmt(est.totalHardCost),
                sub: `$${est.costPerSqft}/SF`,
                color: '#60a5fa',
              },
              {
                label: 'Soft Costs',
                value: fmt(est.totalSoftCost),
                sub: `${Math.round((est.totalSoftCost / est.totalHardCost) * 100)}% of hard`,
                color: '#a78bfa',
              },
              {
                label: 'Contingency',
                value: fmt(est.contingency),
                sub: `${((est.contingency / est.totalCost) * 100).toFixed(1)}%`,
                color: '#fbbf24',
              },
              {
                label: 'Timeline',
                value: `${est.timelineMonths} mo`,
                sub: `P10: ${est.timelineP10} · P90: ${est.timelineP90}`,
                color: '#34d399',
              },
            ].map((m) => (
              <div
            ...
            <div className="space-y-2">
              {est.breakdown.map((item) => (
                <button
                  key={item.division}
                  onClick={() =>
                    setSelectedDivision(item.division === selectedDivision ? null : item.division)
                  }
                  className={cn(
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1 h-1.5 rounded-full bg-white/[0.06]">
                      <m.div
                        ...
                        style={{ background: '#2d6a4f', width: `${item.pctOfHard}%` }}
                      />
                    </div>
                  ...
                  <div className="text-[10px] text-white/30 mt-1">
                    {item.description} · ${item.costPerSqft}/SF
                  </div>
                </button>
              ))}
            </div>
                ...
                >
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/[0.08] bg-black/20">
                    {mt.trend === 'up' ? (
                      ...
                      <ArrowDownRight className="h-3.5 w-3.5" style={{ color: '#34d399' }} />
                    ) : (
                  ...
                  <div className="text-right">
                    <div
                      ...
                      style={{
                        color:
                          mt.yoyChange > 0 ? '#ef4444' : mt.yoyChange < 0 ? '#34d399' : '#fbbf24',
                      }}
                    >
                      {mt.yoyChange > 0 ? '+' : ''}
                      {mt.yoyChange}%
                    ...
                    <span
                      ...
                      style={{
                        background:
                          mt.supplyStatus === 'normal'
                            ? '#34d39910'
                            : mt.supplyStatus === 'tight'
                              ? '#fbbf2410'
                              : '#ef444410',
                        color:
                          mt.supplyStatus === 'normal'
              ...
              <div className="space-y-2.5">
                {est.marketFactors.map((mf) => (
                  <div key={mf.factor} className="flex items-center justify-between">
                    ...
                    <span
                      ...
                      style={{
                        color:
                          mf.adjustment > 0 ? '#ef4444' : mf.adjustment < 0 ? '#34d399' : '#fbbf24',
                      }}
                    >
                      {mf.adjustment > 0 ? '+' : ''}
                      {mf.adjustment}%
                ...
                <div className="border-t border-white/[0.06] pt-2 mt-2 flex items-center justify-between">
                  ...
                  <span
                    ...
                    style={{
                      color:
                        est.marketFactors.reduce((s, f) => s + f.adjustment, 0) > 0
                          ? '#ef4444'
                          : '#34d399',
                    }}
                  >
                    {est.marketFactors.reduce((s, f) => s + f.adjustment, 0) > 0 ? '+' : ''}
                    {est.marketFactors.reduce((s, f) => s + f.adjustment, 0).toFixed(1)}%
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-white/35 mt-0.5">
                    10,000 iterations simulated across weather delays, permit cycles, material lead
                    times, and labor availability. P50 estimate: {est.timelineMonths} months. 80%
                    confidence interval: {est.timelineP10}–{est.timelineP90} months. Key risk
                    drivers: electrical transformer lead time (18+ weeks) and concrete crew
                    availability.
                  </p>
                </div>
              </div>
