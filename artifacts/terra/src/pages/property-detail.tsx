...
import {
  ArrowLeft, Building2, MapPin, Users, DollarSign, TrendingUp, Calendar, Wrench, User, AlertTriangle, Download, Loader2, CheckCircle, Clock, FileText, Shield, Activity, Target, Tag, LayoutDashboard, Thermometer, Layers, Calculator, Eye, BarChart3, Brain, ChevronRight, Flame
} from "lucide-react";
          ...
          <div className="rounded-xl p-5" style={{ background: "rgba(239,68,68,0.04)", border: "1px solid rgba(239,68,68,0.15)" }}>
            ...
            {!whyNowLoading && whyNowError && whyNowError !== "not-found" && (
              <div className="rounded-lg p-4 text-center" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <button
                  onClick={() => { setWhyNowError(null); setWhyNowData(null); }}
                ...
                <>
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] leading-relaxed line-clamp-2" style={{ color: "rgba(255,255,255,0.5)" }}>
                        {d.dealNarrative}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-4 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                    <p className="text-[9px]" style={{ color: "rgba(255,255,255,0.25)" }}>
                      Computed {new Date(d.computedAt).toLocaleString()} · HPD · ACRIS · ECB · DOB · DOF
