            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>
                  Add MAPBOX_ACCESS_TOKEN to enable the property map
                </p>
              </div>
            </div>
          )
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    <p className="text-[11px] font-mono font-bold" style={{ color: '#c8a060' }}>
                      {formatCurrency(prop.value)}
                    </p>
                    <p className="text-[9px] mt-0.5" style={{ color: 'rgba(255,255,255,0.3)' }}>
                      {prop.occupancy}% occ · {prop.capRate}% cap
                    </p>
                  </div>
                  <Link href={`/property/${prop.id}`}>
                    <button
                      className="shrink-0 text-[10px] px-2.5 py-1.5 rounded-lg border transition-all hover:bg-white/5"
