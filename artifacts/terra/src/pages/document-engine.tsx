    ...
    <div className="flex flex-col h-full overflow-hidden">
      <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} className="flex-shrink-0">
        <div className="flex items-center gap-3 px-6 pt-6 pb-0">
          <div className="w-8 h-8 rounded-xl" style={{ background: "rgba(160,120,72,0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <BookOpen className="w-4 h-4" style={{ color: "#c8a060" }} />
          </div>
          <div>
            <h1 className="text-xl font-display font-bold text-white">Document Engine</h1>
            <p className="text-xs text-white/40">Deal memos, property reports, contracts, and e-signatures</p>
          </div>
        </div>
