  ...
  const causalChains = [
    {
      ...
      runs: goldenFlowRuns,
      summary: "Approval SLA breach triggered by legal team capacity pressure during Q1 close, predicted by Nimbus, rerouted by AlloyScape, now on recovery path.",
    },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.4)" }}>Root factors traced end-to-end across Beacon detections, Lyte actions, Nimbus predictions, and AlloyScape execution runs.</p>
      </div>
          ...
          <div className="p-5 space-y-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-semibold text-white">Nimbus Predictions</span>
                <span className="text-[9px] px-1.5 py-0.5 rounded font-bold" style={{ color: "#8b5cf6", background: "rgba(139,92,246,0.15)" }}>DECIDE</span>
                <a href="/dreamscape/" className="ml-auto text-[9px] flex items-center gap-1 hover:opacity-80" style={{ color: "#8b5cf6" }}><ExternalLink className="w-3 h-3" /> Open in Nimbus</a>
              </div>
              <div className="space-y-2 ml-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-semibold text-white">AlloyScape Execution Runs</span>
                <span className="text-[9px] px-1.5 py-0.5 rounded font-bold" style={{ color: "#00d4ff", background: "rgba(0,212,255,0.15)" }}>EXECUTE</span>
                <a href="/alloy/" className="ml-auto text-[9px] flex items-center gap-1 hover:opacity-80" style={{ color: "#00d4ff" }}><ExternalLink className="w-3 h-3" /> Open in AlloyScape</a>
              </div>
              <div className="space-y-2 ml-4">
                {chain.runs.map(r => (
