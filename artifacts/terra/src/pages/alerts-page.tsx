    ...
    <div className="p-6 space-y-6 overflow-auto">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-sm text-terra-text-secondary mt-1">
          Properties requiring attention — vacancies, lease expirations, maintenance, and payment
          issues
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <motion.div
          ...
          className="p-4 rounded-xl border border-terra-border bg-terra-surface/50 flex items-center gap-3"
        >
