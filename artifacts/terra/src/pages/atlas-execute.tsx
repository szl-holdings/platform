      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-[11px] mt-0.5" style={{ color: 'rgba(255,255,255,0.35)' }}>
            Ingest property signals, trigger deal underwriting workflows, and manage approval gates
          ...
          <div className="flex-1">
            ...
            <div className="text-[11px] text-white mb-1">
              {pendingApproval.reason ??
                'This deal requires underwriting review before the commitment workflow continues.'}
            </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <div className="text-[9px] leading-relaxed" style={{ color: 'rgba(255,255,255,0.35)' }}>
              Select property signals, then{' '}
              <strong className="text-white">Run Underwriting Workflow</strong> to trigger the deal
              thesis, underwriting, and legal review pipeline. Deals ≥ $5M and distressed assets
