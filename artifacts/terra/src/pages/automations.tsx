    ...
    <div className="p-6 space-y-6 overflow-auto">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-2xl font-display font-bold text-terra-text">AlloyScape Automation</h1>
        </div>
          ...
          {failed.length === 0 ? (
            ...
            <>
              <div className="flex items-center gap-2 px-4 py-3 rounded-lg bg-terra-surface border border-terra-border">
                ...
                <p className="text-xs text-terra-text-secondary">AlloyScape retries failed automations automatically. Override or manually retry below. All overrides are logged to the audit trail.</p>
              </div>
              {failed.map(run => (
