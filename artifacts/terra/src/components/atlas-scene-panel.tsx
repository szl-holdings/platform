import { Activity, Building2, Clock, ShieldAlert, TrendingUp } from 'lucide-react';
        ...
        {tab === 'location' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            >
              ...
              >
                Market value{' '}
                <strong style={{ color: 'rgba(255,255,255,0.8)' }}>{p.marketValue}</strong> · last
                sale {p.lastSale}
              </span>
            </div>
          </div>
        ...
        {tab === 'risk' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            >
              ...
              >
                Composite risk <strong style={{ color: '#fbbf24' }}>0.46 / MEDIUM</strong> — tenant
                renewal negotiation flagged for Counsel review
              </span>
            </div>
          </div>
        )}
