  ...
  return (
    <div className="flex h-full overflow-hidden">
            ...
            return (
              ...
              >
                ...
                {item.phase === 'VERIFY' && isActive && (
                  <span
                    className="ml-auto text-[8px] px-1 py-0.5 rounded font-bold uppercase"
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header
          className="h-12 border-b flex items-center justify-between px-4 md:px-6 shrink-0 z-10"
          style={{
        ...
        >
          <div className="flex items-center gap-3 text-xs font-mono">
            ...
            <span className="hidden sm:block" style={{ color: '#f59e0b' }}>
              $4.02M at risk
            </span>
          </div>
