      ...
      <aside className="w-56 border-r flex flex-col shrink-0 relative z-20" style={{ borderColor: "rgba(255,255,255,0.06)", background: "rgba(8,12,20,0.95)" }}>
        ...
        <div className="p-3 border-t" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
          ...
          <div className="flex gap-1 mt-2">
            ...
            <a href="/dreamscape/" className="text-[9px] px-1.5 py-0.5 rounded font-medium hover:opacity-80 transition-opacity" style={{ color: "#8b5cf6", background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.2)" }}>NIMBUS</a>
