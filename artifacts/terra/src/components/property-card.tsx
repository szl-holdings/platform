...
import { AlertTriangle, Building2, DollarSign, MapPin, TrendingUp, Users } from 'lucide-react';
          ...
          <div className="p-5">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-display font-bold text-terra-text group-hover:text-terra-primary transition-colors">
                    {property.name}
                  </h3>
              ...
              <div
                className={cn(
                  ...
                  property.status === 'critical'
                    ? 'bg-terra-rose/5 text-terra-rose'
                    : 'bg-terra-amber/5 text-terra-amber',
                )}
              >
            ...
            <div className="mt-3 pt-3 border-t border-terra-border flex items-center justify-between text-[10px] text-terra-text-muted">
              <span>
                {property.units} units · {formatNumber(property.sqft)} sqft
              </span>
