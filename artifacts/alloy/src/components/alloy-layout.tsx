      ...
      <aside className="w-56 border-r flex flex-col shrink-0" style={{ borderColor: "rgba(255,255,255,0.06)", background: "rgba(8,12,20,0.95)" }}>
        ...
        <div className="p-3 border-t" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
          ...
          <div className="flex gap-1">
            ...
            <a href="/dreamscape/" className="text-[9px] px-1.5 py-0.5 rounded font-medium hover:opacity-80" style={{ color: "#8b5cf6", background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.2)" }}>NIMBUS</a>
          </div>
        </div>
      </aside>
        ...
        <header className="h-12 border-b flex items-center justify-between px-6 shrink-0" style={{ borderColor: "rgba(255,255,255,0.05)", background: "rgba(8,12,20,0.8)", backdropFilter: "blur(8px)" }}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold border" style={{ background: "linear-gradient(135deg, #00d4ff, #0090cc)", borderColor: "rgba(255,255,255,0.1)" }}>EU</div>
            </div>
          </div>
        </header>
