...
import { Activity, AlertTriangle, ArrowUpRight, Bell, Clock, ShieldAlert } from 'lucide-react';
...
const alerts: CounselAlert[] = [
  {
    ...
    detail:
      'Morrison & Vance has not produced responsive documents. Missed deadline now blocks the regulatory filing chain.',
  ...
  },
  {
    ...
    matter: matterTwins[0]?.name,
    detail:
      'Upstream blocker (Draft Regulatory Report) cannot complete in time without external counsel reassignment.',
    triggeredAt: hoursAgo(4),
    confidence: 0.92,
    recommendedAction:
      'Re-route Draft Regulatory Report to Sterling & Ross for parallel completion.',
  },
  {
    id: 'alert-003',
    severity: 'high',
  ...
  },
  {
    ...
    detail:
      'Fenwick LLP confirms on-track; one inter-region clarification pending from EU privacy lead.',
    triggeredAt: hoursAgo(12),
    confidence: 0.74,
    recommendedAction:
      'Confirm EU lead availability; auto-draft clarification request from prior memo.',
  },
  {
    id: 'alert-005',
    severity: 'medium',
    ...
    detail:
      '12 newly produced documents lack matching privilege classifications versus baseline policy.',
