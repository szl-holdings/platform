        ...
        <div className="relative z-10 max-w-4xl text-center">
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <span className="text-sm font-medium text-violet-300/60">
              Counsel Legal Matter Command · Powered by Alloy
            </span>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={feature.title}
                className="bg-[#120a24]/80 border border-violet-500/10 rounded-xl p-5 hover:border-violet-500/25 transition-all"
              >
      ...
      <section className="px-6 py-20 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {CORE_VIEWS.map((view) => (
            <div
              key={view.title}
              className="bg-[#120a24]/80 border border-violet-500/10 rounded-xl p-6"
            >
          ...
          <div className="bg-[#120a24]/90 border border-violet-500/15 rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-5 py-3 border-b border-violet-500/10 bg-[#1a0e30]/60">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-mono uppercase tracking-widest text-violet-300/70">
                  Live · Exposure Desk
                </span>
              </div>
            ...
            <div className="divide-y divide-violet-500/5">
              {EXPOSURE_DEMO.map((row) => (
                <div key={row.matter} className="grid grid-cols-12 gap-3 items-center px-5 py-3.5">
                  <div className="col-span-4 text-[12px] text-violet-100/85 leading-snug">
                    {row.matter}
                  </div>
                  <div className="col-span-2 text-right text-[12px] font-mono text-violet-200/85">
                    {row.exposure}
                  </div>
