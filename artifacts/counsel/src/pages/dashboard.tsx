...
import { Briefcase, Clock, Scale, ShieldAlert } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      <header>
        ...
        <p className="text-violet-400/60 text-sm">
          Real-time legal obligation and risk monitoring.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-violet-500/5 border border-violet-500/10 p-4 rounded-xl">
          ...
          <div className="text-[10px] text-violet-400/50 mt-1">
            {atRiskMatters} currently at risk
          </div>
        </div>
        ...
        <div className="bg-violet-500/5 border border-violet-500/10 p-4 rounded-xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs font-medium text-violet-300/70 uppercase">
              Overdue Obligations
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="text-xs font-bold text-red-400">
                      ${(m.exposureUsd / 1000000).toFixed(1)}M Exposure
                    </div>
        ...
        <div className="bg-[#0a0614] border border-violet-500/10 rounded-xl p-5">
          ...
          <div className="space-y-3">
            {obligationTwins
              .filter((o) => o.status === 'overdue' || o.status === 'blocked')
              .map((o) => (
                <div
                  key={o.id}
                  className="flex items-center justify-between p-3 rounded-lg bg-violet-500/5 border border-violet-500/10"
                >
                  <div>
                    ...
                    <div className="text-[10px] text-violet-400/60 mt-0.5">
                      {o.status.toUpperCase()} — {o.assignedTo}
                    </div>
                  </div>
                  <span
                    className={cn(
