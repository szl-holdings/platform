...
const SLIDES = [
  {
    ...
    subtitle:
      "Discover off-market properties before they hit the market. AI-powered scanner identifies opportunities across every asset class.",
    accent: "#B8943C",
  },
  {
    icon: "zap" as const,
    ...
    subtitle:
      "Get push notifications the moment a property matching your criteria hits the pipeline. Never miss a high-value opportunity.",
    accent: "#D4A853",
  },
  {
    ...
    subtitle:
      "Manage your entire acquisition pipeline from offer to close. Track status, due diligence, and financing all in one place.",
    accent: "#C9A060",
  },
];
    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom + 24 }]}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.nextButton} onPress={handleNext}>
          ...
          <Feather name={isLast ? "check" : "arrow-right"} size={18} color="#0d0b08" />
        </TouchableOpacity>
      </View>
    </View>
  );
