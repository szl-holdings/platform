...
export default function ProfileScreen() {
  ...
  const handleLogout = () => {
    Alert.alert(
      "Sign Out",
      "Are you sure you want to sign out of Vessels?",
      [
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.bg }]} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.avatarSection, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={{ flex: 1 }}>
            ...
            {user?.roles && user.roles.length > 0 && (
              <View style={[styles.roleBadge, { backgroundColor: colors.primaryDim, borderColor: colors.primaryBorder }]}>
        ...
        <SectionCard title="MARITIME INTELLIGENCE">
          <View style={[styles.capabilityRow, { borderBottomColor: colors.border }]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.capDesc, { color: colors.textFaint }]}>AIS blackout anomaly alerts via WebSocket</Text>
            </View>
          ...
          <View style={[styles.capabilityRow, { borderBottomColor: colors.border }]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.capDesc, { color: colors.textFaint }]}>OFAC & EU list monitoring with R/Y/G indicators</Text>
            </View>
            <View style={[styles.capStatus, { backgroundColor: colors.greenDim }]}>
              <Text style={[styles.capStatusText, { color: colors.green }]}>Active</Text>
            </View>
          ...
          <View style={[styles.capabilityRow, { borderBottomColor: colors.border }]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.capDesc, { color: colors.textFaint }]}>Critical alert push via expo-notifications</Text>
            </View>
            <View style={[styles.capStatus, { backgroundColor: colors.greenDim }]}>
              <Text style={[styles.capStatusText, { color: colors.green }]}>Active</Text>
            </View>
          ...
          <View style={styles.capabilityRow}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.capDesc, { color: colors.textFaint }]}>Cached fleet state for poor connectivity</Text>
            </View>
            <View style={[styles.capStatus, { backgroundColor: colors.greenDim }]}>
        ...
        <TouchableOpacity
          ...
          style={[styles.logoutBtn, { backgroundColor: colors.redDim, borderColor: `${colors.red}30` }]}
        >
...
const styles = StyleSheet.create({
  ...
  sectionTitle: {
    ...
    fontSize: 10, letterSpacing: 0.5, fontFamily: "Inter_500Medium",
  },
  infoRow: {
    flexDirection: "row", alignItems: "center", gap: 12,
    paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 0.5,
  },
  infoIcon: { width: 30, height: 30, borderRadius: 8, justifyContent: "center", alignItems: "center" },
  infoLabel: { fontSize: 10, fontFamily: "Inter_400Regular" },
  infoValue: { fontSize: 13, fontWeight: "500" as const, fontFamily: "Inter_500Medium", marginTop: 1 },
  capabilityRow: {
    flexDirection: "row", alignItems: "center", gap: 12,
    paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 0.5,
  },
