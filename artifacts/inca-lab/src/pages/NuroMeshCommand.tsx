...
import { Brain, Shield, BarChart3, Server, Compass, ArrowRight, Loader2, AlertCircle } from "lucide-react";
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground ml-3.5">
          Visual topology of all agents in the Nuro Mesh. Click any agent to inspect model assignments and swap providers.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-3">
          <div className="inca-panel p-5">
            <div className="text-xs text-muted-foreground uppercase tracking-wider font-medium mb-4">Agent Topology</div>
          ...
          <div className="inca-panel p-4 mt-4">
            <div className="text-xs text-muted-foreground uppercase tracking-wider font-medium mb-3">Routing Rules</div>
...
function AgentNodeComponent({
  agent, active, saved, onClick, isOrchestrator = false
}: {
  agent: AgentDef;
  active: boolean;
  saved: boolean;
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "agent-node p-3 flex flex-col items-center gap-1.5 transition-all text-center",
