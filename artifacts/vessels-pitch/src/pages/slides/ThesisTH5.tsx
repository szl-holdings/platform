...
const theorem = paper.theorems.find((t) => t.id === 'TH5')!;

export default function ThesisTH5() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-[#0a0a0a] text-text">
      ...
      <div className="absolute top-[6vh] left-0 w-[5vw] flex flex-col items-center gap-[1vh]">
        ...
        <div className="font-mono text-[0.7vw] tracking-[0.25em] text-muted uppercase [writing-mode:vertical-rl] mt-[2vh]">Theorem 5 of 8</div>
      </div>
      ...
      <div className="absolute left-[10vw] right-[10vw] top-[20vh]">
        <div className="font-mono text-[1vw] tracking-[0.25em] text-muted uppercase mb-[3vh]">Cofree comonad carrier</div>
        ...
        <p className="mt-[5vh] max-w-[72vw] text-[1.55vw] leading-[1.5] text-text/85" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          Every well-typed computation from the same input reaches the same ρ-closed chain —
          a unique normal form. Two paths cannot diverge. Legal reasoning that depends on
          replayable order gets a confluence theorem under it.
        </p>
      </div>
      ...
      <div className="absolute bottom-[6vh] left-[10vw] right-[6vw] grid grid-cols-3 gap-[3vw]">
        ...
        <div>
          ...
          <div className="font-mono text-[1.1vw] text-text">Counsel</div>
        </div>
      </div>
    </div>
  );
