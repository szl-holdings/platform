...
const OUTER_KERNELS: KernelNode[] = [
  ...
  { id: 'aegis',     label: 'Aegis',     role: 'Threat Intelligence & Defense',     pullsFrom: 'Threat actors, CVE feed, incident severity, escalation queue',               status: 'in-development', icon: '⛨', color: '#ef4444', previewPath: '/aegis/',     angle: 140, radius: 290 },
