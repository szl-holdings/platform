...
export default function ThreatCostTranslator() {
  ...
  const ambientSignals: AmbientSignal[] = [
    { id: "sig-1", domain: "aegis", title: "APT-41 Activity Spike", summary: "Threat actor APT-41 activity spike detected across 3 subsidiaries", severity: "high", score: 0.92, timestamp: Date.now() },
  ...
  const correlations: CrossDomainCorrelation[] = [
    { id: "cor-1", title: "Cyber Resilience ↔ AIOps Maturity", description: "Subsidiaries with higher AIOps adoption resolve incidents 3x faster", domains: ["aegis", "lyte"], confidence: 0.91, timestamp: Date.now(), signals: [{ domain: "aegis", event: "MTTR decreased 42%", severity: "medium" }, { domain: "lyte", event: "Self-healing rate 94%", severity: "info" }], impact: "high" },
  ];
    ...
    <div className="min-h-screen bg-[#060810] text-white p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-white/5">
        <div className="md:col-span-2">
          <CorrelationFeed correlations={correlations} currentDomain="aegis" accentColor="#ef4444" />
        </div>
