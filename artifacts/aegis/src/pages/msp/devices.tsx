...
export default function DevicesPage() {
  ...
  const filtered = allDevices
    .filter(d => d.hostname.toLowerCase().includes(search.toLowerCase()) || (d.clientName || "").toLowerCase().includes(search.toLowerCase()) || (d.ipAddress || "").includes(search))
    ...
    <div className="p-6 space-y-6 animate-fade-in">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Endpoint health, resource utilization, and patch compliance across managed devices</p>
        </div>
