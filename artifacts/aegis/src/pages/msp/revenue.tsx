      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            MRR, ARR, client revenue breakdown, churn risk analysis, and 6-month forecast
          </p>
        </div>
          ...
          : summary
            ? [
                ...
                >
                  ...
                  <p className={cn('text-2xl font-display font-bold mt-2', stat.color)}>
                    {stat.value}
                  </p>
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={cn(
                          ...
                          tierColors[client.tier] || 'text-muted-foreground bg-muted',
                        )}
                      >
                        {client.tier}
                      </span>
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Contract: ${client.contractValue.toLocaleString()}
                    </p>
                  </div>
                  <div className="shrink-0">
                    <span
                      className={cn(
                        ...
                        churnRiskColors[client.churnRisk],
                      )}
                    >
                      {client.churnRisk} risk
                    </span>
                    <p className="text-[10px] text-muted-foreground text-center mt-0.5">
                      {client.daysToRenewal}d renewal
                    </p>
                  </div>
                </div>
              );
