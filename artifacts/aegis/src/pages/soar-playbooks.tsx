...
const EXECUTION_HISTORY = [
  ...
  },
  {
    ...
    trigger: 'ID-001 Impossible Travel',
    started: '3h ago',
    duration: '6m 52s',
    status: 'partial',
    analyst: 'Auto',
  ...
  },
  {
    ...
    trigger: 'Network Anomaly SEN-0416',
    started: '1d ago',
    duration: '3m 12s',
    status: 'success',
    analyst: 'Auto',
  ...
  },
  {
    id: 'EX-1037',
    playbook: 'Account Compromise',
    trigger: 'ID-003 Priv Escalation',
    started: '2d ago',
    duration: '8m 14s',
    status: 'failed',
    analyst: 'M. Rodriguez',
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-xs text-white/40 mt-0.5">
            Automated incident response workflows — CrowdStrike Falcon Fusion & Palo Alto XSOAR
            inspired
          </p>
        </div>
      ...
      <div className="grid grid-cols-3 lg:grid-cols-6 gap-3">
        {[
          ...
          },
          {
            ...
            value: `${displayAnalytics.falsePositiveRate}%`,
            color: '#6b7280',
            sub: 'rate',
          },
          {
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      style={{ background: `${pb.color}12`, border: `1px solid ${pb.color}20` }}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-[10px] text-white/30 mt-0.5">
                        {pb.category} · {pb.executions} runs · {pb.successRate}% success
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="rounded-xl border border-white/6 bg-white/[0.015] p-5 space-y-5">
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <selectedPlaybook.icon
                    className="w-5 h-5"
                    style={{ color: selectedPlaybook.color }}
                  />
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-white/5 text-white/60 hover:bg-white/10 transition-colors">
                  ...
                  <div key={step.id}>
                    ...
                    >
                      ...
                      <div className="flex-1 flex items-center gap-2">
                        <span
                          className={cn(
                            'text-[9px] px-1.5 py-0.5 rounded border uppercase font-bold tracking-wide',
                        ...
                        {step.auto && (
                          <span className="text-[9px] text-white/20 ml-auto">AUTO</span>
                        )}
                      </div>
                    ...
                    {expandedStep === step.id && (
                      <div className="ml-10 mt-1 p-2.5 rounded-lg bg-white/[0.015] border border-white/5 text-[10px] text-white/40 space-y-1">
                        <div>
                          Type: <span className="text-white/60">{step.type}</span>
                        </div>
                        <div>
                          Execution:{' '}
                          <span className="text-white/60">
                            {step.auto ? 'Fully automated' : 'Requires analyst approval'}
                          </span>
                        </div>
                        <div>
                          Status:{' '}
          ...
          <div className="rounded-xl border border-white/6 overflow-hidden">
            ...
            <div className="divide-y divide-white/3">
              {EXECUTION_HISTORY.map((ex) => (
                <div
                  key={ex.id}
                  className="grid grid-cols-[80px_160px_1fr_100px_80px_80px_80px] gap-0 px-4 py-3 hover:bg-white/[0.015] transition-colors items-center"
                >
                ...
                <div key={pb.id}>
                  ...
                  <div className="h-1.5 rounded-full bg-white/5 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${pb.successRate}%`,
                        background: `linear-gradient(90deg, ${pb.color}80, ${pb.color})`,
                      }}
                    />
                  </div>
            ...
            <div className="mt-5 pt-4 border-t border-white/6 grid grid-cols-2 gap-3">
              {[
                ...
                },
                {
                  ...
                  value: '4.2%',
                  desc: 'Playbooks triggered incorrectly',
                  color: '#6b7280',
                },
                {
