      ...
      <div className="p-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 flex-wrap mb-1">
              <span
                ...
                style={{ background: 'hsl(220 72% 56% / 0.12)', color: ACCENT }}
              >
        ...
        {approval.comments.length > 0 && (
          <>
            ...
            >
              <MessageSquare size={12} /> {approval.comments.length} comment
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {govIssues.length > 0 && (
        <div
          ...
          style={{ background: '#c04a2a05', borderColor: '#c04a2a20' }}
        >
          <div className="flex items-center gap-2 mb-3">
            <AlertTriangle size={14} style={{ color: '#c04a2a' }} />
            <h3 className="text-sm font-semibold" style={{ color: '#c04a2a' }}>
              Governance Gaps
            </h3>
          </div>
        ...
        {['all', 'pending', 'approved', 'rejected'].map((s) => {
          ...
          return (
            <button
              ...
              style={{
                background:
                  statusFilter === s ? 'hsl(220 72% 56% / 0.06)' : 'rgba(255,255,255,0.01)',
                borderColor:
                  statusFilter === s ? 'hsl(220 72% 56% / 0.2)' : 'rgba(255,255,255,0.04)',
              }}
            >
              <div className="text-lg font-bold" style={{ color: 'rgba(255,255,255,0.8)' }}>
                {count}
              </div>
              <div
      ...
      >
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-sm font-medium" style={{ color: 'rgba(255,255,255,0.5)' }}>
            Security Audit Trace & Export
          </h3>
        </div>
        <p className="text-xs mb-3" style={{ color: 'rgba(255,255,255,0.35)' }}>
          Generate a signed security governance report — approval log, action history, exposure
          summary, and audit chain. Immutable once generated.
        </p>
        <button
          className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg hover:bg-white/5"
