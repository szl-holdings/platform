        ...
        <div className="max-w-3xl px-6 py-5">
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <p className="text-[10px] leading-relaxed" style={{ color: DS.text.secondary }}>
                  ...
                  and all persistence mechanisms were removed. The Aegis platform's pre-detection
          ...
          {activeSection === 'recommendations' && (
            <div className="space-y-4">
              ...
              <p className="text-[10px]" style={{ color: DS.text.muted }}>
                Recommendations generated by Alloy based on incident timeline, root cause analysis,
