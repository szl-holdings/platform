    ...
    >
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            'radial-gradient(ellipse 60% 50% at 20% 80%, rgba(12,200,217,0.05) 0%, transparent 50%)',
        }}
      />
      <div
        style={{
      ...
      >
        ...
        >
          The same nine-step architecture governs decisions across defense, maritime, real estate,
          advisory, operations, and corporate management.
        </div>
        <div
          style={{
            display: 'grid',
              ...
              >
                ...
                <div
                  style={{
                    ...
                    color: d.color,
                    background:
                      d.color === '#0cc8d9' ? 'rgba(12,200,217,0.1)' : 'rgba(245,166,35,0.1)',
                    padding: '0.3vh 0.6vw',
                    borderRadius: '0.3vw',
                    whiteSpace: 'nowrap',
                  }}
