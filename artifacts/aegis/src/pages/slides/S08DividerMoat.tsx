export default function S08DividerMoat() {
  return (
    ...
    >
      <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(ellipse at 50% 50%, rgba(12,200,217,0.1) 0%, transparent 65%)" }} />
      <div
        style={{
          position: "absolute",
          top: "50%",
      ...
      <div style={{ position: "relative", textAlign: "center" }}>
        <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "1vw", fontWeight: 600, letterSpacing: "0.25em", textTransform: "uppercase", color: "#0cc8d9", marginBottom: "2vh" }}>
          Part Two
        </div>
