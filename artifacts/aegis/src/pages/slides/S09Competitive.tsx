export default function S09Competitive() {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", left: "50%", top: "5vh", bottom: "5vh", width: "1px", background: "rgba(255,255,255,0.07)" }} />
      <div style={{ position: "absolute", inset: 0, padding: "5vh 7vw" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5vw", height: "62vh" }}>
          <div>
            <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "1vw", fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(240,236,230,0.3)", marginBottom: "2vh" }}>
              Legacy Approach
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "1.8vh" }}>
              {legacy.map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "1.2vw" }}>
                  <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "rgba(240,236,230,0.15)", flexShrink: 0, marginTop: "0.7vh" }} />
                  <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "1.3vw", color: "rgba(240,236,230,0.35)", lineHeight: 1.4 }}>{item}</div>
                </div>
              ))}
            </div>
          </div>
          <div>
            <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "1vw", fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "#0cc8d9", marginBottom: "2vh" }}>
              SZL Holdings
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "1.8vh" }}>
              {szl.map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "1.2vw" }}>
                  <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "#0cc8d9", flexShrink: 0, marginTop: "0.7vh" }} />
