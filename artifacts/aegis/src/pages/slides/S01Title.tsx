    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0, padding: "7vh 7vw", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div style={{ display: "flex", gap: "3vw", marginTop: "4vh" }}>
          <div>
            <div style={{ fontSize: "1.1vw", fontWeight: 300, color: "rgba(240,236,230,0.35)", fontFamily: "'Inter', sans-serif", letterSpacing: "0.08em" }}>
              Est. 2023
            </div>
          </div>
      ...
      >
        <div style={{ fontSize: "1vw", color: "rgba(240,236,230,0.2)", fontFamily: "'Inter', sans-serif", letterSpacing: "0.1em" }}>
          CONFIDENTIAL
        </div>
      </div>
    </div>
