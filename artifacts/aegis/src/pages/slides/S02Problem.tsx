    ...
    >
      ...
      <div style={{ position: 'absolute', inset: 0, padding: '6vh 7vw' }}>
        ...
        >
          ...
          >
            <div>
              ...
              >
                of enterprise AI incidents involve outputs with no reasoning trail or source
                attribution
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              >
                Existing tools produce recommendations but record no immutable proof of what was
          ...
          >
            <div>
              ...
              >
                Compliance layers are added post-deployment — not embedded in the architecture from
                day one
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            High-consequence domains — security, maritime, legal, real estate — cannot operate on AI
            they cannot verify.
          </p>
        </div>
      </div>
