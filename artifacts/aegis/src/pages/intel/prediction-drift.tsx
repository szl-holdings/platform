...
const driftData = [
  {
    ...
    drift: 14.3,
    status: 'warning',
    history: [2.1, 2.4, 2.8, 3.0, 3.2, 3.1, 3.2],
  },
  {
    ...
    drift: -2.4,
    status: 'stable',
    history: [89.2, 88.9, 88.5, 87.8, 87.4, 87.2, 87.1],
  },
  {
    ...
    drift: 9.8,
    status: 'stable',
    history: [4.1, 4.2, 4.1, 4.3, 4.4, 4.5, 4.5],
  },
  {
    ...
    drift: -7.6,
    status: 'critical',
    history: [89.1, 88.2, 87.0, 85.5, 84.1, 83.2, 82.3],
  },
  {
    ...
    drift: -0.7,
    status: 'stable',
    history: [91.8, 91.7, 91.5, 91.4, 91.3, 91.2, 91.2],
  },
  {
    ...
    drift: -2.9,
    status: 'warning',
    history: [87.2, 86.8, 86.2, 85.7, 85.1, 84.9, 84.7],
  },
  {
    ...
    drift: 11.5,
    status: 'warning',
    history: [5.2, 5.3, 5.4, 5.5, 5.6, 5.7, 5.8],
  },
];
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Model drift detection and degradation alerting before it impacts predictions
        </p>
      </div>
          ...
          <tbody>
            {driftData.map((d, i) => (
              <tr key={i} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                ...
                <td className="p-4">
                  <MiniSparkline data={d.history} status={d.status} />
                </td>
                <td className="p-4">
                  <span
                    className={cn(
