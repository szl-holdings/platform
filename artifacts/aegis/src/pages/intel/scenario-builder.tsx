...
const scenarios: Scenario[] = [
  {
    ...
    description: 'Increase marketing spend by 40% with expanded sales team',
    variables: [
    ...
    predictedOutcome: 'Revenue increase to $3.1M',
    confidence: 0.82,
    impact: 'positive',
    delta: '+29%',
  },
  {
    ...
    description: 'Reduce infrastructure costs through right-sizing and automation',
    variables: [
    ...
    predictedOutcome: '27% cost reduction, margin +4.2pp',
    confidence: 0.89,
    impact: 'positive',
    delta: '-27% costs',
  },
  {
    ...
    description: 'Simulated 15% market contraction scenario',
    variables: [
    ...
    predictedOutcome: 'Revenue decline to $1.8M, 8-month runway',
    confidence: 0.76,
    impact: 'negative',
    delta: '-25%',
  },
  {
    ...
    description: 'Shift to PLG with freemium tier and self-serve onboarding',
    variables: [
    ...
    predictedOutcome: '525 new paid users, +$630K ARR by Q4',
    confidence: 0.71,
    impact: 'positive',
    delta: '+$630K',
  },
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Parameter ranges, counterfactual simulations, and outcome distributions side-by-side
        </p>
      </div>
                ...
                <div className="flex items-center gap-4 flex-1">
                  <div className="text-right w-32">
                    ...
                    <p className="text-sm font-mono text-foreground">
                      {v.baseline.toLocaleString()} {v.unit}
                    </p>
                  </div>
                  ...
                  <div className="w-32">
                    ...
                    <p className="text-sm font-mono text-foreground font-semibold">
                      {v.modified.toLocaleString()} {v.unit}
                    </p>
                  </div>
                </div>
              </div>
