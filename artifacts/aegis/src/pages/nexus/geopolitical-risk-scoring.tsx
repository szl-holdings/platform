...
const COUNTRIES: CountryRisk[] = [
  ...
  },
  {
    ...
    keyDrivers: [
      ...
      'SWIFT sanctions expansion',
      'Energy market weaponization',
      'Arctic route militarization',
    ],
  },
  {
    id: 'GR-003',
    ...
    lastUpdated: '2024-03-15T14:00:00Z',
    keyDrivers: [
      'Houthi proxy attacks on Red Sea shipping',
  ...
  },
  {
    ...
    lastUpdated: '2024-03-15T14:00:00Z',
    keyDrivers: [
      'CBAM carbon tax expansion',
      'AI Act implementation',
      'Energy transition costs',
      'Migration-driven political shifts',
    ],
  },
];
...
const trendIcon = (t: string) =>
  t === 'escalating' ? TrendingUp : t === 'de-escalating' ? TrendingDown : Minus;
const trendColor = (t: string) =>
  t === 'escalating' ? RED : t === 'de-escalating' ? GREEN : DS.text.muted;
const fmt = (n: number) =>
...
export default function GeopoliticalRiskScoringPage() {
  ...
  const totalExposure = COUNTRIES.reduce(
    (s, c) => s + c.affectedAssets.reduce((a, b) => a + b.exposure, 0),
    0,
  );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[11px] mt-1" style={{ color: DS.text.muted }}>
          Real-time country and region-level risk assessment with cascading impact to portfolio
          assets, maritime routes, and legal matters
        </p>
      </div>
        ...
        {[
          {
            ...
            value: `${globalAvg}/100`,
            icon: Globe,
            color: scoreColor(globalAvg),
          },
          {
            label: 'Escalating Regions',
            value: escalatingCount.toString(),
            icon: TrendingUp,
            color: RED,
          },
          {
      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          {COUNTRIES.sort((a, b) => b.overallScore - a.overallScore).map((c) => {
            ...
            return (
              <button
                ...
                style={{
                  background: selectedId === c.id ? 'rgba(255,255,255,0.04)' : DS.surface,
                  border: `1px solid ${selectedId === c.id ? 'rgba(255,255,255,0.12)' : DS.border}`,
                }}
              >
        ...
        <div className="col-span-7 space-y-4">
          ...
          >
            ...
            <h4
              className="text-[9px] uppercase tracking-wider font-semibold mb-3"
              style={{ color: DS.text.muted }}
            >
            ...
            <div className="space-y-2 mb-4">
              {Object.entries(selected.factors).map(([key, val]) => (
                <div key={key} className="flex items-center gap-3">
                  <span
                    className="text-[10px] w-24 capitalize"
