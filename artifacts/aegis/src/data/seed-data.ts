...
export const projects: Project[] = [
  {
    ...
    description: "Multi-class neural network for real-time threat vector classification across network traffic patterns.",
    accuracy: 97.4,
    loss: 0.041,
    inferenceTime: 12,
    progress: 100,
  ...
  },
  {
    ...
    status: "testing",
    domain: "Intelligence",
    description: "LSTM-based forecasting model combining OSINT signals with structured geopolitical indicators.",
    accuracy: 84.1,
    loss: 0.183,
    inferenceTime: 45,
    progress: 82,
  ...
  },
  {
    ...
    status: "development",
    domain: "Data Fusion",
    description: "Graph-based entity resolution across disparate intelligence sources using transformer embeddings.",
    accuracy: 91.6,
    loss: 0.098,
    inferenceTime: 28,
    progress: 64,
  ...
  },
  {
    ...
    status: "research",
    domain: "Monitoring",
    description: "Unsupervised anomaly detection across multi-variate time-series telemetry streams.",
    accuracy: 76.3,
    loss: 0.312,
    inferenceTime: 8,
    progress: 31,
  ...
  },
  {
    ...
    description: "Fine-tuned LLM pipeline for extracting structured intelligence signals from unstructured text.",
    accuracy: 88.9,
    loss: 0.142,
    inferenceTime: 62,
    progress: 57,
...
export const experiments: Experiment[] = [
  ...
  },
  {
    ...
    status: "running",
    hypothesis: "Attention mechanism will improve long-range temporal dependencies in geopolitical sequences.",
    results: "",
    duration: "2h 14m",
  ...
  },
  {
    ...
    status: "completed",
    hypothesis: "GAT layers will outperform GCN on heterogeneous entity graphs with varying edge weights.",
  ...
  },
  {
    ...
    status: "failed",
    hypothesis: "Reconstruction error threshold tuned on rolling 7-day baseline will reduce false positives by 30%.",
  ...
  },
  {
    ...
    status: "queued",
    hypothesis: "LoRA adapters at r=64 will match full fine-tune quality at 12x lower compute cost.",
    results: "",
    duration: "—",
...
export const models: Model[] = [
  ...
  },
  {
    ...
    cost: 81,
    performanceHistory: [
      { date: "2026-04", accuracy: 88.9, latency: 62 },
    ],
  },
];
...
export const insights: Insight[] = [
  {
    ...
    description: "The latest production model hit 97.4% validation accuracy — a 4.3pp improvement from v2. Rare class F1 scores are now consistently above 0.84, enabling high-confidence automated triage.",
    category: "success",
    impact: "high",
    confidence: 96,
  ...
  },
  {
    ...
    description: "Recall for Pacific-region geopolitical events is 12pp below Atlantic baseline. Training data imbalance likely cause — Pacific events represent only 8% of training corpus.",
    category: "warning",
    impact: "medium",
    confidence: 84,
  ...
  },
  {
    ...
    description: "Consistent across 3 cross-validation folds with p < 0.01. Heterogeneous edge type encoding is the likely differentiating factor.",
    category: "discovery",
    impact: "high",
    confidence: 91,
  ...
  },
  {
    ...
    description: "P95 inference latency increased from 48ms to 62ms over the past 30 days as document length distributions shift. Quantization or batching optimization needed before production.",
    category: "trend",
    impact: "medium",
    confidence: 78,
  ...
  },
  {
    ...
    description: "Post-recalibration FPR dropped from 2.3% to 0.8%. 7-day rolling baseline approach is holding across seasonal shifts.",
    category: "success",
    impact: "low",
    confidence: 88,
