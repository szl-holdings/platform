...
export const api = {
  scenarios: {
    ...
    create: (data: any) => apiFetch<any>("/aegis/scenarios", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/scenarios/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  assessments: {
    ...
    create: (data: any) => apiFetch<any>("/aegis/assessments", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/assessments/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  simulations: {
    ...
    create: (data: any) => apiFetch<any>("/aegis/simulations", { method: "POST", body: JSON.stringify(data) }),
  },
  findings: {
    list: (assessmentId?: number) => apiFetch<any[]>(`/aegis/findings${assessmentId ? `?assessmentId=${assessmentId}` : ""}`),
    get: (id: number) => apiFetch<any>(`/aegis/findings/${id}`),
    create: (data: any) => apiFetch<any>("/aegis/findings", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/findings/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  },
  riskScores: {
    list: (assessmentId?: number) => apiFetch<any[]>(`/aegis/risk-scores${assessmentId ? `?assessmentId=${assessmentId}` : ""}`),
    create: (data: any) => apiFetch<any>("/aegis/risk-scores", { method: "POST", body: JSON.stringify(data) }),
  },
  reports: {
  ...
  incidents: {
    ...
    create: (data: any) => apiFetch<any>("/aegis/incidents", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/incidents/${id}`, { method: "PUT", body: JSON.stringify(data) }),
    delete: (id: number) => apiFetch<void>(`/aegis/incidents/${id}`, { method: "DELETE" }),
  },
  compliance: {
    list: (framework?: string) => apiFetch<any[]>(`/aegis/compliance${framework ? `?framework=${framework}` : ""}`),
  },
  alerts: {
    list: (status?: string) => apiFetch<any[]>(`/aegis/alerts${status ? `?status=${status}` : ""}`),
    create: (data: any) => apiFetch<any>("/aegis/alerts", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/alerts/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  },
  socDashboard: {
    get: () => apiFetch<any>("/aegis/soc-dashboard"),
  },
  cves: {
    list: (keyword?: string) => apiFetch<any[]>(`/aegis/cves${keyword ? `?keyword=${encodeURIComponent(keyword)}` : ""}`),
  },
  assets: {
    ...
    create: (data: any) => apiFetch<any>("/aegis/assets", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/assets/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  },
  vulnerabilities: {
    ...
    update: (id: number, data: any) => apiFetch<any>(`/aegis/vulnerabilities/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  },
  workflowActions: {
    ...
    create: (data: any) => apiFetch<any>("/aegis/workflow-actions", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/workflow-actions/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  },
  cases: {
    ...
    create: (data: any) => apiFetch<any>("/aegis/cases", { method: "POST", body: JSON.stringify(data) }),
    update: (id: number, data: any) => apiFetch<any>(`/aegis/cases/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  },
  mitreDetections: {
  ...
  live: {
    ...
    mitreAttack: (tactic?: string) =>
      apiFetch<any>(`/aegis/live/mitre-attack${tactic ? `?tactic=${encodeURIComponent(tactic)}` : ""}`),
  ...
  hardeningControls: {
    ...
    update: (id: number, data: any) => apiFetch<any>(`/aegis/hardening-controls/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  ingest: {
    webhook: (payload: any) => apiFetch<any>("/aegis/ingest/webhook", { method: "POST", body: JSON.stringify(payload) }),
    syslog: (payload: any) => apiFetch<any>("/aegis/ingest/syslog", { method: "POST", body: JSON.stringify(payload) }),
  },
  soar: {
    playbooks: () => apiFetch<any>("/aegis/soar/playbooks"),
    execute: (playbookId: string, alertId?: string, context?: any) =>
      apiFetch<any>("/aegis/soar/execute", { method: "POST", body: JSON.stringify({ playbookId, alertId, context }) }),
  },
  stix: {
    objects: (type?: string) => apiFetch<any>(`/aegis/stix/objects${type ? `?type=${type}` : ""}`),
    export: (objectIds: string[], bundleName?: string) =>
      apiFetch<any>("/aegis/stix/export", { method: "POST", body: JSON.stringify({ objectIds, bundleName }) }),
  },
  taxii: {
  ...
  tradecraft: {
    decisions: (params?: string) => apiFetch<any[]>(`/aegis/tradecraft/decisions${params ? `?${params}` : ""}`),
    getDecision: (objectId: string) => apiFetch<any>(`/aegis/tradecraft/decisions/${objectId}`),
    createDecision: (data: unknown) => apiFetch<any>("/aegis/tradecraft/decisions", { method: "POST", body: JSON.stringify(data) }),
    updateDecision: (objectId: string, data: unknown) => apiFetch<any>(`/aegis/tradecraft/decisions/${objectId}`, { method: "PUT", body: JSON.stringify(data) }),
    notebook: (params?: string) => apiFetch<any[]>(`/aegis/tradecraft/notebook${params ? `?${params}` : ""}`),
    createNote: (data: unknown) => apiFetch<any>("/aegis/tradecraft/notebook", { method: "POST", body: JSON.stringify(data) }),
    updateNote: (noteId: string, data: unknown) => apiFetch<any>(`/aegis/tradecraft/notebook/${noteId}`, { method: "PUT", body: JSON.stringify(data) }),
    deleteNote: (noteId: string) => apiFetch<void>(`/aegis/tradecraft/notebook/${noteId}`, { method: "DELETE" }),
    caseMemory: (caseId: string) => apiFetch<any>(`/aegis/tradecraft/case-memory/${caseId}`),
    createCaseMemory: (data: unknown) => apiFetch<any>("/aegis/tradecraft/case-memory", { method: "POST", body: JSON.stringify(data) }),
    updateCaseMemory: (caseId: string, data: unknown) => apiFetch<any>(`/aegis/tradecraft/case-memory/${caseId}`, { method: "PUT", body: JSON.stringify(data) }),
    evidenceIndex: (params?: string) => apiFetch<any>(`/aegis/tradecraft/evidence-index${params ? `?${params}` : ""}`),
  ...
  command: {
    ...
    addNote: (note: string, caseId?: number) =>
      apiFetch<any>("/aegis/command/investigations", { method: "POST", body: JSON.stringify({ type: "note", content: note, caseId }) }),
