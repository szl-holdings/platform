...
const SURFACES = [
  ...
  },
  {
    ...
    description:
      'Step-by-step reconstruction of who knew what, when — surfacing every signal, memo, and actor confirmation anchored to the Counsel ledger.',
  },
  {
    href: '/board',
    title: 'Board View',
      ...
      <section className="px-6 py-14 border-t border-amber-500/10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-sm text-amber-100/55 mb-8 leading-relaxed">
            Lyte onboards in 2 weeks with no integration required beyond a read-only Counsel
