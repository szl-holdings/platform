...
import {
  Shield, GitBranch, Printer, Clock, Activity, Lock, Users,
  TrendingDown, ArrowLeft, Link2, CheckCircle2,
} from "lucide-react";
import {
...
export default function BriefingPage() {
  ...
  useEffect(() => {
    document.title = signal
      ? `Briefing — ${signal.title}`
      : "Decision Twin Briefing — Not found";
  }, [signal]);
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-8">
        <div className="max-w-md text-center space-y-3">
          ...
          <p className="text-sm text-slate-600">
            No signal was found for ID <code className="px-1 py-0.5 bg-slate-200 rounded">{signalId}</code>.
            The link may be from a different deployment or the signal has been retired.
          </p>
          <Link
            href="/decision-twin"
