...
const ESCALATIONS = [
  {
    ...
    reason: "48h approval SLA breach. Legal team at 94% capacity. Q1 close window closes in 6 days. $840K ARR at risk.",
    escalate_to: "CFO + CEO",
  ...
  },
  {
    ...
    reason: "NPS dropped 42 points. Competitive renewal offer received. 88% churn probability without executive contact.",
    escalate_to: "CEO",
  ...
  },
  {
    ...
    reason: "Compliance step has no owner for 6 days. Blocking 6 downstream vendor onboardings. Process gap from team reorg.",
    escalate_to: "CPO",
    team: "Procurement",
            ...
            <div key={esc.id} className="rounded-xl border p-5" style={{ borderColor, background: bgColor }}>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="rounded-lg p-3" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
                  <div className="text-[9px] font-semibold uppercase tracking-wider mb-1" style={{ color: "rgba(255,255,255,0.4)" }}>Escalate To</div>
                  <div className="text-xs font-medium text-white">{esc.escalate_to}</div>
                  <div className="text-[10px]" style={{ color: "rgba(255,255,255,0.35)" }}>{esc.team}</div>
                </div>
                <div className="rounded-lg p-3" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
                  <div className="text-[9px] font-semibold uppercase tracking-wider mb-1" style={{ color: "rgba(255,255,255,0.4)" }}>Recommended Action</div>
                  <div className="text-[10px] leading-relaxed text-white">{esc.recommended_action}</div>
                </div>
              </div>
