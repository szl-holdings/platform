...
const NODES = [
  ...
  { id: "msp", name: "MSP", role: "IT Operations Organ", agent: "IT Sentinel", color: "text-blue-400", bg: "bg-blue-400/10", border: "border-blue-400/20", x: 5, y: 55, type: "organ" },
  { id: "terra", name: "Terra", role: "Real Estate Organ", agent: "Deal Scout", color: "text-emerald-400", bg: "bg-emerald-400/10", border: "border-emerald-400/20", x: 17, y: 78, type: "organ" },
  { id: "dreamscape", name: "Dreamscape", role: "Creative Organ", agent: "Creative Director", color: "text-violet-400", bg: "bg-violet-400/10", border: "border-violet-400/20", x: 38, y: 85, type: "organ" },
...
const AGENT_ACTIVITY: { time: string; app: string; agent: string; action: string; type: "signal" | "intelligence" | "policy" | "reflex" }[] = [
  ...
  { time: "45s", app: "MSP", agent: "IT Sentinel", action: "Auto-remediated memory leak — TKT-4821 closed", type: "reflex" },
  ...
  { time: "2m", app: "Dreamscape", agent: "Creative Director", action: "Campaign rebalance: +$12K to LinkedIn video segment", type: "reflex" },
