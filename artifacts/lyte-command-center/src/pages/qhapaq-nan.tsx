...
const NODES = [
  ...
  { id: "dreamscape", name: "Nimbus", role: "Prediction Intelligence Organ", agent: "Creative Director", color: "text-violet-400", bg: "bg-violet-400/10", border: "border-violet-400/20", x: 38, y: 85, type: "organ" },
...
const AGENT_ACTIVITY: { time: string; app: string; agent: string; action: string; type: "signal" | "intelligence" | "policy" | "reflex" }[] = [
  ...
  { time: "2m", app: "Nimbus", agent: "Creative Director", action: "Campaign rebalance: +$12K to LinkedIn video segment", type: "reflex" },
