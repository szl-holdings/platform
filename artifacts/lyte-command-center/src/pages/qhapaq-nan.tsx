...
const NODES = [
  ...
  { id: "dreamscape", name: "Alloy", role: "Prediction Intelligence Engine", agent: "Intelligence Engine", color: "text-violet-400", bg: "bg-violet-400/10", border: "border-violet-400/20", x: 38, y: 85, type: "organ" },
