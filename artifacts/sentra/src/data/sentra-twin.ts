  ...
  incidents: [
    {
      ...
      description: "Encrypted payload detected on 3 OT assets (SCADA, PLC). Anomalous C2 beaconing to known malicious IPs.",
...
export const SENTRA_SIGNAL_LABELS = [
  { id: "sig-sentra-001", label: "Ransomware Payload Detected", severity: "critical", occurredAt: hoursAgo(4) },
  { id: "sig-sentra-002", label: "Anomalous C2 Beacon", severity: "critical", occurredAt: hoursAgo(3.5) },
] as const;
