...
const SEED_DECISIONS: PolicyDecision[] = [
  ...
  },
  {
    ...
    agent: 'IT Sentinel',
    domain: 'Sentra Operations',
    action: 'Read all client device inventories across Sentra Operations accounts',
    actionType: 'data_access',
    decision: 'permitted',
    policyRule: 'MSP-AGENT-FULL-READ',
    riskScore: 35,
    details: 'IT Sentinel has full read access to Sentra Operations domain data within its scope.',
  },
];
