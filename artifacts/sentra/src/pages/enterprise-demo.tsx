  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (payload?.url) {
        ...
        setStatus('success');
        setResultMessage(
          'Your enterprise profile is ready. Complete payment to activate your Sentra environment.',
        );
        ...
        setResultMessage(
          payload?.message ??
            'Your enterprise invoice has been sent. Review and pay to activate your Sentra environment.',
        );
      } else {
        setStatus('success');
        setResultMessage(
    ...
    <div className="min-h-screen bg-[#0c0a0a] text-white">
      <nav className="border-b border-white/5 px-6 py-4 flex items-center justify-between max-w-5xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-[14px]">Sentra</span>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        <div className="mb-12">
          ...
          <p className="text-gray-400 text-[15px] leading-relaxed max-w-xl">
            ...
            Sentra demo tailored to your threat profile. Zero commitment.
          </p>
        </div>
