...
function AccountPanel() {
  ...
  return (
    <SettingsSectionPanel title="Account" description="Your profile on the Sentra MSP platform">
...
function BillingPanel() {
  return (
    <SettingsSectionPanel
      title="Billing"
      description="Subscription, plan, and usage billing for your Sentra MSP account"
    >
      <SettingsCard title="Current Plan">
        <SettingsRow label="Plan">
          <div className="flex items-center gap-2">
            <Building className="w-4 h-4 text-[#8a8a8a]" />
            <span className="text-sm">Managed via the Sentra platform portal</span>
          </div>
        </SettingsRow>
      ...
      <div className="mt-4 p-3 rounded-lg bg-[#8a8a8a]/5 border border-indigo-500/15">
        <p className="text-xs text-[#8a8a8a]/70">
          Billing changes and invoices are managed through the Sentra platform admin panel.
...
function AuditPanel() {
  ...
  return (
    <SettingsSectionPanel
      ...
      description="Audit trail of settings changes in Sentra"
    >
