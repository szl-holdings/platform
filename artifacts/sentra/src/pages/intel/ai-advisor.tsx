...
const ORACLES = [
  {
    ...
    subtitle: 'General Reasoning — Cross-Domain Analysis',
    description:
      'The most capable model in the platform. Handles complex multi-domain reasoning, strategic synthesis, and long-context analysis.',
    accuracy: 96.2,
    latency: '420ms',
    cost: '$0.0018/req',
    context: '128K tokens',
  ...
  },
  {
    ...
    subtitle: 'Domain Oracle — Sea & Trade',
    description:
      'Specialized in maritime logistics, vessel behavior, trade route analysis, and port operations forecasting.',
    accuracy: 94.8,
    latency: '95ms',
    cost: '$0.0004/req',
    context: '32K tokens',
  ...
  },
  {
    ...
    subtitle: 'Domain Oracle — Capital & Markets',
    description:
      'Specialized in financial modeling, investment analysis, portfolio optimization, and market regime detection.',
    accuracy: 93.7,
    latency: '210ms',
    cost: '$0.0012/req',
    context: '64K tokens',
  ...
  },
  {
    ...
    subtitle: 'Domain Oracle — Threat & Defense',
    description:
      'Specialized in cybersecurity threat analysis, attack pattern detection, compliance assessment, and policy evaluation.',
    accuracy: 97.1,
    latency: '140ms',
    cost: '$0.0006/req',
    context: '32K tokens',
  ...
  },
  {
    ...
    subtitle: 'Domain Oracle — Story & Brand',
    description:
      'Specialized in content strategy, brand voice analysis, creative brief generation, and campaign performance interpretation.',
    accuracy: 88.4,
    latency: '320ms',
    cost: '$0.0014/req',
    context: '64K tokens',
  ...
  },
  {
    id: 'code-oracle',
    name: 'Code Oracle',
    subtitle: 'Domain Oracle — Logic & Systems',
    description:
      'Specialized in code analysis, system architecture review, technical debt assessment, and engineering strategy.',
    accuracy: 95.9,
    latency: '380ms',
    cost: '$0.0015/req',
    context: '64K tokens',
...
const EXAMPLE_CONSULTATIONS = [
  {
    question:
      'What maritime disruptions should we anticipate in the next 30 days based on current geopolitical signals?',
    oracle: 'Maritime Oracle',
    confidence: 87,
    summary:
  ...
  },
  {
    ...
    confidence: 91,
    summary:
      "Cross-portfolio talent concentration risk is highest — 4 of 9 apps rely on the same 3 engineers for critical path work. Secondary risk: MSP's customer concentration (top 3 clients = 62% of ARR). Recommend: talent redundancy planning and MSP diversification initiative.",
  },
  {
    question: 'Which Dreamscape campaign targeting segments show highest predicted ROAS for Q2?',
    oracle: 'Creative Oracle',
    confidence: 78,
    summary:
      'B2B SaaS decision-makers aged 35–44 in the US Southeast show 2.8x predicted ROAS based on Q1 engagement data. LinkedIn video format outperforms display by 3.1x for this cohort. Recommend shifting 40% of Q2 budget to this segment and format combination.',
  },
];
...
const COMPARISON_RESULTS: ComparisonResult[] = [
  ...
  },
  {
    ...
    answer:
      'Instrument the portfolio intelligence layer with real-time cash flow correlation across all portfolio companies — enabling proactive capital allocation 45-90 days ahead of need.',
    confidence: 84,
    reasoning: [
      'Portfolio companies share seasonal patterns',
      'Capital allocation timing gap costs ~$340K/yr in opportunity cost',
      'AI-driven allocation has 2.1x better outcomes in comparable portfolios',
    ],
    caveats: 'Financial data sensitivity requires Adaptive Defense escalation review.',
  },
  {
    oracle: 'Security Oracle',
    answer:
      'Implement continuous agent action auditing across all agent network nodes — current visibility gap means 23% of agent actions are unaudited, creating compliance and security exposure.',
    confidence: 96,
    reasoning: [
      'Compliance frameworks require full audit trails by Q3 2026',
      '3 incidents last quarter traced to unaudited agent actions',
      'Audit infrastructure reduces investigation time by 80%',
    ],
    caveats: 'Performance overhead estimated at 4–7ms per action.',
  },
];
...
export default function AiAdvisor() {
  ...
  const [consultResult, setConsultResult] = useState<(typeof EXAMPLE_CONSULTATIONS)[0] | null>(
    null,
  );
    ...
    <div className="p-6 lg:p-8 space-y-6 max-w-[1600px]">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Consult domain-specific AI models, compare their reasoning, and receive confidence-scored
          interpretations.
        </p>
      </div>
          ...
          {ORACLES.map((oracle) => (
                ...
                !oracle.available
                  ...
                  : selectedOracle === oracle.id
                    ? cn(
                        ...
                        oracle.border.replace('border-', 'border-'),
                      )
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <div
                  className={cn('w-8 h-8 rounded-lg flex items-center justify-center', oracle.bg)}
                >
              ...
              <div className="mt-2">
                <div className="h-1 bg-border rounded-full overflow-hidden">
                  <div
                    className={cn(
                      'h-full rounded-full',
                      oracle.bg.replace('bg-', 'bg-').replace('/10', ''),
                    )}
                    style={{
      ...
      <div className="bg-card/60 border border-border rounded-xl p-5">
        ...
        <div className="space-y-3">
          <div>
            ...
            >
              {selectedOracle
                ? ORACLES.find((o) => o.id === selectedOracle)?.name
                : '— Select an oracle above —'}
            </div>
          </div>
          <div>
            <label className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground block mb-1.5">
