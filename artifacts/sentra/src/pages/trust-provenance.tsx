import { Lock, FileText, Bot, Terminal } from "lucide-react";
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded flex items-center justify-center ${highlight ? "bg-sky-500/10" : "bg-emerald-500/10"}`}>
                    {highlight ? (
                ...
                <div className="flex items-center gap-6">
                  ...
                  <span className={`px-2 py-0.5 rounded border text-[10px] font-bold ${verified ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : "bg-amber-500/10 border-amber-500/20 text-amber-400"}`}>
                    {item.status}
                  </span>
                </div>
              </div>
