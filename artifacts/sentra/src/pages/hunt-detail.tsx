...
import { approveHunt, approveHuntRemediationPlan, dismissHunt } from '@/lib/sentra-api';
...
export default function HuntDetailPage() {
  ...
  const handleApproveRemediation = async () => {
    ...
    try {
      ...
      const remRes = await approveHuntRemediationPlan(`rem-${hunt.id}`, {
        huntId: hunt.id,
        huntTitle: hunt.title,
        blastRadiusCost: hunt.attackPath.blastRadiusCost,
          ...
          <div className="sentra-panel p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                ...
                SEXTANT, Pulse) will react automatically.
              </p>
            </div>
          </div>
