    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="sentra-panel p-4 text-center">
          ...
          <div className="text-2xl font-display font-bold text-red-400">{criticalOpen}</div>
        </div>
        <div className="sentra-panel p-4 text-center">
              ...
              {filtered.map((alert) => (
                <tr
                  ...
                  className={cn(
                    ...
                    alert.severity === 'critical' && alert.status === 'open' && 'bg-red-500/[0.03]',
                  )}
                >
                  ...
                  <td className="px-5 py-4">
                    {alert.status === 'open' ? (
                      <button
                        ...
                        className="px-2 py-1 rounded text-[10px] font-mono border border-sky-500/30 bg-sky-500/10 text-sky-400 hover:bg-sky-500/20 transition-colors disabled:opacity-50 flex items-center gap-1"
                      >
