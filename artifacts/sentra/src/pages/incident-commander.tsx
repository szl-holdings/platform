...
import { Activity, CheckCircle2, Cpu, Info, ShieldAlert, XCircle, Zap } from 'lucide-react';
      ...
      <header className="flex justify-between items-start">
        ...
        <div className="px-4 py-2 rounded border border-red-500/40 bg-red-500/10 flex items-center gap-3">
          ...
          <div className="text-right">
            <div className="text-[10px] text-red-400 font-mono uppercase tracking-widest">
              Active Incident
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="sentra-panel p-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <span className="px-2 py-0.5 rounded bg-red-500/10 border border-red-500/20 text-[10px] text-red-400 font-mono">
                    MITRE: {activeIncident.mitreStage}
                  </span>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">{activeIncident.description}</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-bold text-slate-200">
                          Isolate PLC Segment (VLAN 42)
                        </div>
                        <p className="text-xs text-slate-500">
                          Anomalous C2 beaconing identified from PLC Controller (asset-003).
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          Credential spraying detected targeting admin accounts in OT segment.
                        </p>
                      </div>
                    </div>
          ...
          <div className="sentra-panel p-6">
            <h2 className="text-sm font-bold text-slate-300 uppercase tracking-widest font-mono mb-4">
              Incident Timeline
            </h2>
            <div className="space-y-6">
              {[
                {
                  time: '14:12',
                  event: 'Isolation recommendation generated by Signal Mesh',
                  type: 'system',
                },
                {
                  time: '14:05',
                  event: 'Anomalous C2 beacon detected from PLC-003',
                  type: 'alert',
                },
                {
                  time: '13:58',
                  event: 'Ransomware payload signature matched on SCADA-01',
                  type: 'alert',
                },
