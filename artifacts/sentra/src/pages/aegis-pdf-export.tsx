                ...
                >
                  ...
                  <div style={{ padding: '40px 48px 32px', background: '#080510', color: 'white' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                      ...
                      <div>
                        <div style={{ fontSize: '20px', fontWeight: 700, color: '#fef2f2' }}>Sentra</div>
                  ...
                  <div style={{ padding: '16px 48px', background: '#f8fafc', borderTop: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: '9px', color: '#94a3b8' }}>Sentra — Defense & Intelligence Command · CONFIDENTIAL · Q2 2026</span>
                    <span style={{ fontSize: '9px', color: '#94a3b8' }}>Generated by Sentra Governed AI Platform</span>
                  </div>
                </div>
              </div>
            </div>
