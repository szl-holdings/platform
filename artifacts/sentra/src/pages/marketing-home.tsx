      ...
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-[#f5f5f5]/10 bg-[#0a0608]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-[15px] tracking-tight">Sentra</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-gray-500 text-[15px] mb-10 max-w-xl mx-auto leading-relaxed">
              Schedule a private threat briefing with the Sentra team. We'll assess your current
