...
const EXPOSURE_EVIDENCE: EvidenceSource[] = [
  {
    ...
    excerpt:
      'Monte Carlo simulation (10,000 runs) estimates 92% probability of lateral movement to ERP cluster if SCADA segment remains unsegmented. Expected loss: $1.4M.',
  },
  {
    id: 'ev-exp-002',
    ...
    excerpt:
      'Cyber policy CHR-2024-991 section 8.3 requires verified backup cadence ≤ 24h. Current status: 2 critical servers at 72h+ backup age. Policy clause at risk.',
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 sentra-panel p-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="text-5xl font-display font-bold text-[#f5f5f5]">$2.8M</div>
          </div>
          ...
          <div className="flex justify-between text-[10px] text-slate-500 font-mono px-4 border-t border-slate-800 pt-4">
            ...
            <span className="text-[#f5f5f5]">↑ 14% SINCE LAST INCIDENT</span>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div className="p-3 rounded bg-slate-800/50 border border-slate-700">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-[10px] text-[#f5f5f5] font-bold">9.8 CRITICAL</span>
                </div>
                <p className="text-[10px] text-slate-500">
                  Remote Code Execution on legacy SCADA systems via malformed packet.
                </p>
              </div>
              <div className="p-3 rounded bg-slate-800/50 border border-slate-700">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-[10px] text-[#c9b787] font-bold">8.1 HIGH</span>
                </div>
                <p className="text-[10px] text-slate-500">
                  Authentication bypass in HMI control plane web server.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="sentra-panel p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="pt-2 border-t border-slate-800 flex justify-between text-xs font-bold">
                ...
                <span className="text-[#c9b787]">FAIL (Backup Staleness)</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 mt-1 max-w-2xl">
                    By isolating the compromised SCADA segment, we avoid a 92% probability of
                    ransomware spread to the ERP cluster, preventing an additional $1.4M in
