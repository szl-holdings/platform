    ...
    <div className="space-y-5">
      <header className="flex items-end justify-between">
        ...
        <button
          onClick={() =>
            setSummaryText(
              'Based on current readiness metrics, Sentra demonstrates strong positioning across cybersecurity (82%) and cloud infrastructure (78%) dimensions. Key areas for improvement include AI/ML maturity (+12 potential points) and data governance frameworks. Recommended actions: 1) Accelerate Zero Trust implementation, 2) Expand AI training programs, 3) Implement automated compliance scanning.',
            )
          }
