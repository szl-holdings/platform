...
const INIT_COMMS: CommEntry[] = [
  ...
  { id: 'C009', time: '15:05', from: 'INCIDENT SYSTEM', role: 'Automated Broadcast', message: 'BROADCAST: Crisis status update distributed to all connected verticals. SEXTANT, DOMAINE, PRISM, Sentra — crisis banner active. Cross-domain impact assessment underway.', type: 'broadcast' },
];
            ...
            <div className="max-w-3xl space-y-4">
              ...
              {drillsLoading && (
                <div className="flex items-center gap-2 text-xs py-4" style={{ color: DS.text.muted }}>
                  ...
                  Loading drill scenarios from Sentra…
                </div>
              )}
