...
export default function MeshExposures() {
  ...
  const [runFixIds, setRunFixIds] = useState<Set<string>>(new Set());
  ...
  function handleRunFix(id: string) {
    setRunFixIds(prev => {
  ...
  const openCount = exposures.filter(e => e.status === "open").length;
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="space-y-6">
        {exposures.map(exp => {
          ...
          const isFixPending = exp.status === "fix-pending" || runFixIds.has(exp.id);
          ...
          return (
            <ProofEnvelope
              ...
              policyReason="Guardian approval required before executing remediation on agent mesh"
              autonomyMode={mode}
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex gap-4 flex-1">
                    <div className={cn(
                      ...
                      exp.severity === "critical" ? "bg-red-500/10 border-red-500/20" : "bg-orange-500/10 border-orange-500/20"
                    )}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className={cn(
                        ...
                        isFixPending ? "bg-amber-500/5 border-amber-500/20" : "bg-emerald-500/5 border-emerald-500/10"
                      )}>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-xs font-bold text-slate-200">
                              {isFixPending ? "Fix Pending Guardian Approval" : "Automated Fix Available"}
                            </div>
                  ...
                  <div className="shrink-0 text-right">
                    ...
                    <div className="mt-3 flex flex-col items-end gap-1.5">
                      <span className={cn(
                        ...
                        exp.status === "open" ? "text-red-400 border-red-500/30 bg-red-500/5" :
                        exp.status === "fix-pending" ? "text-amber-400 border-amber-500/30 bg-amber-500/5" :
