...
export const nexusApi = {
  ...
  getResearch: (id: string) => req<import('./types').ResearchRun>(`/research/${id}`),

  listResearch: () => req<import('./types').ResearchRun[]>('/research'),
  ...
  listPatterns: () => req<import('./types').PatternFamily[]>('/patterns'),
  ...
  getOrchestration: (id: string) => req<import('./types').OrchestrationPlan>(`/orchestrate/${id}`),

  listOrchestrations: () => req<import('./types').OrchestrationPlan[]>('/orchestrate'),

  listIngestJobs: () => req<import('./types').IngestJob[]>('/ingest'),
  ...
  getIngestJob: (id: string) => req<import('./types').IngestJob>(`/ingest/${id}`),
