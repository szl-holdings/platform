...
const PILLARS = [
  ...
  },
  {
    ...
    description:
      'Routes user intents to the right artifact — PARAGON, SEXTANT, DOMAINE, LUMINA, Command, SZL Holdings, Carlota Jo, KORA, Prism Counsel, Imperium — via the API server and stitches multi-app workflows together.',
