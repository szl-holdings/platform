TERRA (@terra_re) — X (TWITTER) LAUNCH KIT
===========================================

Subaccount kit forked from the parent @szlholdings template. Same grammar,
Terra-green accent, SZL affiliate badge baked into avatar, header and bio.

Quick start (plug-and-play):

 1. Open bio.md. Copy Name, Handle, Bio (use the Primary one), Location and
    Website into x.com/settings/profile for @terra_re.
