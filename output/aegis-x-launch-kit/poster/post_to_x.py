#!/usr/bin/env python3
"""Post the 5 Aegis (@aegis_soc) launch posts to X.
...
granted from the @aegis_soc subaccount (NOT the @szlholdings parent — the
parent has its own kit at ../../szl-x-launch-kit/). Generate them at
developer.x.com → your @aegis_soc Project → App → "Keys and tokens".
"""
