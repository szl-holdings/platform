#!/usr/bin/env python3
"""Post the 9 launch-kit posts (plus the doctrine thread) to X.

Reads the post plan from post_plan.json (co-located), uploads the matching
image attachment from ../screenshots/, and creates the tweet via the X API v2
...
Usage:
    ...
    python3 post_to_x.py --live --only 1 # post only post #1 (1-indexed)
...
granted from the @szlholdings account. Get them from
developer.x.com → your Project → App → "Keys and tokens".
"""
