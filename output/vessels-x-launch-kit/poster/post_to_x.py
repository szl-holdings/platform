#!/usr/bin/env python3
"""Post the 5 Vessels (@vessels_maritime) launch posts to X.
...
granted from the @vessels_maritime subaccount (NOT the @szlholdings parent —
the parent has its own kit at ../../szl-x-launch-kit/). Generate them at
developer.x.com → your @vessels_maritime Project → App → "Keys and tokens".
"""
