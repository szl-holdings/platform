...
> = {
  ...
  alloy: {
    ...
    description:
      'Alloy — execution fabric, connectors, automations, DAGs, and predictive intelligence engine across the SZL platform. Microsoft 365 integration surfaces SharePoint workflow attachments and Teams notifications.',
    liveFeeds: [
  ...
  dreamscape: {
    ...
    description:
      'Alloy predictive intelligence layer — scenario modeling, confidence scoring, and prediction surfaces using HuggingFace Hub model discovery and media analytics benchmarks. Absorbed into Alloy.',
    liveFeeds: [
      'HuggingFace Hub — AI Creative Tools (live API)',
