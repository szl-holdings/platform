...
> = {
  ...
  alloy: {
    ...
    description:
      'Counsel — execution fabric, connectors, automations, DAGs, and predictive intelligence engine across the SZL platform. Microsoft 365 integration surfaces SharePoint workflow attachments and Teams notifications.',
    liveFeeds: [
  ...
  dreamscape: {
    ...
    description:
      'Counsel predictive intelligence layer — scenario modeling, confidence scoring, and prediction surfaces using HuggingFace Hub model discovery and media analytics benchmarks. Absorbed into Alloy.',
    liveFeeds: [
      'HuggingFace Hub — AI Creative Tools (live API)',
  ...
  inca: {
    ...
    description:
      'AI research platform with live arXiv multi-category papers, Semantic Scholar citation graph, PapersWithCode ML benchmarks, HuggingFace Hub model discovery, and research trend monitoring across cs.CL, cs.CR, cs.CV.',
    liveFeeds: [
  ...
  'control-plane': {
    ...
    description:
      'Admin panel monitors all connectors and live feeds across the platform including government, OSINT, and Microsoft 365 adapters.',
    liveFeeds: [
  ...
  'carlota-jo': {
    ...
    description:
      'Luxury advisory booking uses World Bank live GDP indicators, BLS employment data, Harvard Business Review strategic news RSS, and consulting industry trend intelligence. Outlook Calendar integration provides real booking availability and Outlook Contacts sync with the CRM.',
    liveFeeds: [
