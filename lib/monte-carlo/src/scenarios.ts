...
export const TERRA_PROPERTY_RETURNS: ScenarioDefinition = {
  ...
  description:
    'Simulates IRR and equity multiple for a real estate investment over a 5-year hold period.',
  domain: 'terra',
  ...
  outputs: [
    {
      ...
      format: 'percentage',
      higherIsBetter: true,
      thresholds: { excellent: 20, good: 12, poor: 6 },
    },
...
export const SZL_FUND_EXIT: ScenarioDefinition = {
  ...
  description:
    'Models fund exit returns across portfolio companies with market condition uncertainty.',
  domain: 'szl',
  ...
  outputs: [
    {
      ...
      format: 'number',
      higherIsBetter: true,
      thresholds: { excellent: 4, good: 2.5, poor: 1.5 },
    },
    {
      id: 'irr',
      label: 'IRR (%)',
      format: 'percentage',
      higherIsBetter: true,
      thresholds: { excellent: 30, good: 20, poor: 10 },
    },
...
export const PRISM_LITIGATION_OUTCOME: ScenarioDefinition = {
  ...
  description:
    'Predicts verdict ranges, settlement probability, and total legal cost for active matters.',
  domain: 'prism',
  ...
  outputs: [
    ...
    {
      id: 'directCost',
      label: 'Direct Verdict/Settlement ($M)',
      format: 'currency',
      higherIsBetter: false,
    },
...
export const AEGIS_CYBER_RISK: ScenarioDefinition = {
  ...
  description:
    'Quantifies annual expected loss from cyber incidents including breach probability, impact, and recovery.',
  domain: 'aegis',
  ...
  outputs: [
    {
      id: 'annualExpectedLoss',
      label: 'Annual Expected Loss ($M)',
      format: 'currency',
      higherIsBetter: false,
    },
    {
      id: 'grossLossIfBreached',
      label: 'Gross Loss if Breached ($M)',
      format: 'currency',
      higherIsBetter: false,
    },
    {
      id: 'netLossIfBreached',
      label: 'Net Loss After Insurance ($M)',
      format: 'currency',
      higherIsBetter: false,
    },
    {
      id: 'dataBreachCost',
      label: 'Data Breach Cost ($M)',
      format: 'currency',
      higherIsBetter: false,
    },
  ],
...
export const NEXUS_GEOPOLITICAL_CASCADE: ScenarioDefinition = {
  ...
  description:
    'Models cascading economic and operational impact of geopolitical events on portfolio operations.',
  domain: 'nexus',
  ...
  outputs: [
    ...
    {
      id: 'impactMagnitude',
      label: 'Impact Magnitude (0-1)',
      format: 'number',
      higherIsBetter: false,
    },
    {
      id: 'annualExpectedImpact',
      label: 'Annual Expected Impact ($M)',
      format: 'currency',
      higherIsBetter: false,
    },
    {
...
export const LYTE_CAPACITY_PLANNING: ScenarioDefinition = {
  ...
  description:
    'Models infrastructure capacity requirements given demand growth, failure rates, and scaling triggers.',
  domain: 'lyte',
  ...
  outputs: [
    ...
    {
      id: 'totalTcoThousands',
      label: '3-Year TCO ($000)',
      format: 'currency',
      higherIsBetter: false,
    },
    {
      id: 'expectedDowntimeHours',
...
export const SCENARIO_VARIANTS: Record<
  string,
  Array<{ id: string; label: string; description: string; overrides: Record<string, unknown> }>
> = {
  ...
  [SZL_FUND_EXIT.id]: [
    { id: 'base', label: 'Base Case', description: 'Expected fund performance', overrides: {} },
    {
      ...
      overrides: {
        revenueGrowthCagr: { distribution: { type: 'normal', mean: 0.4, stdDev: 0.08 } },
