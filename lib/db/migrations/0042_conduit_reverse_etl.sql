-- Conduit Reverse ETL schema
-- Creates 6 tables and their enum types for the Conduit data routing product.
...
DO $$ BEGIN
  CREATE TYPE conduit_mapping_transform AS ENUM ('uppercase', 'lowercase', 'concat', 'split', 'format_date', 'lookup', 'json_extract', 'constant', 'conditional');
EXCEPTION WHEN duplicate_object THEN null; END $$;
