import { pgTable, text, timestamp, bigserial, jsonb, integer, index } from "drizzle-orm/pg-core";
...
export const insertChangeEventSchema = createInsertSchema(changeEventsTable).omit({ cursor: true, timestamp: true });
