...
export const szlDecisioningRunsTable = pgTable("szl_decisioning_runs", {
...
export const szlDecisioningRecommendationsTable = pgTable("szl_decisioning_recommendations", {
  id: serial("id").primaryKey(),
  ...
  urgency: text("urgency", { enum: ["routine", "moderate", "urgent", "critical"] }).notNull().default("routine"),
...
export const szlPolicyViolationsTable = pgTable("szl_policy_violations", {
  id: serial("id").primaryKey(),
  policyId: text("policy_id").notNull(),
  policyName: text("policy_name"),
  ruleName: text("rule_name"),
  effect: text("effect", { enum: ["block", "require_approval", "warn"] }).notNull().default("block"),
...
export const insertSzlDecisioningRunSchema = createInsertSchema(szlDecisioningRunsTable).omit({ id: true, createdAt: true });
...
export const insertSzlDecisioningRecommendationSchema = createInsertSchema(szlDecisioningRecommendationsTable).omit({ id: true, createdAt: true });
export type InsertSzlDecisioningRecommendation = z.infer<typeof insertSzlDecisioningRecommendationSchema>;
export type SzlDecisioningRecommendation = typeof szlDecisioningRecommendationsTable.$inferSelect;

export const insertSzlPolicyViolationSchema = createInsertSchema(szlPolicyViolationsTable).omit({ id: true, createdAt: true });
