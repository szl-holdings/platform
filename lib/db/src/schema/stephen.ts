...
export const insertStephenContentBlockSchema = createInsertSchema(stephenContentBlocksTable).omit({ id: true, createdAt: true });
...
export const insertStephenCaseStudySchema = createInsertSchema(stephenCaseStudiesTable).omit({ id: true, createdAt: true });
...
export const insertStephenBookingRequestSchema = createInsertSchema(stephenBookingRequestsTable).omit({ id: true, createdAt: true, status: true });
