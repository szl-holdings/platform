...
export const insertAgentTrainingPairSchema = createInsertSchema(agentTrainingPairs).omit({
  id: true,
  createdAt: true,
});
...
export const insertAdvisoryAuditSchema = createInsertSchema(advisoryAudit).omit({
  id: true,
  createdAt: true,
  actionedAt: true,
});
