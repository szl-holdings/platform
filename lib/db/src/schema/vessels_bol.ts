import { pgTable, text, serial, integer, numeric, boolean, timestamp, uniqueIndex, index } from "drizzle-orm/pg-core";
...
export const insertVesselsBolChainEventSchema = createInsertSchema(vesselsBolChainEventsTable).omit({ id: true, createdAt: true });
