...
export const workspaceConstitutionsTable = pgTable(
  'workspace_constitutions',
  {
...
export const decisionsRuntimeTable = pgTable(
  'decisions_runtime',
  {
    id: serial('id').primaryKey(),
...
export const decisionEvidenceTable = pgTable(
  'decision_evidence',
  {
    id: serial('id').primaryKey(),
  ...
  (t) => [index('de_card_id_idx').on(t.cardId), index('de_workspace_id_idx').on(t.workspaceId)],
);
...
export const decisionValidationsTable = pgTable(
...
export const decisionRunsTable = pgTable(
  'decision_runs',
  {
    id: serial('id').primaryKey(),
    cardId: text('card_id').notNull(),
...
export const decisionAuditEventsTable = pgTable(
