...
export const fundPortfolioFinancialsTable = pgTable(
  'fund_portfolio_financials',
  {
    id: serial('id').primaryKey(),
    companySlug: text('company_slug').notNull(),
    companyName: text('company_name').notNull(),
    periodType: text('period_type', { enum: ['monthly', 'quarterly', 'annual'] })
      .notNull()
      .default('quarterly'),
    periodLabel: text('period_label').notNull(),
    periodStart: text('period_start').notNull(),
    periodEnd: text('period_end').notNull(),
    reportingStatus: text('reporting_status', { enum: ['draft', 'submitted', 'reviewed', 'final'] })
      .notNull()
      .default('draft'),
...
export const fundPortfolioKpisTable = pgTable(
  'fund_portfolio_kpis',
  {
    id: serial('id').primaryKey(),
    companySlug: text('company_slug').notNull(),
...
export const fundFormDFilingsTable = pgTable(
  'fund_form_d_filings',
  {
    id: serial('id').primaryKey(),
    entityName: text('entity_name').notNull(),
    cikNumber: text('cik_number'),
    filingType: text('filing_type', { enum: ['initial', 'amendment', 'annual_amendment'] })
      .notNull()
      .default('initial'),
    exemption: text('exemption', {
      enum: ['rule_506b', 'rule_506c', 'rule_504', 'rule_505', 'other'],
    })
      .notNull()
      .default('rule_506b'),
    ...
    status: text('status', { enum: ['pending', 'filed', 'amended', 'closed'] })
      .notNull()
      .default('pending'),
    regDStatus: text('reg_d_status', { enum: ['compliant', 'review_needed', 'non_compliant'] })
      .notNull()
...
export const fundAccreditedInvestorsTable = pgTable(
  'fund_accredited_investors',
  {
    id: serial('id').primaryKey(),
    lpName: text('lp_name').notNull(),
    lpType: text('lp_type', {
      enum: ['individual', 'entity', 'trust', 'fund_of_funds', 'family_office'],
    })
      .notNull()
      .default('individual'),
    accreditationBasis: text('accreditation_basis', {
      ...
      .notNull()
      .default('net_worth_1m'),
    verificationMethod: text('verification_method', {
      enum: [
        'self_certification',
        'third_party_verification',
        'letter_from_cpa',
        'letter_from_attorney',
        'finra_check',
      ],
    })
      .notNull()
      .default('self_certification'),
...
export const fundLpReportsTable = pgTable(
  'fund_lp_reports',
  {
    id: serial('id').primaryKey(),
    ...
    status: text('status', {
      enum: ['draft', 'under_review', 'approved', 'distributed', 'archived'],
    })
      .notNull()
      .default('draft'),
...
export const fundShareClassesTable = pgTable(
  'fund_share_classes',
  {
    id: serial('id').primaryKey(),
    ...
    antiDilutionProvision: text('anti_dilution_provision', {
      enum: [
        'none',
  ...
  (t) => [index('fund_share_classes_type_idx').on(t.classType)],
);

export const fundCapTableHoldersTable = pgTable(
  'fund_cap_table_holders',
  {
    id: serial('id').primaryKey(),
    name: text('name').notNull(),
  ...
  (t) => [index('fund_holders_type_idx').on(t.holderType)],
);

export const fundCapTableTransactionsTable = pgTable(
  'fund_cap_table_transactions',
  {
    id: serial('id').primaryKey(),
    holderId: integer('holder_id')
      .notNull()
      .references(() => fundCapTableHoldersTable.id, { onDelete: 'restrict' }),
    shareClassId: integer('share_class_id')
      .notNull()
      .references(() => fundShareClassesTable.id, { onDelete: 'restrict' }),
...
export const fundVestingSchedulesTable = pgTable(
  'fund_vesting_schedules',
  {
    id: serial('id').primaryKey(),
    holderId: integer('holder_id')
      .notNull()
      .references(() => fundCapTableHoldersTable.id, { onDelete: 'restrict' }),
    shareClassId: integer('share_class_id').references(() => fundShareClassesTable.id, {
      onDelete: 'set null',
    }),
    ...
    accelerationTrigger: text('acceleration_trigger', {
  ...
  (t) => [index('fund_vesting_holder_idx').on(t.holderId)],
);

// ─── FUND ADMINISTRATION ──────────────────────────────────────────────────────

export const fundCapitalCallsTable = pgTable(
  'fund_capital_calls',
  {
    id: serial('id').primaryKey(),
    ...
    status: text('status', {
      enum: ['draft', 'notices_sent', 'partially_funded', 'fully_funded', 'overdue', 'cancelled'],
    })
      .notNull()
      .default('draft'),
...
export const fundLpCapitalAccountsTable = pgTable(
  'fund_lp_capital_accounts',
  {
    id: serial('id').primaryKey(),
    lpId: integer('lp_id')
      .notNull()
      .references(() => fundAccreditedInvestorsTable.id, { onDelete: 'restrict' }),
  ...
  (t) => [index('fund_lp_accounts_lp_idx').on(t.lpId)],
);

export const fundCapitalCallLinesTable = pgTable(
  'fund_capital_call_lines',
  {
    id: serial('id').primaryKey(),
    capitalCallId: integer('capital_call_id')
      .notNull()
      .references(() => fundCapitalCallsTable.id, { onDelete: 'cascade' }),
    lpId: integer('lp_id')
      .notNull()
      .references(() => fundAccreditedInvestorsTable.id, { onDelete: 'restrict' }),
    ...
    status: text('status', { enum: ['pending', 'received', 'overdue', 'waived'] })
      .notNull()
      .default('pending'),
    notes: text('notes'),
    createdAt: timestamp('created_at').notNull().defaultNow(),
...
export const fundDistributionsTable = pgTable(
  'fund_distributions',
  {
    id: serial('id').primaryKey(),
    ...
    source: text('source'),
    status: text('status', {
      enum: ['planned', 'approved', 'processing', 'completed', 'cancelled'],
    })
      .notNull()
      .default('planned'),
...
export const fundDistributionLinesTable = pgTable(
  'fund_distribution_lines',
  {
    id: serial('id').primaryKey(),
    distributionId: integer('distribution_id')
      .notNull()
      .references(() => fundDistributionsTable.id, { onDelete: 'cascade' }),
    lpId: integer('lp_id')
      .notNull()
      .references(() => fundAccreditedInvestorsTable.id, { onDelete: 'restrict' }),
    ...
    paymentReference: text('payment_reference'),
    status: text('status', { enum: ['pending', 'sent', 'confirmed', 'returned'] })
      .notNull()
      .default('pending'),
    notes: text('notes'),
    createdAt: timestamp('created_at').notNull().defaultNow(),
...
export const fundNavRecordsTable = pgTable(
  'fund_nav_records',
  {
    id: serial('id').primaryKey(),
    ...
    uncalledCommitmentsCents: bigint('uncalled_commitments_cents', { mode: 'number' })
      .notNull()
      .default(0),
    ...
    managementFeesPaidCents: bigint('management_fees_paid_cents', { mode: 'number' })
      .notNull()
      .default(0),
  ...
  (t) => [index('fund_nav_date_idx').on(t.navDate)],
);

export const fundCapTableAuditLogTable = pgTable(
  'fund_cap_table_audit_log',
  {
    id: serial('id').primaryKey(),
    entityType: text('entity_type').notNull(),
    entityId: text('entity_id').notNull(),
    actionType: text('action_type', {
      enum: ['create', 'update', 'delete', 'convert', 'vest', 'exercise'],
    }).notNull(),
...
export const fundLpDataRoomDocsTable = pgTable(
  'fund_lp_data_room_docs',
  {
    id: serial('id').primaryKey(),
    name: text('name').notNull(),
    folder: text('folder').notNull(),
    fileType: text('file_type', { enum: ['pdf', 'xlsx', 'pptx', 'docx', 'csv', 'other'] })
      .notNull()
      .default('pdf'),
...
export const fundLpMessagesTable = pgTable(
  'fund_lp_messages',
  {
    id: serial('id').primaryKey(),
    lpId: integer('lp_id')
...
export const fundLpActivityEventsTable = pgTable(
  'fund_lp_activity_events',
  {
    id: serial('id').primaryKey(),
    lpId: integer('lp_id')
      .notNull()
      .references(() => fundAccreditedInvestorsTable.id, { onDelete: 'cascade' }),
    action: text('action', {
      enum: ['viewed', 'downloaded', 'messaged_gp', 'logged_in'],
    }).notNull(),
    target: text('target').notNull(),
    documentId: integer('document_id').references(() => fundLpDataRoomDocsTable.id, {
      onDelete: 'set null',
    }),
    reportId: integer('report_id').references(() => fundLpReportsTable.id, {
      onDelete: 'set null',
    }),
...
export const insertFundPortfolioFinancialSchema = createInsertSchema(
...
export const insertFundPortfolioKpiSchema = createInsertSchema(fundPortfolioKpisTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundFormDFilingSchema = createInsertSchema(fundFormDFilingsTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundAccreditedInvestorSchema = createInsertSchema(
...
export const insertFundLpReportSchema = createInsertSchema(fundLpReportsTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundShareClassSchema = createInsertSchema(fundShareClassesTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundCapTableHolderSchema = createInsertSchema(fundCapTableHoldersTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundCapTableTransactionSchema = createInsertSchema(
...
export const insertFundVestingScheduleSchema = createInsertSchema(fundVestingSchedulesTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundCapitalCallSchema = createInsertSchema(fundCapitalCallsTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundLpCapitalAccountSchema = createInsertSchema(fundLpCapitalAccountsTable).omit(
...
export const insertFundCapitalCallLineSchema = createInsertSchema(fundCapitalCallLinesTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundDistributionSchema = createInsertSchema(fundDistributionsTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundDistributionLineSchema = createInsertSchema(fundDistributionLinesTable).omit(
  { id: true, createdAt: true, updatedAt: true },
);
...
export const insertFundNavRecordSchema = createInsertSchema(fundNavRecordsTable).omit({
  id: true,
  createdAt: true,
});
...
export const insertFundLpDataRoomDocSchema = createInsertSchema(fundLpDataRoomDocsTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertFundLpMessageSchema = createInsertSchema(fundLpMessagesTable).omit({
  id: true,
  sentAt: true,
});
...
export const insertFundLpActivityEventSchema = createInsertSchema(fundLpActivityEventsTable).omit({
  id: true,
  occurredAt: true,
});
