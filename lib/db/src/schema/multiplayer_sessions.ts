 ...
 */
export const commandSessionsTable = pgTable(
  'command_sessions',
  {
...
export const commandSessionCommentsTable = pgTable(
  'command_session_comments',
  {
    id: serial('id').primaryKey(),
...
export const insertCommandSessionSchema = createInsertSchema(commandSessionsTable).omit({
  id: true,
  createdAt: true,
  lastActivityAt: true,
});
...
export const insertCommandSessionCommentSchema = createInsertSchema(
