...
export const atlasArtifactsTable = pgTable("atlas_artifacts", {
...
export const atlasExportJobsTable = pgTable("atlas_export_jobs", {
  id: serial("id").primaryKey(),
  orgId: integer("org_id").references(() => organizationsTable.id, { onDelete: "cascade" }),
  artifactId: integer("artifact_id").notNull().references(() => atlasArtifactsTable.id, { onDelete: "cascade" }),
