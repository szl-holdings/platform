...
export const connectorsTable = pgTable("connectors", {
  ...
  type: text("type", { enum: ["stripe", "slack", "twilio", "google", "notion", "github", "shopify", "salesforce", "hubspot", "dynamics365", "custom"] }).notNull(),
  syncStatus: text("sync_status", { enum: ["idle", "syncing", "success", "error"] }).default("idle"),
...
export const insertConnectorLogSchema = createInsertSchema(connectorLogsTable).omit({ id: true, createdAt: true });
