...
export const tradingInstrumentTypeEnum = pgEnum("trading_instrument_type", [
  "freight_futures", "bunker_fuel", "dry_bulk", "wet_bulk", "container_rate", "lng_spot", "iron_ore_swap"
]);
...
export const insertCommodityTradingOrderSchema = createInsertSchema(commodityTradingOrdersTable).omit({ id: true, createdAt: true, updatedAt: true });
export const insertCommodityTradingPositionSchema = createInsertSchema(commodityTradingPositionsTable).omit({ id: true, createdAt: true });
export const insertCommodityTradingFillSchema = createInsertSchema(commodityTradingFillsTable).omit({ id: true, createdAt: true });
