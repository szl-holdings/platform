...
export const insertFineTuningJobSchema = createInsertSchema(fineTuningJobs).omit({ id: true, createdAt: true, updatedAt: true });
export const insertFineTunedModelSchema = createInsertSchema(fineTunedModelRegistry).omit({ id: true, registeredAt: true });
export const insertFineTuningDatasetSchema = createInsertSchema(fineTuningDatasets).omit({ id: true, createdAt: true });
