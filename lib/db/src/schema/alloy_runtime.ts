...
export const insertAlloyRuntimeWorkflowSchema = createInsertSchema(
  alloyRuntimeWorkflowsTable,
...
export const insertAlloyRuntimeAgentSchema = createInsertSchema(
...
export const insertAlloyRuntimePromptSchema = createInsertSchema(
  alloyRuntimePromptsTable,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertAlloyRuntimeModelSchema = createInsertSchema(
  alloyRuntimeModelsTable,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertAlloyRuntimeSignalSchema = createInsertSchema(
  alloyRuntimeSignalsTable,
).omit({ id: true, createdAt: true });
...
export const insertAlloyRuntimeActionSchema = createInsertSchema(
  alloyRuntimeActionsTable,
).omit({ id: true, createdAt: true });
