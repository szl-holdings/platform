...
export type ProofReviewState = 'unreviewed' | 'reviewed' | 'approved' | 'flagged' | 'retracted';

export type ProofExportSafetyState = 'safe' | 'restricted' | 'blocked' | 'pending_review';

export const proofChainTable = pgTable(
  'proof_chain',
  {
