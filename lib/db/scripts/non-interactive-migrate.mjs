...
import { DB_DIR, computeSchemaHash } from './_schema-hash.mjs';
...
// Schema hashing lives in ./_schema-hash.mjs (shared with the author-time
// check:schema-sync guardrail — task #5057). The runtime marker row and the
// committed _schema_hash.json marker file MUST stay comparable, so both
// callers use the exact same hash function.
