...
registerDataset({
  ...
  cases: [
    ...
    },
    {
      ...
      input: {
        signals: [
          { type: "ais_gap", duration_minutes: 25, vessel_id: "vsl_test_002" },
        ],
    ...
    },
    {
      ...
      input: {
        ...
        entity_context: { vessel_type: "general_cargo", flag_state: "Liberia", risk_history: "high" },
        policy_context: { applicable_policies: ["maritime_sanctions_001", "cargo_verification_001"] },
      },
      expected_output: {
        inference_type: "risk_assessment",
        confidence_min: 0.70,
    ...
    },
    {
      ...
      input: {
        ...
        entity_context: { vessel_type: "container_ship", flag_state: "Denmark", risk_history: "none" },
        policy_context: { applicable_policies: ["maritime_monitoring_001"] },
      },
      expected_output: {
        inference_type: "risk_assessment",
  ...
  cases: [
    ...
    },
    {
      ...
      input: {
        ...
        entity_context: { dwt: 300000, fuel_type: "HFO", charter_type: "spot", current_market_rate: "below_breakeven" },
        policy_context: { applicable_policies: ["voyage_economics_001"] },
      },
      expected_output: {
        inference_type: "voyage_pnl",
...
registerDataset({
  ...
  description: "Security threat triage eval — intrusion detection, access anomalies, vulnerability assessment",
  cases: [
    {
      case_id: "sec_001",
      ...
      input: {
        signals: [{ type: "vulnerability", cvss: 9.8, cve: "CVE-2026-0001", exploit_available: true, asset_tier: "production" }],
    ...
    },
    {
      ...
      input: {
        signals: [{ type: "vulnerability", cvss: 3.1, exploit_available: false, asset_tier: "staging" }],
