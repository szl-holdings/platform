...
export class SalesforceConnector extends ToolConnector {
  ...
  readonly description =
    'Salesforce CRM — accounts, contacts, opportunities, leads, cases, pipeline health, SOQL queries, and real-time CDC event streaming';
  ...
  readonly authConfig: AuthConfig = {
    ...
    description:
      'Connected App OAuth 2.0. Create a Connected App in Salesforce Setup > App Manager.',
  };
  ...
  readonly capabilities: Capability[] = [
      ...
      parameters: [
        {
          name: 'limit',
          type: 'number',
          description: 'Maximum cases to return (default 50)',
          required: false,
        },
        {
          name: 'escalatedOnly',
          type: 'boolean',
          description: 'Only return escalated cases (default false)',
          required: false,
        },
      ],
      requiresAuth: true,
      ...
      parameters: [
        {
          name: 'limit',
          type: 'number',
          description: 'Maximum leads to return (default 50)',
          required: false,
        },
      ],
      requiresAuth: true,
    ...
    },
    {
      ...
      name: 'Ingest Signals',
      description:
        'Ingest Salesforce signals (escalated cases, stale opportunities, new high-value leads) for platform analysis',
      parameters: [],
      requiresAuth: true,
      tags: ['read', 'signals'],
    },
    {
      ...
      parameters: [
        ...
        },
        {
          name: 'accountId',
          type: 'string',
          description: 'Salesforce account ID to associate',
          required: false,
        },
        {
          name: 'contactId',
          type: 'string',
          description: 'Salesforce contact ID to associate',
          required: false,
        },
      ],
      requiresAuth: true,
