...
export class GroqConnector extends ToolConnector {
  readonly id = "groq";
  readonly name = "Groq";
  readonly description = "Groq — ultra-fast LLM inference via LPU hardware. Supports Llama 3, Mixtral, Gemma, and Whisper with industry-leading token throughput";
  ...
  readonly capabilities: Capability[] = [
    {
      ...
      parameters: [
        { name: "model", type: "string", description: "Model ID: llama3-70b-8192, llama3-8b-8192, mixtral-8x7b-32768, gemma2-9b-it", required: false },
        { name: "messages", type: "array", description: "Array of {role, content} message objects", required: true },
        { name: "maxTokens", type: "number", description: "Maximum tokens to generate (default 1024)", required: false },
        { name: "temperature", type: "number", description: "Sampling temperature 0.0–2.0 (default 0.7)", required: false },
        { name: "stream", type: "boolean", description: "Enable streaming (not supported via connector hub — returns full response)", required: false },
      ],
      requiresAuth: true,
    ...
    },
    {
      ...
      parameters: [
        { name: "audioUrl", type: "string", description: "URL of the audio file to transcribe", required: true },
        { name: "language", type: "string", description: "Language code (e.g. en, es, fr — default: auto-detect)", required: false },
        { name: "model", type: "string", description: "Whisper model: whisper-large-v3 (default)", required: false },
      ],
      requiresAuth: true,
