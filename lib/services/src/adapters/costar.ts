...
const MOCK_COSTAR_PROPERTIES: CoStarProperty[] = [
  {
    ...
    askingRentPerSqft: 62.5,
    effectiveRentPerSqft: 54.0,
    capRate: 5.8,
    lastSalePrice: 185000000,
    lastSaleDate: '2021-08-15',
    tenants: [
      {
        tenantName: 'Creative Media Group',
        leaseExpiration: '2026-12-31',
        leasedSqft: 18500,
        floorOccupied: '5-6',
      },
      {
        tenantName: 'Allied Financial Partners',
  ...
  },
  {
    ...
    askingRentPerSqft: 89.0,
    effectiveRentPerSqft: 82.0,
    capRate: 4.7,
    ...
    tenants: [
      {
        ...
        leaseExpiration: '2029-03-31',
        leasedSqft: 85000,
        floorOccupied: '15-19',
      },
      {
        tenantName: 'Law Partners LLP',
        leaseExpiration: '2027-09-30',
        leasedSqft: 42000,
        floorOccupied: '22-23',
      },
      {
        tenantName: 'Venture Capital Fund IV',
  ...
  },
  {
    ...
    askingRentPerSqft: 38.0,
    effectiveRentPerSqft: 36.5,
    capRate: 5.2,
    lastSalePrice: null,
    lastSaleDate: null,
    tenants: [
      {
        tenantName: 'Artisan Foods Co',
        leaseExpiration: '2028-06-30',
        leasedSqft: 35000,
        floorOccupied: '1-2',
      },
      {
        tenantName: 'Creative Studio Hub',
        leaseExpiration: '2026-12-31',
        leasedSqft: 28000,
        floorOccupied: '3',
      },
  ...
  },
  {
    ...
    askingRentPerSqft: 95.0,
    effectiveRentPerSqft: 88.0,
    capRate: 5.5,
  ...
  },
  {
    ...
    askingRentPerSqft: 28.0,
    effectiveRentPerSqft: 28.0,
    capRate: 5.8,
    lastSalePrice: 42000000,
    lastSaleDate: '2023-05-08',
    tenants: [
      {
        tenantName: 'Regional Logistics Corp',
        leaseExpiration: '2031-12-31',
        leasedSqft: 185000,
        floorOccupied: 'Full Building',
      },
    ],
...
const MOCK_MARKET_STATS: CoStarMarketStats[] = [
  {
    ...
    propertyType: 'Office',
    vacancyRate: 18.4,
    netAbsorptionSqft: -245000,
    avgAskingRentPerSqft: 98.5,
    completionsSqft: 0,
    underConstructionSqft: 1200000,
    capRateAvg: 5.1,
    pricePerSqft: 1250,
    salesVolume: 2100000000,
    period: 'Q4 2025',
  },
  {
    ...
    propertyType: 'Office',
    vacancyRate: 14.1,
    netAbsorptionSqft: 85000,
    avgAskingRentPerSqft: 82.0,
    completionsSqft: 350000,
    underConstructionSqft: 800000,
    capRateAvg: 4.8,
    pricePerSqft: 1050,
    salesVolume: 780000000,
    period: 'Q4 2025',
  },
  {
    submarket: 'Brooklyn Industrial',
    propertyType: 'Industrial',
    vacancyRate: 5.8,
    netAbsorptionSqft: 320000,
    avgAskingRentPerSqft: 35.5,
    completionsSqft: 410000,
    underConstructionSqft: 650000,
    capRateAvg: 5.0,
    pricePerSqft: 420,
    salesVolume: 540000000,
    period: 'Q4 2025',
  },
  {
    submarket: 'Queens Boulevard',
    propertyType: 'Retail',
    vacancyRate: 9.2,
    netAbsorptionSqft: 42000,
    avgAskingRentPerSqft: 78.0,
    completionsSqft: 0,
    underConstructionSqft: 85000,
    capRateAvg: 5.6,
    pricePerSqft: 680,
...
const MOCK_SALE_COMPS: CoStarSaleComp[] = [
  {
    ...
    zipCode: '10171',
    propertyType: 'Office',
    rentableArea: 1250000,
    salePrice: 1800000000,
    pricePerSqft: 1440,
    capRate: 4.2,
    saleDate: '2025-11-15',
    buyerName: 'Sovereign Wealth Fund III',
    sellerName: 'Park Avenue Partners',
  },
  {
    compId: 'cs-comp-002',
    address: '555 W 34th St',
    city: 'New York',
    state: 'NY',
    zipCode: '10001',
    propertyType: 'Industrial',
    ...
    capRate: 5.1,
    saleDate: '2025-10-22',
    buyerName: 'Prologis NYC Fund',
    sellerName: 'Hudson Yards Industrial LLC',
  },
  {
    compId: 'cs-comp-003',
    address: '180 Atlantic Ave',
    city: 'Brooklyn',
    state: 'NY',
    zipCode: '11201',
    propertyType: 'Retail',
    ...
    capRate: 5.8,
    saleDate: '2025-09-14',
    buyerName: 'Brooklyn Retail Partners',
    sellerName: 'Atlantic Properties Group',
  },
  {
    compId: 'cs-comp-004',
    address: '3250 Grand Concourse',
    city: 'Bronx',
    state: 'NY',
    zipCode: '10468',
    ...
    capRate: 6.2,
    saleDate: '2025-12-01',
    buyerName: 'Bronx Multifamily LLC',
    sellerName: 'Grand Concourse Holdings',
  },
];
...
export class CoStarAdapter extends ServiceAdapter {
  ...
  readonly requiredEnvVars = ['COSTAR_API_KEY', 'COSTAR_CLIENT_ID'];
  ...
  async getSaleComps(
    ...
    if (!this.isLive) {
      ...
      if (params.propertyType) {
        comps = comps.filter(
          (c) => c.propertyType.toLowerCase() === params.propertyType!.toLowerCase(),
        );
      }
