...
const MOCK_MLS_LISTINGS: MlsListing[] = [
  {
    ...
    media: [
      { mediaUrl: 'https://example.com/mls/rbny-2024001-01.jpg', mediaType: 'Photo', order: 1 },
    ],
    listAgentFullName: 'Sarah Chen',
    listOfficeName: 'REBNY Premier Realty',
    publicRemarks:
      'Stunning 3BR/2BA condo with floor-to-ceiling windows and Hudson River views. High-floor unit in boutique doorman building.',
    mlsName: 'REBNY RLS',
  },
  {
    ...
    publicRemarks:
      'Sunny pre-war co-op with original hardwood floors and exposed brick. Pets allowed.',
    mlsName: 'REBNY RLS',
  },
  {
    ...
    publicRemarks:
      "Penthouse duplex with private rooftop terrace. Panoramic views of the East River. Chef's kitchen.",
    mlsName: 'REBNY RLS',
  },
  {
    ...
    publicRemarks:
      'Pristine colonial in top-rated school district. Updated kitchen, finished basement. Close to Metro-North.',
    mlsName: 'OneKey MLS',
  },
  {
    ...
    publicRemarks:
      'Charming expanded ranch, meticulously maintained. New roof, updated electric, large deck with seasonal water views.',
    mlsName: 'OneKey MLS',
  },
];
...
export class ResoMlsAdapter extends ServiceAdapter {
  ...
  private async odataRequest(
    resource: string,
    params: ODataQueryParams,
  ): Promise<{ value: unknown[]; '@odata.count'?: number }> {
