  ...
  facts: {
    "us-gaap": {
      Revenues: {
        ...
        units: {
          USD: [
            { end: "2025-09-27", val: 391035000000, accn: "0000320193-25-000001", fy: 2025, fp: "FY", form: "10-K", filed: "2025-11-01" },
            { end: "2024-09-28", val: 391035000000, accn: "0000320193-24-000001", fy: 2024, fp: "FY", form: "10-K", filed: "2024-11-01" },
          ],
        },
      },
      NetIncomeLoss: {
        ...
        units: {
          USD: [
            { end: "2025-09-27", val: 93736000000, accn: "0000320193-25-000001", fy: 2025, fp: "FY", form: "10-K", filed: "2025-11-01" },
            { end: "2024-09-28", val: 93736000000, accn: "0000320193-24-000001", fy: 2024, fp: "FY", form: "10-K", filed: "2024-11-01" },
          ],
        },
      },
    },
...
export class SecEdgarAdapter extends ServiceAdapter {
  ...
  async searchCompanies(query: string): Promise<EdgarSearchResult[]> {
    if (this.isDemoMode) {
      ...
      return MOCK_EDGAR_COMPANIES.filter(
        c => c.entityName.toLowerCase().includes(q) || c.tickers.some(t => t.toLowerCase().includes(q))
      );
    }
    ...
    const data = (await res.json()) as { hits?: { hits?: Array<{ _source?: { display_names?: string[]; file_num?: string[] } }> } };
  ...
  async getConceptData(cik: string, taxonomy: string, concept: string): Promise<EdgarConceptUnit[]> {
    if (this.isDemoMode) {
