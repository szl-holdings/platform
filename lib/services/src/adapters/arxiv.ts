...
const DEMO_PAPERS: ArxivPaper[] = [
  { id: "2401.12345", title: "Scaling Language Models: Methods, Analysis & Insights from Training Gopher", authors: ["Hoffmann, J.", "Borgeaud, S."], abstract: "This paper presents a comprehensive study of scaling laws for language models, investigating how performance changes as a function of model size, training data, and compute budget.", categories: ["cs.CL", "cs.LG", "cs.AI"], published: "2024-01-15", updated: "2024-01-20", pdfUrl: "https://arxiv.org/pdf/2401.12345", citationCount: 892 },
  { id: "2402.34567", title: "Self-Supervised Learning of Video Representations from Human Demonstrations", authors: ["Nair, A.", "Bahl, S."], abstract: "We present a method for learning video representations from unlabeled human demonstrations that enables efficient transfer to downstream robotic manipulation tasks.", categories: ["cs.CV", "cs.LG", "cs.RO"], published: "2024-02-10", updated: "2024-02-15", pdfUrl: "https://arxiv.org/pdf/2402.34567", citationCount: 234 },
  { id: "2403.56789", title: "Constitutional AI: Harmlessness from AI Feedback", authors: ["Bai, Y.", "Jones, A."], abstract: "We propose Constitutional AI, a method for training AI assistants that are both helpful and harmless without relying on human feedback for every output.", categories: ["cs.AI", "cs.CL"], published: "2024-03-05", updated: "2024-03-08", pdfUrl: "https://arxiv.org/pdf/2403.56789", citationCount: 1456 },
];
...
export class ArxivAdapter extends ServiceAdapter {
  ...
  protected async performHealthCheck(): Promise<void> {
    const res = await fetch("https://export.arxiv.org/api/query?search_query=all:AI&max_results=1", {
      method: "HEAD",
