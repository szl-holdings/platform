...
const MOCK_ECONOMIC_SNAPSHOT: FredEconomicSnapshot = {
  ...
  federalFundsRate: {
    date: '2026-03-01',
    value: '4.50',
    realtimeStart: '2026-04-01',
    realtimeEnd: '9999-12-31',
  },
  unemploymentRate: {
    date: '2026-03-01',
    value: '4.2',
    realtimeStart: '2026-04-04',
    realtimeEnd: '9999-12-31',
  },
  tenYearTreasury: {
    date: '2026-04-11',
    value: '4.38',
    realtimeStart: '2026-04-14',
    realtimeEnd: '9999-12-31',
  },
  mortgageRate30Year: {
    date: '2026-04-10',
    value: '6.82',
    realtimeStart: '2026-04-11',
    realtimeEnd: '9999-12-31',
  },
  commercialRealEstatePriceIndex: {
    date: '2026-01-01',
    value: '218.5',
    realtimeStart: '2026-04-01',
    realtimeEnd: '9999-12-31',
...
const KEY_SERIES: Record<string, { id: string; title: string; units: string }> = {
  ...
  commercialRealEstatePriceIndex: {
    id: 'COMREPUSQ159N',
    title: 'Commercial Real Estate Prices for United States',
...
export class FredAdapter extends ServiceAdapter {
  ...
  async getObservations(
    ...
    if (this.isDemoMode) {
      const snap = MOCK_ECONOMIC_SNAPSHOT as unknown as Record<
        string,
        FredObservation | null | string
      >;
