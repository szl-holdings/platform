...
export class WorldBankAdapter extends ServiceAdapter {
  ...
  readonly description = "World Bank Open Data API — GDP growth, population, inflation and 14,000+ economic indicators. Free, no key required.";
  ...
  protected async performHealthCheck(): Promise<void> {
    ...
    if (!Array.isArray(entries) || entries.length === 0) throw new Error("World Bank returned no data");
  }
}
