...
const MOCK_LEASE_COMPS: CompStakLeaseComp[] = [
  {
    ...
    leasedSqft: 92000,
    startingRentPerSqft: 110.0,
    effectiveRentPerSqft: 98.5,
    freeRentMonths: 12,
  ...
  },
  {
    ...
    leasedSqft: 248000,
    startingRentPerSqft: 74.0,
    effectiveRentPerSqft: 68.0,
    freeRentMonths: 18,
  ...
  },
  {
    ...
    transactionType: 'New Lease',
    leasedSqft: 142000,
    startingRentPerSqft: 32.0,
    effectiveRentPerSqft: 32.0,
    freeRentMonths: 3,
  ...
  },
  {
    ...
    transactionType: 'New Lease',
    leasedSqft: 95000,
    startingRentPerSqft: 35.0,
    effectiveRentPerSqft: 35.0,
    freeRentMonths: 0,
  ...
  },
  {
    ...
    leasedSqft: 22000,
    startingRentPerSqft: 65.0,
    effectiveRentPerSqft: 65.0,
    freeRentMonths: 0,
...
export class CompStakAdapter extends ServiceAdapter {
  ...
  readonly requiredEnvVars = ['COMPSTAK_API_KEY', 'COMPSTAK_API_SECRET'];
  ...
  async getLeaseComps(
    ...
    if (!this.isLive) {
      ...
      if (params.limit)
        comps = comps.slice(params.offset ?? 0, (params.offset ?? 0) + params.limit);
      return comps;
    }
  ...
  async getPropertyDetail(propertyId: string): Promise<CompStakPropertyDetail | null> {
    ...
    const data = (await this.compstakRequest(
      `/properties/${propertyId}`,
    )) as CompStakPropertyDetail | null;
    return data;
  }
