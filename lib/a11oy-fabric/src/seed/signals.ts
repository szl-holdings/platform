...
const owners: Record<string, string[]> = {
  'lyte-revenue': ['VP Revenue, KORA', 'VP Sales, KORA', 'Head of Customer Success, KORA', 'Head of Product, KORA'],
  'vessels-maritime': ['Operations Controller, SEXTANT', 'Fleet Compliance Officer', 'Fleet Chartering Manager', 'Technical Superintendent', 'Environmental Compliance Manager'],
  'terra-real-estate': ['Portfolio Director, LA', 'Leasing Director, Northern CA', 'CFO, DOMAINE', 'Development Director, Pacific NW', 'Portfolio Director, Texas'],
  'aegis-defense': ['Threat Intelligence Lead, PARAGON', 'Operations Director, PARAGON', 'Compliance Officer, PARAGON', 'Deputy CISO, PARAGON'],
...
export const SEED_SIGNALS: BusinessSignal[] = [
  ...
  },
  {
    ...
    entity: 'PARAGON Platform — Threat Intelligence',
    ...
    owner: 'Threat Intelligence Lead, PARAGON',
    detectedAt: minus(1),
