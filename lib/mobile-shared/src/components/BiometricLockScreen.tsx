  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      <View style={styles.inner}>
        ...
        <Text style={[styles.title, { color: foregroundColor }]}>{appName} Locked</Text>
        ...
        {failed && (
          <View
            style={[styles.errorBanner, { backgroundColor: '#ef444420', borderColor: '#ef444440' }]}
          >
        ...
        <TouchableOpacity
          style={[styles.unlockBtn, { backgroundColor: accentColor, opacity: unlocking ? 0.7 : 1 }]}
        ...
        <Text style={[styles.secNoteText, { color: mutedColor }]}>{appName}</Text>
      </View>
    </View>
  );
}
