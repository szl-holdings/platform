...
export const PRISM_DOMAIN_TOOLS: Record<PrismDomain, string[]> = {
  ...
  "prism-counsel": ["alloy_research", "alloy_create_artifact", "query_audit_log", "get_matter_list", "get_obligations", "get_proof_chain"],
  global: [],
};
...
export const PRISM_BUILT_IN_TOOLS: PrismToolDescriptor[] = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        depth: { type: "string", description: "Research depth: quick | standard | deep", enum: ["quick", "standard", "deep"] },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        type: { type: "string", description: "Artifact type", enum: ["report", "brief", "summary", "analysis"] },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        severity: { type: "string", description: "Min severity filter", enum: ["low", "medium", "high", "critical"] },
      },
      required: ["target"],
    },
    domains: ["aegis"],
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        framework: { type: "string", description: "Compliance framework", enum: ["NIST", "SOC2", "ISO27001", "CIS", "PCI_DSS"] },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        timeRange: { type: "string", description: "Time range for summary", enum: ["1h", "6h", "24h", "7d"] },
      },
    },
