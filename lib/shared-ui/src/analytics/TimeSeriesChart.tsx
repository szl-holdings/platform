import type { MetricDataPoint, MetricQueryResult } from '@szl-holdings/observability/analytics';
...
export function TimeSeriesChart({
  ...
  const comparePoints = useMemo(
    () =>
      compareResult
        ? computeChartPoints(compareResult.dataPoints, width, height, minVal, maxVal)
        : [],
    ...
    <div className="rounded-xl border border-white/10 bg-white/5 p-4 flex flex-col gap-3">
      ...
      >
        ...
        {thresholdWarning !== undefined && (
          <line
            x1={0}
            y1={thresholdY(thresholdWarning)}
            x2={width}
            y2={thresholdY(thresholdWarning)}
            stroke="#eab308"
            strokeWidth={1}
            strokeDasharray="4 4"
          />
        ...
        {thresholdCritical !== undefined && (
          <line
            x1={0}
            y1={thresholdY(thresholdCritical)}
            x2={width}
            y2={thresholdY(thresholdCritical)}
            stroke="#ef4444"
            strokeWidth={1}
            strokeDasharray="4 4"
          />
        ...
        {primaryPath && <path d={primaryPath} fill="none" stroke={color} strokeWidth={2} />}
