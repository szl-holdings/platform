...
export function CookieBanner({ privacyUrl = "/legal/privacy", accentColor = "#d4a054" }: CookieBannerProps) {
  ...
  return (
    ...
    >
      <div style={{ flex: 1 }}>
        <p style={{ margin: 0, fontSize: "0.8125rem", color: "rgba(255,255,255,0.75)", lineHeight: 1.5 }}>
          We use cookies for session management and platform analytics — no advertising or third-party tracking.{" "}
          <a
            href={privacyUrl}
