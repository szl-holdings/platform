...
const STATE_CONFIG: Record<DataState, { label: string; color: string; bg: string; border: string; dot?: string }> = {
  live: {
    label: "Live",
    color: "hsl(142 70% 58%)",
...
export function DataStateBadge({ state, label, size = "xs", pulse = false, className, style }: DataStateBadgeProps) {
