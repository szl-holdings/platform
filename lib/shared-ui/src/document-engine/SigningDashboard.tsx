...
export function SigningDashboard({
  ...
  const filtered = signatures.filter((s) => {
    if (
      ...
      !s.docTitle.toLowerCase().includes(search.toLowerCase())
    )
      return false;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-white/50 mt-0.5">
            Track all signature requests and signing status
          </p>
        </div>
      </div>
          ...
          {filtered.map((sig) => {
            ...
            return (
              <div
                key={sig.sigId}
                className={cn(
                  'flex items-center gap-4 p-4 rounded-xl border bg-white/5',
                  expired ? 'border-slate-600/20 opacity-70' : 'border-white/10',
                )}
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-white/30 mt-0.5">
                    Signer #{sig.signingOrder} · Requested{' '}
                ...
                {(sig.status === 'pending' || sig.status === 'viewed') && !expired && (
                  <button
                    ...
                    title={
                      reminded || sig.reminderSentAt ? 'Reminder already sent' : 'Send reminder'
                    }
                  >
...
const DEMO_SIGNATURES: SignatureSummary[] = [
  {
    sigId: 1,
    documentId: 1,
    signerEmail: 'client@meridian.com',
    signerName: 'James Meridian',
    status: 'signed',
    signingOrder: 1,
    createdAt: '2026-01-15T10:00:00Z',
    expiresAt: '2026-01-22T10:00:00Z',
    reminderSentAt: null,
    docTitle: 'Engagement Letter — Meridian',
    docType: 'engagement_letter',
    docAppSource: 'carlota_jo',
  },
  {
    sigId: 2,
    documentId: 1,
    signerEmail: 'legal@meridian.com',
  ...
  },
  {
    sigId: 3,
    documentId: 2,
    signerEmail: 'buyer@blackwood.com',
    signerName: 'Marcus Blackwood',
    status: 'pending',
    signingOrder: 1,
    createdAt: '2026-03-10T09:00:00Z',
    expiresAt: '2026-03-17T09:00:00Z',
    reminderSentAt: null,
    docTitle: 'NDA — Blackwood Ventures',
    docType: 'nda',
    docAppSource: 'carlota_jo',
  },
  {
    sigId: 4,
    documentId: 3,
    signerEmail: 'captain@maritime.com',
    signerName: 'Capt. Rodriguez',
    status: 'signed',
    signingOrder: 1,
    createdAt: '2026-01-25T08:00:00Z',
    expiresAt: '2026-02-01T08:00:00Z',
    reminderSentAt: null,
    docTitle: 'Charter Party — Pacific Navigator',
    docType: 'charter_party',
    docAppSource: 'vessels',
  },
  {
    sigId: 5,
    documentId: 4,
    signerEmail: 'broker@terra.com',
    signerName: 'Alexandra Park',
    status: 'signed',
    signingOrder: 1,
    createdAt: '2026-01-18T14:00:00Z',
    expiresAt: '2026-01-25T14:00:00Z',
    reminderSentAt: null,
    docTitle: 'Deal Memo — 123 Main Street',
    docType: 'deal_memo',
    docAppSource: 'terra',
  },
  {
    sigId: 6,
    documentId: 5,
    signerEmail: 'ciso@company.com',
    signerName: 'David Thorpe',
    status: 'signed',
    signingOrder: 1,
    createdAt: '2026-02-10T09:00:00Z',
    expiresAt: '2026-02-17T09:00:00Z',
    reminderSentAt: null,
    docTitle: 'Compliance Evidence — Q1',
    docType: 'compliance_evidence',
    docAppSource: 'aegis',
  },
  {
    sigId: 7,
    documentId: 6,
    signerEmail: 'ops@alloy.io',
    signerName: 'Nina Walsh',
    status: 'pending',
    signingOrder: 1,
    createdAt: '2026-03-18T10:00:00Z',
    expiresAt: '2026-03-25T10:00:00Z',
    reminderSentAt: null,
    docTitle: 'Workflow Approval — CRM v3',
    docType: 'workflow_approval_memo',
    docAppSource: 'alloy',
  },
  {
    sigId: 8,
    documentId: 7,
    signerEmail: 'declined@company.com',
    signerName: 'Robert Lee',
    status: 'declined',
    signingOrder: 2,
    createdAt: '2026-02-01T11:00:00Z',
    expiresAt: '2026-02-08T11:00:00Z',
    reminderSentAt: null,
    docTitle: 'Service Agreement — Argon',
