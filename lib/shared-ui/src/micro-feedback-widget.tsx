...
export function MicroFeedbackWidget({
  ...
  if (state === "submitted") {
    return (
      <div style={{ ...baseStyle, color: "#10b981", gap: "0.375rem" }}>
        ...
        <button onClick={() => setDismissed(true)} style={{ background: "none", border: "none", cursor: "pointer", color: "inherit", padding: "0 0 0 2px", lineHeight: 1, opacity: 0.6 }}>
  ...
  if (state === "comment") {
    return (
      <div style={{ display: "inline-flex", flexDirection: "column", gap: "0.375rem", padding: "0.5rem 0.75rem", borderRadius: "0.75rem", background: "hsla(0,0%,100%,0.04)", border: "1px solid hsla(0,0%,100%,0.08)", maxWidth: "320px" }}>
        <p style={{ fontSize: "10px", color: "hsl(210,5%,52%)", margin: 0 }}>What could be better? (optional)</p>
        <div style={{ display: "flex", gap: "0.375rem" }}>
          ...
          <button
            ...
            style={{ background: "hsla(265,70%,60%,0.2)", border: "1px solid hsla(265,70%,60%,0.3)", borderRadius: "0.375rem", padding: "4px 8px", cursor: "pointer", color: "#a78bfa", display: "flex", alignItems: "center" }}
          >
            <Send size={11} />
          </button>
          <button
            onClick={handleSubmitComment}
            style={{ background: "none", border: "none", cursor: "pointer", color: "hsl(210,5%,44%)", fontSize: "10px", padding: "4px", fontFamily: "system-ui, sans-serif" }}
          >
            Skip
          </button>
        </div>
  ...
  return (
    <div style={baseStyle}>
      ...
      <button
        ...
        title="Helpful"
        style={{ background: "none", border: "none", cursor: "pointer", color: "hsl(210,5%,46%)", padding: "2px", display: "flex", alignItems: "center", borderRadius: "4px", transition: "color 0.15s" }}
      ...
      <button onClick={() => setDismissed(true)} style={{ background: "none", border: "none", cursor: "pointer", color: "hsl(210,5%,34%)", padding: "2px", display: "flex", alignItems: "center" }}>
        <X size={compact ? 9 : 11} />
      </button>
    </div>
  );
