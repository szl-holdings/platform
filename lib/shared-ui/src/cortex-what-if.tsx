        ...
        <div style={{ padding: "0 14px 12px", borderTop: "1px solid #ffffff10" }}>
          {cascade.affectedEntities.length > 0 && (
            <div style={{ marginTop: 10, marginBottom: 10 }}>
              <p style={{ margin: "0 0 5px", fontSize: 11, fontWeight: 600, color: "#ffffff50", letterSpacing: "0.06em", textTransform: "uppercase" as const }}>
                Affected Entities
              </p>
          ...
          {cascade.mitigationOptions.length > 0 && (
            <div>
              <p style={{ margin: "0 0 6px", fontSize: 11, fontWeight: 600, color: "#ffffff50", letterSpacing: "0.06em", textTransform: "uppercase" as const }}>
                Mitigation Options
              </p>
      ...
      {result && !loading && (
        <div>
          ...
          >
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 10 }}>
              <div style={{ flex: 1 }}>
                ...
                <p style={{ margin: "0 0 6px", fontSize: 11, fontWeight: 600, color: "#ffffff60", letterSpacing: "0.06em", textTransform: "uppercase" as const }}>
                  Scenario
                </p>
                <p
                  style={{
            ...
            <div style={{ display: "flex", gap: 4, flexWrap: "wrap" as const }}>
              <span style={{ fontSize: 11, color: "#ffffff50", marginRight: 4 }}>Affected domains:</span>
          ...
          >
            ...
            <span>
              CORTEX scenario engine uses the cross-domain entity graph and historical pattern library.
              Results are probabilistic — human judgment required for final decisions.
            </span>
          </div>
        </div>
      )}
