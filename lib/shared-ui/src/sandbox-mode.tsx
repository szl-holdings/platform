...
export function SandboxModeProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SandboxModeContext.Provider
      value={{ sandboxActive, enableSandbox, disableSandbox, toggleSandbox, resetSandboxData, resetKey }}
    >
      {children}
    </SandboxModeContext.Provider>
  );
    ...
    >
      ...
      >
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
          ...
          <path d="M4 5.5C4 4.67 4.67 4 5.5 4h1C7.33 4 8 4.67 8 5.5c0 .55-.3 1.04-.74 1.3L6 7.5" stroke="#d4a054" strokeWidth="1.2" strokeLinecap="round" />
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "6px", marginLeft: "auto" }}>
        ...
        >
          <svg width="11" height="11" viewBox="0 0 11 11" fill="none" aria-hidden="true">
            <path d="M9 5.5A3.5 3.5 0 1 1 5.5 2" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
            <path d="M5.5 2l1.5-1.5L5.5 2 7 3.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          Reset
        </button>
        <button
      ...
      <div ref={ref} style={{ position: "relative" }}>
        ...
        {open && (
          ...
          >
            ...
            <button
              onClick={() => { toggleSandbox(); setOpen(false); }}
              style={{
                width: "100%",
                padding: "8px 12px",
                background: sandboxActive ? "rgba(196,90,74,0.18)" : "rgba(212,160,84,0.18)",
                border: sandboxActive ? "1px solid rgba(196,90,74,0.40)" : "1px solid rgba(212,160,84,0.40)",
                borderRadius: "8px",
                cursor: "pointer",
                fontSize: "12px",
                fontWeight: 600,
  ...
  return (
    <button
      ...
      style={{
        ...
        border: sandboxActive ? "1px solid rgba(212,160,84,0.40)" : "1px solid rgba(255,255,255,0.09)",
        borderRadius: "6px",
        cursor: "pointer",
        fontFamily: "Inter, system-ui, sans-serif",
        fontSize: "11px",
