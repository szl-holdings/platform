...
const ECOSYSTEM_APPS: EcosystemApp[] = [
  {
    ...
    accent: '#c9b787',
    icon: '◆',
    description: 'Governed Decision Operating System — Ecosystem Intelligence Layer',
  },
  {
    id: 'sentra',
    name: 'Sentra',
    subtitle: 'Domain Pack · Cyber Resilience',
    path: '/sentra/',
    accent: '#f5f5f5',
    icon: '⬡',
    description: 'Cyber Resilience Command — Threat Intelligence, Incident Response & Remediation',
  },
  {
    id: 'conduit',
    name: 'Conduit',
    subtitle: 'Domain Pack · Reverse ETL',
    path: '/conduit/',
    accent: '#6ee7b7',
    icon: '⇌',
    description: 'Reverse ETL — Sync warehouse data to any destination with governed orchestration',
  },
  {
    id: 'vessels',
    name: 'Vessels',
  ...
  },
  {
    ...
    accent: '#c9b787',
    icon: '⬢',
    description: 'Real Estate Intelligence — Distress Radar, Deal Pipeline & Market Analytics',
  },
  {
    id: 'carlota-jo',
    name: 'Carlota Jo',
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    <span
                      style={{ fontSize: '10px', color: 'rgba(255,255,255,0.3)', flexShrink: 0 }}
                    >
                  ...
                  {n.actionUrl && !n.read && (
                    <div
                      style={{ fontSize: '10px', color: 'rgba(255,255,255,0.3)', marginTop: '4px' }}
                    >
                      Click to view →
                    </div>
                  )}
...
function getSearchResults(query: string): SearchResult[] {
  ...
  for (const app of ECOSYSTEM_APPS) {
    if (app.name.toLowerCase().includes(q) || app.subtitle.toLowerCase().includes(q)) {
      results.push({
        icon: app.icon,
        title: app.name,
        app: app.name,
...
function getDomainSearchResults(q: string): SearchResult[] {
  ...
  const searchableContent = [
    ...
    {
      keywords: ['brand', 'consulting', 'advisory', 'discreet', 'residence', 'estate', 'private'],
      app: 'Carlota Jo',
      icon: '◈',
      accent: '#d4b896',
      href: '/carlota-jo/',
      items: ['Services', 'Approach', 'Private Inquiry'],
    },
  ];
        ...
        >
          ...
          <div ref={notificationsRef} style={{ position: 'relative' }}>
            ...
            >
              ...
              >
                <path
                  d="M8 1.5a4 4 0 0 0-4 4v2.382a1 1 0 0 1-.106.447l-1.106 2.213A.5.5 0 0 0 3.236 11h9.528a.5.5 0 0 0 .448-.724l-1.106-2.213a1 1 0 0 1-.106-.447V5.5a4 4 0 0 0-4-4Z"
                  stroke="currentColor"
                  strokeWidth="1.25"
                  strokeLinejoin="round"
                />
          ...
          {isAuthenticated && user ? (
            <div ref={userMenuRef} style={{ position: 'relative' }}>
              ...
              {showUserMenu && (
                ...
                >
                  ...
                  <div
                    style={{ height: '1px', background: 'rgba(255,255,255,0.07)', margin: '4px 0' }}
                  />
                  <button
                    onClick={() => {
            ...
            <button
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLElement).style.background = `${accentColor}35`;
              }}
              onMouseLeave={(e) => {
