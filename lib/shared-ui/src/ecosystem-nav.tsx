...
const ECOSYSTEM_APPS: EcosystemApp[] = [
  {
    id: "szl-holdings",
    name: "SZL Holdings",
    subtitle: "Ecosystem · Parent Brand",
    path: "/",
    accent: "#94a3b8",
    icon: "◆",
  ...
  },
  {
    id: "alloy",
    name: "Alloy",
    subtitle: "Engine · Intelligence Layer",
    path: "/alloy/",
    accent: "#60a5fa",
    icon: "⬡",
    description: "Systems, Orchestration & Intelligence",
  },
  {
    id: "lyte",
    name: "Lyte",
    subtitle: "Flagship · Business Observability",
  ...
  },
  {
    id: "vessels",
    name: "Vessels",
    subtitle: "Flagship · Maritime Command",
    path: "/vessels/",
    accent: "#38bdf8",
    icon: "⚓",
