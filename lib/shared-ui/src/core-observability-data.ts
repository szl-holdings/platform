...
export const PREDICTIONS: PredictionEntity[] = [
  ...
  {
    id: 'pred-004',
    title: 'FORGE reroute will recover 6.2h cycle time on contract workflow',
    ...
    recommended_action:
      'Execute reroute in FORGE to CFO backup approver. Notify original approver. Set 2h SLA on new path.',
    correlation_id: GOLDEN_FLOW_CORRELATION_ID,
...
export const EXECUTION_RUNS: ExecutionRun[] = [
  ...
  },
  {
    ...
    steps_completed: 3,
    steps_failed: 0,
    triggered_by: 'Manual override — Jordan Alvarez via KORA Command',
    trigger_type: 'manual',
    correlation_id: GOLDEN_FLOW_CORRELATION_ID,
    linked_lyte_action: 'apr-001',
  },
  {
    ...
    steps_completed: 2,
    steps_failed: 0,
    triggered_by: 'KORA drift detection — NPS anomaly',
    trigger_type: 'event',
    correlation_id: 'corr-churn-techcorp',
  },
  {
...
export const EVENTS: ObsEvent[] = [
  {
    ...
    actor_type: 'system',
    actor_name: 'KORA Drift Detection',
    severity: 'critical',
    confidence: 99,
    status: 'escalated',
    correlation_id: GOLDEN_FLOW_CORRELATION_ID,
  ...
  },
  {
    ...
    actor_type: 'system',
    actor_name: 'KORA Workflow Monitor',
    severity: 'critical',
    confidence: 100,
    status: 'blocked',
    correlation_id: GOLDEN_FLOW_CORRELATION_ID,
  ...
  },
  {
    ...
    actor_type: 'system',
    actor_name: 'KORA Ownership Monitor',
    severity: 'high',
    confidence: 100,
    status: 'blocked',
    correlation_id: 'corr-vendor-apex',
...
export const WORKFLOWS_UI: WorkflowUI[] = WORKFLOWS.map((w) => {
  const stepMap: Record<string, WorkflowStep[]> = {
    'wf-001': [
      ...
      { name: 'Contract Gen', status: 'completed', assignee: 'FORGE' },
    ...
    'wf-004': [
      { name: 'NPS Alert', status: 'completed', assignee: 'DOMAINE' },
