...
const ECOSYSTEM_NODES: EcosystemNode[] = [
  ...
  },
  {
    ...
    description: "Scenario modeling & confidence-weighted forecasting — powered by Alloy",
    angle: 180,
  },
  {
    id: "alloy",
    ...
    description: "Connector mesh, DAGs, automations & predictive intelligence engine",
    angle: 270,
  },
  {
    id: "rosie",
...
const CONNECTION_PAIRS: Array<[string, string, string]> = [
  ...
  ["inca", "alloy-predict", "Intelligence → forecast"],
  ["alloy-predict", "lyte", "Prediction → workflow"],
