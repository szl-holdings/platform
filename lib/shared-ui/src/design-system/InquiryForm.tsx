      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {config.extraFields && (
          <div className="grid sm:grid-cols-2 gap-4">
            {config.extraFields.map((field) => (
              <div key={field.name}>
                <label className="block text-neutral-900 text-xs font-semibold mb-1.5">
                  {field.label}
                </label>
                <input
                  type="text"
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-neutral-900 placeholder-neutral-400 text-sm focus:outline-none focus:ring-2 transition-all bg-white"
                />
              </div>
            ))}
          </div>
        ...
        <div>
          ...
          <input
            ...
            value={form.subject}
            onChange={handleChange}
            placeholder={config.subjectPlaceholder ?? 'Subject'}
