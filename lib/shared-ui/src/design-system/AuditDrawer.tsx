  ...
  return (
    <>
      ...
      <aside
        ...
        aria-modal="true"
        className={cn(
          "fixed top-0 right-0 bottom-0 w-full max-w-[26rem] flex flex-col",
          className
        )}
        style={{
              ...
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="flex gap-3">
                  ...
                  <div className="flex-1 space-y-1.5 pt-1">
                    <div className="h-3 rounded animate-pulse w-3/4" style={{ background: colors.surface.glass }} />
                    <div className="h-2.5 rounded animate-pulse w-1/2" style={{ background: colors.surface.glass }} />
                  </div>
                </div>
              ))}
            </div>
                  ...
                  <div key={entry.id ?? i} className="relative flex gap-3">
                    <div
                      ...
                      style={{
                        ...
                        borderColor: accentColor ? toAlpha(accentColor, 0.22) : colors.border.DEFAULT,
                      }}
                    >
                      <span
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                        <span className="text-[11px]" style={{ color: accentColor ?? colors.semantic.stable }}>
                          {entry.actor}
                        </span>
                        {entry.actorRole && (
                      ...
                      {entry.detail && (
                        <p className="text-[12px] mt-1 leading-relaxed" style={{ color: colors.text.muted }}>
                          {entry.detail}
                        </p>
                      )}
