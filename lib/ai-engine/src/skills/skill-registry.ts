...
const SKILL_REGISTRY: Map<string, SkillPackage> = new Map(<[string, SkillPackage][]>[
  ["threat_triage", {
    ...
    inputSchema: {
      ...
      properties: {
        threatDescription: { type: "string", description: "Description of the threat or incident" },
    ...
    estimatedTokens: 600,
    systemPromptFragment: "Apply MITRE ATT&CK framework. Classify with CVSS scoring. Output severity, technique ID, and priority.",
  ...
  ["maritime_risk_scoring", {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sanctionsCheck: { type: "boolean", description: "Whether to include sanctions screening" },
      },
    },
    outputSchema: {
      properties: {
    ...
    estimatedTokens: 800,
    systemPromptFragment: "Use AIS data, BIMCO guidelines, and sanctions lists. Calculate composite risk score.",
    executionHint: "Cross-reference vessel history, flag state, and owner/operator against sanctions databases.",
  }],
  ["research_synthesis", {
    skillId: "research_synthesis",
    name: "Research Synthesis",
    description: "Synthesize AI/ML research papers, models, and datasets into actionable intelligence",
    version: "1.0.0",
    category: "research",
    ...
    systemPromptFragment: "Synthesize from arXiv, HuggingFace, and academic sources. Cite evidence. Focus on actionable insights.",
  ...
  ["anomaly_detection", {
    ...
    inputSchema: {
      ...
      properties: {
        metricDescription: { type: "string", description: "Description of metrics or system state" },
    ...
    estimatedTokens: 700,
    systemPromptFragment: "Apply statistical analysis and rule-based detection. Identify root cause patterns.",
    executionHint: "Compare against historical baselines. Apply 3-sigma rule for statistical anomalies.",
  }],
  ["incident_response_plan", {
    skillId: "incident_response_plan",
    name: "Incident Response Plan",
    description: "Generate structured incident response plans with containment, eradication, and recovery steps",
    version: "1.0.0",
    category: "generation",
    applicableAgents: ["sentinel", "alloy"],
    triggerConditions: {
    ...
    systemPromptFragment: "Generate NIST IR framework-aligned response plan. Be specific about ownership and timelines.",
    executionHint: "Reference NIST SP 800-61 playbooks. Include rollback steps for every action.",
  }],
  ["executive_brief", {
    skillId: "executive_brief",
    name: "Executive Brief",
    description: "Translate technical findings into executive-level summaries with business impact",
    version: "1.0.0",
    category: "synthesis",
    applicableAgents: ["alloy", "sentinel", "compass"],
    triggerConditions: {
      keywords: ["executive", "brief", "board", "C-suite", "summary", "business impact", "leadership"],
    ...
    chainableWith: [],
    estimatedTokens: 800,
    systemPromptFragment: "Translate technical details to business risk. No jargon. Focus on financial and operational impact.",
    executionHint: "Avoid technical acronyms. Lead with business impact, not technical details.",
  }],
  ["escalation_decision", {
    skillId: "escalation_decision",
    name: "Escalation Decision",
    description: "Determine whether and how to escalate an issue through organizational hierarchy",
    version: "1.0.0",
    category: "analysis",
    ...
    estimatedTokens: 500,
    systemPromptFragment: "Apply RACI matrix logic. Consider time criticality, business impact, and escalation fatigue.",
  ...
  ["readiness_gap_analysis", {
    ...
    triggerConditions: {
      keywords: ["readiness", "maturity", "gap", "assessment", "capability", "score", "framework"],
      domains: ["readiness"],
      minConfidenceThreshold: 0.6,
    },
    inputSchema: {
      ...
      properties: {
        framework: { type: "string", description: "Assessment framework (NIST, ISO, SOC2, etc.)" },
    ...
    systemPromptFragment: "Apply CMMI levels. Score each domain. Prioritize gaps by risk and feasibility.",
