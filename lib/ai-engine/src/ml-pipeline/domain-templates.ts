...
export type PredictionTask = "classification" | "regression" | "forecasting" | "anomaly_detection" | "ranking" | "scoring";
  ...
  vessels: [
    {
      ...
      primaryMetric: "mape",
      defaultHyperparameters: { horizon_days: 14, seasonality_mode: "additive", changepoint_prior_scale: 0.05, fourier_order: 5 },
      featureGroups: ["vessels.fuel_consumption_7d_avg", "vessels.speed_variance", "vessels.cargo_utilisation"],
    ...
    },
    {
      ...
      primaryMetric: "rmse",
      defaultHyperparameters: { n_estimators: 300, max_depth: 6, learning_rate: 0.05, subsample: 0.8, colsample_bytree: 0.8 },
      featureGroups: ["vessels.route_deviation_score", "vessels.speed_variance", "vessels.port_call_frequency"],
    ...
    },
    {
      ...
      primaryMetric: "auc",
      defaultHyperparameters: { n_estimators: 400, max_depth: 5, learning_rate: 0.05, scale_pos_weight: 5 },
      featureGroups: ["vessels.days_since_last_maintenance", "vessels.fuel_consumption_7d_avg", "vessels.speed_variance"],
  ...
  terra: [
    {
      ...
      primaryMetric: "mape",
      defaultHyperparameters: { n_estimators: 500, max_depth: 6, learning_rate: 0.03, min_child_weight: 5, reg_alpha: 0.1 },
      featureGroups: ["terra.price_per_sqft", "terra.neighborhood_cap_rate", "terra.walk_score", "terra.zoning_class"],
    ...
    },
    {
      ...
      primaryMetric: "f1",
      defaultHyperparameters: { n_estimators: 300, max_depth: 4, learning_rate: 0.05, scale_pos_weight: 8 },
      featureGroups: ["terra.days_on_market", "terra.price_reduction_count", "terra.vacancy_rate_submarket"],
  ...
  prism: [
    {
      ...
      primaryMetric: "f1",
      defaultHyperparameters: { n_estimators: 350, max_depth: 5, learning_rate: 0.05, num_class: 3 },
      featureGroups: ["prism.case_age_days", "prism.opposing_counsel_win_rate", "prism.motion_grant_rate_judge", "prism.filing_jurisdiction"],
    ...
    },
    {
      ...
      featureGroups: ["prism.settlement_demand_to_claimed_ratio", "prism.case_age_days", "prism.discovery_volume_pages"],
  ...
  aegis: [
    {
      ...
      primaryMetric: "auc",
      defaultHyperparameters: { n_estimators: 200, contamination: 0.01, max_features: 0.8, bootstrap: true },
      featureGroups: ["aegis.failed_auth_rate_1h", "aegis.lateral_movement_score", "aegis.data_exfil_bytes_delta", "aegis.privilege_escalation_events"],
    ...
    },
    {
      ...
      featureGroups: ["aegis.ioc_match_count", "aegis.user_baseline_deviation", "aegis.privilege_escalation_events", "aegis.lateral_movement_score"],
  ...
  szl: [
    {
      ...
      primaryMetric: "rmse",
      defaultHyperparameters: { n_estimators: 400, max_depth: 5, learning_rate: 0.04, subsample: 0.8 },
    ...
    },
    {
      ...
      featureGroups: ["szl.revenue_growth_yoy", "szl.burn_multiple", "szl.ndr", "szl.months_runway", "szl.gross_margin"],
  ...
  lyte: [
    {
      ...
      primaryMetric: "mape",
      defaultHyperparameters: { horizon_days: 7, seasonality: "weekly", changepoint_prior_scale: 0.1 },
      featureGroups: ["lyte.incident_rate_7d", "lyte.deployment_frequency_7d", "lyte.error_rate_pct"],
    ...
    },
    {
      ...
      primaryMetric: "f1",
      defaultHyperparameters: { n_estimators: 300, max_depth: 4, learning_rate: 0.05, scale_pos_weight: 6 },
      featureGroups: ["lyte.p99_latency_ms", "lyte.error_rate_pct", "lyte.cpu_utilisation_avg", "lyte.slo_compliance_pct"],
    ...
    },
    {
      ...
      featureGroups: ["lyte.cpu_utilisation_avg", "lyte.p99_latency_ms", "lyte.deployment_frequency_7d"],
