  ...
  helmsman: [
    {
      ...
      inputSchema: { type: "object", properties: { vessels: { type: "array" }, timeRange: { type: "string" } } },
    ...
    },
    {
      ...
      description: "Assess risk for planned maritime routes including sanctions, weather, piracy zones",
      inputSchema: { type: "object", properties: { origin: { type: "string" }, destination: { type: "string" } } },
      outputSchema: { type: "object", properties: { riskLevel: { type: "string" }, blockers: { type: "array" } } },
      costEstimate: "medium",
      avgLatencyMs: 2200,
    },
  ],
  sentinel: [
    {
      ...
      inputSchema: { type: "object", properties: { threat: { type: "string" }, assets: { type: "array" } } },
      outputSchema: { type: "object", properties: { severity: { type: "string" }, cvss: { type: "number" } } },
      costEstimate: "medium",
      avgLatencyMs: 2000,
    },
    {
      ...
      inputSchema: { type: "object", properties: { primaryOutput: { type: "string" }, context: { type: "string" } } },
      outputSchema: { type: "object", properties: { validated: { type: "boolean" }, notes: { type: "string" } } },
      costEstimate: "low",
      avgLatencyMs: 1500,
    },
  ],
  inca: [
    {
      ...
      inputSchema: { type: "object", properties: { topic: { type: "string" }, depth: { type: "string" } } },
      outputSchema: { type: "object", properties: { summary: { type: "string" }, models: { type: "array" } } },
      costEstimate: "high",
      avgLatencyMs: 3500,
    },
  ],
  muse: [
    {
      ...
      inputSchema: { type: "object", properties: { brief: { type: "string" }, audience: { type: "string" } } },
      outputSchema: { type: "object", properties: { content: { type: "string" }, strategy: { type: "object" } } },
      costEstimate: "medium",
      avgLatencyMs: 2500,
    },
  ],
  beacon: [
    {
      ...
      inputSchema: { type: "object", properties: { metrics: { type: "array" }, baseline: { type: "object" } } },
  ...
  zeus: [
    {
      ...
      inputSchema: { type: "object", properties: { system: { type: "string" }, symptoms: { type: "array" } } },
      outputSchema: { type: "object", properties: { diagnosis: { type: "string" }, actions: { type: "array" } } },
      costEstimate: "medium",
      avgLatencyMs: 2000,
    },
  ],
  compass: [
    {
      ...
      inputSchema: { type: "object", properties: { framework: { type: "string" }, scope: { type: "string" } } },
      outputSchema: { type: "object", properties: { score: { type: "number" }, gaps: { type: "array" } } },
      costEstimate: "medium",
      avgLatencyMs: 2800,
    },
  ],
  alloy: [
    {
      ...
      inputSchema: { type: "object", properties: { query: { type: "string" }, agents: { type: "array" } } },
      outputSchema: { type: "object", properties: { synthesis: { type: "string" }, confidence: { type: "number" } } },
      costEstimate: "high",
      avgLatencyMs: 5000,
    },
  ],
...
export function discoverAgentsByCapability(capabilityName: string): AgentCard[] {
  return getAllAgentCards().filter(card =>
    card.capabilities.some(c => c.name.includes(capabilityName) || c.description.toLowerCase().includes(capabilityName.toLowerCase()))
  );
}

export function discoverAgentsByDomain(domain: string): AgentCard[] {
  return getAllAgentCards().filter(card => card.domain === domain && card.availability !== "offline");
}
