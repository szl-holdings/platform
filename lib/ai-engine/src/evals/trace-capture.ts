...
export function captureTrace(input: TraceCaptureInput): AITrace {
  ...
  const trace: AITrace = {
    ...
    ...(input.routeClass !== undefined ? { routeClass: input.routeClass } : {}),
    ...(input.riskLevel !== undefined ? { riskLevel: input.riskLevel } : {}),
    ...(reviewCheck.reason !== undefined ? { reviewReason: reviewCheck.reason } : {}),
    ...(input.proofChainId !== undefined ? { proofChainId: input.proofChainId } : {}),
    ...(input.outcomeGraphId !== undefined ? { outcomeGraphId: input.outcomeGraphId } : {}),
