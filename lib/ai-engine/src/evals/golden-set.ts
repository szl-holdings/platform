...
export const GOLDEN_SET: GoldenTestCase[] = [
  {
    ...
    input:
      'Critical vulnerability CVE-2024-9999 found in production API gateway. CVSS 9.8. Exploit available in the wild.',
  ...
  },
  {
    ...
    category: 'risk_extraction',
    input:
      'Minor configuration drift detected in staging environment. Non-critical service affected.',
  ...
  },
  {
    ...
    input:
      'Maritime sanctions alert: vessel IMO-1234567 detected in restricted waters near Iranian coast.',
  ...
  },
  {
    ...
    category: 'owner_assignment',
    input:
      'Customer billing dispute: $45,000 overcharge on Q3 invoice. Client escalating to legal.',
  ...
  },
  {
    ...
    input:
      'Active data breach detected. PII of 50,000 users potentially exposed. Unauthorized access from external IP.',
  ...
  },
  {
    ...
    category: 'escalation_proposal',
    input:
      'Third-party vendor API returning 50% error rate for payment processing. Revenue impact estimated at $200K/hour.',
  ...
  },
  {
    ...
    assertions: [{ field: 'approvalRequired', operator: 'equals', value: false }],
  },
  {
    id: 'approval-003',
    category: 'approval_gating',
    ...
    assertions: [{ field: 'approvalRequired', operator: 'equals', value: true }],
  },
  {
    id: 'evidence-001',
  ...
  },
  {
    ...
    expectedOutput: {},
    assertions: [{ field: 'evidence', operator: 'exists' }],
  },
  {
    id: 'retrieval-001',
    category: 'retrieval_relevance',
    input:
      "Find previous incidents similar to 'database connection pool exhaustion during peak traffic'.",
    expectedOutput: {},
    assertions: [
  ...
  },
  {
    ...
    expectedOutput: {},
    assertions: [{ field: 'summary', operator: 'notEmpty' }],
  },
  {
    id: 'retrieval-003',
    category: 'retrieval_relevance',
  ...
  },
  {
    ...
    category: 'schema_validity',
    input:
      "Extract entities from: 'John Smith at Acme Corp reported a phishing attack targeting accounts@acme.com on 2024-03-15'.",
    expectedOutput: {},
    assertions: [
  ...
  },
  {
    ...
    category: 'schema_validity',
    input:
      "Plan a response to: 'Multiple failed login attempts from IP 192.168.1.100 targeting admin accounts'.",
    expectedOutput: {},
    assertions: [
  ...
  },
  {
    ...
    expectedOutput: {},
    assertions: [{ field: 'confidence', operator: 'lt', value: 0.5 }],
  },
  {
