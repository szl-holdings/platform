...
export function validateApprovalRecommendation(obj: unknown): obj is ApprovalRecommendation {
  ...
  return (
    ...
    typeof o.approvalLevel === "string" && VALID_APPROVAL_LEVELS.includes(o.approvalLevel as string) &&
    typeof o.approvalReason === "string" &&
    typeof o.riskClassification === "string" && VALID_RISK_CLASSIFICATIONS.includes(o.riskClassification as string) &&
