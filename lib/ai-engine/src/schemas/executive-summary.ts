...
export function validateExecutiveSummary(obj: unknown): obj is ExecutiveSummary {
  ...
  return (
    ...
    typeof o.headline === "string" && o.headline.length > 0 &&
    typeof o.situationOverview === "string" &&
    Array.isArray(o.keyFindings) &&
    Array.isArray(o.recommendedActions) &&
    typeof o.audienceLevel === "string" && VALID_AUDIENCE_LEVELS.includes(o.audienceLevel as string) &&
    typeof o.confidence === "number" &&
    o.confidence >= 0 && o.confidence <= 1 &&
    o.riskSummary !== null && typeof o.riskSummary === "object" &&
