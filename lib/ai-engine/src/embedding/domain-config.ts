...
export function inferDomain(appOrDomain: string): EmbeddingDomain {
  ...
  if (normalized.includes("prism") || normalized.includes("legal") || normalized.includes("counsel")) return "legal";
  if (normalized.includes("vessel") || normalized.includes("maritime") || normalized.includes("fleet")) return "maritime";
  if (normalized.includes("aegis") || normalized.includes("security") || normalized.includes("soc") || normalized.includes("firestorm")) return "security";
  if (normalized.includes("terra") || normalized.includes("real-estate") || normalized.includes("realestate") || normalized.includes("property")) return "real-estate";
  if (normalized.includes("szl") || normalized.includes("holdings") || normalized.includes("finance")) return "finance";
  if (normalized.includes("lyte") || normalized.includes("aiops") || normalized.includes("ops")) return "aiops";
