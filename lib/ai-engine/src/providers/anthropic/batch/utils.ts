 ...
 * USAGE:
 * ```typescript
 * import { batchProcess } from "@szl-holdings/ai-engine/providers/anthropic/batch";
      ...
      pRetry(
        async () => {
          try {
            ...
            throw new PRetryAbortError(error instanceof Error ? error : new Error(String(error)));
          }
        },
