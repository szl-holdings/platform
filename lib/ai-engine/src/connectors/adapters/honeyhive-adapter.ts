  ...
  tools: ConnectorToolDefinition[] = [
    {
      ...
      outputSchema: { type: "object", properties: { eventId: { type: "string" }, success: { type: "boolean" } } },
      costEstimate: "free",
    },
    {
    ...
    },
    {
      ...
      outputSchema: { type: "object", properties: { evaluations: { type: "array" }, total: { type: "number" } } },
      costEstimate: "free",
    },
  ];
