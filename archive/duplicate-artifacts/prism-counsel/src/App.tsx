  ...
  return (
    <div className="flex items-center justify-center h-full min-h-[200px]">
      <div
        ...
        style={{ borderColor: 'rgba(167,139,250,0.2)', borderTopColor: PRISM_ACCENT }}
      />
    </div>
  );
}
...
const prismCommands: CommandItem[] = [
  {
    ...
    group: 'Navigation',
    action: () => {
      window.location.href = window.location.pathname.replace(/\/[^/]*$/, '/matters');
    },
  },
  {
    id: 'nav-obligation',
    ...
    group: 'Navigation',
    action: () => {
      window.location.href = window.location.pathname.replace(/\/[^/]*$/, '/obligation-graph');
    },
  },
  {
    id: 'nav-heatmap',
    ...
    group: 'Navigation',
    action: () => {
      window.location.href = window.location.pathname.replace(/\/[^/]*$/, '/deadline-heatmap');
    },
  },
  {
    id: 'nav-proof',
    ...
    group: 'Navigation',
    action: () => {
      window.location.href = window.location.pathname.replace(/\/[^/]*$/, '/proof-chain');
    },
  },
  {
    id: 'nav-privilege',
    ...
    group: 'Governance',
    action: () => {
      window.location.href = window.location.pathname.replace(/\/[^/]*$/, '/privilege');
    },
  },
  {
    id: 'nav-audit',
    ...
    group: 'Governance',
    action: () => {
      window.location.href = window.location.pathname.replace(/\/[^/]*$/, '/audit');
    },
  },
  ...createBaselineWebActions(
    (path) => {
    ...
    {
      helpUrl: 'https://szlholdings.com/docs/prism',
      themeToggle: {
        label: 'Toggle Theme',
        action: () => {
