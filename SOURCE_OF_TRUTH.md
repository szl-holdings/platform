...
| CI workflows | **47** | Permanent tracked `.github/workflows/*.yml` and `*.yaml`, including exact-head screenshot evidence, exact-head Series A screenshot proof, hosted observability proof, and public npm release paths |
