...
| CI workflows | **47** | Permanent tracked `.github/workflows/*.yml` and `*.yaml`, including hosted observability, public npm release, and exact-head Series A screenshot proof paths, after two obsolete one-shots were retired |
