...
| CI workflows | **46** | Permanent tracked `.github/workflows/*.yml` and `*.yaml`, including hosted observability, public npm release, and provider-neutral exact-source screenshot proof after two obsolete mutation one-shots were retired |
