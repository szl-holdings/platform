...
Complete all applicable items in [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md).
...
- [RUNBOOK_ROLLBACK.md](infra/runbooks/RUNBOOK_ROLLBACK.md) — rollback if needed
...
2. **Assess severity** — use [INCIDENT_SEVERITY_MATRIX.md](INCIDENT_SEVERITY_MATRIX.md)
