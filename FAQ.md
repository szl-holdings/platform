...
Visit /demo or /contact to request a guided demonstration. See [DEMO_GUIDE.md](DEMO_GUIDE.md) for demo options.

**How do I become a design partner?**  
See [DESIGN_PARTNER_PROGRAM.md](DESIGN_PARTNER_PROGRAM.md) or contact inquiries@szlholdings.com.

**How do I report a security issue?**  
Email security@szlholdings.com. See [SECURITY.md](SECURITY.md) for our responsible disclosure policy.

**Where can I find documentation?**  
Start at [DOCS_HOME.md](DOCS_HOME.md). All docs are indexed there.
